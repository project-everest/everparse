...
EVERPARSE_STATIC_ASSERT(sizeof(S32Attempt) == 12);
EVERPARSE_STATIC_ASSERT(offsetof(S32Attempt, f) == 0);
EVERPARSE_STATIC_ASSERT(offsetof(S32Attempt, ptrT) == 4);
EVERPARSE_STATIC_ASSERT(offsetof(S32Attempt, g) == 8);
EVERPARSE_STATIC_ASSERT(sizeof(R32_Attempt) == 8);
EVERPARSE_STATIC_ASSERT(offsetof(R32_Attempt, f) == 0);
EVERPARSE_STATIC_ASSERT(offsetof(R32_Attempt, ptrS) == 4);
