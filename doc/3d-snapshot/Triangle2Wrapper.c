...
static char* Triangle2StructNameOfErr(uint64_t err) {
	switch (EverParseFieldIdOfResult(err)) {
		...
		case 35: return "Triangle._point";
		case 36: return "Triangle._point";
		case 37: return "Triangle2._point";
		case 38: return "Triangle2._point";
		case 39: return "Triangle2._triangle"; 
		default: return "";
	}
}
