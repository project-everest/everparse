...
static inline uint64_t ValidateTriangleA(uint32_t Uu, uint8_t *Input, uint64_t StartPosition)
/*++
    Internal helper function:
...
static inline uint64_t ValidateTriangleB(uint32_t Uu, uint8_t *Input, uint64_t StartPosition)
/*++
    Internal helper function:
...
static inline uint64_t ValidateTriangleC(uint32_t Uu, uint8_t *Input, uint64_t StartPosition)
/*++
    Internal helper function:
