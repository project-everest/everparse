...
)
{
  ...
  /* Field _triangle_b */
  uint64_t positionAfterTriangle0 = ValidateTriangleB(Ctxt, Err, Input, positionAftera);
  ...
  /* Field _triangle_c */
  uint64_t positionAfterTriangle1 = ValidateTriangleC(Ctxt, Err, Input, positionAfterb);
