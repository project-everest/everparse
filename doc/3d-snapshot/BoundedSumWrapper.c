...
static char* BoundedSumStructNameOfErr(uint64_t err) {
	switch (EverParseFieldIdOfResult(err)) {
		...
		case 36: return "BoundedSumConst._boundedSum";
		case 37: return "BoundedSumConst._boundedSum";
		case 38: return "BoundedSum._boundedSum";
		case 39: return "BoundedSum._boundedSum";
		case 40: return "BoundedSum.mySum"; 
		default: return "";
	}
}
