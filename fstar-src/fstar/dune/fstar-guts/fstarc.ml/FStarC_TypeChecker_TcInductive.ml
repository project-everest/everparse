...
let (dbg_Injectivity : Prims.bool FStarC_Effect.ref) =
                         ...
                         let uu___11 =
                           let uu___12 =
                             FStarC_Syntax_Subst.shift_subst
                               (FStarC_List.length tps) usubst in
          ...
          (match uu___1 with
           | (usubst, uvs1) ->
               let uu___2 =
                 ...
                 let uu___5 =
                   let uu___6 =
                     FStarC_Syntax_Subst.shift_subst (FStarC_List.length tps)
                       usubst in
                       ...
                       | (env2, tps, u_tc) ->
                           let uu___4 =
                             ...
                             | FStarC_Syntax_Syntax.Tm_arrow
                                 ...
                                 ->
                                 let uu___6 = FStarC_Util.first_N ntps bs in
                                 (match uu___6 with
                                  | (uu___7, bs') ->
                                      let t4 =
                           ...
                           (match uu___4 with
                            | (arguments, result) ->
                                ((let uu___6 = FStarC_Debug.low () in
                                  if uu___6
                                  then
                                    let uu___7 =
                                      FStarC_Class_Show.show
    ...
    fun tcs ->
      fun datas ->
        ...
        let t =
          ...
          FStarC_Syntax_Util.arrow (FStarC_List.op_At binders binders') uu___ in
        (let uu___1 = FStarC_Effect.op_Bang dbg_GenUniverses in
         if uu___1
         then
        ...
        (let uu___1 =
         ...
         match uu___1 with
         | (uvs, t1) ->
             ((let uu___3 = FStarC_Effect.op_Bang dbg_GenUniverses in
               if uu___3
               then
                 let uu___4 =
                   let uu___5 =
                     FStarC_List.map (fun u -> FStarC_Ident.string_of_id u)
                       uvs in
              ...
              (let uu___3 = FStarC_Syntax_Subst.open_univ_vars uvs t1 in
               ...
               | (uvs1, t2) ->
                   ...
                   (match uu___4 with
                    | (args, uu___5) ->
                        let uu___6 =
                          FStarC_Util.first_N (FStarC_List.length binders)
                            args in
                        (match uu___6 with
                         | (tc_types, data_types) ->
                             let tcs1 =
...
let (is_haseq_lid : FStarC_Ident.lid -> Prims.bool) =
  fun lid ->
    ...
    let len = FStarC_String.length str in
    let haseq_suffix_len = FStarC_String.length haseq_suffix in
    (len > haseq_suffix_len) &&
      (let uu___ =
         let uu___1 =
           FStarC_String.substring str (len - haseq_suffix_len)
             haseq_suffix_len in
         FStarC_String.compare uu___1 haseq_suffix in
      ...
      fun usubst ->
        fun us ->
          ...
          | (lid, bs, t) ->
              ...
              let t1 =
                let uu___1 =
                  FStarC_Syntax_Subst.shift_subst (FStarC_List.length bs1)
                    usubst in
                       ...
                       (fun b ->
                          fun t3 ->
                            ...
                            FStarC_Syntax_Syntax.mk_Tm_app
                              ...
                              FStarC_Range_Type.dummyRange) ibs1 fml1 in
                   let fml3 =
                     FStarC_List.fold_right
                       (fun b ->
                          fun t3 ->
                            ...
                            FStarC_Syntax_Syntax.mk_Tm_app
                              FStarC_Syntax_Util.tforall uu___2
                              FStarC_Range_Type.dummyRange) bs2 fml2 in
      ...
      fun usubst ->
        fun bs ->
          ...
          | FStarC_Syntax_Syntax.Tm_arrow
              ...
              ->
              let dbs1 =
                let uu___2 = FStarC_List.splitAt (FStarC_List.length bs) dbs in
              ...
              FStarC_List.fold_right
                (fun b ->
                   fun t ->
                     ...
                     FStarC_Syntax_Syntax.mk_Tm_app
                       FStarC_Syntax_Util.tforall uu___2
                       FStarC_Range_Type.dummyRange) dbs3 cond
                 ...
                 | (axiom_lid, fml, bs, ibs, haseq_bs) ->
                     ...
                     (match uu___5 with
                      | (l_axioms, env, guard', cond') ->
                          ...
                          ((FStarC_List.op_At l_axioms [(axiom_lid, fml)]),
                            env2, uu___6, uu___7)))
          ...
          fun acc ->
            fun data ->
              ...
              | FStarC_Syntax_Syntax.Tm_arrow
                  ...
                  let dbs1 =
                    let uu___2 =
                      FStarC_List.splitAt (FStarC_List.length bs) dbs in
                    FStar_Pervasives_Native.snd uu___2 in
                  let dbs2 =
                    let uu___2 = FStarC_Syntax_Subst.opening_of_binders bs in
                    FStarC_Syntax_Subst.subst_binders uu___2 dbs1 in
                    ...
                    FStarC_List.fold_right
                      (fun b ->
                         fun t ->
                           ...
                           FStarC_Syntax_Syntax.mk_Tm_app
                             FStarC_Syntax_Util.tforall uu___2
                             FStarC_Range_Type.dummyRange) dbs3 cond in
            ...
            fun ty ->
              ...
              | (lid, bs, t, d_lids) ->
                  ...
                  let t1 =
                    let uu___1 =
                      FStarC_Syntax_Subst.shift_subst
                        (FStarC_List.length bs1) usubst in
                    FStarC_Syntax_Subst.subst uu___1 t in
                  let uu___1 = FStarC_Syntax_Subst.open_term bs1 t1 in
                  (match uu___1 with
                   | (bs2, t2) ->
              ...
              ((let uu___2 =
               ...
               (let univs =
                  ...
                  then []
                    ...
                    (let uu___3 =
                       let uu___4 = FStarC_List.hd tys in
                     ...
                     | (datas1, g2) ->
                         let uu___4 =
                           let tc_universe_vars =
                             FStarC_List.map FStar_Pervasives_Native.snd tcs in
                           let g3 =
                             let uu___5 =
                               let uu___6 =
                    ...
                    fun indices ->
                      fun fields ->
                        fun erasable ->
                          ...
                          let arg_typ =
                            ...
                            let args =
                              FStarC_List.map
                                ...
                                (FStarC_List.op_At tps indices) in
                          ...
                          let ntps = FStarC_List.length tps in
                          let all_params =
                            let uu___ =
                              FStarC_List.map
                                (fun b ->
                            ...
                            FStarC_List.op_At uu___ fields in
                          let imp_binders =
                            FStarC_List.map
                              (fun b ->
                                 let uu___ =
                            ...
                            let uu___ =
                              (fvq <> FStarC_Syntax_Syntax.Data_ctor) ||
                                (FStarC_Syntax_Util.has_attribute attrs
                                   FStarC_Parser_Const.no_auto_projectors_decls_attr) in
                            if uu___
                            then []
                            else
                                 ...
                                 (let body =
                                    ...
                                    then FStarC_Syntax_Util.exp_true_bool
                                      ...
                                      (let arg_pats =
                                       ...
                                       let uu___5 =
                                         ...
                                         FStarC_Syntax_Syntax.Tm_match uu___6 in
                                       FStarC_Syntax_Syntax.mk uu___5 p) in
                                  let imp =
                                  ...
                                  let lb =
                                    ...
                                    let uu___5 =
                                      FStarC_Syntax_Subst.close_univ_vars uvs
                                        imp in
                                    FStarC_Syntax_Util.mk_letbinding uu___4
                                      uvs lbtyp
                          ...
                          let binders =
                            FStarC_List.op_At imp_binders [arg_binder] in
                          let arg =
                            FStarC_Syntax_Util.arg_of_non_null_binder
                              arg_binder in
                          let subst =
                          ...
                          let no_plugin se =
                            ...
                            let uu___ =
                              FStarC_List.filter not_plugin_attr
                          ...
                          FStarC_List.map no_plugin
                            (FStarC_List.op_At discriminator_ses
                               projectors_ses)
