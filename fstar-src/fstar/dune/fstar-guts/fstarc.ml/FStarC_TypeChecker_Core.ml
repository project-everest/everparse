...
let (dbg_Eq : Prims.bool FStarC_Effect.ref) =
  FStarC_Debug.get_toggle "CoreEq"
let (dbg_Top : Prims.bool FStarC_Effect.ref) =
        ...
        fun p1 ->
          fun sub ->
            ...
            | FStarC_Syntax_Syntax.Pat_dot_term eopt ->
                let eopt1 =
                  FStarC_Util.map_option (FStarC_Syntax_Subst.subst sub) eopt in
                (g1,
                  {
                    FStarC_Syntax_Syntax.v =
      ...
      | (p, wopt, e) ->
          ...
          (match uu___1 with
           | (g1, p1, s) ->
               let uu___2 =
                 let uu___3 =
                   FStarC_Util.map_option (FStarC_Syntax_Subst.subst s) wopt in
...
let (report_cache_stats : unit -> cache_stats_t) =
  fun uu___ -> FStarC_Effect.op_Bang cache_stats
...
let fail_str : 'a . Prims.string -> 'a result =
  fun msg ->
    fun ctx ->
      let uu___ = let uu___1 = FStarC_Errors_Msg.mkmsg msg in (ctx, uu___1) in
      Error uu___
let fail : 'a . FStarC_Errors_Msg.error_message -> 'a result =
  fun msg -> fun ctx -> Error (ctx, msg)
let (dump_context : unit result) =
  fun ctx ->
    (let uu___1 = print_context ctx in FStarC_Util.print_string uu___1);
      ...
      let rec aux t1 =
              ...
              (match uu___2 with
               | (g1, x1, c1) ->
                   ...
                   let uu___3 =
                     ...
                     (x1, eff, uu___4) in
                   (fun uu___4 ->
                      Success (uu___3, FStar_Pervasives_Native.None)))
            else
              (let e_tag =
        ...
        | uu___1 ->
            let uu___2 =
              let uu___3 =
                let uu___4 =
                  FStarC_Errors_Msg.text "Expected an arrow, got a" in
                let uu___5 =
                  let uu___6 =
                    let uu___7 =
                  ...
                  let uu___7 =
                    let uu___8 =
                      FStarC_Class_PP.pp FStarC_Syntax_Print.pretty_term t1 in
                    FStarC_Pprint.op_Hat_Slash_Hat FStarC_Pprint.colon uu___8 in
            ...
            let uu___2 =
              FStarC_Class_Show.show
                (FStarC_Class_Show.show_option
                   FStarC_Syntax_Print.showable_bqual) b0 in
            let uu___3 =
              FStarC_Class_Show.show
                (FStarC_Class_Show.show_option
                   FStarC_Syntax_Print.showable_bqual) b1 in
            FStarC_Util.format2 "Binder qualifier mismatch, %s vs %s" uu___2
              uu___3 in
          fail_str uu___1
let (check_aqual :
    ...
    fun a1 ->
      ...
      | uu___ ->
          let uu___1 =
            let uu___2 =
              let uu___3 =
                FStarC_Errors_Msg.text "Unequal arg qualifiers: lhs" in
              let uu___4 =
                let uu___5 =
...
let (weaken_subtyping_guard :
  FStarC_Syntax_Syntax.term -> precondition -> precondition) =
  fun p ->
    fun g -> FStarC_Util.map_opt g (fun q -> FStarC_Syntax_Util.mk_imp p q)
let (strengthen_subtyping_guard :
  ...
  fun p ->
    fun g ->
      let uu___ =
        let uu___1 =
          FStarC_Util.map_opt g (fun q -> FStarC_Syntax_Util.mk_conj p q) in
        FStarC_Util.dflt p uu___1 in
      FStar_Pervasives_Native.Some uu___
let weaken :
  'a .
      ...
      | Success (x, FStar_Pervasives_Native.Some g1) ->
          let uu___1 =
            let uu___2 =
              ...
              FStarC_Util.format1 "Unexpected guard: %s" uu___3 in
            fail_str uu___2 in
          uu___1 ctx
      | err -> err
...
let (is_gtot_comp : FStarC_Syntax_Syntax.comp -> Prims.bool) =
  fun c ->
        ...
        fun t1 ->
                ...
                let uu___ =
                  let uu___1 =
                    let uu___2 =
                      ...
                      FStarC_Pprint.parens uu___3 in
                    let uu___3 =
                ...
                let uu___1 =
                  let uu___2 =
                    ...
                    let uu___4 =
                      ...
                      let uu___6 =
                        let uu___7 =
                          FStarC_Errors_Msg.text "is not a subtype of" in
                        let uu___8 =
                          FStarC_Class_PP.pp FStarC_Syntax_Print.pretty_term
                            t1 in
                        FStarC_Pprint.op_Hat_Slash_Hat uu___7 uu___8 in
          ...
          (let uu___1 = FStarC_Effect.op_Bang dbg in
           ...
           then
             ...
             let uu___5 =
               FStarC_Class_Show.show FStarC_Syntax_Print.showable_term t1 in
             FStarC_Util.print5 "check_relation (%s) %s %s (%s) %s\n" uu___2
               uu___3 (rel_to_string rel) uu___4 uu___5
           else ());
          (fun ctx0 ->
                   ...
                   let uu___3 =
                     ...
                     let head_matches t01 =
                       fun t11 ->
                         ...
                         | uu___5 -> false in
                     let which_side_to_unfold t01 =
                       fun t11 ->
                         maybe_relate_after_unfolding g.tcenv t01 t11 in
                     let maybe_unfold_side side1 =
                       fun t01 ->
                         fun t11 ->
                           FStarC_Profiling.profile
                             (fun uu___4 ->
                               ...
                               let uu___5 =
                                 let uu___6 =
                                   ...
                                   then
                                     let uu___7 =
                                       let uu___8 =
                                         which_side_to_unfold t01 t11 in
                     ...
                     let maybe_unfold_side_and_retry side1 =
                       fun t01 ->
                         fun t11 ->
                           fun ctx01 ->
                             let uu___4 = unfolding_ok ctx01 in
                             ...
                             | Success (x1, g11) ->
                                 let uu___5 =
                                   let uu___6 =
                                     ...
                                     then
                                       let uu___7 =
                                         maybe_unfold_side side1 t01 t11 in
                                       match uu___7 with
                                       | FStar_Pervasives_Native.None ->
                                           fallback t01 t11
                                       | FStar_Pervasives_Native.Some
                                 ...
                                 (match uu___5 with
                                  ...
                                  | err1 -> err1)
                             | Error err1 -> Error err1 in
                     let maybe_unfold_and_retry t01 =
                       fun t11 ->
                               ...
                               (let uu___10 =
                                  let uu___11 =
                                    ...
                                    let uu___13 =
                                      ...
                                      let uu___15 =
                                        let uu___16 =
                                          FStarC_Pprint.doc_of_string "and" in
                                        let uu___17 =
                                          FStarC_Class_PP.pp
                                            FStarC_Ident.pretty_lident
                                            ct1.FStarC_Syntax_Syntax.effect_name in
          ...
          fun ctx ->
            ...
            | Success (res, FStar_Pervasives_Native.Some guard1) ->
                (match g1.guard_handler with
                 | FStar_Pervasives_Native.None ->
                     (insert g1 e1
                        (res, (FStar_Pervasives_Native.Some guard1));
                      r)
                 | FStar_Pervasives_Native.Some gh ->
                     ...
                     then
                       ...
                       (let uu___2 = fail_str "guard handler failed" in
                        uu___2 ctx))
            | uu___ -> r in
      fun ctx ->
    ...
    fun e ->
          ...
          (match uu___ with
           | FStar_Pervasives_Native.None ->
               let uu___1 =
                 ...
                 FStarC_Util.format1 "Variable not found: %s" uu___2 in
               fail_str uu___1
               ...
               let uu___4 =
                 let uu___5 =
                   FStarC_Ident.string_of_lid
                     (f.FStarC_Syntax_Syntax.fv_name).FStarC_Syntax_Syntax.v in
                 FStarC_Util.format1 "Top-level name not found: %s" uu___5 in
               fail_str uu___4
      ...
      | uu___ ->
          let uu___1 =
            ...
            FStarC_Util.format1 "Unexpected term: %s" uu___2 in
          fail_str uu___1
and (check_binders :
  env ->
    FStarC_Syntax_Syntax.binders ->
    ...
    fun p ->
      fun t_sc ->
        ...
        | FStarC_Syntax_Syntax.Pat_cons (fv, usopt, pats) ->
            let us =
              if FStarC_Util.is_none usopt
              then []
              else FStarC_Util.must usopt in
            let uu___ =
              let uu___1 =
            ...
            (match uu___ with
             | (formals, t_pat) ->
                 let uu___1 =
                   let pats1 =
                     FStarC_List.map FStar_Pervasives_Native.fst pats in
                   let uu___2 =
                     let uu___3 =
                   ...
                   FStarC_Util.dflt (pats1, []) uu___2 in
                 (match uu___1 with
                  | (dot_pats, rest_pats) ->
                      let uu___2 =
                        FStarC_List.splitAt (FStarC_List.length dot_pats)
                          formals in
                      (match uu___2 with
        ...
        let err s =
          let uu___ =
            let uu___1 =
              ...
              let uu___3 =
                let uu___4 = FStarC_Errors_Msg.text "Scrutinee type" in
                let uu___5 =
                  let uu___6 =
                    FStarC_Class_PP.pp FStarC_Syntax_Print.pretty_term t_sc in
                  let uu___7 =
                    let uu___8 = FStarC_Errors_Msg.text "and pattern type" in
                    let uu___9 =
                      let uu___10 =
                        FStarC_Class_PP.pp FStarC_Syntax_Print.pretty_term
                          t_pat in
                      let uu___11 =
                        ...
                        let uu___13 =
                          let uu___14 = FStarC_Errors_Msg.text s in [uu___14] in
                        uu___12 :: uu___13 in
                      uu___10 :: uu___11 in
                    uu___8 :: uu___9 in
                  uu___6 :: uu___7 in
                uu___4 :: uu___5 in
              FStarC_Pprint.flow uu___2 uu___3 in
            [uu___1] in
          fail uu___ in
                          ...
                          then
                            ...
                            (match uu___4 with
                             | (eff, t) ->
                                 ...
                                 then
                                   fail_str
                                     "expected total effect, found ghost"
                                 else
                                   (fun uu___7 ->
                                      Success
                                        ((E_Total, t),
          ...
          fun gh ->
            (let uu___1 = FStarC_Effect.op_Bang dbg_Eq in
             ...
             then
               ...
               FStarC_Util.print1 "(%s) Entering core ... \n" uu___2
             else ());
            (let uu___2 =
             ...
             then
               ...
               FStarC_Util.print3 "(%s) Entering core with %s <: %s\n" uu___3
                 uu___4 uu___5
             else ());
            ...
            (let ctx =
             ...
             let res1 =
               ...
               | Success (et, FStar_Pervasives_Native.Some guard0) ->
                   let guard1 =
                     FStarC_TypeChecker_Normalize.normalize simplify_steps g
                       guard0 in
                   ((let uu___5 =
                       ((FStarC_Effect.op_Bang dbg) ||
                          (FStarC_Effect.op_Bang dbg_Top))
                         || (FStarC_Effect.op_Bang dbg_Exit) in
                     if uu___5
                     then
                       ((let uu___7 =
                           let uu___8 = get_goal_ctr () in
                           FStarC_Util.string_of_int uu___8 in
                         let uu___8 =
                           FStarC_Class_Show.show
               ...
               | Success uu___4 ->
                   ((let uu___6 =
                       (FStarC_Effect.op_Bang dbg) ||
                         (FStarC_Effect.op_Bang dbg_Top) in
                     if uu___6
                     then
                       let uu___7 =
                         let uu___8 = get_goal_ctr () in
                         FStarC_Util.string_of_int uu___8 in
                       FStarC_Util.print1 "(%s) Exiting core (ok)\n" uu___7
                     else ());
                    res)
               | Error uu___4 ->
                   ((let uu___6 =
                     ...
                     then
                       let uu___7 =
                         let uu___8 = get_goal_ctr () in
                         FStarC_Util.string_of_int uu___8 in
                       FStarC_Util.print1 "(%s) Exiting core (failed)\n"
                         uu___7
                     else ());
                    res) in
              ...
              then
                (FStarC_Syntax_TermHashTable.print_stats table;
                 (let cs = report_cache_stats () in
                  let uu___7 = FStarC_Util.string_of_int cs.hits in
                  let uu___8 = FStarC_Util.string_of_int cs.misses in
                  FStarC_Util.print2
