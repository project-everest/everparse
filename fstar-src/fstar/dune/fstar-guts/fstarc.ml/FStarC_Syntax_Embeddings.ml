...
let (map_shadow :
  FStarC_Syntax_Embeddings_Base.shadow_term ->
    (FStarC_Syntax_Syntax.term -> FStarC_Syntax_Syntax.term) ->
      FStarC_Syntax_Embeddings_Base.shadow_term)
  = fun s -> fun f -> FStarC_Util.map_opt s (FStarC_Thunk.map f)
let (force_shadow :
  FStarC_Syntax_Embeddings_Base.shadow_term ->
    FStarC_Syntax_Syntax.term FStar_Pervasives_Native.option)
  = fun s -> FStarC_Util.map_opt s FStarC_Thunk.force
...
let unknown_printer :
  ...
  fun typ ->
    fun uu___ ->
      ...
      FStarC_Util.format1 "unknown %s" uu___1
  ...
  fun t ->
    ...
    | uu___1 ->
        let uu___2 =
          ...
          FStarC_Util.format1 "Embeddings not defined for type %s" uu___3 in
        failwith uu___2
let lazy_embed :
  'a .
    'a printer ->
          ...
          fun _norm ->
            (let uu___1 =
             ...
             then
               ...
               FStarC_Util.print1 "Embedding abstract: %s\n" uu___2
             else ());
            t in
    let un t =
      fun _n ->
        (let uu___1 = FStarC_Effect.op_Bang FStarC_Options.debug_embedding in
         ...
         then
           let uu___2 = unknown_printer typ t in
           FStarC_Util.print1 "Unembedding abstract: %s\n" uu___2
         else ());
...
let (e_any :
  ...
  let un t = fun _n -> FStar_Pervasives_Native.Some t in
...
let (e_bool : Prims.bool FStarC_Syntax_Embeddings_Base.embedding) =
  ...
  FStarC_Syntax_Embeddings_Base.mk_emb_full em un
    (fun uu___ -> FStarC_Syntax_Syntax.t_bool) FStarC_Util.string_of_bool
    (fun uu___ ->
       let uu___1 =
...
let (e_int : FStarC_BigInt.t FStarC_Syntax_Embeddings_Base.embedding) =
  ...
  let em i =
    fun rng ->
      fun _shadow ->
        fun _norm ->
          lazy_embed FStarC_BigInt.string_of_big_int (fun uu___ -> emb_t_int)
            rng (fun uu___ -> ty) i
            (fun uu___ ->
        ...
        fun _norm ->
          FStarC_Syntax_Syntax.mk
            (FStarC_Syntax_Syntax.Tm_constant
               (FStarC_Const.Const_string (s, rng))) rng in
  let un t =
    fun _norm ->
      let uu___ =
        let uu___1 = FStarC_Syntax_Subst.compress t in
      ...
      let printer1 uu___ =
        ...
        | (x, y) ->
            ...
            let uu___2 =
              ...
              uu___3 y in
            FStarC_Util.format2 "(%s, %s)" uu___1 uu___2 in
      let em x =
        fun rng ->
          fun shadow ->
            fun norm ->
                   ...
                   let proj i =
                     fun ab ->
                       let proj_1 =
                         ...
                         FStarC_Syntax_Util.mk_field_projector_name uu___1
                           uu___2 i in
                       let proj_1_tm =
                         let uu___1 =
                       ...
                       let uu___2 =
                         ...
                         let uu___4 =
                           ...
                           let uu___6 =
                             let uu___7 = FStarC_Syntax_Syntax.as_arg ab in
                             [uu___7] in
                           uu___5 :: uu___6 in
                         uu___3 :: uu___4 in
                       FStarC_Syntax_Syntax.mk_Tm_app uu___1 uu___2 rng in
            ...
            (fun uu___ ->
               (fun t1 ->
                  ...
                  | (hd, args) ->
                      ...
                      (match uu___1 with
                       | (FStarC_Syntax_Syntax.Tm_fvar fv,
                          uu___2::uu___3::(a1, uu___4)::(b1, uu___5)::[])
                           when
                           FStarC_Syntax_Syntax.fv_eq_lid fv
        ...
        let printer1 uu___ =
          ...
          | (x, y, z) ->
              ...
              let uu___3 =
                ...
                uu___4 z in
              FStarC_Util.format3 "(%s, %s, %s)" uu___1 uu___2 uu___3 in
        let em uu___ =
          fun rng ->
            fun shadow ->
              fun norm ->
                ...
                | (x1, x2, x3) ->
                    lazy_embed printer1 emb_t_pair rng typ (x1, x2, x3)
                      (fun uu___1 ->
                             ...
                             let uu___3 =
                               ...
                               let uu___5 =
                                 ...
                                 let uu___7 =
                                   ...
                                   let uu___9 =
                                     let uu___10 =
                                       FStarC_Syntax_Syntax.as_arg abc in
                                     [uu___10] in
                                   uu___8 :: uu___9 in
                                 uu___6 :: uu___7 in
                               uu___4 :: uu___5 in
                         ...
                         let shadow_a =
                           map_shadow shadow (proj Prims.int_one) in
                         let shadow_b =
              ...
              (fun uu___ ->
                 (fun t1 ->
                    ...
                    | (hd, args) ->
                        ...
                        (match uu___1 with
                         | (FStarC_Syntax_Syntax.Tm_fvar fv,
                            uu___2::uu___3::uu___4::(a1, uu___5)::(b1,
                                                                   uu___6)::
                            (c1, uu___7)::[]) when
                             FStarC_Syntax_Syntax.fv_eq_lid fv
          ...
          let printer1 uu___ =
            ...
            | (x, y, z, w) ->
                ...
                let uu___4 =
                  ...
                  uu___5 w in
                FStarC_Util.format4 "(%s, %s, %s, %s)" uu___1 uu___2 uu___3
                  uu___4 in
          let em uu___ =
            fun rng ->
              fun shadow ->
            ...
            let printer1 uu___ =
              ...
              | (x, y, z, w, v) ->
                  ...
                  let uu___5 =
                    ...
                    uu___6 v in
                  FStarC_Util.format5 "(%s, %s, %s, %s, %s)" uu___1 uu___2
              ...
              fun rng ->
                fun shadow ->
                  fun norm ->
                    match uu___ with
                    | (x1, x2, x3, x4, x5) ->
                        lazy_embed printer1 emb_t_pair rng typ
                          (x1, x2, x3, x4, x5)
                          (fun uu___1 ->
                             let proj i =
                               fun abcde ->
                   ...
                   (match uu___1 with
                    ...
                    | (FStarC_Syntax_Syntax.Tm_fvar fv,
                       uu___2::uu___3::(b1, uu___4)::[]) when
                        ...
                        ->
                        let uu___5 =
                          FStarC_Syntax_Embeddings_Base.try_unembed eb b1
                            norm in
                        FStarC_Util.bind_opt uu___5
                          (fun b2 ->
                             FStar_Pervasives_Native.Some
                     ...
                     let uu___1 =
                       let uu___2 =
                         let uu___3 =
                           let uu___4 =
                             let uu___5 =
                               FStarC_Syntax_Embeddings_Base.embed ea hd in
               ...
               | FStarC_NormSteps.UnfoldOnly l ->
                   let uu___1 =
                     let uu___2 =
                       let uu___3 =
                         let uu___4 =
                           FStarC_Syntax_Embeddings_Base.embed e_string_list
                             l in
               ...
               | FStarC_NormSteps.UnfoldFully l ->
                   let uu___1 =
                     let uu___2 =
                       ...
                       FStarC_Syntax_Syntax.as_arg uu___3 in
                     [uu___2] in
                   FStarC_Syntax_Syntax.mk_Tm_app steps_UnfoldFully uu___1
                     rng
               ...
               | FStarC_NormSteps.UnfoldNamespace l ->
                   let uu___1 =
                     let uu___2 =
                       ...
                       FStarC_Syntax_Syntax.as_arg uu___3 in
                     [uu___2] in
                   FStarC_Syntax_Syntax.mk_Tm_app steps_UnfoldNamespace
                     uu___1 rng) in
  let un t =
    fun norm ->
           ...
           | (hd, args) ->
               ...
               (match uu___1 with
                ...
                | (FStarC_Syntax_Syntax.Tm_fvar fv, (l, uu___2)::[]) when
                    ...
                    ->
                    let uu___3 =
                      FStarC_Syntax_Embeddings_Base.try_unembed e_string_list
                        l norm in
                    FStarC_Util.bind_opt uu___3
                      (fun ss ->
                         FStar_Pervasives_Native.Some
    ...
    fun rng ->
      fun _shadow ->
        fun norm ->
          let uu___ =
            FStarC_Syntax_Syntax.tdataconstr
              FStarC_Parser_Const.mkvconfig_lid in
          let uu___1 =
            let uu___2 =
              let uu___3 =
                let uu___4 =
                            ...
                            let uu___19 =
                              let uu___20 =
                                let uu___21 =
                                  let uu___22 =
                                    FStarC_Syntax_Embeddings_Base.embed
                                      e_bool vcfg.FStarC_VConfig.quake_keep in
                                  uu___22 rng FStar_Pervasives_Native.None
                                    norm in
                              ...
                              let uu___21 =
                                let uu___22 =
                                  let uu___23 =
                                    let uu___24 =
                                      FStarC_Syntax_Embeddings_Base.embed
                                        e_bool vcfg.FStarC_VConfig.retry in
                                    uu___24 rng FStar_Pervasives_Native.None
                                      norm in
          ...
          (match uu___1 with
           | (FStarC_Syntax_Syntax.Tm_fvar fv,
              (initial_fuel, uu___2)::(max_fuel, uu___3)::(initial_ifuel,
                                                           uu___4)::(max_ifuel,
                                                                    uu___5)::
              (detail_errors, uu___6)::(detail_hint_replay, uu___7)::
              ...
              (z3version, uu___27)::(trivial_pre_for_unannotated_effectful_fns,
               ...
               FStarC_Util.bind_opt uu___30
                 (fun initial_fuel1 ->
                    let uu___31 =
                      FStarC_Syntax_Embeddings_Base.try_unembed e_fsint
                        max_fuel norm in
                    FStarC_Util.bind_opt uu___31
                      (fun max_fuel1 ->
                         let uu___32 =
                           FStarC_Syntax_Embeddings_Base.try_unembed e_fsint
                             initial_ifuel norm in
                         FStarC_Util.bind_opt uu___32
                           (fun initial_ifuel1 ->
                              let uu___33 =
                                FStarC_Syntax_Embeddings_Base.try_unembed
                                  e_fsint max_ifuel norm in
                              FStarC_Util.bind_opt uu___33
                                (fun max_ifuel1 ->
                                   let uu___34 =
                                     FStarC_Syntax_Embeddings_Base.try_unembed
                                       e_bool detail_errors norm in
                                   FStarC_Util.bind_opt uu___34
                                     (fun detail_errors1 ->
                                        let uu___35 =
                                          FStarC_Syntax_Embeddings_Base.try_unembed
                                            e_bool detail_hint_replay norm in
                                        FStarC_Util.bind_opt uu___35
                                          (fun detail_hint_replay1 ->
                                             let uu___36 =
                                               FStarC_Syntax_Embeddings_Base.try_unembed
                                                 e_bool no_smt norm in
                                             FStarC_Util.bind_opt uu___36
                                               (fun no_smt1 ->
                                                  let uu___37 =
                                                    FStarC_Syntax_Embeddings_Base.try_unembed
      ...
      fun shadow ->
        fun cb ->
            ...
            | FStarC_Order.Gt -> ord_Gt in
          {
            ...
            FStarC_Syntax_Syntax.hash_code =
              (r.FStarC_Syntax_Syntax.hash_code)
          } in
  let unembed_order t =
    fun cb ->
               ...
               let f_wrapped a1 =
                 (let uu___1 =
                  ...
                  then
                    let uu___2 =
                      FStarC_Class_Show.show
                        FStarC_Syntax_Print.showable_term f1 in
                ...
                (fun t ->
                   let unseal =
                     FStarC_Syntax_Util.fvar_const
                       FStarC_Parser_Const.unseal_lid in
                   let uu___ =
                        ...
                        (Obj.repr
                           (let uu___4 =
                            ...
                            FStarC_Class_Monad.fmap
                              FStarC_Class_Monad.monad_option () ()
                              (fun uu___5 ->
                                 (Obj.magic FStarC_Sealed.seal) uu___5)
                              (Obj.magic uu___4)))
                  | uu___2 ->
                      Obj.magic (Obj.repr FStar_Pervasives_Native.None)))
          uu___1 uu___ in
...
let (e___range :
  FStarC_Range_Type.range FStarC_Syntax_Embeddings_Base.embedding) =
  let em r =
    fun rng ->
      fun _shadow ->
        fun _norm ->
                          ...
                          let uu___4 =
                            FStarC_Thunk.mk
                              (fun uu___5 ->
                                 let uu___6 =
                                   norm (FStar_Pervasives.Inl fv_lid) in
                                 FStarC_Syntax_Syntax.mk_Tm_app uu___6 args
                                   rng) in
                          FStar_Pervasives_Native.Some uu___4 in
                        let uu___4 =
                          let uu___5 =
                            FStarC_Syntax_Embeddings_Base.try_unembed ea x
                              norm in
                          FStarC_Util.bind_opt uu___5
                            (fun x1 ->
                               let uu___6 =
                                 FStarC_Syntax_Embeddings_Base.try_unembed eb
                                   y norm in
...
let debug_wrap : 'a . Prims.string -> (unit -> 'a) -> 'a =
  fun s ->
    fun f ->
      (let uu___1 = FStarC_Effect.op_Bang FStarC_Options.debug_embedding in
       if uu___1 then FStarC_Util.print1 "++++starting %s\n" s else ());
      (let res = f () in
       (let uu___2 = FStarC_Effect.op_Bang FStarC_Options.debug_embedding in
        if uu___2 then FStarC_Util.print1 "------ending %s\n" s else ());
       res)
