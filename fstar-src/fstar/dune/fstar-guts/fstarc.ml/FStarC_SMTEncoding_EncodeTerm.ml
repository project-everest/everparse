...
let raise_arity_mismatch :
  'a .
    Prims.string -> Prims.int -> Prims.int -> FStarC_Range_Type.range -> 'a
  =
  fun head ->
    fun arity ->
      fun n_args ->
            ...
            (match uu___ with
             ...
             | FStar_Pervasives_Native.Some
                 ...
                 FStarC_Errors.log_issue FStarC_Class_HasRange.hasRange_range
                   ...
                   (Obj.magic uu___4))
type label =
  (FStarC_SMTEncoding_Term.fv * Prims.string * FStarC_Range_Type.range)
               ...
               let uu___1 =
                 let uu___2 =
                   FStarC_Class_Show.show FStarC_Syntax_Print.showable_const
                     c1 in
                 FStarC_Util.format1 "Unhandled constant: %s" uu___2 in
               failwith uu___1)
and (encode_binders :
      ...
      fun env ->
        (let uu___1 = FStarC_Debug.medium () in
         ...
         then
           ...
           FStarC_Util.print1 "Encoding binders %s\n" uu___2
         else ());
        (let uu___1 =
           FStarC_List.fold_left
             (fun uu___2 ->
    ...
    fun head ->
      fun args_e ->
        ...
        | (tm_sz, uu___1) ->
            ...
            let sz_key =
              FStarC_Util.format1 "BitVector_%s" (Prims.string_of_int sz) in
            let sz_decls =
            ...
            let uu___3 =
              ...
              | (FStarC_Syntax_Syntax.Tm_fvar fv,
                 uu___4::(sz_arg, uu___5)::uu___6::[]) when
                  ...
                  ->
                  let uu___7 =
                    let uu___8 = FStarC_List.tail args_e in
                    FStarC_List.tail uu___8 in
                  let uu___8 =
                      ...
                      let uu___4 =
                        let uu___5 =
                          FStarC_SMTEncoding_Term.mk_decls "" tkey_hash 
                            [ax] (FStarC_List.op_At decls decls') in
                        FStarC_List.op_At decls' uu___5 in
       ...
       (match t1.FStarC_Syntax_Syntax.n with
        | FStarC_Syntax_Syntax.Tm_delayed uu___2 ->
            let uu___3 =
              ...
              let uu___6 =
                FStarC_Class_Show.show FStarC_Syntax_Print.showable_term t1 in
              FStarC_Util.format3 "(%s) Impossible: %s\n%s\n" uu___4 uu___5
                uu___6 in
            failwith uu___3
        ...
        | FStarC_Syntax_Syntax.Tm_lazy i ->
            ...
            ((let uu___3 = FStarC_Effect.op_Bang dbg_SMTEncoding in
              ...
              then
                ...
                FStarC_Util.print2 ">> Unfolded (%s) ~> (%s)\n" uu___4 uu___5
              else ());
             encode_term e env)
        | FStarC_Syntax_Syntax.Tm_bvar x ->
            let uu___2 =
              let uu___3 =
                FStarC_Class_Show.show FStarC_Syntax_Print.showable_bv x in
              FStarC_Util.format1 "Impossible: locally nameless; got %s"
                uu___3 in
            failwith uu___2
        ...
        | FStarC_Syntax_Syntax.Tm_quoted (qt, uu___2) ->
            ...
            ((let uu___4 = FStarC_Effect.op_Bang dbg_SMTEncoding in
              ...
              then
                ...
                FStarC_Util.print2 ">> Inspected (%s) ~> (%s)\n" uu___5
                  uu___6
              else ());
             (let t2 =
                let uu___4 =
                                           ...
                                           let uu___10 =
                                             let uu___11 =
                                               FStarC_TypeChecker_Normalize.term_to_string
                                                 env.FStarC_SMTEncoding_Env.tcenv
                                                 t0 in
                                             FStarC_Util.replace_char uu___11
                                               10 32 in
                                           FStar_Pervasives_Native.Some
                                             uu___10
                   ...
                   let uu___4 =
                     let uu___5 =
                       let uu___6 =
                         ...
                         FStarC_Util.format1 "uvar_typing_%s" uu___7 in
              ...
              FStarC_List.map
                (fun lb ->
                   ...
                   | { FStarC_Syntax_Syntax.lbname = lbname;
                       ...
                       let x = FStarC_Util.left lbname in
                       let uu___11 =
              ...
              | (ee1, decls1) ->
                  ...
                  (match uu___1 with
                   | (xs, e21) ->
                       ...
                       (match uu___2 with
                        | (ee2, decls2) ->
                            (ee2, (FStarC_List.op_At decls1 decls2))))
and (encode_match :
  FStarC_Syntax_Syntax.term ->
    ...
    fun pat ->
      (let uu___1 = FStarC_Debug.medium () in
       ...
       then
         ...
         FStarC_Util.print1 "Encoding pattern %s\n" uu___2
       else ());
