...
let (find_name : env -> Prims.string -> name) =
  fun env1 ->
    fun x ->
      let uu___ =
        FStarC_List.tryFind (fun name1 -> name1.pretty = x) env1.names in
      match uu___ with
...
and (translate_binders :
  ...
  = fun env1 -> fun bs -> FStarC_List.map (translate_binder env1) bs
...
and (translate_branches :
  ...
  =
  fun env1 ->
    fun branches1 -> FStarC_List.map (translate_branch env1) branches1
                     ...
                     try
                       (fun uu___8 ->
                          ...
                          | () ->
                              ...
                              FStar_Pervasives_Native.Some
                                (DFunction
                                   (cc1, meta1, (FStarC_List.length tvars),
              ...
              (let meta1 = translate_flags meta in
               ...
               | uu___4 ->
                   ((let uu___6 =
                    ...
                    FStar_Pervasives_Native.Some
                      (DGlobal
                         (meta1, name2, (FStarC_List.length tvars), t1, EAny))))
        | { FStarC_Extraction_ML_Syntax.mllb_name = name1;
...
let (translate_let :
  ...
  fun env1 ->
    fun flavor ->
      fun lb ->
        let uu___ = FStarC_Effect.op_Bang ref_translate_let in
