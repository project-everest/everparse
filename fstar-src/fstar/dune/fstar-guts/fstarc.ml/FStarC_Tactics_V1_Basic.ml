             ...
             (fun b ->
                ...
                then
                  ...
                  (let uu___4 =
                     ...
                     FStarC_Util.format3 "%s does not solve %s : %s" uu___5
                       uu___6 uu___7 in
             ...
             (fun g ->
                (let uu___4 = FStarC_Tactics_Types.goal_type g in
                 let uu___5 =
                   ...
                   FStarC_Util.format1 "Tactics admitted goal <%s>\n\n"
                     uu___6 in
                 FStarC_Errors.log_issue
        ...
        (fun ps ->
           FStarC_Tactics_Monad.mlog
             (fun uu___1 ->
                ...
                FStarC_Util.print2 "Tac> __tc_lax(%s)(Context:%s)\n" uu___2
                  uu___3)
             (fun uu___1 ->
                let e1 =
                  {
  ...
  fun e ->
    fun t ->
      let uu___ =
        ...
        uu___2 uu___1
          (fun c ->
             let uu___3 = FStarC_Syntax_Util.comp_result c in ret uu___3) in
                 ...
                 (FStarC_Class_Monad.op_let_Bang
                    ...
                    (fun uu___ ->
                       (fun uu___ ->
                          ...
                          then
                            let s =
                              FStarC_Util.run_process "tactic_launch" prog
                                args (FStar_Pervasives_Native.Some input) in
                            Obj.magic (ret s)
                          else
                            Obj.magic
                              (FStarC_Tactics_Monad.fail
