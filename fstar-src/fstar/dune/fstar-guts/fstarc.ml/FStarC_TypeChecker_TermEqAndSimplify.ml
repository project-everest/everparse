      ...
      fun t2 ->
                ...
                f2) when
                 (FStarC_Syntax_Syntax.fv_eq f1 f2) &&
                   (let uu___1 =
                    ...
                    FStarC_List.mem uu___1 injectives)
        ...
        | (FStarC_Syntax_Syntax.Tm_match
           ...
           { FStarC_Syntax_Syntax.scrutinee = t23;
            ...
            then
              let uu___4 = FStarC_List.zip bs1 bs2 in
                 ...
                 (let uu___12 =
                  ...
                  then
                    ...
                    (let uu___14 =
                     ...
                     if uu___14
                     then
                       let uu___15 = FStarC_List.map simplify1 args in
                       match uu___15 with
                       ...
                       (let uu___16 =
                        ...
                        if uu___16
                        then
                          let uu___17 = FStarC_List.map simplify1 args in
                          match uu___17 with
                          ...
                          (let uu___18 =
                           ...
                           if uu___18
                           then
                             let uu___19 = FStarC_List.map simplify1 args in
                             match uu___19 with
