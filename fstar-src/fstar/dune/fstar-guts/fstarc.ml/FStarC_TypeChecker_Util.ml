...
let (dbg_bind : Prims.bool FStarC_Effect.ref) =
        ...
        FStarC_Syntax_Syntax.typ ->
          Prims.bool ->
            (FStarC_Syntax_Syntax.term * (FStarC_Syntax_Syntax.ctx_uvar *
              FStarC_Range_Type.range) * FStarC_TypeChecker_Env.guard_t))
  =
  fun reason ->
    fun r ->
      fun env ->
          ...
          then
            ...
            | (solve_now, defer) ->
                ((let uu___3 = FStarC_Effect.op_Bang dbg_Rel in
                  if uu___3
                  then
                    (FStarC_Util.print_string "SOLVE BEFORE CLOSING:\n";
                     FStarC_List.iter
                       (fun uu___6 ->
                          match uu___6 with
                          | (uu___7, s, p) ->
                       ...
                       solve_now;
                     FStarC_Util.print_string " ...DEFERRED THE REST:\n";
                     FStarC_List.iter
                       (fun uu___8 ->
                          match uu___8 with
                          | (uu___9, s, p) ->
...
let (check_uvars :
  FStarC_Range_Type.range -> FStarC_Syntax_Syntax.typ -> unit) =
  fun r ->
    fun t ->
                ...
                (let env1 =
                 ...
                 let reconcile_let_rec_ascription_and_body_type tarr =
                   fun lbtyp_opt ->
                     ...
                     let fallback uu___6 =
                       let uu___7 =
                         FStarC_Syntax_Util.arrow_formals_comp tarr in
                       match uu___7 with
                       | (bs, c) ->
                           ...
                           (match uu___8 with
                            | FStar_Pervasives_Native.Some
                                ...
                                ->
                                let c1 =
                                  FStarC_TypeChecker_Env.comp_set_flags env1
                                    c (FStarC_List.op_At pfx sfx) in
...
let (effect_args_from_repr :
  FStarC_Syntax_Syntax.term ->
    Prims.bool ->
      FStarC_Range_Type.range -> FStarC_Syntax_Syntax.term Prims.list)
  =
  fun repr ->
    fun is_layered ->
      fun r ->
  ...
  FStarC_TypeChecker_Env.env ->
    FStarC_Syntax_Syntax.eff_decl ->
      FStarC_Syntax_Syntax.universe ->
        FStarC_Syntax_Syntax.typ ->
          FStarC_Syntax_Syntax.term ->
            FStarC_Range_Type.range -> FStarC_Syntax_Syntax.comp)
  =
  fun env ->
    fun ed ->
      fun u_a ->
            ...
            fun r ->
              ...
              (let uu___1 = FStarC_Effect.op_Bang dbg_Return in
               ...
               then
                 ...
                 FStarC_Util.print3 "(%s) returning %s at comp type %s\n"
                     ...
                     let uu___2 =
                       ...
                       then lift_comp env2 c21 lift2
                         ...
                         (let x_a =
                            ...
                            | FStar_Pervasives_Native.None ->
                                let uu___4 =
                                  FStarC_Syntax_Util.comp_result c12 in
                   ...
                   fun res_t ->
                     fun bvs1 ->
                       fun wp0 ->
                         let close =
                           let uu___5 =
                             FStarC_Syntax_Util.get_wp_close_combinator md in
                              ...
                              fun wp ->
                                  ...
                                  let uu___5 =
                                    let uu___6 =
                                      env.FStarC_TypeChecker_Env.universe_of
                                        env_bvs x.FStarC_Syntax_Syntax.sort in
                                    [uu___6] in
                                  u_res :: uu___5 in
                                let wp1 =
                                  let uu___5 =
                                ...
                                let uu___6 =
                                  ...
                                  let uu___8 =
                                    ...
                                    let uu___10 =
                                      let uu___11 =
                                        FStarC_Syntax_Syntax.as_arg wp1 in
                                      [uu___11] in
                                    uu___9 :: uu___10 in
                                  uu___7 :: uu___8 in
            ...
            fun num_effect_params ->
              fun r ->
                ...
                | (close_bs1, subst) ->
                    let uu___1 =
                      let uu___2 =
                        FStarC_List.splitAt num_effect_params close_bs1 in
                      match uu___2 with
                      | (eff_params_bs, close_bs2) ->
                          let uu___3 =
                            FStarC_List.splitAt num_effect_params ct_args in
                          (match uu___3 with
                    ...
                    (match uu___1 with
                     | (close_bs2, subst1, ct_args1) ->
                         let uu___2 =
                           FStarC_List.splitAt
                             ((FStarC_List.length close_bs2) - Prims.int_one)
                             close_bs2 in
                         (match uu___2 with
                          | (close_bs3, uu___3) ->
                                     ...
                                     fun uu___4 ->
                                       ...
                                       | (ct_arg, uu___5) ->
                                           let uu___6 =
                                             ...
                                             [uu___7] in
                                           FStarC_List.op_At ss uu___6)
                                subst1 close_bs3 ct_args1))
                        ...
                        fun has_range_binders ->
                          ...
                          let bind_name uu___ =
                            ...
                            then
                              ...
                              FStarC_Util.format3 "(%s, %s) |> %s" uu___1
                                uu___2 uu___3
                            else "" in
                          let uu___ =
                            let uu___1 = bs in
                            ...
                            | a_b::b_b::bs1 ->
                                let uu___2 =
                                  let uu___3 =
                                    FStarC_List.splitAt (Prims.of_int (2))
                                      binder_kinds in
                               ...
                               | (bs2, binder_kinds2, subst1, guard, args1,
                                  args2) ->
                                   let uu___2 =
                                     ...
                                     let uu___3 =
                                       FStarC_List.splitAt m_num_effect_args
                                         bs2 in
                                     match uu___3 with
                                     | (f_bs, bs3) ->
                                         let f_subst =
                                         ...
                                         (bs3, uu___4,
                                           (FStarC_List.op_At subst1 f_subst)) in
                                   (match uu___2 with
                                    | (bs3, binder_kinds3, subst2) ->
                                        let uu___3 =
                                          let n_num_effect_args =
                                            FStarC_List.length args2 in
                                          let uu___4 =
                                            FStarC_List.splitAt
                          ...
                          let uu___3 =
                            let uu___4 =
                              FStarC_Ident.ident_of_lid
                                p_ed.FStarC_Syntax_Syntax.mname in
                            FStarC_Ident.string_of_id uu___4 in
                          FStarC_Util.format3 "(%s, %s) |> %s" uu___1 uu___2
                            uu___3
                        else "" in
                      let bind_t_shape_error r =
                        fun s ->
                          let uu___ =
                        ...
                        then
                          ...
                          | a_b::b_b::bs1 ->
                              let uu___2 =
                                let uu___3 =
                                  FStarC_List.splitAt
                                    (((FStarC_List.length bs1) -
                                        (Prims.of_int (2)))
                                       - num_range_binders) bs1 in
                                match uu___3 with
                                | (l1, l2) ->
                                    let uu___4 =
                                      FStarC_List.splitAt num_range_binders
                                        l2 in
                                    (match uu___4 with
                                     | (uu___5, l21) ->
                                 ...
                                 let uu___6 =
                                   let uu___7 =
                                     FStarC_Ident.string_of_lid
                                       ed.FStarC_Syntax_Syntax.mname in
                                   FStarC_Util.format1 "%s.return" uu___7 in
                                 let uu___7 =
                                   FStarC_Range_Ops.string_of_range r in
                                 FStarC_Util.format3
                                   "implicit var for binder %s of %s at %s"
                             ...
                             (if debug
                              then
                                (let uu___6 =
                                 ...
                                 FStarC_Util.print1 "} c after return %s\n"
                                   uu___6)
                              else ();
                              (c, g_uvars)))))
let (mk_indexed_bind :
                ...
                let debug f =
                  let uu___1 =
                    (FStarC_Debug.extreme ()) ||
                      (FStarC_Effect.op_Bang dbg_bind) in
                                     ...
                                     | FStar_Pervasives.Inr reason ->
                                         (debug
                                          ...
                                          (let mk_bind1 c11 =
                                           ...
                                           | (u_res_t1, res_t1) ->
                                               let uu___11 =
                                                 (FStarC_Option.isSome b) &&
                                                   (should_return env e1opt
                                                      lc11) in
                                               if uu___11
                                               then
                                                 let e1 =
                                                   FStarC_Option.get e1opt in
                                                 let x = FStarC_Option.get b in
                                                 let uu___12 =
                           ...
                           ((FStarC_Ident.lid_equals eff2
                              ...
                              (let uu___3 =
                                 FStarC_TypeChecker_Env.join_opt env eff1
                                   eff2 in
                               FStarC_Util.is_none uu___3))
                             &&
                             (let uu___3 =
                                FStarC_TypeChecker_Env.exists_polymonadic_bind
                                  env eff1 eff2 in
                              FStarC_Util.is_none uu___3) in
                         if uu___2
                         then
                         ...
                         | (bs2, subst1, guard, args1, args2) ->
                             let uu___2 =
                               let m_num_effect_args =
                                 FStarC_List.length args1 in
                               let uu___3 =
                                 FStarC_List.splitAt m_num_effect_args bs2 in
                               match uu___3 with
                               | (f_bs, bs3) ->
                                   let f_subst =
                                     FStarC_List.map2
                                  ...
                                  let uu___3 =
                                    ...
                                    then
                                      let n_num_effect_args =
                                        FStarC_List.length args2 in
                                      let uu___4 =
                                        FStarC_List.splitAt n_num_effect_args
                                          bs3 in
                                      match uu___4 with
                                      | (g_bs, bs4) ->
                                          let g_subst =
                                                   ...
                                                   | (arg, uu___6) ->
                                                       FStarC_Syntax_Syntax.NT
                                                         ((g_b.FStarC_Syntax_Syntax.binder_bv),
                                                           arg)) g_bs args2 in
                                          (bs4,
                                            (FStarC_List.op_At subst2 g_subst),
                                            guard)
                                    else
                                      if
                ...
                let conjunction_name uu___ =
                  ...
                  then
                    let uu___1 =
                      FStarC_Ident.string_of_lid
                        ct_then.FStarC_Syntax_Syntax.effect_name in
                    FStarC_Util.format1 "%s.conjunction" uu___1
                  else "" in
                let conjunction_t_error r1 =
                  fun s ->
                    let uu___ =
                      let uu___1 =
                ...
                let uu___ =
                  ...
                  then
                    ...
                    | a_b::bs1 ->
                        let uu___2 =
                          FStarC_List.splitAt
                            ((FStarC_List.length bs1) - (Prims.of_int (3)))
                            bs1 in
                        (match uu___2 with
                         | (rest_bs, f_b::g_b::p_b::[]) ->
                     ...
                     | (rest_bs_uvars, g_uvars) ->
                         let substs =
                           FStarC_List.map2
                             ...
                             (a_b :: (FStarC_List.op_At rest_bs [p_b])) (a ::
                ...
                fun r ->
                  ...
                  let uu___ =
                    ...
                    | (ts, kopt) ->
                        ...
                        (match uu___2 with
                         | (uu___3, conjunction) ->
                             let uu___4 = FStarC_Util.must kopt in
...
let (get_neg_branch_conds :
  ...
  fun branch_conds ->
    let uu___ =
      ...
      FStarC_List.splitAt ((FStarC_List.length uu___1) - Prims.int_one)
        uu___1 in
    match uu___ with
          ...
          | (should_not_inline_whole_match, bind_cases_flags) ->
              let bind_cases1 uu___1 =
                ...
                then
                  ...
                  (let maybe_return eff_label_then =
                     fun cthen ->
                       let uu___4 =
                         ...
                         | uu___6 ->
                             let uu___7 =
                               let uu___8 =
                                 let uu___9 =
                                   FStarC_List.splitAt
                                     ((FStarC_List.length lcases) -
                                        Prims.int_one) neg_branch_conds in
                                 match uu___9 with
                                 | (l1, l2) ->
                                     let uu___10 = FStarC_List.hd l2 in
                                     (l1, uu___10) in
                               match uu___8 with
                            ...
                            (match uu___6 with
                             | (comp1, g_comp1) ->
                                 (match lcases with
                                  ...
                                  | uu___7 ->
                                      let uu___8 =
                                        let uu___9 = FStarC_Util.must md in
                ...
                | FStar_Pervasives_Native.Some uu___1 ->
                    ((let uu___3 = FStarC_Effect.op_Bang dbg_Coercions in
                      ...
                      then
                        ...
                        FStarC_Util.print1 "Coercing with %s!\n" uu___4
                      else ());
...
let rec first_opt :
  ...
  fun f ->
    fun xs ->
      ...
      | x::xs1 ->
          let uu___ = f x in
          FStarC_Util.catch_opt uu___ (fun uu___1 -> first_opt f xs1)
let op_let_Question :
  'uuuuu 'uuuuu1 .
    unit ->
  ...
  = fun uu___ -> FStarC_Util.bind_opt
              ...
              | FStar_Pervasives_Native.Some (coerced, lc1, g) ->
                  ((let uu___4 = FStarC_Effect.op_Bang dbg_Coercions in
                    ...
                    then
                      ...
                      FStarC_Util.print3 "(%s) COERCING %s to %s\n" uu___5
                        uu___6 uu___7
                    else ());
                   (coerced, lc1, g))
              | FStar_Pervasives_Native.None ->
                  ((let uu___4 = FStarC_Effect.op_Bang dbg_Coercions in
                    ...
                    then
                      let uu___5 =
                        FStarC_Range_Ops.string_of_range
                          e.FStarC_Syntax_Syntax.pos in
                      FStarC_Util.print1 "(%s) No user coercion found\n"
                        uu___5
                    else ());
                   (let strip_hide_or_reveal e1 =
                      fun hide_or_reveal ->
                        let uu___4 =
                             ...
                             (match uu___6 with
                              | (e_hide, lc1) ->
                                  let e_hide1 =
                                    ...
                                    FStarC_Util.dflt e_hide uu___7 in
                                  (e_hide1, lc1, g1)))
                    | (Yes ty, No) ->
                        let u = env.FStarC_TypeChecker_Env.universe_of env ty in
                        let uu___5 =
                        ...
                        (match uu___5 with
                         | (e_reveal, lc1) ->
                             let e_reveal1 =
                               ...
                               FStarC_Util.dflt e_reveal uu___6 in
                             (e_reveal1, lc1,
                               FStarC_TypeChecker_Env.trivial_guard))
        ...
        (let t' =
         ...
         (let uu___2 = FStarC_Effect.op_Bang dbg_SMTEncodingReify in
          ...
          then
            ...
            let uu___4 =
              FStarC_Class_Show.show FStarC_Syntax_Print.showable_term t' in
            FStarC_Util.print2 "Reified body %s \nto %s\n" uu___3 uu___4
          else ());
         t')
      ...
      fun t ->
        ...
        then
          ...
          ((let uu___2 = FStarC_Debug.high () in
           ...
           (let unfolded_arrow_formals env1 =
              fun t1 ->
                let rec aux env2 =
                  fun bs ->
                    fun t2 ->
                      let t3 =
                        FStarC_TypeChecker_Normalize.unfold_whnf env2 t2 in
            ...
            | (e1, lc1, g_c) ->
                ...
                ((let uu___2 = FStarC_Effect.op_Bang dbg_Rel in
                  ...
                  then
                    ...
                    FStarC_Util.print1 "Applied guard is %s\n" uu___3
                  else ());
          ...
          (fun uu___ ->
             (let uu___2 = FStarC_Debug.medium () in
              ...
              then
                ...
                FStarC_Util.print1 "check_top_level, lc = %s\n" uu___3
              else ());
             (let discharge g1 =
                    ...
                    (let c1 =
                     ...
                     then
                       ...
                       (let steps =
                        ...
                        | (ct, vc, g_pre) ->
                            ((let uu___9 =
                                FStarC_Effect.op_Bang dbg_Simplification in
                              if uu___9
                              then
                                let uu___10 =
                                  FStarC_Class_Show.show
                                    FStarC_Syntax_Print.showable_term vc in
                                FStarC_Util.print1 "top-level VC: %s\n"
                                  uu___10
                              else ());
                             (let uu___9 =
                                let uu___10 =
    ...
    fun t ->
      ...
      and aux env =
        fun t1 ->
          ...
          let res =
            (FStarC_TypeChecker_Env.non_informative env t2) ||
              (descend env t2) in
...
let (check_non_informative_type_for_lift :
  FStarC_TypeChecker_Env.env ->
    FStarC_Ident.lident ->
      FStarC_Ident.lident ->
        FStarC_Syntax_Syntax.term -> FStarC_Range_Type.range -> unit)
  =
  fun env ->
    fun m1 ->
      fun m2 ->
                ...
                (match uu___1 with
                 | (bs2, subst1) ->
                     let bs3 =
                       let uu___2 =
                         FStarC_List.splitAt
                           ((FStarC_List.length bs2) - Prims.int_one) bs2 in
                       FStar_Pervasives_Native.fst uu___2 in
                     FStarC_List.fold_left
                       (fun uu___2 ->
                          fun b ->
        ...
        fun lift_name ->
          fun r ->
            ...
            let lift_t_shape_error s =
              FStarC_Util.format2 "Lift %s has unexpected shape, reason: %s"
                lift_name s in
            let uu___ =
          ...
          fun c ->
            ...
            then
              (let uu___1 =
               ...
               FStarC_Util.print2 "Lifting indexed comp %s to  %s {\n" uu___1
                 uu___2)
            else ();
            (let r = FStarC_TypeChecker_Env.get_range env in
             ...
             (let lift_name uu___2 =
                ...
                then
                  ...
                  FStarC_Util.format2 "%s ~> %s" uu___3 uu___4
                else "" in
              let uu___2 =
                let uu___3 =
                  let uu___4 =
                    FStarC_List.hd ct.FStarC_Syntax_Syntax.comp_univs in
                  [uu___4] in
                        ...
                        | (substs, g) ->
                            ...
                            ((let uu___7 =
                              ...
                              then
                                ...
                                FStarC_Util.print1 "Guard for lift is: %s"
                                  uu___8
                              else ());
                             (let c1 =
                                let uu___7 =
                              ...
                              then
                                (let uu___8 =
                                 ...
                                 FStarC_Util.print1 "} Lifted comp: %s\n"
                                   uu___8)
                              else ();
                              (let g1 =
                                 let uu___8 =
      ...
      fun u ->
        fun a ->
          fun e ->
            let lift =
              let uu___ =
                let uu___1 = FStarC_Util.must sub.FStarC_Syntax_Syntax.lift in
                FStarC_TypeChecker_Env.inst_tscheme_with uu___1 [u] in
              FStar_Pervasives_Native.snd uu___ in
            let rest_bs =
              let lift_t = FStarC_Util.must sub.FStarC_Syntax_Syntax.lift_wp in
              let uu___ =
                let uu___1 =
                  FStarC_Syntax_Subst.compress
              ...
              | FStarC_Syntax_Syntax.Tm_arrow
                  ...
                  let uu___3 =
                    FStarC_List.splitAt
                      ((FStarC_List.length bs) - Prims.int_one) bs in
...
let (get_mlift_for_subeff :
  ...
  fun env ->
    fun sub ->
      ...
      then
        let uu___1 =
          let uu___2 = FStarC_Util.must sub.FStarC_Syntax_Syntax.lift_wp in
          let uu___3 = FStarC_Util.must sub.FStarC_Syntax_Syntax.kind in
           ...
           fun env1 ->
             fun c ->
               ...
               (let uu___3 =
                ...
                | (uu___4, lift_t) ->
                    let wp =
                      FStarC_List.hd ct.FStarC_Syntax_Syntax.effect_args in
                    let uu___5 =
                      let uu___6 =
                        let uu___7 =
                          let uu___8 =
               ...
               fun e ->
                 ...
                 | (uu___3, lift_t) ->
                     ...
                     FStarC_Syntax_Syntax.mk uu___4
                       e.FStarC_Syntax_Syntax.pos in
         let uu___2 =
           let uu___3 = FStarC_Util.must sub.FStarC_Syntax_Syntax.lift_wp in
           ...
           FStarC_TypeChecker_Env.mlift_term =
             (match sub.FStarC_Syntax_Syntax.lift with
              | FStar_Pervasives_Native.None ->
                  FStar_Pervasives_Native.Some
                    ((fun uu___3 ->
                        fun uu___4 -> fun e -> FStarC_Util.return_all e))
...
let (update_env_sub_eff :
  FStarC_TypeChecker_Env.env ->
    FStarC_Syntax_Syntax.sub_eff ->
      FStarC_Range_Type.range -> FStarC_TypeChecker_Env.env)
  =
  fun env ->
    fun sub ->
      fun r ->
                ...
                (match uu___2 with
                 ...
                 | FStar_Pervasives_Native.None ->
                     let uu___3 =
                       ...
                       FStarC_Util.format1 "Record name %s not found." uu___4 in
          ...
          FStarC_Syntax_DsEnv.record_or_dc ->
            (FStarC_Ident.lident * 'a) Prims.list ->
              (FStarC_Ident.ident -> 'a FStar_Pervasives_Native.option) ->
                FStarC_Range_Type.range -> 'a Prims.list
  =
  fun env ->
    fun uc ->
      fun topt ->
              ...
              fun rng ->
                let debug uu___ =
                  ...
                  let print_topt topt1 =
                    ...
                    FStarC_Util.format2 "topt=%s; rdc=%s" uu___1 uu___2 in
                  let uu___1 =
                    FStarC_Class_Show.show
                      (FStarC_Class_Show.show_option
                  ...
                  let uu___5 =
                    let uu___6 =
                      FStarC_List.map FStar_Pervasives_Native.fst fas in
                    FStarC_Class_Show.show
                      (FStarC_Class_Show.show_list
                              ...
                              let uu___7 =
                                ...
                                let uu___9 =
                                  FStarC_Class_Show.show
                                    ...
                                    rdc.FStarC_Syntax_DsEnv.typename in
                                FStarC_Util.format2
                                  "No field '%s' in record type '%s'." uu___8
                                  uu___9 in
