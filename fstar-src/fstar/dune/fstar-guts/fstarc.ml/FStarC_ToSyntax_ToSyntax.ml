...
let (tun_r : FStarC_Range_Type.range -> FStarC_Syntax_Syntax.term) =
  fun r ->
    {
...
type annotated_pat =
  (FStarC_Syntax_Syntax.pat * (FStarC_Syntax_Syntax.bv *
    ...
    Prims.list)
let (mk_thunk : FStarC_Syntax_Syntax.term -> FStarC_Syntax_Syntax.term) =
  fun e ->
    let b =
      let uu___ =
          ...
          (fun uu___1 ->
             fun l ->
               ...
               | (ns_opt, out) ->
                   ...
                   (match uu___2 with
                    | "" ->
                        if FStarC_Option.isSome ns_opt
                        then
                          let uu___3 =
...
let rec (unparen : FStarC_Parser_AST.term -> FStarC_Parser_AST.term) =
  fun t ->
    ...
    | uu___ -> t
let (tm_type_z : FStarC_Range_Type.range -> FStarC_Parser_AST.term) =
  fun r ->
    let uu___ =
...
let (tm_type : FStarC_Range_Type.range -> FStarC_Parser_AST.term) =
  fun r ->
    let uu___ =
...
let rec (is_comp_type :
  ...
  fun env ->
    fun t ->
      ...
      | uu___1 -> false
let (unit_ty : FStarC_Range_Type.range -> FStarC_Parser_AST.term) =
  fun rng ->
...
let (compile_op_lid :
  Prims.int -> Prims.string -> FStarC_Range_Type.range -> FStarC_Ident.lident)
  =
  fun n ->
    fun s ->
      fun r ->
...
let rec (gather_pattern_bound_vars_maybe_top :
  FStarC_Ident.ident FStarC_FlatSet.t ->
  ...
  fun aq ->
    ...
    | (bv,
       {
        ...
        let uu___5 =
          ...
          FStarC_Util.format1 "Unexpected antiquotation: `@(%s)" uu___6 in
    ...
    | (bv, e)::uu___ ->
        let uu___1 =
          let uu___2 =
            FStarC_Class_Show.show FStarC_Syntax_Print.showable_term e in
          FStarC_Util.format1 "Unexpected antiquotation: `#(%s)" uu___2 in
        FStarC_Errors.raise_error (FStarC_Syntax_Syntax.has_range_syntax ())
          e FStarC_Errors_Codes.Fatal_UnexpectedAntiquotation ()
          (Obj.magic FStarC_Errors_Msg.is_error_message_string)
          (Obj.magic uu___1)
...
let (smt_pat_or_lid : FStarC_Range_Type.range -> FStarC_Ident.lident) =
    ...
    let handle_list type_lid =
      fun pat_cons ->
        fun pats ->
          ...
          | (pats1, terms) ->
              let uu___1 =
                FStarC_List.for_all FStar_Pervasives_Native.uu___is_None
                  terms in
              if uu___1
              ...
              let uu___ =
                FStarC_Util.find_opt
                  (fun y ->
                     let uu___1 =
                       FStarC_Ident.string_of_id
                         y.FStarC_Syntax_Syntax.ppname in
          ...
          fun loc ->
            fun aqs ->
              fun env1 ->
                fun p1 ->
                  let pos q =
                    FStarC_Syntax_Syntax.withinfo q
                      p1.FStarC_Parser_AST.prange in
                  let pos_r r = fun q -> FStarC_Syntax_Syntax.withinfo q r in
                  let orig = p1 in
                      ...
                      let id_op =
                        let uu___ =
                          let uu___1 =
                            let uu___2 = FStarC_Ident.string_of_id op in
                            let uu___3 = FStarC_Ident.range_of_id op in
                            FStarC_Parser_AST.compile_op Prims.int_zero
                              uu___2 uu___3 in
                          let uu___2 = FStarC_Ident.range_of_id op in
                          (uu___1, uu___2) in
                      ...
                      let x =
                        ...
                        FStarC_Syntax_Syntax.new_bv
                          (FStar_Pervasives_Native.Some
                             (p1.FStarC_Parser_AST.prange)) uu___ in
                       ...
                       | (loc1, aqs1, env2, annots, args1) ->
                           let l1 =
                             FStarC_Syntax_DsEnv.fail_or env2
                               (FStarC_Syntax_DsEnv.try_lookup_datacon env2)
                               l in
                           let x =
                  ...
                  | FStarC_Parser_AST.PatApp uu___ ->
                      FStarC_Errors.raise_error
                        FStarC_Parser_AST.hasRange_pattern p1
                  ...
                  | FStarC_Parser_AST.PatList pats ->
                      ...
                      (match uu___ with
                       | (loc1, aqs1, env2, annots, pats1) ->
                           ...
                           (loc1, aqs1, env2,
                             (LocalBinder
                                (x, FStar_Pervasives_Native.None, [])), pat,
                             annots))
                             ...
                             | (f, uu___2)::uu___3 ->
                                 ...
                                 (match uu___4 with
                                  ...
                                  | FStar_Pervasives_Native.Some r ->
                                      let uu___5 =
                                        qualify_field_names
                                          r.FStarC_Syntax_DsEnv.typename
                                          field_names in
                                      ((FStar_Pervasives_Native.Some
                                          (r.FStarC_Syntax_DsEnv.typename)),
                                        uu___5)) in
                            ...
                            | (typename, field_names1) ->
                                    ...
                                    (fun uu___3 ->
                                       fun p2 ->
                                         ...
                                         | (loc1, aqs1, env2, annots, pats1)
                                             ->
                                             let uu___4 =
                                               aux loc1 aqs1 env2 p2 in
                                             (match uu___4 with
                                              | (loc2, aqs2, env3, uu___5,
                                                 pat, ann) ->
                                                  (loc2, aqs2, env3,
                                                    (FStarC_List.op_At ann
                                                       annots), ((pat, false)
                                                    :: pats1))))
                                ...
                                (match uu___2 with
                                 | (loc1, aqs1, env2, annots, pats1) ->
                                     ...
                                     let x =
                                       let uu___3 =
                                         tun_r p1.FStarC_Parser_AST.prange in
                                       FStarC_Syntax_Syntax.new_bv
                                         (FStar_Pervasives_Native.Some
                                            (p1.FStarC_Parser_AST.prange))
                                         uu___3 in
                                     (loc1, aqs1, env2,
                                       (LocalBinder
                                          (x, FStar_Pervasives_Native.None,
                                            [])), pat, annots))))
        and aux loc =
          fun aqs -> fun env1 -> fun p1 -> aux' false loc aqs env1 p1 in
        let aux_maybe_or env1 =
          fun p1 ->
            let loc = [] in
            match p1.FStarC_Parser_AST.pat with
                              ...
                              | (loc2, aqs1, env3, ps1) ->
                                  ...
                                  (match uu___3 with
                                   | (loc3, aqs2, env4, uu___4, p5, ans1) ->
                                       (loc3, aqs2, env4, ((p5, ans1) ::
                                         ps1)))) (loc1, aqs, env2, []) ps in
                     (match uu___1 with
                      | (loc2, aqs1, env3, ps1) ->
        ...
        then
          ...
          | FStarC_Parser_AST.PatAscribed
              ({ FStarC_Parser_AST.pat = FStarC_Parser_AST.PatOp x;
               ...
               (t, tacopt))
              ->
              let tacopt1 = FStarC_Util.map_opt tacopt (desugar_term env) in
      ...
      fun top ->
          ...
          fun binders ->
            let uu___ =
              FStarC_List.fold_left
                ...
                binders in
            match uu___ with
            | (env2, bs_rev) -> (env2, (FStarC_List.rev bs_rev)) in
        ...
        (let uu___1 = FStarC_Effect.op_Bang dbg_ToSyntax in
         ...
         then
           ...
           FStarC_Util.print1 "desugaring (%s)\n\n" uu___2
         else ());
        (let uu___1 = let uu___2 = unparen top in uu___2.FStarC_Parser_AST.tm in
             ...
             (match uu___2 with
              | FStar_Pervasives_Native.None ->
                  let uu___3 =
                    ...
                    FStarC_Util.format1 "Data constructor %s not found"
                      uu___4 in
                  FStarC_Errors.raise_error FStarC_Parser_AST.hasRange_term
                    ...
                    fun aqs ->
                      fun bs1 ->
                        fun uu___3 ->
                          ...
                          | [] ->
                              let cod =
                                desugar_comp top.FStarC_Parser_AST.range true
                                  env1 t1 in
                              let uu___4 =
                                let uu___5 =
                                  FStarC_Syntax_Util.arrow
                                    (FStarC_List.rev bs1) cod in
                                setpos uu___5 in
                              (uu___4, aqs)
                          | hd::tl ->
                              ...
                              (match uu___4 with
                               | (bb, aqs') ->
                                   let uu___5 =
                                     as_binder env1
                                       hd.FStarC_Parser_AST.aqual bb in
                                   (match uu___5 with
                                    | (b, env2) ->
                                        aux env2 (FStarC_List.op_At aqs' aqs)
                                          (b :: bs1) tl)) in
                  aux env [] [] bs)
                             ...
                             | [] ->
                                 ...
                                 (match uu___5 with
                                  | (body1, aq) ->
                                      ...
                                      let uu___6 =
                                        let uu___7 =
                                          no_annot_abs (FStarC_List.rev bs)
                                            body2 in
                                        setpos uu___7 in
         ...
         | FStarC_Parser_AST.LetOpenRecord (r, rty, e) ->
             ...
             let record =
               ...
               | FStar_Pervasives_Native.None ->
                   let uu___3 =
                     let uu___4 = FStarC_Parser_AST.term_to_string rty in
                     FStarC_Util.format1 "Not a record type: `%s`" uu___4 in
                   FStarC_Errors.raise_error FStarC_Parser_AST.hasRange_term
                     rty FStarC_Errors_Codes.Error_BadLetOpenRecord ()
                     (Obj.magic FStarC_Errors_Msg.is_error_message_string)
                     (Obj.magic uu___3) in
         ...
         | FStarC_Parser_AST.Let (qual, lbs, body) ->
             ...
             let ds_let_rec_or_app uu___2 =
               ...
               | (env', fnames, rec_bindings, used_markers) ->
                   ...
                   let desugar_one_def env1 =
                     fun lbname ->
                       fun uu___4 ->
                         match uu___4 with
                         | (attrs_opt, (uu___5, args, result_t), def) ->
                             let args1 =
                               FStarC_List.map replace_unit_pattern args in
                             ...
                             let def2 =
                               ...
                               | uu___6 ->
                                   let uu___7 =
                                     FStarC_Parser_AST.un_curry_abs args1
                                       def1 in
                             ...
                             (match uu___6 with
                              | (body1, aq) ->
                                  ...
                                  let uu___7 =
                                    mk_lb
                                      (attrs, lbname1,
                                        (setpos FStarC_Syntax_Syntax.tun),
                                        body2, pos) in
                                  (uu___7, aq)) in
                   let uu___4 =
                     let uu___5 =
                         ...
                         | (body1, aq) ->
                             (if is_rec
                              ...
                              (let uu___7 =
                                 ...
                                 mk uu___8 in
                               (uu___7,
                                 (FStarC_List.op_At aq
                                    (FStarC_List.flatten aqss))))))) in
             let ds_non_rec attrs_opt =
               fun pat ->
                 fun t1 ->
                   fun t2 ->
                     let attrs =
                              ...
                              (check_no_aq aqs;
                               (let uu___5 =
                                  ...
                                  | LetBinder (l, (t, tacopt)) ->
                                      (if FStarC_Util.is_some tacopt
                                       then
                                         (let uu___7 =
                                            FStarC_Util.must tacopt in
                                          FStarC_Errors.log_issue
                                ...
                                match uu___5 with
                                | (tm, aq1) ->
                                    (tm, (FStarC_List.op_At aq0 aq1))))) in
                  ...
                  (match uu___3 with
                   | (asc_opt, aq0) ->
                       let uu___4 =
                         let uu___5 =
                           let uu___6 =
                             FStarC_List.map desugar_branch branches in
                           FStarC_List.unzip uu___6 in
                         match uu___5 with
                         | (x, y) -> ((FStarC_List.flatten x), y) in
                       (match uu___4 with
                        | (brs, aqs) ->
                            let uu___5 =
                              mk
              ...
              | (tm, vts) ->
                  let vt_binders =
                    FStarC_List.map
                      ...
                      vts in
                  let vt_tms =
                    FStarC_List.map FStar_Pervasives_Native.snd vts in
                          ...
                          | (b::bs3, v::vs3) ->
                              ...
                              let token1 =
                                let uu___3 =
                                  FStarC_Syntax_Subst.subst_binders
                                    ((FStarC_Syntax_Syntax.NT (x, v)) :: sub)
                                    bs3 in
                                aux uu___3 vs3
                                  ((FStarC_Syntax_Syntax.NT (x, v)) :: sub)
                                  token in
                              let token2 =
                                let uu___3 =
                                  let uu___4 =
                                    let uu___5 =
                                      FStarC_Syntax_Subst.subst sub p1 in
                                    FStarC_Syntax_Util.close_exists_no_univs
                                      bs3 uu___5 in
                                  FStarC_Syntax_Util.abs [b] uu___4
                                    FStar_Pervasives_Native.None in
                                mk_exists_intro x.FStarC_Syntax_Syntax.sort
                                  uu___3 v token1 in
                              token2
                          | uu___3 ->
                              FStarC_Errors.raise_error
                          ...
                          | (b::bs3, v::vs3) ->
                              ...
                              let token1 =
                                let uu___3 =
                                  ...
                                  FStarC_Syntax_Util.abs [b] uu___4
                                    FStar_Pervasives_Native.None in
                                mk_forall_elim x.FStarC_Syntax_Syntax.sort
                                  uu___3 v token in
                              let sub1 = (FStarC_Syntax_Syntax.NT (x, v)) ::
                                sub in
                              let uu___3 =
         ...
         | FStarC_Parser_AST.ListLiteral ts ->
             ...
             let t' =
               ...
               FStarC_List.fold_right (cons top.FStarC_Parser_AST.range) ts
                 uu___2 in
             desugar_term_aq env t'
         | FStarC_Parser_AST.SeqLiteral ts ->
             let nil r =
               ...
               fun hd ->
                 fun tl ->
                   let uu___2 =
                     FStarC_Parser_AST.mk_term
                       (FStarC_Parser_AST.Var
                          FStarC_Parser_Const.seq_cons_lid) r
                       FStarC_Parser_AST.Expr in
                   FStarC_Parser_AST.mkApp uu___2
                     [(hd, FStarC_Parser_AST.Nothing);
    ...
    fun t ->
      fun tac_opt ->
        fun use_eq ->
          ...
          | (annot, aq0) ->
              let uu___1 =
                let uu___2 = FStarC_Util.map_opt tac_opt (desugar_term env) in
                     ...
                     let fail_lemma uu___1 =
                       ...
                       let uu___2 =
                         let uu___3 =
                           ...
                           let uu___5 =
                             let uu___6 =
                               FStarC_List.map FStarC_Pprint.doc_of_string
                                 expected_one_of in
              ...
              (if (FStarC_List.length args) = Prims.int_zero
               then
                 (let uu___2 =
                    ...
                    FStarC_Util.format1 "Not enough args to effect %s" uu___3 in
                                ...
                                (let uu___7 =
                                 ...
                                 then
                                   ...
                                   (let flags =
                                    ...
                                    let flags1 =
                                      FStarC_List.op_At flags cattributes in
                                    let rest3 =
                                      let uu___9 =
                                        FStarC_Ident.lid_equals eff
                                          FStarC_Parser_Const.effect_Lemma_lid in
...
and (desugar_formula :
  ...
  fun env ->
    fun f ->
      ...
      let desugar_quant q_head =
        fun b ->
          fun pats ->
            fun should_wrap_with_pat ->
              fun body ->
                let tk =
                  desugar_binder env
                    {
                                   ...
                                   (fun i ->
                                      let uu___2 =
                                        FStarC_Syntax_DsEnv.fail_or2 env1
                                          (FStarC_Syntax_DsEnv.try_lookup_id
                                             env1) i in
                                   ...
                                   (fun es ->
                                      FStarC_List.map
                                        (fun e ->
                                           ...
                                           arg_withimp_t
                                             FStarC_Parser_AST.Nothing uu___2)
                                        es) pats1 in
                               (match pats2 with
                                | [] when
                                    Prims.op_Negation should_wrap_with_pat ->
                                    body1
                                | uu___2 ->
                                    mk
                                      (FStarC_Syntax_Syntax.Tm_meta
          ...
          let q_head =
            ...
            | FStar_Pervasives_Native.None ->
                let uu___2 =
                  ...
                  FStarC_Util.format1 "quantifier operator %s not found"
                    uu___3 in
...
and (desugar_vquote :
  env_t -> FStarC_Parser_AST.term -> FStarC_Range_Type.range -> Prims.string)
  =
  fun env ->
    fun e ->
      fun r ->
                ...
                | (formals, uu___5) ->
                    (match formals with
                     ...
                     | uu___6 ->
                         ...
                         let uu___7 = FStarC_Util.first_N n formals in
                         (match uu___7 with
                          | (uu___8, rest) ->
          ...
          FStarC_Syntax_Syntax.binders ->
            FStarC_Syntax_Syntax.typ FStar_Pervasives_Native.option ->
              FStarC_Syntax_Syntax.term ->
                FStarC_Ident.lident Prims.list ->
                  FStarC_Syntax_Syntax.qualifier Prims.list ->
                    FStarC_Range_Type.range -> FStarC_Syntax_Syntax.sigelt)
  =
  fun env ->
    fun d ->
      fun lid ->
                ...
                fun lids ->
                  fun quals ->
                    fun rng ->
                      let attrs =
                        let uu___ =
                          FStarC_List.map (desugar_term env)
                      ...
                      let lb =
                        ...
                        let uu___1 =
                          if FStarC_Util.is_some kopt
                          then
                            let uu___2 =
                              let uu___3 = FStarC_Util.must kopt in
                      ...
                      let uu___ =
                        FStarC_Syntax_Util.deduplicate_terms
                          (FStarC_List.op_At val_attrs attrs) in
          ...
          fun tcs ->
              ...
              | FStarC_Parser_AST.TyconVariant (id, bds, k, variants) ->
                  ...
                  (match uu___1 with
                   | (additional_records, variants1) ->
                       let concat_options =
                         FStarC_List.filter_map (fun r -> r) in
                    ...
                    ((FStarC_Parser_AST.TyconVariant
                        (id, parms, kopt,
                          [(constrName,
                             ...
                             attrs)])), uu___2)))
              | uu___1 -> failwith "impossible" in
            let desugar_abstract_tc quals1 =
              fun _env ->
                fun mutuals ->
                  fun d_attrs ->
                    fun uu___ ->
            ...
            let push_tparams env1 =
              fun bs ->
                ...
                match uu___ with
                | (env2, bs1) -> (env2, (FStarC_List.rev bs1)) in
            match tcs1 with
               ...
               _d_attrs)::[] ->
                ...
                (match uu___ with
                 | (env', typars) ->
                     ...
                     let se =
                       if
                         FStarC_List.contains FStarC_Syntax_Syntax.Effect
                           quals1
                       then
                         let uu___1 =
                           let uu___2 =
                         ...
                         | (t1, cattributes) ->
                             ...
                             let uu___2 =
                               let uu___3 =
                                 let uu___4 =
                                   let uu___5 =
                                     FStarC_Syntax_Util.comp_flags c1 in
            ...
            | uu___::uu___1 ->
                ...
                let uu___2 =
                  FStarC_List.fold_left (collect_tcs quals) (env, []) tcs1 in
                (match uu___2 with
                 | (env1, tcs2) ->
                      ...
                      | (bundle, abbrevs) ->
                          ((let uu___5 = FStarC_Effect.op_Bang dbg_attrs in
                            ...
                            then
                              ...
                              FStarC_Util.print1 "After disentangling: %s\n"
                                uu___6
                            else ());
                           (let env2 =
                                ...
                                (fun se ->
                                   ...
                                   | FStarC_Syntax_Syntax.Sig_inductive_typ
                                       ...
                                       mk_data_discriminators quals1 env3
                                         ...
                                         se.FStarC_Syntax_Syntax.sigattrs
                                   | uu___5 -> []) sigelts in
                            let ops = FStarC_List.op_At discs data_ops in
                            let env4 =
                              FStarC_List.fold_left
                                FStarC_Syntax_DsEnv.push_sigelt env3 ops in
                            (env4,
                              (FStarC_List.op_At [bundle]
                                 (FStarC_List.op_At abbrevs ops)))))))
            | [] -> failwith "impossible"
let (desugar_binders :
  FStarC_Syntax_DsEnv.env ->
    FStarC_Parser_AST.binder Prims.list ->
    ...
    fun binders ->
      let uu___ =
        FStarC_List.fold_left
          ...
          binders in
      match uu___ with
      | (env1, binders1) -> (env1, (FStarC_List.rev binders1))
let (push_reflect_effect :
  FStarC_Syntax_DsEnv.env ->
    FStarC_Syntax_Syntax.qualifier Prims.list ->
      FStarC_Ident.lid -> FStarC_Range_Type.range -> FStarC_Syntax_DsEnv.env)
  =
  fun env ->
    fun quals ->
      fun effect_name ->
...
let (parse_attr_with_list :
  Prims.bool ->
    FStarC_Syntax_Syntax.term ->
      FStarC_Ident.lident ->
        ((Prims.int Prims.list * FStarC_Range_Type.range)
                      ...
                      (match uu___3 with
                       | FStar_Pervasives_Native.Some es ->
                           let uu___4 =
                             let uu___5 =
                               let uu___6 =
                                 FStarC_List.map FStarC_BigInt.to_int_fs es in
...
let (get_fail_attr1 :
  Prims.bool ->
    FStarC_Syntax_Syntax.term ->
      (Prims.int Prims.list * FStarC_Range_Type.range * Prims.bool)
        FStar_Pervasives_Native.option)
  =
  fun warn ->
    fun at ->
...
let (lookup_effect_lid :
  FStarC_Syntax_DsEnv.env ->
    FStarC_Ident.lident ->
      FStarC_Range_Type.range -> FStarC_Syntax_Syntax.eff_decl)
  =
  fun env ->
    fun l ->
      fun r ->
                          ...
                          let uu___2 =
                            FStarC_List.partition
                              (fun decl ->
                                 ...
                                 FStarC_List.mem uu___3 mandatory_members)
                              eff_decls in
                          match uu___2 with
      ...
      let no_fail_attrs ats =
        FStarC_List.filter
          (fun at ->
             ...
             FStarC_Option.isNone uu___) ats in
      let uu___ =
        let attrs =
          FStarC_List.map (desugar_term env) d.FStarC_Parser_AST.attrs in
  ...
  fun env ->
    fun d ->
      ...
      (let uu___1 = desugar_decl_maybe_fail_attr env d in
       match uu___1 with
       | (env1, ses) ->
           let uu___2 = FStarC_List.map generalize_annotated_univs ses in
           (env1, uu___2))
    ...
    fun d_attrs ->
      fun d ->
             ...
             | (env1, ses) ->
                 ((let uu___2 = FStarC_Effect.op_Bang dbg_attrs in
                   ...
                   then
                     ...
                     FStarC_Util.print2 "Desugared tycon from {%s} to {%s}\n"
                       uu___3 uu___4
                   else ());
                  (let mkclass lid =
                   ...
                   let uu___2 =
                     ...
                     then
                       ...
                       let uu___4 =
                         FStarC_List.concatMap (splice_decl meths) ses in
                       (uu___3, uu___4)
                     else (ses, []) in
                   match uu___2 with
                   | (ses1, extra) ->
        ...
        | FStarC_Parser_AST.TopLevelLet (isrec, lets) ->
            ...
            then
              let lets1 =
                FStarC_List.map (fun x -> (FStar_Pervasives_Native.None, x))
                  lets in
              let as_inner_let =
                let uu___ =
                  let uu___1 =
                                      ...
                                      (match uu___6 with
                                       | (qs', ats') ->
                                           ((FStarC_List.rev_append qs' qs),
                                             (FStarC_List.rev_append ats' ats))))
                             fvs ([], []) in
                         (match uu___4 with
                          | (val_quals, val_attrs) ->
                              let top_attrs =
              ...
              (let uu___1 =
               ...
               | (pat, body) ->
                   ...
                   let build_generic_projection uu___2 =
                     fun id_opt ->
                       match uu___2 with
                       | (env1, ses) ->
                           let uu___3 =
        ...
        | FStarC_Parser_AST.Exception (id, t_opt) ->
            ...
            let env2 =
              FStarC_List.fold_left FStarC_Syntax_DsEnv.push_sigelt env1
                (FStarC_List.op_At discs data_ops) in
            (env2, (FStarC_List.op_At (se' :: discs) data_ops))
        ...
        | FStarC_Parser_AST.DeclSyntaxExtension
            ...
            (match extension_parser with
             | FStar_Pervasives_Native.None ->
                 let uu___1 =
                   FStarC_Util.format1 "Unknown syntax extension %s"
                     extension_name in
                 FStarC_Errors.raise_error
                   FStarC_Class_HasRange.hasRange_range range
                   FStarC_Errors_Codes.Fatal_SyntaxError ()
                ...
                | (env2, modul1) ->
                    ((let uu___5 =
                      ...
                      then
                        ...
                        FStarC_Util.print1 "Module after desugaring:\n%s\n"
                          uu___6
                      else ());
                     (let uu___5 =
                        if pop_when_done
                  ...
                  let erase_tscheme uu___2 =
                    ...
                    | (us, t) ->
                        let t1 =
                          let uu___3 =
                            FStarC_Syntax_Subst.shift_subst
                              (FStarC_List.length us) binders_opening in
