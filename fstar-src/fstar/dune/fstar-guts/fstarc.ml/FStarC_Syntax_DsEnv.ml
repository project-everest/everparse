  ...
  fun x ->
    fun xs ->
      let cands =
        FStarC_List.map
          (fun y ->
             let uu___ = FStarC_EditDist.edit_distance x y in (uu___, y)) xs in
      let cands1 =
        let uu___ =
      ...
      let cands2 =
        takeWhileMax (Prims.of_int (5))
          (fun uu___ ->
             match uu___ with | (d, uu___1) -> d < (Prims.of_int (3))) cands1 in
  ...
  fun s1 ->
    fun s2 ->
      fun xs ->
        ...
        | x::y::xs1 ->
            let uu___ =
              let uu___1 = list_sep2 s1 s2 (y :: xs1) in s1 :: uu___1 in
            x :: uu___
let (typo_msg :
  Prims.string -> Prims.string Prims.list -> FStarC_Pprint.document) =
  fun x ->
    fun xs ->
      ...
      then FStarC_Pprint.empty
        ...
        (let uu___1 =
           ...
           let uu___3 =
             let uu___4 =
               let uu___5 =
                 ...
                 let uu___7 =
                   let uu___8 = FStarC_Pprint.break_ Prims.int_one in
                   let uu___9 =
                     let uu___10 = FStarC_Pprint.doc_of_string "or" in
                     let uu___11 = FStarC_Pprint.break_ Prims.int_one in
                     FStarC_Pprint.op_Hat_Hat uu___10 uu___11 in
                   FStarC_Pprint.op_Hat_Hat uu___8 uu___9 in
                 let uu___8 =
                   FStarC_List.map FStarC_Pprint.doc_of_string cands in
                 list_sep2 uu___6 uu___7 uu___8 in
               FStarC_Pprint.flow FStarC_Pprint.empty uu___5 in
         ...
         FStarC_Pprint.nest (Prims.of_int (2)) uu___1)
...
type scope_mod =
  ...
  | Top_level_defs of Prims.bool FStarC_PSMap.t 
...
let (__proj__Local_bindings__item___0 :
  scope_mod -> local_binding FStarC_PSMap.t) =
...
let (__proj__Top_level_defs__item___0 :
  scope_mod -> Prims.bool FStarC_PSMap.t) =
...
let (uu___0 : scope_mod FStarC_Class_Show.showable) =
  {
    FStarC_Class_Show.show =
      (fun uu___ ->
         ...
         | Open_module_or_namespace (lid, uu___1, uu___2) ->
             let uu___3 = FStarC_Ident.string_of_lid lid in
             Prims.strcat "Open_module_or_namespace " uu___3
...
let (__proj__Mkenv__item__curmodule :
  ...
  fun projectee ->
    ...
    | { curmodule; curmonad; modules; scope_mods; exported_ids;
        ...
        ds_hooks; dep_graph; no_prelude;_} -> curmodule
let (__proj__Mkenv__item__curmonad :
  ...
  fun projectee ->
    ...
    | { curmodule; curmonad; modules; scope_mods; exported_ids;
        trans_exported_ids; includes; sigaccum; sigmap; iface;
        admitted_iface; expect_typ; remaining_iface_decls; syntax_only;
        ds_hooks; dep_graph; no_prelude;_} -> curmonad
let (__proj__Mkenv__item__modules :
  ...
  fun projectee ->
    ...
    | { curmodule; curmonad; modules; scope_mods; exported_ids;
        trans_exported_ids; includes; sigaccum; sigmap; iface;
        admitted_iface; expect_typ; remaining_iface_decls; syntax_only;
        ds_hooks; dep_graph; no_prelude;_} -> modules
let (__proj__Mkenv__item__scope_mods : env -> scope_mod Prims.list) =
  fun projectee ->
    ...
    | { curmodule; curmonad; modules; scope_mods; exported_ids;
        trans_exported_ids; includes; sigaccum; sigmap; iface;
        admitted_iface; expect_typ; remaining_iface_decls; syntax_only;
        ds_hooks; dep_graph; no_prelude;_} -> scope_mods
let (__proj__Mkenv__item__exported_ids :
  env -> exported_id_set FStarC_SMap.t) =
  fun projectee ->
    match projectee with
    | { curmodule; curmonad; modules; scope_mods; exported_ids;
        trans_exported_ids; includes; sigaccum; sigmap; iface;
        admitted_iface; expect_typ; remaining_iface_decls; syntax_only;
        ds_hooks; dep_graph; no_prelude;_} -> exported_ids
let (__proj__Mkenv__item__trans_exported_ids :
  ...
  fun projectee ->
    ...
    | { curmodule; curmonad; modules; scope_mods; exported_ids;
        trans_exported_ids; includes; sigaccum; sigmap; iface;
        admitted_iface; expect_typ; remaining_iface_decls; syntax_only;
        ds_hooks; dep_graph; no_prelude;_} -> trans_exported_ids
let (__proj__Mkenv__item__includes :
  ...
  fun projectee ->
    ...
    | { curmodule; curmonad; modules; scope_mods; exported_ids;
        trans_exported_ids; includes; sigaccum; sigmap; iface;
        admitted_iface; expect_typ; remaining_iface_decls; syntax_only;
        ds_hooks; dep_graph; no_prelude;_} -> includes
let (__proj__Mkenv__item__sigaccum : env -> FStarC_Syntax_Syntax.sigelts) =
  fun projectee ->
    ...
    | { curmodule; curmonad; modules; scope_mods; exported_ids;
        trans_exported_ids; includes; sigaccum; sigmap; iface;
        admitted_iface; expect_typ; remaining_iface_decls; syntax_only;
        ds_hooks; dep_graph; no_prelude;_} -> sigaccum
let (__proj__Mkenv__item__sigmap :
  env -> (FStarC_Syntax_Syntax.sigelt * Prims.bool) FStarC_SMap.t) =
  fun projectee ->
    match projectee with
    | { curmodule; curmonad; modules; scope_mods; exported_ids;
        trans_exported_ids; includes; sigaccum; sigmap; iface;
        admitted_iface; expect_typ; remaining_iface_decls; syntax_only;
        ds_hooks; dep_graph; no_prelude;_} -> sigmap
let (__proj__Mkenv__item__iface : env -> Prims.bool) =
  fun projectee ->
    ...
    | { curmodule; curmonad; modules; scope_mods; exported_ids;
        trans_exported_ids; includes; sigaccum; sigmap; iface;
        admitted_iface; expect_typ; remaining_iface_decls; syntax_only;
        ds_hooks; dep_graph; no_prelude;_} -> iface
let (__proj__Mkenv__item__admitted_iface : env -> Prims.bool) =
  fun projectee ->
    ...
    | { curmodule; curmonad; modules; scope_mods; exported_ids;
        trans_exported_ids; includes; sigaccum; sigmap; iface;
        admitted_iface; expect_typ; remaining_iface_decls; syntax_only;
        ds_hooks; dep_graph; no_prelude;_} -> admitted_iface
let (__proj__Mkenv__item__expect_typ : env -> Prims.bool) =
  fun projectee ->
    ...
    | { curmodule; curmonad; modules; scope_mods; exported_ids;
        trans_exported_ids; includes; sigaccum; sigmap; iface;
        admitted_iface; expect_typ; remaining_iface_decls; syntax_only;
        ds_hooks; dep_graph; no_prelude;_} -> expect_typ
let (__proj__Mkenv__item__remaining_iface_decls :
  ...
  fun projectee ->
    ...
    | { curmodule; curmonad; modules; scope_mods; exported_ids;
        trans_exported_ids; includes; sigaccum; sigmap; iface;
        admitted_iface; expect_typ; remaining_iface_decls; syntax_only;
        ds_hooks; dep_graph; no_prelude;_} -> remaining_iface_decls
let (__proj__Mkenv__item__syntax_only : env -> Prims.bool) =
  fun projectee ->
    ...
    | { curmodule; curmonad; modules; scope_mods; exported_ids;
        trans_exported_ids; includes; sigaccum; sigmap; iface;
        admitted_iface; expect_typ; remaining_iface_decls; syntax_only;
        ds_hooks; dep_graph; no_prelude;_} -> syntax_only
let (__proj__Mkenv__item__ds_hooks : env -> dsenv_hooks) =
  fun projectee ->
    ...
    | { curmodule; curmonad; modules; scope_mods; exported_ids;
        trans_exported_ids; includes; sigaccum; sigmap; iface;
        admitted_iface; expect_typ; remaining_iface_decls; syntax_only;
        ds_hooks; dep_graph; no_prelude;_} -> ds_hooks
let (__proj__Mkenv__item__dep_graph : env -> FStarC_Parser_Dep.deps) =
  fun projectee ->
    ...
    | { curmodule; curmonad; modules; scope_mods; exported_ids;
        trans_exported_ids; includes; sigaccum; sigmap; iface;
        admitted_iface; expect_typ; remaining_iface_decls; syntax_only;
        ds_hooks; dep_graph; no_prelude;_} -> dep_graph
let (__proj__Mkenv__item__no_prelude : env -> Prims.bool) =
  fun projectee ->
    match projectee with
    | { curmodule; curmonad; modules; scope_mods; exported_ids;
        trans_exported_ids; includes; sigaccum; sigmap; iface;
        admitted_iface; expect_typ; remaining_iface_decls; syntax_only;
        ds_hooks; dep_graph; no_prelude;_} -> no_prelude
...
let (all_local_names : env -> Prims.string Prims.list) =
  fun env1 ->
    FStarC_List.fold_right
      (fun scope ->
         fun acc ->
           match scope with
           | Local_bindings lbs ->
               let uu___ = FStarC_PSMap.keys lbs in
               FStarC_List.op_At uu___ acc
           ...
           | Top_level_defs lbs ->
               ...
               FStarC_List.op_At uu___ acc
           | Record_or_dc r ->
               let uu___ = FStarC_Ident.string_of_lid r.typename in uu___ ::
                 acc) env1.scope_mods []
let (all_mod_names : env -> Prims.string Prims.list) =
  fun env1 ->
    let uu___ =
      FStarC_List.map
        (fun uu___2 ->
      ...
      FStarC_List.fold_right
        (fun scope ->
           fun acc ->
             ...
             | Open_module_or_namespace (m, uu___3, uu___4) ->
                 let uu___5 = FStarC_Ident.string_of_lid m in uu___5 :: acc
...
let (default_ds_hooks : dsenv_hooks) =
  {
    ds_push_open_hook = (fun uu___ -> fun uu___2 -> ());
    ds_push_include_hook = (fun uu___ -> fun uu___2 -> ());
    ds_push_module_abbrev_hook =
      (fun uu___ -> fun uu___2 -> fun uu___3 -> ())
  }
...
let new_sigmap : 'uuuuu . unit -> 'uuuuu FStarC_SMap.t =
  fun uu___ -> FStarC_SMap.create (Prims.of_int (100))
...
let (set_bv_range :
  FStarC_Syntax_Syntax.bv ->
    FStarC_Range_Type.range -> FStarC_Syntax_Syntax.bv)
  =
  fun bv ->
    fun r ->
                ...
                (fun uu___2 ->
                   ...
                   | (f, uu___3) ->
                       let uu___4 =
                         ...
                         let uu___6 = FStarC_Ident.string_of_id f in
                         uu___5 = uu___6 in
                       if uu___4
...
let (get_exported_id_set :
  ...
  = fun e -> fun mname -> FStarC_SMap.try_find e.exported_ids mname
let (get_trans_exported_id_set :
  env ->
    Prims.string ->
      (exported_id_kind -> string_set FStarC_Effect.ref)
        FStar_Pervasives_Native.option)
  = fun e -> fun mname -> FStarC_SMap.try_find e.trans_exported_ids mname
...
let (is_exported_id_field : exported_id_kind -> Prims.bool) =
  fun uu___ -> match uu___ with | Exported_id_field -> true | uu___2 -> false
                               ...
                               | (ns1, restriction) ->
                                   let opt =
                                     FStarC_Syntax_Syntax.is_ident_allowed_by_restriction
                                       id1 restriction in
                                   FStarC_Util.map_opt opt
                                     (fun id2 -> (ns1, id2))) uu___3 in
                    let look_into =
                      if not_shadowed
                      then
                        let uu___2 = qual modul id1 in find_in_module uu___2
                      else Cont_ignore in
              ...
              fun find_in_module ->
                fun lookup_default_id ->
                         ...
                         | FStar_Pervasives_Native.Some l ->
                             ...
                             (match uu___3 with
                              | (uu___4, uu___5, used_marker1) ->
                                  (FStarC_Effect.op_Colon_Equals used_marker1
                                     true;
                                   k_local_binding l)))
                    ...
                    | Record_or_dc r when is_exported_id_field eikind ->
                        ...
                        find_in_module_with_includes Exported_id_field
                          (fun lid ->
                             ...
                             find_in_record uu___3 id1 r k_record)
                  ...
                  let rec aux uu___ =
                    match uu___ with
                    | a1::q ->
                        let uu___2 = proc a1 in
                        option_of_cont (fun uu___3 -> aux q) uu___2
                    | [] ->
                        let uu___2 = lookup_default_id Cont_fail id in
                        option_of_cont
                          (fun uu___3 -> FStar_Pervasives_Native.None) uu___2 in
                  aux env1.scope_mods
let found_local_binding :
  ...
  =
  fun r -> fun uu___ -> match uu___ with | (id', x, uu___2) -> bv_to_name x r
let find_in_module :
  'uuuuu .
    env ->
      FStarC_Ident.lident ->
    ...
    fun id ->
      ...
      | uu___2 ->
          try_lookup_id'' env1 id Exported_id_term_type
            ...
            (fun i ->
               find_in_module env1 i (fun uu___3 -> fun uu___4 -> Cont_fail)
                 Cont_ignore) (fun uu___3 -> fun uu___4 -> Cont_fail)
        ...
        let rec aux uu___ =
          ...
          | (Open_module_or_namespace
              ...
              let new_lid =
                ...
                let uu___3 = FStarC_Ident.range_of_lid lid in
                FStarC_Ident.lid_of_path uu___2 uu___3 in
    ...
    fun ids ->
      fun is_full_path ->
        let rec aux revns =
          fun id ->
            let lid =
              FStarC_Ident.lid_of_ns_and_id (FStarC_List.rev revns) id in
            let uu___ = namespace_is_open env1 lid in
            if uu___
            then
              FStar_Pervasives_Native.Some
                ((FStarC_List.rev (id :: revns)), [])
            else
              (match revns with
               | [] -> FStar_Pervasives_Native.None
                       ...
                       | FStar_Pervasives_Native.Some modul ->
                           let uu___5 =
                             ...
                             find_in_module_with_includes eikind f_module
                               Cont_fail env1 modul uu___6 in
                           option_of_cont
                             (fun uu___6 -> FStar_Pervasives_Native.None)
                             uu___5)
                  | [] ->
                      let uu___2 = FStarC_Ident.ident_of_lid lid in
                      try_lookup_id'' env1 uu___2 eikind k_local_binding
      ...
      fun k_local_binding ->
        fun k_rec_binding ->
          fun k_global_def ->
            ...
            let l_default k =
              fun i -> lookup_default_id env1 i (k_global_def' k) k in
    ...
    | FStarC_Syntax_Syntax.Sig_datacon
        ...
        let qopt =
          FStarC_Util.find_map se.FStarC_Syntax_Syntax.sigquals
            (fun uu___7 ->
               match uu___7 with
               | FStarC_Syntax_Syntax.RecordConstructor (uu___8, fs) ->
                   FStar_Pervasives_Native.Some
    ...
    fun exclude_interf ->
      fun env1 ->
        fun lid ->
          ...
          let k_global_def source_lid =
            fun uu___ ->
              match uu___ with
              | (uu___2, true) when exclude_interf ->
                  FStar_Pervasives_Native.None
              | (se, uu___2) ->
                  (match se.FStarC_Syntax_Syntax.sigel with
                         ...
                         let uu___4 =
                           let uu___5 =
                             ...
                             FStarC_Ident.set_lid_range
                               ne.FStarC_Syntax_Syntax.mname uu___6 in
                           (se, uu___5) in
                         Eff_name uu___4 in
                       FStar_Pervasives_Native.Some uu___3
                   | FStarC_Syntax_Syntax.Sig_effect_abbrev uu___3 ->
                       FStar_Pervasives_Native.Some
                         (Eff_name (se, source_lid))
                ...
                (match s.FStarC_Syntax_Syntax.sigel with
                 | FStarC_Syntax_Syntax.Sig_new_effect ne ->
                     let uu___15 =
                       ...
                       FStarC_Ident.set_lid_range
                         ne.FStarC_Syntax_Syntax.mname uu___16 in
    ...
    fun lid0 ->
      ...
      | (pref, ns) ->
          ...
          let rec go nss =
            ...
            | ns1::rest ->
                let lid' =
                  FStarC_Ident.lid_of_ns_and_id (FStarC_List.op_At pref ns1)
                    id0 in
        ...
        fun se ->
          ...
          | ({
             ...
             uu___8) ->
              ...
              let uu___9 = FStarC_Syntax_Syntax.lid_and_dd_as_fv lid1 qual1 in
              FStar_Pervasives_Native.Some uu___9
          | ({
...
let (extract_record :
  env ->
    scope_mod Prims.list FStarC_Effect.ref ->
            ...
            FStarC_List.iter
              (fun uu___2 ->
                 ...
                 | {
                     ...
                     FStarC_Syntax_Syntax.sigopts = uu___11;_} ->
                     let uu___12 =
                       let uu___13 = find_dc dc in FStarC_Util.must uu___13 in
                     (match uu___12 with
                      | {
                          FStarC_Syntax_Syntax.sigel =
                            FStarC_Syntax_Syntax.Sig_datacon
                            { FStarC_Syntax_Syntax.lid1 = constrname;
                              ...
                              FStarC_Syntax_Syntax.injective_type_params1 =
                                uu___16;_};
                          FStarC_Syntax_Syntax.sigrng = uu___17;
                          FStarC_Syntax_Syntax.sigquals = uu___18;
                          FStarC_Syntax_Syntax.sigmeta = uu___19;
                          FStarC_Syntax_Syntax.sigattrs = uu___20;
                          FStarC_Syntax_Syntax.sigopens_and_abbrevs = uu___21;
                          FStarC_Syntax_Syntax.sigopts = uu___22;_} ->
                          let uu___23 = FStarC_Syntax_Util.arrow_formals t in
                          (match uu___23 with
                           | (all_formals, uu___24) ->
                               let uu___25 =
                                 FStarC_Util.first_N n all_formals in
                               (match uu___25 with
                                | (_params, formals) ->
                                    ...
                                    ((let uu___27 =
                                        ...
                                        (Record_or_dc record) :: uu___28 in
                                      FStarC_Effect.op_Colon_Equals new_globs
                                        uu___27);
                                     (match () with
                                      | () ->
                                          ((let add_field uu___28 =
                                              match uu___28 with
                                              | (id, uu___29) ->
                                                  let modul =
                                                    let uu___30 =
    ...
    fun fieldname ->
      let find_in_cache fieldname1 =
        let uu___ =
          ...
          let uu___3 = FStarC_Ident.ident_of_lid fieldname1 in
          (uu___2, uu___3) in
        match uu___ with
        | (ns, id) ->
    ...
    fun lid ->
      fun record ->
        ...
        | FStar_Pervasives_Native.Some record' when
            ...
            let uu___3 = FStarC_Ident.nsstr record'.typename in
            uu___2 = uu___3 ->
            let uu___2 =
              let uu___3 = FStarC_Ident.ns_of_lid record.typename in
...
let (try_lookup_dc_by_field_name :
  ...
  fun env1 ->
    fun fieldname ->
      ...
      | uu___2 -> FStar_Pervasives_Native.None
let (string_set_ref_new : unit -> string_set FStarC_Effect.ref) =
  fun uu___ ->
    let uu___2 =
      Obj.magic
...
let (exported_id_set_new :
  unit -> exported_id_kind -> string_set FStarC_Effect.ref) =
  fun uu___ ->
...
let (push_top_level_rec_binding :
  env -> FStarC_Ident.ident -> (env * Prims.bool FStarC_Effect.ref)) =
  fun env0 ->
    fun x ->
    ...
    fun env1 ->
      fun s ->
        let err l =
          ...
          let r =
            ...
            | FStar_Pervasives_Native.Some (se, uu___) ->
                let uu___2 =
                  ...
                  FStarC_Util.find_opt (FStarC_Ident.lid_equals l) uu___3 in
                (match uu___2 with
                 | FStar_Pervasives_Native.Some l1 ->
          ...
          let uu___ =
            let uu___2 =
              let uu___3 =
                let uu___4 = FStarC_Ident.string_of_lid l in
                FStarC_Util.format1 "Duplicate top-level names [%s]" uu___4 in
              FStarC_Errors_Msg.text uu___3 in
            let uu___3 =
              let uu___4 =
                let uu___5 =
                  FStarC_Util.format1 "Previously declared at %s" r in
        ...
        let env2 =
          let uu___ =
            match s.FStarC_Syntax_Syntax.sigel with
            | FStarC_Syntax_Syntax.Sig_let uu___2 -> (false, true)
            | FStarC_Syntax_Syntax.Sig_bundle uu___2 -> (false, true)
            | uu___2 -> (false, false) in
          match uu___ with
          | (any_val, exclude_interface) ->
              let lids = FStarC_Syntax_Util.lids_of_sigelt s in
              let uu___2 =
                FStarC_Util.find_map lids
                  (fun l ->
                     let uu___3 =
                       let uu___4 = unique any_val exclude_interface env1 l in
        ...
        let uu___ =
          ...
          | FStarC_Syntax_Syntax.Sig_bundle
              ...
              let uu___3 =
                FStarC_List.map
                  (fun se ->
                     let uu___4 = FStarC_Syntax_Util.lids_of_sigelt se in
                     (uu___4, se)) ses in
              (env3, uu___3)
          | uu___2 ->
              let uu___3 =
                let uu___4 =
                  let uu___5 = FStarC_Syntax_Util.lids_of_sigelt s in
                  (uu___5, s) in
                [uu___4] in
              (env3, uu___3) in
        match uu___ with
        | (env4, lss) ->
            let push_top_level_def id =
              fun stack ->
                match stack with
                | (Top_level_defs ids)::rest ->
                    let uu___2 =
                      let uu___3 =
                        let uu___4 = FStarC_Ident.string_of_id id in
                        FStarC_PSMap.add ids uu___4 true in
                      Top_level_defs uu___3 in
                    uu___2 :: rest
                | uu___2 ->
                    let uu___3 =
                      let uu___4 =
                        let uu___5 = FStarC_PSMap.empty () in
                        let uu___6 = FStarC_Ident.string_of_id id in
                        FStarC_PSMap.add uu___5 uu___6 true in
                      Top_level_defs uu___4 in
                    uu___3 :: stack in
            (FStarC_List.iter
               (fun uu___3 ->
                  match uu___3 with
                  | (lids, se) ->
                      FStarC_List.iter
                        (fun lid ->
                           (let uu___5 =
                              let uu___6 = FStarC_Ident.ident_of_lid lid in
                              let uu___7 = FStarC_Effect.op_Bang globals in
                              push_top_level_def uu___6 uu___7 in
                            FStarC_Effect.op_Colon_Equals globals uu___5);
                           (match () with
                            | () ->
                                let modul =
                                  let uu___5 =
                                ...
                                ((let uu___6 = get_exported_id_set env4 modul in
                                  match uu___6 with
                                        ...
                                        Obj.magic
                                          (FStarC_Class_Setlike.add ()
                                             (Obj.magic
                                                (FStarC_RBSet.setlike_rbset
                                                   FStarC_Class_Ord.ord_string))
                                             uu___8 (Obj.magic uu___9)) in
                                      FStarC_Effect.op_Colon_Equals
                                        my_exported_ids uu___7
                                  | FStar_Pervasives_Native.None -> ());
                                 (match () with
                                  | () ->
                                      let is_iface =
                                      ...
                                      FStarC_SMap.add (sigmap env4) uu___6
                                        (se,
                                          (env4.iface &&
                                             (Prims.op_Negation
                                                env4.admitted_iface)))))))
    ...
    fun lid ->
              ...
              let uu___14 =
                let uu___15 =
                  let uu___16 =
                    let uu___17 =
                      let uu___18 =
                        FStarC_Syntax_Util.arrow_formals_comp_ln t in
                      FStar_Pervasives_Native.fst uu___18 in
                    FStarC_List.splitAt num_ty_params uu___17 in
      ...
      (let uu___2 = FStarC_Effect.op_Bang debug in
       ...
       then
         ...
         FStarC_Util.print_endline uu___3
       else ());
      result
                             ...
                             let with_id_range =
                               let uu___4 =
                                 FStarC_Ident.range_of_id
                                   (FStarC_Util.dflt id renamed) in
              ...
              let l2 =
                ...
                let uu___ =
                  ...
                  FStarC_List.map
                    (fun uu___3 ->
                       match uu___3 with
                       | (uu___4, lid) -> (lid, FStar_Pervasives_Native.None))
                    uu___2 in
                                        ...
                                        FStarC_Util.map_opt renamed
                                          (fun renamed1 ->
                                             let uu___9 =
                                               ...
                                               FStarC_Syntax_Util.mk_field_projector_name_from_ident
                                                 uu___10 binder in
                                             FStarC_Ident.ident_of_lid uu___9) in
                                     ...
                                     FStarC_List.map
                                       (fun uu___10 ->
                                          ...
                                          | (x, y) ->
                                              ...
                                              let uu___12 =
                                                FStarC_Util.map_opt y
                                                  FStarC_Ident.ident_of_lid in
                                              (uu___11, uu___12)) uu___9 in
                                   FStarC_List.filter
                                     (fun uu___9 ->
                                        match uu___9 with
                                        | (x, uu___10) -> name_exists x)
                                     uu___8 in
                                 let uu___8 =
                                   let uu___9 =
                  ...
                  FStarC_List.mapi
                    (fun i ->
                       fun uu___ ->
                         match uu___ with
                         | (id, renamed) ->
                             ((FStarC_Util.dflt id renamed), i)) l3 in
                let uu___ =
                ...
                | FStar_Pervasives_Native.Some (id, i) ->
                    ...
                    ((let uu___3 =
                               ...
                               | (other, uu___5) ->
                                   let nth1 =
                                     ...
                                     | uu___6 when uu___6 = Prims.int_zero ->
                                         "first"
                                     | uu___6 when uu___6 = Prims.int_one ->
                                         "second"
                                     | uu___6 when
                                         uu___6 = (Prims.of_int (2)) ->
                                         "third"
                                     | nth2 ->
                                         let uu___6 =
                                           FStarC_Class_Show.show
                     ...
                     (let uu___3 =
                        ...
                        let uu___5 = FStarC_Ident.string_of_id id in
                        FStarC_Util.format1 uu___4 uu___5 in
                          ...
                          let uu___4 =
                            let uu___5 =
                              let uu___6 =
                                ...
                                FStarC_Util.format1
                                  "Definition %s cannot be found." uu___7 in
                ...
                FStarC_Util.for_some
                  (fun m ->
                     let uu___4 =
                       ...
                       Prims.strcat uu___5 "." in
                     let uu___5 =
                       let uu___6 = FStarC_Ident.string_of_lid ns in
                       Prims.strcat uu___6 "." in
                     FStarC_Util.starts_with uu___4 uu___5) module_names1 in
              if uu___3
                ...
                (let uu___5 =
                   let uu___6 =
                     let uu___7 =
                       ...
                       FStarC_Util.format1 "Namespace '%s' cannot be found."
                         uu___8 in
                     FStarC_Errors_Msg.text uu___7 in
                   let uu___7 =
                     let uu___8 =
                       let uu___9 = FStarC_Ident.string_of_lid ns in
                       let uu___10 =
      ...
      fun restriction ->
             ...
             (let env2 =
              ...
              (let uu___4 = FStarC_SMap.try_find env2.includes curmod in
               ...
               | FStar_Pervasives_Native.Some incl ->
                   let uu___5 =
                     let uu___6 = FStarC_Effect.op_Bang incl in
                     (ns1, restriction) :: uu___6 in
                              ...
                              let update_exports k =
                                ...
                                (match () with
                                 | () ->
                                     ...
                                     let uu___9 =
                                       let uu___10 =
                                         FStarC_Effect.op_Bang trans_ex in
                                       Obj.magic
                                         (FStarC_Class_Setlike.union ()
                                            ...
                                            (Obj.magic uu___10)
                                            (Obj.magic ns_ex)) in
                                     FStarC_Effect.op_Colon_Equals trans_ex
                                       uu___9) in
                              FStarC_List.iter update_exports
        ...
        | uu___2 ->
            let uu___3 =
              ...
              FStarC_Util.format1 "include: Module %s cannot be found" uu___4 in
            FStarC_Errors.raise_error FStarC_Ident.hasrange_lident ns
    ...
    fun x ->
      fun l ->
        ...
        then
          ...
          (let uu___3 =
             let uu___4 = FStarC_Ident.string_of_lid l in
             FStarC_Util.format1 "Module %s cannot be found" uu___4 in
           FStarC_Errors.raise_error FStarC_Ident.hasrange_lident l
             FStarC_Errors_Codes.Fatal_ModuleNotFound ()
             (Obj.magic FStarC_Errors_Msg.is_error_message_string)
             (Obj.magic uu___3))
                 ...
                 FStarC_List.iter
                   (fun se1 ->
                      ...
                      | FStarC_Syntax_Syntax.Sig_datacon
                          ...
                          FStarC_SMap.remove (sigmap env1) uu___9
                      | FStarC_Syntax_Syntax.Sig_inductive_typ
                          ...
                          ((let uu___8 = FStarC_Ident.string_of_lid lid in
                           ...
                           then
                             (let sigel =
                              ...
                              let uu___8 = FStarC_Ident.string_of_lid lid in
                              FStarC_SMap.add (sigmap env1) uu___8
                                (se2, false))
                           else ())
                      | uu___3 -> ()) ses
               else ()
  ...
  fun uu___ ->
    FStarC_Util.atomically
      (fun uu___2 ->
         ...
         | env1::tl ->
             (pop_record_cache ();
              FStarC_Effect.op_Colon_Equals stack tl;
              env1)
...
let (as_exported_ids : exported_id_set -> exported_ids) =
  fun e ->
    ...
    let fields =
      let uu___ = e Exported_id_field in FStarC_Effect.op_Bang uu___ in
...
let (__proj__Mkmodule_inclusion_info__item__mii_no_prelude :
  module_inclusion_info -> Prims.bool) =
  fun projectee ->
    match projectee with
    | { mii_exported_ids; mii_trans_exported_ids; mii_includes;
  ...
  fun env1 ->
    fun l ->
      ...
      let as_ids_opt m =
        ...
        FStarC_Util.map_opt uu___ as_exported_ids in
      ...
      let uu___3 =
        ...
        FStarC_Util.map_opt uu___4 (fun r -> FStarC_Effect.op_Bang r) in
      {
          ...
          fun mii ->
            let prep env2 =
              let filename =
                ...
                FStarC_Util.strcat uu___ ".fst" in
              let auto_open =
                if mii.mii_no_prelude then [] else FStarC_Parser_Dep.prelude in
              let auto_open1 =
              ...
              let namespace_of_module =
                let uu___ =
                  let uu___2 =
                    ...
                    FStarC_List.length uu___3 in
                  uu___2 > Prims.int_zero in
                if uu___
                then
                  let uu___2 =
                    let uu___3 =
                      let uu___4 = FStarC_Ident.ns_of_lid mname in
                      FStarC_Ident.lid_of_ids uu___4 in
                    (uu___3, FStarC_Syntax_Syntax.Open_namespace,
                      FStarC_Syntax_Syntax.Unrestricted) in
                  [uu___2]
                else [] in
              let auto_open2 =
                FStarC_List.op_At namespace_of_module
                  (FStarC_List.rev auto_open1) in
                               ...
                               (FStarC_List.iter
                                  (fun op ->
                                     (env2.ds_hooks).ds_push_open_hook env'
                                       op) (FStarC_List.rev auto_open2);
                                env')))))) in
            let uu___ =
              FStarC_Util.find_opt
                (fun uu___2 ->
                   match uu___2 with
                   | (l, uu___3) -> FStarC_Ident.lid_equals l mname)
                env1.modules in
            match uu___ with
            | FStar_Pervasives_Native.None ->
                let uu___2 = prep env1 in (uu___2, false)
            | FStar_Pervasives_Native.Some (uu___2, m) ->
                ((let uu___4 =
                 ...
                 (let uu___4 = let uu___5 = push env1 in prep uu___5 in
                  (uu___4, true)))
      ...
      fun lid ->
        ...
        | FStar_Pervasives_Native.None ->
            ...
            then
              let uu___3 =
                let uu___4 =
                  let uu___5 = FStarC_Errors_Msg.text "Identifier not found:" in
                  let uu___6 =
                ...
                let uu___5 =
                  let uu___6 =
                    ...
                    let uu___8 = all_local_names env1 in
                    typo_msg uu___7 uu___8 in
                  [uu___6] in
                uu___4 :: uu___5 in
                       ...
                       FStarC_List.fold_right
                         (fun i ->
                            fun r ->
                              ...
                              FStarC_Range_Ops.union_ranges uu___6 r) t
                         uu___5 in
               ...
               | FStar_Pervasives_Native.None ->
                   let uu___5 =
                     let uu___6 =
                       let uu___7 = FStarC_Pprint.break_ Prims.int_one in
                       let uu___8 =
                         let uu___9 = FStarC_Errors_Msg.text "Module name" in
                         let uu___10 =
                           let uu___11 =
                     ...
                     uu___6 :: uu___7 in
                   FStarC_Errors.raise_error FStarC_Ident.hasrange_lident
                     modul1 FStarC_Errors_Codes.Fatal_IdentifierNotFound ()
                     (Obj.magic FStarC_Errors_Msg.is_error_message_list_doc)
                     (Obj.magic uu___5)
                   ...
                   let uu___5 =
                     ...
                     let uu___7 =
                       let uu___8 =
                         ...
                         then
                           let uu___10 =
                             FStarC_Errors_Msg.text "Opened modules =" in
                           let uu___11 =
                             FStarC_Errors_Msg.text
                               (FStarC_String.concat ", " opened_modules) in
                           FStarC_Pprint.op_Hat_Slash_Hat uu___10 uu___11
               ...
               | FStar_Pervasives_Native.Some modul' ->
                   let uu___5 =
                     let uu___6 =
                       let uu___7 = FStarC_Pprint.break_ Prims.int_one in
                       let uu___8 =
                         let uu___9 = FStarC_Errors_Msg.text "Identifier" in
                         let uu___10 =
                           let uu___11 =
                             let uu___12 = FStarC_Ident.ident_of_lid lid in
                           ...
                           let uu___12 =
                             ...
                             let uu___14 =
                               let uu___15 =
                                 FStarC_Class_PP.pp
                                   FStarC_Ident.pretty_lident modul1 in
                               let uu___16 =
                                 let uu___17 =
                                   let uu___18 =
                                     FStarC_Class_Deq.op_Less_Greater_Question
                                       FStarC_Syntax_Syntax.deq_fv modul1
                                       modul' in
                                   if uu___18
                                   then
                                     let uu___19 =
  ...
  fun e ->
    fun name ->
      ...
      | FStar_Pervasives_Native.Some (Eff_name (se, l)) ->
          ...
          FStar_Pervasives_Native.Some uu___2
let (set_no_prelude : env -> Prims.bool -> env) =
  fun e ->
    fun b ->
      {
        curmodule = (e.curmodule);
