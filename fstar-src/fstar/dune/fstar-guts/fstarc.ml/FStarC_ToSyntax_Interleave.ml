...
let (is_definition_of :
  ...
  fun x ->
    fun d ->
      ...
      FStarC_Util.for_some (id_eq_lid x) uu___
      ...
      fun env ->
        ...
        | FStar_Pervasives_Native.Some uu___1 ->
            let uu___2 =
              ...
              FStarC_Util.format1 "Interface %s has already been processed"
                uu___3 in
        ...
        | (decls, env1) ->
            ((let uu___2 =
              ...
              then
                ...
                FStarC_Util.print1 "Interleaved decls:\n%s\n" uu___3
              else ());
             (decls, env1))
                        ...
                        fun impl ->
                          ...
                          | (iface2, impls1) ->
                              ...
                              (match uu___3 with
                               | (iface3, impls') ->
                                   (iface3,
                                     (FStarC_List.op_At impls1 impls'))))
                     (iface1, []) impls in
                 (match uu___1 with
                  | (iface2, impls1) ->
                      let uu___2 =
