        ...
        fun a ->
          fun r ->
            ...
            then
              ...
              FStarC_Syntax_Syntax.withinfo (FStarC_Syntax_Syntax.Pat_var a)
                r in
                     ...
                     let uu___3 =
                       ...
                       FStarC_TypeChecker_Env.new_implicit_var_aux
                         ...
                         (FStarC_Syntax_Syntax.Allow_untyped
                            "pattern bv type") FStar_Pervasives_Native.None
                         false in
                     (match uu___3 with
                      | (t_x, uu___4, guard) ->
                          let x1 =
                          ...
                          (x1, guard, uu___5))) in
          let rec pat_as_arg_with_env env1 =
            fun p1 ->
              match p1.FStarC_Syntax_Syntax.v with
              | FStarC_Syntax_Syntax.Pat_constant c ->
                  let e =
                        ...
                        (let uu___1 = FStarC_Syntax_Util.type_u () in
                         ...
                         | (k, uu___2) ->
                             let uu___3 =
                               FStarC_TypeChecker_Env.new_implicit_var_aux
                                 "pat_dot_term type"
                                 p1.FStarC_Syntax_Syntax.p env1 k
                             ...
                             (match uu___3 with
                              | (t, uu___4, g) ->
                                  let uu___5 =
                                    FStarC_TypeChecker_Env.new_implicit_var_aux
                                      "pat_dot_term"
                                      p1.FStarC_Syntax_Syntax.p env1 t
                                      (FStarC_Syntax_Syntax.Allow_ghost
                                         "pat dot term")
                                      FStar_Pervasives_Native.None false in
                                  (match uu___5 with
                  ...
                  (match uu___ with
                   | (b, a, w, env2, args, guard, pats1) ->
                       ...
                       let uu___1 =
                         ...
                         then
                           let uu___2 = inst_head hd us_opt in
                           (uu___2, us_opt)
                         else
                           (let uu___3 =
          ...
          let one_pat env1 =
            fun p1 ->
              ...
              | (b, a, w, env2, arg, guard, p3) ->
                  let uu___1 =
                    FStarC_Util.find_dup FStarC_Syntax_Syntax.bv_eq b in
                  (match uu___1 with
