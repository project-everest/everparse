    ...
    fun mllibs ->
      ...
      then
        ...
        | FStar_Pervasives_Native.Some (FStarC_Options.FSharp) ->
            ...
            let uu___ = FStarC_List.map FStar_Pervasives_Native.snd mllibs in
            FStarC_List.iter (FStarC_Extraction_ML_PrintML.print outdir ext)
              uu___
                               ...
                               | (mname, modul, uu___3) ->
                                   ...
                                   (match modul with
                                    | FStar_Pervasives_Native.Some
                                        ...
                                        FStarC_Util.save_value_to_file uu___5
                                          (deps, bindings, decls)
                                    | FStar_Pervasives_Native.None ->
                                        failwith
                   ...
                   then
                     let uu___5 =
                       ...
                       let uu___7 =
                         let uu___8 =
                           let uu___9 =
                             FStarC_Util.format1 "Module %s was not checked."
                               fn in
...
let (needs_interleaving : Prims.string -> Prims.string -> Prims.bool) =
  fun intf ->
    fun impl ->
      ...
      ((m1 = m2) &&
         (let uu___ = FStarC_Util.get_file_extension intf in
          FStarC_List.mem uu___ ["fsti"; "fsi"]))
        &&
        (let uu___ = FStarC_Util.get_file_extension impl in
  ...
  fun filenames ->
    fun dep_graph ->
      (let uu___1 = FStarC_Effect.op_Bang dbg_dep in
       if uu___1
       then
         (FStarC_Util.print_endline "Auto-deps kicked in; here's some info.";
          FStarC_Util.print1
