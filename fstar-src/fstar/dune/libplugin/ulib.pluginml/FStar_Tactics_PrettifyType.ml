...
open Prims
type ('s, 'a) named = 'a
let (fakeunit : Fstarcompiler.FStarC_Reflection_Types.term) =
  Fstarcompiler.FStarC_Reflection_V2_Builtins.pack_ln
    (Fstarcompiler.FStarC_Reflection_V2_Data.Tv_FVar
       (Fstarcompiler.FStarC_Reflection_V2_Builtins.pack_fv ["Prims"; "unit"]))
...
let (add_suffix :
  ...
  fun s ->
    fun nm ->
      Fstarcompiler.FStarC_Reflection_V2_Builtins.explode_qn
        (Prims.strcat
           (Fstarcompiler.FStarC_Reflection_V2_Builtins.implode_qn nm) s)
let (add_prefix :
  Prims.string ->
    Fstarcompiler.FStarC_Reflection_Types.name ->
      Fstarcompiler.FStarC_Reflection_Types.name)
...
type cfg_t =
  ...
  at: parsed_type ;
  fat: flat_type ;
  orig_tynm: Fstarcompiler.FStarC_Reflection_Types.name ;
  pretty_tynm: Fstarcompiler.FStarC_Reflection_Types.name ;
...
let (__proj__Mkcfg_t__item__orig_tynm :
  cfg_t -> Fstarcompiler.FStarC_Reflection_Types.name) =
  fun projectee ->
...
let (__proj__Mkcfg_t__item__ctors :
  cfg_t -> Fstarcompiler.FStarC_Reflection_V2_Data.ctor Prims.list) =
  fun projectee ->
    match projectee with
...
let (mk_ctor :
  Fstarcompiler.FStarC_Reflection_Types.name ->
    Prims.string ->
      prod_type ->
        (Fstarcompiler.FStarC_Reflection_V2_Data.ctor, unit)
                                                            ...
                                                            (FStar_Tactics_Effect.tac_bind
                                                               ...
                                                               (fun uu___6 ->
                                                                  (fun
                                                                    ...
                                                                    ->
                                                                    Prims.op_Negation
                                                                    (Fstarcompiler.FStarC_Reflection_V2_Data.uu___is_Unfold_for_unification_and_vcgen
                                                                    q))))
                                                                    uu___21)
                                                                    quals in
                                                                    FStar_Tactics_Effect.tac_bind
                                                                    ...
                                                                    ->
                                                                    Prims.op_Negation
                                                                    ((Fstarcompiler.FStarC_Reflection_V2_Data.uu___is_Noeq
                                                                    q) ||
                                                                    (Fstarcompiler.FStarC_Reflection_V2_Data.uu___is_Unopteq
                                                                    q)))))
                                                                    uu___22)
                                                                    quals in
                                                                    FStar_Tactics_Effect.tac_bind
