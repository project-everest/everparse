    ...
    fun t2 ->
      ...
      FStar_Tactics_Effect.tac_bind
        (FStar_Sealed.seal
           (Obj.magic
              (FStar_Range.mk_range "FStar.Tactics.LaxTermEq.fst"
                 (Prims.of_int (78)) (Prims.of_int (11)) (Prims.of_int (78))
                 (Prims.of_int (22)))))
        (FStar_Sealed.seal
           (Obj.magic
              (FStar_Range.mk_range "FStar.Tactics.LaxTermEq.fst"
                 (Prims.of_int (78)) (Prims.of_int (25)) (Prims.of_int (145))
                 (Prims.of_int (14))))) (Obj.magic uu___)
        (fun uu___1 ->
           (fun t11 ->
            ...
            (FStar_Sealed.seal
               (Obj.magic
                  (FStar_Range.mk_range "FStar.Tactics.LaxTermEq.fst"
                     ...
                     (Prims.of_int (148)) (Prims.of_int (18)))))
            (FStar_Sealed.seal
               (Obj.magic
                  (FStar_Range.mk_range "FStar.Tactics.LaxTermEq.fst"
                     (Prims.of_int (148)) (Prims.of_int (2))
                     (Prims.of_int (148)) (Prims.of_int (49)))))
            (Obj.magic uu___2)
            (fun uu___3 ->
               (fun uu___3 ->
                  if uu___3
        ...
        (FStar_Sealed.seal
           (Obj.magic
              (FStar_Range.mk_range "FStar.Tactics.LaxTermEq.fst"
                 ...
                 (Prims.of_int (164)) (Prims.of_int (11)))))
        (Obj.magic uu___)
        (fun uu___1 ->
           (fun uu___1 ->
              match uu___1 with
                       ...
                       (FStar_Sealed.seal
                          (Obj.magic
                             (FStar_Range.mk_range
                                ...
                                (Prims.of_int (160)) (Prims.of_int (38)))))
                       (FStar_Sealed.seal
                          (Obj.magic
                             (FStar_Range.mk_range
                                "FStar.Tactics.LaxTermEq.fst"
    ...
    fun b2 ->
      ...
      FStar_Tactics_Effect.tac_bind
        ...
        (FStar_Sealed.seal
           (Obj.magic
              (FStar_Range.mk_range "FStar.Tactics.LaxTermEq.fst"
                 (Prims.of_int (167)) (Prims.of_int (32))
                   ...
                   (FStar_Sealed.seal
                      (Obj.magic
                         (FStar_Range.mk_range "FStar.Tactics.LaxTermEq.fst"
                            ...
                            (Prims.of_int (168)) (Prims.of_int (29)))))
                   (FStar_Sealed.seal
                      (Obj.magic
                         (FStar_Range.mk_range "FStar.Tactics.LaxTermEq.fst"
    ...
    fun c2 ->
      ...
      FStar_Tactics_Effect.tac_bind
        ...
        (FStar_Sealed.seal
           (Obj.magic
              (FStar_Range.mk_range "FStar.Tactics.LaxTermEq.fst"
                 (Prims.of_int (174)) (Prims.of_int (30))
                   ...
                   (FStar_Sealed.seal
                      (Obj.magic
                         (FStar_Range.mk_range "FStar.Tactics.LaxTermEq.fst"
                            ...
                            (Prims.of_int (175)) (Prims.of_int (27)))))
                   (FStar_Sealed.seal
                      (Obj.magic
                         (FStar_Range.mk_range "FStar.Tactics.LaxTermEq.fst"
    ...
    fun br2 ->
      let uu___ =
        ...
        FStar_Tactics_Effect.tac_bind
          ...
          (FStar_Sealed.seal
             (Obj.magic
                (FStar_Range.mk_range "FStar.Tactics.LaxTermEq.fst"
                   (Prims.of_int (200)) (Prims.of_int (5))
                   (Prims.of_int (200)) (Prims.of_int (38)))))
          (Obj.magic uu___1)
          (fun uu___2 ->
             FStar_Tactics_Effect.lift_div_tac
      ...
      FStar_Tactics_Effect.tac_bind
        (FStar_Sealed.seal
           (Obj.magic
              (FStar_Range.mk_range "FStar.Tactics.LaxTermEq.fst"
                 (Prims.of_int (200)) (Prims.of_int (5)) (Prims.of_int (200))
                 (Prims.of_int (38)))))
        (FStar_Sealed.seal
           (Obj.magic
              (FStar_Range.mk_range "FStar.Tactics.LaxTermEq.fst"
                 (Prims.of_int (200)) (Prims.of_int (2)) (Prims.of_int (201))
              ...
              (FStar_Sealed.seal
                 (Obj.magic
                    (FStar_Range.mk_range "FStar.Tactics.LaxTermEq.fst"
                       ...
                       (Prims.of_int (218)) (Prims.of_int (24)))))
              (FStar_Sealed.seal
                 (Obj.magic
                    (FStar_Range.mk_range "FStar.Tactics.LaxTermEq.fst"
            ...
            (FStar_Sealed.seal
               (Obj.magic
                  (FStar_Range.mk_range "FStar.Tactics.LaxTermEq.fst"
                     ...
                     (Prims.of_int (219)) (Prims.of_int (9)))))
            (Obj.magic uu___2)
            (fun uu___3 ->
               FStar_Tactics_Effect.lift_div_tac
                 (fun uu___4 -> if uu___3 then false else b1 = b2))
let (lax_term_eq :
    ...
    fun t2 ->
      ...
      FStar_Tactics_Effect.tac_bind
        ...
        (FStar_Sealed.seal
           (Obj.magic
              (FStar_Range.mk_range "FStar.Tactics.LaxTermEq.fst"
                 (Prims.of_int (222)) (Prims.of_int (6)) (Prims.of_int (222))
