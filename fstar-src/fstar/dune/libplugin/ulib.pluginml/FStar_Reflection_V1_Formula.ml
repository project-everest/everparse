    ...
    let uu___ =
      Obj.magic
        (FStar_Tactics_Effect.lift_div_tac
           (fun uu___1 ->
              Fstarcompiler.FStarC_Reflection_V1_Builtins.inspect_bv bv)) in
         ...
         (fun bvv ->
            Obj.magic
              (FStarC_Tactics_Unseal.unseal
                 bvv.Fstarcompiler.FStarC_Reflection_V1_Data.bv_ppname))
           uu___1)
let rec (inspect_unascribe :
  Fstarcompiler.FStarC_Reflection_Types.term ->
    (Fstarcompiler.FStarC_Reflection_V1_Data.term_view, unit)
...
let (collect_app :
  ...
  = collect_app' []
type comparison =
  | Eq of Fstarcompiler.FStarC_Reflection_Types.typ
  FStar_Pervasives_Native.option 
  | BoolEq of Fstarcompiler.FStarC_Reflection_Types.typ
  FStar_Pervasives_Native.option 
  | Lt 
  | Le 
  | Gt 
...
type formula =
  | True_ 
  | False_ 
  | Comp of comparison * Fstarcompiler.FStarC_Reflection_Types.term *
  Fstarcompiler.FStarC_Reflection_Types.term 
  | And of Fstarcompiler.FStarC_Reflection_Types.term *
  Fstarcompiler.FStarC_Reflection_Types.term 
  | Or of Fstarcompiler.FStarC_Reflection_Types.term *
  Fstarcompiler.FStarC_Reflection_Types.term 
  | Not of Fstarcompiler.FStarC_Reflection_Types.term 
  | Implies of Fstarcompiler.FStarC_Reflection_Types.term *
  Fstarcompiler.FStarC_Reflection_Types.term 
  | Iff of Fstarcompiler.FStarC_Reflection_Types.term *
  Fstarcompiler.FStarC_Reflection_Types.term 
  | Forall of Fstarcompiler.FStarC_Reflection_Types.bv *
  Fstarcompiler.FStarC_Reflection_Types.typ *
  Fstarcompiler.FStarC_Reflection_Types.term 
  | Exists of Fstarcompiler.FStarC_Reflection_Types.bv *
  Fstarcompiler.FStarC_Reflection_Types.typ *
  Fstarcompiler.FStarC_Reflection_Types.term 
  | App of Fstarcompiler.FStarC_Reflection_Types.term *
  Fstarcompiler.FStarC_Reflection_Types.term 
  | Name of Fstarcompiler.FStarC_Reflection_Types.bv 
  | FV of Fstarcompiler.FStarC_Reflection_Types.fv 
  | IntLit of Prims.int 
  | F_Unknown 
...
let (__proj__Comp__item___1 :
  formula -> Fstarcompiler.FStarC_Reflection_Types.term) =
  fun projectee -> match projectee with | Comp (_0, _1, _2) -> _1
let (__proj__Comp__item___2 :
  formula -> Fstarcompiler.FStarC_Reflection_Types.term) =
...
let (__proj__And__item___0 :
  formula -> Fstarcompiler.FStarC_Reflection_Types.term) =
  fun projectee -> match projectee with | And (_0, _1) -> _0
let (__proj__And__item___1 :
  formula -> Fstarcompiler.FStarC_Reflection_Types.term) =
...
let (__proj__Or__item___0 :
  formula -> Fstarcompiler.FStarC_Reflection_Types.term) =
  fun projectee -> match projectee with | Or (_0, _1) -> _0
let (__proj__Or__item___1 :
  formula -> Fstarcompiler.FStarC_Reflection_Types.term) =
...
let (__proj__Implies__item___0 :
  formula -> Fstarcompiler.FStarC_Reflection_Types.term) =
  fun projectee -> match projectee with | Implies (_0, _1) -> _0
let (__proj__Implies__item___1 :
  formula -> Fstarcompiler.FStarC_Reflection_Types.term) =
...
let (__proj__Iff__item___0 :
  formula -> Fstarcompiler.FStarC_Reflection_Types.term) =
  fun projectee -> match projectee with | Iff (_0, _1) -> _0
let (__proj__Iff__item___1 :
  formula -> Fstarcompiler.FStarC_Reflection_Types.term) =
...
let (__proj__Forall__item___0 :
  formula -> Fstarcompiler.FStarC_Reflection_Types.bv) =
  fun projectee -> match projectee with | Forall (_0, _1, _2) -> _0
let (__proj__Forall__item___1 :
  formula -> Fstarcompiler.FStarC_Reflection_Types.typ) =
  fun projectee -> match projectee with | Forall (_0, _1, _2) -> _1
let (__proj__Forall__item___2 :
  formula -> Fstarcompiler.FStarC_Reflection_Types.term) =
         ...
         fun pred ->
           Obj.magic
             (FStar_Tactics_Effect.lift_div_tac
                (fun uu___ ->
                   Forall
                     ((Fstarcompiler.FStarC_Reflection_V1_Builtins.pack_bv
                         {
                           Fstarcompiler.FStarC_Reflection_V1_Data.bv_ppname
                             =
                             (Fstarcompiler.FStarC_Reflection_V1_Data.as_ppname
                                "x");
  ...
  fun t ->
    ...
    FStar_Tactics_Effect.tac_bind
      ...
      (fun uu___1 ->
         (fun uu___1 ->
            match uu___1 with
            | Fstarcompiler.FStarC_Reflection_V1_Data.Tv_Var n ->
                Obj.magic
                  (Obj.repr
                     (FStar_Tactics_Effect.lift_div_tac
                        (fun uu___2 -> Name n)))
            ...
            | Fstarcompiler.FStarC_Reflection_V1_Data.Tv_App (h0, t1) ->
                Obj.magic
                  (Obj.repr
            ...
            | Fstarcompiler.FStarC_Reflection_V1_Data.Tv_Const
                (Fstarcompiler.FStarC_Reflection_V1_Data.C_Int i) ->
                Obj.magic
                  (Obj.repr
                     (FStar_Tactics_Effect.lift_div_tac
                        (fun uu___2 -> IntLit i)))
            ...
            | Fstarcompiler.FStarC_Reflection_V1_Data.Tv_Type uu___2 ->
                Obj.magic
                  (Obj.repr
                     (FStar_Tactics_Effect.lift_div_tac
                        (fun uu___3 -> F_Unknown)))
            | Fstarcompiler.FStarC_Reflection_V1_Data.Tv_Abs (uu___2, uu___3)
                ->
                Obj.magic
                  (Obj.repr
                     (FStar_Tactics_Effect.lift_div_tac
            ...
            | Fstarcompiler.FStarC_Reflection_V1_Data.Tv_Unsupp ->
                Obj.magic
                  (Obj.repr
                     (FStar_Tactics_Effect.lift_div_tac
                        (fun uu___2 -> F_Unknown)))
            | Fstarcompiler.FStarC_Reflection_V1_Data.Tv_Refine
                ...
                Obj.magic
                  (Obj.repr
                     (FStar_Tactics_Effect.lift_div_tac
                        (fun uu___5 -> F_Unknown)))
            | Fstarcompiler.FStarC_Reflection_V1_Data.Tv_Const uu___2 ->
                Obj.magic
                  (Obj.repr
                     (FStar_Tactics_Effect.lift_div_tac
                        (fun uu___3 -> F_Unknown)))
            | Fstarcompiler.FStarC_Reflection_V1_Data.Tv_BVar uu___2 ->
                Obj.magic
                  (Obj.repr
                     (FStar_Tactics_Effect.lift_div_tac
...
let (formula_as_term_view :
  formula -> Fstarcompiler.FStarC_Reflection_V1_Data.term_view) =
  fun f ->
    let mk_app' tv args =
      FStar_List_Tot_Base.fold_left
        (fun tv1 ->
           fun a ->
             Fstarcompiler.FStarC_Reflection_V1_Data.Tv_App
               ((Fstarcompiler.FStarC_Reflection_V1_Builtins.pack_ln tv1), a))
        tv args in
    let e = Fstarcompiler.FStarC_Reflection_V1_Data.Q_Explicit in
    let i = Fstarcompiler.FStarC_Reflection_V1_Data.Q_Implicit in
    match f with
    | True_ ->
        Fstarcompiler.FStarC_Reflection_V1_Data.Tv_FVar
    ...
    | App (p, q) ->
        Fstarcompiler.FStarC_Reflection_V1_Data.Tv_App
          (p, (q, Fstarcompiler.FStarC_Reflection_V1_Data.Q_Explicit))
    | Name b -> Fstarcompiler.FStarC_Reflection_V1_Data.Tv_Var b
    | FV fv -> Fstarcompiler.FStarC_Reflection_V1_Data.Tv_FVar fv
    | IntLit i1 ->
        Fstarcompiler.FStarC_Reflection_V1_Data.Tv_Const
          (Fstarcompiler.FStarC_Reflection_V1_Data.C_Int i1)
    | F_Unknown -> Fstarcompiler.FStarC_Reflection_V1_Data.Tv_Unknown
let (formula_as_term : formula -> Fstarcompiler.FStarC_Reflection_Types.term)
  =
  fun f ->
    Fstarcompiler.FStarC_Reflection_V1_Builtins.pack_ln
      (formula_as_term_view f)
