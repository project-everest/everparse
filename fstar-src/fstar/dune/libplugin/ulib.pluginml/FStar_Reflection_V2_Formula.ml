...
type formula =
  ...
  | Forall of FStar_Tactics_NamedView.bv *
  Fstarcompiler.FStarC_Reflection_Types.typ * FStar_Tactics_NamedView.term 
  | Exists of FStar_Tactics_NamedView.bv *
  Fstarcompiler.FStarC_Reflection_Types.typ * FStar_Tactics_NamedView.term 
    ...
    fun pred ->
      let b =
        FStar_Tactics_NamedView.pack_bv
          {
            Fstarcompiler.FStarC_Reflection_V2_Data.index = Prims.int_zero;
            Fstarcompiler.FStarC_Reflection_V2_Data.sort1 =
              (FStar_Sealed.seal typ);
            Fstarcompiler.FStarC_Reflection_V2_Data.ppname1 =
              (Fstarcompiler.FStarC_Reflection_V2_Data.as_ppname "x")
          } in
      Forall
        (b, typ,
...
let (formula_as_term_view : formula -> FStar_Tactics_NamedView.term_view) =
  fun f ->
    ...
    let e = Fstarcompiler.FStarC_Reflection_V2_Data.Q_Explicit in
    let i = Fstarcompiler.FStarC_Reflection_V2_Data.Q_Implicit in
    match f with
    | True_ ->
        FStar_Tactics_NamedView.Tv_FVar
    ...
    | App (p, q) ->
        FStar_Tactics_NamedView.Tv_App
          (p, (q, Fstarcompiler.FStarC_Reflection_V2_Data.Q_Explicit))
         ...
         (fun namedvv ->
            Obj.magic
              (FStarC_Tactics_Unseal.unseal
                 namedvv.Fstarcompiler.FStarC_Reflection_V2_Data.ppname))
           uu___1)
