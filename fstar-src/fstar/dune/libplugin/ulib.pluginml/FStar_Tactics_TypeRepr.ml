      ...
      Fstarcompiler.FStarC_Reflection_V2_Builtins.pack_ln
        (Fstarcompiler.FStarC_Reflection_V2_Data.Tv_App
           ((Fstarcompiler.FStarC_Reflection_V2_Builtins.pack_ln
             ...
             (b, Fstarcompiler.FStarC_Reflection_V2_Data.Q_Explicit)))
let (tuple2_ :
  FStar_Tactics_NamedView.term ->
    FStar_Tactics_NamedView.term -> FStar_Tactics_NamedView.term)
  =
  ...
  fun b ->
    let uu___ =
      FStar_Tactics_V2_SyntaxHelpers.collect_app
        b.Fstarcompiler.FStarC_Reflection_V2_Data.sort3 in
    FStar_Tactics_Effect.tac_bind
      (FStar_Sealed.seal
         (Obj.magic
            (FStar_Range.mk_range "FStar.Tactics.TypeRepr.fst"
                                                       ...
                                                       (Fstarcompiler.FStarC_Reflection_V2_Builtins.pack_ln
                                                          (Fstarcompiler.FStarC_Reflection_V2_Data.Tv_Type
                                                             (Fstarcompiler.FStarC_Reflection_V2_Builtins.pack_universe
                                                                Fstarcompiler.FStarC_Reflection_V2_Data.Uv_Unk)))) in
                                                FStar_Tactics_Effect.tac_bind
                                                  (FStar_Sealed.seal
                                                     (Obj.magic
                                                        (FStar_Range.mk_range
