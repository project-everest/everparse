open Fstarcompiler
open Prims
type namedv = Fstarcompiler.FStarC_Reflection_V2_Data.namedv_view
type bv = Fstarcompiler.FStarC_Reflection_V2_Data.bv_view
type comp = Fstarcompiler.FStarC_Reflection_V2_Data.comp_view
type binding = Fstarcompiler.FStarC_Reflection_V2_Data.binding
type term = Fstarcompiler.FStarC_Reflection_Types.term
type universe = Fstarcompiler.FStarC_Reflection_Types.universe
type binder =
  {
  uniq: Prims.nat ;
  ppname: Fstarcompiler.FStarC_Reflection_V2_Data.ppname_t ;
  sort: Fstarcompiler.FStarC_Reflection_Types.typ ;
  qual: Fstarcompiler.FStarC_Reflection_V2_Data.aqualv ;
...
let (__proj__Mkbinder__item__ppname :
  binder -> Fstarcompiler.FStarC_Reflection_V2_Data.ppname_t) =
  fun projectee ->
    match projectee with | { uniq; ppname; sort; qual; attrs;_} -> ppname
let (__proj__Mkbinder__item__sort :
  binder -> Fstarcompiler.FStarC_Reflection_Types.typ) =
  fun projectee ->
    match projectee with | { uniq; ppname; sort; qual; attrs;_} -> sort
let (__proj__Mkbinder__item__qual :
  binder -> Fstarcompiler.FStarC_Reflection_V2_Data.aqualv) =
  fun projectee ->
...
type named_universe_view =
  | Uv_Zero 
  | Uv_Succ of universe 
  | Uv_Max of Fstarcompiler.FStarC_Reflection_V2_Data.universes 
  | Uv_BVar of Prims.nat 
  | Uv_Name of univ_name 
  | Uv_Unif of Fstarcompiler.FStarC_Reflection_Types.universe_uvar 
  | Uv_Unk 
...
let (__proj__Uv_Max__item___0 :
  named_universe_view -> Fstarcompiler.FStarC_Reflection_V2_Data.universes) =
...
let (__proj__Uv_Unif__item___0 :
  named_universe_view -> Fstarcompiler.FStarC_Reflection_Types.universe_uvar)
...
type pattern__Pat_Constant__payload =
  {
  c: Fstarcompiler.FStarC_Reflection_V2_Data.vconst }
and pattern__Pat_Cons__payload =
  {
  head: Fstarcompiler.FStarC_Reflection_Types.fv ;
  univs:
...
and pattern__Pat_Var__payload =
  {
  v: namedv ;
  sort1: Fstarcompiler.FStarC_Reflection_Types.typ FStar_Sealed.sealed }
...
let (__proj__Mkpattern__Pat_Cons__payload__item__head :
  pattern__Pat_Cons__payload -> Fstarcompiler.FStarC_Reflection_Types.fv) =
...
let (__proj__Mkpattern__Pat_Var__payload__item__sort :
  pattern__Pat_Var__payload ->
    Fstarcompiler.FStarC_Reflection_Types.typ FStar_Sealed.sealed)
...
type named_term_view =
  | Tv_Var of namedv 
  | Tv_BVar of bv 
  | Tv_FVar of Fstarcompiler.FStarC_Reflection_Types.fv 
  | Tv_UInst of Fstarcompiler.FStarC_Reflection_Types.fv *
  Fstarcompiler.FStarC_Reflection_V2_Data.universes 
  | Tv_App of term * Fstarcompiler.FStarC_Reflection_V2_Data.argv 
  | Tv_Abs of binder * term 
  | Tv_Arrow of binder * comp 
  | Tv_Type of universe 
  | Tv_Refine of simple_binder * term 
  | Tv_Const of Fstarcompiler.FStarC_Reflection_V2_Data.vconst 
  | Tv_Uvar of Prims.nat *
...
let (__proj__Tv_FVar__item__v :
  named_term_view -> Fstarcompiler.FStarC_Reflection_Types.fv) =
...
let (__proj__Tv_UInst__item__us :
  named_term_view -> Fstarcompiler.FStarC_Reflection_V2_Data.universes) =
...
let (__proj__Tv_App__item__a :
  named_term_view -> Fstarcompiler.FStarC_Reflection_V2_Data.argv) =
...
let (__proj__Tv_Const__item___0 :
  named_term_view -> Fstarcompiler.FStarC_Reflection_V2_Data.vconst) =
...
let (__proj__Tv_Uvar__item___1 :
  named_term_view -> Fstarcompiler.FStarC_Reflection_Types.ctx_uvar_and_subst)
...
type letbinding =
  {
  lb_fv: Fstarcompiler.FStarC_Reflection_Types.fv ;
  lb_us: univ_name Prims.list ;
  lb_typ: Fstarcompiler.FStarC_Reflection_Types.typ ;
  lb_def: term }
...
let (__proj__Mkletbinding__item__lb_fv :
  letbinding -> Fstarcompiler.FStarC_Reflection_Types.fv) =
  fun projectee ->
...
let (__proj__Mkletbinding__item__lb_typ :
  letbinding -> Fstarcompiler.FStarC_Reflection_Types.typ) =
  fun projectee ->
...
and named_sigelt_view__Sg_Inductive__payload =
  {
  nm: Fstarcompiler.FStarC_Reflection_Types.name ;
  univs1: univ_name Prims.list ;
  params: binders ;
  typ: Fstarcompiler.FStarC_Reflection_Types.typ ;
  ctors: Fstarcompiler.FStarC_Reflection_V2_Data.ctor Prims.list }
and named_sigelt_view__Sg_Val__payload =
  {
  nm1: Fstarcompiler.FStarC_Reflection_Types.name ;
  univs2: univ_name Prims.list ;
  typ1: Fstarcompiler.FStarC_Reflection_Types.typ }
...
let (__proj__Mknamed_sigelt_view__Sg_Inductive__payload__item__ctors :
  named_sigelt_view__Sg_Inductive__payload ->
    Fstarcompiler.FStarC_Reflection_V2_Data.ctor Prims.list)
  =
  fun projectee ->
    match projectee with
...
let (binder_to_binding : binder -> binding) =
  fun b ->
    {
      Fstarcompiler.FStarC_Reflection_V2_Data.uniq1 = (b.uniq);
      Fstarcompiler.FStarC_Reflection_V2_Data.sort3 = (b.sort);
      Fstarcompiler.FStarC_Reflection_V2_Data.ppname3 = (b.ppname)
    }
let (binding_to_binder : binding -> binder) =
  fun bnd ->
    {
      uniq = (bnd.Fstarcompiler.FStarC_Reflection_V2_Data.uniq1);
      ppname = (bnd.Fstarcompiler.FStarC_Reflection_V2_Data.ppname3);
      sort = (bnd.Fstarcompiler.FStarC_Reflection_V2_Data.sort3);
      qual = Fstarcompiler.FStarC_Reflection_V2_Data.Q_Explicit;
      attrs = []
    }
let (namedv_to_binder : namedv -> term -> binder) =
  fun v ->
    fun sort ->
      {
        uniq = (v.Fstarcompiler.FStarC_Reflection_V2_Data.uniq);
        ppname = (v.Fstarcompiler.FStarC_Reflection_V2_Data.ppname);
        sort;
        qual = Fstarcompiler.FStarC_Reflection_V2_Data.Q_Explicit;
        attrs = []
      }
...
let (open_universe_view :
  Fstarcompiler.FStarC_Reflection_V2_Data.universe_view ->
    named_universe_view)
  =
  fun v ->
    match v with
    | Fstarcompiler.FStarC_Reflection_V2_Data.Uv_Zero -> Uv_Zero
    | Fstarcompiler.FStarC_Reflection_V2_Data.Uv_Succ u -> Uv_Succ u
    | Fstarcompiler.FStarC_Reflection_V2_Data.Uv_Max us -> Uv_Max us
    | Fstarcompiler.FStarC_Reflection_V2_Data.Uv_BVar n -> Uv_BVar n
    | Fstarcompiler.FStarC_Reflection_V2_Data.Uv_Name i ->
        Uv_Name (Fstarcompiler.FStarC_Reflection_V2_Builtins.inspect_ident i)
    | Fstarcompiler.FStarC_Reflection_V2_Data.Uv_Unif uvar -> Uv_Unif uvar
    | Fstarcompiler.FStarC_Reflection_V2_Data.Uv_Unk -> Uv_Unk
let (inspect_universe : universe -> named_universe_view) =
  fun u ->
    let v = Fstarcompiler.FStarC_Reflection_V2_Builtins.inspect_universe u in
...
let (close_universe_view :
  ...
  fun v ->
    match v with
    | Uv_Zero -> Fstarcompiler.FStarC_Reflection_V2_Data.Uv_Zero
    | Uv_Succ u -> Fstarcompiler.FStarC_Reflection_V2_Data.Uv_Succ u
    | Uv_Max us -> Fstarcompiler.FStarC_Reflection_V2_Data.Uv_Max us
    | Uv_BVar n -> Fstarcompiler.FStarC_Reflection_V2_Data.Uv_BVar n
    | Uv_Name i ->
        Fstarcompiler.FStarC_Reflection_V2_Data.Uv_Name
          (Fstarcompiler.FStarC_Reflection_V2_Builtins.pack_ident i)
    | Uv_Unif uvar -> Fstarcompiler.FStarC_Reflection_V2_Data.Uv_Unif uvar
    | Uv_Unk -> Fstarcompiler.FStarC_Reflection_V2_Data.Uv_Unk
let (pack_universe : named_universe_view -> universe) =
  fun uv ->
    let uv1 = close_universe_view uv in
    Fstarcompiler.FStarC_Reflection_V2_Builtins.pack_universe uv1
let _ =
  Fstarcompiler.FStarC_Tactics_Native.register_plugin
...
let (__binding_to_binder :
  binding -> Fstarcompiler.FStarC_Reflection_Types.binder -> binder) =
  fun bnd ->
    fun b ->
      {
        uniq = (bnd.Fstarcompiler.FStarC_Reflection_V2_Data.uniq1);
        ...
        sort = (bnd.Fstarcompiler.FStarC_Reflection_V2_Data.sort3);
        qual =
          ((Fstarcompiler.FStarC_Reflection_V2_Builtins.inspect_binder b).Fstarcompiler.FStarC_Reflection_V2_Data.qual);
        attrs =
          ((Fstarcompiler.FStarC_Reflection_V2_Builtins.inspect_binder b).Fstarcompiler.FStarC_Reflection_V2_Data.attrs)
      }
let (r_binder_to_namedv :
  binder -> Fstarcompiler.FStarC_Reflection_Types.namedv) =
  fun b ->
    Fstarcompiler.FStarC_Reflection_V2_Builtins.pack_namedv
      {
        Fstarcompiler.FStarC_Reflection_V2_Data.uniq = (b.uniq);
        Fstarcompiler.FStarC_Reflection_V2_Data.sort =
          (FStar_Sealed.seal b.sort);
        Fstarcompiler.FStarC_Reflection_V2_Data.ppname = (b.ppname)
      }
let (open_binder :
           ...
           (fun uu___1 ->
              {
                uniq = n;
                ppname =
                  ((Fstarcompiler.FStarC_Reflection_V2_Builtins.inspect_binder
                      b).Fstarcompiler.FStarC_Reflection_V2_Data.ppname2);
                sort =
                  ((Fstarcompiler.FStarC_Reflection_V2_Builtins.inspect_binder
                      b).Fstarcompiler.FStarC_Reflection_V2_Data.sort2);
                qual =
                  ((Fstarcompiler.FStarC_Reflection_V2_Builtins.inspect_binder
                      b).Fstarcompiler.FStarC_Reflection_V2_Data.qual);
                attrs =
                  ((Fstarcompiler.FStarC_Reflection_V2_Builtins.inspect_binder
                      b).Fstarcompiler.FStarC_Reflection_V2_Data.attrs)
              }))
let (close_binder : binder -> Fstarcompiler.FStarC_Reflection_Types.binder) =
  fun b ->
    Fstarcompiler.FStarC_Reflection_V2_Builtins.pack_binder
      {
        Fstarcompiler.FStarC_Reflection_V2_Data.sort2 = (b.sort);
        Fstarcompiler.FStarC_Reflection_V2_Data.qual = (b.qual);
        Fstarcompiler.FStarC_Reflection_V2_Data.attrs = (b.attrs);
        Fstarcompiler.FStarC_Reflection_V2_Data.ppname2 = (b.ppname)
      }
let (open_term_with :
  Fstarcompiler.FStarC_Reflection_Types.binder ->
                 ...
                 (FStar_Tactics_Effect.lift_div_tac
                    (fun uu___ ->
                       Fstarcompiler.FStarC_Reflection_V2_Builtins.subst_term
                         [Fstarcompiler.FStarC_Syntax_Syntax.DB
                            (Prims.int_zero,
                              (Fstarcompiler.FStarC_Reflection_V2_Builtins.pack_namedv
                                 {
...
let (subst_comp : Fstarcompiler.FStarC_Syntax_Syntax.subst_t -> comp -> comp)
  =
  fun s ->
    fun c ->
      Fstarcompiler.FStarC_Reflection_V2_Builtins.inspect_comp
        (Fstarcompiler.FStarC_Reflection_V2_Builtins.subst_comp s
           (Fstarcompiler.FStarC_Reflection_V2_Builtins.pack_comp c))
let (open_comp :
  Fstarcompiler.FStarC_Reflection_Types.binder ->
...
let (close_term :
  binder -> term -> (Fstarcompiler.FStarC_Reflection_Types.binder * term)) =
  fun b ->
    fun t ->
      let nv = r_binder_to_namedv b in
      let t' =
        Fstarcompiler.FStarC_Reflection_V2_Builtins.subst_term
          [Fstarcompiler.FStarC_Syntax_Syntax.NM (nv, Prims.int_zero)] t in
      let b1 =
        Fstarcompiler.FStarC_Reflection_V2_Builtins.pack_binder
          {
            Fstarcompiler.FStarC_Reflection_V2_Data.sort2 = (b.sort);
             ...
             (fun _ ->
                (Fstarcompiler.FStarC_TypeChecker_NBETerm.arrow_as_prim_step_2
                   ...
                   (Fstarcompiler.FStarC_Ident.lid_of_str
                      "FStar.Tactics.NamedView.close_term") cb us) args))
let (close_comp :
  binder -> comp -> (Fstarcompiler.FStarC_Reflection_Types.binder * comp)) =
  fun b ->
    fun t ->
      let nv = r_binder_to_namedv b in
      let t' =
...
let (close_term_simple :
  simple_binder ->
    term -> (Fstarcompiler.FStarC_Reflection_V2_Data.simple_binder * term))
  =
  fun b ->
    fun t ->
      let nv = r_binder_to_namedv b in
      ...
      let b1 = Fstarcompiler.FStarC_Reflection_V2_Builtins.pack_binder bv1 in
      (b1, t')
let (close_comp_simple :
  simple_binder ->
    comp -> (Fstarcompiler.FStarC_Reflection_V2_Data.simple_binder * comp))
  =
  fun b ->
    fun t ->
      let nv = r_binder_to_namedv b in
...
let (r_subst_binder_sort :
  Fstarcompiler.FStarC_Syntax_Syntax.subst_t ->
    Fstarcompiler.FStarC_Reflection_Types.binder ->
      Fstarcompiler.FStarC_Reflection_Types.binder)
  =
  fun s ->
    fun b ->
      let v = Fstarcompiler.FStarC_Reflection_V2_Builtins.inspect_binder b in
      let v1 =
        {
          Fstarcompiler.FStarC_Reflection_V2_Data.sort2 =
            (Fstarcompiler.FStarC_Reflection_V2_Builtins.subst_term s
               v.Fstarcompiler.FStarC_Reflection_V2_Data.sort2);
          Fstarcompiler.FStarC_Reflection_V2_Data.qual =
            (v.Fstarcompiler.FStarC_Reflection_V2_Data.qual);
          Fstarcompiler.FStarC_Reflection_V2_Data.attrs =
            (v.Fstarcompiler.FStarC_Reflection_V2_Data.attrs);
          Fstarcompiler.FStarC_Reflection_V2_Data.ppname2 =
            (v.Fstarcompiler.FStarC_Reflection_V2_Data.ppname2)
        } in
      Fstarcompiler.FStarC_Reflection_V2_Builtins.pack_binder v1
let (subst_binder_sort :
  Fstarcompiler.FStarC_Syntax_Syntax.subst_t -> binder -> binder) =
  fun s ->
    fun b ->
      {
        uniq = (b.uniq);
        ppname = (b.ppname);
        sort =
          (Fstarcompiler.FStarC_Reflection_V2_Builtins.subst_term s b.sort);
        qual = (b.qual);
        attrs = (b.attrs)
      }
let rec (__open_term_n_aux :
  Fstarcompiler.FStarC_Reflection_Types.binder Prims.list ->
    binder Prims.list ->
      Fstarcompiler.FStarC_Syntax_Syntax.subst_t ->
        ((binder Prims.list * Fstarcompiler.FStarC_Syntax_Syntax.subst_t),
                           ...
                           (FStar_Sealed.seal
                              (Obj.magic
                                 (FStar_Range.mk_range
                                    ...
                                    (Prims.of_int (243)) (Prims.of_int (64)))))
                           (Obj.magic uu___)
                           (fun uu___1 ->
                              (fun b1 ->
        ...
        (FStar_Sealed.seal
           (Obj.magic
              (FStar_Range.mk_range "FStar.Tactics.NamedView.fst"
                 ...
                 (Prims.of_int (248)) (Prims.of_int (36)))))
        (Obj.magic uu___)
        (fun uu___1 ->
           FStar_Tactics_Effect.lift_div_tac
             (fun uu___2 ->
...
let (close_term_n :
  binder Prims.list ->
    term -> (Fstarcompiler.FStarC_Reflection_Types.binder Prims.list * term))
  =
  fun bs ->
    fun t ->
      let rec aux bs1 =
        fun cbs ->
          fun s ->
            ...
            | b::bs2 ->
                ...
                aux bs2 (b2 :: cbs)
                  ((Fstarcompiler.FStarC_Syntax_Syntax.NM
                      (nv, Prims.int_zero)) ::
      ...
      | (cbs, s) ->
          ((FStar_List_Tot_Base.rev cbs),
            (Fstarcompiler.FStarC_Reflection_V2_Builtins.subst_term s t))
let rec (open_term_n_simple :
  Fstarcompiler.FStarC_Reflection_V2_Data.simple_binder Prims.list ->
    term ->
...
let rec (open_pat :
  Fstarcompiler.FStarC_Reflection_V2_Data.pattern ->
    Fstarcompiler.FStarC_Syntax_Syntax.subst_t ->
      ((pattern * Fstarcompiler.FStarC_Syntax_Syntax.subst_t), unit)
  ...
  fun uu___1 ->
    fun uu___ ->
      (fun p ->
         fun s ->
           match p with
           | Fstarcompiler.FStarC_Reflection_V2_Data.Pat_Constant c ->
               Obj.magic
                 (Obj.repr
                    (FStar_Tactics_Effect.lift_div_tac
                       (fun uu___ -> ((Pat_Constant { c }), s))))
           | Fstarcompiler.FStarC_Reflection_V2_Data.Pat_Var (ssort, n) ->
               Obj.magic
                 (Obj.repr
                       ...
                       (FStar_Sealed.seal
                          (Obj.magic
                             (FStar_Range.mk_range
                                ...
                                (Prims.of_int (308)) (Prims.of_int (67)))))
                       (Obj.magic uu___)
                       (fun uu___1 ->
                          (fun sort ->
                             let uu___1 =
...
let rec (close_pat :
  ...
  fun p ->
    fun s ->
      match p with
      | Pat_Constant { c;_} ->
          ((Fstarcompiler.FStarC_Reflection_V2_Data.Pat_Constant c), s)
      | Pat_Var { v; sort1 = sort;_} ->
          let nv = Fstarcompiler.FStarC_Reflection_V2_Builtins.pack_namedv v in
          let s1 =
            (Fstarcompiler.FStarC_Syntax_Syntax.NM (nv, Prims.int_zero)) ::
            (FStar_Reflection_V2_Derived.shift_subst Prims.int_one s) in
          ((Fstarcompiler.FStarC_Reflection_V2_Data.Pat_Var
              (sort, (v.Fstarcompiler.FStarC_Reflection_V2_Data.ppname))),
            s1)
      | Pat_Cons { head; univs; subpats;_} ->
          ...
          (match uu___ with
           | (subpats1, s1) ->
               ...
               ((Fstarcompiler.FStarC_Reflection_V2_Data.Pat_Cons
                   (head, univs, subpats2)), s1))
      | Pat_Dot_Term { t = FStar_Pervasives_Native.None;_} ->
          ((Fstarcompiler.FStarC_Reflection_V2_Data.Pat_Dot_Term
              FStar_Pervasives_Native.None), s)
      | Pat_Dot_Term { t = FStar_Pervasives_Native.Some t;_} ->
          let t1 = Fstarcompiler.FStarC_Reflection_V2_Builtins.subst_term s t in
          ((Fstarcompiler.FStarC_Reflection_V2_Data.Pat_Dot_Term
              (FStar_Pervasives_Native.Some t1)), s)
let (close_branch : branch -> Fstarcompiler.FStarC_Reflection_V2_Data.branch)
  =
  fun b ->
    let uu___ = b in
    match uu___ with
    | (pat, t) ->
        ...
        (match uu___1 with
         | (pat1, s) ->
             let t' =
               Fstarcompiler.FStarC_Reflection_V2_Builtins.subst_term s t in
             (pat1, t'))
        ...
        let ct1 =
          ...
          | Fstarcompiler.FStar_Pervasives.Inr c ->
              ...
              (match uu___1 with
               | (uu___2, c1) ->
                   let c2 =
                     Fstarcompiler.FStarC_Reflection_V2_Builtins.pack_comp c1 in
...
let (open_view :
  ...
  fun uu___ ->
    (fun tv ->
                   ...
                   (fun uu___ ->
                      Tv_Var
                        (Fstarcompiler.FStarC_Reflection_V2_Builtins.inspect_namedv
                           v))))
       | Fstarcompiler.FStarC_Reflection_V2_Data.Tv_BVar v ->
           Obj.magic
             (Obj.repr
                (FStar_Tactics_Effect.lift_div_tac
                   (fun uu___ ->
                      Tv_BVar
                        (Fstarcompiler.FStarC_Reflection_V2_Builtins.inspect_bv
                           v))))
       | Fstarcompiler.FStarC_Reflection_V2_Data.Tv_FVar v ->
           Obj.magic
             (Obj.repr
                (FStar_Tactics_Effect.lift_div_tac (fun uu___ -> Tv_FVar v)))
       | Fstarcompiler.FStarC_Reflection_V2_Data.Tv_UInst (v, us) ->
           Obj.magic
             (Obj.repr
                (FStar_Tactics_Effect.lift_div_tac
                   (fun uu___ -> Tv_UInst (v, us))))
       | Fstarcompiler.FStarC_Reflection_V2_Data.Tv_App (hd, a) ->
           Obj.magic
             (Obj.repr
                (FStar_Tactics_Effect.lift_div_tac
                   ...
                   (FStar_Sealed.seal
                      (Obj.magic
                         (FStar_Range.mk_range "FStar.Tactics.NamedView.fst"
                            ...
                            (Prims.of_int (435)) (Prims.of_int (46)))))
                   (FStar_Sealed.seal
                      (Obj.magic
                         (FStar_Range.mk_range "FStar.Tactics.NamedView.fst"
       ...
       | Fstarcompiler.FStarC_Reflection_V2_Data.Tv_Refine (b, ref) ->
           Obj.magic
             (Obj.repr
                 ...
                 FStar_Tactics_Effect.tac_bind
                   ...
                   (fun uu___1 ->
                      (fun brs1 ->
                        ...
                        uu___1)))) uu___
let (close_view :
  named_term_view -> Fstarcompiler.FStarC_Reflection_V2_Data.term_view) =
  fun tv ->
    match tv with
    | Tv_Var v ->
        Fstarcompiler.FStarC_Reflection_V2_Data.Tv_Var
          (Fstarcompiler.FStarC_Reflection_V2_Builtins.pack_namedv v)
    | Tv_BVar v ->
        Fstarcompiler.FStarC_Reflection_V2_Data.Tv_BVar
          (Fstarcompiler.FStarC_Reflection_V2_Builtins.pack_bv v)
    | Tv_FVar v -> Fstarcompiler.FStarC_Reflection_V2_Data.Tv_FVar v
    | Tv_UInst (v, us) ->
        Fstarcompiler.FStarC_Reflection_V2_Data.Tv_UInst (v, us)
    | Tv_App (hd, a) ->
        Fstarcompiler.FStarC_Reflection_V2_Data.Tv_App (hd, a)
    | Tv_Type u -> Fstarcompiler.FStarC_Reflection_V2_Data.Tv_Type u
    | Tv_Const c -> Fstarcompiler.FStarC_Reflection_V2_Data.Tv_Const c
    ...
    | Tv_AscribedC (e, c, tac, use_eq) ->
        Fstarcompiler.FStarC_Reflection_V2_Data.Tv_AscribedC
          (e, (Fstarcompiler.FStarC_Reflection_V2_Builtins.pack_comp c), tac,
            use_eq)
    | Tv_Unknown -> Fstarcompiler.FStarC_Reflection_V2_Data.Tv_Unknown
    | Tv_Unsupp -> Fstarcompiler.FStarC_Reflection_V2_Data.Tv_Unsupp
    | Tv_Abs (nb, body) ->
        let uu___ = close_term nb body in
        (match uu___ with
         | (b, body1) ->
             Fstarcompiler.FStarC_Reflection_V2_Data.Tv_Abs (b, body1))
    | Tv_Arrow (nb, c) ->
        ...
        (match uu___ with
         | (b, c1) ->
             let c2 =
               Fstarcompiler.FStarC_Reflection_V2_Builtins.pack_comp c1 in
             Fstarcompiler.FStarC_Reflection_V2_Data.Tv_Arrow (b, c2))
    | Tv_Refine (nb, ref) ->
        let uu___ = close_term_simple nb ref in
        (match uu___ with
         | (b, ref1) ->
             Fstarcompiler.FStarC_Reflection_V2_Data.Tv_Refine (b, ref1))
         ...
         (fun t1 ->
            let uu___1 =
              Obj.magic
                (FStar_Tactics_Effect.lift_div_tac
                   (fun uu___2 ->
                      Fstarcompiler.FStarC_Reflection_V2_Builtins.inspect_ln
                        t1)) in
            Obj.magic
              (FStar_Tactics_Effect.tac_bind
                 (FStar_Sealed.seal
...
let (pack : named_term_view -> term) =
  fun tv ->
    ...
    Fstarcompiler.FStarC_Reflection_V2_Builtins.pack_ln tv1
let _ =
  Fstarcompiler.FStarC_Tactics_Native.register_plugin
             ...
             (fun _ ->
                (Fstarcompiler.FStarC_TypeChecker_NBETerm.arrow_as_prim_step_1
                   ...
                   (Fstarcompiler.FStarC_Ident.lid_of_str
                      "FStar.Tactics.NamedView.pack") cb us) args))
let (open_univ_s :
  Fstarcompiler.FStarC_Reflection_Types.univ_name Prims.list ->
    ((univ_name Prims.list * Fstarcompiler.FStarC_Syntax_Syntax.subst_t),
      unit) FStar_Tactics_Effect.tac_repr)
  =
  fun us ->
    let uu___ =
    ...
    FStar_Tactics_Effect.tac_bind
      ...
      (FStar_Sealed.seal
         (Obj.magic
            (FStar_Range.mk_range "FStar.Tactics.NamedView.fst"
               (Prims.of_int (527)) (Prims.of_int (31)) (Prims.of_int (529))
               (Prims.of_int (45))))) (Obj.magic uu___)
      (fun uu___1 ->
         (fun n ->
            let uu___1 =
                     ...
                     (fun i ->
                        fun u ->
                          Obj.magic
                            (FStar_Tactics_Effect.lift_div_tac
                               (fun uu___2 ->
                                  Fstarcompiler.FStarC_Syntax_Syntax.UN
                                    (((n - Prims.int_one) - i),
                                      (Fstarcompiler.FStarC_Reflection_V2_Builtins.pack_universe
                                         (Fstarcompiler.FStarC_Reflection_V2_Data.Uv_Name
                                            u)))))) uu___3 uu___2) us in
            Obj.magic
              (FStar_Tactics_Effect.tac_bind
                 (FStar_Sealed.seal
                    (Obj.magic
                       (FStar_Range.mk_range "FStar.Tactics.NamedView.fst"
                          ...
                          (Prims.of_int (528)) (Prims.of_int (73)))))
                 (FStar_Sealed.seal
                    (Obj.magic
                       (FStar_Range.mk_range "FStar.Tactics.NamedView.fst"
                          (Prims.of_int (529)) (Prims.of_int (2))
                          (Prims.of_int (529)) (Prims.of_int (45)))))
                 (Obj.magic uu___1)
                 (fun uu___2 ->
                    (fun s ->
                       let uu___2 =
                           ...
                           (fun uu___3 ->
                              (fun i ->
                                 Obj.magic
                                   (FStar_Tactics_Effect.lift_div_tac
                                      (fun uu___3 ->
                                         Fstarcompiler.FStarC_Reflection_V2_Builtins.inspect_ident
                                           i))) uu___3) us in
                       Obj.magic
                         (FStar_Tactics_Effect.tac_bind
                            (FStar_Sealed.seal
  ...
  fun us ->
    ...
    let us1 =
      FStar_List_Tot_Base.map
        (fun i -> Fstarcompiler.FStarC_Reflection_V2_Builtins.pack_ident i)
        us in
    let s =
      FStar_List_Tot_Base.mapi
        (fun i ->
           fun u ->
             Fstarcompiler.FStarC_Syntax_Syntax.UD
               (u, ((n - i) - Prims.int_one))) us1 in
    (us1, s)
let (open_lb :
  Fstarcompiler.FStarC_Reflection_Types.letbinding ->
  ...
  fun lb ->
    let uu___ =
      Obj.magic
        (FStar_Tactics_Effect.lift_div_tac
           (fun uu___1 ->
              Fstarcompiler.FStarC_Reflection_V2_Builtins.inspect_lb lb)) in
    FStar_Tactics_Effect.tac_bind
      (FStar_Sealed.seal
         (Obj.magic
            (FStar_Range.mk_range "FStar.Tactics.NamedView.fst"
               (Prims.of_int (540)) (Prims.of_int (39)) (Prims.of_int (540))
               (Prims.of_int (54)))))
      (FStar_Sealed.seal
         (Obj.magic
            (FStar_Range.mk_range "FStar.Tactics.NamedView.fst"
               (Prims.of_int (539)) (Prims.of_int (50)) (Prims.of_int (544))
               (Prims.of_int (34))))) (Obj.magic uu___)
      (fun uu___1 ->
         (fun uu___1 ->
            match uu___1 with
            | { Fstarcompiler.FStarC_Reflection_V2_Data.lb_fv = lb_fv;
                Fstarcompiler.FStarC_Reflection_V2_Data.lb_us = lb_us;
                Fstarcompiler.FStarC_Reflection_V2_Data.lb_typ = lb_typ;
                Fstarcompiler.FStarC_Reflection_V2_Data.lb_def = lb_def;_} ->
                  ...
                  (FStar_Tactics_Effect.tac_bind
                     (FStar_Sealed.seal
                        (Obj.magic
                           (FStar_Range.mk_range
                              "FStar.Tactics.NamedView.fst"
                              (Prims.of_int (541)) (Prims.of_int (17))
                              (Prims.of_int (541)) (Prims.of_int (34)))))
                     (FStar_Sealed.seal
                        (Obj.magic
                           (FStar_Range.mk_range
                              "FStar.Tactics.NamedView.fst"
                              (Prims.of_int (540)) (Prims.of_int (57))
                              (Prims.of_int (544)) (Prims.of_int (34)))))
                     (Obj.magic uu___2)
                     (fun uu___3 ->
                        FStar_Tactics_Effect.lift_div_tac
                          (fun uu___4 ->
...
let (close_lb :
  letbinding -> Fstarcompiler.FStarC_Reflection_Types.letbinding) =
  fun lb ->
    let uu___ = lb in
    match uu___ with
        ...
        (match uu___1 with
         | (lb_us1, s) ->
             ...
             Fstarcompiler.FStarC_Reflection_V2_Builtins.pack_lb
               {
                 Fstarcompiler.FStarC_Reflection_V2_Data.lb_fv = lb_fv;
                 Fstarcompiler.FStarC_Reflection_V2_Data.lb_us = lb_us1;
                 Fstarcompiler.FStarC_Reflection_V2_Data.lb_typ = lb_typ1;
                 Fstarcompiler.FStarC_Reflection_V2_Data.lb_def = lb_def1
               })
let (subst_r_binders :
  Fstarcompiler.FStarC_Syntax_Syntax.subst_t ->
    Fstarcompiler.FStarC_Reflection_Types.binder Prims.list ->
                     ...
                     FStar_Tactics_Effect.tac_bind
                       (FStar_Sealed.seal
                          (Obj.magic
                             (FStar_Range.mk_range
                                "FStar.Tactics.NamedView.fst"
                                (Prims.of_int (563)) (Prims.of_int (10))
                                (Prims.of_int (563)) (Prims.of_int (19)))))
                       (FStar_Sealed.seal
                          (Obj.magic
                             (FStar_Range.mk_range
                                "FStar.Tactics.NamedView.fst"
                                      ...
                                      (let uu___2 =
                                         Obj.magic
                                           (FStar_Tactics_Effect.lift_div_tac
                                              (fun uu___3 ->
                                                 Fstarcompiler.FStarC_Reflection_V2_Builtins.subst_term
                                                   [Fstarcompiler.FStarC_Syntax_Syntax.NT
...
let (open_sigelt_view :
  Fstarcompiler.FStarC_Reflection_V2_Data.sigelt_view ->
    (named_sigelt_view, unit) FStar_Tactics_Effect.tac_repr)
  =
  fun uu___ ->
    (fun sv ->
       match sv with
       | Fstarcompiler.FStarC_Reflection_V2_Data.Sg_Let (isrec, lbs) ->
           Obj.magic
             (Obj.repr
       ...
       | Fstarcompiler.FStarC_Reflection_V2_Data.Sg_Inductive
                                                     ...
                                                     (FStar_Tactics_Effect.tac_bind
                                                        ...
                                                        (fun uu___5 ->
                                                           (fun typ1 ->
                                                             ...
                                                             uu___5))) uu___4)))
                                   uu___2))) uu___1)))
       | Fstarcompiler.FStarC_Reflection_V2_Data.Sg_Val (nm, univs, typ) ->
           Obj.magic
             (Obj.repr
       ...
       | Fstarcompiler.FStarC_Reflection_V2_Data.Unk ->
           Obj.magic
                         ...
                         (FStar_Sealed.seal
                            (Obj.magic
                               (FStar_Range.mk_range
                                  ...
                                  (Prims.of_int (615)) (Prims.of_int (37)))))
                         (FStar_Sealed.seal
                            (Obj.magic
                               (FStar_Range.mk_range
                                  "FStar.Tactics.NamedView.fst"
                                  (Prims.of_int (615)) (Prims.of_int (13))
                                  (Prims.of_int (615)) (Prims.of_int (37)))))
                         (Obj.magic uu___1)
                         (fun uu___2 ->
                            FStar_Tactics_Effect.lift_div_tac
...
let (close_sigelt_view :
  named_sigelt_view ->
    (Fstarcompiler.FStarC_Reflection_V2_Data.sigelt_view, unit)
      FStar_Tactics_Effect.tac_repr)
  =
  fun uu___ ->
    (fun sv ->
       ...
       | Sg_Let { isrec; lbs;_} ->
           Obj.magic
             (Obj.repr
                (FStar_Tactics_Effect.lift_div_tac
                   (fun uu___ ->
                      Fstarcompiler.FStarC_Reflection_V2_Data.Sg_Let
                ...
                (let uu___ =
                 ...
                 FStar_Tactics_Effect.tac_bind
                   (FStar_Sealed.seal
                      (Obj.magic
                         (FStar_Range.mk_range "FStar.Tactics.NamedView.fst"
                            (Prims.of_int (626)) (Prims.of_int (18))
                            (Prims.of_int (626)) (Prims.of_int (40)))))
                   (FStar_Sealed.seal
                      (Obj.magic
                         (FStar_Range.mk_range "FStar.Tactics.NamedView.fst"
                            (Prims.of_int (626)) (Prims.of_int (43))
                            (Prims.of_int (645)) (Prims.of_int (45)))))
                   (Obj.magic uu___)
                   (fun uu___1 ->
                      (fun nparams ->
                         let uu___1 =
             ...
             (Obj.repr
                (FStar_Tactics_Effect.lift_div_tac
                   (fun uu___ ->
                      ...
                      | (univs1, s) ->
                          Fstarcompiler.FStarC_Reflection_V2_Data.Sg_Val
                            (nm, univs1,
                              (Fstarcompiler.FStarC_Reflection_V2_Builtins.subst_term
                                 s typ)))))) uu___
let (inspect_sigelt :
  ...
  fun s ->
    let uu___ =
      Obj.magic
        (FStar_Tactics_Effect.lift_div_tac
           (fun uu___1 ->
              Fstarcompiler.FStarC_Reflection_V2_Builtins.inspect_sigelt s)) in
    FStar_Tactics_Effect.tac_bind
      (FStar_Sealed.seal
         (Obj.magic
            (FStar_Range.mk_range "FStar.Tactics.NamedView.fst"
               (Prims.of_int (654)) (Prims.of_int (11)) (Prims.of_int (654))
               (Prims.of_int (29)))))
      (FStar_Sealed.seal
         (Obj.magic
            (FStar_Range.mk_range "FStar.Tactics.NamedView.fst"
...
let (pack_sigelt :
  named_sigelt_view ->
    (Fstarcompiler.FStarC_Reflection_Types.sigelt, unit)
      FStar_Tactics_Effect.tac_repr)
  =
  fun sv ->
    ...
    FStar_Tactics_Effect.tac_bind
      ...
      (fun sv1 ->
         FStar_Tactics_Effect.lift_div_tac
           (fun uu___1 ->
              Fstarcompiler.FStarC_Reflection_V2_Builtins.pack_sigelt sv1))
let _ =
  Fstarcompiler.FStarC_Tactics_Native.register_tactic
    ...
    fun t ->
      ...
      FStar_Tactics_Effect.tac_bind
        (FStar_Sealed.seal
           (Obj.magic
              (FStar_Range.mk_range "FStar.Tactics.NamedView.fst"
                 (Prims.of_int (664)) (Prims.of_int (19))
        ...
        (fun c ->
           FStar_Tactics_Effect.lift_div_tac
             (fun uu___1 ->
                Fstarcompiler.FStarC_Reflection_V2_Builtins.inspect_comp c))
let _ =
  Fstarcompiler.FStarC_Tactics_Native.register_tactic
  ...
  fun t ->
    ...
    FStar_Tactics_Effect.tac_bind
      (FStar_Sealed.seal
         (Obj.magic
            (FStar_Range.mk_range "FStar.Tactics.NamedView.fst"
               (Prims.of_int (671)) (Prims.of_int (8)) (Prims.of_int (671))
               (Prims.of_int (17)))))
      (FStar_Sealed.seal
         (Obj.magic
            (FStar_Range.mk_range "FStar.Tactics.NamedView.fst"
               (Prims.of_int (671)) (Prims.of_int (2)) (Prims.of_int (688))
