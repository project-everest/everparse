...
type match_exception =
  ...
  | IncorrectTypeInAbsPatBinder of Fstarcompiler.FStarC_Reflection_Types.typ 
...
let (__proj__IncorrectTypeInAbsPatBinder__item___0 :
  match_exception -> Fstarcompiler.FStarC_Reflection_Types.typ) =
  fun projectee ->
...
let (name_of_namedv :
  ...
  fun x ->
    FStarC_Tactics_Unseal.unseal
      (FStar_Tactics_NamedView.inspect_namedv x).Fstarcompiler.FStarC_Reflection_V2_Data.ppname
...
type abspat_binder_kind =
  | ABKVar of Fstarcompiler.FStarC_Reflection_Types.typ 
  | ABKHyp 
  | ABKGoal 
...
let (__proj__ABKVar__item___0 :
  abspat_binder_kind -> Fstarcompiler.FStarC_Reflection_Types.typ) =
...
let (locate_fn_of_binder_kind :
  abspat_binder_kind -> Fstarcompiler.FStarC_Reflection_Types.term) =
  fun binder_kind ->
    match binder_kind with
    | ABKVar uu___ ->
        Fstarcompiler.FStarC_Reflection_V2_Builtins.pack_ln
              ...
              let uu___1 =
                let uu___2 =
                  let uu___3 =
                    let uu___4 =
                      FStarC_Tactics_Unseal.unseal
                        (argspec.asa_name).Fstarcompiler.FStarC_Reflection_V2_Data.ppname3 in
                    FStar_Tactics_Effect.tac_bind
                      (FStar_Sealed.seal
                         (Obj.magic
                            (FStar_Range.mk_range
