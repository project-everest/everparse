...
let rec (universe_to_ast_string :
  ...
  =
  fun u ->
    let uu___ = FStar_Tactics_NamedView.inspect_universe u in
    FStar_Tactics_Effect.tac_bind
      (FStar_Sealed.seal
         (Obj.magic
            (FStar_Range.mk_range "FStar.Tactics.Print.fst"
      ...
      (FStar_Sealed.seal
         (Obj.magic
            (FStar_Range.mk_range "FStar.Tactics.Print.fst"
               (Prims.of_int (32)) (Prims.of_int (2)) (Prims.of_int (39))
         ...
         (fun uu___1 ->
            ...
            | FStar_Tactics_NamedView.Uv_Succ u1 ->
                Obj.magic
                  (Obj.repr
                     (let uu___2 =
                        let uu___3 = universe_to_ast_string u1 in
                        FStar_Tactics_Effect.tac_bind
                          (FStar_Sealed.seal
                             (Obj.magic
                                (FStar_Range.mk_range
                      ...
                      FStar_Tactics_Effect.tac_bind
                        ...
                        (fun uu___3 ->
                           FStar_Tactics_Effect.lift_div_tac
                             (fun uu___4 -> Prims.strcat "Uv_Succ" uu___3))))
            | FStar_Tactics_NamedView.Uv_Max us ->
                Obj.magic
                  (Obj.repr
                     (let uu___2 = print_list universe_to_ast_string us in
                      FStar_Tactics_Effect.tac_bind
                        (FStar_Sealed.seal
                           (Obj.magic
                              (FStar_Range.mk_range "FStar.Tactics.Print.fst"
                        ...
                        (fun uu___3 ->
                           FStar_Tactics_Effect.lift_div_tac
                             (fun uu___4 -> Prims.strcat "Uv_Max" uu___3))))
            | FStar_Tactics_NamedView.Uv_BVar n ->
                Obj.magic
                  (Obj.repr
                     (FStar_Tactics_Effect.lift_div_tac
                        (fun uu___2 ->
                           Prims.strcat "Uv_BVar"
                             (paren (Prims.string_of_int n)))))
            ...
            | FStar_Tactics_NamedView.Uv_Unif uu___2 ->
                Obj.magic
                  (Obj.repr
                     (FStar_Tactics_Effect.lift_div_tac
                        (fun uu___3 -> "Uv_Unif")))
