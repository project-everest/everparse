...
let injective_fuel (fuel: nat) (#t: Type0) (p: bare_parser t) : GTot Type0 =
...
let parser_subkind_prop_fuel (fuel: nat) (k: parser_subkind) (#t: Type0) (f: bare_parser t) : GTot Type0 =
  match k with
  | ParserStrong ->
...
let parser_always_fails_fuel (fuel: nat) (#t: Type0) (f: bare_parser t) : GTot Type0 =
  forall (input: bytes { Seq.length input < fuel }) . {:pattern (parse f input)} parse f input == None

let parser_kind_metadata_prop_fuel (fuel: nat) (#t: Type0) (k: parser_kind) (f: bare_parser t) : GTot Type0 =
...
let parser_kind_prop_fuel (fuel: nat) (#t: Type0) (k: parser_kind) (f: bare_parser t) : GTot Type0 =
...
let parser_subkind_prop_fuel_correct
  (k: parser_subkind) (#t: Type0) (f: bare_parser t)
: Lemma
