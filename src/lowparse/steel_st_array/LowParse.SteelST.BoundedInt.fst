...
= validate_total_constant_size (parse_bounded_integer i) (SZ.mk_size_t (U32.uint_to_t i))

inline_for_extraction
let validate_bounded_integer'
  (i: U32.t { 1 <= U32.v i /\ U32.v i <= 4 })
: Tot (validator (parse_bounded_integer (U32.v i)))
= validate_total_constant_size (parse_bounded_integer (U32.v i)) (SZ.mk_size_t i)
...
= jump_constant_size (parse_bounded_integer i) (SZ.mk_size_t (U32.uint_to_t i))

inline_for_extraction
let jump_bounded_integer'
  (i: U32.t { 1 <= U32.v i /\ U32.v i <= 4 })
: Tot (jumper (parse_bounded_integer (U32.v i)))
= jump_constant_size (parse_bounded_integer (U32.v i)) (SZ.mk_size_t i)
...
= fun #va a ->
  ...
  let res = be_to_n_3 a (SZ.mk_size_t 3ul) in
