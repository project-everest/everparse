...
let rec compile_enum tch o i n (fl: enum_field_t list) (al:attr list) =
  ...
  wh o "let %s_size32 =\n" n;
  wh o "  [@inline_let] let _ = assert_norm (LSZ.size32_constant_precond %s_serializer %dul) in\n" n blen;
  wh o "  LSZ.size32_constant %s_serializer %dul ()\n\n" n blen;
...
and compile tch o i (tn:typ) (p:gemstone_t) =
  ...
  wh i "module LSZ = LowParse.SLow.Base\n";
