        ...
        (long_argument){
          .tag = LongArgumentU16,
          {
            .case_LongArgumentU16 = (uint32_t)(uint16_t)(uint32_t)last +
              (uint32_t)(uint16_t)(uint32_t)op_Array_Access__uint8_t(input2, (size_t)0U) * 256U
          }
        }
      );
  }
                    ...
                    ((uint64_t)(uint32_t)last4 +
                      ((uint64_t)(uint32_t)last5 +
                        ((uint64_t)(uint32_t)last6 +
                          (uint64_t)(uint32_t)op_Array_Access__uint8_t(input2, (size_t)0U) * 256ULL)
                        * 256ULL)
                      * 256ULL)
                    * 256ULL)
                  * 256ULL)
...
static size_t jump_header(Pulse_Lib_Slice_slice__uint8_t input, size_t offset)
{
  ...
  return
    x.additional_info == ADDITIONAL_INFO_LONG_ARGUMENT_8_BITS ? off1 + (size_t)1U
                                                              : x.additional_info ==
                                                                ADDITIONAL_INFO_LONG_ARGUMENT_16_BITS ? off1
                                                                                                      +
                                                                                                        (size_t)2U
                                                                                                      : x.additional_info
                                                                                                      ==
                                                                                                        ADDITIONAL_INFO_LONG_ARGUMENT_32_BITS ? off1
                                                                                                                                              +
                                                                                                                                                (size_t)4U
                                                                                                                                              : x.additional_info
                                                                                                                                              ==
                                                                                                                                                ADDITIONAL_INFO_LONG_ARGUMENT_64_BITS ? off1
                                                                                                                                                                                      +
                                                                                                                                                                                        (size_t)8U
                                                                                                                                                                                      : off1;
}
    ...
    if (scrut.tag == LongArgumentU8)
      ite =
        (
          (CBOR_Spec_Raw_Base_raw_uint64){
            .size = 1U,
            .value = (uint64_t)(uint32_t)scrut.case_LongArgumentU8
          }
        );
      ...
      ite =
        (
          (CBOR_Spec_Raw_Base_raw_uint64){
            .size = 2U,
            .value = (uint64_t)(uint32_t)scrut.case_LongArgumentU16
          }
        );
      ...
      ite =
        (
          (CBOR_Spec_Raw_Base_raw_uint64){
            .size = 0U,
            .value = (uint64_t)(uint32_t)h.fst.additional_info
          }
        );
    else
      ite =
...
{
  return lex_compare_bytes(a1, a2) < 0;
}
...
)
{
  ...
  if (b.major_type == CBOR_MAJOR_TYPE_BYTE_STRING || b.major_type == CBOR_MAJOR_TYPE_TEXT_STRING)
  {
    ...
    if (x_.tag == CBOR_Case_Array)
    {
      ...
      size_t pi = (size_t)0U;
      size_t i0 = pi;
      bool cond = i0 < argument_as_uint64(xh1.fst, xh1.snd);
      while (cond)
      {
        size_t i = pi;
        size_t off = pres;
        ...
        pres = res;
        size_t i0 = pi;
        cond = i0 < argument_as_uint64(xh1.fst, xh1.snd);
      }
      return pres;
    }
    else
  ...
  if (size_header(xh1, out))
  {
    ...
    if (b.major_type == CBOR_MAJOR_TYPE_BYTE_STRING || b.major_type == CBOR_MAJOR_TYPE_TEXT_STRING)
    {
      ...
      if (x_.tag == CBOR_Case_Array)
      {
        ...
        bool res = pres;
        size_t i0 = pi;
        bool cond = res && i0 < argument_as_uint64(xh1.fst, xh1.snd);
        while (cond)
        {
          size_t i0 = pi;
          if
          ...
          bool res = pres;
          size_t i = pi;
          cond = res && i < argument_as_uint64(xh1.fst, xh1.snd);
        }
        return pres;
      }
      else
...
cbor_raw cbor_det_mk_map_from_array(cbor_map_entry *a, uint64_t len)
{
  ...
  bool ite;
  if (len__CBOR_Pulse_Raw_Type_cbor_map_entry(s) > 18446744073709551615ULL)
    ite = false;
