...
static size_t Pulse_Lib_Slice_len__uint8_t(byte_slice s)
{
  return s.len;
}

static uint8_t Pulse_Lib_Slice_op_Array_Access__uint8_t(byte_slice a, size_t i)
{
  return a.elt[i];
}

static int16_t CBOR_Pulse_Raw_Compare_Bytes_lex_compare_bytes(byte_slice s1, byte_slice s2)
{
  byte_slice sp1 = s1;
  byte_slice sp2 = s2;
...
static bool CBOR_Pulse_Raw_EverParse_UTF8_impl_correct(byte_slice s)
{
  bool pres = true;
  size_t pi = (size_t)0U;
...
CBOR_Pulse_Raw_EverParse_Validate_read_initial_byte_t(byte_slice input)
{
...
Pulse_Lib_Slice_split__uint8_t(byte_slice s, size_t i)
{
  return
    (
      (K___CBOR_Pulse_Raw_Slice_byte_slice_CBOR_Pulse_Raw_Slice_byte_slice){
...
static CBOR_Spec_Raw_EverParse_header
CBOR_Pulse_Raw_EverParse_Validate_read_header(byte_slice input)
{
  K___CBOR_Pulse_Raw_Slice_byte_slice_CBOR_Pulse_Raw_Slice_byte_slice
...
static bool
CBOR_Pulse_Raw_EverParse_Validate_validate_header(byte_slice input, size_t *poffset)
{
...
static size_t CBOR_Pulse_Raw_EverParse_Validate_jump_header(byte_slice input, size_t offset)
{
...
static size_t CBOR_Pulse_Raw_EverParse_Validate_jump_recursive_step_count_leaf(byte_slice a)
{
  K___CBOR_Pulse_Raw_Slice_byte_slice_CBOR_Pulse_Raw_Slice_byte_slice
  scrut =
    Pulse_Lib_Slice_split__uint8_t(a,
...
static bool
CBOR_Pulse_Raw_EverParse_Validate_validate_raw_data_item(byte_slice input, size_t *poffset)
{
  size_t pn = (size_t)1U;
  bool pres = true;
...
static size_t
CBOR_Pulse_Raw_EverParse_Validate_jump_raw_data_item(byte_slice input, size_t offset)
{
...
static size_t
CBOR_Pulse_Raw_EverParse_Validate_jump_raw_data_item_eta(byte_slice input, size_t offset)
{
...
static cbor_raw CBOR_Pulse_Raw_EverParse_Read_cbor_raw_read_match_aux(byte_slice input)
{
  K___CBOR_Pulse_Raw_Slice_byte_slice_CBOR_Pulse_Raw_Slice_byte_slice
  scrut0 =
...
static cbor_raw CBOR_Pulse_Raw_EverParse_Read_cbor_raw_read(byte_slice input)
{
  return CBOR_Pulse_Raw_EverParse_Read_cbor_raw_read_match_aux(input);
}

static cbor_raw CBOR_Pulse_Raw_EverParse_Read_cbor_raw_read_fuel(byte_slice input)
{
  return CBOR_Pulse_Raw_EverParse_Read_cbor_raw_read_match_aux(input);
}
...
static byte_slice CBOR_Pulse_Raw_EverParse_Access_cbor_raw_get_string_aux(cbor_raw x)
{
...
static byte_slice CBOR_Pulse_Raw_EverParse_Access_cbor_raw_get_string(cbor_raw x)
{
...
)
{
  ...
  else
  {
    ...
    if (scrut.tag == LowParse_PulseParse_Iterator_Type_Base)
    {
      ...
      {
        byte_slice pl = bi.case_Serialized.payload;
        size_t pn = cur_off_v;
  ...
  if (scrut0.tag == IBase)
  {
    ...
    else
    {
      ...
      else if (bi.tag == LowParse_PulseParse_Iterator_Type_Serialized)
      {
        ...
        byte_slice pl_suffix = Pulse_Lib_Slice_split__uint8_t(pl, poffset).snd;
        x1 =
          (
            (LowParse_PulseParse_Iterator_elt_or_serialized__CBOR_Pulse_Raw_EverParse_Type_cbor_raw){
              .tag = LowParse_PulseParse_Iterator_ESerialized,
      ...
      if (len_sz == (size_t)1U)
      {
        ...
        else
        {
          ...
          if (scrut.tag == LowParse_PulseParse_Iterator_Type_Base)
          {
            ...
            {
              byte_slice pl = bi1.case_Serialized.payload;
              size_t pn = cur_off_v;
              size_t poffset = (size_t)0U;
              while (pn > (size_t)0U)
              {
...
static size_t CBOR_Pulse_Raw_EverParse_Det_Validate_cbor_validate(byte_slice input)
{
  size_t poffset = (size_t)0U;
...
static bool CBOR_Pulse_Raw_EverParse_Det_Validate_cbor_raw_ints_optimal(byte_slice a)
{
  K___CBOR_Pulse_Raw_Slice_byte_slice_CBOR_Pulse_Raw_Slice_byte_slice
  scrut0 =
    Pulse_Lib_Slice_split__uint8_t(a,
...
static bool CBOR_Pulse_Raw_EverParse_Det_Validate_cbor_raw_sorted(byte_slice a)
{
  K___CBOR_Pulse_Raw_Slice_byte_slice_CBOR_Pulse_Raw_Slice_byte_slice
  scrut0 =
    Pulse_Lib_Slice_split__uint8_t(a,
  ...
  if (CBOR_Spec_Raw_EverParse_get_header_major_type(h) == CBOR_MAJOR_TYPE_MAP)
  {
    ...
    else
    {
      ...
      byte_slice input4 = scrut7.snd;
      byte_slice pkey = scrut7.fst;
      ...
      while (pres && ppairs > 0ULL)
      {
        ...
        K___CBOR_Pulse_Raw_Slice_byte_slice_CBOR_Pulse_Raw_Slice_byte_slice
        scrut3 = { .fst = scrut2.fst, .snd = scrut2.snd };
        byte_slice key2 = scrut3.fst;
        byte_slice tail2 = scrut3.snd;
        if
        (
...
static size_t CBOR_Pulse_Raw_EverParse_Det_Validate_cbor_validate_det_(byte_slice input)
{
  ...
  else
  {
    ...
    while (pres0 && pn > (size_t)0U)
    {
      ...
      else
      {
        ...
        K___CBOR_Pulse_Raw_Slice_byte_slice_CBOR_Pulse_Raw_Slice_byte_slice
        scrut4 = { .fst = scrut3.fst, .snd = scrut3.snd };
        byte_slice ph = scrut4.fst;
        byte_slice pc = scrut4.snd;
...
static size_t CBOR_Pulse_Raw_EverParse_Det_Validate_cbor_validate_det(byte_slice input)
{
  return CBOR_Pulse_Raw_EverParse_Det_Validate_cbor_validate_det_(input);
}

static cbor_raw CBOR_Pulse_Raw_EverParse_Det_Validate_cbor_parse_valid(byte_slice input)
{
...
static cbor_raw CBOR_Pulse_Raw_EverParse_Make_cbor_mk_string(uint8_t ty, byte_slice s)
{
  return
    (
      (cbor_raw){
...
static uint8_t CBOR_Pulse_Raw_EverParse_ArrayBuilder_minimal_len_size(uint64_t len)
{
  return CBOR_Spec_Raw_Optimal_mk_raw_uint64(len).size;
}

static LowParse_PulseParse_Iterator_Type_mixed_list__CBOR_Pulse_Raw_EverParse_Type_cbor_raw
CBOR_Pulse_Raw_EverParse_ArrayBuilder_cbor_array_owned_elim(cbor_raw x)
{
  if (x.tag == CBOR_Case_Array)
    return x.case_CBOR_Case_Array.cbor_array_ptr;
  else if (x.tag == CBOR_Case_Invalid)
...
static cbor_raw
CBOR_Pulse_Raw_EverParse_ArrayBuilder_cbor_mk_array_full(
  uint8_t len_size,
  LowParse_PulseParse_Iterator_Type_mixed_list__CBOR_Pulse_Raw_EverParse_Type_cbor_raw ml
)
{
...
static cbor_raw
CBOR_Pulse_Raw_EverParse_MapBuilder_cbor_mk_map_full(
  uint8_t len_size,
  LowParse_PulseParse_Iterator_Type_mixed_list__CBOR_Pulse_Raw_EverParse_Type_cbor_map_entry__CBOR_Pulse_Raw_EverParse_Type_cbor_raw
  ml
)
...
static cbor_map_entry__CBOR_Pulse_Raw_EverParse_Type_cbor_raw
CBOR_Pulse_Raw_EverParse_ReadMapEntry_cbor_raw_read_map_entry(byte_slice input)
{
  K___CBOR_Pulse_Raw_Slice_byte_slice_CBOR_Pulse_Raw_Slice_byte_slice
  scrut =
    Pulse_Lib_Slice_split__uint8_t(input,
...
CBOR_Pulse_Raw_EverParse_Det_Compare_impl_cbor_compare_fuel(cbor_raw x1, cbor_raw x2)
{
  ...
  if (c == (int16_t)0)
    ...
    else if (ty1 == CBOR_MAJOR_TYPE_BYTE_STRING || ty1 == CBOR_MAJOR_TYPE_TEXT_STRING)
    {
      ...
      if (cl == (int16_t)0)
      {
        byte_slice s1 = CBOR_Pulse_Raw_EverParse_Access_cbor_raw_get_string_aux(x1);
        return
...
CBOR_Pulse_Raw_EverParse_Det_Compare_impl_cbor_compare_fuel_tagged(cbor_raw x1, cbor_raw x2)
{
  ...
  {
    byte_slice s1 = e1.case_ESerialized;
    if (e2.tag == LowParse_PulseParse_Iterator_EElement)
    {
    ...
    {
      byte_slice s2 = e2.case_ESerialized;
      K___CBOR_Pulse_Raw_Slice_byte_slice_CBOR_Pulse_Raw_Slice_byte_slice
      scrut0 =
...
static bool
CBOR_Pulse_Raw_EverParse_Det_MapInsert_cbor_raw_map_key_present(
  cbor_raw key,
  LowParse_PulseParse_Iterator_Type_mixed_list__CBOR_Pulse_Raw_EverParse_Type_cbor_map_entry__CBOR_Pulse_Raw_EverParse_Type_cbor_raw
  ml
)
{
  ...
  cbor_det_map_iterator_t r_it = it0;
  bool r_found = false;
  bool ite0;
  if (it0.tag == IBase)
    ite0 =
      LowParse_PulseParse_Iterator_Type_base_mixed_list_length__CBOR_Pulse_Raw_EverParse_Type_cbor_map_entry_CBOR_Pulse_Raw_EverParse_Type_cbor_raw(it0.case_IBase)
      == (size_t)0U;
  else if (it0.tag == IPair)
    ite0 =
      LowParse_PulseParse_Iterator_Type_base_mixed_list_length__CBOR_Pulse_Raw_EverParse_Type_cbor_map_entry_CBOR_Pulse_Raw_EverParse_Type_cbor_raw(it0.case_IPair.before)
      == (size_t)0U;
  else
  ...
  {
    K___CBOR_Pulse_Raw_EverParse_Type_cbor_map_entry__CBOR_Pulse_Raw_EverParse_Type_cbor_raw_CBOR_Pulse_API_Det_Type_cbor_det_map_iterator_t
    scrut = CBOR_Pulse_Raw_EverParse_ReadMapEntry_iterator_next_map_entry_raw_data_item(r_it);
    cbor_det_map_iterator_t tail_it = scrut.snd;
    if
    (
      CBOR_Pulse_Raw_EverParse_Det_Compare_impl_cbor_compare(key, scrut.fst.cbor_map_entry_key) ==
        (int16_t)0
    )
    {
      r_found = true;
    ...
    else
    {
      r_it = tail_it;
      bool ite;
      if (tail_it.tag == IBase)
        ite =
          LowParse_PulseParse_Iterator_Type_base_mixed_list_length__CBOR_Pulse_Raw_EverParse_Type_cbor_map_entry_CBOR_Pulse_Raw_EverParse_Type_cbor_raw(tail_it.case_IBase)
          == (size_t)0U;
      else if (tail_it.tag == IPair)
        ite =
          LowParse_PulseParse_Iterator_Type_base_mixed_list_length__CBOR_Pulse_Raw_EverParse_Type_cbor_map_entry_CBOR_Pulse_Raw_EverParse_Type_cbor_raw(tail_it.case_IPair.before)
          == (size_t)0U;
      else
...
static void Pulse_Lib_Slice_op_Array_Assignment__uint8_t(byte_slice a, size_t i, uint8_t v)
{
  a.elt[i] = v;
}

static bool
CBOR_Pulse_Raw_EverParse_Insert_cbor_raw_map_insert(byte_slice out, size_t off2, size_t off3)
{
  ...
  {
    size_t off = poff;
    byte_slice out2kv = Pulse_Lib_Slice_split__uint8_t(out, off).snd;
    K___CBOR_Pulse_Raw_Slice_byte_slice_CBOR_Pulse_Raw_Slice_byte_slice
    scrut0 = Pulse_Lib_Slice_split__uint8_t(out2kv, off2 - off);
    byte_slice out2 = scrut0.fst;
    byte_slice outk = Pulse_Lib_Slice_split__uint8_t(scrut0.snd, off3 - off2).fst;
...
static void Pulse_Lib_Slice_copy__uint8_t(byte_slice dst, byte_slice src)
{
...
size_t CBOR_Pulse_Raw_EverParse_Serialize_ser_(cbor_raw x_, byte_slice out, size_t offset)
{
  ...
  if (b.major_type == CBOR_MAJOR_TYPE_BYTE_STRING || b.major_type == CBOR_MAJOR_TYPE_TEXT_STRING)
  {
    byte_slice x2_ = CBOR_Pulse_Raw_EverParse_Access_cbor_raw_get_string(x_);
  ...
  else if (xh1.fst.major_type == CBOR_MAJOR_TYPE_ARRAY)
  {
    ...
    else
    {
      ...
      while (p_remaining > (size_t)0U)
      {
        ...
        {
          byte_slice pl_bi = bi.case_Serialized.payload;
...
static size_t
CBOR_Pulse_Raw_EverParse_Serialize_ser(cbor_raw x1_, byte_slice out, size_t offset)
{
  return CBOR_Pulse_Raw_EverParse_Serialize_ser_(x1_, out, offset);
}

static size_t CBOR_Pulse_Raw_EverParse_Serialize_cbor_serialize(cbor_raw x, byte_slice output)
{
...
)
{
  ...
  if (CBOR_Pulse_Raw_EverParse_Serialize_size_header(h, &rem))
  {
    ...
    byte_slice sp1 = Pulse_Lib_Slice_split__uint8_t(out, llen).fst;
...
static byte_slice Pulse_Lib_Slice_arrayptr_to_slice_intro__uint8_t(uint8_t *a, size_t alen)
{
  return ((byte_slice){ .elt = a, .len = alen });
}
...
FStar_Pervasives_Native_fst__Pulse_Lib_Slice_slice_uint8_t_Pulse_Lib_Slice_slice_uint8_t(
  K___CBOR_Pulse_Raw_Slice_byte_slice_CBOR_Pulse_Raw_Slice_byte_slice x
)
{
  return x.fst;
}
...
{
  byte_slice s = Pulse_Lib_Slice_arrayptr_to_slice_intro__uint8_t(output, output_len);
...
{
  byte_slice s = Pulse_Lib_Slice_arrayptr_to_slice_intro__uint8_t(input, len);
...
bool cbor_det_mk_byte_string_from_arrayptr(uint8_t *a, uint64_t len, cbor_raw *dest)
{
  ...
  {
    byte_slice s = Pulse_Lib_Slice_arrayptr_to_slice_intro__uint8_t(a, (size_t)len);
    bool ite;
...
{
  return
    CBOR_Pulse_Raw_EverParse_ArrayBuilder_cbor_mk_array_full(CBOR_Pulse_Raw_EverParse_ArrayBuilder_minimal_len_size(0ULL),
      (
        (LowParse_PulseParse_Iterator_Type_mixed_list__CBOR_Pulse_Raw_EverParse_Type_cbor_raw){
          .tag = LowParse_PulseParse_Iterator_Type_Base,
...
cbor_raw cbor_det_array_singleton(cbor_raw x, cbor_raw *ry)
{
  *ry = x;
  ...
  return
    CBOR_Pulse_Raw_EverParse_ArrayBuilder_cbor_mk_array_full(CBOR_Pulse_Raw_EverParse_ArrayBuilder_minimal_len_size(1ULL),
      ml);
}
...
{
  LowParse_PulseParse_Iterator_Type_mixed_list__CBOR_Pulse_Raw_EverParse_Type_cbor_raw
  ml_a = CBOR_Pulse_Raw_EverParse_ArrayBuilder_cbor_array_owned_elim(x1);
  LowParse_PulseParse_Iterator_Type_mixed_list__CBOR_Pulse_Raw_EverParse_Type_cbor_raw
  ml_b = CBOR_Pulse_Raw_EverParse_ArrayBuilder_cbor_array_owned_elim(x2);
  uint64_t
  la64 =
    (uint64_t)LowParse_PulseParse_Iterator_Type_mixed_list_length__CBOR_Pulse_Raw_EverParse_Type_cbor_raw(ml_a);
  uint64_t
  lb64 =
    (uint64_t)LowParse_PulseParse_Iterator_Type_mixed_list_length__CBOR_Pulse_Raw_EverParse_Type_cbor_raw(ml_b);
  FStar_Pervasives_Native_option__CBOR_Pulse_Raw_EverParse_Type_cbor_raw scrut;
  if (la64 > 0xffffffffffffffffULL - lb64)
    scrut =
      (
        (FStar_Pervasives_Native_option__CBOR_Pulse_Raw_EverParse_Type_cbor_raw){
          .tag = FStar_Pervasives_Native_None
  ...
  {
    uint64_t sum64 = la64 + lb64;
    size_t
    len_a1 =
      LowParse_PulseParse_Iterator_Type_mixed_list_length__CBOR_Pulse_Raw_EverParse_Type_cbor_raw(ml_a);
    size_t
    len_b1 =
      LowParse_PulseParse_Iterator_Type_mixed_list_length__CBOR_Pulse_Raw_EverParse_Type_cbor_raw(ml_b);
    *r_before = ml_a;
    *r_after = ml_b;
    LowParse_PulseParse_Iterator_Type_mixed_list__CBOR_Pulse_Raw_EverParse_Type_cbor_raw
    ml_res =
      {
        ...
        {
          .case_Append = {
            .cb = len_a1, .ca = len_b1, .ob = (size_t)0U, .before = r_before, .oa = (size_t)0U,
            .after = r_after
          }
        }
      };
    scrut =
      (
        (FStar_Pervasives_Native_option__CBOR_Pulse_Raw_EverParse_Type_cbor_raw){
          .tag = FStar_Pervasives_Native_Some,
          .v = CBOR_Pulse_Raw_EverParse_ArrayBuilder_cbor_mk_array_full(CBOR_Pulse_Raw_EverParse_ArrayBuilder_minimal_len_size(sum64),
            ml_res)
        }
      );
  }
...
static uint8_t *Pulse_Lib_Slice_slice_to_arrayptr_intro__uint8_t(byte_slice s)
{
  return s.elt;
}
...
typedef struct
FStar_Pervasives_Native_option__LowParse_PulseParse_Iterator_Type_mixed_list__CBOR_Pulse_Raw_EverParse_Type_cbor_map_entry__CBOR_Pulse_Raw_EverParse_Type_cbor_raw_s
{
  FStar_Pervasives_Native_option__uint8_t_tags tag;
  LowParse_PulseParse_Iterator_Type_mixed_list__CBOR_Pulse_Raw_EverParse_Type_cbor_map_entry__CBOR_Pulse_Raw_EverParse_Type_cbor_raw
  v;
}
FStar_Pervasives_Native_option__LowParse_PulseParse_Iterator_Type_mixed_list__CBOR_Pulse_Raw_EverParse_Type_cbor_map_entry__CBOR_Pulse_Raw_EverParse_Type_cbor_raw;
...
{
  if (cbor_det_major_type(x) == CBOR_MAJOR_TYPE_MAP)
  {
    cbor_map__CBOR_Pulse_Raw_EverParse_Type_cbor_raw ite0;
    if (x.tag == CBOR_Case_Map)
      ite0 = x.case_CBOR_Case_Map;
    else
      ite0 =
        KRML_EABORT(cbor_map__CBOR_Pulse_Raw_EverParse_Type_cbor_raw,
          "unreachable (pattern matches are exhaustive in F*)");
    LowParse_PulseParse_Iterator_Type_mixed_list__CBOR_Pulse_Raw_EverParse_Type_cbor_map_entry__CBOR_Pulse_Raw_EverParse_Type_cbor_raw
    ml0c = ite0.cbor_map_ptr;
    FStar_Pervasives_Native_option__CBOR_Pulse_Raw_EverParse_Type_cbor_raw scrut0;
    if
    (
      (uint64_t)LowParse_PulseParse_Iterator_Type_mixed_list_length__CBOR_Pulse_Raw_EverParse_Type_cbor_map_entry_CBOR_Pulse_Raw_EverParse_Type_cbor_raw(ml0c)
      <= 18446744073709551614ULL
    )
      if (CBOR_Pulse_Raw_EverParse_Det_MapInsert_cbor_raw_map_key_present(key, ml0c))
        scrut0 =
          (
            (FStar_Pervasives_Native_option__CBOR_Pulse_Raw_EverParse_Type_cbor_raw){
              .tag = FStar_Pervasives_Native_None
      ...
      {
        cbor_map_entry__CBOR_Pulse_Raw_EverParse_Type_cbor_raw
        y_elem = CBOR_Pulse_Raw_EverParse_Make_cbor_mk_map_entry(key, value);
        size_t
        total_sz =
          LowParse_PulseParse_Iterator_Type_mixed_list_length__CBOR_Pulse_Raw_EverParse_Type_cbor_map_entry_CBOR_Pulse_Raw_EverParse_Type_cbor_raw(ml0c);
        size_t r_k = (size_t)0U;
        bool r_continue = true;
        size_t r_found = (size_t)0U;
        while (r_continue)
        {
          size_t k_val = r_k;
          if (k_val == total_sz)
          ...
          else
          {
            LowParse_PulseParse_Iterator_Type_mixed_list__CBOR_Pulse_Raw_EverParse_Type_cbor_map_entry__CBOR_Pulse_Raw_EverParse_Type_cbor_raw
            ml_k;
            if (ml0c.tag == LowParse_PulseParse_Iterator_Type_Base)
            {
              LowParse_PulseParse_Iterator_Type_base_mixed_list__CBOR_Pulse_Raw_EverParse_Type_cbor_map_entry__CBOR_Pulse_Raw_EverParse_Type_cbor_raw
              bi = ml0c.case_Base;
              LowParse_PulseParse_Iterator_Type_base_mixed_list__CBOR_Pulse_Raw_EverParse_Type_cbor_map_entry__CBOR_Pulse_Raw_EverParse_Type_cbor_raw
              ...
              if (bi.tag == LowParse_PulseParse_Iterator_Type_Empty)
                ...
                ite =
                  (
                    (LowParse_PulseParse_Iterator_Type_base_mixed_list__CBOR_Pulse_Raw_EverParse_Type_cbor_map_entry__CBOR_Pulse_Raw_EverParse_Type_cbor_raw){
                      .tag = LowParse_PulseParse_Iterator_Type_Singleton,
                      { .case_Singleton = bi.case_Singleton }
                    }
                  );
              else if (bi.tag == LowParse_PulseParse_Iterator_Type_Slice)
                ite =
            ...
            else if (ml0c.tag == LowParse_PulseParse_Iterator_Type_Append)
            {
              LowParse_PulseParse_Iterator_Type_mixed_list__CBOR_Pulse_Raw_EverParse_Type_cbor_map_entry__CBOR_Pulse_Raw_EverParse_Type_cbor_raw
              *after = ml0c.case_Append.after;
              size_t oa = ml0c.case_Append.oa;
              LowParse_PulseParse_Iterator_Type_mixed_list__CBOR_Pulse_Raw_EverParse_Type_cbor_map_entry__CBOR_Pulse_Raw_EverParse_Type_cbor_raw
              *before = ml0c.case_Append.before;
              size_t ob = ml0c.case_Append.ob;
              size_t cb = ml0c.case_Append.cb;
              size_t
              cb__sz = LowParse_PulseParse_Iterator_append_n_before_sz(k_val, (size_t)1U, cb);
              size_t ca__sz = LowParse_PulseParse_Iterator_append_n_after_sz(k_val, (size_t)1U, cb);
              size_t ob__sz = LowParse_PulseParse_Iterator_append_off_before_sz(k_val, ob, cb);
              ml_k =
                (
                  (LowParse_PulseParse_Iterator_Type_mixed_list__CBOR_Pulse_Raw_EverParse_Type_cbor_map_entry__CBOR_Pulse_Raw_EverParse_Type_cbor_raw){
                    .tag = LowParse_PulseParse_Iterator_Type_Append,
                    {
                      .case_Append = {
                        .cb = cb__sz, .ca = ca__sz, .ob = ob__sz, .before = before,
                        .oa = LowParse_PulseParse_Iterator_append_off_after_sz(k_val, oa, cb),
                        .after = after
                      }
                    }
                  }
            ...
            r_node = ml_k;
            size_t r_off = (size_t)0U;
            size_t r_n = (size_t)1U;
            bool
            pcontinue =
              !LowParse_PulseParse_Iterator_Type_uu___is_Base__CBOR_Pulse_Raw_EverParse_Type_cbor_map_entry_CBOR_Pulse_Raw_EverParse_Type_cbor_raw(ml_k);
            while (pcontinue)
            {
              size_t cur_off_v = r_off;
              size_t cur_n_v = r_n;
            ...
            LowParse_PulseParse_Iterator_Type_base_mixed_list__CBOR_Pulse_Raw_EverParse_Type_cbor_map_entry__CBOR_Pulse_Raw_EverParse_Type_cbor_raw
            bi_k =
              FStar_Pervasives_Native_fst__LowParse_PulseParse_Iterator_Type_base_mixed_list_CBOR_Pulse_Raw_EverParse_Type_cbor_map_entry_CBOR_Pulse_Raw_EverParse_Type_cbor_raw_size_t(res_extract);
            FStar_Pervasives_Native_snd__LowParse_PulseParse_Iterator_Type_base_mixed_list_CBOR_Pulse_Raw_EverParse_Type_cbor_map_entry_CBOR_Pulse_Raw_EverParse_Type_cbor_raw_size_t(res_extract);
            cbor_map_entry__CBOR_Pulse_Raw_EverParse_Type_cbor_raw x_elem;
            if (bi_k.tag == LowParse_PulseParse_Iterator_Type_Empty)
              x_elem =
                KRML_EABORT(cbor_map_entry__CBOR_Pulse_Raw_EverParse_Type_cbor_raw,
                  "Pulse.Lib.Dv.unreachable");
            else if (bi_k.tag == LowParse_PulseParse_Iterator_Type_Singleton)
              x_elem = *bi_k.case_Singleton;
            else if (bi_k.tag == LowParse_PulseParse_Iterator_Type_Slice)
              x_elem =
                Pulse_Lib_Slice_op_Array_Access__CBOR_Pulse_Raw_EverParse_Type_cbor_map_entry_CBOR_Pulse_Raw_EverParse_Type_cbor_raw(bi_k.case_Slice,
                  (size_t)0U);
            else if (bi_k.tag == LowParse_PulseParse_Iterator_Type_Serialized)
            {
              byte_slice pl = bi_k.case_Serialized.payload;
              size_t pn = (size_t)0U;
              size_t poffset = (size_t)0U;
              while (pn > (size_t)0U)
              {
              ...
              x_elem =
                CBOR_Pulse_Raw_EverParse_ReadMapEntry_cbor_raw_read_map_entry(Pulse_Lib_Slice_split__uint8_t(pl,
                    poffset).snd);
            }
            else
              x_elem =
            ...
            int16_t
            ck =
              CBOR_Pulse_Raw_EverParse_Det_Compare_impl_cbor_compare(x_elem.cbor_map_entry_key,
                y_elem.cbor_map_entry_key);
            size_t cmp_result;
            if (ck < (int16_t)0)
              cmp_result = (size_t)0U;
            else if (ck > (int16_t)0)
              cmp_result = (size_t)2U;
            else
            {
              int16_t
              cv =
                CBOR_Pulse_Raw_EverParse_Det_Compare_impl_cbor_compare(x_elem.cbor_map_entry_value,
                  y_elem.cbor_map_entry_value);
              if (cv < (int16_t)0)
                cmp_result = (size_t)0U;
              else if (cv > (int16_t)0)
                cmp_result = (size_t)2U;
              else
                cmp_result = (size_t)1U;
            }
            if (cmp_result == (size_t)0U)
              r_k = k_val + (size_t)1U;
            else if (cmp_result == (size_t)1U)
            {
              r_found = (size_t)1U;
              r_continue = false;
            }
        ...
        else
        {
          ...
          else if (ml0c.tag == LowParse_PulseParse_Iterator_Type_Append)
          {
            ...
            *before = ml0c.case_Append.before;
            size_t ob = ml0c.case_Append.ob;
            size_t cb = ml0c.case_Append.cb;
            size_t cb__sz = LowParse_PulseParse_Iterator_append_n_before_sz((size_t)0U, k_val, cb);
            size_t ca__sz = LowParse_PulseParse_Iterator_append_n_after_sz((size_t)0U, k_val, cb);
            size_t ob__sz = LowParse_PulseParse_Iterator_append_off_before_sz((size_t)0U, ob, cb);
            ml_before =
              (
                (LowParse_PulseParse_Iterator_Type_mixed_list__CBOR_Pulse_Raw_EverParse_Type_cbor_map_entry__CBOR_Pulse_Raw_EverParse_Type_cbor_raw){
          ...
          else if (ml0c.tag == LowParse_PulseParse_Iterator_Type_Append)
          {
            ...
            *before = ml0c.case_Append.before;
            size_t ob = ml0c.case_Append.ob;
            size_t cb = ml0c.case_Append.cb;
            size_t cb__sz = LowParse_PulseParse_Iterator_append_n_before_sz(k_val, rest_sz, cb);
            size_t ca__sz = LowParse_PulseParse_Iterator_append_n_after_sz(k_val, rest_sz, cb);
            size_t ob__sz = LowParse_PulseParse_Iterator_append_off_before_sz(k_val, ob, cb);
            ml_after =
              (
                (LowParse_PulseParse_Iterator_Type_mixed_list__CBOR_Pulse_Raw_EverParse_Type_cbor_map_entry__CBOR_Pulse_Raw_EverParse_Type_cbor_raw){
          ...
          inner_ml =
            {
              ...
              {
                .case_Append = {
                  .cb = (size_t)1U, .ca = rest_sz, .ob = (size_t)0U, .before = r3, .oa = (size_t)0U,
                  .after = r4
                }
              }
            };
            ...
            (
              (FStar_Pervasives_Native_option__LowParse_PulseParse_Iterator_Type_mixed_list__CBOR_Pulse_Raw_EverParse_Type_cbor_map_entry__CBOR_Pulse_Raw_EverParse_Type_cbor_raw){
                ...
                .v = {
                  ...
                  {
                    .case_Append = {
                      .cb = k_val, .ca = (size_t)1U + rest_sz, .ob = (size_t)0U, .before = r1,
                      .oa = (size_t)0U, .after = r2
                    }
                  }
                }
              }
        ...
        if (scrut.tag == FStar_Pervasives_Native_Some)
        {
          ...
          scrut0 =
            (
              (FStar_Pervasives_Native_option__CBOR_Pulse_Raw_EverParse_Type_cbor_raw){
                .tag = FStar_Pervasives_Native_Some,
                .v = CBOR_Pulse_Raw_EverParse_MapBuilder_cbor_mk_map_full(CBOR_Pulse_Raw_EverParse_ArrayBuilder_minimal_len_size((uint64_t)LowParse_PulseParse_Iterator_Type_mixed_list_length__CBOR_Pulse_Raw_EverParse_Type_cbor_map_entry_CBOR_Pulse_Raw_EverParse_Type_cbor_raw(ml_result)),
                  ml_result)
              }
            );
        }
          ...
          scrut0 =
            KRML_EABORT(FStar_Pervasives_Native_option__CBOR_Pulse_Raw_EverParse_Type_cbor_raw,
              "Pulse.Lib.Dv.unreachable");
        else
          scrut0 =
            KRML_EABORT(FStar_Pervasives_Native_option__CBOR_Pulse_Raw_EverParse_Type_cbor_raw,
...
{
  byte_slice sout = Pulse_Lib_Slice_arrayptr_to_slice_intro__uint8_t(out, out_len);
  return
...
static byte_slice Pulse_Lib_Slice_from_array__uint8_t(uint8_t *a, size_t alen)
{
  return ((byte_slice){ .elt = a, .len = alen });
}
...
static cbor_det_freeable_t_ cbor_copy_impl(cbor_raw c)
{
  ...
  byte_slice sl = Pulse_Lib_Slice_from_array__uint8_t(buf, size);
