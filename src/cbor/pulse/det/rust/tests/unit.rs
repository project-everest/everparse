...
fn test22()
{
  ...
  let source_cbor : cbor_raw = cbor_det_mk_array(&source_cbor_array[..]);
  let mut target_bytes: [u8; 1] = [0xff; 1];
  let mut target_byte_size: usize = cbor_det_size(source_cbor, 1);
  assert!(target_byte_size == 1);
  target_byte_size = cbor_det_serialize (source_cbor, &mut target_bytes[..]);
...
fn test24()
{
  ...
  let source_cbor_array_2 : cbor_raw = cbor_det_mk_array(&source_cbor_array_2_array[..]);
  source_cbor_array[2] = source_cbor_array_2;
  ...
  let source_cbor_array_1 : cbor_raw = cbor_det_mk_array(&source_cbor_array_1_array[..]);
  source_cbor_array[1] = source_cbor_array_1;
  let source_cbor_array_0 : cbor_raw = cbor_det_mk_int64(cbor_major_type_uint64,1);
  source_cbor_array[0] = source_cbor_array_0;
  let source_cbor : cbor_raw = cbor_det_mk_array(&source_cbor_array[..]);
...
fn test26()
{
  ...
  let source_cbor : cbor_raw = cbor_det_mk_map(& mut source_cbor_map[..]);
  let mut target_bytes: [u8; 1] = [0xff; 1];
  let mut target_byte_size: usize = cbor_det_size(source_cbor, 1);
  assert!(target_byte_size == 1);
  target_byte_size = cbor_det_serialize (source_cbor, &mut target_bytes[..]);
...
fn test27()
{
  ...
  let source_cbor_map_1_value : cbor_raw = cbor_det_mk_array(&source_cbor_map_1_value_array[..]);
...
fn test28()
{
  ...
  let source_cbor_array_1 : cbor_raw = cbor_det_mk_map(& mut source_cbor_array_1_map[..]);
  source_cbor_array[1] = source_cbor_array_1;
