...
fn test15()
{
  ...
  let source_bytes = &source_bytes[..];
  let source_cbor : CborDet = cbor_det_mk_string(CborDetStringKind::TextString, str::as_bytes("")).expect("Expected string short enough");
  let mut target_bytes: [u8; 1] = [0xff; 1];
  let mut target_byte_size: usize = (cbor_det_size(source_cbor, 1)).expect("Expected some size to be returned");
  assert!(target_byte_size == 1);
  target_byte_size = (cbor_det_serialize (source_cbor, &mut target_bytes[..])).expect("Expected serialization to succeed");
...
fn test16()
{
  ...
  let source_bytes = &source_bytes[..];
  let source_cbor : CborDet = cbor_det_mk_string(CborDetStringKind::TextString, str::as_bytes("a")).expect("Expected string short enough");
  let mut target_bytes: [u8; 2] = [0xff; 2];
  let mut target_byte_size: usize = (cbor_det_size(source_cbor, 2)).expect("Expected some size to be returned");
  assert!(target_byte_size == 2);
  target_byte_size = (cbor_det_serialize (source_cbor, &mut target_bytes[..])).expect("Expected serialization to succeed");
...
fn test17()
{
  ...
  let source_bytes = &source_bytes[..];
  let source_cbor : CborDet = cbor_det_mk_string(CborDetStringKind::TextString, str::as_bytes("IETF")).expect("Expected string short enough");
  let mut target_bytes: [u8; 5] = [0xff; 5];
  let mut target_byte_size: usize = (cbor_det_size(source_cbor, 5)).expect("Expected some size to be returned");
  assert!(target_byte_size == 5);
  target_byte_size = (cbor_det_serialize (source_cbor, &mut target_bytes[..])).expect("Expected serialization to succeed");
...
fn test19()
{
  ...
  let source_bytes = &source_bytes[..];
  let source_cbor : CborDet = cbor_det_mk_string(CborDetStringKind::TextString, str::as_bytes("ü")).expect("Expected string short enough");
  let mut target_bytes: [u8; 3] = [0xff; 3];
  let mut target_byte_size: usize = (cbor_det_size(source_cbor, 3)).expect("Expected some size to be returned");
  assert!(target_byte_size == 3);
  target_byte_size = (cbor_det_serialize (source_cbor, &mut target_bytes[..])).expect("Expected serialization to succeed");
...
fn test20()
{
  ...
  let source_bytes = &source_bytes[..];
  let source_cbor : CborDet = cbor_det_mk_string(CborDetStringKind::TextString, str::as_bytes("水")).expect("Expected string short enough");
...
fn test21()
{
  ...
  let source_bytes = &source_bytes[..];
  let source_cbor : CborDet = cbor_det_mk_string(CborDetStringKind::TextString, str::as_bytes("𐅑")).expect("Expected string short enough");
  let mut target_bytes: [u8; 5] = [0xff; 5];
  let mut target_byte_size: usize = (cbor_det_size(source_cbor, 5)).expect("Expected some size to be returned");
  assert!(target_byte_size == 5);
  target_byte_size = (cbor_det_serialize (source_cbor, &mut target_bytes[..])).expect("Expected serialization to succeed");
...
fn test27()
{
  ...
  let source_cbor_map_1_key : CborDet = cbor_det_mk_string(CborDetStringKind::TextString, str::as_bytes("b")).expect("Expected string short enough");
  ...
  let source_cbor_map_0_key : CborDet = cbor_det_mk_string(CborDetStringKind::TextString, str::as_bytes("a")).expect("Expected string short enough");
...
fn test28()
{
  ...
  let source_cbor_array_1_map_0_key : CborDet = cbor_det_mk_string(CborDetStringKind::TextString, str::as_bytes("b")).expect("Expected string short enough");
  let source_cbor_array_1_map_0_value : CborDet = cbor_det_mk_string(CborDetStringKind::TextString, str::as_bytes("c")).expect("Expected string short enough");
  ...
  source_cbor_array[1] = source_cbor_array_1;
  let source_cbor_array_0 : CborDet = cbor_det_mk_string(CborDetStringKind::TextString, str::as_bytes("a")).expect("Expected string short enough");
  source_cbor_array[0] = source_cbor_array_0;
  let source_cbor : CborDet = cbor_det_mk_array(&source_cbor_array[..]).expect("Expected an array small enough");
  let mut target_bytes: [u8; 8] = [0xff; 8];
  let mut target_byte_size: usize = (cbor_det_size(source_cbor, 8)).expect("Expected some size to be returned");
...
fn test29()
{
  ...
  let source_cbor_map_4_key : CborDet = cbor_det_mk_string(CborDetStringKind::TextString, str::as_bytes("e")).expect("Expected string short enough");
  let source_cbor_map_4_value : CborDet = cbor_det_mk_string(CborDetStringKind::TextString, str::as_bytes("E")).expect("Expected string short enough");
  source_cbor_map[4] = cbor_det_mk_map_entry(source_cbor_map_4_key, source_cbor_map_4_value);
  let source_cbor_map_3_key : CborDet = cbor_det_mk_string(CborDetStringKind::TextString, str::as_bytes("d")).expect("Expected string short enough");
  let source_cbor_map_3_value : CborDet = cbor_det_mk_string(CborDetStringKind::TextString, str::as_bytes("D")).expect("Expected string short enough");
  source_cbor_map[3] = cbor_det_mk_map_entry(source_cbor_map_3_key, source_cbor_map_3_value);
  let source_cbor_map_2_key : CborDet = cbor_det_mk_string(CborDetStringKind::TextString, str::as_bytes("c")).expect("Expected string short enough");
  let source_cbor_map_2_value : CborDet = cbor_det_mk_string(CborDetStringKind::TextString, str::as_bytes("C")).expect("Expected string short enough");
  source_cbor_map[2] = cbor_det_mk_map_entry(source_cbor_map_2_key, source_cbor_map_2_value);
  let source_cbor_map_1_key : CborDet = cbor_det_mk_string(CborDetStringKind::TextString, str::as_bytes("b")).expect("Expected string short enough");
  let source_cbor_map_1_value : CborDet = cbor_det_mk_string(CborDetStringKind::TextString, str::as_bytes("B")).expect("Expected string short enough");
  source_cbor_map[1] = cbor_det_mk_map_entry(source_cbor_map_1_key, source_cbor_map_1_value);
  let source_cbor_map_0_key : CborDet = cbor_det_mk_string(CborDetStringKind::TextString, str::as_bytes("a")).expect("Expected string short enough");
  let source_cbor_map_0_value : CborDet = cbor_det_mk_string(CborDetStringKind::TextString, str::as_bytes("A")).expect("Expected string short enough");
  source_cbor_map[0] = cbor_det_mk_map_entry(source_cbor_map_0_key, source_cbor_map_0_value);
  let source_cbor : CborDet = (cbor_det_mk_map(& mut source_cbor_map[..])).expect("Expected a well-formed map");
