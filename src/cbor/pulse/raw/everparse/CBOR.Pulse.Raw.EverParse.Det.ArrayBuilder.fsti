...
(* Ownership of a structurally-built deterministic-CBOR array. *)
...
fn cbor_det_array_append
  (x1 x2: cbor_det_t)
  (r_before r_after: R.ref (IT.mixed_list cbor_det_t))
  (#l1 #l2: Ghost.erased (list Spec.cbor))
  (#vb0 #va0: Ghost.erased (IT.mixed_list cbor_det_t))
requires
