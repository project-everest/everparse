...
typedef struct
K___CBOR_Pulse_Raw_EverParse_Type_cbor_raw_LowParse_PulseParse_Iterator_Type_base_mixed_list__CBOR_Pulse_Raw_EverParse_Type_cbor_raw_s
{
  cbor_raw fst;
  LowParse_PulseParse_Iterator_Type_base_mixed_list__CBOR_Pulse_Raw_EverParse_Type_cbor_raw snd;
}
K___CBOR_Pulse_Raw_EverParse_Type_cbor_raw_LowParse_PulseParse_Iterator_Type_base_mixed_list__CBOR_Pulse_Raw_EverParse_Type_cbor_raw;

static K___CBOR_Pulse_Raw_EverParse_Type_cbor_raw_LowParse_PulseParse_Iterator_Type_base_mixed_list__CBOR_Pulse_Raw_EverParse_Type_cbor_raw
CBOR_Pulse_Raw_EverParse_MapEntry_Fuel_base_iterator_next_raw_data_item_fuel(
  LowParse_PulseParse_Iterator_Type_base_mixed_list__CBOR_Pulse_Raw_EverParse_Type_cbor_raw x
)
{
  LowParse_PulseParse_Iterator_Type_base_mixed_list__CBOR_Pulse_Raw_EverParse_Type_cbor_raw
  r = x;
  ...
  len_sz =
    LowParse_PulseParse_Iterator_Type_base_mixed_list_length__CBOR_Pulse_Raw_EverParse_Type_cbor_raw(bi);
  LowParse_PulseParse_Iterator_elt_or_serialized__CBOR_Pulse_Raw_EverParse_Type_cbor_raw scrut;
  if (len_sz == (size_t)0U)
    scrut =
      KRML_EABORT(LowParse_PulseParse_Iterator_elt_or_serialized__CBOR_Pulse_Raw_EverParse_Type_cbor_raw,
        "Pulse.Lib.Dv.unreachable");
  ...
  cbor_raw elt;
  if (scrut.tag == LowParse_PulseParse_Iterator_EElement)
    elt = scrut.case_EElement;
  else if (scrut.tag == LowParse_PulseParse_Iterator_ESerialized)
    elt = CBOR_Pulse_Raw_EverParse_Read_cbor_raw_read_fuel(scrut.case_ESerialized);
  else
    elt = KRML_EABORT(cbor_raw, "unreachable (pattern matches are exhaustive in F*)");
  return
    (
...
)
{
  ...
  {
    byte_slice pl = scrut1.case_ESerialized;
    K___CBOR_Pulse_Raw_Slice_byte_slice_CBOR_Pulse_Raw_Slice_byte_slice
    scrut =
    ...
    if (ar_ml1.tag == LowParse_PulseParse_Iterator_Type_Base)
    {
      ...
      if (ar_ml2.tag == LowParse_PulseParse_Iterator_Type_Base)
      {
        ...
        while (cond)
        {
          K___CBOR_Pulse_Raw_EverParse_Type_cbor_raw_LowParse_PulseParse_Iterator_Type_base_mixed_list__CBOR_Pulse_Raw_EverParse_Type_cbor_raw
          scrut0 =
            CBOR_Pulse_Raw_EverParse_MapEntry_Fuel_base_iterator_next_raw_data_item_fuel(r_it1);
          cbor_raw e1 = scrut0.fst;
          r_it1 = scrut0.snd;
          K___CBOR_Pulse_Raw_EverParse_Type_cbor_raw_LowParse_PulseParse_Iterator_Type_base_mixed_list__CBOR_Pulse_Raw_EverParse_Type_cbor_raw
          scrut1 =
            CBOR_Pulse_Raw_EverParse_MapEntry_Fuel_base_iterator_next_raw_data_item_fuel(r_it2);
        ...
        return
          CBOR_Pulse_Raw_EverParse_Nondet_Compare_compare_cbor_raw_basic_fuel_array_slow(map_bound,
            x1,
            x2,
            len);
    }
    ...
    (
      ...
      else
      {
        ...
        while (cond)
        {
          ...
          K___CBOR_Pulse_Raw_Slice_byte_slice_CBOR_Pulse_Raw_Slice_byte_slice
          scrut4 = { .fst = scrut3.fst, .snd = scrut3.snd };
          byte_slice lh = scrut4.fst;
          byte_slice lt = scrut4.snd;
          K___CBOR_Pulse_Raw_Slice_byte_slice_CBOR_Pulse_Raw_Slice_byte_slice
          scrut5 =
          ...
          byte_slice lv = scrut9.fst;
          byte_slice lt_ = scrut9.snd;
          byte_slice pll = c2;
          size_t pn1 = nv2;
          FStar_Pervasives_Native_option__bool
          ...
          while (cond0)
          {
            ...
            K___CBOR_Pulse_Raw_Slice_byte_slice_CBOR_Pulse_Raw_Slice_byte_slice
            scrut4 = { .fst = scrut3.fst, .snd = scrut3.snd };
            byte_slice lt1 = scrut4.snd;
            size_t pn2 = (size_t)1U;
            byte_slice pl10 = lh;
            byte_slice pl20 = scrut4.fst;
            FStar_Pervasives_Native_option__bool
            ...
            while (cond)
            {
              ...
              else
              {
                ...
                else
                {
                  ...
                  K___CBOR_Pulse_Raw_Slice_byte_slice_CBOR_Pulse_Raw_Slice_byte_slice
                  scrut4 = { .fst = scrut3.fst, .snd = scrut3.snd };
                  byte_slice lc1 = scrut4.fst;
                  byte_slice tl1_ = scrut4.snd;
                  size_t
                  n_2 =
                  ...
                  K___CBOR_Pulse_Raw_Slice_byte_slice_CBOR_Pulse_Raw_Slice_byte_slice
                  scrut9 = { .fst = scrut8.fst, .snd = scrut8.snd };
                  byte_slice lc2 = scrut9.fst;
                  byte_slice tl2_ = scrut9.snd;
            ...
            else
            {
              ...
              K___CBOR_Pulse_Raw_Slice_byte_slice_CBOR_Pulse_Raw_Slice_byte_slice
              scrut4 = { .fst = scrut3.fst, .snd = scrut3.snd };
              byte_slice lv1 = scrut4.fst;
              byte_slice lt_1 = scrut4.snd;
              bool ite0;
...
)
{
  ...
  {
    size_t pn = n1;
    byte_slice pl1 = exact1;
    byte_slice pl2 = exact2;
  ...
  while (pres && pn > (size_t)0U)
  {
    ...
    if (CBOR_Spec_Raw_EverParse_get_header_major_type(h) == CBOR_MAJOR_TYPE_MAP)
    {
      ...
      while (cond)
      {
        ...
        K___CBOR_Pulse_Raw_Slice_byte_slice_CBOR_Pulse_Raw_Slice_byte_slice
        scrut3 = { .fst = scrut2.fst, .snd = scrut2.snd };
        byte_slice lh = scrut3.fst;
        byte_slice lt = scrut3.snd;
        K___CBOR_Pulse_Raw_Slice_byte_slice_CBOR_Pulse_Raw_Slice_byte_slice
        scrut4 =
          Pulse_Lib_Slice_split__uint8_t(lt,
            CBOR_Pulse_Raw_EverParse_Validate_jump_raw_data_item(lt, (size_t)0U));
...
static cbor_raw
CBOR_Pulse_Raw_EverParse_Nondet_ArrayBuilder_mk_array_owned_with_ptr(
  uint8_t len_size,
  LowParse_PulseParse_Iterator_Type_mixed_list__CBOR_Pulse_Raw_EverParse_Type_cbor_raw ml
)
{
...
)
{
  ...
  else
  {
    ...
    {
      size_t len1 = *plen;
      byte_slice s = Pulse_Lib_Slice_arrayptr_to_slice_intro__uint8_t(input1, len1);
      FStar_Pervasives_Native_option__size_t ite;
...
size_t cbor_nondet_serialize(cbor_raw x, uint8_t *output, size_t len)
{
  ...
  {
    byte_slice s = Pulse_Lib_Slice_arrayptr_to_slice_intro__uint8_t(output, len);
...
cbor_raw cbor_nondet_array_singleton(cbor_raw x, cbor_raw *ry)
{
  *ry = x;
  ...
  return
    CBOR_Pulse_Raw_EverParse_Nondet_ArrayBuilder_mk_array_owned_with_ptr(CBOR_Pulse_Raw_EverParse_ArrayBuilder_minimal_len_size(1ULL),
      ml);
}
...
)
{
  ...
  uint64_t la64 = (uint64_t)len_a;
  uint64_t lb64 = (uint64_t)len_b;
    ...
    *r_after = ml_b;
    ...
    ml_res =
      {
        ...
        {
          .case_Append = {
            .cb = len_a, .ca = len_b, .ob = (size_t)0U, .before = r_before, .oa = (size_t)0U,
            .after = r_after
          }
        }
      };
    return
      (
        (FStar_Pervasives_Native_option__CBOR_Pulse_Raw_EverParse_Type_cbor_raw){
          .tag = FStar_Pervasives_Native_Some,
          .v = CBOR_Pulse_Raw_EverParse_Nondet_ArrayBuilder_mk_array_owned_with_ptr(CBOR_Pulse_Raw_EverParse_ArrayBuilder_minimal_len_size(sum64),
            ml_res)
        }
      );
  }
...
{
  if (cbor_nondet_major_type(x) == CBOR_MAJOR_TYPE_MAP)
  {
    ...
    )
    {
      ...
      cbor_nondet_map_iterator_t it0;
      if (total_sz == (size_t)0U)
        it0 =
          (
            (cbor_nondet_map_iterator_t){
      ...
      else
      {
        ...
        bool
        pcontinue =
          !LowParse_PulseParse_Iterator_Type_uu___is_Base__CBOR_Pulse_Raw_EverParse_Type_cbor_map_entry_CBOR_Pulse_Raw_EverParse_Type_cbor_raw(ml0c);
        while (pcontinue)
        {
          size_t cur_off_v = r_off;
          size_t cur_n_v = r_n;
      ...
      cbor_nondet_map_iterator_t r_it = it0;
      bool r_found = false;
      bool ite0;
      if (it0.tag == IBase)
        ite0 =
      ...
      {
        K___CBOR_Pulse_Raw_EverParse_Type_cbor_map_entry__CBOR_Pulse_Raw_EverParse_Type_cbor_raw_CBOR_Pulse_API_Nondet_Type_cbor_nondet_map_iterator_t
        scrut0 = CBOR_Pulse_Raw_EverParse_ReadMapEntry_iterator_next_map_entry_raw_data_item(r_it);
        cbor_nondet_map_iterator_t tail_it = scrut0.snd;
        FStar_Pervasives_Native_option__bool
        scrut =
          CBOR_Pulse_Raw_EverParse_Nondet_Compare_compare_cbor_raw_basic_fuel((
              (FStar_Pervasives_Native_option__size_t){ .tag = FStar_Pervasives_Native_None }
      ...
      {
        *ry = CBOR_Pulse_Raw_EverParse_Make_cbor_mk_map_entry(key, value);
        LowParse_PulseParse_Iterator_Type_mixed_list__CBOR_Pulse_Raw_EverParse_Type_cbor_map_entry__CBOR_Pulse_Raw_EverParse_Type_cbor_raw
        sing_ml =
          {
            .tag = LowParse_PulseParse_Iterator_Type_Base,
        ...
        size_t
        len_a =
          LowParse_PulseParse_Iterator_Type_mixed_list_length__CBOR_Pulse_Raw_EverParse_Type_cbor_map_entry_CBOR_Pulse_Raw_EverParse_Type_cbor_raw(sing_ml);
        size_t
        len_b =
          LowParse_PulseParse_Iterator_Type_mixed_list_length__CBOR_Pulse_Raw_EverParse_Type_cbor_map_entry_CBOR_Pulse_Raw_EverParse_Type_cbor_raw(ml0c);
        *r1 = sing_ml;
        *r2 = ml0c;
        ...
        res_ml =
          {
            ...
            {
              .case_Append = {
                .cb = len_a, .ca = len_b, .ob = (size_t)0U, .before = r1, .oa = (size_t)0U,
                .after = r2
              }
            }
          };
        scrut0 =
          (
            (FStar_Pervasives_Native_option__CBOR_Pulse_Raw_EverParse_Type_cbor_raw){
              .tag = FStar_Pervasives_Native_Some,
              .v = CBOR_Pulse_Raw_EverParse_MapBuilder_cbor_mk_map_full(CBOR_Pulse_Raw_EverParse_ArrayBuilder_minimal_len_size((uint64_t)LowParse_PulseParse_Iterator_Type_mixed_list_length__CBOR_Pulse_Raw_EverParse_Type_cbor_map_entry_CBOR_Pulse_Raw_EverParse_Type_cbor_raw(res_ml)),
                res_ml)
            }
          );
      }
