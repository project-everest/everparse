...
int gentest(void) {
  {
    ...
    cbor_nondet_t source_cbor = cbor_nondet_mk_int64(CBOR_MAJOR_TYPE_UINT64,0);
    ...
    size_t target_byte_size2 = cbor_nondet_validate(false, 0, false, target_bytes, target_byte_size);
    ...
    cbor_nondet_t target_cbor = cbor_nondet_parse_valid(target_bytes, target_byte_size2);
    ...
    target_byte_size2 = cbor_nondet_validate(false, 0, false, source_bytes, target_byte_size);
    if (target_byte_size2 == 0)
    {
      printf("Validation failed: expected 1 bytes, got 0\n");
      return 1;
    }
    printf("Validation succeeded!\n");
    target_cbor = cbor_nondet_parse_valid(source_bytes, target_byte_size2);
    printf("Parsing succeeded!\n");
    if (! (cbor_nondet_equal(source_cbor, target_cbor)))
    {
      printf("Decoding mismatch!\n");
  ...
  }
  {
    ...
    cbor_nondet_t source_cbor = cbor_nondet_mk_int64(CBOR_MAJOR_TYPE_UINT64,1);
    uint8_t target_bytes[1];
    size_t target_byte_size = cbor_nondet_serialize (source_cbor, target_bytes, 1);
    if (target_byte_size == 0)
    {
  ...
  }
  {
    ...
    cbor_nondet_t source_cbor = cbor_nondet_mk_int64(CBOR_MAJOR_TYPE_UINT64,10);
    uint8_t target_bytes[1];
    size_t target_byte_size = cbor_nondet_serialize (source_cbor, target_bytes, 1);
    if (target_byte_size == 0)
    {
  ...
  }
  {
    ...
    cbor_nondet_t source_cbor = cbor_nondet_mk_int64(CBOR_MAJOR_TYPE_UINT64,23);
    uint8_t target_bytes[1];
    size_t target_byte_size = cbor_nondet_serialize (source_cbor, target_bytes, 1);
    if (target_byte_size == 0)
    {
  ...
  }
  {
    ...
    cbor_nondet_t source_cbor = cbor_nondet_mk_int64(CBOR_MAJOR_TYPE_UINT64,24);
    ...
    if (target_byte_size2 == 0)
    {
      printf("Validation failed: expected 2 bytes, got 0\n");
      return 1;
    }
    printf("Validation succeeded!\n");
    target_cbor = cbor_nondet_parse_valid(source_bytes, target_byte_size2);
  ...
  }
  {
    ...
    cbor_nondet_t source_cbor = cbor_nondet_mk_int64(CBOR_MAJOR_TYPE_UINT64,25);
    uint8_t target_bytes[2];
    size_t target_byte_size = cbor_nondet_serialize (source_cbor, target_bytes, 2);
    if (target_byte_size == 0)
    {
  ...
  }
  {
    ...
    cbor_nondet_t source_cbor = cbor_nondet_mk_int64(CBOR_MAJOR_TYPE_UINT64,100);
    uint8_t target_bytes[2];
    size_t target_byte_size = cbor_nondet_serialize (source_cbor, target_bytes, 2);
    if (target_byte_size == 0)
    {
  ...
  }
  {
    ...
    cbor_nondet_t source_cbor = cbor_nondet_mk_int64(CBOR_MAJOR_TYPE_UINT64,1000);
    ...
    if (target_byte_size2 == 0)
    {
      printf("Validation failed: expected 3 bytes, got 0\n");
      return 1;
    }
    printf("Validation succeeded!\n");
    target_cbor = cbor_nondet_parse_valid(source_bytes, target_byte_size2);
  ...
  }
  {
    ...
    cbor_nondet_t source_cbor = cbor_nondet_mk_int64(CBOR_MAJOR_TYPE_UINT64,1000000);
    ...
    if (target_byte_size2 == 0)
    {
      printf("Validation failed: expected 5 bytes, got 0\n");
      return 1;
    }
    printf("Validation succeeded!\n");
    target_cbor = cbor_nondet_parse_valid(source_bytes, target_byte_size2);
  ...
  }
  {
    ...
    cbor_nondet_t source_cbor = cbor_nondet_mk_int64(CBOR_MAJOR_TYPE_UINT64,1000000000000);
    ...
    if (target_byte_size2 == 0)
    {
      printf("Validation failed: expected 9 bytes, got 0\n");
      return 1;
    }
    printf("Validation succeeded!\n");
    target_cbor = cbor_nondet_parse_valid(source_bytes, target_byte_size2);
  ...
  }
  {
    ...
    cbor_nondet_t source_cbor = cbor_nondet_mk_int64(CBOR_MAJOR_TYPE_NEG_INT64,0);
    uint8_t target_bytes[1];
    size_t target_byte_size = cbor_nondet_serialize (source_cbor, target_bytes, 1);
    if (target_byte_size == 0)
    {
  ...
  }
  {
    ...
    cbor_nondet_t source_cbor = cbor_nondet_mk_int64(CBOR_MAJOR_TYPE_NEG_INT64,9);
    uint8_t target_bytes[1];
    size_t target_byte_size = cbor_nondet_serialize (source_cbor, target_bytes, 1);
    if (target_byte_size == 0)
    {
  ...
  }
  {
    ...
    cbor_nondet_t source_cbor = cbor_nondet_mk_int64(CBOR_MAJOR_TYPE_NEG_INT64,99);
    uint8_t target_bytes[2];
    size_t target_byte_size = cbor_nondet_serialize (source_cbor, target_bytes, 2);
    if (target_byte_size == 0)
    {
  ...
  }
  {
    ...
    cbor_nondet_t source_cbor = cbor_nondet_mk_int64(CBOR_MAJOR_TYPE_NEG_INT64,999);
    uint8_t target_bytes[3];
    size_t target_byte_size = cbor_nondet_serialize (source_cbor, target_bytes, 3);
    if (target_byte_size == 0)
    {
  ...
  }
  {
    ...
    cbor_nondet_t source_cbor = cbor_nondet_mk_string(CBOR_MAJOR_TYPE_TEXT_STRING, (uint8_t *)"", 0);
    uint8_t target_bytes[1];
    size_t target_byte_size = cbor_nondet_serialize (source_cbor, target_bytes, 1);
    if (target_byte_size == 0)
    {
  ...
  }
  {
    ...
    cbor_nondet_t source_cbor = cbor_nondet_mk_string(CBOR_MAJOR_TYPE_TEXT_STRING, (uint8_t *)"a", 1);
    uint8_t target_bytes[2];
    size_t target_byte_size = cbor_nondet_serialize (source_cbor, target_bytes, 2);
    if (target_byte_size == 0)
    {
  ...
  }
  {
    ...
    cbor_nondet_t source_cbor = cbor_nondet_mk_string(CBOR_MAJOR_TYPE_TEXT_STRING, (uint8_t *)"IETF", 4);
    uint8_t target_bytes[5];
    size_t target_byte_size = cbor_nondet_serialize (source_cbor, target_bytes, 5);
    if (target_byte_size == 0)
    {
  ...
  }
  {
    ...
    cbor_nondet_t source_cbor = cbor_nondet_mk_string(CBOR_MAJOR_TYPE_TEXT_STRING, (uint8_t *)"\"\\", 2);
    uint8_t target_bytes[3];
    size_t target_byte_size = cbor_nondet_serialize (source_cbor, target_bytes, 3);
    if (target_byte_size == 0)
    {
  ...
  }
  {
    ...
    cbor_nondet_t source_cbor = cbor_nondet_mk_string(CBOR_MAJOR_TYPE_TEXT_STRING, (uint8_t *)"ü", 2);
    uint8_t target_bytes[3];
    size_t target_byte_size = cbor_nondet_serialize (source_cbor, target_bytes, 3);
    if (target_byte_size == 0)
    {
  ...
  }
  {
    ...
    cbor_nondet_t source_cbor = cbor_nondet_mk_string(CBOR_MAJOR_TYPE_TEXT_STRING, (uint8_t *)"水", 3);
    ...
    if (target_byte_size2 == 0)
    {
      printf("Validation failed: expected 4 bytes, got 0\n");
      return 1;
    }
    printf("Validation succeeded!\n");
    target_cbor = cbor_nondet_parse_valid(source_bytes, target_byte_size2);
  ...
  }
  {
    ...
    cbor_nondet_t source_cbor = cbor_nondet_mk_string(CBOR_MAJOR_TYPE_TEXT_STRING, (uint8_t *)"𐅑", 4);
    uint8_t target_bytes[5];
    size_t target_byte_size = cbor_nondet_serialize (source_cbor, target_bytes, 5);
    if (target_byte_size == 0)
    {
  ...
  }
  {
    ...
    cbor_nondet_t source_cbor = cbor_nondet_mk_array(source_cbor_array, 0);
    uint8_t target_bytes[1];
    size_t target_byte_size = cbor_nondet_serialize (source_cbor, target_bytes, 1);
    if (target_byte_size == 0)
    {
  ...
  }
  {
    ...
    cbor_nondet_t source_cbor_map_2 = cbor_nondet_mk_int64(CBOR_MAJOR_TYPE_UINT64,3);
    source_cbor_array[2] = source_cbor_map_2;
    cbor_nondet_t source_cbor_map_1 = cbor_nondet_mk_int64(CBOR_MAJOR_TYPE_UINT64,2);
    source_cbor_array[1] = source_cbor_map_1;
    cbor_nondet_t source_cbor_map_0 = cbor_nondet_mk_int64(CBOR_MAJOR_TYPE_UINT64,1);
    source_cbor_array[0] = source_cbor_map_0;
    cbor_nondet_t source_cbor = cbor_nondet_mk_array(source_cbor_array, 3);
    uint8_t target_bytes[4];
    size_t target_byte_size = cbor_nondet_serialize (source_cbor, target_bytes, 4);
    if (target_byte_size == 0)
    {
  ...
  }
  {
    ...
    cbor_nondet_t source_cbor_array[3];
    cbor_nondet_t source_cbor_map_2_array[2];
    cbor_nondet_t source_cbor_map_2_map_1 = cbor_nondet_mk_int64(CBOR_MAJOR_TYPE_UINT64,5);
    source_cbor_map_2_array[1] = source_cbor_map_2_map_1;
    cbor_nondet_t source_cbor_map_2_map_0 = cbor_nondet_mk_int64(CBOR_MAJOR_TYPE_UINT64,4);
    source_cbor_map_2_array[0] = source_cbor_map_2_map_0;
    cbor_nondet_t source_cbor_map_2 = cbor_nondet_mk_array(source_cbor_map_2_array, 2);
    source_cbor_array[2] = source_cbor_map_2;
    cbor_nondet_t source_cbor_map_1_array[2];
    cbor_nondet_t source_cbor_map_1_map_1 = cbor_nondet_mk_int64(CBOR_MAJOR_TYPE_UINT64,3);
    source_cbor_map_1_array[1] = source_cbor_map_1_map_1;
    cbor_nondet_t source_cbor_map_1_map_0 = cbor_nondet_mk_int64(CBOR_MAJOR_TYPE_UINT64,2);
    source_cbor_map_1_array[0] = source_cbor_map_1_map_0;
    cbor_nondet_t source_cbor_map_1 = cbor_nondet_mk_array(source_cbor_map_1_array, 2);
    source_cbor_array[1] = source_cbor_map_1;
    cbor_nondet_t source_cbor_map_0 = cbor_nondet_mk_int64(CBOR_MAJOR_TYPE_UINT64,1);
    source_cbor_array[0] = source_cbor_map_0;
    cbor_nondet_t source_cbor = cbor_nondet_mk_array(source_cbor_array, 3);
    ...
    if (target_byte_size2 == 0)
    {
      printf("Validation failed: expected 8 bytes, got 0\n");
      return 1;
    }
    printf("Validation succeeded!\n");
    target_cbor = cbor_nondet_parse_valid(source_bytes, target_byte_size2);
  ...
  }
  {
    ...
    cbor_nondet_t source_cbor_map_24 = cbor_nondet_mk_int64(CBOR_MAJOR_TYPE_UINT64,25);
    source_cbor_array[24] = source_cbor_map_24;
    cbor_nondet_t source_cbor_map_23 = cbor_nondet_mk_int64(CBOR_MAJOR_TYPE_UINT64,24);
    source_cbor_array[23] = source_cbor_map_23;
    cbor_nondet_t source_cbor_map_22 = cbor_nondet_mk_int64(CBOR_MAJOR_TYPE_UINT64,23);
    source_cbor_array[22] = source_cbor_map_22;
    cbor_nondet_t source_cbor_map_21 = cbor_nondet_mk_int64(CBOR_MAJOR_TYPE_UINT64,22);
    source_cbor_array[21] = source_cbor_map_21;
    cbor_nondet_t source_cbor_map_20 = cbor_nondet_mk_int64(CBOR_MAJOR_TYPE_UINT64,21);
    source_cbor_array[20] = source_cbor_map_20;
    cbor_nondet_t source_cbor_map_19 = cbor_nondet_mk_int64(CBOR_MAJOR_TYPE_UINT64,20);
    source_cbor_array[19] = source_cbor_map_19;
    cbor_nondet_t source_cbor_map_18 = cbor_nondet_mk_int64(CBOR_MAJOR_TYPE_UINT64,19);
    source_cbor_array[18] = source_cbor_map_18;
    cbor_nondet_t source_cbor_map_17 = cbor_nondet_mk_int64(CBOR_MAJOR_TYPE_UINT64,18);
    source_cbor_array[17] = source_cbor_map_17;
    cbor_nondet_t source_cbor_map_16 = cbor_nondet_mk_int64(CBOR_MAJOR_TYPE_UINT64,17);
    source_cbor_array[16] = source_cbor_map_16;
    cbor_nondet_t source_cbor_map_15 = cbor_nondet_mk_int64(CBOR_MAJOR_TYPE_UINT64,16);
    source_cbor_array[15] = source_cbor_map_15;
    cbor_nondet_t source_cbor_map_14 = cbor_nondet_mk_int64(CBOR_MAJOR_TYPE_UINT64,15);
    source_cbor_array[14] = source_cbor_map_14;
    cbor_nondet_t source_cbor_map_13 = cbor_nondet_mk_int64(CBOR_MAJOR_TYPE_UINT64,14);
    source_cbor_array[13] = source_cbor_map_13;
    cbor_nondet_t source_cbor_map_12 = cbor_nondet_mk_int64(CBOR_MAJOR_TYPE_UINT64,13);
    source_cbor_array[12] = source_cbor_map_12;
    cbor_nondet_t source_cbor_map_11 = cbor_nondet_mk_int64(CBOR_MAJOR_TYPE_UINT64,12);
    source_cbor_array[11] = source_cbor_map_11;
    cbor_nondet_t source_cbor_map_10 = cbor_nondet_mk_int64(CBOR_MAJOR_TYPE_UINT64,11);
    source_cbor_array[10] = source_cbor_map_10;
    cbor_nondet_t source_cbor_map_9 = cbor_nondet_mk_int64(CBOR_MAJOR_TYPE_UINT64,10);
    source_cbor_array[9] = source_cbor_map_9;
    cbor_nondet_t source_cbor_map_8 = cbor_nondet_mk_int64(CBOR_MAJOR_TYPE_UINT64,9);
    source_cbor_array[8] = source_cbor_map_8;
    cbor_nondet_t source_cbor_map_7 = cbor_nondet_mk_int64(CBOR_MAJOR_TYPE_UINT64,8);
    source_cbor_array[7] = source_cbor_map_7;
    cbor_nondet_t source_cbor_map_6 = cbor_nondet_mk_int64(CBOR_MAJOR_TYPE_UINT64,7);
    source_cbor_array[6] = source_cbor_map_6;
    cbor_nondet_t source_cbor_map_5 = cbor_nondet_mk_int64(CBOR_MAJOR_TYPE_UINT64,6);
    source_cbor_array[5] = source_cbor_map_5;
    cbor_nondet_t source_cbor_map_4 = cbor_nondet_mk_int64(CBOR_MAJOR_TYPE_UINT64,5);
    source_cbor_array[4] = source_cbor_map_4;
    cbor_nondet_t source_cbor_map_3 = cbor_nondet_mk_int64(CBOR_MAJOR_TYPE_UINT64,4);
    ...
    cbor_nondet_t source_cbor_map_0 = cbor_nondet_mk_int64(CBOR_MAJOR_TYPE_UINT64,1);
    source_cbor_array[0] = source_cbor_map_0;
    cbor_nondet_t source_cbor = cbor_nondet_mk_array(source_cbor_array, 25);
    ...
    if (target_byte_size2 == 0)
    {
      printf("Validation failed: expected 29 bytes, got 0\n");
      return 1;
    }
    printf("Validation succeeded!\n");
    target_cbor = cbor_nondet_parse_valid(source_bytes, target_byte_size2);
  ...
  }
  {
    ...
    if (! cbor_nondet_mk_map_gen(source_cbor_map, 0, &source_cbor))
    {
  ...
  }
  {
    ...
    cbor_nondet_t source_cbor_map_1_key = cbor_nondet_mk_string(CBOR_MAJOR_TYPE_TEXT_STRING, (uint8_t *)"b", 1);
    cbor_nondet_t source_cbor_map_1_value_array[2];
    cbor_nondet_t source_cbor_map_1_value_map_1 = cbor_nondet_mk_int64(CBOR_MAJOR_TYPE_UINT64,3);
    source_cbor_map_1_value_array[1] = source_cbor_map_1_value_map_1;
    cbor_nondet_t source_cbor_map_1_value_map_0 = cbor_nondet_mk_int64(CBOR_MAJOR_TYPE_UINT64,2);
    source_cbor_map_1_value_array[0] = source_cbor_map_1_value_map_0;
    cbor_nondet_t source_cbor_map_1_value = cbor_nondet_mk_array(source_cbor_map_1_value_array, 2);
    source_cbor_map[1] = (cbor_map_entry) {.cbor_map_entry_key = source_cbor_map_1_key, .cbor_map_entry_value = source_cbor_map_1_value};
    cbor_nondet_t source_cbor_map_0_key = cbor_nondet_mk_string(CBOR_MAJOR_TYPE_TEXT_STRING, (uint8_t *)"a", 1);
    cbor_nondet_t source_cbor_map_0_value = cbor_nondet_mk_int64(CBOR_MAJOR_TYPE_UINT64,1);
    source_cbor_map[0] = (cbor_map_entry) {.cbor_map_entry_key = source_cbor_map_0_key, .cbor_map_entry_value = source_cbor_map_0_value};
    cbor_nondet_t source_cbor;;
    if (! cbor_nondet_mk_map_gen(source_cbor_map, 2, &source_cbor))
    {
      printf("Map build failed for source_cbor\n");
      return 1;
    }
  ...
  }
  {
    ...
    cbor_nondet_t source_cbor_map_1_map_0_key = cbor_nondet_mk_string(CBOR_MAJOR_TYPE_TEXT_STRING, (uint8_t *)"b", 1);
    cbor_nondet_t source_cbor_map_1_map_0_value = cbor_nondet_mk_string(CBOR_MAJOR_TYPE_TEXT_STRING, (uint8_t *)"c", 1);
    ...
    cbor_nondet_t source_cbor_map_1;;
    if (! cbor_nondet_mk_map_gen(source_cbor_map_1_map, 1, &source_cbor_map_1))
    {
      printf("Map build failed for source_cbor_map_1\n");
      return 1;
    }
    source_cbor_array[1] = source_cbor_map_1;
    cbor_nondet_t source_cbor_map_0 = cbor_nondet_mk_string(CBOR_MAJOR_TYPE_TEXT_STRING, (uint8_t *)"a", 1);
    source_cbor_array[0] = source_cbor_map_0;
    cbor_nondet_t source_cbor = cbor_nondet_mk_array(source_cbor_array, 2);
    uint8_t target_bytes[8];
    size_t target_byte_size = cbor_nondet_serialize (source_cbor, target_bytes, 8);
    if (target_byte_size == 0)
    {
  ...
  }
  {
    ...
    cbor_nondet_t source_cbor_map_4_key = cbor_nondet_mk_string(CBOR_MAJOR_TYPE_TEXT_STRING, (uint8_t *)"e", 1);
    cbor_nondet_t source_cbor_map_4_value = cbor_nondet_mk_string(CBOR_MAJOR_TYPE_TEXT_STRING, (uint8_t *)"E", 1);
    source_cbor_map[4] = (cbor_map_entry) {.cbor_map_entry_key = source_cbor_map_4_key, .cbor_map_entry_value = source_cbor_map_4_value};
    cbor_nondet_t source_cbor_map_3_key = cbor_nondet_mk_string(CBOR_MAJOR_TYPE_TEXT_STRING, (uint8_t *)"d", 1);
    cbor_nondet_t source_cbor_map_3_value = cbor_nondet_mk_string(CBOR_MAJOR_TYPE_TEXT_STRING, (uint8_t *)"D", 1);
    source_cbor_map[3] = (cbor_map_entry) {.cbor_map_entry_key = source_cbor_map_3_key, .cbor_map_entry_value = source_cbor_map_3_value};
    cbor_nondet_t source_cbor_map_2_key = cbor_nondet_mk_string(CBOR_MAJOR_TYPE_TEXT_STRING, (uint8_t *)"c", 1);
    cbor_nondet_t source_cbor_map_2_value = cbor_nondet_mk_string(CBOR_MAJOR_TYPE_TEXT_STRING, (uint8_t *)"C", 1);
    source_cbor_map[2] = (cbor_map_entry) {.cbor_map_entry_key = source_cbor_map_2_key, .cbor_map_entry_value = source_cbor_map_2_value};
    cbor_nondet_t source_cbor_map_1_key = cbor_nondet_mk_string(CBOR_MAJOR_TYPE_TEXT_STRING, (uint8_t *)"b", 1);
    cbor_nondet_t source_cbor_map_1_value = cbor_nondet_mk_string(CBOR_MAJOR_TYPE_TEXT_STRING, (uint8_t *)"B", 1);
    source_cbor_map[1] = (cbor_map_entry) {.cbor_map_entry_key = source_cbor_map_1_key, .cbor_map_entry_value = source_cbor_map_1_value};
    cbor_nondet_t source_cbor_map_0_key = cbor_nondet_mk_string(CBOR_MAJOR_TYPE_TEXT_STRING, (uint8_t *)"a", 1);
    cbor_nondet_t source_cbor_map_0_value = cbor_nondet_mk_string(CBOR_MAJOR_TYPE_TEXT_STRING, (uint8_t *)"A", 1);
    source_cbor_map[0] = (cbor_map_entry) {.cbor_map_entry_key = source_cbor_map_0_key, .cbor_map_entry_value = source_cbor_map_0_value};
    cbor_nondet_t source_cbor;;
    if (! cbor_nondet_mk_map_gen(source_cbor_map, 5, &source_cbor))
    {
      printf("Map build failed for source_cbor\n");
      return 1;
    }
    ...
    if (target_byte_size2 == 0)
    {
      printf("Validation failed: expected 21 bytes, got 0\n");
      return 1;
    }
    printf("Validation succeeded!\n");
    target_cbor = cbor_nondet_parse_valid(source_bytes, target_byte_size2);
  ...
  }
  {
    ...
    cbor_nondet_t mycbor = cbor_nondet_mk_string(CBOR_MAJOR_TYPE_TEXT_STRING, mystr, 2);
    uint8_t output[11];
    size_t serialized_size = cbor_nondet_serialize(mycbor, output, 11);
    if (serialized_size == 0)
    {
      printf("Could not serialize: expected 11, got %ld\n", serialized_size);
      return 1;
    }
    printf("Serialization succeeded!\n");
    size_t test = cbor_nondet_validate(false, 0, false, output, 11);
    ...
    printf("Validation succeeded!\n");
    cbor_nondet_t outcbor = cbor_nondet_parse_valid(output, serialized_size);
  ...
  }
  {
    ...
    cbor_nondet_t mycbor = cbor_nondet_mk_string(CBOR_MAJOR_TYPE_TEXT_STRING, mystr, 4);
    uint8_t output[13];
    size_t serialized_size = cbor_nondet_serialize(mycbor, output, 13);
    if (serialized_size == 0)
    {
      printf("Could not serialize: expected 13, got %ld\n", serialized_size);
      return 1;
    }
    printf("Serialization succeeded!\n");
    size_t test = cbor_nondet_validate(false, 0, false, output, 13);
    if (test != 0)
    {
  ...
  }
  {
    ...
    cbor_nondet_t mycbor = cbor_nondet_mk_string(CBOR_MAJOR_TYPE_TEXT_STRING, mystr, 3);
    uint8_t output[12];
    size_t serialized_size = cbor_nondet_serialize(mycbor, output, 12);
    if (serialized_size == 0)
    {
      printf("Could not serialize: expected 12, got %ld\n", serialized_size);
      return 1;
    }
    printf("Serialization succeeded!\n");
    size_t test = cbor_nondet_validate(false, 0, false, output, 12);
    if (test != serialized_size)
    {
      printf("Validation failed, but it was expected to succeed\n");
      return 1;
  ...
  }
  {
    ...
    cbor_nondet_t mycbor = cbor_nondet_mk_string(CBOR_MAJOR_TYPE_TEXT_STRING, mystr, 1);
    uint8_t output[10];
    size_t serialized_size = cbor_nondet_serialize(mycbor, output, 10);
    if (serialized_size == 0)
    {
      printf("Could not serialize: expected 10, got %ld\n", serialized_size);
      return 1;
    }
    printf("Serialization succeeded!\n");
    size_t test = cbor_nondet_validate(false, 0, false, output, 10);
    if (test != serialized_size)
    {
      printf("Validation failed, but it was expected to succeed\n");
      return 1;
  ...
  }
  {
    ...
    cbor_nondet_t mycbor = cbor_nondet_mk_string(CBOR_MAJOR_TYPE_TEXT_STRING, mystr, 8);
    uint8_t output[17];
    size_t serialized_size = cbor_nondet_serialize(mycbor, output, 17);
    if (serialized_size == 0)
    {
      printf("Could not serialize: expected 17, got %ld\n", serialized_size);
      return 1;
    }
    printf("Serialization succeeded!\n");
    size_t test = cbor_nondet_validate(false, 0, false, output, 17);
    if (test != serialized_size)
    {
      printf("Validation failed, but it was expected to succeed\n");
      return 1;
  ...
  }
  {
    ...
    cbor_nondet_t mycbor = cbor_nondet_mk_string(CBOR_MAJOR_TYPE_TEXT_STRING, mystr, 14);
    uint8_t output[23];
    size_t serialized_size = cbor_nondet_serialize(mycbor, output, 23);
    if (serialized_size == 0)
    {
      printf("Could not serialize: expected 23, got %ld\n", serialized_size);
      return 1;
    }
    printf("Serialization succeeded!\n");
    size_t test = cbor_nondet_validate(false, 0, false, output, 23);
    if (test != 0)
    {
      printf("Validation succeeded, but it was expected to fail\n");
      return 1;
  ...
  }
  {
    ...
    cbor_nondet_t mycbor = cbor_nondet_mk_string(CBOR_MAJOR_TYPE_TEXT_STRING, mystr, 18);
    uint8_t output[27];
    size_t serialized_size = cbor_nondet_serialize(mycbor, output, 27);
    if (serialized_size == 0)
    {
      printf("Could not serialize: expected 27, got %ld\n", serialized_size);
      return 1;
    }
    printf("Serialization succeeded!\n");
    size_t test = cbor_nondet_validate(false, 0, false, output, 27);
    if (test != 0)
    {
      printf("Validation succeeded, but it was expected to fail\n");
      return 1;
  ...
  }
  {
    ...
    cbor_nondet_t mycbor = cbor_nondet_mk_string(CBOR_MAJOR_TYPE_TEXT_STRING, mystr, 6);
    uint8_t output[15];
    size_t serialized_size = cbor_nondet_serialize(mycbor, output, 15);
    if (serialized_size == 0)
    {
      printf("Could not serialize: expected 15, got %ld\n", serialized_size);
      return 1;
    }
    printf("Serialization succeeded!\n");
    size_t test = cbor_nondet_validate(false, 0, false, output, 15);
    if (test != 0)
    {
      printf("Validation succeeded, but it was expected to fail\n");
      return 1;
  ...
  }
  {
    ...
    cbor_nondet_t mycbor = cbor_nondet_mk_string(CBOR_MAJOR_TYPE_TEXT_STRING, mystr, 7);
    uint8_t output[16];
    size_t serialized_size = cbor_nondet_serialize(mycbor, output, 16);
    if (serialized_size == 0)
    {
      printf("Could not serialize: expected 16, got %ld\n", serialized_size);
      return 1;
    }
    printf("Serialization succeeded!\n");
    size_t test = cbor_nondet_validate(false, 0, false, output, 16);
    if (test != 0)
    {
      printf("Validation succeeded, but it was expected to fail\n");
      return 1;
  ...
  }
  {
    ...
    cbor_nondet_t mycbor = cbor_nondet_mk_string(CBOR_MAJOR_TYPE_TEXT_STRING, mystr, 5);
    uint8_t output[14];
    size_t serialized_size = cbor_nondet_serialize(mycbor, output, 14);
    if (serialized_size == 0)
    {
      printf("Could not serialize: expected 14, got %ld\n", serialized_size);
      return 1;
    }
    printf("Serialization succeeded!\n");
    size_t test = cbor_nondet_validate(false, 0, false, output, 14);
    if (test != 0)
    {
      printf("Validation succeeded, but it was expected to fail\n");
      return 1;
  ...
  }
  {
    ...
    cbor_nondet_t mycbor = cbor_nondet_mk_string(CBOR_MAJOR_TYPE_TEXT_STRING, mystr, 9);
    uint8_t output[18];
    size_t serialized_size = cbor_nondet_serialize(mycbor, output, 18);
    if (serialized_size == 0)
    {
      printf("Could not serialize: expected 18, got %ld\n", serialized_size);
      return 1;
    }
    printf("Serialization succeeded!\n");
    size_t test = cbor_nondet_validate(false, 0, false, output, 18);
    if (test != 0)
    {
      printf("Validation succeeded, but it was expected to fail\n");
      return 1;
