                              ...
                              =>
                                {
                                    ...
                                    cond
                                    {
                                        ...
                                        let offset·: usize =
                                            crate::cbornondetveraux::jump_raw_data_item(pl, offset);
    ...
    <'a>)
{
    let mut r: [crate::cbornondetveraux::iterator__CBOR_Pulse_Raw_EverParse_Type_cbor_raw; 1] =
        [x; 1usize];
    let i: crate::cbornondetveraux::iterator__CBOR_Pulse_Raw_EverParse_Type_cbor_raw = (&r)[0];
    let len_sz: usize =
        crate::cbornondetveraux::base_mixed_list_length__CBOR_Pulse_Raw_EverParse_Type_cbor_raw(
            i.before
        );
    let
    eos_res: crate::cbornondetveraux::elt_or_serialized__CBOR_Pulse_Raw_EverParse_Type_cbor_raw
    =
        if len_sz == 0usize
        { panic!("Pulse.Lib.Dv.unreachable") }
        else
        {
            let
            x1: crate::cbornondetveraux::elt_or_serialized__CBOR_Pulse_Raw_EverParse_Type_cbor_raw
            =
                match i.before
                {
                    crate::cbornondetveraux::base_mixed_list__CBOR_Pulse_Raw_EverParse_Type_cbor_raw::Empty
                    ...
                    =>
                      {
                          let x_val: crate::cbornondetveraux::cbor_raw = s[0];
                          crate::cbornondetveraux::elt_or_serialized__CBOR_Pulse_Raw_EverParse_Type_cbor_raw::EElement
                          { _0: x_val }
                      },
                    crate::cbornondetveraux::base_mixed_list__CBOR_Pulse_Raw_EverParse_Type_cbor_raw::Slice
                    { ss: s }
                    =>
                      {
                          let x_val: crate::cbornondetveraux::cbor_raw = s[0usize];
                          crate::cbornondetveraux::elt_or_serialized__CBOR_Pulse_Raw_EverParse_Type_cbor_raw::EElement
                          { _0: x_val }
                      },
                    crate::cbornondetveraux::base_mixed_list__CBOR_Pulse_Raw_EverParse_Type_cbor_raw::Serialized
                    ...
                    =>
                      {
                          ...
                          let consumed_sz: usize =
                              crate::cbornondetveraux::jump_raw_data_item(pl_suffix, 0usize);
                          let pl_hd_p: (&[u8], &[u8]) = pl_suffix.split_at(consumed_sz);
                          let pl_head: &[u8] = pl_hd_p.0;
                          let _pl_rest: &[u8] = pl_hd_p.1;
                          crate::cbornondetveraux::elt_or_serialized__CBOR_Pulse_Raw_EverParse_Type_cbor_raw::ESerialized
                          { _0: pl_head }
                      },
                    _ => panic!("Incomplete pattern matching")
                };
            ...
            {
                let total_sz: usize =
                    crate::cbornondetveraux::mixed_list_length__CBOR_Pulse_Raw_EverParse_Type_cbor_raw(
                        i.after
                    );
                let
                it_new: crate::cbornondetveraux::iterator__CBOR_Pulse_Raw_EverParse_Type_cbor_raw
                =
                    if total_sz == 0usize
                    {
                        crate::cbornondetveraux::iterator__CBOR_Pulse_Raw_EverParse_Type_cbor_raw
                                              ...
                                              =>
                                                {
                                                    ...
                                                    =
                                                        s.split_at(cur_off_v);
                                                    let
                                                    _s_prefix: &[crate::cbornondetveraux::cbor_raw]
                                                    =
                                                        s_pr.0;
                                                    let
                                                    s_rest: &[crate::cbornondetveraux::cbor_raw]
                                                    =
                                                        s_pr.1;
                                                    let
                                                    s_ms:
                                                    ...
                                                    =
                                                        s_rest.split_at(cur_n_v);
                                                    let
                                                    s_middle: &[crate::cbornondetveraux::cbor_raw]
                                                    =
                                                        s_ms.0;
                                                    let
                                                    _s_suffix: &[crate::cbornondetveraux::cbor_raw]
                                                    =
                                                        s_ms.1;
                                                    crate::cbornondetveraux::base_mixed_list__CBOR_Pulse_Raw_EverParse_Type_cbor_raw::Slice
                                                    { ss: s_middle }
                                              ...
                                              =>
                                                {
                                                    ...
                                                    cond
                                                    {
                                                        ...
                                                        let offset: usize = (&poffset)[0];
                                                        let offset·: usize =
                                                            crate::cbornondetveraux::jump_raw_data_item(
                                                                pl,
                                                                offset
                                                            );
                                                        (&mut pn)[0] = n0.wrapping_sub(1usize);
    ...
    let elt: crate::cbornondetveraux::cbor_raw =
        match eos_res
        {
            ...
            crate::cbornondetveraux::elt_or_serialized__CBOR_Pulse_Raw_EverParse_Type_cbor_raw::ESerialized
            { _0: pl }
            => crate::cbornondetveraux::cbor_raw_read(pl),
            _ => panic!("Incomplete pattern matching")
        };
    ...
    <'a>
{
    ...
    else
    {
        ...
        (&pcont)[0]
        {
            let i1: crate::cbornondetveraux::iterator__CBOR_Pulse_Raw_EverParse_Type_cbor_raw =
                (&pit)[0];
            let len_sz: usize =
                crate::cbornondetveraux::base_mixed_list_length__CBOR_Pulse_Raw_EverParse_Type_cbor_raw(
                    i1.before
            ...
            let
            eos_res:
            crate::cbornondetveraux::elt_or_serialized__CBOR_Pulse_Raw_EverParse_Type_cbor_raw
            =
                if len_sz == 0usize
                { panic!("Pulse.Lib.Dv.unreachable") }
                else
                              ...
                              =>
                                {
                                    ...
                                    cond
                                    {
                                        ...
                                        let off1: usize =
                                            crate::cbornondetveraux::jump_raw_data_item(pl, offset);
                                        let offset·: usize =
                                            crate::cbornondetveraux::jump_raw_data_item(pl, off1);
                                        (&mut pn)[0] = n0.wrapping_sub(1usize);
                                        (&mut poffset)[0] = offset·;
                                        let n1: usize = (&pn)[0];
                                        cond = n1 > 0usize
    ...
    <'a>)
{
    ...
    let
    eos_res:
    crate::cbornondetveraux::elt_or_serialized__CBOR_Pulse_Raw_EverParse_Type_cbor_map_entry__CBOR_Pulse_Raw_EverParse_Type_cbor_raw
    =
        if len_sz == 0usize
        { panic!("Pulse.Lib.Dv.unreachable") }
        else
                    ...
                    =>
                      {
                          ...
                          =
                              s[0];
                          crate::cbornondetveraux::elt_or_serialized__CBOR_Pulse_Raw_EverParse_Type_cbor_map_entry__CBOR_Pulse_Raw_EverParse_Type_cbor_raw::EElement
                          { _0: x_val }
                      },
                    crate::cbornondetveraux::base_mixed_list__CBOR_Pulse_Raw_EverParse_Type_cbor_map_entry__CBOR_Pulse_Raw_EverParse_Type_cbor_raw::Slice
                    { ss: s }
                    ...
                    =>
                      {
                          ...
                          let off1: usize =
                              crate::cbornondetveraux::jump_raw_data_item(pl_suffix, 0usize);
                          let consumed_sz: usize =
                              crate::cbornondetveraux::jump_raw_data_item(pl_suffix, off1);
                          let pl_hd_p: (&[u8], &[u8]) = pl_suffix.split_at(consumed_sz);
                          let pl_head: &[u8] = pl_hd_p.0;
                          let _pl_rest: &[u8] = pl_hd_p.1;
                          crate::cbornondetveraux::elt_or_serialized__CBOR_Pulse_Raw_EverParse_Type_cbor_map_entry__CBOR_Pulse_Raw_EverParse_Type_cbor_raw::ESerialized
                          { _0: pl_head }
                      },
                    _ => panic!("Incomplete pattern matching")
                };
    ...
    let elt: crate::cbornondetveraux::cbor_map_entry__CBOR_Pulse_Raw_EverParse_Type_cbor_raw =
        match eos_res
        {
            ...
            crate::cbornondetveraux::elt_or_serialized__CBOR_Pulse_Raw_EverParse_Type_cbor_map_entry__CBOR_Pulse_Raw_EverParse_Type_cbor_raw::ESerialized
            { _0: pl }
            => crate::cbornondetveraux::cbor_raw_read_map_entry(pl),
            _ => panic!("Incomplete pattern matching")
        };
    let
    x·:
