...
// Section 5.9.3
let session_message = Cddl.t_array3 (fun _ ->
...
let profile_descriptor = Cddl.t_map (fun _ ->
...
[@@_input_args] let get_profile_input_args = Cddl.t_map (fun _ ->
...
[@@_output_args] let get_profile_output_args = Cddl.t_map (fun _ ->
...
[@@_input_args] let open_session_input_args = Cddl.t_map (fun _ ->
...
[@@_output_args] let open_session_output_args = Cddl.t_map (fun _ ->
...
[@@_input_args] let close_session_input_args = Cddl.t_map (fun _ ->
  Cddl.map_group_cons_zero_or_more (Cddl.uint `Cddl.MapGroupEntry` Cddl.any) false (
  Cddl.map_group_empty
))

[@@_output_args] let close_session_output_args = Cddl.t_map (fun _ ->
  Cddl.map_group_cons_zero_or_more (Cddl.uint `Cddl.MapGroupEntry` Cddl.any) false (
  Cddl.map_group_empty
))
...
[@@_input_args] let sync_session_input_args = Cddl.t_map (fun _ ->
...
[@@_output_args] let sync_session_output_args = Cddl.t_map (fun _ ->
...
[@@_input_args] let export_session_input_args = Cddl.t_map (fun _ ->
...
[@@_output_args] let export_session_output_args = Cddl.t_map (fun _ ->
...
[@@_input_args] let import_session_input_args = Cddl.t_map (fun _ ->
...
[@@_output_args] let import_session_output_args = Cddl.t_map (fun _ ->
...
[@@_input_args] let initialize_context_input_args = Cddl.t_map (fun _ ->
...
[@@_output_args] let initialize_context_output_args = Cddl.t_map (fun _ ->
...
[@@_input_args] let derive_child_input_args = Cddl.t_map (fun _ ->
  ...
  Cddl.map_group_cons_zero_or_one (Cddl.t_uint_literal derive_child_internal_inputs `Cddl.MapGroupEntry` Cddl.t_array3_bounded (Cddl.array_group3_zero_or_more (Cddl.array_group3_item internal_input_type))) false (
  Cddl.map_group_cons_zero_or_more (Cddl.uint `Cddl.MapGroupEntry` Cddl.any) false Cddl.map_group_empty
)))))))))
...
[@@_output_args] let derive_child_output_args = Cddl.t_map (fun _ ->
...
[@@_input_args] let certify_key_input_args = Cddl.t_map (fun _ ->
  ...
  Cddl.map_group_cons_zero_or_one (Cddl.t_uint_literal certify_key_policies `Cddl.MapGroupEntry` Cddl.t_array3_bounded (Cddl.array_group3_zero_or_more (Cddl.array_group3_item policy_type))) false (
  Cddl.map_group_cons_zero_or_more (Cddl.uint `Cddl.MapGroupEntry` Cddl.any) false Cddl.map_group_empty
))))))
...
[@@_output_args] let certify_key_output_args = Cddl.t_map (fun _ ->
  Cddl.map_group_cons_zero_or_one (Cddl.t_uint_literal certify_key_certificate_chain `Cddl.MapGroupEntry` Cddl.t_array3_bounded (Cddl.array_group3_one_or_more (Cddl.array_group3_item Cddl.bytes))) false (
...
[@@_input_args] let sign_input_args = Cddl.t_map (fun _ ->
...
[@@_output_args] let sign_output_args = Cddl.t_map (fun _ ->
...
[@@_input_args] let seal_input_args = Cddl.t_map (fun _ ->
...
[@@_output_args] let seal_output_args = Cddl.t_map (fun _ ->
...
[@@_input_args] let unseal_input_args = Cddl.t_map (fun _ ->
...
[@@_output_args] let unseal_output_args = Cddl.t_map (fun _ ->
...
[@@_input_args] let derive_sealing_input_args = Cddl.t_map (fun _ ->
...
[@@_output_args] let derive_sealing_output_args = Cddl.t_map (fun _ ->
...
[@@_input_args] let rotate_context_handle_input_args = Cddl.t_map (fun _ ->
...
[@@_output_args] let rotate_context_handle_output_args = Cddl.t_map (fun _ ->
...
[@@_input_args] let destroy_context_input_args = Cddl.t_map (fun _ ->
  Cddl.map_group_cons_zero_or_one (Cddl.t_uint_literal destroy_context_context_handle `Cddl.MapGroupEntry` Cddl.bytes) false (
  Cddl.map_group_cons_zero_or_more (Cddl.uint `Cddl.MapGroupEntry` Cddl.any) false Cddl.map_group_empty
))

[@@_output_args] let destroy_context_output_args = Cddl.t_map (fun _ ->
  Cddl.map_group_cons_zero_or_more (Cddl.uint `Cddl.MapGroupEntry` Cddl.any) false Cddl.map_group_empty
)
