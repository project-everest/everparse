...
let rec list_sorted_map_entry_order_lt_tail
  ...
  (k: t1)
: Lemma
  (requires (List.Tot.sorted (Cbor.map_entry_order key_order _) (a :: l) /\ List.Tot.memP k (List.Tot.map fst l)))
...
let list_sorted_map_entry_order_not_memP_tail
  ...
  (l: list (t1 & t2))
: Lemma
  (requires (List.Tot.sorted (Cbor.map_entry_order key_order _) (a :: l)))
...
let rec list_sorted_map_entry_order_no_repeats
  ...
  (l: list (t1 & t2))
: Lemma
  (requires (List.Tot.sorted (Cbor.map_entry_order key_order _) l))
...
let list_sorted_map_entry_order_deterministically_encoded_cbor_map_key_order_no_repeats
  ...
  (l: list (Cbor.raw_data_item & t))
: Lemma
  (requires (List.Tot.sorted (Cbor.map_entry_order Cbor.deterministically_encoded_cbor_map_key_order _) l))
  (ensures (List.Tot.no_repeats_p (List.Tot.map fst l)))
= list_sorted_map_entry_order_no_repeats Cbor.deterministically_encoded_cbor_map_key_order l

let matches_map_group_map_group_cons_zero_or_one_deterministically_encoded_cbor_map_key_order
  #b k ty g x
= list_sorted_map_entry_order_deterministically_encoded_cbor_map_key_order_no_repeats x;
