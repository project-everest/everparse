...
let rec translate_probe_action (a:A.probe_action) : ML (T.probe_action & T.decls) =
  let translate_atomic (a:A.probe_atomic_action) : ML T.atomic_probe_action =
    ...
    | A.Probe_action_copy_and_return r w ty ->
      // TODO: Add support for Probe_action_copy_and_return in the interpreter
      failwith "Probe_action_copy_and_return not yet supported in interpreter"
  ...
  | A.Probe_action_let d i (A.Probe_action_copy_and_return reader writer _) k ->
