...
= produce_z3_and_test_gen batch out_dir (fun out_file nbwitnesses prog z3 ->
    Z3TestGen.do_test (Options.get_skip_checks_in_z3_test_executable ()) out_dir out_file z3 prog name nbwitnesses (Options.get_z3_branch_depth ()) (Options.get_z3_pos_test ()) (Options.get_z3_neg_test ())
  )
...
=
  ...
  produce_z3_and_test_gen batch out_dir (fun out_file nbwitnesses prog z3 ->
    Z3TestGen.do_diff_test (Options.get_skip_checks_in_z3_test_executable ()) out_dir out_file z3 prog name1 name2 nbwitnesses (Options.get_z3_branch_depth ())
  )
