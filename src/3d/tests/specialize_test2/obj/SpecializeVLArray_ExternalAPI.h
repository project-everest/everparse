...
#ifndef SpecializeVLArray_ExternalAPI_H
#define SpecializeVLArray_ExternalAPI_H
...
#define SpecializeVLArray_ExternalAPI_H_DEFINED
#endif /* SpecializeVLArray_ExternalAPI_H */
