...
)
{
  ...
  else
  {
    ...
    positionAfterZeroByte =
      EverParseCheckConstraintOk(zero_refinementConstraintIsOk,
        positionAfterzero_refinement);
  }
  ...
  else
  {
    ...
    else
    {
      ...
      else
      {
        ...
        uint64_t
        positionAfternone3 = EverParseCheckConstraintOk(noneConstraintIsOk1, positionAfternone2);
        ...
        else
        {
          ...
          else
          {
            ...
            uint64_t
            positionAfternone5 = EverParseCheckConstraintOk(noneConstraintIsOk2, positionAfternone4);
            ...
            else
            {
              ...
              else
              {
                ...
                uint64_t
                positionAfternone7 =
                  EverParseCheckConstraintOk(noneConstraintIsOk3,
                    positionAfternone6);
                  ...
                  else
                  {
                    ...
                    noneConstraintIsOk4 =
                      ...
                      &&
                        (ELF____ELFCLASSNONE
                        == none4
                        || ELF____ELFCLASS32 == none4 || ELF____ELFCLASS64 == none4);
                    uint64_t
                    positionAfternone9 =
                      EverParseCheckConstraintOk(noneConstraintIsOk4,
                        positionAfternone8);
                    ...
                    else
                    {
                      ...
                      else
                      {
                        ...
                        positionAfterEIdent0 =
                          EverParseCheckConstraintOk(fIVE_refinementConstraintIsOk,
                            positionAfterFIVE_refinement);
                      }
                      ...
                      else
                      {
                        /* Checking that we have enough space for a UINT8, i.e., 1 byte */
                        BOOLEAN
                        hasBytes0 = (uint64_t)1U <= (InputLength - positionAfterFIVE_refinement0);
                        ...
                        else
                        {
                          ...
                          BOOLEAN noneConstraintIsOk5 = none5 == (uint8_t)1U;
                          uint64_t
                          positionAfternone11 =
                            EverParseCheckConstraintOk(noneConstraintIsOk5,
                              positionAfternone10);
                          ...
                          else
                          {
                            ...
                            /* Checking that we have enough space for a UINT8, i.e., 1 byte */
                            BOOLEAN hasBytes0 = (uint64_t)1U <= (InputLength - positionAfternone11);
                            uint64_t positionAfterSEVEN_refinement;
                            if (hasBytes0)
                            {
                              positionAfterSEVEN_refinement = positionAfternone11 + (uint64_t)1U;
                            }
                            else
                            {
                            ...
                            {
                              /* reading field_value */
                              uint8_t sEVEN_refinement = Input[(uint32_t)positionAfternone11];
                              /* start: checking constraint */
                              BOOLEAN
                              ...
                              /* end: checking constraint */
                              positionAfterEIdent =
                                EverParseCheckConstraintOk(sEVEN_refinementConstraintIsOk,
                                  positionAfterSEVEN_refinement);
                            }
                            ...
                            else
                            {
                              ...
                              else
                              {
                                /* reading field_value */
                                uint8_t
                                eIGHT_refinement = Input[(uint32_t)positionAfterSEVEN_refinement0];
                                /* start: checking constraint */
                                BOOLEAN
                                eIGHT_refinementConstraintIsOk = eIGHT_refinement == (uint8_t)0U;
                                /* end: checking constraint */
                                positionAfterEIdent =
                                  EverParseCheckConstraintOk(eIGHT_refinementConstraintIsOk,
                                    positionAfterEIGHT_refinement);
                              }
        ...
        else
        {
          ...
          else
          {
            ...
            else
            {
              ...
              uint64_t
              positionAfternone3 =
                EverParseCheckConstraintOk(noneConstraintIsOk1,
                  positionAfternone2);
              if (EverParseIsError(positionAfternone3))
              {
  ...
  else
  {
    ...
    while (TRUE)
    {
      ...
      else
      {
        uint64_t
        positionAfterProgramHeaderTableOpt =
          ValidateProgramHeaderTableEntry(ElfFileSize,
            Ctxt,
            Err,
            truncatedInput,
            truncatedInputLength,
  ...
  else
  {
    ...
    else
    {
      ...
      else
      {
        uint8_t *truncatedInput = Input;
        uint64_t
        truncatedInputLength = positionAfternone1 + (uint64_t)(uint32_t)(ShOff - PhTableEnd);
        ...
        else
        {
          ...
          while (TRUE)
          {
            ...
            else
            {
              uint64_t
              positionAfterSectionHeaderTable =
                ValidateSectionHeaderTableEntry(ShNum,
                  ElfFileSize,
                  Ctxt,
                  Err,
                  truncatedInput,
  ...
  else
  {
    ...
    else
    {
      ...
      else
      {
        uint8_t *truncatedInput = Input;
        uint64_t
        truncatedInputLength = positionAfternone1 + (uint64_t)(uint32_t)(ElfFileSize - PhTableEnd);
        uint64_t result = positionAfternone1;
        while (TRUE)
        {
          uint64_t position = *&result;
...
)
{
  ...
  {
    /* ; When there is no Section Header table,; the following type ensures that there are at least ElfFileSize - PhTableEnd; bytes remaining in the file; */
    uint64_t
    positionAfterSectionHeaderTableOpt =
      ValidateNoSectionHeaderTable(PhTableEnd,
        ElfFileSize,
        Ctxt,
        Err,
        Input,
  ...
  uint64_t
  positionAfterSectionHeaderTableOpt =
    ValidateSectionHeaderTable(PhTableEnd,
      ShOff,
      ShNum,
      ElfFileSize,
      Ctxt,
...
)
{
  ...
  else
  {
    ...
    noneConstraintIsOk =
      ...
      &&
        ...
        ||
          ELF____ET_REL
          == none
          || ELF____ET_EXEC == none || ELF____ET_DYN == none || ELF____ET_CORE == none);
    uint64_t
    positionAfternone1 = EverParseCheckConstraintOk(noneConstraintIsOk, positionAfternone);
    if (EverParseIsError(positionAfternone1))
    {
    ...
    {
      /* ; We can restrict the values of E_MACHINE by making its type an enum, for example; The elf man page lists some possible values, but that list does not seem to be exhaustive; */
      /* Checking that we have enough space for a UINT16, i.e., 2 bytes */
                ...
                else
                {
                  ...
                  else
                  {
                    ...
                    else
                    {
                      ...
                      uint64_t
                      positionAfternone5 =
                        EverParseCheckConstraintOk(noneConstraintIsOk2,
                          positionAfternone4);
                      if (EverParseIsError(positionAfternone5))
                      {
                      ...
                      else
                      {
                        ...
                        else
                        {
                          ...
                          {
                            uint16_t r0 = Load16Le(Input + (uint32_t)positionAfterEPhentsize);
                            uint16_t none3 = (uint16_t)(uint32_t)r0;
                            BOOLEAN
                            noneConstraintIsOk3 =
                              (none3 == (uint16_t)(uint8_t)0U && ePhoff == (uint64_t)(uint8_t)0U)
                              ||
                                ((uint16_t)(uint8_t)0U
                                < none3
                                && none3 < ELF____PN_XNUM
                            ...
                            else
                            {
                              /* Checking that we have enough space for a UINT16, i.e., 2 bytes */
                              BOOLEAN
                              hasBytes0 = (uint64_t)2U <= (InputLength - positionAfternone7);
                              uint64_t positionAfterElf0;
                              if (hasBytes0)
                              {
                              ...
                              {
                                uint16_t r0 = Load16Le(Input + (uint32_t)positionAfternone7);
                                uint16_t eShentsize = (uint16_t)(uint32_t)r0;
                                /* Checking that we have enough space for a UINT16, i.e., 2 bytes */
                                BOOLEAN
                                hasBytes0 = (uint64_t)2U <= (InputLength - positionAfterEShentsize);
                                uint64_t positionAfternone8;
                                if (hasBytes0)
                                {
                                  positionAfternone8 = positionAfterEShentsize + (uint64_t)2U;
                                }
                                else
                                {
                                  positionAfternone8 =
                                ...
                                {
                                  uint16_t r0 = Load16Le(Input + (uint32_t)positionAfterEShentsize);
                                  ...
                                  else
                                  {
                                    /* Checking that we have enough space for a UINT16, i.e., 2 bytes */
                                    BOOLEAN
                                    hasBytes = (uint64_t)2U <= (InputLength - positionAfternone9);
                                    uint64_t positionAfternone10;
                                    if (hasBytes)
                                    {
                                      positionAfternone10 = positionAfternone9 + (uint64_t)2U;
                                    }
                                    else
                                    {
                                      positionAfternone10 =
                                    ...
                                    {
                                      uint16_t r = Load16Le(Input + (uint32_t)positionAfternone9);
                                      ...
                                      noneConstraintIsOk5 =
                                        ...
                                        || ((uint16_t)(uint8_t)0U < none4 && none5 < none4);
                                      uint64_t
                                      positionAfternone11 =
                                        EverParseCheckConstraintOk(noneConstraintIsOk5,
                                          positionAfternone10);
                                      ...
                                      else
                                      {
                                        ...
                                        uint64_t
                                        positionAfterElf0 =
                                          ValidateProgramHeaderTableOpt(none3,
                                            ElfFileSize,
                                            Ctxt,
                                            Err,
                                            Input,
                                        ...
                                        if (EverParseIsSuccess(positionAfterElf0))
                                        {
                                          positionAfterPhTable = positionAfterElf0;
                                        }
                                        else
                                        {
                                          Err("_ELF",
                                        ...
                                        if (EverParseIsError(positionAfterPhTable))
                                        {
                                          positionAfterElf = positionAfterPhTable;
                                        }
                                        else
                                        {
                                          /* (Optional) Section Header Table */
                                          uint64_t ite;
                                          if (none3 == (uint16_t)(uint8_t)0U)
                                          {
                                            ite = (uint64_t)none2;
                                          }
                                          else
                                          ...
                                          uint64_t
                                          positionAfterElf0 =
                                            ValidateSectionHeaderTableOpt(ite
