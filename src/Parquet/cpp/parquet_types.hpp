...
class GeographyType : public virtual ::apache::thrift::TBase {
 public:
  ...
  void __set_algorithm(const EdgeInterpolationAlgorithm val);
...
class SchemaElement : public virtual ::apache::thrift::TBase {
 public:
  ...
  void __set_repetition_type(const FieldRepetitionType val);

  void __set_name(const std::string& val);

  void __set_num_children(const int32_t val);

  void __set_converted_type(const ConvertedType val);
...
class DataPageHeader : public virtual ::apache::thrift::TBase {
 public:
  ...
  void __set_encoding(const Encoding val);

  void __set_definition_level_encoding(const Encoding val);

  void __set_repetition_level_encoding(const Encoding val);
...
class PageHeader : public virtual ::apache::thrift::TBase {
 public:
  ...
  void __set_type(const PageType val);
...
class PageEncodingStats : public virtual ::apache::thrift::TBase {
 public:
  ...
  void __set_page_type(const PageType val);
...
class ColumnMetaData : public virtual ::apache::thrift::TBase {
 public:
  ...
  void __set_encodings(const std::vector<Encoding> & val);

  void __set_path_in_schema(const std::vector<std::string> & val);

  void __set_codec(const CompressionCodec val);
...
class ColumnIndex : public virtual ::apache::thrift::TBase {
 public:
  ...
  void __set_boundary_order(const BoundaryOrder val);
