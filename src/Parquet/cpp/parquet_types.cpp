...
int _kTypeValues[] = {BOOLEAN, INT32,  INT64,      INT96,
                      FLOAT,   DOUBLE, BYTE_ARRAY, FIXED_LEN_BYTE_ARRAY};
const char* _kTypeNames[] = {"BOOLEAN", "INT32",  "INT64",      "INT96",
                             "FLOAT",   "DOUBLE", "BYTE_ARRAY", "FIXED_LEN_BYTE_ARRAY"};
...
const std::map<int, const char*> _ConvertedType_VALUES_TO_NAMES(
    ::apache::thrift::TEnumIterator(22, _kConvertedTypeValues, _kConvertedTypeNames),
    ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));

std::ostream& operator<<(std::ostream& out, const ConvertedType val) {
...
std::string to_string(const ConvertedType val) {
  std::map<int, const char*>::const_iterator it =
      _ConvertedType_VALUES_TO_NAMES.find(val);
  if (it != _ConvertedType_VALUES_TO_NAMES.end()) {
    return std::string(it->second);
...
const std::map<int, const char*> _FieldRepetitionType_VALUES_TO_NAMES(
    ::apache::thrift::TEnumIterator(3, _kFieldRepetitionTypeValues,
                                    _kFieldRepetitionTypeNames),
    ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));

std::ostream& operator<<(std::ostream& out, const FieldRepetitionType val) {
  std::map<int, const char*>::const_iterator it =
...
std::string to_string(const FieldRepetitionType val) {
  std::map<int, const char*>::const_iterator it =
      _FieldRepetitionType_VALUES_TO_NAMES.find(val);
  if (it != _FieldRepetitionType_VALUES_TO_NAMES.end()) {
    return std::string(it->second);
...
int _kEdgeInterpolationAlgorithmValues[] = {SPHERICAL, VINCENTY, THOMAS, ANDOYER, KARNEY};
const char* _kEdgeInterpolationAlgorithmNames[] = {"SPHERICAL", "VINCENTY", "THOMAS",
                                                   "ANDOYER", "KARNEY"};
const std::map<int, const char*> _EdgeInterpolationAlgorithm_VALUES_TO_NAMES(
    ::apache::thrift::TEnumIterator(5, _kEdgeInterpolationAlgorithmValues,
                                    _kEdgeInterpolationAlgorithmNames),
    ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));

std::ostream& operator<<(std::ostream& out, const EdgeInterpolationAlgorithm val) {
  std::map<int, const char*>::const_iterator it =
      _EdgeInterpolationAlgorithm_VALUES_TO_NAMES.find(val);
...
std::string to_string(const EdgeInterpolationAlgorithm val) {
  std::map<int, const char*>::const_iterator it =
      _EdgeInterpolationAlgorithm_VALUES_TO_NAMES.find(val);
  if (it != _EdgeInterpolationAlgorithm_VALUES_TO_NAMES.end()) {
    return std::string(it->second);
...
std::ostream& operator<<(std::ostream& out, const Encoding val) {
...
std::string to_string(const Encoding val) {
  std::map<int, const char*>::const_iterator it = _Encoding_VALUES_TO_NAMES.find(val);
  if (it != _Encoding_VALUES_TO_NAMES.end()) {
    return std::string(it->second);
  } else {
...
int _kCompressionCodecValues[] = {UNCOMPRESSED, SNAPPY, GZIP, LZO,
                                  BROTLI,       LZ4,    ZSTD, LZ4_RAW};
const char* _kCompressionCodecNames[] = {"UNCOMPRESSED", "SNAPPY", "GZIP", "LZO",
                                         "BROTLI",       "LZ4",    "ZSTD", "LZ4_RAW"};
const std::map<int, const char*> _CompressionCodec_VALUES_TO_NAMES(
    ::apache::thrift::TEnumIterator(8, _kCompressionCodecValues, _kCompressionCodecNames),
    ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));

std::ostream& operator<<(std::ostream& out, const CompressionCodec val) {
  std::map<int, const char*>::const_iterator it =
...
std::string to_string(const CompressionCodec val) {
  std::map<int, const char*>::const_iterator it =
      _CompressionCodec_VALUES_TO_NAMES.find(val);
  if (it != _CompressionCodec_VALUES_TO_NAMES.end()) {
    return std::string(it->second);
...
int _kPageTypeValues[] = {DATA_PAGE, INDEX_PAGE, DICTIONARY_PAGE, DATA_PAGE_V2};
const char* _kPageTypeNames[] = {"DATA_PAGE", "INDEX_PAGE", "DICTIONARY_PAGE",
                                 "DATA_PAGE_V2"};
const std::map<int, const char*> _PageType_VALUES_TO_NAMES(
    ::apache::thrift::TEnumIterator(4, _kPageTypeValues, _kPageTypeNames),
    ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));

std::ostream& operator<<(std::ostream& out, const PageType val) {
...
std::string to_string(const PageType val) {
  std::map<int, const char*>::const_iterator it = _PageType_VALUES_TO_NAMES.find(val);
  if (it != _PageType_VALUES_TO_NAMES.end()) {
    return std::string(it->second);
  } else {
...
int _kBoundaryOrderValues[] = {UNORDERED, ASCENDING, DESCENDING};
...
const std::map<int, const char*> _BoundaryOrder_VALUES_TO_NAMES(
    ::apache::thrift::TEnumIterator(3, _kBoundaryOrderValues, _kBoundaryOrderNames),
    ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));

std::ostream& operator<<(std::ostream& out, const BoundaryOrder val) {
  std::map<int, const char*>::const_iterator it =
...
std::string to_string(const BoundaryOrder val) {
  std::map<int, const char*>::const_iterator it =
      _BoundaryOrder_VALUES_TO_NAMES.find(val);
  if (it != _BoundaryOrder_VALUES_TO_NAMES.end()) {
    return std::string(it->second);
...
SizeStatistics::SizeStatistics() noexcept : unencoded_byte_array_data_bytes(0) {}
...
uint32_t SizeStatistics::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.unencoded_byte_array_data_bytes) {
    xfer += oprot->writeFieldBegin("unencoded_byte_array_data_bytes",
  ...
  if (this->__isset.repetition_level_histogram) {
    xfer += oprot->writeFieldBegin("repetition_level_histogram",
                                   ::apache::thrift::protocol::T_LIST, 2);
    {
      xfer += oprot->writeListBegin(
          ::apache::thrift::protocol::T_I64,
          static_cast<uint32_t>(this->repetition_level_histogram.size()));
      std::vector<int64_t>::const_iterator _iter10;
      for (_iter10 = this->repetition_level_histogram.begin();
           _iter10 != this->repetition_level_histogram.end(); ++_iter10) {
  ...
  if (this->__isset.definition_level_histogram) {
    xfer += oprot->writeFieldBegin("definition_level_histogram",
                                   ::apache::thrift::protocol::T_LIST, 3);
    {
      xfer += oprot->writeListBegin(
          ::apache::thrift::protocol::T_I64,
          static_cast<uint32_t>(this->definition_level_histogram.size()));
      std::vector<int64_t>::const_iterator _iter11;
      for (_iter11 = this->definition_level_histogram.begin();
           _iter11 != this->definition_level_histogram.end(); ++_iter11) {
...
bool SizeStatistics::operator==(const SizeStatistics& rhs) const {
  if (__isset.unencoded_byte_array_data_bytes !=
      rhs.__isset.unencoded_byte_array_data_bytes)
    return false;
  else if (__isset.unencoded_byte_array_data_bytes &&
           !(unencoded_byte_array_data_bytes == rhs.unencoded_byte_array_data_bytes))
    return false;
  if (__isset.repetition_level_histogram != rhs.__isset.repetition_level_histogram)
    return false;
  else if (__isset.repetition_level_histogram &&
           !(repetition_level_histogram == rhs.repetition_level_histogram))
    return false;
  if (__isset.definition_level_histogram != rhs.__isset.definition_level_histogram)
    return false;
  else if (__isset.definition_level_histogram &&
           !(definition_level_histogram == rhs.definition_level_histogram))
    return false;
  return true;
}
...
void SizeStatistics::printTo(std::ostream& out) const {
  ...
  out << "SizeStatistics(";
  out << "unencoded_byte_array_data_bytes=";
  (__isset.unencoded_byte_array_data_bytes
       ? (out << to_string(unencoded_byte_array_data_bytes))
       : (out << "<null>"));
  out << ", " << "repetition_level_histogram=";
  (__isset.repetition_level_histogram ? (out << to_string(repetition_level_histogram))
                                      : (out << "<null>"));
  out << ", " << "definition_level_histogram=";
...
BoundingBox::BoundingBox() noexcept
    : xmin(0), xmax(0), ymin(0), ymax(0), zmin(0), zmax(0), mmin(0), mmax(0) {}

void BoundingBox::__set_xmin(const double val) { this->xmin = val; }

void BoundingBox::__set_xmax(const double val) { this->xmax = val; }

void BoundingBox::__set_ymin(const double val) { this->ymin = val; }

void BoundingBox::__set_ymax(const double val) { this->ymax = val; }
...
uint32_t BoundingBox::read(::apache::thrift::protocol::TProtocol* iprot) {
  ...
  if (!isset_xmin) throw TProtocolException(TProtocolException::INVALID_DATA);
  if (!isset_xmax) throw TProtocolException(TProtocolException::INVALID_DATA);
  if (!isset_ymin) throw TProtocolException(TProtocolException::INVALID_DATA);
  if (!isset_ymax) throw TProtocolException(TProtocolException::INVALID_DATA);
  return xfer;
}
...
bool BoundingBox::operator==(const BoundingBox& rhs) const {
  if (!(xmin == rhs.xmin)) return false;
  if (!(xmax == rhs.xmax)) return false;
  if (!(ymin == rhs.ymin)) return false;
  if (!(ymax == rhs.ymax)) return false;
...
void BoundingBox::printTo(std::ostream& out) const {
  ...
  out << ", " << "zmin=";
  (__isset.zmin ? (out << to_string(zmin)) : (out << "<null>"));
  out << ", " << "zmax=";
  (__isset.zmax ? (out << to_string(zmax)) : (out << "<null>"));
  out << ", " << "mmin=";
  (__isset.mmin ? (out << to_string(mmin)) : (out << "<null>"));
  out << ", " << "mmax=";
  (__isset.mmax ? (out << to_string(mmax)) : (out << "<null>"));
  out << ")";
}
...
uint32_t GeospatialStatistics::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.geospatial_types) {
    xfer +=
        oprot->writeFieldBegin("geospatial_types", ::apache::thrift::protocol::T_LIST, 2);
    {
      xfer += oprot->writeListBegin(::apache::thrift::protocol::T_I32,
                                    static_cast<uint32_t>(this->geospatial_types.size()));
      std::vector<int32_t>::const_iterator _iter21;
      for (_iter21 = this->geospatial_types.begin();
           _iter21 != this->geospatial_types.end(); ++_iter21) {
...
GeospatialStatistics& GeospatialStatistics::operator=(
    const GeospatialStatistics& other23) {
  bbox = other23.bbox;
...
void GeospatialStatistics::printTo(std::ostream& out) const {
  ...
  out << "bbox=";
  (__isset.bbox ? (out << to_string(bbox)) : (out << "<null>"));
  out << ", " << "geospatial_types=";
  (__isset.geospatial_types ? (out << to_string(geospatial_types)) : (out << "<null>"));
  out << ")";
}
...
uint32_t Statistics::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.distinct_count) {
    xfer +=
        oprot->writeFieldBegin("distinct_count", ::apache::thrift::protocol::T_I64, 4);
...
void Statistics::printTo(std::ostream& out) const {
  ...
  out << ", " << "distinct_count=";
  (__isset.distinct_count ? (out << to_string(distinct_count)) : (out << "<null>"));
  out << ", " << "max_value=";
  ...
  (__isset.is_max_value_exact ? (out << to_string(is_max_value_exact))
                              : (out << "<null>"));
  out << ", " << "is_min_value_exact=";
  (__isset.is_min_value_exact ? (out << to_string(is_min_value_exact))
                              : (out << "<null>"));
  out << ")";
}
...
bool StringType::operator==(const StringType& /* rhs */) const { return true; }

StringType::StringType(const StringType& other26) noexcept { (void)other26; }
...
bool UUIDType::operator==(const UUIDType& /* rhs */) const { return true; }

UUIDType::UUIDType(const UUIDType& other28) noexcept { (void)other28; }
...
bool MapType::operator==(const MapType& /* rhs */) const { return true; }

MapType::MapType(const MapType& other30) noexcept { (void)other30; }
...
bool ListType::operator==(const ListType& /* rhs */) const { return true; }

ListType::ListType(const ListType& other32) noexcept { (void)other32; }
...
bool EnumType::operator==(const EnumType& /* rhs */) const { return true; }

EnumType::EnumType(const EnumType& other34) noexcept { (void)other34; }
...
bool DateType::operator==(const DateType& /* rhs */) const { return true; }

DateType::DateType(const DateType& other36) noexcept { (void)other36; }
...
bool Float16Type::operator==(const Float16Type& /* rhs */) const { return true; }

Float16Type::Float16Type(const Float16Type& other38) noexcept { (void)other38; }
...
bool NullType::operator==(const NullType& /* rhs */) const { return true; }

NullType::NullType(const NullType& other40) noexcept { (void)other40; }
...
DecimalType::DecimalType() noexcept : scale(0), precision(0) {}

void DecimalType::__set_scale(const int32_t val) { this->scale = val; }

void DecimalType::__set_precision(const int32_t val) { this->precision = val; }
...
uint32_t DecimalType::read(::apache::thrift::protocol::TProtocol* iprot) {
  ...
  if (!isset_scale) throw TProtocolException(TProtocolException::INVALID_DATA);
  if (!isset_precision) throw TProtocolException(TProtocolException::INVALID_DATA);
  return xfer;
}
...
bool MilliSeconds::operator==(const MilliSeconds& /* rhs */) const { return true; }

MilliSeconds::MilliSeconds(const MilliSeconds& other44) noexcept { (void)other44; }
...
bool MicroSeconds::operator==(const MicroSeconds& /* rhs */) const { return true; }

MicroSeconds::MicroSeconds(const MicroSeconds& other46) noexcept { (void)other46; }
...
bool NanoSeconds::operator==(const NanoSeconds& /* rhs */) const { return true; }

NanoSeconds::NanoSeconds(const NanoSeconds& other48) noexcept { (void)other48; }
...
TimestampType::TimestampType() noexcept : isAdjustedToUTC(0) {}

void TimestampType::__set_isAdjustedToUTC(const bool val) { this->isAdjustedToUTC = val; }

void TimestampType::__set_unit(const TimeUnit& val) { this->unit = val; }
...
uint32_t TimestampType::read(::apache::thrift::protocol::TProtocol* iprot) {
  ...
  if (!isset_isAdjustedToUTC) throw TProtocolException(TProtocolException::INVALID_DATA);
  if (!isset_unit) throw TProtocolException(TProtocolException::INVALID_DATA);
  return xfer;
}
...
uint32_t TimestampType::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer +=
      oprot->writeFieldBegin("isAdjustedToUTC", ::apache::thrift::protocol::T_BOOL, 1);
...
TimeType::TimeType() noexcept : isAdjustedToUTC(0) {}

void TimeType::__set_isAdjustedToUTC(const bool val) { this->isAdjustedToUTC = val; }

void TimeType::__set_unit(const TimeUnit& val) { this->unit = val; }
...
IntType::IntType() noexcept : bitWidth(0), isSigned(0) {}

void IntType::__set_bitWidth(const int8_t val) { this->bitWidth = val; }

void IntType::__set_isSigned(const bool val) { this->isSigned = val; }
...
uint32_t IntType::read(::apache::thrift::protocol::TProtocol* iprot) {
  ...
  if (!isset_bitWidth) throw TProtocolException(TProtocolException::INVALID_DATA);
  if (!isset_isSigned) throw TProtocolException(TProtocolException::INVALID_DATA);
  return xfer;
}
...
bool JsonType::operator==(const JsonType& /* rhs */) const { return true; }

JsonType::JsonType(const JsonType& other58) noexcept { (void)other58; }
...
bool BsonType::operator==(const BsonType& /* rhs */) const { return true; }

BsonType::BsonType(const BsonType& other60) noexcept { (void)other60; }
...
VariantType::VariantType() noexcept : specification_version(0) {}
...
uint32_t VariantType::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.specification_version) {
    xfer += oprot->writeFieldBegin("specification_version",
                                   ::apache::thrift::protocol::T_BYTE, 1);
...
bool VariantType::operator==(const VariantType& rhs) const {
  if (__isset.specification_version != rhs.__isset.specification_version)
    return false;
  else if (__isset.specification_version &&
           !(specification_version == rhs.specification_version))
    return false;
  return true;
}
...
void VariantType::printTo(std::ostream& out) const {
  using ::apache::thrift::to_string;
  out << "VariantType(";
  out << "specification_version=";
  (__isset.specification_version ? (out << to_string(specification_version))
                                 : (out << "<null>"));
  out << ")";
}
...
GeometryType::GeometryType() noexcept : crs() {}
...
void GeometryType::printTo(std::ostream& out) const {
  ...
  out << "GeometryType(";
  out << "crs=";
  (__isset.crs ? (out << to_string(crs)) : (out << "<null>"));
  out << ")";
}
...
GeographyType::GeographyType() noexcept
    : crs(), algorithm(static_cast<EdgeInterpolationAlgorithm>(0)) {}
...
void GeographyType::__set_algorithm(const EdgeInterpolationAlgorithm val) {
  this->algorithm = val;
    ...
    switch (fid) {
      ...
      case 2:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->algorithm = static_cast<EdgeInterpolationAlgorithm>(ecast66);
...
void GeographyType::printTo(std::ostream& out) const {
  ...
  (__isset.crs ? (out << to_string(crs)) : (out << "<null>"));
  out << ", " << "algorithm=";
  (__isset.algorithm ? (out << to_string(algorithm)) : (out << "<null>"));
  out << ")";
}
...
void LogicalType::printTo(std::ostream& out) const {
  ...
  out << ", " << "FLOAT16=";
  (__isset.FLOAT16 ? (out << to_string(FLOAT16)) : (out << "<null>"));
  out << ", " << "VARIANT=";
  (__isset.VARIANT ? (out << to_string(VARIANT)) : (out << "<null>"));
  out << ", " << "GEOMETRY=";
  (__isset.GEOMETRY ? (out << to_string(GEOMETRY)) : (out << "<null>"));
  out << ", " << "GEOGRAPHY=";
  (__isset.GEOGRAPHY ? (out << to_string(GEOGRAPHY)) : (out << "<null>"));
  out << ")";
}
...
SchemaElement::SchemaElement() noexcept
    : type(static_cast<Type>(0)),
      type_length(0),
      repetition_type(static_cast<FieldRepetitionType>(0)),
      name(),
      num_children(0),
      converted_type(static_cast<ConvertedType>(0)),
      scale(0),
      precision(0),
      field_id(0) {}

void SchemaElement::__set_type(const Type val) {
  this->type = val;
  __isset.type = true;
}
...
void SchemaElement::__set_repetition_type(const FieldRepetitionType val) {
  this->repetition_type = val;
  __isset.repetition_type = true;
}

void SchemaElement::__set_name(const std::string& val) { this->name = val; }
...
void SchemaElement::__set_converted_type(const ConvertedType val) {
...
uint32_t SchemaElement::read(::apache::thrift::protocol::TProtocol* iprot) {
    ...
    switch (fid) {
      case 1:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->type = static_cast<Type>(ecast71);
      ...
      case 3:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->repetition_type = static_cast<FieldRepetitionType>(ecast72);
      ...
      case 6:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->converted_type = static_cast<ConvertedType>(ecast73);
  ...
  if (!isset_name) throw TProtocolException(TProtocolException::INVALID_DATA);
  return xfer;
}
...
uint32_t SchemaElement::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.repetition_type) {
    xfer +=
        oprot->writeFieldBegin("repetition_type", ::apache::thrift::protocol::T_I32, 3);
  ...
  if (this->__isset.converted_type) {
    xfer +=
        oprot->writeFieldBegin("converted_type", ::apache::thrift::protocol::T_I32, 6);
  ...
  if (this->__isset.logicalType) {
    xfer +=
        oprot->writeFieldBegin("logicalType", ::apache::thrift::protocol::T_STRUCT, 10);
...
void SchemaElement::printTo(std::ostream& out) const {
  ...
  out << ", " << "repetition_type=";
  (__isset.repetition_type ? (out << to_string(repetition_type)) : (out << "<null>"));
  out << ", " << "name=" << to_string(name);
  out << ", " << "num_children=";
  (__isset.num_children ? (out << to_string(num_children)) : (out << "<null>"));
  out << ", " << "converted_type=";
  (__isset.converted_type ? (out << to_string(converted_type)) : (out << "<null>"));
  out << ", " << "scale=";
...
DataPageHeader::DataPageHeader() noexcept
    : num_values(0),
      encoding(static_cast<Encoding>(0)),
      definition_level_encoding(static_cast<Encoding>(0)),
      repetition_level_encoding(static_cast<Encoding>(0)) {}

void DataPageHeader::__set_num_values(const int32_t val) { this->num_values = val; }

void DataPageHeader::__set_encoding(const Encoding val) { this->encoding = val; }

void DataPageHeader::__set_definition_level_encoding(const Encoding val) {
  this->definition_level_encoding = val;
}

void DataPageHeader::__set_repetition_level_encoding(const Encoding val) {
...
uint32_t DataPageHeader::read(::apache::thrift::protocol::TProtocol* iprot) {
    ...
    switch (fid) {
      ...
      case 2:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->encoding = static_cast<Encoding>(ecast76);
          isset_encoding = true;
        } else {
          xfer += iprot->skip(ftype);
        }
      ...
      case 3:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->definition_level_encoding = static_cast<Encoding>(ecast77);
      ...
      case 4:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->repetition_level_encoding = static_cast<Encoding>(ecast78);
  ...
  if (!isset_num_values) throw TProtocolException(TProtocolException::INVALID_DATA);
  if (!isset_encoding) throw TProtocolException(TProtocolException::INVALID_DATA);
...
bool IndexPageHeader::operator==(const IndexPageHeader& /* rhs */) const { return true; }
...
DictionaryPageHeader::DictionaryPageHeader() noexcept
    : num_values(0), encoding(static_cast<Encoding>(0)), is_sorted(0) {}

void DictionaryPageHeader::__set_num_values(const int32_t val) { this->num_values = val; }

void DictionaryPageHeader::__set_encoding(const Encoding val) { this->encoding = val; }
    ...
    switch (fid) {
      ...
      case 2:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->encoding = static_cast<Encoding>(ecast83);
          isset_encoding = true;
        } else {
          xfer += iprot->skip(ftype);
        }
...
DictionaryPageHeader& DictionaryPageHeader::operator=(
    const DictionaryPageHeader& other85) noexcept {
...
void DataPageHeaderV2::__set_num_values(const int32_t val) { this->num_values = val; }

void DataPageHeaderV2::__set_num_nulls(const int32_t val) { this->num_nulls = val; }

void DataPageHeaderV2::__set_num_rows(const int32_t val) { this->num_rows = val; }

void DataPageHeaderV2::__set_encoding(const Encoding val) { this->encoding = val; }
...
uint32_t DataPageHeaderV2::read(::apache::thrift::protocol::TProtocol* iprot) {
    ...
    switch (fid) {
      ...
      case 4:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->encoding = static_cast<Encoding>(ecast86);
          isset_encoding = true;
        } else {
          xfer += iprot->skip(ftype);
        }
  ...
  if (!isset_num_values) throw TProtocolException(TProtocolException::INVALID_DATA);
  if (!isset_num_nulls) throw TProtocolException(TProtocolException::INVALID_DATA);
  if (!isset_num_rows) throw TProtocolException(TProtocolException::INVALID_DATA);
  if (!isset_encoding) throw TProtocolException(TProtocolException::INVALID_DATA);
...
uint32_t DataPageHeaderV2::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.is_compressed) {
    xfer +=
        oprot->writeFieldBegin("is_compressed", ::apache::thrift::protocol::T_BOOL, 7);
...
void DataPageHeaderV2::printTo(std::ostream& out) const {
  ...
  out << ", " << "encoding=" << to_string(encoding);
  out << ", "
      << "definition_levels_byte_length=" << to_string(definition_levels_byte_length);
  out << ", "
      << "repetition_levels_byte_length=" << to_string(repetition_levels_byte_length);
  out << ", " << "is_compressed=";
  (__isset.is_compressed ? (out << to_string(is_compressed)) : (out << "<null>"));
  out << ", " << "statistics=";
  (__isset.statistics ? (out << to_string(statistics)) : (out << "<null>"));
  out << ")";
}
...
SplitBlockAlgorithm& SplitBlockAlgorithm::operator=(
    const SplitBlockAlgorithm& other90) noexcept {
  (void)other90;
  return *this;
}
...
BloomFilterAlgorithm& BloomFilterAlgorithm::operator=(
    const BloomFilterAlgorithm& other92) noexcept {
  BLOCK = other92.BLOCK;
...
bool XxHash::operator==(const XxHash& /* rhs */) const { return true; }

XxHash::XxHash(const XxHash& other93) noexcept { (void)other93; }
...
bool Uncompressed::operator==(const Uncompressed& /* rhs */) const { return true; }

Uncompressed::Uncompressed(const Uncompressed& other97) noexcept { (void)other97; }
...
uint32_t BloomFilterCompression::write(
  ...
  if (this->__isset.UNCOMPRESSED) {
    xfer +=
        oprot->writeFieldBegin("UNCOMPRESSED", ::apache::thrift::protocol::T_STRUCT, 1);
...
BloomFilterCompression::BloomFilterCompression(
    const BloomFilterCompression& other99) noexcept {
  UNCOMPRESSED = other99.UNCOMPRESSED;
  __isset = other99.__isset;
}
BloomFilterCompression& BloomFilterCompression::operator=(
    const BloomFilterCompression& other100) noexcept {
...
BloomFilterHeader::BloomFilterHeader() noexcept : numBytes(0) {}

void BloomFilterHeader::__set_numBytes(const int32_t val) { this->numBytes = val; }

void BloomFilterHeader::__set_algorithm(const BloomFilterAlgorithm& val) {
  this->algorithm = val;
}

void BloomFilterHeader::__set_hash(const BloomFilterHash& val) { this->hash = val; }
...
uint32_t BloomFilterHeader::read(::apache::thrift::protocol::TProtocol* iprot) {
  ...
  if (!isset_numBytes) throw TProtocolException(TProtocolException::INVALID_DATA);
  if (!isset_algorithm) throw TProtocolException(TProtocolException::INVALID_DATA);
  if (!isset_hash) throw TProtocolException(TProtocolException::INVALID_DATA);
  if (!isset_compression) throw TProtocolException(TProtocolException::INVALID_DATA);
  return xfer;
}
...
BloomFilterHeader& BloomFilterHeader::operator=(
    const BloomFilterHeader& other102) noexcept {
...
PageHeader::PageHeader() noexcept
    : type(static_cast<PageType>(0)),
      uncompressed_page_size(0),
      compressed_page_size(0),
      crc(0) {}

void PageHeader::__set_type(const PageType val) { this->type = val; }
    ...
    switch (fid) {
      case 1:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->type = static_cast<PageType>(ecast103);
          isset_type = true;
        } else {
          xfer += iprot->skip(ftype);
        }
...
void PageHeader::printTo(std::ostream& out) const {
  ...
  (__isset.data_page_header ? (out << to_string(data_page_header)) : (out << "<null>"));
  out << ", " << "index_page_header=";
  (__isset.index_page_header ? (out << to_string(index_page_header)) : (out << "<null>"));
...
KeyValue::KeyValue() noexcept : key(), value() {}

void KeyValue::__set_key(const std::string& val) { this->key = val; }
...
uint32_t KeyValue::read(::apache::thrift::protocol::TProtocol* iprot) {
  ...
  if (!isset_key) throw TProtocolException(TProtocolException::INVALID_DATA);
  return xfer;
}
...
SortingColumn::SortingColumn() noexcept : column_idx(0), descending(0), nulls_first(0) {}

void SortingColumn::__set_column_idx(const int32_t val) { this->column_idx = val; }

void SortingColumn::__set_descending(const bool val) { this->descending = val; }

void SortingColumn::__set_nulls_first(const bool val) { this->nulls_first = val; }
...
uint32_t SortingColumn::read(::apache::thrift::protocol::TProtocol* iprot) {
  ...
  if (!isset_column_idx) throw TProtocolException(TProtocolException::INVALID_DATA);
  if (!isset_descending) throw TProtocolException(TProtocolException::INVALID_DATA);
  if (!isset_nulls_first) throw TProtocolException(TProtocolException::INVALID_DATA);
  return xfer;
}
...
PageEncodingStats::PageEncodingStats() noexcept
    : page_type(static_cast<PageType>(0)), encoding(static_cast<Encoding>(0)), count(0) {}

void PageEncodingStats::__set_page_type(const PageType val) { this->page_type = val; }

void PageEncodingStats::__set_encoding(const Encoding val) { this->encoding = val; }

void PageEncodingStats::__set_count(const int32_t val) { this->count = val; }
...
uint32_t PageEncodingStats::read(::apache::thrift::protocol::TProtocol* iprot) {
    ...
    switch (fid) {
      case 1:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->page_type = static_cast<PageType>(ecast110);
      ...
      case 2:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->encoding = static_cast<Encoding>(ecast111);
          isset_encoding = true;
        } else {
          xfer += iprot->skip(ftype);
        }
  ...
  if (!isset_page_type) throw TProtocolException(TProtocolException::INVALID_DATA);
  if (!isset_encoding) throw TProtocolException(TProtocolException::INVALID_DATA);
  if (!isset_count) throw TProtocolException(TProtocolException::INVALID_DATA);
  return xfer;
}
...
PageEncodingStats& PageEncodingStats::operator=(
    const PageEncodingStats& other113) noexcept {
...
ColumnMetaData::ColumnMetaData() noexcept
    : type(static_cast<Type>(0)),
      codec(static_cast<CompressionCodec>(0)),
      num_values(0),
...
void ColumnMetaData::__set_type(const Type val) { this->type = val; }

void ColumnMetaData::__set_encodings(const std::vector<Encoding>& val) {
  this->encodings = val;
}
...
void ColumnMetaData::__set_codec(const CompressionCodec val) { this->codec = val; }

void ColumnMetaData::__set_num_values(const int64_t val) { this->num_values = val; }
...
uint32_t ColumnMetaData::read(::apache::thrift::protocol::TProtocol* iprot) {
    ...
    switch (fid) {
      case 1:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->type = static_cast<Type>(ecast114);
          isset_type = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            for (_i119 = 0; _i119 < _size115; ++_i119) {
              ...
              this->encodings[_i119] = static_cast<Encoding>(ecast120);
            }
            xfer += iprot->readListEnd();
          }
      ...
      case 4:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->codec = static_cast<CompressionCodec>(ecast126);
          isset_codec = true;
        } else {
          xfer += iprot->skip(ftype);
        }
  ...
  if (!isset_type) throw TProtocolException(TProtocolException::INVALID_DATA);
  if (!isset_encodings) throw TProtocolException(TProtocolException::INVALID_DATA);
  if (!isset_path_in_schema) throw TProtocolException(TProtocolException::INVALID_DATA);
  if (!isset_codec) throw TProtocolException(TProtocolException::INVALID_DATA);
  if (!isset_num_values) throw TProtocolException(TProtocolException::INVALID_DATA);
  if (!isset_total_uncompressed_size)
    throw TProtocolException(TProtocolException::INVALID_DATA);
  if (!isset_total_compressed_size)
    throw TProtocolException(TProtocolException::INVALID_DATA);
  if (!isset_data_page_offset) throw TProtocolException(TProtocolException::INVALID_DATA);
  return xfer;
}
...
uint32_t ColumnMetaData::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("encodings", ::apache::thrift::protocol::T_LIST, 2);
  {
    ...
    std::vector<Encoding>::const_iterator _iter137;
    for (_iter137 = this->encodings.begin(); _iter137 != this->encodings.end();
         ++_iter137) {
  ...
  xfer += oprot->writeFieldBegin("path_in_schema", ::apache::thrift::protocol::T_LIST, 3);
  {
    ...
    for (_iter138 = this->path_in_schema.begin(); _iter138 != this->path_in_schema.end();
         ++_iter138) {
  ...
  if (this->__isset.key_value_metadata) {
                                   ...
                                   ::apache::thrift::protocol::T_LIST, 8);
    {
      ...
      for (_iter139 = this->key_value_metadata.begin();
           _iter139 != this->key_value_metadata.end(); ++_iter139) {
  ...
  xfer +=
      oprot->writeFieldBegin("data_page_offset", ::apache::thrift::protocol::T_I64, 9);
  xfer += oprot->writeI64(this->data_page_offset);
  xfer += oprot->writeFieldEnd();

  if (this->__isset.index_page_offset) {
    xfer += oprot->writeFieldBegin("index_page_offset", ::apache::thrift::protocol::T_I64,
                                   10);
  ...
  if (this->__isset.statistics) {
    xfer +=
        oprot->writeFieldBegin("statistics", ::apache::thrift::protocol::T_STRUCT, 12);
    xfer += this->statistics.write(oprot);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.encoding_stats) {
    xfer +=
        oprot->writeFieldBegin("encoding_stats", ::apache::thrift::protocol::T_LIST, 13);
    {
      xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT,
                                    static_cast<uint32_t>(this->encoding_stats.size()));
      std::vector<PageEncodingStats>::const_iterator _iter140;
      for (_iter140 = this->encoding_stats.begin();
           _iter140 != this->encoding_stats.end(); ++_iter140) {
...
bool ColumnMetaData::operator==(const ColumnMetaData& rhs) const {
  ...
  if (__isset.bloom_filter_offset != rhs.__isset.bloom_filter_offset)
    return false;
  else if (__isset.bloom_filter_offset &&
           !(bloom_filter_offset == rhs.bloom_filter_offset))
    return false;
  if (__isset.bloom_filter_length != rhs.__isset.bloom_filter_length)
    return false;
  else if (__isset.bloom_filter_length &&
           !(bloom_filter_length == rhs.bloom_filter_length))
    return false;
  ...
  if (__isset.geospatial_statistics != rhs.__isset.geospatial_statistics)
    return false;
  else if (__isset.geospatial_statistics &&
           !(geospatial_statistics == rhs.geospatial_statistics))
    return false;
  return true;
}
...
void ColumnMetaData::printTo(std::ostream& out) const {
  ...
  (__isset.index_page_offset ? (out << to_string(index_page_offset)) : (out << "<null>"));
  ...
  (__isset.statistics ? (out << to_string(statistics)) : (out << "<null>"));
  out << ", " << "encoding_stats=";
  (__isset.encoding_stats ? (out << to_string(encoding_stats)) : (out << "<null>"));
  out << ", " << "bloom_filter_offset=";
  (__isset.bloom_filter_offset ? (out << to_string(bloom_filter_offset))
                               : (out << "<null>"));
  out << ", " << "bloom_filter_length=";
  (__isset.bloom_filter_length ? (out << to_string(bloom_filter_length))
                               : (out << "<null>"));
  out << ", " << "size_statistics=";
  (__isset.size_statistics ? (out << to_string(size_statistics)) : (out << "<null>"));
  out << ", " << "geospatial_statistics=";
  (__isset.geospatial_statistics ? (out << to_string(geospatial_statistics))
                                 : (out << "<null>"));
  out << ")";
}
...
EncryptionWithFooterKey::EncryptionWithFooterKey(
    const EncryptionWithFooterKey& other143) noexcept {
  (void)other143;
}
EncryptionWithFooterKey& EncryptionWithFooterKey::operator=(
    const EncryptionWithFooterKey& other144) noexcept {
  (void)other144;
  return *this;
}
...
EncryptionWithColumnKey::EncryptionWithColumnKey() noexcept : key_metadata() {}
...
uint32_t EncryptionWithColumnKey::write(
  ...
  xfer += oprot->writeFieldBegin("path_in_schema", ::apache::thrift::protocol::T_LIST, 1);
  {
    ...
    for (_iter150 = this->path_in_schema.begin(); _iter150 != this->path_in_schema.end();
         ++_iter150) {
  ...
  if (this->__isset.key_metadata) {
    xfer +=
        oprot->writeFieldBegin("key_metadata", ::apache::thrift::protocol::T_STRING, 2);
...
EncryptionWithColumnKey::EncryptionWithColumnKey(
    const EncryptionWithColumnKey& other151) {
...
EncryptionWithColumnKey& EncryptionWithColumnKey::operator=(
    const EncryptionWithColumnKey& other152) {
...
uint32_t ColumnCryptoMetaData::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.ENCRYPTION_WITH_FOOTER_KEY) {
    xfer += oprot->writeFieldBegin("ENCRYPTION_WITH_FOOTER_KEY",
  ...
  if (this->__isset.ENCRYPTION_WITH_COLUMN_KEY) {
    xfer += oprot->writeFieldBegin("ENCRYPTION_WITH_COLUMN_KEY",
...
ColumnCryptoMetaData& ColumnCryptoMetaData::operator=(
    const ColumnCryptoMetaData& other154) {
...
void ColumnCryptoMetaData::printTo(std::ostream& out) const {
  ...
  (__isset.ENCRYPTION_WITH_FOOTER_KEY ? (out << to_string(ENCRYPTION_WITH_FOOTER_KEY))
                                      : (out << "<null>"));
  out << ", " << "ENCRYPTION_WITH_COLUMN_KEY=";
  (__isset.ENCRYPTION_WITH_COLUMN_KEY ? (out << to_string(ENCRYPTION_WITH_COLUMN_KEY))
                                      : (out << "<null>"));
  out << ")";
}
...
void ColumnChunk::__set_file_offset(const int64_t val) { this->file_offset = val; }
...
uint32_t ColumnChunk::read(::apache::thrift::protocol::TProtocol* iprot) {
  ...
  if (!isset_file_offset) throw TProtocolException(TProtocolException::INVALID_DATA);
  return xfer;
}
...
void ColumnChunk::printTo(std::ostream& out) const {
  ...
  (__isset.column_index_length ? (out << to_string(column_index_length))
                               : (out << "<null>"));
  out << ", " << "crypto_metadata=";
  (__isset.crypto_metadata ? (out << to_string(crypto_metadata)) : (out << "<null>"));
  out << ", " << "encrypted_column_metadata=";
  (__isset.encrypted_column_metadata ? (out << to_string(encrypted_column_metadata))
                                     : (out << "<null>"));
  out << ")";
}
...
void RowGroup::__set_columns(const std::vector<ColumnChunk>& val) { this->columns = val; }

void RowGroup::__set_total_byte_size(const int64_t val) { this->total_byte_size = val; }

void RowGroup::__set_num_rows(const int64_t val) { this->num_rows = val; }
...
uint32_t RowGroup::read(::apache::thrift::protocol::TProtocol* iprot) {
  ...
  if (!isset_columns) throw TProtocolException(TProtocolException::INVALID_DATA);
  if (!isset_total_byte_size) throw TProtocolException(TProtocolException::INVALID_DATA);
  if (!isset_num_rows) throw TProtocolException(TProtocolException::INVALID_DATA);
  return xfer;
}
...
uint32_t RowGroup::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.sorting_columns) {
    xfer +=
        oprot->writeFieldBegin("sorting_columns", ::apache::thrift::protocol::T_LIST, 4);
    {
      xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT,
                                    static_cast<uint32_t>(this->sorting_columns.size()));
      std::vector<SortingColumn>::const_iterator _iter168;
      for (_iter168 = this->sorting_columns.begin();
           _iter168 != this->sorting_columns.end(); ++_iter168) {
...
bool RowGroup::operator==(const RowGroup& rhs) const {
  ...
  if (__isset.total_compressed_size != rhs.__isset.total_compressed_size)
    return false;
  else if (__isset.total_compressed_size &&
...
void RowGroup::printTo(std::ostream& out) const {
  ...
  out << ", " << "num_rows=" << to_string(num_rows);
  out << ", " << "sorting_columns=";
  (__isset.sorting_columns ? (out << to_string(sorting_columns)) : (out << "<null>"));
  out << ", " << "file_offset=";
...
void PageLocation::__set_offset(const int64_t val) { this->offset = val; }
...
uint32_t PageLocation::read(::apache::thrift::protocol::TProtocol* iprot) {
  ...
  if (!isset_offset) throw TProtocolException(TProtocolException::INVALID_DATA);
  if (!isset_compressed_page_size)
    throw TProtocolException(TProtocolException::INVALID_DATA);
  if (!isset_first_row_index) throw TProtocolException(TProtocolException::INVALID_DATA);
  return xfer;
}
...
uint32_t OffsetIndex::read(::apache::thrift::protocol::TProtocol* iprot) {
  ...
  if (!isset_page_locations) throw TProtocolException(TProtocolException::INVALID_DATA);
  return xfer;
}
...
uint32_t OffsetIndex::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("page_locations", ::apache::thrift::protocol::T_LIST, 1);
  {
    ...
    for (_iter187 = this->page_locations.begin(); _iter187 != this->page_locations.end();
         ++_iter187) {
  ...
  if (this->__isset.unencoded_byte_array_data_bytes) {
                                   ...
                                   ::apache::thrift::protocol::T_LIST, 2);
    {
      xfer += oprot->writeListBegin(
          ::apache::thrift::protocol::T_I64,
          static_cast<uint32_t>(this->unencoded_byte_array_data_bytes.size()));
      std::vector<int64_t>::const_iterator _iter188;
      for (_iter188 = this->unencoded_byte_array_data_bytes.begin();
           _iter188 != this->unencoded_byte_array_data_bytes.end(); ++_iter188) {
...
ColumnIndex::ColumnIndex() noexcept : boundary_order(static_cast<BoundaryOrder>(0)) {}
...
void ColumnIndex::__set_boundary_order(const BoundaryOrder val) {
...
uint32_t ColumnIndex::read(::apache::thrift::protocol::TProtocol* iprot) {
    ...
    switch (fid) {
      ...
      case 4:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->boundary_order = static_cast<BoundaryOrder>(ecast206);
  ...
  if (!isset_null_pages) throw TProtocolException(TProtocolException::INVALID_DATA);
  if (!isset_min_values) throw TProtocolException(TProtocolException::INVALID_DATA);
  if (!isset_max_values) throw TProtocolException(TProtocolException::INVALID_DATA);
  if (!isset_boundary_order) throw TProtocolException(TProtocolException::INVALID_DATA);
  return xfer;
}
...
uint32_t ColumnIndex::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("null_pages", ::apache::thrift::protocol::T_LIST, 1);
  {
    ...
    for (_iter222 = this->null_pages.begin(); _iter222 != this->null_pages.end();
         ++_iter222) {
  ...
  xfer += oprot->writeFieldBegin("min_values", ::apache::thrift::protocol::T_LIST, 2);
  {
    ...
    for (_iter223 = this->min_values.begin(); _iter223 != this->min_values.end();
         ++_iter223) {
  ...
  xfer += oprot->writeFieldBegin("max_values", ::apache::thrift::protocol::T_LIST, 3);
  {
    ...
    for (_iter224 = this->max_values.begin(); _iter224 != this->max_values.end();
         ++_iter224) {
  ...
  if (this->__isset.null_counts) {
    xfer += oprot->writeFieldBegin("null_counts", ::apache::thrift::protocol::T_LIST, 5);
    {
      ...
      for (_iter225 = this->null_counts.begin(); _iter225 != this->null_counts.end();
           ++_iter225) {
  ...
  if (this->__isset.repetition_level_histograms) {
    xfer += oprot->writeFieldBegin("repetition_level_histograms",
                                   ::apache::thrift::protocol::T_LIST, 6);
    {
      xfer += oprot->writeListBegin(
          ::apache::thrift::protocol::T_I64,
          static_cast<uint32_t>(this->repetition_level_histograms.size()));
      std::vector<int64_t>::const_iterator _iter226;
      for (_iter226 = this->repetition_level_histograms.begin();
           _iter226 != this->repetition_level_histograms.end(); ++_iter226) {
  ...
  if (this->__isset.definition_level_histograms) {
    xfer += oprot->writeFieldBegin("definition_level_histograms",
                                   ::apache::thrift::protocol::T_LIST, 7);
    {
      xfer += oprot->writeListBegin(
          ::apache::thrift::protocol::T_I64,
          static_cast<uint32_t>(this->definition_level_histograms.size()));
      std::vector<int64_t>::const_iterator _iter227;
      for (_iter227 = this->definition_level_histograms.begin();
           _iter227 != this->definition_level_histograms.end(); ++_iter227) {
...
bool ColumnIndex::operator==(const ColumnIndex& rhs) const {
  ...
  if (__isset.repetition_level_histograms != rhs.__isset.repetition_level_histograms)
    return false;
  else if (__isset.repetition_level_histograms &&
           !(repetition_level_histograms == rhs.repetition_level_histograms))
    return false;
  if (__isset.definition_level_histograms != rhs.__isset.definition_level_histograms)
    return false;
  else if (__isset.definition_level_histograms &&
...
void ColumnIndex::printTo(std::ostream& out) const {
  ...
  out << ", " << "repetition_level_histograms=";
  (__isset.repetition_level_histograms ? (out << to_string(repetition_level_histograms))
                                       : (out << "<null>"));
  out << ", " << "definition_level_histograms=";
  (__isset.definition_level_histograms ? (out << to_string(definition_level_histograms))
                                       : (out << "<null>"));
  out << ")";
}
...
AesGcmV1::AesGcmV1() noexcept : aad_prefix(), aad_file_unique(), supply_aad_prefix(0) {}
...
void AesGcmV1::printTo(std::ostream& out) const {
  ...
  out << ", " << "aad_file_unique=";
  (__isset.aad_file_unique ? (out << to_string(aad_file_unique)) : (out << "<null>"));
  out << ", " << "supply_aad_prefix=";
  (__isset.supply_aad_prefix ? (out << to_string(supply_aad_prefix)) : (out << "<null>"));
  out << ")";
}
...
uint32_t EncryptionAlgorithm::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.AES_GCM_CTR_V1) {
    xfer +=
        oprot->writeFieldBegin("AES_GCM_CTR_V1", ::apache::thrift::protocol::T_STRUCT, 2);
...
void EncryptionAlgorithm::printTo(std::ostream& out) const {
  ...
  out << ", " << "AES_GCM_CTR_V1=";
  (__isset.AES_GCM_CTR_V1 ? (out << to_string(AES_GCM_CTR_V1)) : (out << "<null>"));
  out << ")";
}
...
void FileMetaData::__set_version(const int32_t val) { this->version = val; }

void FileMetaData::__set_schema(const std::vector<SchemaElement>& val) {
  this->schema = val;
}

void FileMetaData::__set_num_rows(const int64_t val) { this->num_rows = val; }
...
uint32_t FileMetaData::read(::apache::thrift::protocol::TProtocol* iprot) {
  ...
  if (!isset_version) throw TProtocolException(TProtocolException::INVALID_DATA);
  if (!isset_schema) throw TProtocolException(TProtocolException::INVALID_DATA);
  if (!isset_num_rows) throw TProtocolException(TProtocolException::INVALID_DATA);
  if (!isset_row_groups) throw TProtocolException(TProtocolException::INVALID_DATA);
  return xfer;
}
...
uint32_t FileMetaData::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("schema", ::apache::thrift::protocol::T_LIST, 2);
  {
    ...
    std::vector<SchemaElement>::const_iterator _iter256;
  ...
  xfer += oprot->writeFieldBegin("row_groups", ::apache::thrift::protocol::T_LIST, 4);
  {
    ...
    std::vector<RowGroup>::const_iterator _iter257;
    for (_iter257 = this->row_groups.begin(); _iter257 != this->row_groups.end();
         ++_iter257) {
  ...
  if (this->__isset.key_value_metadata) {
                                   ...
                                   ::apache::thrift::protocol::T_LIST, 5);
    {
      xfer +=
          oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT,
                                static_cast<uint32_t>(this->key_value_metadata.size()));
      std::vector<KeyValue>::const_iterator _iter258;
      for (_iter258 = this->key_value_metadata.begin();
           _iter258 != this->key_value_metadata.end(); ++_iter258) {
  ...
  if (this->__isset.column_orders) {
    xfer +=
        oprot->writeFieldBegin("column_orders", ::apache::thrift::protocol::T_LIST, 7);
    {
      xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT,
                                    static_cast<uint32_t>(this->column_orders.size()));
      std::vector<ColumnOrder>::const_iterator _iter259;
      for (_iter259 = this->column_orders.begin(); _iter259 != this->column_orders.end();
           ++_iter259) {
  ...
  if (this->__isset.encryption_algorithm) {
    xfer += oprot->writeFieldBegin("encryption_algorithm",
                                   ::apache::thrift::protocol::T_STRUCT, 8);
...
bool FileMetaData::operator==(const FileMetaData& rhs) const {
  ...
  if (__isset.encryption_algorithm != rhs.__isset.encryption_algorithm)
    return false;
  else if (__isset.encryption_algorithm &&
...
void FileMetaData::printTo(std::ostream& out) const {
  ...
  out << ", " << "column_orders=";
  (__isset.column_orders ? (out << to_string(column_orders)) : (out << "<null>"));
  out << ", " << "encryption_algorithm=";
  (__isset.encryption_algorithm ? (out << to_string(encryption_algorithm))
                                : (out << "<null>"));
  out << ", " << "footer_signing_key_metadata=";
  (__isset.footer_signing_key_metadata ? (out << to_string(footer_signing_key_metadata))
                                       : (out << "<null>"));
  out << ")";
}
...
FileCryptoMetaData::FileCryptoMetaData() noexcept : key_metadata() {}
