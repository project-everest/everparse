...
static Pulse_Lib_Slice_slice___COSE_Format_aux_env25_type_2_pretty___COSE_Format_aux_env25_type_4_pretty_
from_array___COSE_Format_aux_env25_type_2_pretty___COSE_Format_aux_env25_type_4_pretty_(
  K___COSE_Format_aux_env25_type_2_pretty_COSE_Format_aux_env25_type_4_pretty *a,
  size_t alen
)
{
  return
...
COSE_EverCrypt_mk_phdrs(
  int32_t alg,
  K___COSE_Format_aux_env25_type_2_pretty_COSE_Format_aux_env25_type_4_pretty *rest
)
{
        ...
        .tag = COSE_Format_Mkevercddl_empty_or_serialized_map_pretty0,
        {
          .case_Mkevercddl_empty_or_serialized_map_pretty0 = {
            ...
            ._x1 = {
              .tag = COSE_Format_Inl,
              {
                .case_Inl = from_array___COSE_Format_aux_env25_type_2_pretty___COSE_Format_aux_env25_type_4_pretty_(rest,
                  (size_t)0U)
              }
            }
          }
...
)
{
  KRML_CHECK_SIZE(sizeof (
    ...
    (size_t)0U);
  K___COSE_Format_aux_env25_type_2_pretty_COSE_Format_aux_env25_type_4_pretty phdrauxbuf[0U];
      ...
      .tag = COSE_Format_Mkevercddl_empty_or_serialized_map_pretty0,
      {
        .case_Mkevercddl_empty_or_serialized_map_pretty0 = {
          ...
          ._x1 = {
            .tag = COSE_Format_Inl,
            {
              .case_Inl = from_array___COSE_Format_aux_env25_type_2_pretty___COSE_Format_aux_env25_type_4_pretty_(phdrauxbuf,
                (size_t)0U)
            }
          }
        }
...
)
{
  KRML_CHECK_SIZE(sizeof (
    ...
    (size_t)0U);
  K___COSE_Format_aux_env25_type_2_pretty_COSE_Format_aux_env25_type_4_pretty buf0[0U];
  for (uint32_t _i = 0U; _i < (size_t)0U; ++_i)
  ...
  uhdr =
    {
      ...
      ._x1 = {
        .tag = COSE_Format_Inl,
        {
          .case_Inl = from_array___COSE_Format_aux_env25_type_2_pretty___COSE_Format_aux_env25_type_4_pretty_(buf0,
            (size_t)0U)
        }
      }
    };
