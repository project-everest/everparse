...
static
bstr mk_sig_structure(COSE_Format_evercddl_empty_or_serialized_map protected_headers,
...
COSE_Format_evercddl_header_map COSE_OpenSSL_empty_sig_headers() {
    return (COSE_Format_evercddl_header_map) {
        ...
        ._x1 = {
            .tag = COSE_Format_Inl,
            .case_Inl = {
                .elt = (K___COSE_Format_evercddl_label_COSE_Format_evercddl_values[]) {},
                .len = 0,
            },
        },
    };
...
bstr COSE_OpenSSL_sign1(EVP_PKEY *signing_key,
        COSE_Format_evercddl_header_map protected_headers,
        COSE_Format_evercddl_header_map unprotected_headers,
        bstr aad, bstr payload) {
    protected_headers.intkey1 = (FStar_Pervasives_Native_option__FStar_Pervasives_either_COSE_Format_evercddl_int_COSE_Format_evercddl_tstr) {
    ...
    COSE_Format_evercddl_empty_or_serialized_map protected_headers_ = {
        .tag = COSE_Format_Mkevercddl_empty_or_serialized_map0,
        .case_Mkevercddl_empty_or_serialized_map0 = protected_headers,
    };
...
bstr COSE_OpenSSL_verify1(EVP_PKEY *signing_key, bstr aad, bstr msg) {
    FStar_Pervasives_Native_option___COSE_Format_evercddl_COSE_Sign1_Tagged___Pulse_Lib_Slice_slice_uint8_t_ parsed_msg =
    ...
    COSE_Format_evercddl_empty_or_serialized_map protected_headers =
