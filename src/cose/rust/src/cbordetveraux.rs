...
pub(crate) fn sizet_lte_u64(b: usize, a: u64) -> bool
{
    let q1: usize = b.wrapping_div(32768usize);
...
pub(crate) fn sizet_fits_u64(b: usize) -> bool
{
    let q1: usize = b.wrapping_div(32768usize);
    let q2: usize = q1.wrapping_div(32768usize);
    let q3: usize = q2.wrapping_div(32768usize);
...
pub(crate) fn u64_lte_sizet(a: u64, b: usize) -> bool
{
    let q1: usize = b.wrapping_div(32768usize);
    let q2: usize = q1.wrapping_div(32768usize);
    let q3: usize = q2.wrapping_div(32768usize);
...
pub(crate) fn sizet_eq_u64(b: usize, a: u64) -> bool
{
    let q1: usize = b.wrapping_div(32768usize);
    let q2: usize = q1.wrapping_div(32768usize);
    let q3: usize = q2.wrapping_div(32768usize);
...
{
    let
    tmp: dtuple2__CBOR_Spec_Raw_EverParse_initial_byte_t_CBOR_Spec_Raw_EverParse_long_argument
    =
        h;
    tmp._1.major_type
}
            ...
            let input·: &[u8] =
                {
                    ...
                    let _letpattern3: (&[u8], &[u8]) =
                        {
                            let left: &[u8] = _letpattern2.0;
                            let right: &[u8] = _letpattern2.1;
                            (left,right)
                        };
                    let input2: &[u8] = _letpattern3.0;
                    let _input3: &[u8] = _letpattern3.1;
                    input2
                };
        ...
        if x.additional_info == additional_info_long_argument_8_bits
        {
            if x.major_type == cbor_major_type_simple_value
            {
                ...
                if is_valid2
                {
                    ...
                    let s·1: (&[u8], &[u8]) = input.split_at(offset3);
                    ...
                    let input·1: &[u8] =
                        {
                            ...
                            let _letpattern3: (&[u8], &[u8]) =
                                {
                                    let s1: &[u8] = _letpattern2.0;
                                    let s2: &[u8] = _letpattern2.1;
                                    (s1,s2)
                                };
                            ...
                            let input2: &[u8] = _letpattern4.0;
                            let _input3: &[u8] = _letpattern4.1;
                            input2
                        };
                ...
                if is_valid1
                {
                    ...
                    b.major_type == cbor_major_type_text_string
                    {
                        ...
                        if is_valid
                        {
                            ...
                            let s·1: (&[u8], &[u8]) = input.split_at(offset1);
                            let _letpattern1: (&[u8], &[u8]) =
                                {
                                    let s1: &[u8] = s·1.0;
                                    let s2: &[u8] = s·1.1;
...
fn jump_raw_data_item(input: &[u8], offset: usize) -> usize
{
    ...
    cond
    {
        ...
        let s·1: (&[u8], &[u8]) = input.split_at(off);
        let _letpattern1: (&[u8], &[u8]) =
            {
                let s1: &[u8] = s·1.0;
                let s2: &[u8] = s·1.1;
...
fn cbor_read <'a>(input: &'a [u8]) -> cbor_raw <'a>
{
    ...
    let pc: &[u8] =
        {
            let ph1: &[u8] = _letpattern1.0;
            let outc: &[u8] = _letpattern1.1;
            let
            h: dtuple2__CBOR_Spec_Raw_EverParse_initial_byte_t_CBOR_Spec_Raw_EverParse_long_argument
            =
                read_header(ph1);
...
fn cbor_validate(input: &[u8]) -> usize
{
    ...
    if is_valid { (&poffset)[0usize] } else { 0usize }
}
...
fn cbor_raw_sorted(a: &[u8]) -> bool
{
    ...
    {
        let nbpairs: u64 = argument_as_uint64(h._1, h._2);
        if nbpairs < 2u64
        { true }
        else
        {
            ...
            let i1: usize =
                ...
                { 0usize };
            let s1: (&[u8], &[u8]) = input2.split_at(i1);
            let _letpattern3: (&[u8], &[u8]) =
                {
                    let s11: &[u8] = s1.0;
                    let s2: &[u8] = s1.1;
            ...
            let _letpattern5: (&[u8], &[u8]) =
                {
                    let input11: &[u8] = _letpattern4.0;
                    let input21: &[u8] = _letpattern4.1;
                    (input11,input21)
                };
            let input3: &[u8] =
                {
                    let _input11: &[u8] = _letpattern5.0;
                    let input21: &[u8] = _letpattern5.1;
                    input21
                };
            let i2: usize = jump_raw_data_item(input3, 0usize);
            let s2: (&[u8], &[u8]) = input3.split_at(i2);
            ...
            let _letpattern7: (&[u8], &[u8]) =
                {
                    let input11: &[u8] = _letpattern6.0;
                    let input21: &[u8] = _letpattern6.1;
                    (input11,input21)
                };
            let _letpattern8: (&[u8], &[u8]) =
                {
                    let input11: &[u8] = _letpattern7.0;
                    let input21: &[u8] = _letpattern7.1;
                    (input11,input21)
                };
            let _letpattern9: (&[u8], &[u8]) =
                {
                    let hd: &[u8] = _letpattern8.0;
                    let tl: &[u8] = _letpattern8.1;
                    (hd,tl)
                };
            let hd4: &[u8] = _letpattern9.0;
            let input4: &[u8] = _letpattern9.1;
            let i3: usize = jump_raw_data_item(input4, 0usize);
            let s3: (&[u8], &[u8]) = input4.split_at(i3);
            ...
            let _letpattern13: (&[u8], &[u8]) =
                {
                    let hd: &[u8] = _letpattern12.0;
                    let tl: &[u8] = _letpattern12.1;
                    (hd,tl)
                };
            let input5: &[u8] =
                {
                    let _hd: &[u8] = _letpattern13.0;
            ...
            let mut pres: [bool; 1] = [true; 1usize];
            let res: bool = (&pres)[0usize];
            let pairs1: u64 = (&ppairs)[0usize];
            let mut cond: bool = res && pairs1 > 0u64;
            while
            cond
            {
                let tail: &[u8] = (&ptail)[0usize];
                let i4: usize = jump_raw_data_item(tail, 0usize);
                let s4: (&[u8], &[u8]) = tail.split_at(i4);
                ...
                let _letpattern16: (&[u8], &[u8]) =
                    {
                        let input11: &[u8] = _letpattern15.0;
                        let input21: &[u8] = _letpattern15.1;
                        (input11,input21)
                    };
                let _letpattern17: (&[u8], &[u8]) =
                    {
                        let hd: &[u8] = _letpattern16.0;
                        let tl: &[u8] = _letpattern16.1;
                        (hd,tl)
                    };
                {
                    let key2: &[u8] = _letpattern17.0;
                    let tail2: &[u8] = _letpattern17.1;
                    let key1: &[u8] = (&pkey)[0usize];
                    let res0: bool = impl_deterministically_encoded_cbor_map_key_order(key1, key2);
                    if res0
                    {
                        let i5: usize = jump_raw_data_item(tail2, 0usize);
                        let s5: (&[u8], &[u8]) = tail2.split_at(i5);
                        ...
                        let _letpattern19: (&[u8], &[u8]) =
                            {
                                let input11: &[u8] = _letpattern18.0;
                                let input21: &[u8] = _letpattern18.1;
                                (input11,input21)
                            };
                        let _letpattern20: (&[u8], &[u8]) =
                            {
                                let input11: &[u8] = _letpattern19.0;
                                let input21: &[u8] = _letpattern19.1;
                                (input11,input21)
                            };
                        let _letpattern21: (&[u8], &[u8]) =
                            {
                                let hd: &[u8] = _letpattern20.0;
                                let tl: &[u8] = _letpattern20.1;
                                (hd,tl)
                            };
                        let tail·: &[u8] =
                            {
                                let _hd: &[u8] = _letpattern21.0;
                                let tl: &[u8] = _letpattern21.1;
                                tl
                            };
                        (&mut pkey)[0usize] = key2;
                        let pairs10: u64 = (&ppairs)[0usize];
                        let pairs·: u64 = pairs10.wrapping_sub(1u64);
                        (&mut ppairs)[0usize] = pairs·;
                        (&mut ptail)[0usize] = tail·
                    }
                    else
                    { (&mut pres)[0usize] = false }
                };
...
fn cbor_validate_det·(input: &[u8]) -> usize
{
    ...
    else
    {
        ...
        let discarded: [bool; 1] = [false; 1usize];
        crate::lowstar::ignore::ignore::<[bool; 1]>(discarded);
        let mut pn: [usize; 1] = [1usize; 1usize];
        let mut pres: [bool; 1] = [true; 1usize];
        ...
        cond
        {
            ...
            else
            {
                ...
                let s·1: (&[u8], &[u8]) = pi.split_at(0usize);
                let _letpattern1: (&[u8], &[u8]) =
                    {
                        let s1: &[u8] = s·1.0;
                        let s2: &[u8] = s·1.1;
                ...
                let input·: &[u8] =
                    {
                        let _input11: &[u8] = _letpattern1.0;
                        let input23: &[u8] = _letpattern1.1;
                ...
                let ph: &[u8] = _letpattern3.0;
                let pc: &[u8] = _letpattern3.1;
        ...
        let check1: bool = (&pres)[0usize];
        if ! check1
        { 0usize }
        else
        {
            let mut pn1: [usize; 1] = [1usize; 1usize];
            let mut pres1: [bool; 1] = [true; 1usize];
            let mut ppi1: [&[u8]; 1] = [input1; 1usize];
            ...
            cond0
            {
                ...
                let pi: &[u8] = (&ppi1)[0usize];
                let res1: bool = cbor_raw_sorted(pi);
                if ! res1
                { (&mut pres1)[0usize] = false }
                else
                {
                    let off1: usize = jump_header(pi, 0usize);
                    let s·1: (&[u8], &[u8]) = pi.split_at(0usize);
...
pub(crate) fn cbor_raw_map_insert(out: &mut [u8], off2: usize, off3: usize) -> bool
{
    ...
    let res: cbor_raw_map_insert_result = (&pres)[0usize];
        ...
        let _letpattern: (&mut [u8], &mut [u8]) = out.split_at_mut(off0);
        {
            ...
            else if c > 0i16
            {
                if ! (off2.wrapping_sub(off0) == 0usize || off2.wrapping_sub(off0) == out2kv.len())
                {
                    ...
                    let __anf0: usize = (&pl)[0usize];
                    let mut cond0: bool = __anf0 > 0usize;
                    while
                    cond0
                    {
                        let n: usize = (&pn)[0usize];
                        let l: usize = (&pl)[0usize];
                        let l·: usize = n.wrapping_rem(l);
                        (&mut pn)[0usize] = l;
                        (&mut pl)[0usize] = l·;
                        let __anf00: usize = (&pl)[0usize];
                        cond0 = __anf00 > 0usize
                    };
                    let d: usize = (&pn)[0usize];
                    let q: usize = out2kv.len().wrapping_div(d);
                    let mut pi: [usize; 1] = [0usize; 1usize];
                    let __anf00: usize = (&pi)[0usize];
                    ...
                    cond1
                    {
                        ...
                        let __anf01: usize = (&pj)[0usize];
                        let mut cond2: bool = __anf01 < q.wrapping_sub(1usize);
                        while
                        cond2
                        {
                            let j: usize = (&pj)[0usize];
                            let idx: usize = (&pidx)[0usize];
                            let idx·: usize =
                                if
                        ...
                        (&mut pi)[0usize] = i·;
                        let __anf02: usize = (&pi)[0usize];
                        cond1 = __anf02 < d
                    }
                };
                (&mut pres)[0usize] = cbor_raw_map_insert_result::CSuccess
            }
            else
            { (&mut pres)[0usize] = cbor_raw_map_insert_result::CFailure }
        };
        let res0: cbor_raw_map_insert_result = (&pres)[0usize];
        let off1: usize = (&poff)[0usize];
        cond =
            match res0
            {
                cbor_raw_map_insert_result::CInProgress => true,
    ...
    <'a>
{
    ...
    let res: cbor_map_entry =
        {
            let s11: &[u8] = _letpattern5.0;
            let s21: &[u8] = _letpattern5.1;
        ...
        cbor_raw_iterator__CBOR_Pulse_Raw_Type_cbor_map_entry::CBOR_Raw_Iterator_Slice { _0: i } =>
          {
              ...
              let i1: &[cbor_map_entry] = s·;
              let i·: &[cbor_map_entry] = i1;
              pi[0usize] =
                  cbor_raw_iterator__CBOR_Pulse_Raw_Type_cbor_map_entry::CBOR_Raw_Iterator_Slice
                  { _0: i· };
              res
...
pub(crate) fn cbor_compare_with_depth(x1: cbor_raw, x2: cbor_raw) -> i16
{
    ...
    if c == 0i16
    {
        ...
        {
            let tag1: raw_uint64 = cbor_match_tagged_get_tag_with_depth(x1);
            let tag2: raw_uint64 = cbor_match_tagged_get_tag_with_depth(x2);
        ...
        {
            let len1: raw_uint64 = cbor_match_array_get_length_with_depth(x1);
            let len2: raw_uint64 = cbor_match_array_get_length_with_depth(x2);
            ...
            if c1 == 0i16
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        let res: i16 = (&pres)[0usize];
                        let fin11: bool = (&pfin1)[0usize];
                        let mut cond: bool = res == 0i16 && ! fin11;
                        while
                        cond
                        {
                            let iter: cbor_raw_iterator__CBOR_Pulse_Raw_Type_cbor_raw =
                                (&pi1)[0usize];
                            let elt1: cbor_raw =
                                match iter
                                {
                            ...
                            let iter1: cbor_raw_iterator__CBOR_Pulse_Raw_Type_cbor_raw =
                                (&pi2)[0usize];
                            let elt2: cbor_raw =
                                match iter1
                                {
        ...
        {
            let len1: raw_uint64 = cbor_match_map_get_length_with_depth(x1);
            let len2: raw_uint64 = cbor_match_map_get_length_with_depth(x2);
            let c1: i16 = impl_raw_uint64_compare(len1, len2);
            if c1 == 0i16
            {
                if
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        cond
                        {
                            ...
                            let iter1: cbor_raw_iterator__CBOR_Pulse_Raw_Type_cbor_map_entry =
                                (&pi2)[0usize];
    ...
    dtuple2__CBOR_Spec_Raw_EverParse_initial_byte_t_CBOR_Spec_Raw_EverParse_long_argument
{
    match xl
    {
        ...
        cbor_raw::CBOR_Case_Tagged { .. } =>
          {
              let tag: raw_uint64 = cbor_match_tagged_get_tag_with_depth0(xl);
        ...
        cbor_raw::CBOR_Case_Array { .. } =>
          {
              let len: raw_uint64 = cbor_match_array_get_length_with_depth0(xl);
        ...
        cbor_raw::CBOR_Case_Map { .. } =>
          {
              let len: raw_uint64 = cbor_match_map_get_length_with_depth0(xl);
...
#[derive(PartialEq, Clone, Copy)]
pub enum option__Pulse_Lib_Slice_slice·CBOR_Pulse_Raw_Type_cbor_raw_tags
{
    None,
    Some
}
    ...
    usize
{
    ...
    if xh1.additional_info == additional_info_long_argument_8_bits
    {
        ...
        {
            let pos·1: usize = res1.wrapping_add(1usize);
            let n·1: u8 =
                match x2·
                {
                    long_argument::LongArgumentSimpleValue { v } => v,
    ...
    {
        let pos·1: usize = res1.wrapping_add(2usize);
        let lo: u8 =
            match x2·
            {
    ...
    {
        let pos·1: usize = res1.wrapping_add(4usize);
        let lo: u8 =
            match x2·
            {
    ...
    {
        let pos·1: usize = res1.wrapping_add(8usize);
        let lo: u8 =
            match x2·
            {
...
pub(crate) fn ser·_d(x·: cbor_raw, out: &mut [u8], offset: usize) -> usize
{
    ...
    if deep
    {
        ...
        b.major_type == cbor_major_type_byte_string || b.major_type == cbor_major_type_text_string
        {
            ...
            let length: usize = x2·.len();
            let _letpattern1: (&mut [u8], &mut [u8]) = out.split_at_mut(res1);
            let _sp11: &[u8] = _letpattern1.0;
            let sp12: &mut [u8] = _letpattern1.1;
            let _letpattern2: (&mut [u8], &mut [u8]) = sp12.split_at_mut(length);
            let sp21: &mut [u8] = _letpattern2.0;
            let _sp22: &[u8] = _letpattern2.1;
        ...
        else
        {
            ...
            else
            {
                ...
                cond
                {
                    ...
                    let i11: usize = (&pi1)[0usize];
                    let i21: usize = (&pi2)[0usize];
                    let res20: bool = (&pres)[0usize];
