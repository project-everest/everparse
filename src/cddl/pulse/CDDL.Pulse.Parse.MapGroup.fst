...
noeq
type map_iterator_t
  (#ty: Type0) (cbor_map_iterator_t: Type0)
...
let cddl_map_iterator_impl_validate1
  ...
  (i: map_iterator_t cbor_map_iterator_t impl_elt1 impl_elt2 vmatch spec1 spec2)
...
: map_iterator_t cbor_map_iterator_t impl_elt1 impl_elt2 vmatch (Iterator.mk_spec r1) (Iterator.mk_spec r2)
= {
...
let mk_map_iterator_eq_postcond
  ...
  (res: map_iterator_t cbor_map_iterator_t impl_elt1 impl_elt2 vmatch (Iterator.mk_spec r1) (Iterator.mk_spec r2))
: Tot prop
...
let rel_map_iterator
  ...
  (impl_elt1: Type0) (impl_elt2: Type0)
  (spec1: Ghost.erased (Iterator.type_spec impl_elt1)) (spec2: Ghost.erased (Iterator.type_spec impl_elt2))
: rel (map_iterator_t cbor_map_iterator_t impl_elt1 impl_elt2 vmatch spec1 spec2) (Map.t (dfst spec1) (list (dfst spec2)))
...
fn rel_map_iterator_prop
  (#ty: Type0) (#vmatch: perm -> ty -> cbor -> slprop) (#cbor_map_iterator_t: Type0) (cbor_map_iterator_match: perm -> cbor_map_iterator_t -> list (cbor & cbor) -> slprop)
  (#impl_elt1: Type0) (#impl_elt2: Type0)
: rel_map_iterator_singletons impl_elt1 impl_elt2 (map_iterator_t cbor_map_iterator_t impl_elt1 impl_elt2 vmatch) (rel_map_iterator vmatch cbor_map_iterator_match impl_elt1 impl_elt2)
=
  (#spec1: Ghost.erased (Iterator.type_spec impl_elt1))
  (#spec2: Ghost.erased (Iterator.type_spec impl_elt2))
...
fn rel_map_iterator_prop'
  (#ty: Type0) (#vmatch: perm -> ty -> cbor -> slprop) (#cbor_map_iterator_t: Type0) (cbor_map_iterator_match: perm -> cbor_map_iterator_t -> list (cbor & cbor) -> slprop)
  (#impl_elt1: Type0) (#impl_elt2: Type0)
: rel_map_iterator_length impl_elt1 impl_elt2 (map_iterator_t cbor_map_iterator_t impl_elt1 impl_elt2 vmatch) (rel_map_iterator vmatch cbor_map_iterator_match impl_elt1 impl_elt2)
=
  (#spec1: Ghost.erased (Iterator.type_spec impl_elt1))
  (#spec2: Ghost.erased (Iterator.type_spec impl_elt2))
  (i: map_iterator_t vmatch cbor_map_iterator_t impl_elt1 impl_elt2 spec1 spec2)
...
=
  cddl_map_iterator_is_empty_gen_t impl_elt1 impl_elt2
    (map_iterator_t cbor_map_iterator_t impl_elt1 impl_elt2 vmatch)
  ...
  (#l: _)
{
  ...
  let j = !pj;
  let i' : map_iterator_t cbor_map_iterator_t impl_elt1 impl_elt2 vmatch spec1 spec2 = { i with
...
: Lemma
  (ensures (
    Map.mem kv (map_of_list_pair key_eq (parse_table_entries pkey.parser key_except pvalue.parser l)) <==> (
      pkey.serializable (fst kv) /\
      (~ (key_except (pkey.serializer (fst kv)))) /\ (
  ...
  (decreases l)
= parse_table_entries_no_repeats pkey key_except pvalue.parser l;
  map_of_list_pair_no_repeats_key key_eq (parse_table_entries pkey.parser key_except pvalue.parser l);
  match l with
  | [] -> ()
  | (k1, v1) :: q ->
    map_of_list_pair_parse_table_entries_mem key_eq pkey key_except pvalue q sq kv
...
let map_of_list_pair_parse_table_entries_correct
  ...
  (#inj: bool)
  (pvalue: spec value tvalue inj)
  (m1: map_group_parser_spec_arg (map_group_zero_or_more (map_group_match_item false (Util.andp key (Util.notp key_except)) value)) (Util.andp key (Util.notp key_except)))
  (m2: cbor_map)
  (l: list (cbor & cbor))
: Lemma
  (requires (
    cbor_map_disjoint_from_footprint m2 (Util.andp key (Util.notp key_except)) /\
    (forall k . cbor_map_get (cbor_map_union m1 m2) k == List.Tot.assoc k l) /\
    List.Tot.no_repeats_p (List.Tot.map fst l)
  ))
  (ensures (
    map_of_list_pair key_eq (parse_table_entries pkey.parser key_except pvalue.parser l) `Map.equal` map_group_zero_or_more_match_item_parser pkey key_except pvalue m1
...
= Classical.forall_intro (list_assoc_no_repeats_mem' l);
  let prf
    (kv: (tkey & list tvalue))
  : Lemma
    (Map.mem kv (map_of_list_pair key_eq (parse_table_entries pkey.parser key_except pvalue.parser l)) <==> Map.mem kv (map_group_zero_or_more_match_item_parser pkey key_except pvalue m1))
  = map_of_list_pair_parse_table_entries_mem key_eq pkey key_except pvalue l () kv;
    map_group_zero_or_more_match_item_parser'_mem pkey key_except pvalue m1 kv;
    ()
  in
...
let map_group_zero_or_more_match_item
  (key: typ)
  (key_except: typ)
  (value: typ)
: Tot det_map_group
= map_group_zero_or_more (map_group_match_item false (Util.andp key (Util.notp key_except)) value)
...
let impl_zero_copy_map_zero_or_more_aux
  ...
  (#cbor_map_iterator_t: Type0)
    ...
    (m1 m2: cbor_map)
    (pm: perm)
    (i: map_iterator_t cbor_map_iterator_t ikey ivalue vmatch (Iterator.mk_spec r1) (Iterator.mk_spec r2))
    (contents: cbor_map_iterator_t)
    (li: list (cbor & cbor))
...
: Lemma
  (requires (
    impl_zero_copy_map_group_pre
      (map_group_zero_or_more_match_item key key_except value)
      (typ_andp key (typ_notp key_except))
      v m1 m2 /\
    (forall k . cbor_map_get (cbor_map_union m1 m2) k == List.Tot.assoc k li) /\
    rel_map_iterator_cond i s li /\
    mk_map_iterator_eq_postcond contents pm sp1 key_eq key_except sp2.parser i
  ))
  (ensures (
    impl_zero_copy_map_group_post
      (map_group_zero_or_more_match_item_parser sp1 key_except sp2)
      v m1 m2 s
  ))
= map_of_list_pair_parse_table_entries_correct key_eq sp1 key_except sp2 m1 m2 li;
  ...
  assert (parse_table_entries sp1.parser key_except sp2.parser li == parse_table_entries i.sp1.parser i.tex i.ps2 li);
  assert (s == map_of_list_pair key_eq (parse_table_entries sp1.parser key_except sp2.parser li));
  ()
...
: impl_zero_copy_map_group
    ...
    #(map_iterator_t cbor_map_iterator_t ikey ivalue vmatch (Iterator.mk_spec r1) (Iterator.mk_spec r2))
    (rel_map_iterator vmatch cbor_map_iterator_match ikey ivalue (Iterator.mk_spec r1) (Iterator.mk_spec r2))
=
  (c: _)
  (#p: _)
  (#v: _)
  ...
  (v2: _)
{
  ...
  let res : map_iterator_t cbor_map_iterator_t ikey ivalue vmatch (Iterator.mk_spec r1) (Iterator.mk_spec r2) = mk_map_iterator i (pl /. 2.0R) sp1 key_eq va1 pa1 va_ex va2 pa2;
...
: impl_zero_copy_map_group
    ...
    #(map_group_zero_or_more_match_item_serializable (Ghost.reveal sp1) (Ghost.reveal key_except) (Ghost.reveal sp2))
    (map_group_zero_or_more_match_item_parser (Ghost.reveal sp1) (Ghost.reveal key_except) (Ghost.reveal sp2))
    #(either (slice (ikey & ivalue)) (map_iterator_t cbor_map_iterator_t ikey ivalue vmatch (Iterator.mk_spec r1) (Iterator.mk_spec r2)))
  ...
  (v2: _)
{
  ...
  let res : either (slice (ikey & ivalue)) (map_iterator_t cbor_map_iterator_t ikey ivalue vmatch (Iterator.mk_spec r1) (Iterator.mk_spec r2)) = Inr rres;
  Trade.rewrite_with_trade
