...
= {
  ...
  cbor_mk_string = mk_string_from_slice (mk_string_from_arrayptr_dispatch (cbor_det_mk_byte_string_from_arrayptr ()) (cbor_det_mk_text_string_from_arrayptr ())) (CBOR.Pulse.API.Det.Dummy.dummy_cbor_det_t ());
