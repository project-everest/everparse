...
=
  ...
  if sp1.serializable gk && sp2.serializable gv then
    cbor_map_min_length_singleton minl (sp1.serializer gk) (sp2.serializer gv)

let impl_serialize_map_zero_or_more_iterator_gen_invariant_min_next
  (#pe: cbor_parser)
  (#minl: cbor_min_length pe)
  (#maxl: cbor_max_length pe)
  (p: cbor_map_parser minl maxl)
