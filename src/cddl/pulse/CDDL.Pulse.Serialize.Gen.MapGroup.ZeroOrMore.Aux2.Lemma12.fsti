...
: Lemma
  (requires
    ...
    (exists (em_old: bool) (vout_old: Seq.seq U8.t) (size_old: SZ.t) (count_old: U64.t) (m_old: cbor_map) (gk: tkey) (gv: tvalue) (key_eq: EqTest.eq_test tkey) (min_old: nat) (max_old: option nat) .
      impl_serialize_map_zero_or_more_iterator_gen_invariant p sp1 sp2 except em_old out vout_old size_old count_old m_old v0 (map_of_list_cons key_eq gk gv v) min_old max_old true /\
