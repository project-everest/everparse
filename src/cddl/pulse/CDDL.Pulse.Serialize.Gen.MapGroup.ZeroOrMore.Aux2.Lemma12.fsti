...
: Lemma
  (requires
    ...
    (exists (em_old: bool) (size_old: SZ.t) (count_old: U64.t) (m_old: cbor_map) (keq: EqTest.eq_test tkey) .
      impl_serialize_map_zero_or_more_iterator_gen_invariant p sp1 sp2 except em_old out (Ghost.reveal vout_old) size_old count_old m_old v0 (map_of_list_cons keq (Ghost.reveal gk) (Ghost.reveal gv) v) (Ghost.reveal min_old) (Ghost.reveal max_old) true /\
      ...
      sp1.serializable (Ghost.reveal gk) /\ sp2.serializable (Ghost.reveal gv) /\
      except (sp1.serializer (Ghost.reveal gk), sp2.serializer (Ghost.reveal gv)) == false)
  )
  (ensures
