...
: Tot (array_bundle cbor_array_iterator_match)
= match b1 with
  | Mkarray_bundle ab_typ1 ab_spec_type1 ab_spec_type_eq1 ab_spec1 ab_impl_type1 ab_rel1 ab_parser1 ->
  match b2 with
  | Mkarray_bundle ab_typ2 ab_spec_type2 ab_spec_type_eq2 ab_spec2 ab_impl_type2 ab_rel2 ab_parser2 ->
{
  ab_typ = _;
  ab_spec_type = _;
