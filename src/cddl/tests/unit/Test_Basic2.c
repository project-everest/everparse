...
int main()
{
    ...
    Basic2_evercddl_map18_pretty m = {
        .intkey18 = 1818,
        ._x0 = {
    ...
    FStar_Pervasives_Native_option___Basic2_evercddl_map18_pretty___Pulse_Lib_Slice_slice_uint8_t_
    ...
    FStar_Pervasives_Native_option___Basic2_evercddl_map42_pretty___Pulse_Lib_Slice_slice_uint8_t_
