...
int main()
{
    ...
    FStar_Pervasives_Native_option___Basic2_map18___Pulse_Lib_Slice_slice__uint8_t_
    ...
    FStar_Pervasives_Native_option___Basic2_map42___Pulse_Lib_Slice_slice__uint8_t_
