...
let venv1 : Impl.validator_env Det.cbor_det_match env1.si_ast.e_sem_env =
  Impl.extend_validator_env_with_typ_weak venv0 (T.pull_name sorted_source0) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) (T.pull_type sorted_source0) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) validate_bool
...
let _ : unit = _ by (FStar.Tactics.print ("env'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let env2 : spec_and_impl_env =
  spec_and_impl_env_extend_typ_with_weak Det.cbor_det_impl env1 (T.pull_name sorted_source1) (T.pull_type sorted_source1) wf2'
let _ : unit = _ by (FStar.Tactics.print ("venv'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let venv2 : Impl.validator_env Det.cbor_det_match env2.si_ast.e_sem_env =
  Impl.extend_validator_env_with_typ_weak venv1 (T.pull_name sorted_source1) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) (T.pull_type sorted_source1) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) validate_everparsenomatch
let _ : unit = _ by (FStar.Tactics.print ("source'"); FStar.Tactics.exact (`()))
[@@FStar.Tactics.postprocess_with (fun _ -> FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ()); noextract_to "krml"; sem_attr] noextract
...
let _ : unit = _ by (FStar.Tactics.print ("env'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let env3 : spec_and_impl_env =
  spec_and_impl_env_extend_typ_with_weak Det.cbor_det_impl env2 (T.pull_name sorted_source2) (T.pull_type sorted_source2) wf3'
let _ : unit = _ by (FStar.Tactics.print ("venv'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let venv3 : Impl.validator_env Det.cbor_det_match env3.si_ast.e_sem_env =
  Impl.extend_validator_env_with_typ_weak venv2 (T.pull_name sorted_source2) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) (T.pull_type sorted_source2) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) validate_uint
let _ : unit = _ by (FStar.Tactics.print ("source'"); FStar.Tactics.exact (`()))
[@@FStar.Tactics.postprocess_with (fun _ -> FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ()); noextract_to "krml"; sem_attr] noextract
...
let _ : unit = _ by (FStar.Tactics.print ("env'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let env4 : spec_and_impl_env =
  spec_and_impl_env_extend_typ_with_weak Det.cbor_det_impl env3 (T.pull_name sorted_source3) (T.pull_type sorted_source3) wf4'
let _ : unit = _ by (FStar.Tactics.print ("venv'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let venv4 : Impl.validator_env Det.cbor_det_match env4.si_ast.e_sem_env =
  Impl.extend_validator_env_with_typ_weak venv3 (T.pull_name sorted_source3) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) (T.pull_type sorted_source3) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) validate_nint
let _ : unit = _ by (FStar.Tactics.print ("source'"); FStar.Tactics.exact (`()))
[@@FStar.Tactics.postprocess_with (fun _ -> FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ()); noextract_to "krml"; sem_attr] noextract
...
let _ : unit = _ by (FStar.Tactics.print ("env'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let env5 : spec_and_impl_env =
  spec_and_impl_env_extend_typ_with_weak Det.cbor_det_impl env4 (T.pull_name sorted_source4) (T.pull_type sorted_source4) wf5'
let _ : unit = _ by (FStar.Tactics.print ("venv'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let venv5 : Impl.validator_env Det.cbor_det_match env5.si_ast.e_sem_env =
  Impl.extend_validator_env_with_typ_weak venv4 (T.pull_name sorted_source4) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) (T.pull_type sorted_source4) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) validate_int
let _ : unit = _ by (FStar.Tactics.print ("source'"); FStar.Tactics.exact (`()))
[@@FStar.Tactics.postprocess_with (fun _ -> FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ()); noextract_to "krml"; sem_attr] noextract
...
let _ : unit = _ by (FStar.Tactics.print ("env'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let env6 : spec_and_impl_env =
  spec_and_impl_env_extend_typ_with_weak Det.cbor_det_impl env5 (T.pull_name sorted_source5) (T.pull_type sorted_source5) wf6'
let _ : unit = _ by (FStar.Tactics.print ("venv'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let venv6 : Impl.validator_env Det.cbor_det_match env6.si_ast.e_sem_env =
  Impl.extend_validator_env_with_typ_weak venv5 (T.pull_name sorted_source5) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) (T.pull_type sorted_source5) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) validate_bstr
let _ : unit = _ by (FStar.Tactics.print ("source'"); FStar.Tactics.exact (`()))
[@@FStar.Tactics.postprocess_with (fun _ -> FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ()); noextract_to "krml"; sem_attr] noextract
...
let _ : unit = _ by (FStar.Tactics.print ("env'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let env7 : spec_and_impl_env =
  spec_and_impl_env_extend_typ_with_weak Det.cbor_det_impl env6 (T.pull_name sorted_source6) (T.pull_type sorted_source6) wf7'
let _ : unit = _ by (FStar.Tactics.print ("venv'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let venv7 : Impl.validator_env Det.cbor_det_match env7.si_ast.e_sem_env =
  Impl.extend_validator_env_with_typ_weak venv6 (T.pull_name sorted_source6) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) (T.pull_type sorted_source6) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) validate_encodedcbor
let _ : unit = _ by (FStar.Tactics.print ("source'"); FStar.Tactics.exact (`()))
[@@FStar.Tactics.postprocess_with (fun _ -> FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ()); noextract_to "krml"; sem_attr] noextract
...
let _ : unit = _ by (FStar.Tactics.print ("env'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let env8 : spec_and_impl_env =
  spec_and_impl_env_extend_typ_with_weak Det.cbor_det_impl env7 (T.pull_name sorted_source7) (T.pull_type sorted_source7) wf8'
let _ : unit = _ by (FStar.Tactics.print ("venv'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let venv8 : Impl.validator_env Det.cbor_det_match env8.si_ast.e_sem_env =
  Impl.extend_validator_env_with_typ_weak venv7 (T.pull_name sorted_source7) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) (T.pull_type sorted_source7) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) validate_bytes
let _ : unit = _ by (FStar.Tactics.print ("source'"); FStar.Tactics.exact (`()))
[@@FStar.Tactics.postprocess_with (fun _ -> FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ()); noextract_to "krml"; sem_attr] noextract
...
let _ : unit = _ by (FStar.Tactics.print ("env'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let env9 : spec_and_impl_env =
  spec_and_impl_env_extend_typ_with_weak Det.cbor_det_impl env8 (T.pull_name sorted_source8) (T.pull_type sorted_source8) wf9'
let _ : unit = _ by (FStar.Tactics.print ("venv'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let venv9 : Impl.validator_env Det.cbor_det_match env9.si_ast.e_sem_env =
  Impl.extend_validator_env_with_typ_weak venv8 (T.pull_name sorted_source8) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) (T.pull_type sorted_source8) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) validate_tstr
let _ : unit = _ by (FStar.Tactics.print ("source'"); FStar.Tactics.exact (`()))
[@@FStar.Tactics.postprocess_with (fun _ -> FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ()); noextract_to "krml"; sem_attr] noextract
...
let _ : unit = _ by (FStar.Tactics.print ("env'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let env10 : spec_and_impl_env =
  spec_and_impl_env_extend_typ_with_weak Det.cbor_det_impl env9 (T.pull_name sorted_source9) (T.pull_type sorted_source9) wf10'
let _ : unit = _ by (FStar.Tactics.print ("venv'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let venv10 : Impl.validator_env Det.cbor_det_match env10.si_ast.e_sem_env =
  Impl.extend_validator_env_with_typ_weak venv9 (T.pull_name sorted_source9) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) (T.pull_type sorted_source9) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) validate_label
let _ : unit = _ by (FStar.Tactics.print ("source'"); FStar.Tactics.exact (`()))
[@@FStar.Tactics.postprocess_with (fun _ -> FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ()); noextract_to "krml"; sem_attr] noextract
...
let _ : unit = _ by (FStar.Tactics.print ("env'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let env11 : spec_and_impl_env =
  spec_and_impl_env_extend_group env10 (T.pull_name sorted_source10) (T.pull_group sorted_source10) (_ by (FStar.Tactics.norm [delta; iota; zeta; primops]; FStar.Tactics.trefl ())) (_ by (FStar.Tactics.norm [delta; iota; zeta; primops]; FStar.Tactics.trefl ()))
let _ : unit = _ by (FStar.Tactics.print ("venv'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let venv11 : Impl.validator_env Det.cbor_det_match env11.si_ast.e_sem_env =
...
let _ : unit = _ by (FStar.Tactics.print ("env'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let env12 : spec_and_impl_env =
  spec_and_impl_env_extend_typ_with_weak Det.cbor_det_impl env11 (T.pull_name sorted_source11) (T.pull_type sorted_source11) wf12'
let _ : unit = _ by (FStar.Tactics.print ("venv'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let venv12 : Impl.validator_env Det.cbor_det_match env12.si_ast.e_sem_env =
  Impl.extend_validator_env_with_typ_weak venv11 (T.pull_name sorted_source11) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) (T.pull_type sorted_source11) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) validate_tdate
let _ : unit = _ by (FStar.Tactics.print ("source'"); FStar.Tactics.exact (`()))
[@@FStar.Tactics.postprocess_with (fun _ -> FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ()); noextract_to "krml"; sem_attr] noextract
...
let _ : unit = _ by (FStar.Tactics.print ("env'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let env13 : spec_and_impl_env =
  spec_and_impl_env_extend_typ_with_weak Det.cbor_det_impl env12 (T.pull_name sorted_source12) (T.pull_type sorted_source12) wf13'
let _ : unit = _ by (FStar.Tactics.print ("venv'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let venv13 : Impl.validator_env Det.cbor_det_match env13.si_ast.e_sem_env =
  Impl.extend_validator_env_with_typ_weak venv12 (T.pull_name sorted_source12) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) (T.pull_type sorted_source12) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) validate_uri
let _ : unit = _ by (FStar.Tactics.print ("source'"); FStar.Tactics.exact (`()))
[@@FStar.Tactics.postprocess_with (fun _ -> FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ()); noextract_to "krml"; sem_attr] noextract
...
let _ : unit = _ by (FStar.Tactics.print ("env'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let env14 : spec_and_impl_env =
  spec_and_impl_env_extend_typ_with_weak Det.cbor_det_impl env13 (T.pull_name sorted_source13) (T.pull_type sorted_source13) wf14'
let _ : unit = _ by (FStar.Tactics.print ("venv'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let venv14 : Impl.validator_env Det.cbor_det_match env14.si_ast.e_sem_env =
  Impl.extend_validator_env_with_typ_weak venv13 (T.pull_name sorted_source13) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) (T.pull_type sorted_source13) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) validate_b64url
let _ : unit = _ by (FStar.Tactics.print ("source'"); FStar.Tactics.exact (`()))
[@@FStar.Tactics.postprocess_with (fun _ -> FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ()); noextract_to "krml"; sem_attr] noextract
...
let _ : unit = _ by (FStar.Tactics.print ("env'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let env15 : spec_and_impl_env =
  spec_and_impl_env_extend_typ_with_weak Det.cbor_det_impl env14 (T.pull_name sorted_source14) (T.pull_type sorted_source14) wf15'
let _ : unit = _ by (FStar.Tactics.print ("venv'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let venv15 : Impl.validator_env Det.cbor_det_match env15.si_ast.e_sem_env =
  Impl.extend_validator_env_with_typ_weak venv14 (T.pull_name sorted_source14) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) (T.pull_type sorted_source14) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) validate_b64legacy
let _ : unit = _ by (FStar.Tactics.print ("source'"); FStar.Tactics.exact (`()))
[@@FStar.Tactics.postprocess_with (fun _ -> FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ()); noextract_to "krml"; sem_attr] noextract
...
let _ : unit = _ by (FStar.Tactics.print ("env'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let env16 : spec_and_impl_env =
  spec_and_impl_env_extend_typ_with_weak Det.cbor_det_impl env15 (T.pull_name sorted_source15) (T.pull_type sorted_source15) wf16'
let _ : unit = _ by (FStar.Tactics.print ("venv'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let venv16 : Impl.validator_env Det.cbor_det_match env16.si_ast.e_sem_env =
  Impl.extend_validator_env_with_typ_weak venv15 (T.pull_name sorted_source15) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) (T.pull_type sorted_source15) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) validate_regexp
let _ : unit = _ by (FStar.Tactics.print ("source'"); FStar.Tactics.exact (`()))
[@@FStar.Tactics.postprocess_with (fun _ -> FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ()); noextract_to "krml"; sem_attr] noextract
...
let _ : unit = _ by (FStar.Tactics.print ("env'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let env17 : spec_and_impl_env =
  spec_and_impl_env_extend_typ_with_weak Det.cbor_det_impl env16 (T.pull_name sorted_source16) (T.pull_type sorted_source16) wf17'
let _ : unit = _ by (FStar.Tactics.print ("venv'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let venv17 : Impl.validator_env Det.cbor_det_match env17.si_ast.e_sem_env =
  Impl.extend_validator_env_with_typ_weak venv16 (T.pull_name sorted_source16) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) (T.pull_type sorted_source16) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) validate_mimemessage
let _ : unit = _ by (FStar.Tactics.print ("source'"); FStar.Tactics.exact (`()))
[@@FStar.Tactics.postprocess_with (fun _ -> FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ()); noextract_to "krml"; sem_attr] noextract
...
let _ : unit = _ by (FStar.Tactics.print ("env'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let env18 : spec_and_impl_env =
  spec_and_impl_env_extend_typ_with_weak Det.cbor_det_impl env17 (T.pull_name sorted_source17) (T.pull_type sorted_source17) wf18'
let _ : unit = _ by (FStar.Tactics.print ("venv'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let venv18 : Impl.validator_env Det.cbor_det_match env18.si_ast.e_sem_env =
  Impl.extend_validator_env_with_typ_weak venv17 (T.pull_name sorted_source17) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) (T.pull_type sorted_source17) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) validate_text
let _ : unit = _ by (FStar.Tactics.print ("source'"); FStar.Tactics.exact (`()))
[@@FStar.Tactics.postprocess_with (fun _ -> FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ()); noextract_to "krml"; sem_attr] noextract
...
let _ : unit = _ by (FStar.Tactics.print ("env'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let env19 : spec_and_impl_env =
  spec_and_impl_env_extend_typ_with_weak Det.cbor_det_impl env18 (T.pull_name sorted_source18) (T.pull_type sorted_source18) wf19'
let _ : unit = _ by (FStar.Tactics.print ("venv'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let venv19 : Impl.validator_env Det.cbor_det_match env19.si_ast.e_sem_env =
  Impl.extend_validator_env_with_typ_weak venv18 (T.pull_name sorted_source18) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) (T.pull_type sorted_source18) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) validate_false
let _ : unit = _ by (FStar.Tactics.print ("source'"); FStar.Tactics.exact (`()))
[@@FStar.Tactics.postprocess_with (fun _ -> FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ()); noextract_to "krml"; sem_attr] noextract
...
let _ : unit = _ by (FStar.Tactics.print ("env'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let env20 : spec_and_impl_env =
  spec_and_impl_env_extend_typ_with_weak Det.cbor_det_impl env19 (T.pull_name sorted_source19) (T.pull_type sorted_source19) wf20'
let _ : unit = _ by (FStar.Tactics.print ("venv'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let venv20 : Impl.validator_env Det.cbor_det_match env20.si_ast.e_sem_env =
  Impl.extend_validator_env_with_typ_weak venv19 (T.pull_name sorted_source19) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) (T.pull_type sorted_source19) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) validate_true
let _ : unit = _ by (FStar.Tactics.print ("source'"); FStar.Tactics.exact (`()))
[@@FStar.Tactics.postprocess_with (fun _ -> FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ()); noextract_to "krml"; sem_attr] noextract
...
let _ : unit = _ by (FStar.Tactics.print ("env'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let env21 : spec_and_impl_env =
  spec_and_impl_env_extend_typ_with_weak Det.cbor_det_impl env20 (T.pull_name sorted_source20) (T.pull_type sorted_source20) wf21'
let _ : unit = _ by (FStar.Tactics.print ("venv'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let venv21 : Impl.validator_env Det.cbor_det_match env21.si_ast.e_sem_env =
  Impl.extend_validator_env_with_typ_weak venv20 (T.pull_name sorted_source20) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) (T.pull_type sorted_source20) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) validate_nil
let _ : unit = _ by (FStar.Tactics.print ("source'"); FStar.Tactics.exact (`()))
[@@FStar.Tactics.postprocess_with (fun _ -> FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ()); noextract_to "krml"; sem_attr] noextract
...
let _ : unit = _ by (FStar.Tactics.print ("env'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let env22 : spec_and_impl_env =
  spec_and_impl_env_extend_typ_with_weak Det.cbor_det_impl env21 (T.pull_name sorted_source21) (T.pull_type sorted_source21) wf22'
let _ : unit = _ by (FStar.Tactics.print ("venv'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let venv22 : Impl.validator_env Det.cbor_det_match env22.si_ast.e_sem_env =
  Impl.extend_validator_env_with_typ_weak venv21 (T.pull_name sorted_source21) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) (T.pull_type sorted_source21) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) validate_null
let _ : unit = _ by (FStar.Tactics.print ("source'"); FStar.Tactics.exact (`()))
[@@FStar.Tactics.postprocess_with (fun _ -> FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ()); noextract_to "krml"; sem_attr] noextract
...
let _ : unit = _ by (FStar.Tactics.print ("env'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let env23 : spec_and_impl_env =
  spec_and_impl_env_extend_typ_with_weak Det.cbor_det_impl env22 (T.pull_name sorted_source22) (T.pull_type sorted_source22) wf23'
let _ : unit = _ by (FStar.Tactics.print ("venv'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let venv23 : Impl.validator_env Det.cbor_det_match env23.si_ast.e_sem_env =
  Impl.extend_validator_env_with_typ_weak venv22 (T.pull_name sorted_source22) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) (T.pull_type sorted_source22) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) validate_undefined
let _ : unit = _ by (FStar.Tactics.print ("source'"); FStar.Tactics.exact (`()))
[@@FStar.Tactics.postprocess_with (fun _ -> FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ()); noextract_to "krml"; sem_attr] noextract
...
let _ : unit = _ by (FStar.Tactics.print ("env'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let env24 : spec_and_impl_env =
  spec_and_impl_env_extend_typ_with_weak Det.cbor_det_impl env23 (T.pull_name sorted_source23) (T.pull_type sorted_source23) wf24'
let _ : unit = _ by (FStar.Tactics.print ("venv'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let venv24 : Impl.validator_env Det.cbor_det_match env24.si_ast.e_sem_env =
  Impl.extend_validator_env_with_typ_weak venv23 (T.pull_name sorted_source23) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) (T.pull_type sorted_source23) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) validate_any
let _ : unit = _ by (FStar.Tactics.print ("source'"); FStar.Tactics.exact (`()))
[@@FStar.Tactics.postprocess_with (fun _ -> FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ()); noextract_to "krml"; sem_attr] noextract
...
let _ : unit = _ by (FStar.Tactics.print ("env'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let env25 : spec_and_impl_env =
  spec_and_impl_env_extend_typ_with_weak Det.cbor_det_impl env24 (T.pull_name sorted_source24) (T.pull_type sorted_source24) wf25'
let _ : unit = _ by (FStar.Tactics.print ("venv'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let venv25 : Impl.validator_env Det.cbor_det_match env25.si_ast.e_sem_env =
  Impl.extend_validator_env_with_typ_weak venv24 (T.pull_name sorted_source24) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) (T.pull_type sorted_source24) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) validate_values
let _ : unit = _ by (FStar.Tactics.print ("source'"); FStar.Tactics.exact (`()))
[@@FStar.Tactics.postprocess_with (fun _ -> FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ()); noextract_to "krml"; sem_attr] noextract
...
let _ : unit = _ by (FStar.Tactics.print ("env'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let env26 : spec_and_impl_env =
  spec_and_impl_env_extend_typ_with_weak Det.cbor_det_impl env25 (T.pull_name sorted_source25) (T.pull_type sorted_source25) wf26'
let _ : unit = _ by (FStar.Tactics.print ("venv'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let venv26 : Impl.validator_env Det.cbor_det_match env26.si_ast.e_sem_env =
  Impl.extend_validator_env_with_typ_weak venv25 (T.pull_name sorted_source25) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) (T.pull_type sorted_source25) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) validate_header_map
let _ : unit = _ by (FStar.Tactics.print ("source'"); FStar.Tactics.exact (`()))
[@@FStar.Tactics.postprocess_with (fun _ -> FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ()); noextract_to "krml"; sem_attr] noextract
...
let _ : unit = _ by (FStar.Tactics.print ("env'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let env27 : spec_and_impl_env =
  spec_and_impl_env_extend_typ_with_weak Det.cbor_det_impl env26 (T.pull_name sorted_source26) (T.pull_type sorted_source26) wf27'
let _ : unit = _ by (FStar.Tactics.print ("venv'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let venv27 : Impl.validator_env Det.cbor_det_match env27.si_ast.e_sem_env =
  Impl.extend_validator_env_with_typ_weak venv26 (T.pull_name sorted_source26) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) (T.pull_type sorted_source26) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) validate_empty_or_serialized_map
let _ : unit = _ by (FStar.Tactics.print ("source'"); FStar.Tactics.exact (`()))
[@@FStar.Tactics.postprocess_with (fun _ -> FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ()); noextract_to "krml"; sem_attr] noextract
...
let _ : unit = _ by (FStar.Tactics.print ("env'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let env28 : spec_and_impl_env =
  spec_and_impl_env_extend_group env27 (T.pull_name sorted_source27) (T.pull_group sorted_source27) (_ by (FStar.Tactics.norm [delta; iota; zeta; primops]; FStar.Tactics.trefl ())) (_ by (FStar.Tactics.norm [delta; iota; zeta; primops]; FStar.Tactics.trefl ()))
let _ : unit = _ by (FStar.Tactics.print ("venv'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let venv28 : Impl.validator_env Det.cbor_det_match env28.si_ast.e_sem_env =
...
let _ : unit = _ by (FStar.Tactics.print ("env'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let env29 : spec_and_impl_env =
  spec_and_impl_env_extend_typ_with_weak Det.cbor_det_impl env28 (T.pull_name sorted_source28) (T.pull_type sorted_source28) wf29'
let _ : unit = _ by (FStar.Tactics.print ("venv'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let venv29 : Impl.validator_env Det.cbor_det_match env29.si_ast.e_sem_env =
  Impl.extend_validator_env_with_typ_weak venv28 (T.pull_name sorted_source28) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) (T.pull_type sorted_source28) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) validate_COSE_Signature
let _ : unit = _ by (FStar.Tactics.print ("source'"); FStar.Tactics.exact (`()))
[@@FStar.Tactics.postprocess_with (fun _ -> FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ()); noextract_to "krml"; sem_attr] noextract
...
let _ : unit = _ by (FStar.Tactics.print ("env'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let env30 : spec_and_impl_env =
  spec_and_impl_env_extend_typ_with_weak Det.cbor_det_impl env29 (T.pull_name sorted_source29) (T.pull_type sorted_source29) wf30'
let _ : unit = _ by (FStar.Tactics.print ("venv'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let venv30 : Impl.validator_env Det.cbor_det_match env30.si_ast.e_sem_env =
  Impl.extend_validator_env_with_typ_weak venv29 (T.pull_name sorted_source29) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) (T.pull_type sorted_source29) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) validate_COSE_Sign
let _ : unit = _ by (FStar.Tactics.print ("source'"); FStar.Tactics.exact (`()))
[@@FStar.Tactics.postprocess_with (fun _ -> FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ()); noextract_to "krml"; sem_attr] noextract
...
let _ : unit = _ by (FStar.Tactics.print ("env'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let env31 : spec_and_impl_env =
  spec_and_impl_env_extend_typ_with_weak Det.cbor_det_impl env30 (T.pull_name sorted_source30) (T.pull_type sorted_source30) wf31'
let _ : unit = _ by (FStar.Tactics.print ("venv'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let venv31 : Impl.validator_env Det.cbor_det_match env31.si_ast.e_sem_env =
  Impl.extend_validator_env_with_typ_weak venv30 (T.pull_name sorted_source30) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) (T.pull_type sorted_source30) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) validate_COSE_Sign_Tagged
let _ : unit = _ by (FStar.Tactics.print ("source'"); FStar.Tactics.exact (`()))
[@@FStar.Tactics.postprocess_with (fun _ -> FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ()); noextract_to "krml"; sem_attr] noextract
...
let _ : unit = _ by (FStar.Tactics.print ("env'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let env32 : spec_and_impl_env =
  spec_and_impl_env_extend_typ_with_weak Det.cbor_det_impl env31 (T.pull_name sorted_source31) (T.pull_type sorted_source31) wf32'
let _ : unit = _ by (FStar.Tactics.print ("venv'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let venv32 : Impl.validator_env Det.cbor_det_match env32.si_ast.e_sem_env =
  Impl.extend_validator_env_with_typ_weak venv31 (T.pull_name sorted_source31) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) (T.pull_type sorted_source31) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) validate_COSE_Sign1
let _ : unit = _ by (FStar.Tactics.print ("source'"); FStar.Tactics.exact (`()))
[@@FStar.Tactics.postprocess_with (fun _ -> FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ()); noextract_to "krml"; sem_attr] noextract
...
let _ : unit = _ by (FStar.Tactics.print ("env'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let env33 : spec_and_impl_env =
  spec_and_impl_env_extend_typ_with_weak Det.cbor_det_impl env32 (T.pull_name sorted_source32) (T.pull_type sorted_source32) wf33'
let _ : unit = _ by (FStar.Tactics.print ("venv'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let venv33 : Impl.validator_env Det.cbor_det_match env33.si_ast.e_sem_env =
  Impl.extend_validator_env_with_typ_weak venv32 (T.pull_name sorted_source32) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) (T.pull_type sorted_source32) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) validate_COSE_Untagged_Message
let _ : unit = _ by (FStar.Tactics.print ("source'"); FStar.Tactics.exact (`()))
[@@FStar.Tactics.postprocess_with (fun _ -> FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ()); noextract_to "krml"; sem_attr] noextract
...
let _ : unit = _ by (FStar.Tactics.print ("env'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let env34 : spec_and_impl_env =
  spec_and_impl_env_extend_typ_with_weak Det.cbor_det_impl env33 (T.pull_name sorted_source33) (T.pull_type sorted_source33) wf34'
let _ : unit = _ by (FStar.Tactics.print ("venv'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let venv34 : Impl.validator_env Det.cbor_det_match env34.si_ast.e_sem_env =
  Impl.extend_validator_env_with_typ_weak venv33 (T.pull_name sorted_source33) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) (T.pull_type sorted_source33) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) validate_COSE_Sign1_Tagged
let _ : unit = _ by (FStar.Tactics.print ("source'"); FStar.Tactics.exact (`()))
[@@FStar.Tactics.postprocess_with (fun _ -> FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ()); noextract_to "krml"; sem_attr] noextract
...
let _ : unit = _ by (FStar.Tactics.print ("env'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let env35 : spec_and_impl_env =
  spec_and_impl_env_extend_typ_with_weak Det.cbor_det_impl env34 (T.pull_name sorted_source34) (T.pull_type sorted_source34) wf35'
let _ : unit = _ by (FStar.Tactics.print ("venv'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let venv35 : Impl.validator_env Det.cbor_det_match env35.si_ast.e_sem_env =
  Impl.extend_validator_env_with_typ_weak venv34 (T.pull_name sorted_source34) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) (T.pull_type sorted_source34) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) validate_COSE_Tagged_Message
let _ : unit = _ by (FStar.Tactics.print ("source'"); FStar.Tactics.exact (`()))
[@@FStar.Tactics.postprocess_with (fun _ -> FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ()); noextract_to "krml"; sem_attr] noextract
...
let _ : unit = _ by (FStar.Tactics.print ("env'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let env36 : spec_and_impl_env =
  spec_and_impl_env_extend_typ_with_weak Det.cbor_det_impl env35 (T.pull_name sorted_source35) (T.pull_type sorted_source35) wf36'
let _ : unit = _ by (FStar.Tactics.print ("venv'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let venv36 : Impl.validator_env Det.cbor_det_match env36.si_ast.e_sem_env =
  Impl.extend_validator_env_with_typ_weak venv35 (T.pull_name sorted_source35) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) (T.pull_type sorted_source35) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) validate_COSE_Messages
let _ : unit = _ by (FStar.Tactics.print ("source'"); FStar.Tactics.exact (`()))
[@@FStar.Tactics.postprocess_with (fun _ -> FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ()); noextract_to "krml"; sem_attr] noextract
...
let _ : unit = _ by (FStar.Tactics.print ("env'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let env37 : spec_and_impl_env =
  spec_and_impl_env_extend_typ_with_weak Det.cbor_det_impl env36 (T.pull_name sorted_source36) (T.pull_type sorted_source36) wf37'
let _ : unit = _ by (FStar.Tactics.print ("venv'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let venv37 : Impl.validator_env Det.cbor_det_match env37.si_ast.e_sem_env =
  Impl.extend_validator_env_with_typ_weak venv36 (T.pull_name sorted_source36) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) (T.pull_type sorted_source36) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) validate_Sig_structure
let _ : unit = _ by (FStar.Tactics.print ("source'"); FStar.Tactics.exact (`()))
[@@FStar.Tactics.postprocess_with (fun _ -> FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ()); noextract_to "krml"; sem_attr] noextract
...
let _ : unit = _ by (FStar.Tactics.print ("env'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let env38 : spec_and_impl_env =
  spec_and_impl_env_extend_typ_with_weak Det.cbor_det_impl env37 (T.pull_name sorted_source37) (T.pull_type sorted_source37) wf38'
let _ : unit = _ by (FStar.Tactics.print ("venv'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let venv38 : Impl.validator_env Det.cbor_det_match env38.si_ast.e_sem_env =
  Impl.extend_validator_env_with_typ_weak venv37 (T.pull_name sorted_source37) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) (T.pull_type sorted_source37) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) validate_Internal_Types
let _ : unit = _ by (FStar.Tactics.print ("source'"); FStar.Tactics.exact (`()))
[@@FStar.Tactics.postprocess_with (fun _ -> FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ()); noextract_to "krml"; sem_attr] noextract
...
let _ : unit = _ by (FStar.Tactics.print ("env'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let env39 : spec_and_impl_env =
  spec_and_impl_env_extend_typ_with_weak Det.cbor_det_impl env38 (T.pull_name sorted_source38) (T.pull_type sorted_source38) wf39'
let _ : unit = _ by (FStar.Tactics.print ("venv'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let venv39 : Impl.validator_env Det.cbor_det_match env39.si_ast.e_sem_env =
  Impl.extend_validator_env_with_typ_weak venv38 (T.pull_name sorted_source38) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) (T.pull_type sorted_source38) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) validate_start
let _ : unit = _ by (FStar.Tactics.print ("source'"); FStar.Tactics.exact (`()))
[@@FStar.Tactics.postprocess_with (fun _ -> FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ()); noextract_to "krml"; sem_attr] noextract
...
let _ : unit = _ by (FStar.Tactics.print ("env'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let env40 : spec_and_impl_env =
  spec_and_impl_env_extend_typ_with_weak Det.cbor_det_impl env39 (T.pull_name sorted_source39) (T.pull_type sorted_source39) wf40'
let _ : unit = _ by (FStar.Tactics.print ("venv'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let venv40 : Impl.validator_env Det.cbor_det_match env40.si_ast.e_sem_env =
  Impl.extend_validator_env_with_typ_weak venv39 (T.pull_name sorted_source39) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) (T.pull_type sorted_source39) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) validate_eb64url
let _ : unit = _ by (FStar.Tactics.print ("source'"); FStar.Tactics.exact (`()))
[@@FStar.Tactics.postprocess_with (fun _ -> FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ()); noextract_to "krml"; sem_attr] noextract
...
let _ : unit = _ by (FStar.Tactics.print ("env'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let env41 : spec_and_impl_env =
  spec_and_impl_env_extend_typ_with_weak Det.cbor_det_impl env40 (T.pull_name sorted_source40) (T.pull_type sorted_source40) wf41'
let _ : unit = _ by (FStar.Tactics.print ("venv'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let venv41 : Impl.validator_env Det.cbor_det_match env41.si_ast.e_sem_env =
  Impl.extend_validator_env_with_typ_weak venv40 (T.pull_name sorted_source40) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) (T.pull_type sorted_source40) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) validate_eb64legacy
let _ : unit = _ by (FStar.Tactics.print ("source'"); FStar.Tactics.exact (`()))
[@@FStar.Tactics.postprocess_with (fun _ -> FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ()); noextract_to "krml"; sem_attr] noextract
...
let _ : unit = _ by (FStar.Tactics.print ("env'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let env42 : spec_and_impl_env =
  spec_and_impl_env_extend_typ_with_weak Det.cbor_det_impl env41 (T.pull_name sorted_source41) (T.pull_type sorted_source41) wf42'
let _ : unit = _ by (FStar.Tactics.print ("venv'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let venv42 : Impl.validator_env Det.cbor_det_match env42.si_ast.e_sem_env =
  Impl.extend_validator_env_with_typ_weak venv41 (T.pull_name sorted_source41) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) (T.pull_type sorted_source41) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) validate_eb16
let _ : unit = _ by (FStar.Tactics.print ("source'"); FStar.Tactics.exact (`()))
[@@FStar.Tactics.postprocess_with (fun _ -> FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ()); noextract_to "krml"; sem_attr] noextract
...
let _ : unit = _ by (FStar.Tactics.print ("env'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let env43 : spec_and_impl_env =
  spec_and_impl_env_extend_typ_with_weak Det.cbor_det_impl env42 (T.pull_name sorted_source42) (T.pull_type sorted_source42) wf43'
let _ : unit = _ by (FStar.Tactics.print ("venv'"); FStar.Tactics.exact (`()))
[@@noextract_to "krml"; sem_attr] noextract
let venv43 : Impl.validator_env Det.cbor_det_match env43.si_ast.e_sem_env =
  Impl.extend_validator_env_with_typ_weak venv42 (T.pull_name sorted_source42) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) (T.pull_type sorted_source42) (_ by (FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ())) validate_cborany
let _ : unit = _ by (FStar.Tactics.print ("source'"); FStar.Tactics.exact (`()))
[@@FStar.Tactics.postprocess_with (fun _ -> FStar.Tactics.norm [delta; zeta; iota; primops]; FStar.Tactics.trefl ()); noextract_to "krml"; sem_attr] noextract
...
Verified module: CDDLTest
All verification conditions discharged successfully
touch -c CDDLTest.fst.checked
