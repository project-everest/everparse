                   ...
                   | () ->
                       (fun ps1 ->
                          apply
                            ...
                            ps1;
                          exact x ps1)) (fun uu___1 -> __assumption_aux bs1))
           ps)
              ...
              (fun ps ->
                 let x1 =
                   FStar_Reflection_V1_Formula.term_as_formula
                     (FStar_Reflection_V1_Derived.type_of_binder x_t) ps in
                 match x1 with
                 | FStar_Reflection_V1_Formula.Comp
                 ...
                 | uu___ -> try_rewrite_equality x bs1 ps))) uu___1 uu___
                                ...
                                | FStar_Reflection_V1_Formula.Implies 
                                    ...
                                    (apply_lemma
                                     ...
                                     apply_squash_or_lem (d - Prims.int_one)
                                       t ps)
                                | uu___5 -> fail "mapply: can't apply (1)" ps)
           ...
           (Obj.repr
              (fun ps ->
                 ...
                 FStarC_Tactics_V1_Builtins.pack
                   (FStarC_Reflection_V1_Data.Tv_Abs (a, x)) ps))) uu___1
    uu___
    ...
    let x1 =
      FStar_Tactics_Util.fold_left
        (fun uu___ uu___1 ->
           ...
           | ((e1, lb_bvs), (i, v)) ->
               (fun ps1 ->
                  let x2 = FStarC_Tactics_V1_Builtins.push_bv_dsenv e1 i ps1 in
                  match x2 with | (e2, bv) -> (e2, ((v, bv) :: lb_bvs))))
        (e, []) letbindings ps in
    match x1 with
    | (e1, lb_bvs) ->
