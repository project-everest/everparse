                 ...
                 let x =
                   let x1 =
                     ...
                     | FStar_Pervasives_Native.Some t ->
                         let x2 =
                           let x3 =
                             FStarC_Tactics_V2_Builtins.term_to_string t ps in
                           Prims.strcat x3 ")" in
                         Prims.strcat " (" x2 in
                   let x2 =
                     let x3 =
                       let x4 =
                         FStarC_Tactics_V2_Builtins.term_to_string l ps in
                       let x5 =
                         let x6 =
                           let x7 =
                             FStarC_Tactics_V2_Builtins.term_to_string r ps in
                           Prims.strcat x7 ")" in
                         Prims.strcat ") (" x6 in
              ...
              (fun ps ->
                 let x =
                   ...
                   let x2 =
                     let x3 =
                       let x4 =
                         FStarC_Tactics_V2_Builtins.term_to_string q ps in
                       Prims.strcat x4 ")" in
                     Prims.strcat ") (" x3 in
                   Prims.strcat x1 x2 in
                 Prims.strcat "And (" x))
     ...
     | Name bv ->
         Obj.magic
           (Obj.repr
              (fun ps ->
                 let x =
                   let x1 = namedv_to_string bv ps in Prims.strcat x1 ")" in
                 Prims.strcat "Name (" x))
     | FV fv ->
         Obj.magic
           (Obj.repr
