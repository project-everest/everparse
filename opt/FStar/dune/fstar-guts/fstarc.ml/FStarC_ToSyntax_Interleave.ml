  ...
  | FStarC_Parser_AST.Tycon (uu___, uu___1, tys) ->
      FStarC_Util.for_some
        (fun t ->
           ...
           let uu___3 = FStarC_Ident.string_of_id x in uu___2 = uu___3) tys
  | uu___ -> false
       ...
       | FStarC_Parser_AST.Splice (uu___, x::[], uu___1) ->
           ...
           then
                 ...
                 FStarC_Util.for_some
                   (fun y ->
                      let uu___4 =
                        ...
                        is_val uu___5 in
                      FStarC_Util.for_some uu___4 iface_tl) def_ids in
               if uu___3
               then
                 let uu___4 =
                   let uu___5 =
                     let uu___6 =
                       FStarC_Errors_Msg.text "Expected the definition of" in
                     let uu___7 =
                       let uu___8 =
                         FStarC_Class_PP.pp FStarC_Ident.pretty_ident x in
                       let uu___9 =
                         let uu___10 = FStarC_Errors_Msg.text "to precede" in
                         let uu___11 =
                           FStarC_Class_PP.pp
             ...
             (let mutually_defined_with_x =
                FStarC_List.filter
                  (fun y ->
                     let uu___3 = id_eq_lid x y in Prims.op_Negation uu___3)
                  def_ids in
                ...
                | (y::ys, iface_hd1::iface_tl1) when
                    let uu___3 =
                      let uu___4 =
                        let uu___5 = FStarC_Ident.ident_of_lid y in
                        is_val uu___5 in
                      FStarC_List.tryFind uu___4 iface_tl1 in
       ...
       | FStarC_Parser_AST.Val (x, uu___) ->
           ...
           then
                 ...
                 FStarC_Util.for_some
                   (fun y ->
                      let uu___3 =
                        ...
                        is_val uu___4 in
                      FStarC_Util.for_some uu___3 iface_tl) def_ids in
               if uu___2
               then
                 let uu___3 =
                   let uu___4 =
             ...
             (let mutually_defined_with_x =
                FStarC_List.filter
                  (fun y ->
                     let uu___2 = id_eq_lid x y in Prims.op_Negation uu___2)
                  def_ids in
              let rec aux mutuals iface1 =
                match (mutuals, iface1) with
                | ([], uu___2) -> ([], iface1)
                ...
                | (y::ys, iface_hd1::iface_tl1) when
                    let uu___2 =
                      let uu___3 =
                        let uu___4 = FStarC_Ident.ident_of_lid y in
                        is_val uu___4 in
                      FStarC_List.tryFind uu___3 iface_tl1 in
...
let ml_mode_prefix_with_iface_decls
  (iface : FStarC_Parser_AST.decl Prims.list) (impl : FStarC_Parser_AST.decl)
  : (FStarC_Parser_AST.decl Prims.list * FStarC_Parser_AST.decl Prims.list)=
  ...
  | FStarC_Parser_AST.TopLevelModule uu___ ->
      ...
      (match uu___1 with
       | (iface_prefix_opens, iface1) ->
           ...
           (iface2, (FStarC_List.op_At [impl] iface_prefix_opens)))
           ...
           (match impl.FStarC_Parser_AST.d with
            | FStarC_Parser_AST.TopLevelLet uu___2 ->
                ...
                (match uu___3 with
                 | (val_xs, rest_iface) ->
                     (rest_iface,
                       (FStarC_List.op_At iface_prefix_tycons
                          (FStarC_List.op_At val_xs [impl]))))
                 ...
                 | (val_xs, rest_iface) ->
                     (rest_iface,
                       (FStarC_List.op_At iface_prefix_tycons
                          (FStarC_List.op_At val_xs [impl]))))
            | uu___2 ->
                (iface1, (FStarC_List.op_At iface_prefix_tycons [impl]))))
let ml_mode_check_initial_interface (mname : 'uuuuu)
  (iface : FStarC_Parser_AST.decl Prims.list) :
  FStarC_Parser_AST.decl Prims.list=
  FStarC_List.filter
    (fun d ->
       match d.FStarC_Parser_AST.d with
       ...
       | uu___ -> false) iface
let prefix_one_decl (mname : 'uuuuu)
  (iface : FStarC_Parser_AST.decl Prims.list) (impl : FStarC_Parser_AST.decl)
  : (FStarC_Parser_AST.decl Prims.list * FStarC_Parser_AST.decl Prims.list)=
  match impl.FStarC_Parser_AST.d with
...
let prefix_with_interface_decls (mname : FStarC_Ident.lident)
  (impl : FStarC_Parser_AST.decl) :
