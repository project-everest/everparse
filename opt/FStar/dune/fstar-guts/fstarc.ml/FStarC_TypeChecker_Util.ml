...
let new_implicit_var (reason : Prims.string) (r : FStarC_Range_Type.t)
  ...
  (FStarC_Syntax_Syntax.term * (FStarC_Syntax_Syntax.ctx_uvar *
    FStarC_Range_Type.t) * FStarC_TypeChecker_Env.guard_t)=
...
let extract_let_rec_annotation (env : FStarC_TypeChecker_Env.env)
  (uu___ : FStarC_Syntax_Syntax.letbinding) :
           ...
           ((let uu___6 = FStarC_Effect.op_Bang dbg_Dec in
            ...
            (let env1 = FStarC_TypeChecker_Env.push_univ_vars env univ_vars1 in
             ...
             let reconcile_let_rec_ascription_and_body_type tarr lbtyp_opt =
               let get_decreases c =
                 let uu___6 = FStarC_Syntax_Util.comp_flags c in
                 FStarC_Util.prefix_until
                   (fun uu___7 ->
                      match uu___7 with
                      | FStarC_Syntax_Syntax.DECREASES uu___8 -> true
                      | uu___8 -> false) uu___6 in
               let fallback uu___6 =
                              ...
                              (let move_decreases d flags flags' =
                               ...
                               | (FStar_Pervasives_Native.Some
                                  ...
                                  FStar_Pervasives_Native.None) ->
                                   ...
                                   move_decreases d
                                     (FStarC_List.op_At pfx sfx) uu___10
             ...
             let extract_annot_from_body lbtyp_opt =
               let rec aux_lbdef e2 =
                 ...
                 | FStarC_Syntax_Syntax.Tm_ascribed
                     ...
                     then
                       let uu___7 =
                         let uu___8 = FStarC_Syntax_Util.comp_result c in
                         reconcile_let_rec_ascription_and_body_type uu___8
                           lbtyp_opt in
                       (match uu___7 with
                        | (t3, lbtyp, recheck) ->
                            let e4 =
                       ...
                       let uu___9 =
                         let uu___10 =
                           ...
                           let uu___12 =
                             ...
                             let uu___14 = FStarC_Errors_Msg.text "instead" in
...
let destruct_wp_comp (c : FStarC_Syntax_Syntax.comp_typ) :
  (FStarC_Syntax_Syntax.universe * FStarC_Syntax_Syntax.typ *
    FStarC_Syntax_Syntax.typ)=
  FStarC_Syntax_Util.destruct_comp c
let mk_comp_l (mname : FStarC_Ident.lident)
  ...
  (wp : FStarC_Syntax_Syntax.term)
  (flags : FStarC_Syntax_Syntax.cflag Prims.list) :
  FStarC_Syntax_Syntax.comp=
  let uu___ =
    let uu___1 = let uu___2 = FStarC_Syntax_Syntax.as_arg wp in [uu___2] in
    {
...
let effect_args_from_repr (repr : FStarC_Syntax_Syntax.term)
  (is_layered : Prims.bool) (r : FStarC_Range_Type.t) :
  ...
  then
    ...
    (match repr1.FStarC_Syntax_Syntax.n with
     ...
     | uu___1 -> err ())
let mk_wp_return (env : FStarC_TypeChecker_Env.env)
  (ed : FStarC_Syntax_Syntax.eff_decl) (u_a : FStarC_Syntax_Syntax.universe)
  (a : FStarC_Syntax_Syntax.typ) (e : FStarC_Syntax_Syntax.term)
  (r : FStarC_Range_Type.t) : FStarC_Syntax_Syntax.comp=
  let c =
    let uu___ =
      let uu___1 =
       ...
       then FStarC_Syntax_Syntax.mk_Total a
         ...
         (let wp =
            ...
            then FStarC_Syntax_Syntax.tun
              ...
              (let ret_wp = FStarC_Syntax_Util.get_return_vc_combinator ed in
               let uu___6 =
                 FStarC_TypeChecker_Env.inst_effect_fun_with [u_a] env ed
                   ret_wp in
               let uu___7 =
                 let uu___8 = FStarC_Syntax_Syntax.as_arg a in
                 let uu___9 =
                   let uu___10 = FStarC_Syntax_Syntax.as_arg e in [uu___10] in
                 uu___8 :: uu___9 in
  ...
  (let uu___1 = FStarC_Effect.op_Bang dbg_Return in
   if uu___1
   then
     let uu___2 = FStarC_Range_Ops.string_of_range e.FStarC_Syntax_Syntax.pos in
     let uu___3 = FStarC_Class_Show.show FStarC_Syntax_Print.showable_term e in
     let uu___4 = FStarC_TypeChecker_Normalize.comp_to_string env c in
     FStarC_Format.print3 "(%s) returning %s at comp type %s\n" uu___2 uu___3
       uu___4
   else ());
  c
...
let label_opt (env : FStarC_TypeChecker_Env.env)
  ...
  | FStar_Pervasives_Native.Some reason1 ->
      let uu___ =
        ...
        Prims.op_Negation uu___1 in
      if uu___ then f else (let uu___2 = reason1 () in label uu___2 r f)
...
let lift_comp (env : FStarC_TypeChecker_Env.env)
  (c : FStarC_Syntax_Syntax.comp_typ) (lift : FStarC_TypeChecker_Env.mlift) :
  (FStarC_Syntax_Syntax.comp * FStarC_TypeChecker_Env.guard_t)=
  let uu___ =
    FStarC_Syntax_Syntax.mk_Comp
      {
        FStarC_Syntax_Syntax.comp_univs = (c.FStarC_Syntax_Syntax.comp_univs);
        FStarC_Syntax_Syntax.effect_name =
          (c.FStarC_Syntax_Syntax.effect_name);
        FStarC_Syntax_Syntax.result_typ = (c.FStarC_Syntax_Syntax.result_typ);
           ...
           let uu___2 =
             ...
             then lift_comp env2 c21 lift2
               ...
               (let x_a =
                  match b with
                  | FStar_Pervasives_Native.None ->
                      let uu___4 = FStarC_Syntax_Util.comp_result c12 in
                      FStarC_Syntax_Syntax.null_binder uu___4
                  | FStar_Pervasives_Native.Some x ->
                      FStarC_Syntax_Syntax.mk_binder x in
                let env_x = FStarC_TypeChecker_Env.push_binders env [x_a] in
                let uu___4 = lift_comp env_x c21 lift2 in
                match uu___4 with
                | (c22, g2) ->
                    let uu___5 =
                      FStarC_TypeChecker_Env.close_guard env [x_a] g2 in
                    (c22, uu___5)) in
            ...
            let uu___6 =
              ...
              let uu___8 =
                let uu___9 =
                  FStarC_Class_PP.pp FStarC_Ident.pretty_lident
                    c21.FStarC_Syntax_Syntax.effect_name in
                let uu___10 = FStarC_Errors_Msg.text "cannot be composed" in
                FStar_Pprint.op_Hat_Slash_Hat uu___9 uu___10 in
              FStar_Pprint.op_Hat_Slash_Hat uu___7 uu___8 in
            FStar_Pprint.op_Hat_Slash_Hat uu___5 uu___6 in
          FStar_Pprint.op_Hat_Slash_Hat uu___3 uu___4 in
...
let is_pure_or_ghost_effect (env : FStarC_TypeChecker_Env.env)
  ...
  (FStarC_Ident.lid_equals l1 FStarC_Parser_Const.effect_PURE_lid) ||
    (FStarC_Ident.lid_equals l1 FStarC_Parser_Const.effect_GHOST_lid)
let lax_mk_tot_or_comp_l (mname : FStarC_Ident.lident)
  (u_result : FStarC_Syntax_Syntax.universe)
  (result : FStarC_Syntax_Syntax.term' FStarC_Syntax_Syntax.syntax)
  (flags : FStarC_Syntax_Syntax.cflag Prims.list) :
  FStarC_Syntax_Syntax.comp=
...
let is_function (t : FStarC_Syntax_Syntax.term) : Prims.bool=
  let uu___ =
...
let close_wp_comp (env : FStarC_TypeChecker_Env.env)
  ...
  (let uu___1 = FStarC_Syntax_Util.is_ml_comp c in
   ...
   then c
     ...
     (let uu___3 = (FStarC_Options.lax ()) && (FStarC_Options.ml_ish ()) in
      if uu___3
      then c
      else
        (let env_bvs = FStarC_TypeChecker_Env.push_bvs env bvs in
           ...
           FStarC_List.fold_right
             (fun x wp ->
                ...
                let wp1 =
                  ...
                  FStarC_Syntax_Util.abs bs wp uu___5 in
                let uu___5 =
                  FStarC_TypeChecker_Env.inst_effect_fun_with us env md close in
                let uu___6 =
                  let uu___7 = FStarC_Syntax_Syntax.as_arg res_t in
                  let uu___8 =
                    let uu___9 =
                      FStarC_Syntax_Syntax.as_arg x.FStarC_Syntax_Syntax.sort in
                    let uu___10 =
         ...
         | (u_res_t, res_t, wp) ->
             ...
             mk_comp md u_res_t c1.FStarC_Syntax_Syntax.result_typ wp1 uu___6)))
...
let substitutive_indexed_close_substs (env : FStarC_TypeChecker_Env.env)
  (close_bs : FStarC_Syntax_Syntax.binders) (a : FStarC_Syntax_Syntax.typ)
  (b_bv : FStarC_Syntax_Syntax.bv) (ct_args : FStarC_Syntax_Syntax.args)
  (num_effect_params : Prims.int) (r : FStarC_Range_Type.t) :
  FStarC_Syntax_Syntax.subst_elt Prims.list=
  let debug = FStarC_Effect.op_Bang dbg_LayeredEffectsApp in
  let uu___ =
    let uu___1 = close_bs in
    match uu___1 with
    | a_b::b_b::close_bs1 ->
        (close_bs1,
          [FStarC_Syntax_Syntax.NT ((a_b.FStarC_Syntax_Syntax.binder_bv), a);
  ...
  | (close_bs1, subst) ->
      let uu___1 =
        let uu___2 = FStarC_List.splitAt num_effect_params close_bs1 in
        match uu___2 with
        | (eff_params_bs, close_bs2) ->
            let uu___3 = FStarC_List.splitAt num_effect_params ct_args in
            (match uu___3 with
                   ...
                   let uu___5 =
                     FStarC_List.map2
                       (fun b uu___6 ->
                          ...
                          | (arg, uu___7) ->
                              FStarC_Syntax_Syntax.NT
                                ((b.FStarC_Syntax_Syntax.binder_bv), arg))
                       eff_params_bs ct_eff_params_args in
                   FStarC_List.op_At subst uu___5 in
                 (close_bs2, uu___4, ct_args1)) in
      (match uu___1 with
       | (close_bs2, subst1, ct_args1) ->
           let uu___2 =
             FStarC_List.splitAt
               ((FStarC_List.length close_bs2) - Prims.int_one) close_bs2 in
           (match uu___2 with
            | (close_bs3, uu___3) ->
                           ...
                           let uu___7 =
                             let uu___8 =
                               let uu___9 =
                                 let uu___10 =
                                   let uu___11 =
                                     FStarC_Syntax_Syntax.mk_binder b_bv in
                                   [uu___11] in
                                 FStarC_Syntax_Util.abs uu___10 ct_arg
                                   FStar_Pervasives_Native.None in
                               ((b.FStarC_Syntax_Syntax.binder_bv), uu___9) in
                             FStarC_Syntax_Syntax.NT uu___8 in
                           [uu___7] in
                         FStarC_List.op_At ss uu___6) subst1 close_bs3
                  ct_args1))
let close_layered_comp_with_combinator (env : FStarC_TypeChecker_Env.env)
  (bvs : FStarC_Syntax_Syntax.bv Prims.list) (c : FStarC_Syntax_Syntax.comp)
  : FStarC_Syntax_Syntax.comp=
  ...
  let num_effect_params =
    ...
    | uu___ ->
        FStarC_Errors.raise_error FStarC_Class_HasRange.hasRange_range r
          FStarC_Errors_Codes.Fatal_UnexpectedEffect ()
          (Obj.magic FStarC_Errors_Msg.is_error_message_string)
          (Obj.magic "mk_indexed_close called with a non-indexed effect") in
  let close_ts =
  ...
  let effect_args =
    FStarC_List.fold_right
      (fun x args ->
         let u_a = FStarC_List.hd ct.FStarC_Syntax_Syntax.comp_univs in
         let u_b =
           env.FStarC_TypeChecker_Env.universe_of env_bvs
             x.FStarC_Syntax_Syntax.sort in
         let uu___ =
           FStarC_TypeChecker_Env.inst_tscheme_with close_ts [u_a; u_b] in
         match uu___ with
         | (uu___1, close_t) ->
             ...
             (match uu___2 with
              | (close_bs, close_body, uu___3) ->
                  let ss =
                    substitutive_indexed_close_substs env_bvs close_bs
                      ct.FStarC_Syntax_Syntax.result_typ x args
                      num_effect_params r in
                  let uu___4 =
                    let uu___5 =
                      let uu___6 = FStarC_Syntax_Subst.subst ss close_body in
                  ...
                  (match uu___4 with
                   ...
                   | uu___5 ->
                       FStarC_Errors.raise_error
                         ...
                         FStarC_Errors_Codes.Fatal_UnexpectedEffect ()
                         (Obj.magic FStarC_Errors_Msg.is_error_message_string)
                         (Obj.magic "Unexpected close combinator shape"))))
      bvs ct.FStarC_Syntax_Syntax.effect_args in
  FStarC_Syntax_Syntax.mk_Comp
    {
      FStarC_Syntax_Syntax.comp_univs = (ct.FStarC_Syntax_Syntax.comp_univs);
      FStarC_Syntax_Syntax.effect_name =
        (ct.FStarC_Syntax_Syntax.effect_name);
      FStarC_Syntax_Syntax.result_typ = (ct.FStarC_Syntax_Syntax.result_typ);
...
let should_return (env : FStarC_TypeChecker_Env.env)
  ...
  let lc_is_unit_or_effectful =
    ...
    then
      let c_eff_name =
        let uu___1 = FStarC_Syntax_Util.comp_effect_name c in
        FStarC_TypeChecker_Env.norm_eff_name env uu___1 in
      let uu___1 =
      ...
      (let uu___2 = FStarC_Syntax_Util.is_pure_or_ghost_comp c in
       ...
       then
         let uu___3 =
           ...
           FStarC_TypeChecker_Normalize.unfold_whnf env uu___4 in
...
let substitutive_indexed_bind_substs (env : FStarC_TypeChecker_Env.env)
  (m_ed : FStarC_Syntax_Syntax.eff_decl)
  (n_ed : FStarC_Syntax_Syntax.eff_decl)
  (p_ed : FStarC_Syntax_Syntax.eff_decl) (bs : FStarC_Syntax_Syntax.binders)
  (binder_kinds : FStarC_Syntax_Syntax.indexed_effect_binder_kind Prims.list)
  (ct1 : FStarC_Syntax_Syntax.comp_typ)
  (b : FStarC_Syntax_Syntax.bv FStar_Pervasives_Native.option)
  (ct2 : FStarC_Syntax_Syntax.comp_typ) (r1 : FStarC_Range_Type.t)
  (num_effect_params : Prims.int) (has_range_binders : Prims.bool) :
  (FStarC_Syntax_Syntax.subst_elt Prims.list *
    FStarC_TypeChecker_Env.guard_t)=
  let debug = FStarC_Effect.op_Bang dbg_LayeredEffectsApp in
  let bind_name uu___ =
    ...
    then
      let uu___1 =
        let uu___2 =
          FStarC_Ident.ident_of_lid m_ed.FStarC_Syntax_Syntax.mname in
        FStarC_Ident.string_of_id uu___2 in
      let uu___2 =
        let uu___3 =
          FStarC_Ident.ident_of_lid n_ed.FStarC_Syntax_Syntax.mname in
        FStarC_Ident.string_of_id uu___3 in
      let uu___3 =
        let uu___4 =
          FStarC_Ident.ident_of_lid p_ed.FStarC_Syntax_Syntax.mname in
  ...
  let uu___ =
    ...
    | a_b::b_b::bs1 ->
        let uu___2 =
          let uu___3 = FStarC_List.splitAt (Prims.of_int (2)) binder_kinds in
  ...
  | (bs1, binder_kinds1, subst) ->
      let uu___1 =
        ...
        then
          (bs1, binder_kinds1, subst, FStarC_TypeChecker_Env.trivial_guard,
           ...
           | (eff_params_bs, bs2) ->
               ...
               (match uu___4 with
                | (uu___5, binder_kinds2) ->
                    let uu___6 = split ct1.FStarC_Syntax_Syntax.effect_args in
                    (match uu___6 with
                     | (param_args1, args1) ->
                         let uu___7 =
                           split ct2.FStarC_Syntax_Syntax.effect_args in
                         (match uu___7 with
                          | (param_args2, args2) ->
                              let g =
                                FStarC_List.fold_left2
                                  (fun g1 uu___8 uu___9 ->
                                     match (uu___8, uu___9) with
                                     | ((arg1, uu___10), (arg2, uu___11)) ->
                                         let uu___12 =
                              ...
                              (bs2, binder_kinds2,
                                (FStarC_List.op_At subst param_subst), g,
                                args1, args2))))) in
      (match uu___1 with
       | (bs2, binder_kinds2, subst1, guard, args1, args2) ->
           let uu___2 =
             let m_num_effect_args = FStarC_List.length args1 in
             let uu___3 = FStarC_List.splitAt m_num_effect_args bs2 in
             match uu___3 with
             | (f_bs, bs3) ->
                 let f_subst =
                   FStarC_List.map2
                     (fun f_b arg ->
                        FStarC_Syntax_Syntax.NT
                          ((f_b.FStarC_Syntax_Syntax.binder_bv),
                            (FStar_Pervasives_Native.fst arg))) f_bs args1 in
                 let uu___4 =
                   let uu___5 =
                     FStarC_List.splitAt m_num_effect_args binder_kinds2 in
                   FStar_Pervasives_Native.snd uu___5 in
                 (bs3, uu___4, (FStarC_List.op_At subst1 f_subst)) in
           (match uu___2 with
            | (bs3, binder_kinds3, subst2) ->
                let uu___3 =
                  let n_num_effect_args = FStarC_List.length args2 in
                  let uu___4 = FStarC_List.splitAt n_num_effect_args bs3 in
                  match uu___4 with
                  | (g_bs, bs4) ->
                      let g_bs_kinds =
                        let uu___5 =
                          FStarC_List.splitAt n_num_effect_args binder_kinds3 in
                      ...
                      let uu___5 =
                        let uu___6 = FStarC_List.zip g_bs g_bs_kinds in
                        FStarC_List.fold_left2
                          (fun uu___7 uu___8 arg ->
                             ...
                             | ((ss, g), (g_b, g_b_kind)) ->
                                 ...
                                 then
                                   let arg_t =
                                     let uu___9 =
                                       let uu___10 =
                                         FStarC_Syntax_Syntax.mk_binder x_bv in
                                       [uu___10] in
                                     FStarC_Syntax_Util.abs uu___9
                          ...
                          (subst2, guard) uu___6 args2 in
                      (match uu___5 with
                       | (subst3, guard1) -> (bs4, subst3, guard1)) in
                (match uu___3 with
                 | (bs4, subst3, guard1) ->
                     let bs5 =
                       ...
                       then
                         let uu___4 =
                           FStarC_List.splitAt (Prims.of_int (2)) bs4 in
                         FStar_Pervasives_Native.snd uu___4
                       else bs4 in
                     let bs6 =
                       let uu___4 =
                         FStarC_List.splitAt
                           ((FStarC_List.length bs5) - (Prims.of_int (2)))
                           bs5 in
                       ...
                       (fun uu___4 b1 ->
                          ...
                          | (ss, g) ->
                              ...
                              (match uu___5 with
                               | (uv_t::[], g_uv) ->
                                   let uu___6 =
                                     FStarC_TypeChecker_Env.conj_guard g g_uv in
                                   ((FStarC_List.op_At ss
                                       [FStarC_Syntax_Syntax.NT
                                          ((b1.FStarC_Syntax_Syntax.binder_bv),
                                            uv_t)]), uu___6)))
                       (subst3, guard1) bs6)))
let ad_hoc_indexed_bind_substs (env : FStarC_TypeChecker_Env.env)
  (m_ed : FStarC_Syntax_Syntax.eff_decl)
  (n_ed : FStarC_Syntax_Syntax.eff_decl)
  (p_ed : FStarC_Syntax_Syntax.eff_decl) (bs : FStarC_Syntax_Syntax.binders)
  (ct1 : FStarC_Syntax_Syntax.comp_typ)
  ...
  let bind_t_shape_error r s =
    let uu___ =
      ...
      FStarC_Format.fmt2 "bind %s does not have proper shape (reason:%s)"
        uu___1 s in
    FStarC_Errors.raise_error FStarC_Class_HasRange.hasRange_range r
      FStarC_Errors_Codes.Fatal_UnexpectedEffect ()
      (Obj.magic FStarC_Errors_Msg.is_error_message_string) (Obj.magic uu___) in
  let num_range_binders =
    if has_range_binders then (Prims.of_int (2)) else Prims.int_zero in
  let uu___ =
    if (FStarC_List.length bs) >= (num_range_binders + (Prims.of_int (4)))
    then
      let uu___1 = bs in
      match uu___1 with
      | a_b::b_b::bs1 ->
          let uu___2 =
            let uu___3 =
              FStarC_List.splitAt
                (((FStarC_List.length bs1) - (Prims.of_int (2))) -
                   num_range_binders) bs1 in
            match uu___3 with
            | (l1, l2) ->
                let uu___4 = FStarC_List.splitAt num_range_binders l2 in
                (match uu___4 with
                 | (uu___5, l21) ->
                     let uu___6 = FStarC_List.hd l21 in
                     let uu___7 =
                       let uu___8 = FStarC_List.tl l21 in
                       FStarC_List.hd uu___8 in
                     (l1, uu___6, uu___7)) in
          (match uu___2 with
           | (rest_bs, f_b, g_b) -> (a_b, b_b, rest_bs, f_b, g_b))
      ...
      let uu___1 =
        FStarC_TypeChecker_Env.uvars_for_binders env rest_bs
          ...
          (fun b1 ->
             ...
             then
               let uu___2 =
                 FStarC_Class_Show.show FStarC_Syntax_Print.showable_binder
                   b1 in
               let uu___3 = bind_name () in
               let uu___4 = FStarC_Range_Ops.string_of_range r1 in
               FStarC_Format.fmt3 "implicit var for binder %s of %s at %s"
           ...
           ((let uu___3 = FStarC_Effect.op_Bang dbg_ResolveImplicitsHook in
               ...
               FStarC_List.iter
                 (fun t ->
                    let uu___4 =
                      ...
                      uu___5.FStarC_Syntax_Syntax.n in
                    match uu___4 with
                    | FStarC_Syntax_Syntax.Tm_uvar (u, uu___5) ->
                        let uu___6 =
                          FStarC_Class_Show.show
                    ...
                    | uu___5 ->
                        let uu___6 =
                          let uu___7 =
                            FStarC_Class_Show.show
                              FStarC_Syntax_Print.showable_term t in
                          Prims.strcat "Impossible, expected a uvar, got : "
                            uu___7 in
            ...
            (let subst =
               FStarC_List.map2
                 (fun b1 t ->
                    FStarC_Syntax_Syntax.NT
                      ((b1.FStarC_Syntax_Syntax.binder_bv), t)) (a_b :: b_b
                 :: rest_bs) ((ct1.FStarC_Syntax_Syntax.result_typ) ::
             ...
             let f_guard =
               let f_sort_is =
                 let uu___3 =
                   ...
                   let uu___5 = FStarC_Syntax_Util.is_layered m_ed in
                   effect_args_from_repr uu___4 uu___5 r1 in
                 FStarC_List.map (FStarC_Syntax_Subst.subst subst) uu___3 in
               let uu___3 =
                 ...
                 (fun g i1 f_i1 ->
                    (let uu___5 =
                     ...
                     then
                       let uu___6 =
                         FStarC_Class_Show.show
                           FStarC_Syntax_Print.showable_term i1 in
                       let uu___7 =
                         FStarC_Class_Show.show
                           FStarC_Syntax_Print.showable_term f_i1 in
                       FStarC_Format.print2 "Generating constraint %s = %s\n"
                         uu___6 uu___7
                     else ());
                    (let uu___5 =
                       let uu___6 =
                       ...
                       FStarC_TypeChecker_Rel.layered_effect_teq env i1 f_i1
                         uu___6 in
                     FStarC_TypeChecker_Env.conj_guard g uu___5))
                 FStarC_TypeChecker_Env.trivial_guard uu___3 f_sort_is in
             let g_guard =
               let x_a =
                 match b with
                 | FStar_Pervasives_Native.None ->
               ...
               let g_sort_is =
                 ...
                 | FStarC_Syntax_Syntax.Tm_arrow
                     { FStarC_Syntax_Syntax.bs1 = bs1;
                       FStarC_Syntax_Syntax.comp = c;_}
                     ->
                     let uu___4 = FStarC_Syntax_Subst.open_comp bs1 c in
                     (match uu___4 with
                      | (bs2, c1) ->
                          let bs_subst =
                            let uu___5 =
                              let uu___6 =
                                let uu___7 = FStarC_List.hd bs2 in
                                uu___7.FStarC_Syntax_Syntax.binder_bv in
                              let uu___7 =
                                FStarC_Syntax_Syntax.bv_to_name
                                  x_a.FStarC_Syntax_Syntax.binder_bv in
                              (uu___6, uu___7) in
                            FStarC_Syntax_Syntax.NT uu___5 in
                          let c2 =
                            FStarC_Syntax_Subst.subst_comp [bs_subst] c1 in
                          let uu___5 =
                            let uu___6 =
                              let uu___7 = FStarC_Syntax_Util.comp_result c2 in
                              FStarC_Syntax_Subst.compress uu___7 in
                            let uu___7 = FStarC_Syntax_Util.is_layered n_ed in
                            effect_args_from_repr uu___6 uu___7 r1 in
                          FStarC_List.map (FStarC_Syntax_Subst.subst subst)
                            uu___5)
                 | uu___4 -> failwith "impossible: mk_indexed_bind" in
               let env_g = FStarC_TypeChecker_Env.push_binders env [x_a] in
               let uu___3 =
                 let uu___4 =
                   FStarC_List.map FStar_Pervasives_Native.fst
                   ...
                   (fun g i1 g_i1 ->
                      (let uu___6 =
                       ...
                       then
                         ...
                         let uu___8 =
                           FStarC_Class_Show.show
                             FStarC_Syntax_Print.showable_term g_i1 in
                         FStarC_Format.print2
                      ...
                      (let uu___6 =
                         ...
                         FStarC_TypeChecker_Rel.layered_effect_teq env_g i1
                           g_i1 uu___7 in
                       FStarC_TypeChecker_Env.conj_guard g uu___6))
                   FStarC_TypeChecker_Env.trivial_guard uu___4 g_sort_is in
               FStarC_TypeChecker_Env.close_guard env [x_a] uu___3 in
             let uu___3 =
               FStarC_TypeChecker_Env.conj_guards [g_uvars; f_guard; g_guard] in
             (subst, uu___3))))
let mk_indexed_return (env : FStarC_TypeChecker_Env.env)
  (ed : FStarC_Syntax_Syntax.eff_decl) (u_a : FStarC_Syntax_Syntax.universe)
  (a : FStarC_Syntax_Syntax.typ) (e : FStarC_Syntax_Syntax.term)
  ...
  if debug
  then
    (let uu___1 = FStarC_Ident.string_of_lid ed.FStarC_Syntax_Syntax.mname in
     let uu___2 =
       FStarC_Class_Show.show FStarC_Syntax_Print.showable_univ u_a in
     let uu___3 = FStarC_Class_Show.show FStarC_Syntax_Print.showable_term a in
     let uu___4 = FStarC_Class_Show.show FStarC_Syntax_Print.showable_term e in
     FStarC_Format.print4 "Computing %s.return for u_a:%s, a:%s, and e:%s{\n"
   ...
   | (uu___2, return_t) ->
         ...
         let uu___3 =
           let uu___4 =
             ...
             let uu___6 =
               ...
               let uu___8 =
                 FStarC_Errors_Msg.text "does not have proper shape" in
               FStar_Pprint.op_Hat_Slash_Hat uu___7 uu___8 in
             FStar_Pprint.op_Hat_Slash_Hat uu___5 uu___6 in
           let uu___5 =
             let uu___6 =
       ...
       let uu___3 =
         ...
         | FStarC_Syntax_Syntax.Tm_arrow
             { FStarC_Syntax_Syntax.bs1 = bs;
               FStarC_Syntax_Syntax.comp = c;_}
             when (FStarC_List.length bs) >= (Prims.of_int (2)) ->
        ...
        | (a_b, x_b, rest_bs, return_typ) ->
                     ...
                     let uu___6 =
                       let uu___7 =
                         FStarC_Ident.string_of_lid
                           ed.FStarC_Syntax_Syntax.mname in
                       FStarC_Format.fmt1 "%s.return" uu___7 in
                     let uu___7 = FStarC_Range_Ops.string_of_range r in
                     FStarC_Format.fmt3
                       "implicit var for binder %s of %s at %s" uu___5 uu___6
                       uu___7
            ...
            (match uu___4 with
             | (rest_bs_uvars, g_uvars) ->
                 ...
                 let is =
                   let uu___5 =
                     let uu___6 = FStarC_Syntax_Subst.compress return_typ in
                     let uu___7 = FStarC_Syntax_Util.is_layered ed in
                     effect_args_from_repr uu___6 uu___7 r in
                   FStarC_List.map (FStarC_Syntax_Subst.subst subst) uu___5 in
                 let c =
                   let uu___5 =
                     let uu___6 =
                       FStarC_List.map FStarC_Syntax_Syntax.as_arg is in
                     {
                 ...
                 (if debug
                  then
                    (let uu___6 =
                     ...
                     FStarC_Format.print1 "} c after return %s\n" uu___6)
                  else ();
                  (c, g_uvars)))))
let mk_indexed_bind (env : FStarC_TypeChecker_Env.env)
  (m : FStarC_Ident.lident) (n : FStarC_Ident.lident)
  (p : FStarC_Ident.lident) (bind_t : FStarC_Syntax_Syntax.tscheme)
  (bind_combinator_kind :
    FStarC_Syntax_Syntax.indexed_effect_combinator_kind)
  (ct1 : FStarC_Syntax_Syntax.comp_typ)
  (b : FStarC_Syntax_Syntax.bv FStar_Pervasives_Native.option)
  (ct2 : FStarC_Syntax_Syntax.comp_typ)
  ...
  then
    (let uu___1 =
       let uu___2 = FStarC_Syntax_Syntax.mk_Comp ct1 in
       FStarC_Class_Show.show FStarC_Syntax_Print.showable_comp uu___2 in
     let uu___2 =
       let uu___3 = FStarC_Syntax_Syntax.mk_Comp ct2 in
       FStarC_Class_Show.show FStarC_Syntax_Print.showable_comp uu___3 in
     FStarC_Format.print2 "Binding indexed effects: c1:%s and c2:%s {\n"
       uu___1 uu___2)
  else ();
  (let uu___2 = FStarC_Effect.op_Bang dbg_ResolveImplicitsHook in
   ...
   then
     ...
     let uu___4 = FStarC_Syntax_Print.tscheme_to_string bind_t in
     FStarC_Format.print2
       "///////////////////////////////Bind at %s/////////////////////\nwith bind_t = %s\n"
       uu___3 uu___4
   else ());
  (let uu___2 =
     let uu___3 = FStarC_TypeChecker_Env.get_effect_decl env m in
     let uu___4 = FStarC_TypeChecker_Env.get_effect_decl env n in
     let uu___5 = FStarC_TypeChecker_Env.get_effect_decl env p in
   ...
   | (m_ed, n_ed, p_ed) ->
       ...
       ((let uu___4 =
           (((FStarC_TypeChecker_Env.is_erasable_effect env m) &&
               (let uu___5 = FStarC_TypeChecker_Env.is_erasable_effect env p in
              ...
              (let uu___5 =
               ...
               Prims.op_Negation uu___5))
             ||
             (((FStarC_TypeChecker_Env.is_erasable_effect env n) &&
                 (let uu___5 =
         ...
         then
           let uu___5 =
             let uu___6 =
               let uu___7 = FStarC_Errors_Msg.text "Cannot apply bind" in
               let uu___8 =
                 let uu___9 =
                   let uu___10 = bind_name () in
                   FStar_Pprint.doc_of_string uu___10 in
                 let uu___10 =
                   let uu___11 = FStarC_Errors_Msg.text "since" in
                   let uu___12 =
                     let uu___13 =
                       FStarC_Class_PP.pp FStarC_Ident.pretty_lident p in
                     let uu___14 =
                       FStarC_Errors_Msg.text
        ...
        (let uu___4 =
           let uu___5 =
             let uu___6 = FStarC_List.hd ct1.FStarC_Syntax_Syntax.comp_univs in
             let uu___7 =
               let uu___8 =
                 FStarC_List.hd ct2.FStarC_Syntax_Syntax.comp_univs in
               [uu___8] in
             uu___6 :: uu___7 in
           FStarC_TypeChecker_Env.inst_tscheme_with bind_t uu___5 in
         match uu___4 with
         | (uu___5, bind_t1) ->
             let uu___6 = FStarC_Syntax_Util.arrow_formals_comp bind_t1 in
             (match uu___6 with
              | (bind_t_bs, bind_c) ->
                  let uu___7 =
                    if
                    ...
                    then
                      ad_hoc_indexed_bind_substs env m_ed n_ed p_ed bind_t_bs
                        ct1 b ct2 r1 has_range_binders
                    else
                      (let uu___9 = bind_combinator_kind in
                       match uu___9 with
                       | FStarC_Syntax_Syntax.Substitutive_combinator
                           binder_kinds ->
                           substitutive_indexed_bind_substs env m_ed n_ed
                             p_ed bind_t_bs binder_kinds ct1 b ct2 r1
                             num_effect_params has_range_binders) in
                  (match uu___7 with
                   | (subst, g) ->
                       let bind_ct =
                         let uu___8 =
                           FStarC_Syntax_Subst.subst_comp subst bind_c in
                         FStarC_TypeChecker_Env.comp_to_comp_typ env uu___8 in
                       let fml =
                         let uu___8 =
                           let uu___9 =
                             FStarC_List.hd
                         ...
                         | (u, wp) ->
                             FStarC_TypeChecker_Env.pure_precondition_for_trivial_post
                               env u bind_ct.FStarC_Syntax_Syntax.result_typ
                               wp FStarC_Range_Type.dummyRange in
                       let is =
                         let uu___8 =
                           FStarC_Syntax_Subst.compress
                             bind_ct.FStarC_Syntax_Syntax.result_typ in
                         let uu___9 = FStarC_Syntax_Util.is_layered p_ed in
                         effect_args_from_repr uu___8 uu___9 r1 in
                       let c =
                         let uu___8 =
                           let uu___9 =
                             FStarC_List.map FStarC_Syntax_Syntax.as_arg is in
                           {
                             ...
                             FStarC_Syntax_Syntax.result_typ =
                               (ct2.FStarC_Syntax_Syntax.result_typ);
                             FStarC_Syntax_Syntax.effect_args = uu___9;
                             FStarC_Syntax_Syntax.flags = flags
                           } in
                       ...
                       (if debug
                        then
                          (let uu___9 =
                             FStarC_Class_Show.show
                               FStarC_Syntax_Print.showable_comp c in
                           FStarC_Format.print1 "} c after bind: %s\n" uu___9)
                        else ();
                        (let guard =
                           let uu___9 =
                             let uu___10 =
                               let uu___11 =
                                 FStarC_TypeChecker_Env.guard_of_guard_formula
                                   (FStarC_TypeChecker_Common.NonTrivial fml) in
                               [uu___11] in
                             g :: uu___10 in
                           FStarC_TypeChecker_Env.conj_guards uu___9 in
                         (let uu___10 =
                            FStarC_Effect.op_Bang dbg_ResolveImplicitsHook in
                          if uu___10
                          then
                            let uu___11 =
                              ...
                              FStarC_Range_Ops.string_of_range uu___12 in
                            let uu___12 =
                         ...
                         (c, guard))))))))
let mk_wp_bind (env : FStarC_TypeChecker_Env.env) (m : FStarC_Ident.lident)
  (ct1 : FStarC_Syntax_Syntax.comp_typ)
  (b : FStarC_Syntax_Syntax.bv FStar_Pervasives_Native.option)
  (ct2 : FStarC_Syntax_Syntax.comp_typ)
  (flags : FStarC_Syntax_Syntax.cflag Prims.list) (r1 : FStarC_Range_Type.t)
  ...
  let uu___ =
    ...
    | (a, kwp) ->
        ...
        let uu___3 = destruct_wp_comp ct2 in ((md, a, kwp), uu___2, uu___3) in
  match uu___ with
  | ((md, a, kwp), (u_t1, t1, wp1), (u_t2, t2, wp2)) ->
      let bs =
        match b with
        | FStar_Pervasives_Native.None ->
            let uu___1 = FStarC_Syntax_Syntax.null_binder t1 in [uu___1]
        | FStar_Pervasives_Native.Some x ->
      ...
      let mk_lam wp =
        ...
        FStarC_Syntax_Util.abs bs wp uu___1 in
      let wp_args =
        ...
        let uu___2 =
          ...
          let uu___4 =
            ...
            let uu___6 =
              let uu___7 =
                let uu___8 = mk_lam wp2 in FStarC_Syntax_Syntax.as_arg uu___8 in
              [uu___7] in
            uu___5 :: uu___6 in
          uu___3 :: uu___4 in
        uu___1 :: uu___2 in
      ...
      (match uu___1 with
       | (bind_wp, uu___2) ->
           let wp =
             let uu___3 =
               FStarC_TypeChecker_Env.inst_effect_fun_with [u_t1; u_t2] env
                 md bind_wp in
...
let mk_bind (env : FStarC_TypeChecker_Env.env)
  ...
  let env2 = maybe_push env b in
  let uu___ =
    let uu___1 = FStarC_TypeChecker_Env.unfold_effect_abbrev env c1 in
    let uu___2 = FStarC_TypeChecker_Env.unfold_effect_abbrev env2 c2 in
    (uu___1, uu___2) in
  match uu___ with
  | (ct1, ct2) ->
      let uu___1 =
           ...
           (match uu___2 with
            | (m, c11, c21, g_lift) ->
                let uu___3 =
                  ...
                  let uu___5 =
                    FStarC_TypeChecker_Env.comp_to_comp_typ env2 c21 in
                  (uu___4, uu___5) in
                (match uu___3 with
                 | (ct11, ct21) ->
                     let uu___4 =
                       let uu___5 =
                         FStarC_TypeChecker_Env.is_layered_effect env m in
                       if uu___5
                       then
                         let m_ed =
                           FStarC_TypeChecker_Env.get_effect_decl env m in
                         let num_effect_params =
                           match m_ed.FStarC_Syntax_Syntax.signature with
                           | FStarC_Syntax_Syntax.Layered_eff_sig (n, uu___6)
                               -> n
                           | uu___6 ->
                               failwith
                                 "Impossible (mk_bind expected an indexed effect)" in
                         let uu___6 =
                           FStarC_Syntax_Util.get_bind_vc_combinator m_ed in
                         match uu___6 with
                         | (bind_t, bind_kind) ->
                             let has_range_args =
                             ...
                             let uu___7 = FStarC_Option.must bind_kind in
                             mk_indexed_bind env m m m bind_t uu___7 ct11 b
                               ct21 flags r1 num_effect_params has_range_args
                       else
                         (let uu___7 = mk_wp_bind env m ct11 b ct21 flags r1 in
                          (uu___7, FStarC_TypeChecker_Env.trivial_guard)) in
                     (match uu___4 with
                      | (c, g_bind) ->
                          let uu___5 =
                            FStarC_TypeChecker_Env.conj_guard g_lift g_bind in
                          (c, uu___5)))))
...
let mk_return (env : FStarC_TypeChecker_Env.env)
  (ed : FStarC_Syntax_Syntax.eff_decl) (u_a : FStarC_Syntax_Syntax.universe)
  (a : FStarC_Syntax_Syntax.typ) (e : FStarC_Syntax_Syntax.term)
  (r : FStarC_Range_Type.t) :
  (FStarC_Syntax_Syntax.comp * FStarC_TypeChecker_Env.guard_t)=
...
let weaken_precondition (env : FStarC_TypeChecker_Env.env)
  ...
  let weaken uu___ =
    ...
    match uu___1 with
    | (c, g_c) ->
        let uu___2 = (FStarC_Options.lax ()) && (FStarC_Options.ml_ish ()) in
        if uu___2
        then (c, g_c)
        else
          (match f with
           ...
           | FStarC_TypeChecker_Common.NonTrivial f1 ->
               ...
               (match uu___4 with
                | (c1, g_w) ->
                    let uu___5 = FStarC_TypeChecker_Env.conj_guard g_c g_w in
                    (c1, uu___5))) in
...
let strengthen_precondition
  ...
  then (lc, g0)
    ...
    (let flags =
       let uu___2 =
         let uu___3 = FStarC_TypeChecker_Common.is_tot_or_gtot_lcomp lc in
         if uu___3
             ...
             FStarC_List.collect
               (fun uu___4 ->
                  ...
                  | FStarC_Syntax_Syntax.SHOULD_NOT_INLINE ->
                      [FStarC_Syntax_Syntax.SHOULD_NOT_INLINE]
                  | uu___5 -> []) lc.FStarC_TypeChecker_Common.cflags in
           FStarC_List.op_At flags1 uu___3 in
             ...
             (let g01 = FStarC_TypeChecker_Rel.simplify_guard env g0 in
              ...
              | FStarC_TypeChecker_Common.NonTrivial f ->
                  ((let uu___8 = FStarC_Debug.extreme () in
                   ...
                   (let uu___8 = strengthen_comp env reason c f flags in
                    match uu___8 with
                    | (c1, g_s) ->
                        let uu___9 =
      ...
      then
        let uu___ =
          let uu___1 =
            ...
            FStarC_TypeChecker_Env.norm_eff_name env uu___2 in
        ...
        (if uu___
         then
           ...
           | (b1, phi1) ->
               ...
               let uu___2 = weaken_comp env c phi2 in
               (match uu___2 with | (c1, g) -> (c1, g, true))
         else
           (let uu___2 = close_wp_comp env [x] c in
            (uu___2, FStarC_TypeChecker_Env.trivial_guard, true)))
...
let bind (r1 : FStarC_Range_Type.t) (is_let_binding : Prims.bool)
  ...
  (lc1 : FStarC_TypeChecker_Common.lcomp) (uu___ : lcomp_with_binder) :
  FStarC_TypeChecker_Common.lcomp=
  match uu___ with
  | (b, lc2) ->
      let debug f =
        let uu___1 =
          (FStarC_Debug.extreme ()) || (FStarC_Effect.op_Bang dbg_bind) in
      ...
      (match uu___1 with
       | (lc11, lc21) ->
           ...
           let bind_flags =
             let uu___2 =
               (should_not_inline_lc lc11) || (should_not_inline_lc lc21) in
             if uu___2
             then [FStarC_Syntax_Syntax.SHOULD_NOT_INLINE]
             else
               (let flags =
                  let uu___4 = FStarC_TypeChecker_Common.is_total_lcomp lc11 in
                  if uu___4
                  then
                    let uu___5 =
                    ...
                    (if uu___5
                     then [FStarC_Syntax_Syntax.TOTAL]
                       ...
                       (let uu___7 =
                          FStarC_TypeChecker_Common.is_tot_or_gtot_lcomp lc21 in
                        if uu___7
                        then [FStarC_Syntax_Syntax.SOMETRIVIAL]
                        else []))
                  else
                    (let uu___6 =
                       (FStarC_TypeChecker_Common.is_tot_or_gtot_lcomp lc11)
                         &&
                         (FStarC_TypeChecker_Common.is_tot_or_gtot_lcomp lc21) in
                     if uu___6
                     then [FStarC_Syntax_Syntax.SOMETRIVIAL]
                ...
                if uu___4
                then FStarC_Syntax_Syntax.TRIVIAL_POSTCONDITION :: flags
                else flags) in
           let bind_it uu___2 =
             let uu___3 =
               (FStarC_Options.lax ()) && (FStarC_Options.ml_ish ()) in
             ...
             then
               ...
               (let uu___5 = FStarC_TypeChecker_Common.lcomp_comp lc11 in
                match uu___5 with
                | (c1, g_c1) ->
                    let uu___6 = FStarC_TypeChecker_Common.lcomp_comp lc21 in
                    (match uu___6 with
                     | (c2, g_c2) ->
                         let trivial_guard =
                           let uu___7 =
                             ...
                             | FStar_Pervasives_Native.Some x ->
                                 ...
                                 let uu___8 =
                                   FStarC_Syntax_Syntax.is_null_binder b1 in
                                 if uu___8
                                 then g_c2
                                 else
                           ...
                           FStarC_TypeChecker_Env.conj_guard g_c1 uu___7 in
                         (debug
                            (fun uu___8 ->
                               let uu___9 =
                                 FStarC_Class_Show.show
                          ...
                          (let aux uu___8 =
                             let uu___9 = FStarC_Syntax_Util.is_trivial_wp c1 in
                             if uu___9
                             then
                               match b with
                               | FStar_Pervasives_Native.None ->
                               ...
                               | FStar_Pervasives_Native.Some uu___10 ->
                                   let uu___11 =
                                     FStarC_Syntax_Util.is_ml_comp c2 in
                                   (if uu___11
                                    then
                                      FStar_Pervasives.Inl (c2, "trivial ml")
                                    else
                                      FStar_Pervasives.Inr
                                ...
                                then
                                  let maybe_close_with_unit_refinement x c =
                                    let x1 =
                                        ...
                                        FStarC_Syntax_Util.comp_result c1 in
                                      {
                                        ...
                                        FStarC_Syntax_Syntax.index =
                                          (x.FStarC_Syntax_Syntax.index);
                                        FStarC_Syntax_Syntax.sort = uu___12
                                      } in
                                  ...
                                  | (FStar_Pervasives_Native.Some e,
                                     FStar_Pervasives_Native.Some x) when
                                      ((let uu___12 = optimize_bind_vc () in
                                        Prims.op_Negation uu___12) ||
                                         (Prims.op_Negation is_let_binding))
                                        || is_layered
                                      ->
                                      let uu___12 =
                                        let uu___13 =
                                          FStarC_Syntax_Subst.subst_comp
                                            [FStarC_Syntax_Syntax.NT (x, e)]
                                            c2 in
                                       ...
                                       | (c21, g_close, uu___13) ->
                                           let uu___14 =
                                             let uu___15 =
                                               ...
                                               FStarC_TypeChecker_Env.conj_guards
                                                 uu___16 in
                                             (c21, uu___15, "c1 Tot") in
                                           FStar_Pervasives.Inl uu___14)
                                  | (FStar_Pervasives_Native.Some e,
                                     FStar_Pervasives_Native.Some x) ->
                                      let default_with_eqn uu___12 =
                                        let uu___13 =
                                          let uu___14 =
                                            let uu___15 =
                                              let uu___16 =
                                          ...
                                          let uu___15 =
                                            ...
                                            let uu___17 =
                                              FStarC_Syntax_Syntax.bv_to_name
                                                x in
                                            FStarC_Syntax_Util.mk_eq2 uu___16
                                              x.FStarC_Syntax_Syntax.sort e
                                              uu___17 in
                                          weaken_comp uu___14 c2 uu___15 in
                                        match uu___13 with
                                        | (c21, g_c2') ->
                                            let uu___14 =
                                            ...
                                            (match uu___14 with
                                             | (c22, g_close) ->
                                                 let uu___15 =
                                                   ...
                                                   (c22, uu___16,
                                                     "c1 Tot with eq") in
                                                 FStar_Pervasives.Inl uu___15) in
                                      let uu___12 =
                                  ...
                                  | (uu___12, FStar_Pervasives_Native.Some x)
                                      ->
                                      let uu___13 = close_with_type_of_x x c2 in
                                      (match uu___13 with
                                       | (c21, g_close) ->
                                           let uu___14 =
                                             let uu___15 =
                                     ...
                                     let uu___14 =
                                       let uu___15 =
                                         ...
                                         FStarC_Syntax_Syntax.mk_GTotal
                                           uu___16 in
                                       (uu___15, trivial_guard, "both GTot") in
                                     FStar_Pervasives.Inl uu___14
                                           ...
                                           (let c21 =
                                            ...
                                            let uu___15 =
                                              let uu___16 =
                                                ...
                                                FStarC_TypeChecker_Env.push_binders
                                                  env uu___17 in
                                              weaken_comp uu___16 c21 x_eq_e in
                                            match uu___15 with
                                            | (c22, g_w) ->
                                                let g =
                                                  let uu___16 =
...
let assume_result_eq_pure_term_in_m (env : FStarC_TypeChecker_Env.env)
  ...
  let m =
    let uu___ =
      (FStar_Pervasives_Native.uu___is_None m_opt) ||
  ...
  let flags =
    ...
    if uu___
    then FStarC_Syntax_Syntax.RETURN :: (lc.FStarC_TypeChecker_Common.cflags)
    ...
    | (c, g_c) ->
        let u_t =
          ...
          | FStar_Pervasives_Native.None ->
              ...
              env.FStarC_TypeChecker_Env.universe_of env uu___2 in
        let uu___2 = FStarC_Syntax_Util.is_tot_or_gtot_comp c in
        if uu___2
        then
          let uu___3 =
            let uu___4 = FStarC_Syntax_Util.comp_result c in
            return_value env m (FStar_Pervasives_Native.Some u_t) uu___4 e in
          (match uu___3 with
           | (retc, g_retc) ->
          ...
          (let c1 = FStarC_TypeChecker_Env.unfold_effect_abbrev env c in
           ...
           | (ret, g_ret) ->
               ...
               let uu___5 =
                 let uu___6 =
                   let uu___7 = FStarC_TypeChecker_Common.lcomp_of_comp c2 in
  ...
  then
    let uu___1 =
      let uu___2 =
        ...
        let uu___4 = FStarC_Class_PP.pp FStarC_Syntax_Print.pretty_term e in
...
let maybe_assume_result_eq_pure_term_in_m (env : FStarC_TypeChecker_Env.env)
  ...
  let should_return1 =
    (((Prims.op_Negation env.FStarC_TypeChecker_Env.phase1) &&
      ...
      &&
      (let uu___ = FStarC_TypeChecker_Common.is_lcomp_partial_return lc in
...
let maybe_return_e2_and_bind (r : FStarC_Range_Type.t)
  ...
  (uu___ : lcomp_with_binder) : FStarC_TypeChecker_Common.lcomp=
  match uu___ with
  | (x, lc2) ->
      let env_x =
        match x with
           ...
           let lc22 =
             ...
             let uu___2 =
               ((FStarC_Ident.lid_equals eff2
                 ...
                 &&
                 (let uu___3 =
                    FStarC_TypeChecker_Env.exists_polymonadic_bind env eff1
                      eff2 in
             ...
             then
               ...
               (let uu___4 =
                  ((let uu___5 = is_pure_or_ghost_effect env eff1 in
                    Prims.op_Negation uu___5) || (should_not_inline_lc lc11))
...
let substitutive_indexed_ite_substs (env : FStarC_TypeChecker_Env.env)
  (k : FStarC_Syntax_Syntax.indexed_effect_combinator_kind)
  (bs : FStarC_Syntax_Syntax.binders) (a : FStarC_Syntax_Syntax.typ)
  (p : FStarC_Syntax_Syntax.term) (ct_then : FStarC_Syntax_Syntax.comp_typ)
  (ct_else : FStarC_Syntax_Syntax.comp_typ) (num_effect_params : Prims.int)
  (r : FStarC_Range_Type.t) :
  (FStarC_Syntax_Syntax.subst_elt Prims.list *
    FStarC_TypeChecker_Env.guard_t)=
  let debug = FStarC_Effect.op_Bang dbg_LayeredEffectsApp in
  let uu___ =
    ...
    | a_b::bs1 ->
        (bs1,
          [FStarC_Syntax_Syntax.NT ((a_b.FStarC_Syntax_Syntax.binder_bv), a)]) in
  match uu___ with
  | (bs1, subst) ->
      let uu___1 =
        if num_effect_params = Prims.int_zero
        then
          ...
          (let split l = FStarC_List.splitAt num_effect_params l in
           ...
           match uu___3 with
           | (eff_params_bs, bs2) ->
               let uu___4 = split ct_then.FStarC_Syntax_Syntax.effect_args in
               (match uu___4 with
                | (param_args1, args1) ->
                    let uu___5 =
                      split ct_else.FStarC_Syntax_Syntax.effect_args in
                    (match uu___5 with
                     | (param_args2, args2) ->
                         let g =
                           FStarC_List.fold_left2
                             (fun g1 uu___6 uu___7 ->
                                match (uu___6, uu___7) with
                                | ((arg1, uu___8), (arg2, uu___9)) ->
                                    let uu___10 =
                                      FStarC_TypeChecker_Rel.layered_effect_teq
                                        env arg1 arg2
                                        (FStar_Pervasives_Native.Some
                                    ...
                                    FStarC_TypeChecker_Env.conj_guard g1
                                      uu___10)
                             FStarC_TypeChecker_Env.trivial_guard param_args1
                             param_args2 in
                         let param_subst =
                           FStarC_List.map2
                             (fun b uu___6 ->
                                ...
                                | (arg, uu___7) ->
                                    FStarC_Syntax_Syntax.NT
                                      ((b.FStarC_Syntax_Syntax.binder_bv),
                                        arg)) eff_params_bs param_args1 in
                         (bs2, (FStarC_List.op_At subst param_subst), g,
                           args1, args2)))) in
      (match uu___1 with
             ...
             | (f_bs, bs3) ->
                 let f_subst =
                   FStarC_List.map2
                     ...
                     f_bs args1 in
                 (bs3, (FStarC_List.op_At subst1 f_subst)) in
           (match uu___2 with
            | (bs3, subst2) ->
                let uu___3 =
                            ...
                            (fun g_b uu___5 ->
                               ...
                               | (arg, uu___6) ->
                                   FStarC_Syntax_Syntax.NT
                                     ((g_b.FStarC_Syntax_Syntax.binder_bv),
                                       arg)) g_bs args2 in
                        (bs4, (FStarC_List.op_At subst2 g_subst), guard)
                  else
                    if
                         ...
                         FStarC_List.fold_left2
                           (fun guard1 uu___6 uu___7 ->
                              ...
                              | ((arg1, uu___8), (arg2, uu___9)) ->
                                  ...
                                  FStarC_TypeChecker_Env.conj_guard guard1
                                    uu___10) guard args1 args2 in
                       (bs3, subst2, uu___5))
                    else
                      failwith
                ...
                (match uu___3 with
                 | (bs4, subst3, guard1) ->
                     let uu___4 =
                       FStarC_List.splitAt
                         ((FStarC_List.length bs4) - (Prims.of_int (3))) bs4 in
                     (match uu___4 with
                               ...
                               ((FStarC_List.op_At subst4
                                   [FStarC_Syntax_Syntax.NT
                                      ((p_b.FStarC_Syntax_Syntax.binder_bv),
                                        p)]), g))))))
let ad_hoc_indexed_ite_substs (env : FStarC_TypeChecker_Env.env)
  (bs : FStarC_Syntax_Syntax.binders) (a : FStarC_Syntax_Syntax.typ)
  (p : FStarC_Syntax_Syntax.term) (ct_then : FStarC_Syntax_Syntax.comp_typ)
  (ct_else : FStarC_Syntax_Syntax.comp_typ) (r : FStarC_Range_Type.t) :
  (FStarC_Syntax_Syntax.subst_elt Prims.list *
    FStarC_TypeChecker_Env.guard_t)=
  let debug = FStarC_Effect.op_Bang dbg_LayeredEffectsApp in
  let conjunction_name uu___ =
    ...
    then
      let uu___1 =
        FStarC_Ident.string_of_lid ct_then.FStarC_Syntax_Syntax.effect_name in
      FStarC_Format.fmt1 "%s.conjunction" uu___1
    else "" in
  let conjunction_t_error r1 s =
      ...
      let uu___1 =
        ...
        let uu___3 =
          let uu___4 =
            FStarC_Class_PP.pp FStarC_Ident.pretty_lident
              ct_then.FStarC_Syntax_Syntax.effect_name in
          let uu___5 = FStarC_Errors_Msg.text "does not have proper shape." in
    ...
    FStarC_Errors.raise_error FStarC_Class_HasRange.hasRange_range r1
      ...
      (Obj.magic uu___) in
  let uu___ =
    if (FStarC_List.length bs) >= (Prims.of_int (4))
    then
      let uu___1 = bs in
      match uu___1 with
      | a_b::bs1 ->
          let uu___2 =
            FStarC_List.splitAt
              ((FStarC_List.length bs1) - (Prims.of_int (3))) bs1 in
          (match uu___2 with
           | (rest_bs, f_b::g_b::p_b::[]) -> (a_b, rest_bs, f_b, g_b, p_b))
    else
      conjunction_t_error r "Either not an abstraction or not enough binders" in
  match uu___ with
          ...
          (fun b ->
             ...
             then
               ...
               let uu___3 =
                 FStarC_Ident.string_of_lid
                   ct_then.FStarC_Syntax_Syntax.effect_name in
               let uu___4 = FStarC_Range_Ops.string_of_range r in
               FStarC_Format.fmt3
                 "implicit var for binder %s of %s:conjunction at %s" uu___2
                 uu___3 uu___4
           ...
           let substs =
             FStarC_List.map2
               (fun b t ->
                  FStarC_Syntax_Syntax.NT
                    ((b.FStarC_Syntax_Syntax.binder_bv), t)) (a_b ::
               (FStarC_List.op_At rest_bs [p_b])) (a ::
               (FStarC_List.op_At rest_bs_uvars [p])) in
           let f_guard =
             let f_sort_is =
               let uu___2 =
                 let uu___3 =
               ...
               | FStarC_Syntax_Syntax.Tm_app
                   ...
                   ->
                   let uu___5 =
                     FStarC_List.map FStar_Pervasives_Native.fst is in
                   FStarC_List.map (FStarC_Syntax_Subst.subst substs) uu___5
               | uu___3 ->
                   conjunction_t_error r "f's type is not a repr type" in
             let uu___2 =
               FStarC_List.map FStar_Pervasives_Native.fst
             ...
             FStarC_List.fold_left2
               (fun g i1 f_i ->
                  let uu___3 =
                    ...
                    FStarC_TypeChecker_Rel.layered_effect_teq env i1 f_i
                      uu___4 in
                  FStarC_TypeChecker_Env.conj_guard g uu___3)
               FStarC_TypeChecker_Env.trivial_guard uu___2 f_sort_is in
           let g_guard =
             let g_sort_is =
               let uu___2 =
                 let uu___3 =
               ...
               | FStarC_Syntax_Syntax.Tm_app
                   ...
                   FStarC_List.map (FStarC_Syntax_Subst.subst substs) uu___5
               | uu___3 ->
                   conjunction_t_error r "g's type is not a repr type" in
             let uu___2 =
               FStarC_List.map FStar_Pervasives_Native.fst
               ...
               (fun g i2 g_i ->
                  let uu___3 =
                    let uu___4 =
                      let uu___5 = conjunction_name () in
                      FStar_Pervasives_Native.Some uu___5 in
                    FStarC_TypeChecker_Rel.layered_effect_teq env i2 g_i
                      uu___4 in
                  FStarC_TypeChecker_Env.conj_guard g uu___3)
               FStarC_TypeChecker_Env.trivial_guard uu___2 g_sort_is in
           let uu___2 =
             FStarC_TypeChecker_Env.conj_guards [g_uvars; f_guard; g_guard] in
           (substs, uu___2))
let mk_layered_conjunction (env : FStarC_TypeChecker_Env.env)
  (ed : FStarC_Syntax_Syntax.eff_decl) (u_a : FStarC_Syntax_Syntax.universe)
  ...
  let uu___ =
    let uu___1 =
      let uu___2 = FStarC_Syntax_Util.get_layered_if_then_else_combinator ed in
      FStarC_Option.must uu___2 in
    match uu___1 with
    | (ts, kopt) ->
        let uu___2 = FStarC_TypeChecker_Env.inst_tscheme_with ts [u_a] in
        (match uu___2 with
         | (uu___3, conjunction) ->
             let uu___4 = FStarC_Option.must kopt in (conjunction, uu___4)) in
  match uu___ with
  | (conjunction, kind) ->
      ...
      (match uu___1 with
       | (bs, body, uu___2) ->
           (if debug
            then
              (let uu___4 =
                 let uu___5 = FStarC_Syntax_Syntax.mk_Comp ct1 in
                 FStarC_Class_Show.show FStarC_Syntax_Print.showable_comp
                   uu___5 in
               let uu___5 =
                 let uu___6 = FStarC_Syntax_Syntax.mk_Comp ct2 in
                 FStarC_Class_Show.show FStarC_Syntax_Print.showable_comp
                   uu___6 in
               FStarC_Format.print2 "layered_ite c1: %s and c2: %s {\n"
                 uu___4 uu___5)
            else ();
            (let uu___4 =
               ...
               then ad_hoc_indexed_ite_substs env bs a p ct1 ct2 r
                 ...
                 (let num_effect_params =
                    match ed.FStarC_Syntax_Syntax.signature with
                    | FStarC_Syntax_Syntax.Layered_eff_sig (n, uu___6) -> n
                    | uu___6 -> failwith "Impossible!" in
                  substitutive_indexed_ite_substs env kind bs a p ct1 ct2
                    num_effect_params r) in
             match uu___4 with
             | (substs, g) ->
                 let body1 = FStarC_Syntax_Subst.subst substs body in
                 let is =
                   let uu___5 =
                     let uu___6 = FStarC_Syntax_Subst.compress body1 in
                   ...
                   | FStarC_Syntax_Syntax.Tm_app
                       ...
                       -> FStarC_List.map FStar_Pervasives_Native.fst args
                   | uu___6 ->
                       conjunction_t_error r "body is not a repr type" in
                 let c =
                   let uu___5 =
                     let uu___6 =
                       FStarC_List.map FStarC_Syntax_Syntax.as_arg is in
                   ...
                   FStarC_Syntax_Syntax.mk_Comp uu___5 in
                 (if debug then FStarC_Format.print_string "\n}\n" else ();
                  (c, g)))))
let mk_non_layered_conjunction (env : FStarC_TypeChecker_Env.env)
  (ed : FStarC_Syntax_Syntax.eff_decl) (u_a : FStarC_Syntax_Syntax.universe)
  (a : FStarC_Syntax_Syntax.term) (p : FStarC_Syntax_Syntax.typ)
  (ct1 : FStarC_Syntax_Syntax.comp_typ) (ct2 : FStarC_Syntax_Syntax.comp_typ)
  (uu___ : FStarC_Range_Type.t) :
  (FStarC_Syntax_Syntax.comp * FStarC_TypeChecker_Env.guard_t)=
  let p1 = FStarC_Syntax_Util.b2t p in
  let if_then_else =
    let uu___1 = FStarC_Syntax_Util.get_wp_if_then_else_combinator ed in
           ...
           let wp =
             ...
             let uu___8 =
               ...
               let uu___10 =
                 ...
                 let uu___12 =
                   let uu___13 = FStarC_Syntax_Syntax.as_arg wp_t in
                   let uu___14 =
                     let uu___15 = FStarC_Syntax_Syntax.as_arg wp_e in
                     [uu___15] in
                   uu___13 :: uu___14 in
                 uu___11 :: uu___12 in
               uu___9 :: uu___10 in
             let uu___9 =
               FStarC_Range_Ops.union_ranges wp_t.FStarC_Syntax_Syntax.pos
                 wp_e.FStarC_Syntax_Syntax.pos in
             FStarC_Syntax_Syntax.mk_Tm_app uu___7 uu___8 uu___9 in
           let uu___7 = mk_comp ed u_a a wp [] in
           (uu___7, FStarC_TypeChecker_Env.trivial_guard))
let comp_pure_wp_false (env : FStarC_TypeChecker_Env.env)
  ...
  let kwp =
    ...
    let uu___1 = FStarC_Syntax_Syntax.mk_Total FStarC_Syntax_Util.ktype0 in
    FStarC_Syntax_Util.arrow uu___ uu___1 in
  let post = FStarC_Syntax_Syntax.new_bv FStar_Pervasives_Native.None post_k in
  let wp =
    let uu___ = let uu___1 = FStarC_Syntax_Syntax.mk_binder post in [uu___1] in
    ...
    FStarC_Syntax_Util.abs uu___ uu___1 uu___2 in
  let md =
    FStarC_TypeChecker_Env.get_effect_decl env
...
let get_neg_branch_conds
  ...
  match uu___ with
  | (l1, l2) -> let uu___1 = FStarC_List.hd l2 in (l1, uu___1)
let bind_cases (env0 : FStarC_TypeChecker_Env.env)
  ...
  let env =
    let uu___ =
      let uu___1 = FStarC_Syntax_Syntax.mk_binder scrutinee in [uu___1] in
          ...
          (let maybe_return eff_label_then cthen =
           ...
           let uu___4 =
             let uu___5 =
               FStarC_List.map
                 (fun uu___6 ->
                    match uu___6 with | (g, uu___7, uu___8, uu___9) -> g)
                 lcases in
           ...
           | (neg_branch_conds, exhaustiveness_branch_cond) ->
               let uu___5 =
                 match lcases with
                 | [] ->
                     let uu___6 = comp_pure_wp_false env u_res_t res_t in
                 ...
                 | uu___6 ->
                     let uu___7 =
                       let uu___8 =
                         ...
                         match uu___9 with
                         | (l1, l2) ->
                             let uu___10 = FStarC_List.hd l2 in (l1, uu___10) in
                       match uu___8 with
                       | (neg_branch_conds1, neg_last) ->
                           let uu___9 =
                             ...
                             match uu___10 with
                             | (l1, l2) ->
                                 let uu___11 = FStarC_List.hd l2 in
                                 (l1, uu___11) in
                           (match uu___9 with
                                  ...
                                  | (c, g) ->
                                      let uu___13 =
                                        let uu___14 =
                                          ...
                                          FStarC_Syntax_Util.mk_conj uu___15
                                            neg_last in
                                        FStarC_TypeChecker_Common.weaken_guard_formula
                                          g uu___14 in
                                      (c, uu___13) in
                     ...
                     (match uu___7 with
                      | (lcases1, neg_branch_conds1, md, comp, g_comp) ->
                          FStarC_List.fold_right2
                                             ...
                                             let uu___14 =
                                               let uu___15 =
                                                 FStarC_TypeChecker_Env.get_range
                                                   env in
                                               fn env md1 u_res_t res_t g
                                                 ct_then ct_else uu___15 in
                                             (match uu___14 with
                                              | (c, g_conjunction) ->
                                                  let uu___15 =
                                                    let g1 =
                            ...
                            ((FStar_Pervasives_Native.Some md), comp, g_comp)) in
               (match uu___5 with
                | (md, comp, g_comp) ->
                    let uu___6 =
                      let uu___7 =
                        ...
                        let check1 =
                          let uu___8 = FStarC_TypeChecker_Env.get_range env in
                          label FStarC_TypeChecker_Err.exhaustiveness_check
                            uu___8 check in
                        strengthen_comp env FStar_Pervasives_Native.None comp
                          check1 bind_cases_flags in
                      match uu___7 with
                      | (c, g) ->
                          let uu___8 =
                            FStarC_TypeChecker_Env.conj_guard g_comp g in
                          (c, uu___8) in
                    (match uu___6 with
                     | (comp1, g_comp1) ->
                         (match lcases with
                          ...
                          | uu___7 ->
                              let uu___8 =
                                let uu___9 = FStarC_Option.must md in
                                ...
                                (let comp2 =
                                 ...
                                 | (uu___11, uu___12, wp) ->
                                     ...
                                     let wp1 =
                                       ...
                                       let uu___14 =
                                         let uu___15 =
                                           FStarC_Syntax_Syntax.as_arg res_t in
                                         let uu___16 =
                                           let uu___17 =
                                             FStarC_Syntax_Syntax.as_arg wp in
                                           [uu___17] in
                                         uu___15 :: uu___16 in
                                       FStarC_Syntax_Syntax.mk_Tm_app uu___13
                                         uu___14 wp.FStarC_Syntax_Syntax.pos in
                                     let uu___13 =
...
let universe_of_comp (env : FStarC_TypeChecker_Env.env)
  ...
  let c_lid =
    ...
    FStarC_TypeChecker_Env.norm_eff_name env uu___ in
  let uu___ = FStarC_Syntax_Util.is_pure_or_ghost_effect c_lid in
  if uu___
  then u_res
  else
    (let is_total =
       let uu___2 = FStarC_TypeChecker_Env.lookup_effect_quals env c_lid in
     ...
     then FStarC_Syntax_Syntax.U_zero
       ...
       (let uu___3 = FStarC_TypeChecker_Env.effect_repr env c u_res in
        ...
        | FStar_Pervasives_Native.None ->
            let uu___4 =
              let uu___5 =
                FStarC_Class_Show.show FStarC_Ident.showable_lident c_lid in
              FStarC_Format.fmt1
                "Effect %s is marked total but does not have a repr" uu___5 in
            FStarC_Errors.raise_error
  ...
  | FStar_Pervasives_Native.Some uu___1 ->
      ((let uu___3 = FStarC_Effect.op_Bang dbg_Coercions in
       ...
       (let lc2 = FStarC_TypeChecker_Common.lcomp_of_comp comp2 in
        ...
        let coercion =
          let uu___3 =
            FStarC_Ident.set_lid_range f e.FStarC_Syntax_Syntax.pos in
        ...
        let e1 =
          ...
          then
            let uu___4 =
              let uu___5 =
                let uu___6 = FStarC_Syntax_Syntax.as_arg e in [uu___6] in
            ...
            (let x =
             ...
             let e2 =
               let uu___5 =
                 let uu___6 =
                   ...
                   [uu___7] in
                 FStarC_List.op_At eargs uu___6 in
             ...
             let e3 =
               maybe_lift env e lc.FStarC_TypeChecker_Common.eff_name
                 ...
                 lc.FStarC_TypeChecker_Common.res_typ in
             let e21 =
               let uu___5 = FStarC_TypeChecker_Env.push_bv env x in
               maybe_lift uu___5 e2 lc2.FStarC_TypeChecker_Common.eff_name
                 lc_res.FStarC_TypeChecker_Common.eff_name
             ...
             let e4 =
               ...
               FStarC_Syntax_Syntax.mk uu___5 e3.FStarC_Syntax_Syntax.pos in
  ...
  FStarC_Errors.with_ctx "find_coercion"
    (fun uu___ ->
       ...
       let is_head_defined t =
         ...
         ((FStarC_Syntax_Syntax.uu___is_Tm_fvar h1.FStarC_Syntax_Syntax.n) ||
            (FStarC_Syntax_Syntax.uu___is_Tm_uinst h1.FStarC_Syntax_Syntax.n))
           ||
           (FStarC_Syntax_Syntax.uu___is_Tm_type h1.FStarC_Syntax_Syntax.n) in
       ...
       let uu___1 =
         let uu___2 =
           (is_head_defined exp_t) &&
             (is_head_defined checked.FStarC_TypeChecker_Common.res_typ) in
                     ...
                     let head_lid_of t =
                       ...
                       | FStarC_Syntax_Syntax.Tm_uinst
                           ({
                            ...
                            uu___10)
                           ->
                           let uu___11 = FStarC_Syntax_Syntax.lid_of_fv fv in
...
let maybe_coerce_lc (env : FStarC_TypeChecker_Env.env)
  ...
  let should_coerce =
    ((env.FStarC_TypeChecker_Env.phase1 || (FStarC_Options.lax ())) &&
       (Prims.op_Negation env.FStarC_TypeChecker_Env.nocoerce))
      &&
      (let uu___ =
         head_types_equal lc.FStarC_TypeChecker_Common.res_typ exp_t in
       Prims.op_Negation uu___) in
  ...
  then
    ...
    ((let uu___2 = FStarC_Effect.op_Bang dbg_Coercions in
      if uu___2
      then
        let uu___3 =
          FStarC_Class_Show.show FStarC_Range_Ops.showable_range
     ...
     (let uu___2 = find_coercion env lc exp_t e in
      ...
      | FStar_Pervasives_Native.Some (coerced, lc1, g) ->
          ((let uu___4 = FStarC_Effect.op_Bang dbg_Coercions in
            if uu___4
            then
              let uu___5 =
      ...
      | FStar_Pervasives_Native.None ->
          ((let uu___4 = FStarC_Effect.op_Bang dbg_Coercions in
           ...
           (let strip_hide_or_reveal e1 hide_or_reveal =
              let uu___4 = FStarC_Syntax_Util.leftmost_head_and_args e1 in
              match uu___4 with
              | (hd, args) ->
                  let uu___5 =
                    let uu___6 =
                  ...
                  (match uu___5 with
                   | (FStarC_Syntax_Syntax.Tm_uinst (hd1, uu___6),
                      (uu___7, aq_t)::(e2, aq_e)::[]) when
                       (((FStarC_Syntax_Util.is_fvar hide_or_reveal hd1) &&
                           (FStar_Pervasives_Native.uu___is_Some aq_t))
                          &&
                          (FStar_Pervasives_Native.__proj__Some__item__v aq_t).FStarC_Syntax_Syntax.aqual_implicit)
                         &&
                 ...
                 | FStar_Pervasives_Native.Some g ->
                     ...
                     let uu___6 =
                       let uu___7 =
                         ...
                         [uu___8] in
                       let uu___8 = FStarC_Syntax_Syntax.mk_Total exp_t in
                     ...
                     (match uu___6 with
                      | (e_hide, lc1) ->
                          let e_hide1 =
                            ...
                            FStarC_Option.dflt e_hide uu___7 in
                          (e_hide1, lc1, g1)))
            | (Yes ty, No) ->
                let u = env.FStarC_TypeChecker_Env.universe_of env ty in
                let uu___5 =
                  let uu___6 =
                    let uu___7 = FStarC_Syntax_Syntax.iarg ty in [uu___7] in
                  let uu___7 = FStarC_Syntax_Syntax.mk_GTotal ty in
                  coerce_with env e lc FStarC_Parser_Const.reveal [u] uu___6
                    uu___7 in
                (match uu___5 with
                 | (e_reveal, lc1) ->
                     let e_reveal1 =
                       ...
                       FStarC_Option.dflt e_reveal uu___6 in
              ...
              | (c, g_c) ->
                  ...
                  then
                    ...
                    (let is_res_t_refinement =
                       ...
                       | FStarC_Syntax_Syntax.Tm_refine uu___6 -> true
                       | uu___6 -> false in
                     ...
                     then
                       ...
                       let uu___6 =
                         ...
                         let uu___8 = FStarC_Syntax_Syntax.bv_to_name x in
                         return_value env uu___7 (comp_univ_opt c) res_t
                           uu___8 in
                       match uu___6 with
                       | (cret, gret) ->
                           let lc1 =
                             ...
                             let uu___8 =
                               ...
                               ((FStar_Pervasives_Native.Some x), uu___9) in
                             bind e.FStarC_Syntax_Syntax.pos false env
                               (FStar_Pervasives_Native.Some e) uu___7 uu___8 in
                           ((let uu___8 = FStarC_Debug.extreme () in
                             if uu___8
                             then
                               let uu___9 =
                       ...
                       ((let uu___8 = FStarC_Debug.extreme () in
                        ...
                        (let uu___8 = set_result_typ c in (uu___8, g_c)))) in
            let lc1 =
              ...
              then FStarC_TypeChecker_Common.lcomp_comp lc
                ...
                (let f1 =
                 ...
                 | uu___6 ->
                     ...
                     (match uu___7 with
                      | (c, g_c) ->
                          ((let uu___9 = FStarC_Debug.extreme () in
                            if uu___9
                            then
                              let uu___10 =
                                FStarC_TypeChecker_Normalize.term_to_string
                                  env lc.FStarC_TypeChecker_Common.res_typ in
                              let uu___11 =
                                FStarC_TypeChecker_Normalize.term_to_string
                                  env t in
                              let uu___12 =
                            ...
                            | (cret, gret) ->
                                let guard =
                                  ...
                                  then
                                    let uu___10 =
                                      let uu___11 =
                                        FStarC_Syntax_Syntax.as_arg xexp in
                                      [uu___11] in
                                    FStarC_Syntax_Syntax.mk_Tm_app f1 uu___10
                                ...
                                let uu___10 =
                                  let uu___11 =
                                    ...
                                    FStarC_TypeChecker_Env.set_range uu___12
                                      e.FStarC_Syntax_Syntax.pos in
                                  let uu___12 =
                                  ...
                                  strengthen_precondition
                                    (FStar_Pervasives_Native.Some
                                       (FStarC_TypeChecker_Err.subtyping_failed
                                          env
                                          lc.FStarC_TypeChecker_Common.res_typ
                                          t)) uu___11 e uu___12 uu___13 in
                                (match uu___10 with
                                 | (eq_ret, _trivial_so_ok_to_discard) ->
                                     ...
                                     let c1 =
                                       let uu___11 =
                                         FStarC_TypeChecker_Common.lcomp_of_comp
                                           c in
                                       bind e.FStarC_Syntax_Syntax.pos false
                                         env (FStar_Pervasives_Native.Some e)
                                         uu___11
                                         ((FStar_Pervasives_Native.Some x1),
                                           eq_ret) in
                                     let uu___11 =
            ...
            let flags =
              FStarC_List.collect
                (fun uu___2 ->
                   ...
                   | FStarC_Syntax_Syntax.PARTIAL_RETURN ->
                       [FStarC_Syntax_Syntax.PARTIAL_RETURN]
                   | FStarC_Syntax_Syntax.CPS -> [FStarC_Syntax_Syntax.CPS]
                   | uu___3 -> []) lc.FStarC_TypeChecker_Common.cflags in
            let lc1 =
              let uu___2 =
                FStarC_TypeChecker_Env.norm_eff_name env
                  lc.FStarC_TypeChecker_Common.eff_name in
              FStarC_TypeChecker_Common.mk_lcomp uu___2 t flags strengthen in
            let g2 =
              {
                FStarC_TypeChecker_Common.guard_f =
                  FStarC_TypeChecker_Common.Trivial;
...
let pure_or_ghost_pre_and_post (env : FStarC_TypeChecker_Env.env)
  ...
  if uu___
  then
    let uu___1 = FStarC_Syntax_Util.comp_result comp in
    (FStar_Pervasives_Native.None, uu___1)
  else
    (match comp.FStarC_Syntax_Syntax.n with
     ...
     | FStarC_Syntax_Syntax.Comp ct ->
         ...
         then
                ...
                let uu___4 =
                  let uu___5 =
                    FStarC_Class_Show.show FStarC_Syntax_Print.showable_comp
                      comp in
                  FStarC_Format.fmt1
                    "Effect constructor is not fully applied; got %s" uu___5 in
                FStarC_Errors.raise_error
           ...
           (let ct1 = FStarC_TypeChecker_Env.unfold_effect_abbrev env comp in
                            ...
                            let uu___10 =
                              let uu___11 =
                                ...
                                ((ct1.FStarC_Syntax_Syntax.result_typ),
                                  uu___12) in
                              let uu___12 =
                                let uu___13 = FStarC_Syntax_Syntax.as_arg wp in
                                [uu___13] in
                              uu___11 :: uu___12 in
        ...
        let rec aux env2 bs t2 =
          ...
          | (bs', t4) ->
              (match bs' with
               | [] -> bs
               | bs'1 ->
                   let uu___3 = FStarC_TypeChecker_Env.push_binders env2 bs'1 in
                   aux uu___3 (FStarC_List.op_At bs bs'1) t4) in
        aux env1 [] t1 in
            ...
            FStarC_Util.prefix_until
              (fun uu___3 ->
                 ...
                 | { FStarC_Syntax_Syntax.binder_bv = uu___4;
                     ...
                     (FStar_Pervasives_Native.uu___is_None imp) ||
      ...
      let inst_n_binders t1 =
        ...
        | FStar_Pervasives_Native.Some (expected_t, uu___3) ->
            ...
            then
              let uu___4 =
                let uu___5 =
                  let uu___6 = FStarC_Errors_Msg.text "Expected a term with " in
                  let uu___7 =
                    let uu___8 =
                      FStarC_Class_PP.pp FStarC_Class_PP.pp_int n_expected in
                    let uu___9 =
                      let uu___10 =
                        FStarC_Errors_Msg.text " implicit arguments, but " in
                      let uu___11 =
                        let uu___12 =
                          FStarC_Class_PP.pp FStarC_Syntax_Print.pretty_term
                            e in
                        let uu___13 =
                          let uu___14 = FStarC_Errors_Msg.text " has only " in
                          let uu___15 =
                            let uu___16 =
          ...
          (match bs with
           | uu___3::uu___4 ->
               let rec aux subst inst_n bs1 =
                 ...
                 | (FStar_Pervasives_Native.Some uu___5, uu___6) when
                 ...
                 | (uu___5,
                    { FStarC_Syntax_Syntax.binder_bv = uu___6;
                      ...
                      FStarC_Syntax_Syntax.binder_attrs = uu___9;_}::rest)
                     ->
                     ...
                     (match uu___10 with
                      | (tm, ty, aq, g) ->
                          let subst1 =
                            ...
                            :: subst in
                          let uu___11 = aux subst1 (decr_inst inst_n) rest in
                          (match uu___11 with
                           | (args, bs2, subst2, g') ->
                               let uu___12 =
               ...
               let uu___5 =
                 let uu___6 = inst_n_binders t1 in aux [] uu___6 bs in
               (match uu___5 with
                | (args, bs1, subst, guard) ->
                    (match (args, bs1) with
                     | ([], uu___6) -> (e, torig, guard)
                     | (uu___6, []) when
                         let uu___7 = FStarC_Syntax_Util.is_total_comp c in
                     ...
                     | uu___6 ->
                         let t2 =
                           ...
                           | uu___7 -> FStarC_Syntax_Util.arrow bs1 c in
                         let t3 = FStarC_Syntax_Subst.subst subst t2 in
                         let e1 =
                           FStarC_Syntax_Syntax.mk_Tm_app e args
                             e.FStarC_Syntax_Syntax.pos in
                         (e1, t3, guard)))
           | uu___3 -> (e, torig, FStarC_TypeChecker_Env.trivial_guard))))
let check_has_type (env : FStarC_TypeChecker_Env.env)
  ...
  | FStar_Pervasives_Native.None ->
      ...
      FStarC_TypeChecker_Err.expected_expression_of_type env1 uu___ t2 e t1
...
let check_top_level (env : FStarC_TypeChecker_Env.env)
  (g : FStarC_TypeChecker_Env.guard_t) (lc : FStarC_TypeChecker_Common.lcomp)
              ...
              (let c1 = FStarC_TypeChecker_Env.unfold_effect_abbrev env c in
               ...
               then
                 ...
                 let c2 =
                   ...
                   FStarC_TypeChecker_Normalize.normalize_comp steps env
                     uu___6 in
                 let top_level_eff_opt =
                   FStarC_TypeChecker_Env.get_top_level_effect env c_eff in
                 ...
                 | FStar_Pervasives_Native.Some top_level_eff ->
                     let uu___6 = FStarC_Ident.lid_equals top_level_eff c_eff in
                     (if uu___6
                      then let uu___7 = discharge g_c in (uu___7, ret_comp)
                      else
                        (let bc_opt =
                           FStarC_TypeChecker_Env.lookup_effect_abbrev env us
                             top_level_eff in
                         match bc_opt with
                         | FStar_Pervasives_Native.None ->
                             let uu___8 =
                               let uu___9 =
                                 FStarC_Ident.string_of_lid top_level_eff in
                               let uu___10 = FStarC_Ident.string_of_lid c_eff in
                               FStarC_Format.fmt2
                         ...
                         | FStar_Pervasives_Native.Some (bs, uu___8) ->
                             ...
                             let uu___9 = FStarC_Syntax_Subst.open_binders bs in
                             (match uu___9 with
                              | a::bs1 ->
                                  let uu___10 =
                                    let uu___11 =
                                      let uu___12 =
                                        let uu___13 =
                                          ...
                                          ((a.FStarC_Syntax_Syntax.binder_bv),
                                            uu___14) in
                                        FStarC_Syntax_Syntax.NT uu___13 in
                                      [uu___12] in
                                    let uu___12 =
                                      FStarC_TypeChecker_Env.get_range env in
                                    FStarC_TypeChecker_Env.uvars_for_binders
                                      ...
                                      (fun b ->
                                         ...
                                         then
                                           ...
                                           FStarC_Format.fmt2
                                             ...
                                             uu___13 uu___14
                                         else "check_top_level") uu___12 in
                                  (match uu___10 with
                                   | (uvs, g_uvs) ->
                                       let top_level_comp =
                                         let uu___11 =
                                         ...
                                         FStarC_Syntax_Syntax.mk_Comp uu___11 in
                                       let gopt =
                                         FStarC_TypeChecker_Rel.eq_comp env
                 ...
                 (let steps =
                  ...
                  match uu___7 with
                  | (ct, vc, g_pre) ->
                      ((let uu___9 = FStarC_Effect.op_Bang dbg_Simplification in
                        if uu___9
                        then
                          let uu___10 =
                            FStarC_Class_Show.show
                       ...
                       (let uu___9 =
                          let uu___10 =
                            ...
                            FStarC_TypeChecker_Env.conj_guard g1 uu___11 in
    ...
    | { FStarC_Syntax_Syntax.binder_bv = uu___1;
        ...
        (match q with
         | FStar_Pervasives_Native.Some (FStarC_Syntax_Syntax.Implicit
             uu___4) -> true
         | FStar_Pervasives_Native.Some (FStarC_Syntax_Syntax.Meta uu___4) ->
             true
         | uu___4 -> false) in
  let pos bs1 =
    match bs1 with
       ...
       | FStar_Pervasives_Native.Some (t, uu___2) ->
           ...
           (match uu___3 with
            | FStarC_Syntax_Syntax.Tm_arrow
                ...
                (match uu___5 with
                 | FStar_Pervasives_Native.None -> bs
                 | FStar_Pervasives_Native.Some ([], uu___6, uu___7) -> bs
        ...
        (match uu___2 with
         | (bs, c) ->
             ...
             (let uu___3 = FStarC_Syntax_Util.comp_effect_name c in
              FStarC_TypeChecker_Env.is_erasable_effect env1 uu___3) ||
...
let fresh_effect_repr (env : FStarC_TypeChecker_Env.env)
  ...
  let fail t =
    FStarC_TypeChecker_Err.unexpected_signature_for_monad env r eff_name t in
      ...
      (match uu___2 with
       | FStarC_Syntax_Syntax.Tm_arrow
           ...
           (match bs1 with
            | a::bs2 ->
                let uu___4 =
                  FStarC_TypeChecker_Env.uvars_for_binders env bs2
                    [FStarC_Syntax_Syntax.NT
                       ((a.FStarC_Syntax_Syntax.binder_bv), a_tm)]
                    (fun b ->
                       if debug
                       then
                         let uu___5 =
                           FStarC_Class_Show.show
                             FStarC_Syntax_Print.showable_binder b in
                         let uu___6 = FStarC_Ident.string_of_lid eff_name in
                         let uu___7 = FStarC_Range_Ops.string_of_range r in
                         FStarC_Format.fmt3
                     ...
                     let uu___5 =
                       ...
                       | FStar_Pervasives_Native.None ->
                           let eff_c =
                             let uu___6 =
                               let uu___7 =
                                 FStarC_List.map FStarC_Syntax_Syntax.as_arg
                                   is in
                               {
                                 FStarC_Syntax_Syntax.comp_univs = [u];
                                 FStarC_Syntax_Syntax.effect_name = eff_name;
                                 FStarC_Syntax_Syntax.result_typ = a_tm;
                           ...
                           let uu___6 =
                             let uu___7 =
                               let uu___8 =
                                 ...
                                 [uu___9] in
                               {
                                 FStarC_Syntax_Syntax.bs1 = uu___8;
                                 FStarC_Syntax_Syntax.comp = eff_c
                               } in
                             FStarC_Syntax_Syntax.Tm_arrow uu___7 in
                           ...
                           let is_args =
                             FStarC_List.map2
                               (fun i b ->
                                  ...
                                  (i, uu___6)) is bs2 in
                           let uu___6 =
                             let uu___7 = FStarC_Syntax_Syntax.as_arg a_tm in
                             uu___7 :: is_args in
                           FStarC_Syntax_Syntax.mk_Tm_app repr uu___6 r in
                     (uu___5, g))
...
let fresh_effect_repr_en (env : FStarC_TypeChecker_Env.env)
  ...
  let uu___1 =
    FStarC_Syntax_Util.effect_sig_ts uu___.FStarC_Syntax_Syntax.signature in
...
let layered_effect_indices_as_binders (env : FStarC_TypeChecker_Env.env)
  ...
  | (uu___1, sig_tm) ->
      let fail t =
        FStarC_TypeChecker_Err.unexpected_signature_for_monad env r eff_name
          t in
      let uu___2 =
      ...
      (match uu___2 with
       | FStarC_Syntax_Syntax.Tm_arrow
           ...
           (match bs1 with
            ...
            | uu___4 -> fail sig_tm)
       | uu___3 -> fail sig_tm)
let check_non_informative_type_for_lift (env : FStarC_TypeChecker_Env.env)
  (m1 : FStarC_Ident.lident) (m2 : FStarC_Ident.lident)
  (t : FStarC_Syntax_Syntax.term) (r : FStarC_Range_Type.t) : unit=
  let uu___ =
    ((FStarC_TypeChecker_Env.is_erasable_effect env m1) &&
       (let uu___1 = FStarC_TypeChecker_Env.is_erasable_effect env m2 in
        Prims.op_Negation uu___1))
      &&
      (let uu___1 = FStarC_TypeChecker_Normalize.non_info_norm env t in
       Prims.op_Negation uu___1) in
  if uu___
  then
    let uu___1 =
...
let substitutive_indexed_lift_substs (env : FStarC_TypeChecker_Env.env)
  (bs : FStarC_Syntax_Syntax.binders) (ct : FStarC_Syntax_Syntax.comp_typ)
  (lift_name : Prims.string) (r : FStarC_Range_Type.t) :
  (FStarC_Syntax_Syntax.subst_elt Prims.list *
    FStarC_TypeChecker_Env.guard_t)=
  let debug = FStarC_Effect.op_Bang dbg_LayeredEffectsApp in
  let uu___ =
  ...
  | (bs1, subst) ->
      let uu___1 =
        let m_num_effect_args =
          FStarC_List.length ct.FStarC_Syntax_Syntax.effect_args in
        let uu___2 = FStarC_List.splitAt m_num_effect_args bs1 in
        match uu___2 with
        | (f_bs, bs2) ->
            let f_subst =
              FStarC_List.map2
                (fun f_b uu___3 ->
                   ...
                   | (arg, uu___4) ->
                       FStarC_Syntax_Syntax.NT
                         ((f_b.FStarC_Syntax_Syntax.binder_bv), arg)) f_bs
                ct.FStarC_Syntax_Syntax.effect_args in
            (bs2, (FStarC_List.op_At subst f_subst)) in
      (match uu___1 with
       | (bs2, subst1) ->
           let bs3 =
             let uu___2 =
               FStarC_List.splitAt ((FStarC_List.length bs2) - Prims.int_one)
                 bs2 in
             FStar_Pervasives_Native.fst uu___2 in
           FStarC_List.fold_left
             (fun uu___2 b ->
                ...
                | (subst2, g) ->
                    let uu___3 =
                      FStarC_TypeChecker_Env.uvars_for_binders env [b] subst2
                        (fun b1 ->
                           if debug
                           then
                             let uu___4 =
                             ...
                             let uu___5 = FStarC_Range_Ops.string_of_range r in
                             FStarC_Format.fmt3
                    ...
                    (match uu___3 with
                     | (uv_t::[], g_uv) ->
                         ...
                         ((FStarC_List.op_At subst2
                             [FStarC_Syntax_Syntax.NT
                                ((b.FStarC_Syntax_Syntax.binder_bv), uv_t)]),
                           uu___4)))
             (subst1, FStarC_TypeChecker_Env.trivial_guard) bs3)
let ad_hoc_indexed_lift_substs (env : FStarC_TypeChecker_Env.env)
  (bs : FStarC_Syntax_Syntax.binders) (ct : FStarC_Syntax_Syntax.comp_typ)
  (lift_name : Prims.string) (r : FStarC_Range_Type.t) :
  (FStarC_Syntax_Syntax.subst_elt Prims.list *
    FStarC_TypeChecker_Env.guard_t)=
  ...
  let lift_t_shape_error s =
    FStarC_Format.fmt2 "Lift %s has unexpected shape, reason: %s" lift_name s in
  let uu___ =
       ...
       | (rest_bs_uvars, g) ->
           let substs =
             FStarC_List.map2
               ...
               ((ct.FStarC_Syntax_Syntax.result_typ) :: rest_bs_uvars) in
           let guard_f =
             let f_sort =
               let uu___2 =
             ...
             FStarC_List.fold_left2
               (fun g1 i1 i2 ->
                  let uu___3 =
                    FStarC_TypeChecker_Rel.layered_effect_teq env i1 i2
           ...
           (substs, uu___2))
let lift_tf_layered_effect (tgt : FStarC_Ident.lident)
  (lift_ts : FStarC_Syntax_Syntax.tscheme)
  (kind : FStarC_Syntax_Syntax.indexed_effect_combinator_kind)
  (env : FStarC_TypeChecker_Env.env) (c : FStarC_Syntax_Syntax.comp) :
  (FStarC_Syntax_Syntax.comp * FStarC_TypeChecker_Env.guard_t)=
  let debug = FStarC_Effect.op_Bang dbg_LayeredEffectsApp in
  if debug
  then
    (let uu___1 = FStarC_Class_Show.show FStarC_Syntax_Print.showable_comp c in
     let uu___2 = FStarC_Class_Show.show FStarC_Ident.showable_lident tgt in
     FStarC_Format.print2 "Lifting indexed comp %s to  %s {\n" uu___1 uu___2)
  else ();
  (let r = FStarC_TypeChecker_Env.get_range env in
   ...
   (let lift_name uu___2 =
      ...
      then
        let uu___3 =
          FStarC_Ident.string_of_lid ct.FStarC_Syntax_Syntax.effect_name in
        let uu___4 = FStarC_Ident.string_of_lid tgt in
        FStarC_Format.fmt2 "%s ~> %s" uu___3 uu___4
      else "" in
    let uu___2 =
      let uu___3 =
        let uu___4 = FStarC_List.hd ct.FStarC_Syntax_Syntax.comp_univs in
        [uu___4] in
             ...
             let uu___5 =
               ...
               then
                 ...
                 (let uu___7 = lift_name () in
                  substitutive_indexed_lift_substs env bs ct uu___7 r) in
             (match uu___5 with
              | (substs, g) ->
                  let lift_ct =
                    let uu___6 = FStarC_Syntax_Subst.subst_comp substs lift_c in
                    FStarC_TypeChecker_Env.comp_to_comp_typ env uu___6 in
                  let is =
                    let uu___6 =
                      FStarC_TypeChecker_Env.is_layered_effect env tgt in
                    effect_args_from_repr
                      lift_ct.FStarC_Syntax_Syntax.result_typ uu___6 r in
                  let fml =
                    let uu___6 =
                      let uu___7 =
                        FStarC_List.hd
                    ...
                    | (u, wp) ->
                        FStarC_TypeChecker_Env.pure_precondition_for_trivial_post
                          env u lift_ct.FStarC_Syntax_Syntax.result_typ wp
                          FStarC_Range_Type.dummyRange in
                  ((let uu___7 =
                      (FStarC_Effect.op_Bang dbg_LayeredEffects) &&
                        (FStarC_Debug.extreme ()) in
                    if uu___7
                    then
                      let uu___8 =
                      ...
                      FStarC_Format.print1 "Guard for lift is: %s" uu___8
                    else ());
                   (let c1 =
                      let uu___7 =
                        let uu___8 =
                    ...
                    then
                      (let uu___8 =
                         FStarC_Class_Show.show
                           FStarC_Syntax_Print.showable_comp c1 in
                       FStarC_Format.print1 "} Lifted comp: %s\n" uu___8)
                    else ();
                    (let g1 =
                       let uu___8 =
                         let uu___9 =
                     ...
                     (c1, g1))))))))
let lift_tf_layered_effect_term (env : 'uuuuu)
  (sub : FStarC_Syntax_Syntax.sub_eff) (u : FStarC_Syntax_Syntax.universe)
  (a : FStarC_Syntax_Syntax.typ) (e : FStarC_Syntax_Syntax.term) :
  FStarC_Syntax_Syntax.term=
  let lift =
    let uu___ =
      let uu___1 = FStarC_Option.must sub.FStarC_Syntax_Syntax.lift in
      FStarC_TypeChecker_Env.inst_tscheme_with uu___1 [u] in
    FStar_Pervasives_Native.snd uu___ in
  let rest_bs =
    let lift_t = FStarC_Option.must sub.FStarC_Syntax_Syntax.lift_wp in
    let uu___ =
      let uu___1 =
        FStarC_Syntax_Subst.compress (FStar_Pervasives_Native.snd lift_t) in
      uu___1.FStarC_Syntax_Syntax.n in
    match uu___ with
    | FStarC_Syntax_Syntax.Tm_arrow
        { FStarC_Syntax_Syntax.bs1 = uu___1::bs;
          FStarC_Syntax_Syntax.comp = uu___2;_}
        when (FStarC_List.length bs) >= Prims.int_one ->
        let uu___3 =
          FStarC_List.splitAt ((FStarC_List.length bs) - Prims.int_one) bs in
        FStar_Pervasives_Native.fst uu___3
    | uu___1 ->
        let uu___2 =
          let uu___3 = FStarC_Syntax_Print.tscheme_to_string lift_t in
          FStarC_Format.fmt1
            "lift_t tscheme %s is not an arrow with enough binders" uu___3 in
    ...
    let uu___1 =
      let uu___2 =
        FStarC_List.map
          ...
          rest_bs in
      let uu___3 = let uu___4 = FStarC_Syntax_Syntax.as_arg e in [uu___4] in
      FStarC_List.op_At uu___2 uu___3 in
    uu___ :: uu___1 in
  FStarC_Syntax_Syntax.mk
    (FStarC_Syntax_Syntax.Tm_app
       { FStarC_Syntax_Syntax.hd = lift; FStarC_Syntax_Syntax.args = args })
    e.FStarC_Syntax_Syntax.pos
...
let get_mlift_for_subeff (env : FStarC_TypeChecker_Env.env)
  (sub : FStarC_Syntax_Syntax.sub_eff) : FStarC_TypeChecker_Env.mlift=
  let uu___ =
    (FStarC_TypeChecker_Env.is_layered_effect env
  ...
  then
    let uu___1 =
      let uu___2 = FStarC_Option.must sub.FStarC_Syntax_Syntax.lift_wp in
      let uu___3 = FStarC_Option.must sub.FStarC_Syntax_Syntax.kind in
      lift_tf_layered_effect sub.FStarC_Syntax_Syntax.target uu___2 uu___3 in
    {
      FStarC_TypeChecker_Env.mlift_wp = uu___1;
      FStarC_TypeChecker_Env.mlift_term =
        (FStar_Pervasives_Native.Some (lift_tf_layered_effect_term env sub))
    }
  else
    (let mk_mlift_wp ts env1 c =
       let ct = FStarC_TypeChecker_Env.comp_to_comp_typ env1 c in
       check_non_informative_type_for_lift env1
         ct.FStarC_Syntax_Syntax.effect_name sub.FStarC_Syntax_Syntax.target
         ct.FStarC_Syntax_Syntax.result_typ env1.FStarC_TypeChecker_Env.range;
       (let uu___3 =
          FStarC_TypeChecker_Env.inst_tscheme_with ts
            ct.FStarC_Syntax_Syntax.comp_univs in
        match uu___3 with
        | (uu___4, lift_t) ->
            let wp = FStarC_List.hd ct.FStarC_Syntax_Syntax.effect_args in
            let uu___5 =
              let uu___6 =
                let uu___7 =
                  let uu___8 =
             ...
             let uu___5 =
               let uu___6 =
                 ...
                 let uu___8 =
                   ...
                   let uu___10 =
                     let uu___11 = FStarC_Syntax_Syntax.as_arg e in [uu___11] in
                   uu___9 :: uu___10 in
                 uu___7 :: uu___8 in
               {
                 FStarC_Syntax_Syntax.hd = lift_t;
     ...
     let uu___2 =
       let uu___3 = FStarC_Option.must sub.FStarC_Syntax_Syntax.lift_wp in
       mk_mlift_wp uu___3 in
     {
       ...
       FStarC_TypeChecker_Env.mlift_term =
         (match sub.FStarC_Syntax_Syntax.lift with
          | FStar_Pervasives_Native.None ->
              FStar_Pervasives_Native.Some ((fun uu___3 uu___4 e -> e))
    ...
    FStarC_TypeChecker_Env.update_effect_lattice
      {
        ...
        FStarC_TypeChecker_Env.missing_decl =
          (env.FStarC_TypeChecker_Env.missing_decl)
      } sub.FStarC_Syntax_Syntax.source sub.FStarC_Syntax_Syntax.target uu___ in
  {
    ...
    FStarC_TypeChecker_Env.is_iface = (env1.FStarC_TypeChecker_Env.is_iface);
    ...
    FStarC_TypeChecker_Env.failhard = (env1.FStarC_TypeChecker_Env.failhard);
    FStarC_TypeChecker_Env.flychecking =
    ...
    FStarC_TypeChecker_Env.nocoerce = (env1.FStarC_TypeChecker_Env.nocoerce);
    ...
    FStarC_TypeChecker_Env.proof_ns = (env1.FStarC_TypeChecker_Env.proof_ns);
    FStarC_TypeChecker_Env.synth_hook =
    ...
    FStarC_TypeChecker_Env.tc_hooks = (env1.FStarC_TypeChecker_Env.tc_hooks);
                             ...
                             | (uu___17, fields) ->
                                 ...
                                 let is_rec =
                                   FStarC_TypeChecker_Env.is_record env
                                     typename in
                                 let r =
                                   let uu___18 = FStarC_Ident.ident_of_lid dc in
                                   {
                                     FStarC_Syntax_DsEnv.typename = typename;
                                     FStarC_Syntax_DsEnv.constrname = uu___18;
...
let find_record_or_dc_from_typ (env : FStarC_TypeChecker_Env.env)
        ...
        (match uu___2 with
         ...
         | FStar_Pervasives_Native.None ->
             let uu___3 =
               ...
               FStarC_Format.fmt1 "Record name %s not found." uu___4 in
  ...
  let constrname =
    let name =
      let uu___ =
        let uu___1 = FStarC_Ident.ns_of_lid rdc.FStarC_Syntax_DsEnv.typename in
        FStarC_List.op_At uu___1 [rdc.FStarC_Syntax_DsEnv.constrname] in
...
let make_record_fields_in_order (env : FStarC_TypeChecker_Env.env)
  ...
  let debug uu___ =
    let print_rdc rdc1 =
      let uu___1 =
        FStarC_Ident.string_of_lid rdc1.FStarC_Syntax_DsEnv.typename in
      let uu___2 =
        FStarC_Ident.string_of_id rdc1.FStarC_Syntax_DsEnv.constrname in
      let uu___3 =
        let uu___4 =
          FStarC_List.map
            (fun uu___5 ->
               match uu___5 with | (i, uu___6) -> FStarC_Ident.string_of_id i)
            rdc1.FStarC_Syntax_DsEnv.fields in
        FStarC_String.concat "; " uu___4 in
      FStarC_Format.fmt3 "{typename=%s; constrname=%s; fields=[%s]}" uu___1
        uu___2 uu___3 in
