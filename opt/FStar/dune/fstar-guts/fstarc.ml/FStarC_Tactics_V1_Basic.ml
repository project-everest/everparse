...
let ret (uu___ : 'a) : 'a FStarC_Tactics_Monad.tac=
  (fun x ->
     Obj.magic
       (FStarC_Class_Monad.return FStarC_Tactics_Monad.monad_tac ()
          (Obj.magic x))) uu___
let bind (uu___2 : unit) (uu___1 : 'a FStarC_Tactics_Monad.tac)
  (uu___ : 'a -> 'b FStarC_Tactics_Monad.tac) : 'b FStarC_Tactics_Monad.tac=
  (fun uu___ ->
     Obj.magic
...
let debugging (uu___ : unit) : Prims.bool FStarC_Tactics_Monad.tac=
  ...
  uu___1 FStarC_Tactics_Monad.get
    (fun ps -> let uu___2 = FStarC_Effect.op_Bang dbg_Tac in ret uu___2)
...
let with_policy (pol : FStarC_Tactics_Types.guard_policy)
  (t : 'a FStarC_Tactics_Monad.tac) : 'a FStarC_Tactics_Monad.tac=
         ...
         (fun uu___4 ->
            ...
            uu___5 t
              (fun r ->
                 ...
                 let uu___7 = bind () in uu___7 uu___6 (fun uu___8 -> ret r))))
let proc_guard' (simplify : Prims.bool) (reason : Prims.string) (e : env)
  ...
  FStarC_Tactics_Monad.mlog
    ...
    (fun uu___ ->
       ...
       (match sc_opt with
        | FStar_Pervasives_Native.Some (FStarC_Syntax_Syntax.Allow_untyped r)
            ->
            FStarC_List.iter
              (fun imp ->
          ...
          (fun uu___3 ->
             (fun uu___3 ->
                ...
                let guard_f =
                  if simplify
                  then
                    let uu___4 = FStarC_TypeChecker_Rel.simplify_guard e g in
                    uu___4.FStarC_TypeChecker_Common.guard_f
                  else g.FStarC_TypeChecker_Common.guard_f in
                match guard_f with
                | FStarC_TypeChecker_Common.Trivial -> Obj.magic (ret ())
              ...
              | FStar_Pervasives.Inr failed ->
                  ...
                  let uu___4 =
                    FStarC_Class_Show.show FStarC_Syntax_Print.showable_term
                      sol in
                  let uu___5 = FStarC_TypeChecker_Core.print_error failed in
                  fail3
                    ...
                    (fun uu___5 ->
                       ...
                       | () ->
                           let res =
                             if allow_guards
                             then
                               FStarC_TypeChecker_Rel.try_teq true env1 t1 t2
                             else FStarC_TypeChecker_Rel.teq_nosmt env1 t1 t2 in
                           (if dbg
                            then
                              (let uu___7 =
                      ...
                      uu___5) ()
               with
               | FStarC_Errors.Error (uu___6, msg, r, uu___7) ->
                   FStarC_Tactics_Monad.mlog
                     (fun uu___8 ->
                        let uu___9 = FStarC_Errors_Msg.rendermsg msg in
                        let uu___10 =
                          FStarC_Class_Show.show
                            FStarC_Range_Ops.showable_range r in
                        FStarC_Format.print2
                          ">> do_unify error, (%s) at (%s)\n" uu___9 uu___10)
                     (fun uu___8 -> ret FStar_Pervasives_Native.None)) in
           ...
           (fun uu___2 ->
              (fun uu___2 ->
                 ...
                 | FStar_Pervasives.Inl exn ->
                     Obj.magic (FStarC_Tactics_Monad.traise exn)
                 | FStar_Pervasives.Inr v -> Obj.magic (ret v)) uu___2))))
    uu___6 uu___5 uu___4 uu___3 uu___2 uu___1 uu___
let __do_unify (allow_guards : Prims.bool) (must_tot : Prims.bool)
  (check_side : check_unifier_solved_implicits_side) (env1 : env)
  ...
  uu___ idtac
    (fun uu___1 ->
       (let uu___3 = FStarC_Effect.op_Bang dbg_TacUnify in
        ...
        then
          (FStarC_Options.push ();
           (let uu___5 = FStarC_Options.set_options "--debug Rel,RelCheck" in
            ()))
        else ());
       (let uu___3 =
          let uu___4 = FStarC_Effect.op_Bang dbg_TacUnify in
          __do_unify_wflags uu___4 allow_guards must_tot check_side env1 t1
            t2 in
        let uu___4 = bind () in
        uu___4 uu___3
          (fun r ->
             (let uu___6 = FStarC_Effect.op_Bang dbg_TacUnify in
              if uu___6 then FStarC_Options.pop () else ());
             ret r)))
let do_unify_aux (must_tot : Prims.bool)
  (check_side : check_unifier_solved_implicits_side) (env1 : env)
  (t1 : FStarC_Syntax_Syntax.term) (t2 : FStarC_Syntax_Syntax.term) :
  ...
  uu___1 uu___
    (fun uu___2 ->
       ...
       | FStar_Pervasives_Native.Some g ->
           ((let uu___4 =
               let uu___5 = FStarC_TypeChecker_Env.is_trivial_guard_formula g in
               Prims.op_Negation uu___5 in
             if uu___4
             then failwith "internal error: do_unify: guard is not trivial"
             else ());
            ret true))
...
let do_match (must_tot : Prims.bool) (env1 : FStarC_TypeChecker_Env.env)
  (t1 : FStarC_Syntax_Syntax.term) (t2 : FStarC_Syntax_Syntax.term) :
  Prims.bool FStarC_Tactics_Monad.tac=
  let uu___ =
    FStarC_Tactics_Monad.mk_tac
              ...
              let uu___4 =
                let uu___5 =
                  FStarC_Class_Setlike.equal ()
                    (Obj.magic
                       (FStarC_FlatSet.setlike_flat_set
                          FStarC_Syntax_Free.ord_ctx_uvar)) (Obj.magic uvs1)
                    (Obj.magic uvs2) in
                Prims.op_Negation uu___5 in
              (if uu___4
...
let do_match_on_lhs (must_tot : Prims.bool)
  (env1 : FStarC_TypeChecker_Env.env) (t1 : FStarC_Syntax_Syntax.term)
  ...
  uu___1 uu___
    (fun tx ->
       ...
       | FStar_Pervasives_Native.Some (lhs, uu___3) ->
           ...
           let uu___4 = do_unify_aux must_tot Check_right_only env1 t1 t2 in
           let uu___5 = bind () in
           uu___5 uu___4
             (fun r ->
                if r
         ...
         (fun b ->
            ...
            then
              ...
              (let uu___4 =
                 ...
                 FStarC_Format.fmt3 "%s does not solve %s : %s" uu___5 uu___6
                   uu___7 in
           ...
           (fun g ->
              (let uu___4 = FStarC_Tactics_Types.goal_type g in
               let uu___5 =
                 ...
                 FStarC_Format.fmt1 "Tactics admitted goal <%s>\n\n" uu___6 in
               FStarC_Errors.log_issue
...
let fresh (uu___ : unit) : Prims.int FStarC_Tactics_Monad.tac=
  ...
  uu___1 FStarC_Tactics_Monad.get
    (fun ps ->
       ...
       let uu___3 = bind () in uu___3 uu___2 (fun uu___4 -> ret n))
let curms (uu___ : unit) : Prims.int FStarC_Tactics_Monad.tac=
  let uu___1 = FStarC_Time.get_time_of_day_ms () in ret uu___1
let __tc (e : env) (t : FStarC_Syntax_Syntax.term) :
         ...
         (fun uu___1 ->
            ...
            try
              (fun uu___2 ->
                 ...
                 | () ->
                     let uu___3 =
                       FStarC_TypeChecker_TcTerm.typeof_tot_or_gtot_term e1 t
                         true in
                     ret uu___3) ()
            with
...
let __tc_ghost (e : env) (t : FStarC_Syntax_Syntax.term) :
  (FStarC_Syntax_Syntax.term * FStarC_Syntax_Syntax.typ *
    FStarC_TypeChecker_Common.guard_t) FStarC_Tactics_Monad.tac=
  let uu___ = bind () in
  uu___ FStarC_Tactics_Monad.get
            ...
            let e2 =
              {
                ...
                FStarC_TypeChecker_Env.nbe = (e1.FStarC_TypeChecker_Env.nbe);
                FStarC_TypeChecker_Env.strict_args_tab =
            ...
            try
              (fun uu___2 ->
                 ...
                 | () ->
                     ...
                     (match uu___3 with
                      | (t1, lc, g) ->
                          ret (t1, (lc.FStarC_TypeChecker_Common.res_typ), g)))
                ()
            with
            | FStarC_Errors.Error (uu___3, msg, uu___4, uu___5) ->
                ...
                fail3 "Cannot type (2) %s in context (%s). Error = (%s)"
                  uu___6 uu___7 uu___8))
let __tc_lax (e : env) (t : FStarC_Syntax_Syntax.term) :
            ...
            let e3 =
              {
                ...
                FStarC_TypeChecker_Env.nbe = (e2.FStarC_TypeChecker_Env.nbe);
                FStarC_TypeChecker_Env.strict_args_tab =
...
let tc (e : env) (t : FStarC_Syntax_Syntax.term) :
  ...
  let uu___ =
    ...
    let uu___2 = bind () in
    uu___2 uu___1
      (fun c -> let uu___3 = FStarC_Syntax_Util.comp_result c in ret uu___3) in
  FStarC_Tactics_Monad.wrap_err "tc" uu___
let divide (n : Prims.int) (l : 'a FStarC_Tactics_Monad.tac)
  (r : 'b FStarC_Tactics_Monad.tac) : ('a * 'b) FStarC_Tactics_Monad.tac=
  let uu___ = bind () in
  uu___ FStarC_Tactics_Monad.get
    (fun p ->
       let uu___1 =
         try
           (fun uu___2 ->
              ...
              | () ->
                  let uu___3 =
                    FStarC_List.splitAt n p.FStarC_Tactics_Types.goals in
                  ret uu___3) ()
         with
         | uu___2 -> FStarC_Tactics_Monad.fail "divide: not enough goals" in
       let uu___2 = bind () in
       uu___2 uu___1
         (fun uu___3 ->
            match uu___3 with
                ...
                let lp =
                  {
                    ...
                    FStarC_Tactics_Types.psc = (p.FStarC_Tactics_Types.psc);
                    FStarC_Tactics_Types.entry_range =
                               ...
                               uu___10 uu___9
                                 (fun uu___11 ->
                                    ...
                                    uu___12 r
                                      (fun b1 ->
                                         let uu___13 = bind () in
                                         uu___13 FStarC_Tactics_Monad.get
                                           (fun rp' ->
                                              let p' =
                                                {
                                                  FStarC_Tactics_Types.main_context
                                              ...
                                              uu___15 uu___14
                                                (fun uu___16 ->
                                                   ...
                                                   uu___17
                                                     ...
                                                     (fun uu___18 ->
                                                        ret (a1, b1)))))))))))
let focus (f : 'a FStarC_Tactics_Monad.tac) : 'a FStarC_Tactics_Monad.tac=
  let uu___ = divide Prims.int_one f idtac in
  let uu___1 = bind () in
  ...
  fun tau ->
    ...
    uu___ FStarC_Tactics_Monad.get
      (fun p ->
         ...
         | uu___1::uu___2 ->
             let uu___3 =
               let uu___4 = map tau in divide Prims.int_one tau uu___4 in
             let uu___4 = bind () in
             uu___4 uu___3
...
let intro (uu___ : unit) :
  FStarC_Syntax_Syntax.binder FStarC_Tactics_Monad.tac=
  let uu___1 =
    Obj.magic
      (FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
                             ...
                             Obj.repr
                               (let bv =
                                ...
                                let uu___6 =
                                  ...
                                  let uu___9 = goal_typedness_deps goal in
                          ...
                          | FStar_Pervasives_Native.None ->
                              Obj.repr
                                (let uu___3 = tts e ty11 in
                                 ...
                                 fail2 "Could not instantiate, %s to %s"
                                   uu___3 uu___4)
                          | FStar_Pervasives_Native.Some (b, c) ->
                              Obj.repr
                                (let uu___3 =
                 ...
                 | FStarC_Syntax_Syntax.Tm_uvar (ctx_uvar1, uu___4) ->
                     let gl1 =
                       ...
                       | FStar_Pervasives_Native.None ->
                           ...
                           FStarC_Tactics_Types.mk_goal env1 ctx_uvar1 uu___5
                             true "goal for unsolved implicit"
                       | FStar_Pervasives_Native.Some gl2 ->
                           {
                             FStarC_Tactics_Types.goal_main_env =
                               (gl2.FStarC_Tactics_Types.goal_main_env);
                             FStarC_Tactics_Types.goal_ctx_uvar = ctx_uvar1;
                             FStarC_Tactics_Types.opts =
...
let rec fold_left :
  ...
  fun f e xs ->
    ...
    | x::xs1 ->
        let uu___ = f x e in
        let uu___1 = bind () in uu___1 uu___ (fun e' -> fold_left f e' xs1)
...
let split_env (bvar : FStarC_Syntax_Syntax.bv) (e : env) :
  ...
  FStarC_Option.map
    ...
    uu___
let subst_goal (uu___2 : FStarC_Syntax_Syntax.bv)
  (uu___1 : FStarC_Syntax_Syntax.bv) (uu___ : FStarC_Tactics_Types.goal) :
  ...
  (fun b1 b2 g ->
     ...
     | FStar_Pervasives_Native.Some (e0, b11, bvs) ->
         Obj.magic
           (Obj.repr
              (let bs =
                 FStarC_List.map FStarC_Syntax_Syntax.mk_binder (b11 :: bvs) in
               ...
               | (bs', t') ->
                   let bs'1 =
                     ...
                     let uu___3 = FStarC_List.tail bs' in uu___2 :: uu___3 in
                   let uu___2 =
                     FStarC_TypeChecker_Core.open_binders_in_term e0 bs'1 t' in
                   (match uu___2 with
                    | (new_env, bs'', t'') ->
                        let b21 =
                        ...
                        let uu___3 =
                          ...
                          FStarC_Tactics_Monad.new_uvar "subst_goal" new_env
                            t'' uu___4 uu___5 (rangeof g) in
                        FStarC_Class_Monad.op_let_Bang
                          FStarC_Tactics_Monad.monad_tac () ()
                          (Obj.magic uu___3)
                          (fun uu___4 ->
                             (fun uu___4 ->
                               ...
                               uu___4))))
     | FStar_Pervasives_Native.None ->
         Obj.magic (Obj.repr (ret FStar_Pervasives_Native.None))) uu___2
    uu___1 uu___
let rewrite (h : FStarC_Syntax_Syntax.binder) :
  unit FStarC_Tactics_Monad.tac=
  let uu___ =
    FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
      (Obj.magic FStarC_Tactics_Monad.cur_goal)
                            ...
                            | FStar_Pervasives_Native.Some (x, e) ->
                                ...
                                (match uu___5 with
                                 | FStarC_Syntax_Syntax.Tm_name x1 ->
                                     ...
                                     let uu___6 =
                                       let uu___7 =
                                         FStarC_Syntax_Subst.close_binders bs in
                                       let uu___8 =
...
let rename_to (b : FStarC_Syntax_Syntax.binder) (s : Prims.string) :
  FStarC_Syntax_Syntax.binder FStarC_Tactics_Monad.tac=
  let uu___ =
    Obj.magic
      (FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
...
let binder_retype (b : FStarC_Syntax_Syntax.binder) :
  unit FStarC_Tactics_Monad.tac=
  let uu___ =
    FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
      (Obj.magic FStarC_Tactics_Monad.cur_goal)
...
let norm_binder_type (s : FStarC_NormSteps.norm_step Prims.list)
  (b : FStarC_Syntax_Syntax.binder) : unit FStarC_Tactics_Monad.tac=
  let uu___ =
    FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
      (Obj.magic FStarC_Tactics_Monad.cur_goal)
      (fun uu___1 ->
...
let free_in (bv : FStarC_Syntax_Syntax.bv) (t : FStarC_Syntax_Syntax.term) :
  ...
  FStarC_Class_Setlike.mem ()
    ...
    bv (Obj.magic uu___)
let clear (b : FStarC_Syntax_Syntax.binder) : unit FStarC_Tactics_Monad.tac=
  let bv = b.FStarC_Syntax_Syntax.binder_bv in
  FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
    (Obj.magic FStarC_Tactics_Monad.cur_goal)
    (fun uu___ ->
  ...
  let should_register_trefl g =
    ...
    then skip_register
      ...
      (let is_uvar_untyped_or_already_checked u =
       ...
       let uu___2 =
         FStarC_Util.for_all is_uvar_untyped_or_already_checked uvars in
       if uu___2
       then skip_register
       else
         (let uu___4 =
                        ...
                        let check_uvar_subtype u t3 =
                          ...
                          let uu___12 =
                            FStarC_TypeChecker_Core.compute_term_type_handle_guards
                              env1 t3 (fun uu___13 uu___14 -> true) in
                          match uu___12 with
                          ...
                          | FStar_Pervasives.Inl (uu___13, t_ty) ->
                              ...
                              (match uu___14 with
                               | FStar_Pervasives.Inl
                                   (FStar_Pervasives_Native.None) ->
                                   (mark_uvar_as_already_checked u; true)
                               | uu___15 -> false) in
                        let uu___12 =
...
let uvar_env (uu___1 : env)
  (uu___ : FStarC_Syntax_Syntax.typ FStar_Pervasives_Native.option) :
  FStarC_Syntax_Syntax.term FStarC_Tactics_Monad.tac=
  (fun env1 ty ->
     Obj.magic
       (FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
                ...
                let uu___ =
                  ...
                  | FStar_Pervasives_Native.Some ty1 ->
                      let env2 =
                        ...
                        FStarC_TypeChecker_Env.set_expected_typ env1 uu___1 in
...
let failwhen (b : Prims.bool) (msg : Prims.string) :
  unit FStarC_Tactics_Monad.tac=
  if b then FStarC_Tactics_Monad.fail msg else ret ()
...
let gather_explicit_guards_for_resolved_goals (uu___ : unit) :
  unit FStarC_Tactics_Monad.tac= ret ()
...
let rec inspect (t : FStarC_Syntax_Syntax.term) :
            ...
            (fun e ->
               ...
               | FStarC_Syntax_Syntax.Tm_uinst (t3, us) ->
                   ...
                   (match uu___2 with
                    | FStarC_Syntax_Syntax.Tm_fvar fv ->
                        Obj.magic
                          (ret (FStarC_Reflection_V1_Data.Tv_UInst (fv, us)))
                    | uu___3 ->
                        Obj.magic
                    ...
                    | (bs1, t4) ->
                        (match bs1 with
                         ...
                         | b::bs2 ->
                             let uu___3 =
                               let uu___4 =
                                 let uu___5 = FStarC_Syntax_Util.abs bs2 t4 k in
                                 (b, uu___5) in
               ...
               | FStarC_Syntax_Syntax.Tm_let
                   ...
                   then Obj.magic (ret FStarC_Reflection_V1_Data.Tv_Unsupp)
                     ...
                     (match lb.FStarC_Syntax_Syntax.lbname with
                      ...
                      | FStar_Pervasives.Inl bv ->
                          let b = FStarC_Syntax_Syntax.mk_binder bv in
                          let uu___3 = FStarC_Syntax_Subst.open_term [b] t21 in
                          (match uu___3 with
                           | (bs, t22) ->
                               let b1 =
                                 match bs with
               ...
               | FStarC_Syntax_Syntax.Tm_match
                   ...
                   let brs1 =
                     FStarC_List.map FStarC_Syntax_Subst.open_branch brs in
                   let brs2 =
                     FStarC_List.map
                       (fun uu___3 ->
                          match uu___3 with
...
let pack' (tv : FStarC_Reflection_V1_Data.term_view)
  (leave_curried : Prims.bool) :
  FStarC_Syntax_Syntax.term FStarC_Tactics_Monad.tac=
  match tv with
  ...
  | FStarC_Reflection_V1_Data.Tv_Abs (b, t) ->
      let uu___ = FStarC_Syntax_Util.abs [b] t FStar_Pervasives_Native.None in
      ret uu___
  ...
  | FStarC_Reflection_V1_Data.Tv_Let (false, attrs, bv, ty, t1, t2) ->
      ...
      let lb =
        FStarC_Syntax_Util.mk_letbinding (FStar_Pervasives.Inl bv1) []
          bv1.FStarC_Syntax_Syntax.sort FStarC_Parser_Const.effect_Tot_lid t1
          attrs FStarC_Range_Type.dummyRange in
      let uu___ =
        let uu___1 =
          let uu___2 =
            let uu___3 =
              let uu___4 =
                let uu___5 = FStarC_Syntax_Syntax.mk_binder bv1 in [uu___5] in
  ...
  | FStarC_Reflection_V1_Data.Tv_Match (t, ret_opt, brs) ->
      let wrap v =
        {
          ...
          FStarC_Syntax_Syntax.p = FStarC_Range_Type.dummyRange
        } in
      let rec pack_pat p =
        match p with
      ...
      let brs2 = FStarC_List.map FStarC_Syntax_Subst.close_branch brs1 in
      let uu___ =
        FStarC_Syntax_Syntax.mk
          (FStarC_Syntax_Syntax.Tm_match
             {
...
let pack (tv : FStarC_Reflection_V1_Data.term_view) :
  FStarC_Syntax_Syntax.term FStarC_Tactics_Monad.tac= pack' tv false
let pack_curried (tv : FStarC_Reflection_V1_Data.term_view) :
  FStarC_Syntax_Syntax.term FStarC_Tactics_Monad.tac= pack' tv true
...
let push_bv_dsenv (e : FStarC_TypeChecker_Env.env) (i : Prims.string) :
  (env * FStarC_Syntax_Syntax.bv) FStarC_Tactics_Monad.tac=
...
let term_to_string (t : FStarC_Syntax_Syntax.term) :
  Prims.string FStarC_Tactics_Monad.tac=
  let s = FStarC_Class_Show.show FStarC_Syntax_Print.showable_term t in ret s
let comp_to_string (c : FStarC_Syntax_Syntax.comp) :
  Prims.string FStarC_Tactics_Monad.tac=
  let s = FStarC_Class_Show.show FStarC_Syntax_Print.showable_comp c in ret s
let range_to_string (r : FStarC_Range_Type.t) :
  Prims.string FStarC_Tactics_Monad.tac=
                  ...
                  FStarC_List.map
                    (fun u ->
                       FStarC_Syntax_Unionfind.uvar_id
                         u.FStarC_Syntax_Syntax.ctx_uvar_head) uu___1 in
...
let refl_typing_builtin_wrapper (f : unit -> 'a) :
