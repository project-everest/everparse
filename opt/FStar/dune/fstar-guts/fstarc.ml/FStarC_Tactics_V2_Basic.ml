...
let subst_goal (uu___2 : FStarC_Syntax_Syntax.bv)
  ...
  (fun b1 b2 g ->
     ...
     | FStar_Pervasives_Native.Some (e0, b11, bvs) ->
         let bs = FStarC_List.map FStarC_Syntax_Syntax.mk_binder (b11 :: bvs) in
         let t = FStarC_Tactics_Types.goal_type g in
         let uu___1 =
           let uu___2 = FStarC_Syntax_Subst.close_binders bs in
           let uu___3 = FStarC_Syntax_Subst.close bs t in (uu___2, uu___3) in
         (match uu___1 with
          | (bs', t') ->
              let bs'1 =
               ...
               | (new_env, bs'', t'') ->
                   ...
                   let uu___3 =
                     let uu___4 =
                       ...
                       FStar_Pervasives_Native.Some uu___5 in
                     let uu___5 = FStarC_Tactics_Monad.goal_typedness_deps g in
                     FStarC_Tactics_Monad.new_uvar "subst_goal" new_env t''
     ...
     | FStar_Pervasives_Native.None ->
         Obj.magic
           (FStarC_Class_Monad.return FStarC_Tactics_Monad.monad_tac ()
              (Obj.magic FStar_Pervasives_Native.None))) uu___2 uu___1 uu___
...
let refl_typing_guard (e : env) (g : FStarC_Syntax_Syntax.typ) :
  unit FStarC_Tactics_Monad.tac=
...
let __refl_typing_builtin_wrapper
  (uu___ : unit -> ('a * refl_guard_t Prims.list)) :
  ('a FStar_Pervasives_Native.option * issues) FStarC_Tactics_Monad.tac=
  (fun f ->
     let tx = FStarC_Syntax_Unionfind.new_transaction () in
     let uu___ =
                  ...
                  dbg_refl g1
                    (fun uu___3 ->
                       let uu___4 =
                         FStarC_Class_Show.show
                           FStarC_Syntax_Print.showable_term e in
                       FStarC_Format.fmt1 "refl_check_prop_validity: %s\n"
                         uu___4);
                  (let must_tot = false in
                   (let uu___4 =
                      let uu___5 =
                      ...
                      FStarC_TypeChecker_Core.check_term g1 e uu___5 must_tot in
                    match uu___4 with
                    | FStar_Pervasives.Inl (FStar_Pervasives_Native.None) ->
                        ()
                    | FStar_Pervasives.Inl (FStar_Pervasives_Native.Some
                        ...
                        FStarC_TypeChecker_Rel.force_trivial_guard g1
                          {
                            FStarC_TypeChecker_Common.guard_f =
                              (FStarC_TypeChecker_Common.NonTrivial guard);
                            FStarC_TypeChecker_Common.deferred_to_tac =
                              (FStarC_TypeChecker_Env.trivial_guard.FStarC_TypeChecker_Common.deferred_to_tac);
                            FStarC_TypeChecker_Common.deferred =
                              (FStarC_TypeChecker_Env.trivial_guard.FStarC_TypeChecker_Common.deferred);
