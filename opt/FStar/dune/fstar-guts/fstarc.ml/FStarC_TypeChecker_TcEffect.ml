open Prims
let dbg : Prims.bool FStarC_Effect.ref= FStarC_Debug.get_toggle "ED"
let dbg_LayeredEffectsTc : Prims.bool FStarC_Effect.ref=
  FStarC_Debug.get_toggle "LayeredEffectsTc"
let dmff_cps_and_elaborate (env : FStarC_TypeChecker_Env.env)
  ...
  FStarC_TypeChecker_DMFF.cps_and_elaborate env ed
let check_and_gen (env : FStarC_TypeChecker_Env.env)
  (eff_name : Prims.string) (comb : Prims.string) (n : Prims.int)
  (uu___ : (FStarC_Syntax_Syntax.univ_names * FStarC_Syntax_Syntax.term)) :
      ...
      FStarC_Errors.with_ctx uu___1
        (fun uu___2 ->
           ...
           | (us1, t1) ->
               let uu___4 =
                 let uu___5 =
                   let uu___6 = FStarC_TypeChecker_Env.push_univ_vars env us1 in
                   FStarC_TypeChecker_TcTerm.tc_tot_or_gtot_term uu___6 t1 in
                 match uu___5 with
                 | (t2, lc, g) ->
               ...
               (match uu___4 with
                | (t2, ty) ->
                    let uu___5 =
                      FStarC_TypeChecker_Generalize.generalize_universes env
                        t2 in
                    (match uu___5 with
                     | (g_us, t3) ->
                         let ty1 =
                           FStarC_Syntax_Subst.close_univ_vars g_us ty in
                         (if (FStarC_List.length g_us) <> n
                          then
                            (let error =
                               let uu___6 =
                                 FStarC_Class_Show.show
                             ...
                             FStarC_Errors.raise_error
                               (FStarC_Syntax_Syntax.has_range_syntax ()) t3
                             ...
                             (match us1 with
                              ...
                              | uu___7 ->
                                  let uu___8 =
                                    ((FStarC_List.length us1) =
                                       (FStarC_List.length g_us))
                                      &&
                                      (FStarC_List.forall2
                                         (fun u1 u2 ->
                                            let uu___9 =
                                              FStarC_Syntax_Syntax.order_univ_name
                                                u1 u2 in
                                            uu___9 = Prims.int_zero) us1 g_us) in
                                  if uu___8
                                  then ()
                                  else
                                    (let uu___10 =
                                       ...
                                       FStarC_Format.fmt4
                                         ...
                                         eff_name comb uu___11 uu___12 in
                                     FStarC_Errors.raise_error
                          ...
                          (g_us, t3, ty1)))))
let pure_wp_uvar (env : FStarC_TypeChecker_Env.env)
  (t : FStarC_Syntax_Syntax.typ) (reason : Prims.string)
  ...
  let uu___ =
    FStarC_TypeChecker_Env.new_implicit_var_aux reason r env pure_wp_t
      FStarC_Syntax_Syntax.Strict FStar_Pervasives_Native.None false in
  match uu___ with
  | (pure_wp_uvar1, uu___1, guard_wp) -> (pure_wp_uvar1, guard_wp)
let op_let_Question (f : 'a FStar_Pervasives_Native.option)
  (g : 'a -> 'b FStar_Pervasives_Native.option) :
  'b FStar_Pervasives_Native.option=
  match f with
  | FStar_Pervasives_Native.None -> FStar_Pervasives_Native.None
  | FStar_Pervasives_Native.Some x -> g x
let mteq (env : FStarC_TypeChecker_Env.env) (t1 : FStarC_Syntax_Syntax.typ)
  (t2 : FStarC_Syntax_Syntax.typ) : Prims.bool=
  try
    (fun uu___ ->
       match () with | () -> FStarC_TypeChecker_Rel.teq_nosmt_force env t1 t2)
      ()
  with | uu___ -> false
let eq_binders (env : FStarC_TypeChecker_Env.env)
  (bs1 : FStarC_Syntax_Syntax.binders) (bs2 : FStarC_Syntax_Syntax.binders) :
           ...
           | (b, ss) ->
               ...
               let uu___4 =
                 let uu___5 =
                   ...
                   [uu___6] in
                 FStarC_List.op_At ss uu___5 in
...
let log_ad_hoc_combinator_warning (comb_name : Prims.string)
...
let bind_combinator_kind (env : FStarC_TypeChecker_Env.env)
  (m_eff_name : FStarC_Ident.lident) (n_eff_name : FStarC_Ident.lident)
  (p_eff_name : FStarC_Ident.lident)
  (m_sig_ts : FStarC_Syntax_Syntax.tscheme)
  (n_sig_ts : FStarC_Syntax_Syntax.tscheme)
  (p_sig_ts : FStarC_Syntax_Syntax.tscheme)
  (m_repr_ts : FStarC_Syntax_Syntax.tscheme FStar_Pervasives_Native.option)
  (n_repr_ts : FStarC_Syntax_Syntax.tscheme FStar_Pervasives_Native.option)
  (p_repr_ts : FStarC_Syntax_Syntax.tscheme FStar_Pervasives_Native.option)
  (bind_us : FStarC_Syntax_Syntax.univ_names) (k : FStarC_Syntax_Syntax.typ)
  ...
  let debug s =
    let uu___ =
      (FStarC_Debug.medium ()) ||
        (FStarC_Effect.op_Bang dbg_LayeredEffectsTc) in
    if uu___ then FStarC_Format.print1 "%s\n" s else () in
  (let uu___1 =
     let uu___2 =
       FStarC_Class_Show.show FStarC_Class_Show.showable_int
         num_effect_params in
     FStarC_Format.fmt1
       "Checking bind combinator kind with %s effect parameters" uu___2 in
   debug uu___1);
  (let uu___1 = bind_us in
   match uu___1 with
   | u_a::u_b::[] ->
       let uu___2 =
         let uu___3 = FStarC_Syntax_Util.arrow_formals k in
              ...
              then FStar_Pervasives_Native.Some ([], [], rest_bs)
                ...
                (let uu___5 =
                 ...
                 | (uu___6, sig1) ->
                     let sig_bs =
                       let uu___7 =
                         let uu___8 = FStarC_Syntax_Util.arrow_formals sig1 in
                         FStar_Pervasives_Native.fst uu___8 in
                       FStarC_List.tl uu___7 in
                     let uu___7 =
                       if (FStarC_List.length sig_bs) < num_effect_params
                       then FStar_Pervasives_Native.None
                       else
                         (let uu___9 =
                            let uu___10 =
                              FStarC_List.splitAt num_effect_params sig_bs in
                     ...
                     op_let_Question uu___7
                       (fun sig_eff_params_bs ->
                          let uu___8 =
                            if
                              (FStarC_List.length rest_bs) <
                                num_effect_params
                            then FStar_Pervasives_Native.None
                            else
                              (let uu___10 =
                                 FStarC_List.splitAt num_effect_params
                                   rest_bs in
                          ...
                          op_let_Question uu___8
                            (fun uu___9 ->
                               ...
                               | (eff_params_bs, rest_bs1) ->
                                   let uu___10 =
                                     eq_binders env sig_eff_params_bs
                                       eff_params_bs in
                                   op_let_Question uu___10
                                     (fun eff_params_bs_kinds ->
                                        FStar_Pervasives_Native.Some
                                          (eff_params_bs,
                                            eff_params_bs_kinds, rest_bs1))))) in
                       ...
                       let f_sig_bs =
                         ...
                         | (uu___7, sig1) ->
                             ...
                             (match uu___8 with
                              | a::bs ->
                                  let uu___9 =
                                    FStarC_List.splitAt num_effect_params bs in
                                  (match uu___9 with
                                   | (sig_bs, bs1) ->
                                       let ss =
                                         let uu___10 =
                                           let uu___11 =
                                             let uu___12 =
                                               ...
                                               ((a.FStarC_Syntax_Syntax.binder_bv),
                                                 uu___13) in
                                             FStarC_Syntax_Syntax.NT uu___12 in
                                           [uu___11] in
                                         FStarC_List.fold_left2
                                           (fun ss1 sig_b b ->
                                              let uu___11 =
                                                let uu___12 =
                                                  ...
                                                  FStarC_Syntax_Syntax.NT
                                                    uu___13 in
                                                [uu___12] in
                                              FStarC_List.op_At ss1 uu___11)
                                           uu___10 sig_bs eff_params_bs in
                                       FStarC_Syntax_Subst.subst_binders ss
                                         bs1)) in
                       let uu___6 =
                         if
                           (FStarC_List.length rest_bs1) <
                             (FStarC_List.length f_sig_bs)
                         then FStar_Pervasives_Native.None
                         else
                           (let uu___8 =
                              FStarC_List.splitAt
                                (FStarC_List.length f_sig_bs) rest_bs1 in
                            FStar_Pervasives_Native.Some uu___8) in
                       op_let_Question uu___6
                         (fun uu___7 ->
                            match uu___7 with
                            | (f_bs, rest_bs2) ->
                                let uu___8 = eq_binders env f_sig_bs f_bs in
                                op_let_Question uu___8
                                  (fun f_bs_kinds ->
                                     FStar_Pervasives_Native.Some
                                                       ...
                                                       let uu___13 =
                                                         let uu___14 =
                                                           ...
                                                           FStarC_Syntax_Syntax.NT
                                                             uu___15 in
                                                         [uu___14] in
                                                       FStarC_List.op_At ss1
                                                         uu___13) uu___12
                                                    sig_bs eff_params_bs in
                                                FStarC_Syntax_Subst.subst_binders
                                                  ss bs1)) in
                                let uu___8 =
                                  if
                                    (FStarC_List.length rest_bs2) <
                                      (FStarC_List.length g_sig_bs)
                                  then FStar_Pervasives_Native.None
                                  else
                                    (let uu___10 =
                                       FStarC_List.splitAt
                                                            ...
                                                            (fun _g_b_ok ->
                                                               ...
                                                               FStar_Pervasives_Native.Some
                                                                 (FStarC_List.op_At
                                                                    ...
                                                                    FStarC_Syntax_Syntax.Repr_binder])))))))))))))))
let validate_indexed_effect_bind_shape (env : FStarC_TypeChecker_Env.env)
  (m_eff_name : FStarC_Ident.lident) (n_eff_name : FStarC_Ident.lident)
  (p_eff_name : FStarC_Ident.lident)
  (m_sig_ts : FStarC_Syntax_Syntax.tscheme)
  (n_sig_ts : FStarC_Syntax_Syntax.tscheme)
  ...
  (n_repr_ts : FStarC_Syntax_Syntax.tscheme FStar_Pervasives_Native.option)
  (p_repr_ts : FStarC_Syntax_Syntax.tscheme FStar_Pervasives_Native.option)
  (bind_us : FStarC_Syntax_Syntax.univ_names)
  (bind_t : FStarC_Syntax_Syntax.typ) (r : FStarC_Range_Type.t)
  (num_effect_params : Prims.int) (has_range_binders : Prims.bool) :
  (FStarC_Syntax_Syntax.typ *
  ...
  let bind_name =
    ...
    let uu___2 = FStarC_Ident.string_of_lid p_eff_name in
    FStarC_Format.fmt3 "(%s , %s) |> %s" uu___ uu___1 uu___2 in
  ...
  | u_a::u_b::[] ->
      let a_b =
        let uu___1 =
          let uu___2 =
            FStarC_Syntax_Util.type_with_u (FStarC_Syntax_Syntax.U_name u_a) in
          FStarC_Syntax_Syntax.gen_bv "a" FStar_Pervasives_Native.None uu___2 in
        FStarC_Syntax_Syntax.mk_binder uu___1 in
      let b_b =
        let uu___1 =
          let uu___2 =
            FStarC_Syntax_Util.type_with_u (FStarC_Syntax_Syntax.U_name u_b) in
          FStarC_Syntax_Syntax.gen_bv "b" FStar_Pervasives_Native.None uu___2 in
        FStarC_Syntax_Syntax.mk_binder uu___1 in
      let rest_bs =
        let uu___1 =
          let uu___2 = FStarC_Syntax_Subst.compress bind_t in
          uu___2.FStarC_Syntax_Syntax.n in
        match uu___1 with
        | FStarC_Syntax_Syntax.Tm_arrow
            { FStarC_Syntax_Syntax.bs1 = bs;
              FStarC_Syntax_Syntax.comp = uu___2;_}
            when (FStarC_List.length bs) >= (Prims.of_int (4)) ->
                       ...
                       let uu___14 =
                         let uu___15 =
                           FStarC_Syntax_Syntax.bv_to_name
                             b_b.FStarC_Syntax_Syntax.binder_bv in
                         (b, uu___15) in
                       FStarC_Syntax_Syntax.NT uu___14 in
                     [uu___13] in
                   uu___11 :: uu___12 in
                 let uu___11 =
                   let uu___12 =
                     FStarC_List.splitAt
                       ((FStarC_List.length bs1) - (Prims.of_int (2))) bs1 in
                   FStar_Pervasives_Native.fst uu___12 in
                 FStarC_Syntax_Subst.subst_binders uu___10 uu___11)
        | uu___2 ->
            let uu___3 =
              let uu___4 =
                FStarC_Class_Show.show FStarC_Syntax_Print.showable_term
                  bind_t in
              FStarC_Format.fmt2
                "Type of %s is not an arrow with >= 4 binders (%s)" bind_name
                uu___4 in
      ...
      let uu___1 =
        if has_range_binders
        then
          (if (FStarC_List.length rest_bs) >= (Prims.of_int (2))
           then
             FStarC_List.splitAt
               ((FStarC_List.length rest_bs) - (Prims.of_int (2))) rest_bs
           else
             (let uu___3 =
                let uu___4 =
                  FStarC_Class_Show.show FStarC_Syntax_Print.showable_term
      ...
      (match uu___1 with
       | (rest_bs1, range_bs) ->
           let uu___2 =
             let uu___3 =
               let uu___4 =
                 FStarC_TypeChecker_Env.push_binders env (a_b :: b_b ::
                   rest_bs1) in
               let uu___5 =
                 FStarC_Syntax_Syntax.bv_to_name
                   a_b.FStarC_Syntax_Syntax.binder_bv in
               FStarC_TypeChecker_Util.fresh_effect_repr uu___4 r m_eff_name
                 m_sig_ts m_repr_ts (FStarC_Syntax_Syntax.U_name u_a) uu___5 in
             match uu___3 with
             | (repr, g) ->
                 let uu___4 =
                   let uu___5 =
                  ...
                  let uu___4 =
                    let uu___5 =
                      FStarC_TypeChecker_Env.push_binders env
                        (FStarC_List.op_At (a_b :: b_b :: rest_bs1) [x_a]) in
                    let uu___6 =
                      FStarC_Syntax_Syntax.bv_to_name
                        b_b.FStarC_Syntax_Syntax.binder_bv in
                    FStarC_TypeChecker_Util.fresh_effect_repr uu___5 r
                      n_eff_name n_sig_ts n_repr_ts
                      (FStarC_Syntax_Syntax.U_name u_b) uu___6 in
                  match uu___4 with
                  | (repr, g) ->
                      let uu___5 =
                        let uu___6 =
                          let uu___7 =
                            let uu___8 = FStarC_Syntax_Syntax.mk_Total repr in
                            FStarC_Syntax_Util.arrow [x_a] uu___8 in
                          ...
                          let uu___5 =
                            ...
                            let uu___7 =
                              FStarC_Format.fmt1
                                ...
                                bind_name in
                            pure_wp_uvar uu___6 return_repr uu___7 r in
                          (match uu___5 with
                           | (pure_wp_uvar1, g_pure_wp_uvar) ->
                               let k =
                                 let uu___6 =
                                   let uu___7 =
                                     let uu___8 =
                                       let uu___9 =
                                         FStarC_TypeChecker_Env.new_u_univ () in
                                       [uu___9] in
                                     let uu___9 =
                                       let uu___10 =
                                         FStarC_Syntax_Syntax.as_arg
                                 ...
                                 FStarC_Syntax_Util.arrow (a_b :: b_b ::
                                   (FStarC_List.op_At rest_bs1
                                      (FStarC_List.op_At range_bs [f; g])))
                                   uu___6 in
                               let guard_eq =
                                 let uu___6 =
                                   FStarC_TypeChecker_Rel.teq_nosmt env k
                                     bind_t in
                                 match uu___6 with
                                 | FStar_Pervasives_Native.None ->
                                     let uu___7 =
                               ...
                               ((let uu___7 =
                                ...
                                (let k1 =
                                 ...
                                 let lopt =
                                   bind_combinator_kind env m_eff_name
                                     n_eff_name p_eff_name m_sig_ts n_sig_ts
                                     p_sig_ts m_repr_ts n_repr_ts p_repr_ts
                                     bind_us k1 num_effect_params
                                 ...
                                 (k1, kind))))))))
let subcomp_combinator_kind (env : FStarC_TypeChecker_Env.env)
  (m_eff_name : FStarC_Ident.lident) (n_eff_name : FStarC_Ident.lident)
  (m_sig_ts : FStarC_Syntax_Syntax.tscheme)
  (n_sig_ts : FStarC_Syntax_Syntax.tscheme)
  (m_repr_ts : FStarC_Syntax_Syntax.tscheme FStar_Pervasives_Native.option)
  (n_repr_ts : FStarC_Syntax_Syntax.tscheme FStar_Pervasives_Native.option)
  (u : FStarC_Syntax_Syntax.univ_name) (k : FStarC_Syntax_Syntax.typ)
  (num_effect_params : Prims.int) :
  FStarC_Syntax_Syntax.indexed_effect_combinator_kind
    FStar_Pervasives_Native.option=
      ...
      let uu___1 =
        ...
        then FStar_Pervasives_Native.Some ([], [], rest_bs)
          ...
          (let uu___3 =
           ...
           match uu___3 with
           | (uu___4, sig1) ->
               let uu___5 = FStarC_Syntax_Util.arrow_formals sig1 in
               (match uu___5 with
                | (uu___6::sig_bs, uu___7) ->
                    let sig_effect_params_bs =
                      ...
                      FStar_Pervasives_Native.fst uu___8 in
                    let uu___8 =
                      FStarC_List.splitAt num_effect_params rest_bs in
                    (match uu___8 with
                     | (eff_params_bs, rest_bs1) ->
                         let uu___9 =
                           eq_binders env sig_effect_params_bs eff_params_bs in
           ...
           | (eff_params_bs, eff_params_bs_kinds, rest_bs1) ->
               let uu___3 =
                 let f_sig_bs =
                   ...
                   | (uu___5, sig1) ->
                       let uu___6 =
                         let uu___7 = FStarC_Syntax_Util.arrow_formals sig1 in
                                        ...
                                        let uu___9 =
                                          let uu___10 =
                                            let uu___11 =
                                              ...
                                              ((sig_b.FStarC_Syntax_Syntax.binder_bv),
                                                uu___12) in
                                            FStarC_Syntax_Syntax.NT uu___11 in
                                          [uu___10] in
                                        FStarC_List.op_At ss1 uu___9) uu___8
                                     sig_bs eff_params_bs in
                                 FStarC_Syntax_Subst.subst_binders ss bs1)) in
                 let uu___4 =
                   if
                     (FStarC_List.length rest_bs1) <
                       (FStarC_List.length f_sig_bs)
                   then FStar_Pervasives_Native.None
                     ...
                     (let uu___6 =
                        FStarC_List.splitAt (FStarC_List.length f_sig_bs)
                          rest_bs1 in
                 ...
                 op_let_Question uu___4
                   (fun uu___5 ->
                      match uu___5 with
                      | (f_bs, rest_bs2) ->
                          let uu___6 = eq_binders env f_sig_bs f_bs in
                          op_let_Question uu___6
                            (fun f_bs_kinds ->
                               FStar_Pervasives_Native.Some
                                 (f_bs, f_bs_kinds, rest_bs2))) in
               op_let_Question uu___3
                 (fun uu___4 ->
                    ...
                    | (f_bs, f_bs_kinds, rest_bs2) ->
                        let uu___5 =
                          if (FStarC_List.length rest_bs2) >= Prims.int_one
                          then
                            let uu___6 =
                              FStarC_List.splitAt
                                ((FStarC_List.length rest_bs2) -
                                   Prims.int_one) rest_bs2 in
                            match uu___6 with
                            | (rest_bs3, f_b::[]) ->
                                FStar_Pervasives_Native.Some (rest_bs3, f_b)
                             ...
                             | (rest_bs3, f_b) ->
                                 ...
                                 op_let_Question uu___7
                                   (fun _f_b_ok_ ->
                                      ...
                                      let uu___8 =
                                        let uu___9 = check_ret_t f_bs in
                                      ...
                                      then
                                        ...
                                        (let uu___10 =
                                         ...
                                         op_let_Question uu___10
                                           (fun uu___11 ->
                                              match uu___11 with
                                              | (g_bs, g_bs_kinds, rest_bs4)
                                                  ->
                                                  let uu___12 =
                                                    check_ret_t g_bs in
                                                  op_let_Question uu___12
                                                    (fun _ret_t_ok_ ->
                                                       let rest_kinds =
                                                         FStarC_List.map
                                                           (fun uu___13 ->
                                                            ...
                                                            (FStarC_List.op_At
                                                               ...
                                                               (FStarC_List.op_At
                                                                  ...
                                                                  (FStarC_List.op_At
                                                                    ...
                                                                    rest_kinds
                                                                    [FStarC_Syntax_Syntax.Repr_binder])))))))))))))
let validate_indexed_effect_subcomp_shape (env : FStarC_TypeChecker_Env.env)
  (m_eff_name : FStarC_Ident.lident) (n_eff_name : FStarC_Ident.lident)
  (m_sig_ts : FStarC_Syntax_Syntax.tscheme)
  (n_sig_ts : FStarC_Syntax_Syntax.tscheme)
  (m_repr_ts : FStarC_Syntax_Syntax.tscheme FStar_Pervasives_Native.option)
  (n_repr_ts : FStarC_Syntax_Syntax.tscheme FStar_Pervasives_Native.option)
  (u : FStarC_Syntax_Syntax.univ_name) (subcomp_t : FStarC_Syntax_Syntax.typ)
  ...
  let a_b =
    let uu___ =
      let uu___1 =
        FStarC_Syntax_Util.type_with_u (FStarC_Syntax_Syntax.U_name u) in
      FStarC_Syntax_Syntax.gen_bv "a" FStar_Pervasives_Native.None uu___1 in
    FStarC_Syntax_Syntax.mk_binder uu___ in
  let rest_bs =
    let uu___ =
      let uu___1 = FStarC_Syntax_Subst.compress subcomp_t in
        ...
        (match uu___2 with
         | { FStarC_Syntax_Syntax.binder_bv = a;
             ...
             let uu___7 =
               let uu___8 =
                 FStarC_List.splitAt
                   ((FStarC_List.length bs1) - Prims.int_one) bs1 in
               FStar_Pervasives_Native.fst uu___8 in
             FStarC_Syntax_Subst.subst_binders uu___6 uu___7)
    | uu___1 ->
        let uu___2 =
          let uu___3 =
            FStarC_Class_Show.show FStarC_Syntax_Print.showable_term
              subcomp_t in
          FStarC_Format.fmt2
            "Type of %s is not an arrow with >= 2 binders (%s)" subcomp_name
            uu___3 in
        FStarC_Errors.raise_error FStarC_Class_HasRange.hasRange_range r
          FStarC_Errors_Codes.Fatal_UnexpectedEffect ()
          (Obj.magic FStarC_Errors_Msg.is_error_message_string)
  ...
  let uu___ =
    let uu___1 =
      let uu___2 = FStarC_TypeChecker_Env.push_binders env (a_b :: rest_bs) in
      let uu___3 =
        FStarC_Syntax_Syntax.bv_to_name a_b.FStarC_Syntax_Syntax.binder_bv in
      FStarC_TypeChecker_Util.fresh_effect_repr uu___2 r m_eff_name m_sig_ts
        m_repr_ts (FStarC_Syntax_Syntax.U_name u) uu___3 in
    match uu___1 with
    | (repr, g) ->
        let uu___2 =
          let uu___3 =
            FStarC_Syntax_Syntax.gen_bv "f" FStar_Pervasives_Native.None repr in
  ...
  | (f, guard_f) ->
      let uu___1 =
        ...
        let uu___3 =
          FStarC_Syntax_Syntax.bv_to_name a_b.FStarC_Syntax_Syntax.binder_bv in
        FStarC_TypeChecker_Util.fresh_effect_repr uu___2 r n_eff_name
          n_sig_ts n_repr_ts (FStarC_Syntax_Syntax.U_name u) uu___3 in
      (match uu___1 with
       | (ret_t, guard_ret_t) ->
           let uu___2 =
             let uu___3 =
               FStarC_TypeChecker_Env.push_binders env (a_b :: rest_bs) in
             let uu___4 =
               FStarC_Format.fmt1 "implicit for pure_wp in checking %s"
                 subcomp_name in
           ...
           (match uu___2 with
            | (pure_wp_uvar1, guard_wp) ->
                let c =
                  let uu___3 =
                    let uu___4 =
                      let uu___5 = FStarC_TypeChecker_Env.new_u_univ () in
                      [uu___5] in
                    let uu___5 =
                      let uu___6 = FStarC_Syntax_Syntax.as_arg pure_wp_uvar1 in
                      [uu___6] in
                    {
                      FStarC_Syntax_Syntax.comp_univs = uu___4;
                      FStarC_Syntax_Syntax.effect_name =
                        FStarC_Parser_Const.effect_PURE_lid;
                      FStarC_Syntax_Syntax.result_typ = ret_t;
                ...
                let k =
                  FStarC_Syntax_Util.arrow
                    (FStarC_List.op_At (a_b :: rest_bs) [f]) c in
                ((let uu___4 =
                    (FStarC_Debug.medium ()) ||
                      (FStarC_Effect.op_Bang dbg_LayeredEffectsTc) in
                  if uu___4
                  then
                    let uu___5 =
                      FStarC_Class_Show.show
                        FStarC_Syntax_Print.showable_term k in
                 ...
                 (let guard_eq =
                    let uu___4 =
                      FStarC_TypeChecker_Rel.teq_nosmt env subcomp_t k in
                    match uu___4 with
                    | FStar_Pervasives_Native.None ->
                        let uu___5 =
                          let uu___6 =
                            FStarC_Class_Show.show
                              FStarC_Syntax_Print.showable_term subcomp_t in
                          FStarC_Format.fmt2 "Unexpected type of %s (%s)\n"
                  ...
                  (let uu___5 =
                     FStarC_TypeChecker_Env.conj_guards
                       [guard_f; guard_ret_t; guard_wp; guard_eq] in
                   FStarC_TypeChecker_Rel.force_trivial_guard env uu___5);
                  (let k1 =
                     let uu___5 =
                       FStarC_TypeChecker_Normalize.remove_uvar_solutions env
                         k in
                     FStarC_Syntax_Subst.compress uu___5 in
                   let kopt =
                     subcomp_combinator_kind env m_eff_name n_eff_name
                       m_sig_ts n_sig_ts m_repr_ts n_repr_ts u k1
                       num_effect_params in
                   let kind =
                     match kopt with
                     | FStar_Pervasives_Native.None ->
                    ...
                    then
                      let uu___7 =
                        FStarC_Class_Show.show
                          FStarC_Syntax_Syntax.showable_indexed_effect_combinator_kind
                          kind in
                      FStarC_Format.print2 "Subcomp %s has %s kind\n"
                        subcomp_name uu___7
                    else ());
                   (k1, kind))))))
let ite_combinator_kind (env : FStarC_TypeChecker_Env.env)
  (eff_name : FStarC_Ident.lident) (sig_ts : FStarC_Syntax_Syntax.tscheme)
  (repr_ts : FStarC_Syntax_Syntax.tscheme)
  (u : FStarC_Syntax_Syntax.univ_name) (tm : FStarC_Syntax_Syntax.term)
  (num_effect_params : Prims.int) :
  FStarC_Syntax_Syntax.indexed_effect_combinator_kind
    FStar_Pervasives_Native.option=
           ...
           | (eff_params_bs, eff_params_bs_kinds, rest_bs1) ->
               let uu___5 =
                 let f_sig_bs =
                   ...
                   | (uu___7, sig1) ->
                       let uu___8 =
                         let uu___9 = FStarC_Syntax_Util.arrow_formals sig1 in
                         FStar_Pervasives_Native.fst uu___9 in
                       (match uu___8 with
                        | a::bs ->
                            let uu___9 =
                                           ...
                                           let uu___14 =
                                             FStarC_List.map
                                               ...
                                               (FStarC_List.op_At
                                                  eff_params_bs f_bs) in
                                           uu___13 :: uu___14 in
                                         FStarC_Syntax_Syntax.mk_Tm_app t
                                           uu___12
                                           FStarC_Range_Type.dummyRange in
                                   let uu___10 =
                                     let uu___11 =
                                                            ...
                                                            (FStarC_List.op_At
                                                               ...
                                                               (FStarC_List.op_At
                                                                  ...
                                                                  (FStarC_List.op_At
                                                                    ...
                                                                    FStarC_Syntax_Syntax.Repr_binder;
                                                                    FStarC_Syntax_Syntax.Substitutive_binder])))))))))))))
let validate_indexed_effect_ite_shape (env : FStarC_TypeChecker_Env.env)
  (eff_name : FStarC_Ident.lident) (sig_ts : FStarC_Syntax_Syntax.tscheme)
  (repr_ts : FStarC_Syntax_Syntax.tscheme)
  (u : FStarC_Syntax_Syntax.univ_name) (ite_ty : FStarC_Syntax_Syntax.typ)
  (ite_tm : FStarC_Syntax_Syntax.term) (num_effect_params : Prims.int)
  (r : FStarC_Range_Type.t) :
  (FStarC_Syntax_Syntax.term *
    FStarC_Syntax_Syntax.indexed_effect_combinator_kind)=
  let ite_name =
    let uu___ = FStarC_Ident.string_of_lid eff_name in
    FStarC_Format.fmt1 "ite_%s" uu___ in
  let a_b =
    let uu___ =
      let uu___1 =
        FStarC_Syntax_Util.type_with_u (FStarC_Syntax_Syntax.U_name u) in
  ...
  let rest_bs =
    ...
    | uu___1 ->
        let uu___2 =
          let uu___3 =
            FStarC_Class_Show.show FStarC_Syntax_Print.showable_term ite_ty in
          FStarC_Format.fmt2
            "Type of %s is not an arrow with >= 4 binders (%s)" ite_name
            uu___3 in
        FStarC_Errors.raise_error FStarC_Class_HasRange.hasRange_range r
          FStarC_Errors_Codes.Fatal_UnexpectedEffect ()
          (Obj.magic FStarC_Errors_Msg.is_error_message_string)
  ...
  let uu___ =
    let uu___1 =
      ...
      let uu___3 =
        FStarC_Syntax_Syntax.bv_to_name a_b.FStarC_Syntax_Syntax.binder_bv in
      FStarC_TypeChecker_Util.fresh_effect_repr uu___2 r eff_name sig_ts
        (FStar_Pervasives_Native.Some repr_ts)
      ...
      let uu___1 =
        let uu___2 =
          ...
          let uu___4 =
            FStarC_Syntax_Syntax.bv_to_name
              a_b.FStarC_Syntax_Syntax.binder_bv in
          FStarC_TypeChecker_Util.fresh_effect_repr uu___3 r eff_name sig_ts
            (FStar_Pervasives_Native.Some repr_ts)
        ...
        | (repr, g) ->
            let uu___3 =
              let uu___4 =
                FStarC_Syntax_Syntax.gen_bv "g" FStar_Pervasives_Native.None
                  repr in
              FStarC_Syntax_Syntax.mk_binder uu___4 in
            (uu___3, g) in
      (match uu___1 with
       | (g, guard_g) ->
           ...
           let uu___2 =
             let uu___3 =
               FStarC_TypeChecker_Env.push_binders env
                 (FStarC_List.op_At (a_b :: rest_bs) [p]) in
             let uu___4 =
               FStarC_Syntax_Syntax.bv_to_name
                 a_b.FStarC_Syntax_Syntax.binder_bv in
             FStarC_TypeChecker_Util.fresh_effect_repr uu___3 r eff_name
               sig_ts (FStar_Pervasives_Native.Some repr_ts)
               (FStarC_Syntax_Syntax.U_name u) uu___4 in
           (match uu___2 with
            | (body_tm, guard_body) ->
                let k =
                  FStarC_Syntax_Util.abs
                    (FStarC_List.op_At (a_b :: rest_bs) [f; g; p]) body_tm
                    FStar_Pervasives_Native.None in
                let guard_eq =
                  let uu___3 = FStarC_TypeChecker_Rel.teq_nosmt env ite_tm k in
                  match uu___3 with
                  | FStar_Pervasives_Native.None ->
                      let uu___4 =
                        let uu___5 =
                          FStarC_Class_Show.show
                            FStarC_Syntax_Print.showable_term ite_tm in
                        FStarC_Format.fmt2 "Unexpected term for %s (%s)\n"
                          ite_name uu___5 in
                      FStarC_Errors.raise_error
                        FStarC_Class_HasRange.hasRange_range r
                        FStarC_Errors_Codes.Fatal_UnexpectedEffect ()
                ...
                ((let uu___4 =
                    FStarC_TypeChecker_Env.conj_guards
                      [guard_f; guard_g; guard_body; guard_eq] in
                  FStarC_TypeChecker_Rel.force_trivial_guard env uu___4);
                 (let k1 =
                    let uu___4 =
                      FStarC_TypeChecker_Normalize.remove_uvar_solutions env
                        k in
                  ...
                  let kopt =
                    ite_combinator_kind env eff_name sig_ts repr_ts u k1
                      num_effect_params in
                  let kind =
                    match kopt with
                    | FStar_Pervasives_Native.None ->
                   ...
                   then
                     let uu___6 =
                       FStarC_Class_Show.show
                         FStarC_Syntax_Syntax.showable_indexed_effect_combinator_kind
                         kind in
                     FStarC_Format.print2 "Ite %s has %s kind\n" ite_name
                       uu___6
                   else ());
                  (k1, kind)))))
let validate_indexed_effect_close_shape (env : FStarC_TypeChecker_Env.env)
  (eff_name : FStarC_Ident.lident) (sig_ts : FStarC_Syntax_Syntax.tscheme)
  (repr_ts : FStarC_Syntax_Syntax.tscheme)
  (u_a : FStarC_Syntax_Syntax.univ_name)
  (u_b : FStarC_Syntax_Syntax.univ_name)
  (close_tm : FStarC_Syntax_Syntax.term) (num_effect_params : Prims.int)
  (r : FStarC_Range_Type.t) : FStarC_Syntax_Syntax.term=
  let close_name =
    let uu___ = FStarC_Ident.string_of_lid eff_name in
    FStarC_Format.fmt1 "close_%s" uu___ in
  let b_b =
    let uu___ =
      let uu___1 =
        FStarC_Syntax_Util.type_with_u (FStarC_Syntax_Syntax.U_name u_b) in
      FStarC_Syntax_Syntax.gen_bv "b" FStar_Pervasives_Native.None uu___1 in
    FStarC_Syntax_Syntax.mk_binder uu___ in
  let uu___ =
    let uu___1 =
      let uu___2 =
  ...
  match uu___ with
  | a_b::sig_bs ->
      let uu___1 = FStarC_List.splitAt num_effect_params sig_bs in
      (match uu___1 with
       | (eff_params_bs, sig_bs1) ->
             ...
             FStarC_List.map
               (fun b ->
                  let x_b =
                    ...
                    FStarC_Syntax_Syntax.mk_binder uu___2 in
                  let uu___2 =
                    let uu___3 = b.FStarC_Syntax_Syntax.binder_bv in
                    let uu___4 =
                      let uu___5 =
                        FStarC_Syntax_Syntax.mk_Total
             ...
             | (uu___3, repr_t) ->
                 ...
                 let is_args =
                   FStarC_List.map
                     (fun uu___4 ->
                        match uu___4 with
                        | { FStarC_Syntax_Syntax.binder_bv = binder_bv;
                            ...
                            let uu___8 =
                              let uu___9 =
                                FStarC_Syntax_Syntax.bv_to_name binder_bv in
                              let uu___10 =
                                let uu___11 =
                                  let uu___12 =
                                    FStarC_Syntax_Syntax.bv_to_name
                                ...
                                [uu___11] in
                              FStarC_Syntax_Syntax.mk_Tm_app uu___9 uu___10
                                FStarC_Range_Type.dummyRange in
                            FStarC_Syntax_Syntax.as_arg uu___8) bs in
                 let repr_app =
                   let uu___4 =
                     let uu___5 =
                       let uu___6 =
                     ...
                     uu___5 :: is_args in
                   FStarC_Syntax_Syntax.mk_Tm_app repr_t uu___4
                     FStarC_Range_Type.dummyRange in
                 let f_sort =
                   let uu___4 = FStarC_Syntax_Syntax.mk_Total repr_app in
           ...
           let env1 =
             FStarC_TypeChecker_Env.push_binders env (a_b :: b_b ::
               (FStarC_List.op_At eff_params_bs bs)) in
           let uu___2 =
             let uu___3 =
               FStarC_Syntax_Syntax.bv_to_name
                 a_b.FStarC_Syntax_Syntax.binder_bv in
             FStarC_TypeChecker_Util.fresh_effect_repr env1 r eff_name sig_ts
               (FStar_Pervasives_Native.Some repr_ts)
            ...
            | (body_tm, g_body) ->
                let k =
                  FStarC_Syntax_Util.abs (a_b :: b_b ::
                    (FStarC_List.op_At eff_params_bs
                       (FStarC_List.op_At bs [f_b]))) body_tm
                    FStar_Pervasives_Native.None in
                let g_eq =
                  let uu___3 =
                    FStarC_TypeChecker_Rel.teq_nosmt env1 close_tm k in
                  match uu___3 with
                  | FStar_Pervasives_Native.None ->
                      let uu___4 =
                        let uu___5 =
                          FStarC_Class_Show.show
                            FStarC_Syntax_Print.showable_term close_tm in
                        FStarC_Format.fmt2 "Unexpected term for %s (%s)\n"
                      ...
                      FStarC_Errors.raise_error
                        ...
                        (Obj.magic uu___4)
                  | FStar_Pervasives_Native.Some g -> g in
                ((let uu___4 = FStarC_TypeChecker_Env.conj_guard g_body g_eq in
                  FStarC_TypeChecker_Rel.force_trivial_guard env1 uu___4);
                 (let uu___4 =
                    FStarC_TypeChecker_Normalize.remove_uvar_solutions env1 k in
                  FStarC_Syntax_Subst.compress uu___4))))
let lift_combinator_kind (env : FStarC_TypeChecker_Env.env)
  (m_eff_name : FStarC_Ident.lident)
  (m_sig_ts : FStarC_Syntax_Syntax.tscheme)
  (m_repr_ts : FStarC_Syntax_Syntax.tscheme FStar_Pervasives_Native.option)
  (u : FStarC_Syntax_Syntax.univ_name) (k : FStarC_Syntax_Syntax.typ) :
  FStarC_Syntax_Syntax.indexed_effect_binder_kind Prims.list
  ...
  | (a_b::rest_bs, uu___1) ->
      let uu___2 =
        let f_sig_bs =
          ...
          | (uu___4, sig1) ->
              let uu___5 =
                let uu___6 = FStarC_Syntax_Util.arrow_formals sig1 in
                     ...
                     let uu___7 =
                       let uu___8 =
                         let uu___9 =
                           FStarC_Syntax_Syntax.bv_to_name
                             a_b.FStarC_Syntax_Syntax.binder_bv in
                         ((a.FStarC_Syntax_Syntax.binder_bv), uu___9) in
                       FStarC_Syntax_Syntax.NT uu___8 in
                     [uu___7] in
                   FStarC_Syntax_Subst.subst_binders uu___6 bs) in
        let uu___3 =
          if (FStarC_List.length rest_bs) < (FStarC_List.length f_sig_bs)
          then FStar_Pervasives_Native.None
          else
            (let uu___5 =
               FStarC_List.splitAt (FStarC_List.length f_sig_bs) rest_bs in
      ...
      op_let_Question uu___2
        (fun uu___3 ->
           ...
           | (f_bs, f_bs_kinds, rest_bs1) ->
               let uu___4 =
                 if (FStarC_List.length rest_bs1) >= Prims.int_one
                 then
                   let uu___5 =
                     FStarC_List.splitAt
                       ((FStarC_List.length rest_bs1) - Prims.int_one)
                       rest_bs1 in
                   match uu___5 with
                   | (rest_bs2, f_b::[]) ->
                       FStar_Pervasives_Native.Some (rest_bs2, f_b)
                 else FStar_Pervasives_Native.None in
               op_let_Question uu___4
                 (fun uu___5 ->
                    match uu___5 with
                        ...
                        let uu___6 =
                          let expected_f_b_sort =
                            ...
                            | FStar_Pervasives_Native.Some repr_ts ->
                                let uu___7 =
                                  FStarC_TypeChecker_Env.inst_tscheme_with
                                    repr_ts [FStarC_Syntax_Syntax.U_name u] in
                                (match uu___7 with
                                 | (uu___8, t) ->
                                     let uu___9 =
                                       let uu___10 =
                                           ...
                                           (fun uu___12 ->
                                              ...
                                              | {
                                                  ...
                                                  FStarC_Syntax_Syntax.as_arg
                                                    uu___16) f_bs in
                                       uu___10 :: uu___11 in
                                     FStarC_Syntax_Syntax.mk_Tm_app t uu___9
                                       FStarC_Range_Type.dummyRange)
                            | FStar_Pervasives_Native.None ->
                                let uu___7 =
                                  let uu___8 =
                        ...
                        op_let_Question uu___6
                          (fun _f_b_ok_ ->
                             ...
                             FStar_Pervasives_Native.Some
                               (FStarC_List.op_At
                                  [FStarC_Syntax_Syntax.Type_binder]
                                  (FStarC_List.op_At f_bs_kinds
                                     (FStarC_List.op_At rest_kinds
                                        [FStarC_Syntax_Syntax.Repr_binder]))))))
let validate_indexed_effect_lift_shape (env : FStarC_TypeChecker_Env.env)
  (m_eff_name : FStarC_Ident.lident) (n_eff_name : FStarC_Ident.lident)
  (u : FStarC_Syntax_Syntax.univ_name) (lift_t : FStarC_Syntax_Syntax.typ)
  (r : FStarC_Range_Type.t) :
  (FStarC_Syntax_Syntax.typ *
    FStarC_Syntax_Syntax.indexed_effect_combinator_kind)=
  let lift_name =
  ...
  let lift_t_shape_error s =
    FStarC_Format.fmt2 "Unexpected shape of lift %s, reason:%s" lift_name s in
  let uu___ =
    let uu___1 = FStarC_TypeChecker_Env.get_effect_decl env m_eff_name in
    let uu___2 = FStarC_TypeChecker_Env.get_effect_decl env n_eff_name in
    (uu___1, uu___2) in
  match uu___ with
  | (m_ed, n_ed) ->
      let a_b =
                   ...
                   let uu___9 =
                     let uu___10 =
                       FStarC_List.splitAt
                         ((FStarC_List.length bs1) - Prims.int_one) bs1 in
                     FStar_Pervasives_Native.fst uu___10 in
                   FStarC_Syntax_Subst.subst_binders uu___8 uu___9 in
                 let uu___8 =
       ...
       | (rest_bs, lift_eff) ->
           ((let uu___3 =
             ...
             then
               ...
               FStarC_Errors.raise_error FStarC_Class_HasRange.hasRange_range
                 r FStarC_Errors_Codes.Fatal_UnexpectedExpressionType ()
                 (Obj.magic FStarC_Errors_Msg.is_error_message_string)
                 (Obj.magic uu___4)
             else ());
            (let uu___3 =
               let uu___4 =
                 ...
                 let uu___8 =
                   FStarC_Syntax_Syntax.bv_to_name
                     a_b.FStarC_Syntax_Syntax.binder_bv in
                 FStarC_TypeChecker_Util.fresh_effect_repr uu___5 r
                   m_eff_name uu___6 uu___7 (FStarC_Syntax_Syntax.U_name u)
                   uu___8 in
               match uu___4 with
               | (repr, g) ->
                   let uu___5 =
             ...
             | (f, guard_f) ->
                 let uu___4 =
                   ...
                   let uu___7 = FStarC_Syntax_Util.get_eff_repr n_ed in
                   let uu___8 =
                     FStarC_Syntax_Syntax.bv_to_name
                       a_b.FStarC_Syntax_Syntax.binder_bv in
                   FStarC_TypeChecker_Util.fresh_effect_repr uu___5 r
                     n_eff_name uu___6 uu___7 (FStarC_Syntax_Syntax.U_name u)
                     uu___8 in
                 (match uu___4 with
                  | (ret_t, guard_ret_t) ->
                      let uu___5 =
                       ...
                       | (pure_wp_uvar1, guard_wp) ->
                           let c =
                             let uu___6 =
                               ...
                               let uu___8 =
                                 let uu___9 =
                                   FStarC_Syntax_Syntax.as_arg pure_wp_uvar1 in
                                 [uu___9] in
                               {
                                 FStarC_Syntax_Syntax.comp_univs = uu___7;
                                 FStarC_Syntax_Syntax.effect_name = lift_eff;
                                 FStarC_Syntax_Syntax.result_typ = ret_t;
                           ...
                           let guard_eq =
                             let uu___6 =
                               FStarC_TypeChecker_Rel.teq_nosmt env lift_t k in
                             match uu___6 with
                             | FStar_Pervasives_Native.None ->
                                 let uu___7 =
                                   let uu___8 =
                           ...
                           ((let uu___7 =
                               FStarC_TypeChecker_Env.conj_guards
                                 [guard_f; guard_ret_t; guard_wp; guard_eq] in
                             FStarC_TypeChecker_Rel.force_trivial_guard env
                               uu___7);
                            (let k1 =
                               let uu___7 =
                                 FStarC_TypeChecker_Normalize.remove_uvar_solutions
                             ...
                             let lopt =
                               ...
                               lift_combinator_kind env m_eff_name uu___7
                                 uu___8 u k1 in
                             let kind =
                               match lopt with
                               | FStar_Pervasives_Native.None ->
                              ...
                              then
                                let uu___9 =
                                  FStarC_Class_Show.show
                                    FStarC_Syntax_Syntax.showable_indexed_effect_combinator_kind
                                    kind in
                                FStarC_Format.print2 "Lift %s has %s kind\n"
                                  lift_name uu___9
                              else ());
                             (k1, kind))))))))
let tc_layered_eff_decl (env0 : FStarC_TypeChecker_Env.env)
  (ed : FStarC_Syntax_Syntax.eff_decl)
  ...
  let uu___ =
    ...
    FStarC_Format.fmt1 "While checking layered effect definition `%s`" uu___1 in
  FStarC_Errors.with_ctx uu___
    (fun uu___1 ->
       (let uu___3 = FStarC_Effect.op_Bang dbg_LayeredEffectsTc in
        if uu___3
        then
          let uu___4 =
            FStarC_Class_Show.show FStarC_Syntax_Print.showable_eff_decl ed in
       ...
       then
         (let uu___4 =
            ...
            Prims.strcat "Binders are not supported for layered effects ("
              uu___5 in
       ...
       (let log_combinator s uu___4 =
          match uu___4 with
          | (us, t, ty) ->
              let uu___5 = FStarC_Effect.op_Bang dbg_LayeredEffectsTc in
              if uu___5
              then
                let uu___6 =
                  FStarC_Ident.string_of_lid ed.FStarC_Syntax_Syntax.mname in
                let uu___7 = FStarC_Syntax_Print.tscheme_to_string (us, t) in
                let uu___8 = FStarC_Syntax_Print.tscheme_to_string (us, ty) in
                FStarC_Format.print4 "Typechecked %s:%s = %s:%s\n" uu___6 s
                  uu___7 uu___8
              else () in
        let fresh_a_and_u_a a =
          ...
          | (t, u) ->
              let uu___5 =
                let uu___6 =
                  FStarC_Syntax_Syntax.gen_bv a FStar_Pervasives_Native.None
                    t in
                FStarC_Syntax_Syntax.mk_binder uu___6 in
              (uu___5, u) in
        let fresh_x_a x a =
          let uu___4 =
            ...
            FStarC_Syntax_Syntax.gen_bv x FStar_Pervasives_Native.None uu___5 in
          FStarC_Syntax_Syntax.mk_binder uu___4 in
        let check_and_gen1 =
          let uu___4 =
            FStarC_Ident.string_of_lid ed.FStarC_Syntax_Syntax.mname in
        ...
        let uu___4 =
          ...
          match uu___5 with
          | (n, sig_ts) ->
              FStarC_Errors.with_ctx "While checking the effect signature"
                (fun uu___6 ->
                   let r =
                   ...
                   | (sig_us, sig_t, sig_ty) ->
                       let uu___8 =
                         FStarC_Syntax_Subst.open_univ_vars sig_us sig_t in
                       (match uu___8 with
                        | (us, t) ->
                            let env =
                              FStarC_TypeChecker_Env.push_univ_vars env0 us in
                             ...
                             | (a, u) ->
                                 let rest_bs =
                                   ...
                                   FStarC_TypeChecker_Util.layered_effect_indices_as_binders
                                     env r ed.FStarC_Syntax_Syntax.mname
                                 ...
                                 let k =
                                   ...
                                   FStarC_Syntax_Util.arrow bs uu___10 in
                                 let g_eq =
                                  ...
                                  (let uu___11 =
                                     let uu___12 =
                                       let uu___13 =
                                         FStarC_TypeChecker_Normalize.remove_uvar_solutions
                                           env k in
                                       FStarC_Syntax_Subst.close_univ_vars us
                                         uu___13 in
        ...
        | (num_effect_params, signature) ->
            (log_combinator "signature" signature;
             (let repr =
                FStarC_Errors.with_ctx "While checking the effect repr"
                  (fun uu___6 ->
                     let repr_ts =
                       let uu___7 = FStarC_Syntax_Util.get_eff_repr ed in
                       FStarC_Option.must uu___7 in
                     let r =
                       (FStar_Pervasives_Native.snd repr_ts).FStarC_Syntax_Syntax.pos in
                     let uu___7 = check_and_gen1 "repr" Prims.int_one repr_ts in
                     match uu___7 with
                     | (repr_us, repr_t, repr_ty) ->
                         let uu___8 =
                           FStarC_Syntax_Subst.open_univ_vars repr_us repr_ty in
                         (match uu___8 with
                          | (us, ty) ->
                              let env =
                                FStarC_TypeChecker_Env.push_univ_vars env0 us in
                              ...
                              (match uu___9 with
                               | (a, u) ->
                                   ...
                                   let k =
                                     ...
                                     FStarC_Syntax_Util.arrow bs uu___10 in
                                   let g =
                                     FStarC_TypeChecker_Rel.teq env ty k in
                                   (FStarC_TypeChecker_Rel.force_trivial_guard
                                      env g;
                                    (let uu___11 =
                                       let uu___12 =
              ...
              (let fresh_repr r env u a_tm =
               ...
               let return_repr =
                 FStarC_Errors.with_ctx
                   ...
                   (fun uu___7 ->
                      let return_repr_ts =
                        let uu___8 = FStarC_Syntax_Util.get_return_repr ed in
                      ...
                      | (ret_us, ret_t, ret_ty) ->
                          let uu___9 =
                            FStarC_Syntax_Subst.open_univ_vars ret_us ret_ty in
                          (match uu___9 with
                           | (us, ty) ->
                               let env =
                                 FStarC_TypeChecker_Env.push_univ_vars env0
                                   us in
                               ...
                               (match uu___10 with
                                | (a, u_a) ->
                                    ...
                                    let rest_bs =
                                      let uu___11 =
                                        let uu___12 =
                                          FStarC_Syntax_Subst.compress ty in
                                     ...
                                     | (repr1, g) ->
                                         let k =
                                           ...
                                           FStarC_Syntax_Util.arrow bs
                                             uu___12 in
                                         let g_eq =
                                           FStarC_TypeChecker_Rel.teq env ty
                                             k in
                                         ((let uu___13 =
               ...
               (let uu___8 =
                  FStarC_Errors.with_ctx "While checking the bind combinator"
                    (fun uu___9 ->
                       let bind_repr_ts =
                         let uu___10 = FStarC_Syntax_Util.get_bind_repr ed in
                         FStarC_Option.must uu___10 in
                       let r =
                       ...
                       | (bind_us, bind_t, bind_ty) ->
                           let uu___11 =
                             FStarC_Syntax_Subst.open_univ_vars bind_us
                               bind_ty in
                           (match uu___11 with
                            | (us, ty) ->
                                let env =
                                ...
                                let uu___12 =
                                  ...
                                  validate_indexed_effect_bind_shape env
                                    ed.FStarC_Syntax_Syntax.mname
                                    ed.FStarC_Syntax_Syntax.mname
                                    ed.FStarC_Syntax_Syntax.mname sig_ts
                                    sig_ts sig_ts
                                    (FStar_Pervasives_Native.Some repr_ts)
                                    (FStar_Pervasives_Native.Some repr_ts)
                                    (FStar_Pervasives_Native.Some repr_ts) us
                                    ty r num_effect_params uu___13 in
                                (match uu___12 with
                                 | (k, kind) ->
                                     let uu___13 =
                                       let uu___14 =
                        ...
                        FStarC_Errors.with_ctx
                          ...
                          (fun uu___11 ->
                             let stronger_repr =
                               let ts =
                                 let uu___12 =
                                   FStarC_Syntax_Util.get_stronger_repr ed in
                                 FStarC_Option.must uu___12 in
                               let uu___12 =
                                 let uu___13 =
                                    ...
                                    | (uu___14, signature_t) ->
                                        ...
                                        (match uu___15 with
                                         | FStarC_Syntax_Syntax.Tm_arrow
                                             ...
                                             ([], uu___17)
                                         | uu___16 -> failwith "Impossible!"))
                               | uu___13 -> ts in
                             let r =
                               (FStar_Pervasives_Native.snd stronger_repr).FStarC_Syntax_Syntax.pos in
                             let uu___12 =
                                   ...
                                   | (us, ty) ->
                                       ...
                                       let uu___15 =
                                         let sig_ts =
                                           ...
                                           match uu___16 with
                                           | (us1, t, uu___17) -> (us1, t) in
                                         let repr_ts =
                                           let uu___16 = repr in
                                           match uu___16 with
                                           | (us1, t, uu___17) -> (us1, t) in
                                         let uu___16 = FStarC_List.hd us in
                                                 ...
                                                 let uu___18 =
                                                   ...
                                                   let repr_ts =
                                                     ...
                                                     | (us1, t1, uu___20) ->
                                                         (us1, t1) in
                                                   let uu___19 =
                                                     FStarC_List.hd us in
                                                   validate_indexed_effect_ite_shape
                                                     env
                                                     ed.FStarC_Syntax_Syntax.mname
                                                     sig_ts repr_ts uu___19
                                                     ty t num_effect_params r in
                                                 (match uu___18 with
                                                  | (k, kind) ->
                                                      let uu___19 =
                                                        let uu___20 =
                                                          FStarC_Syntax_Subst.close_univ_vars
                                                            if_then_else_us k in
                                                        (if_then_else_us,
                                                          uu___20,
                                                          if_then_else_ty) in
                                                      (uu___19, kind))))) in
                                          ...
                                          let uu___16 =
                                            let uu___17 =
                                              let uu___18 =
                                                FStarC_Syntax_Util.get_layered_if_then_else_combinator
                                                  ed in
                                              FStarC_Option.must uu___18 in
                                            FStar_Pervasives_Native.fst
                                              uu___17 in
                                          FStar_Pervasives_Native.snd uu___16 in
                                 ...
                                 (let close_ =
                                         ...
                                         | FStar_Pervasives_Native.Some
                                             ...
                                             let uu___15 =
                                               check_and_gen1 "close"
                                                 (Prims.of_int (2)) close_ts in
                                             (match uu___15 with
                                              | (close_us, close_t, close_ty)
                                                  ->
                                                  let uu___16 =
                                                    FStarC_Syntax_Subst.open_univ_vars
                                                      close_us close_t in
                                  ...
                                  FStarC_Errors.with_ctx
                                    ...
                                    (fun uu___14 ->
                                       match close_ with
                                       | FStar_Pervasives_Native.None -> ()
                                       | FStar_Pervasives_Native.Some close_1
                                           ->
                                  ...
                                  (let tc_action env act =
                                   ...
                                   let tc_action_with_ctx env act =
                                     ...
                                     FStarC_Errors.with_ctx uu___14
                                       (fun uu___15 -> tc_action env act) in
                                   let extraction_mode =
                                     ...
                                     let is_reifiable =
                                       FStarC_List.contains
                                         FStarC_Syntax_Syntax.Reifiable quals in
                                   ...
                                   (let tschemes_of uu___15 k =
                                        ...
                                        ed.FStarC_Syntax_Syntax.actions in
                                    {
                                      ...
                                      FStarC_Syntax_Syntax.combinators =
                                        combinators;
                                      FStarC_Syntax_Syntax.actions = uu___15;
                                      FStarC_Syntax_Syntax.eff_attrs =
                                        (ed.FStarC_Syntax_Syntax.eff_attrs);
                                      FStarC_Syntax_Syntax.extraction_mode =
                                        extraction_mode
                                    }))))))))))))))
let tc_non_layered_eff_decl (env0 : FStarC_TypeChecker_Env.env)
  (ed : FStarC_Syntax_Syntax.eff_decl)
  (_quals : FStarC_Syntax_Syntax.qualifier Prims.list)
  (_attrs : FStarC_Syntax_Syntax.attribute Prims.list) :
  FStarC_Syntax_Syntax.eff_decl=
  let uu___ =
    let uu___1 = FStarC_Ident.string_of_lid ed.FStarC_Syntax_Syntax.mname in
    FStarC_Format.fmt1 "While checking effect definition `%s`" uu___1 in
  FStarC_Errors.with_ctx uu___
    (fun uu___1 ->
       (let uu___3 = FStarC_Effect.op_Bang dbg in
        ...
        then
          let uu___4 =
            FStarC_Class_Show.show FStarC_Syntax_Print.showable_eff_decl ed in
          FStarC_Format.print1 "Typechecking eff_decl: \n\t%s\n" uu___4
        else ());
       (let uu___3 =
          let uu___4 =
            FStarC_Syntax_Subst.univ_var_opening
                   ...
                   let uu___8 =
                     ...
                     | (us, tmp_t1) ->
                         let uu___10 =
                           let uu___11 =
                             let uu___12 =
                               FStarC_Syntax_Util.arrow_formals tmp_t1 in
                             FStar_Pervasives_Native.fst uu___12 in
                                 ...
                                 (FStarC_List.forall2
                                    (fun u1 u2 ->
                                       let uu___11 =
                                         FStarC_Syntax_Syntax.order_univ_name
                                           u1 u2 in
                                       uu___11 = Prims.int_zero) ed_univs us) in
                             if uu___10
                             then (us, bs2)
                             else
                               (let uu___12 =
                                    ...
                                    let uu___15 =
                                      let uu___16 =
                                        let uu___17 =
                                          FStarC_Ident.string_of_lid
                                            ed.FStarC_Syntax_Syntax.mname in
                                        FStar_Pprint.doc_of_string uu___17 in
                                      let uu___17 =
                                        FStarC_Errors_Msg.text
                                          "are different" in
        ...
        | (us, bs) ->
            ...
            (match uu___4 with
             | (ed_univs_subst, ed_univs) ->
                 let uu___5 =
                   let uu___6 =
                     FStarC_Syntax_Subst.subst_binders ed_univs_subst bs in
                  ...
                  | (ed_bs, ed_bs_subst) ->
                        ...
                        let op uu___6 =
                          ...
                          | (us1, t) ->
                              ...
                              let uu___7 =
                                let uu___8 =
                                  FStarC_Syntax_Subst.shift_subst
                                    (FStarC_List.length us1) ed_bs_subst in
                      ...
                      ((let uu___7 = FStarC_Effect.op_Bang dbg in
                        ...
                        then
                          let uu___8 =
                            FStarC_Class_Show.show
                              FStarC_Syntax_Print.showable_eff_decl ed2 in
                          FStarC_Format.print1
                       ...
                       (let env =
                          let uu___7 =
                            FStarC_TypeChecker_Env.push_univ_vars env0
                              ed_univs in
                          FStarC_TypeChecker_Env.push_binders uu___7 ed_bs in
                          ...
                          | (us1, t) ->
                              let env1 =
                                if
                                  FStar_Pervasives_Native.uu___is_Some
                                    env_opt
                                then FStarC_Option.must env_opt
                                else env in
                              let uu___8 =
                                FStarC_Syntax_Subst.open_univ_vars us1 t in
                              (match uu___8 with
                               | (us2, t1) ->
                                   let t2 =
                                     match k with
                                         ...
                                         then
                                           (let error =
                                              ...
                                              FStarC_Format.fmt4
                                                ...
                                                uu___11 comb uu___12 uu___13 in
                                            FStarC_Errors.raise_error
                                              (FStarC_Syntax_Syntax.has_range_syntax
                                                 ()) t3
                                              FStarC_Errors_Codes.Fatal_MismatchUniversePolymorphic
                        ...
                        (let uu___8 = FStarC_Effect.op_Bang dbg in
                         ...
                         then
                           let uu___9 =
                             FStarC_Syntax_Print.tscheme_to_string signature in
                           FStarC_Format.print1 "Typechecked signature: %s\n"
                             uu___9
                         else ());
                        (let fresh_a_and_wp uu___8 =
                           let fail t =
                             ...
                             FStarC_TypeChecker_Err.unexpected_signature_for_monad
                               env uu___9 ed2.FStarC_Syntax_Syntax.mname t in
                           let uu___9 =
                             FStarC_TypeChecker_Env.inst_tscheme signature in
                           match uu___9 with
                           | (uu___10, signature1) ->
                               let uu___11 =
                                 let uu___12 =
                                   FStarC_Syntax_Subst.compress signature1 in
                                 uu___12.FStarC_Syntax_Syntax.n in
                               (match uu___11 with
                                | FStarC_Syntax_Syntax.Tm_arrow
                                    { FStarC_Syntax_Syntax.bs1 = bs1;
                                      FStarC_Syntax_Syntax.comp = uu___12;_}
                                    ->
                                    let bs2 =
                                      FStarC_Syntax_Subst.open_binders bs1 in
                                    (match bs2 with
                                     | { FStarC_Syntax_Syntax.binder_bv = a;
                                         FStarC_Syntax_Syntax.binder_qual =
                                           uu___13;
                           ...
                           then
                             let uu___9 =
                               FStarC_Ident.string_of_lid
                                 ed2.FStarC_Syntax_Syntax.mname in
                             let uu___10 =
                               FStarC_Syntax_Print.tscheme_to_string ts in
                             FStarC_Format.print3 "Typechecked %s:%s = %s\n"
                               uu___9 s uu___10
                           else () in
                         let ret_wp =
                           ...
                           | (a, wp_sort) ->
                               let k =
                                 let uu___9 =
                                   ...
                                   uu___10 :: uu___11 in
                                 let uu___10 =
                                   FStarC_Syntax_Syntax.mk_GTotal wp_sort in
                                 FStarC_Syntax_Util.arrow uu___9 uu___10 in
                               let uu___9 =
                                 ...
                                 | (b, wp_sort_b) ->
                                     let wp_sort_a_b =
                                       ...
                                       let uu___12 =
                                         FStarC_Syntax_Syntax.mk_Total
                                           wp_sort_b in
                                       FStarC_Syntax_Util.arrow uu___11
                                         uu___12 in
                                     let k =
                                       let uu___11 =
                                         let uu___12 =
                                  ...
                                  let p =
                                    ...
                                    let uu___13 =
                                      let uu___14 =
                                        FStarC_Syntax_Util.type_u () in
                                      FStar_Pervasives_Native.fst uu___14 in
                                    FStarC_Syntax_Syntax.new_bv uu___12
                                      uu___13 in
                                  let k =
                                    let uu___12 =
                                      let uu___13 =
                                      ...
                                      let uu___14 =
                                        let uu___15 =
                                          FStarC_Syntax_Syntax.mk_binder p in
                                        let uu___16 =
                                          let uu___17 =
                                            FStarC_Syntax_Syntax.null_binder
                                              wp_sort_a in
                                      ...
                                      uu___13 :: uu___14 in
                                    let uu___13 =
                                      FStarC_Syntax_Syntax.mk_Total wp_sort_a in
                                    FStarC_Syntax_Util.arrow uu___12 uu___13 in
                                  let uu___12 =
                                    let uu___13 =
                               ...
                               | (a, wp_sort_a) ->
                                   let k =
                                     ...
                                     let uu___14 =
                                       FStarC_Syntax_Syntax.mk_Total
                                         wp_sort_a in
                                     FStarC_Syntax_Util.arrow uu___13 uu___14 in
                                   let uu___13 =
                                     let uu___14 =
                                       FStarC_Syntax_Util.get_wp_ite_combinator
                                         ed2 in
                                     FStarC_Option.must uu___14 in
                             ...
                             (let close_wp =
                                ...
                                | (a, wp_sort_a) ->
                                    let b =
                                      ...
                                      FStarC_Syntax_Syntax.new_bv uu___14
                                        uu___15 in
                                    let wp_sort_b_a =
                                      let uu___14 =
                                        let uu___15 =
                              ...
                              (let trivial =
                                          ...
                                          let k =
                                            ...
                                            let uu___18 =
                                              FStarC_Syntax_Syntax.mk_GTotal
                                                t in
                                            FStarC_Syntax_Util.arrow uu___17
                                              uu___18 in
                                          let trivial1 =
                                            let uu___17 =
                                              let uu___18 =
                               ...
                               let uu___14 =
                                 let uu___15 =
                                   FStarC_Syntax_Util.get_eff_repr ed2 in
                                 match uu___15 with
                                 | FStar_Pervasives_Native.None ->
                                     (FStar_Pervasives_Native.None,
                                       FStar_Pervasives_Native.None,
                                      ...
                                      (let mk_repr' t wp =
                                         ...
                                         | (uu___19, repr1) ->
                                             ...
                                             let uu___20 =
                                               ...
                                               FStarC_Syntax_Syntax.Tm_app
                                                 uu___21 in
                                             FStarC_Syntax_Syntax.mk uu___20
                                               FStarC_Range_Type.dummyRange in
                                       let mk_repr a wp =
                                         let uu___18 =
                                           FStarC_Syntax_Syntax.bv_to_name a in
                                          ...
                                          let bind_repr_ts =
                                            let uu___19 =
                                              FStarC_Syntax_Util.get_bind_repr
                                                ed2 in
                                            FStarC_Option.must uu___19 in
                                          let uu___19 = fresh_a_and_wp () in
                                          match uu___19 with
                                          | (a, wp_sort_a) ->
                                              let uu___20 = fresh_a_and_wp () in
                                              (match uu___20 with
                                               | (b, wp_sort_b) ->
                                                   let wp_sort_a_b =
                                                     let uu___21 =
                               ...
                               | (repr, return_repr, bind_repr, actions) ->
                                   ...
                                   let combinators =
                                     {
                                       FStarC_Syntax_Syntax.ret_wp = ret_wp;
                                       FStarC_Syntax_Syntax.bind_wp = bind_wp;
                                       FStarC_Syntax_Syntax.stronger =
                                         stronger;
                                       FStarC_Syntax_Syntax.if_then_else =
                                         if_then_else;
                                       FStarC_Syntax_Syntax.ite_wp = ite_wp;
                                       FStarC_Syntax_Syntax.close_wp =
                                         close_wp;
                                       FStarC_Syntax_Syntax.trivial = trivial;
                                       FStarC_Syntax_Syntax.repr = repr;
                                   ...
                                   let combinators2 =
                                     ...
                                     | FStarC_Syntax_Syntax.Primitive_eff
                                         ...
                                         FStarC_Syntax_Syntax.Primitive_eff
                                           combinators1
                                     | FStarC_Syntax_Syntax.DM4F_eff uu___15
                                         ->
                                   ...
                                   let ed3 =
                                            ...
                                            }) actions in
                                     {
                                       ...
                                       FStarC_Syntax_Syntax.combinators =
                                         combinators2;
                                       FStarC_Syntax_Syntax.actions = uu___16;
                                       FStarC_Syntax_Syntax.eff_attrs =
                                         (ed2.FStarC_Syntax_Syntax.eff_attrs);
                                       FStarC_Syntax_Syntax.extraction_mode =
                                         (ed2.FStarC_Syntax_Syntax.extraction_mode)
                                     } in
                                   ((let uu___16 = FStarC_Effect.op_Bang dbg in
                                     if uu___16
                                     then
                                       let uu___17 =
                                         FStarC_Class_Show.show
...
let monad_signature (env : FStarC_TypeChecker_Env.env)
  (m : FStarC_Ident.lident) (s : FStarC_Syntax_Syntax.term) :
  (FStarC_Syntax_Syntax.bv * FStarC_Syntax_Syntax.term'
    FStarC_Syntax_Syntax.syntax)=
  let fail uu___ =
    let uu___1 = FStarC_Ident.range_of_lid m in
    FStarC_TypeChecker_Err.unexpected_signature_for_monad env uu___1 m s in
  ...
  | FStarC_Syntax_Syntax.Tm_arrow
      ...
      (match bs1 with
       ...
       | uu___ -> fail ())
  | uu___ -> fail ()
let tc_layered_lift (env0 : FStarC_TypeChecker_Env.env)
  (sub : FStarC_Syntax_Syntax.sub_eff) : FStarC_Syntax_Syntax.sub_eff=
  (let uu___1 = FStarC_Effect.op_Bang dbg_LayeredEffectsTc in
   if uu___1
   then
     let uu___2 =
       FStarC_Class_Show.show FStarC_Syntax_Print.showable_sub_eff sub in
     FStarC_Format.print1 "Typechecking sub_effect: %s\n" uu___2
   else ());
  (let lift_ts = FStarC_Option.must sub.FStarC_Syntax_Syntax.lift in
   ...
   | (us, lift, lift_ty) ->
       ((let uu___3 = FStarC_Effect.op_Bang dbg_LayeredEffectsTc in
         ...
         then
           ...
           let uu___5 = FStarC_Syntax_Print.tscheme_to_string (us, lift_ty) in
           FStarC_Format.print2 "Typechecked lift: %s and lift_ty: %s\n"
             uu___4 uu___5
         else ());
        (let uu___3 = FStarC_Syntax_Subst.open_univ_vars us lift_ty in
         ...
         | (us1, lift_ty1) ->
             ...
             let uu___4 =
               let uu___5 = FStarC_List.hd us1 in
             ...
             (match uu___4 with
              | (k, kind) ->
                  ...
                  ((let uu___6 = FStarC_Effect.op_Bang dbg_LayeredEffectsTc in
                    if uu___6
                    then
                      let uu___7 =
                        FStarC_Class_Show.show
                          FStarC_Syntax_Print.showable_sub_eff sub1 in
                      FStarC_Format.print1 "Final sub_effect: %s\n" uu___7
                    else ());
                   sub1)))))
let check_lift_for_erasable_effects (env : FStarC_TypeChecker_Env.env)
  ...
  let err reason =
    let uu___ =
      ...
      FStarC_Format.fmt3 "Error defining a lift/subcomp %s ~> %s: %s" uu___1
        uu___2 reason in
    FStarC_Errors.raise_error FStarC_Class_HasRange.hasRange_range r
      FStarC_Errors_Codes.Fatal_UnexpectedEffect ()
    ...
    (let m1_erasable = FStarC_TypeChecker_Env.is_erasable_effect env m11 in
     ...
     let uu___2 =
       (m2_erasable && (Prims.op_Negation m1_erasable)) &&
         (let uu___3 =
            FStarC_Ident.lid_equals m11 FStarC_Parser_Const.effect_PURE_lid in
...
let tc_lift (env : FStarC_TypeChecker_Env.env)
  ...
  (let check_and_gen1 env1 t k =
     let uu___1 = FStarC_TypeChecker_TcTerm.tc_check_trivial_guard env1 t k in
            ...
            | (b, wp_b_tgt) ->
                ...
                let expected_k =
                  let uu___6 =
                    ...
                    let uu___8 =
                      let uu___9 = FStarC_Syntax_Syntax.null_binder wp_a_src in
                      [uu___9] in
                    uu___7 :: uu___8 in
                ...
                let repr_type eff_name a1 wp =
                  (let uu___7 =
                   ...
                   then
                     let uu___8 =
                       ...
                       FStarC_Format.fmt1 "Effect %s cannot be reified"
                         uu___9 in
                     FStarC_Errors.raise_error
                  ...
                  (let uu___7 =
                     FStarC_TypeChecker_Env.effect_decl_opt env eff_name in
                   match uu___7 with
                   | FStar_Pervasives_Native.None ->
                       failwith
                   ...
                   | FStar_Pervasives_Native.Some (ed, qualifiers) ->
                       let repr =
                         let uu___8 =
                           let uu___9 = FStarC_Syntax_Util.get_eff_repr ed in
                           FStarC_Option.must uu___9 in
                         FStarC_TypeChecker_Env.inst_effect_fun_with
                           [FStarC_Syntax_Syntax.U_unknown] env ed uu___8 in
                       let uu___8 =
                         let uu___9 =
                           let uu___10 =
                             let uu___11 = FStarC_Syntax_Syntax.as_arg a1 in
                             let uu___12 =
                ...
                let uu___6 =
                  ...
                  | (lift, FStar_Pervasives_Native.Some (uvs, lift_wp)) ->
                      let uu___7 =
                        if (FStarC_List.length uvs) > Prims.int_zero
                        then
                          let uu___8 =
                          ...
                          | (usubst, uvs1) ->
                              let uu___9 =
                                FStarC_TypeChecker_Env.push_univ_vars env
                                  uvs1 in
                              let uu___10 =
                                FStarC_Syntax_Subst.subst usubst lift_wp in
                              (uu___9, uu___10)
                        else (env, lift_wp) in
                      (match uu___7 with
                       | (env1, lift_wp1) ->
                  ...
                  | (FStar_Pervasives_Native.Some (what, lift),
                     FStar_Pervasives_Native.None) ->
                      let uu___7 =
                        if (FStarC_List.length what) > Prims.int_zero
                        then
                          let uu___8 =
                       ...
                       | (uvs, lift1) ->
                           ((let uu___9 = FStarC_Effect.op_Bang dbg in
                             ...
                             then
                               let uu___10 =
                                 FStarC_Class_Show.show
                                   FStarC_Syntax_Print.showable_term lift1 in
                               FStarC_Format.print1 "Lift for free : %s\n"
                                 uu___10
                             else ());
                            (let dmff_env =
                               FStarC_TypeChecker_DMFF.empty env
                                 (FStarC_TypeChecker_TcTerm.tc_constant env
                                    FStarC_Range_Type.dummyRange) in
                             let uu___9 =
                               let uu___10 =
                                 FStarC_TypeChecker_Env.push_univ_vars env
                                   uvs in
                               FStarC_TypeChecker_TcTerm.tc_term uu___10
                                 lift1 in
                             match uu___9 with
                             | (lift2, comp, uu___10) ->
                                 let uu___11 =
                                   FStarC_TypeChecker_DMFF.star_expr dmff_env
                                     lift2 in
                                 (match uu___11 with
                             ...
                             | (usubst, uvs1) ->
                                 let uu___9 =
                                   FStarC_TypeChecker_Env.push_univ_vars env1
                                     uvs1 in
                                 let uu___10 =
                                   FStarC_Syntax_Subst.subst usubst lift2 in
                                 (uu___9, uu___10) in
                           (match uu___7 with
                            | (env2, lift3) ->
                                let uu___8 =
                                  let uu___9 =
                                    FStarC_TypeChecker_Env.lookup_effect_lid
                                      env2 sub.FStarC_Syntax_Syntax.source in
                                  monad_signature env2
                                    sub.FStarC_Syntax_Syntax.source uu___9 in
                                (match uu___8 with
                                 | (a1, wp_a_src1) ->
                                     let wp_a =
                                       FStarC_Syntax_Syntax.new_bv
                                     ...
                                     let wp_a_typ =
                                       FStarC_Syntax_Syntax.bv_to_name wp_a in
                                     let repr_f =
                                       repr_type
                                         sub.FStarC_Syntax_Syntax.source
                                         a_typ wp_a_typ in
                                     ...
                                     let expected_k1 =
                                       let uu___9 =
                                         let uu___10 =
                                           FStarC_Syntax_Syntax.mk_binder a1 in
                                         let uu___11 =
                                           let uu___12 =
                                             FStarC_Syntax_Syntax.mk_binder
                                               wp_a in
                                              ...
                                              (let lift5 =
                                               ...
                                               let uu___13 =
                                                 FStarC_Syntax_Subst.close_univ_vars
                                                   uvs lift5 in
                                               (uvs, uu___13)) in
                                          FStar_Pervasives_Native.Some lift4))) in
                     (if
                        (FStarC_List.length
                      ...
                      (let uu___9 =
                         (FStar_Pervasives_Native.uu___is_Some lift1) &&
                           (let uu___10 =
                              let uu___11 =
                                let uu___12 = FStarC_Option.must lift1 in
                                FStar_Pervasives_Native.fst uu___12 in
                              FStarC_List.length uu___11 in
                       ...
                       then
                         let uu___10 =
                           ...
                           let uu___13 =
                             let uu___14 =
                               let uu___15 =
                                 let uu___16 = FStarC_Option.must lift1 in
                                 FStar_Pervasives_Native.fst uu___16 in
                               FStarC_List.length uu___15 in
                             FStarC_Class_Show.show
                               FStarC_Class_Show.showable_nat uu___14 in
                           FStarC_Format.fmt3
        ...
        then (env, uvs, tps, c)
          ...
          (let uu___3 = FStarC_Syntax_Subst.univ_var_opening uvs in
           ...
           | (usubst, uvs1) ->
               ...
               let uu___4 = FStarC_TypeChecker_Env.push_univ_vars env uvs1 in
                           ...
                           (let tps4 = FStarC_Syntax_Subst.close_binders tps3 in
                            ...
                            | (uvs2, t) ->
                                let uu___8 =
                                  ...
                                  match uu___9 with
                                  | ([], FStarC_Syntax_Syntax.Tm_arrow
                                     { FStarC_Syntax_Syntax.bs1 = uu___10;
                                       FStarC_Syntax_Syntax.comp = c5;_})
                                      -> ([], c5)
                                  | (uu___10, FStarC_Syntax_Syntax.Tm_arrow
...
let check_polymonadic_bind_for_erasable_effects
  (env : FStarC_TypeChecker_Env.env) (m : FStarC_Ident.lident)
  (n : FStarC_Ident.lident) (p : FStarC_Ident.lident)
  (r : FStarC_Range_Type.t) : unit=
  let err reason =
    let uu___ =
      let uu___1 = FStarC_Class_Show.show FStarC_Ident.showable_lident m in
      let uu___2 = FStarC_Class_Show.show FStarC_Ident.showable_lident n in
      let uu___3 = FStarC_Class_Show.show FStarC_Ident.showable_lident p in
      FStarC_Format.fmt4
        "Error definition polymonadic bind (%s, %s) |> %s: %s" uu___1 uu___2
        uu___3 reason in
    FStarC_Errors.raise_error FStarC_Class_HasRange.hasRange_range r
      FStarC_Errors_Codes.Fatal_UnexpectedEffect ()
      (Obj.magic FStarC_Errors_Msg.is_error_message_string) (Obj.magic uu___) in
  ...
  let uu___ =
    (FStarC_Ident.lid_equals m1 FStarC_Parser_Const.effect_GHOST_lid) ||
      (FStarC_Ident.lid_equals n1 FStarC_Parser_Const.effect_GHOST_lid) in
  if uu___
  then
    err
      "GHOST computations are not allowed to be composed using user-defined polymonadic binds"
  else
    (let m_erasable = FStarC_TypeChecker_Env.is_erasable_effect env m1 in
     let n_erasable = FStarC_TypeChecker_Env.is_erasable_effect env n1 in
     let p_erasable = FStarC_TypeChecker_Env.is_erasable_effect env p in
     if p_erasable
     then
       let uu___2 =
         (Prims.op_Negation m_erasable) &&
           (let uu___3 =
              FStarC_Ident.lid_equals m1 FStarC_Parser_Const.effect_PURE_lid in
            Prims.op_Negation uu___3) in
       (if uu___2
        then
          let uu___3 =
...
let tc_polymonadic_bind (env : FStarC_TypeChecker_Env.env)
  (m : FStarC_Ident.lident) (n : FStarC_Ident.lident)
  (p : FStarC_Ident.lident) (ts : FStarC_Syntax_Syntax.tscheme) :
  ...
  (let uu___1 =
     check_and_gen env eff_name "polymonadic_bind" (Prims.of_int (2)) ts in
   match uu___1 with
   | (us, t, ty) ->
       let uu___2 = FStarC_Syntax_Subst.open_univ_vars us ty in
       (match uu___2 with
        | (us1, ty1) ->
            let env1 = FStarC_TypeChecker_Env.push_univ_vars env us1 in
            let uu___3 =
              let uu___4 = FStarC_TypeChecker_Env.get_effect_decl env1 m in
              let uu___5 = FStarC_TypeChecker_Env.get_effect_decl env1 n in
              let uu___6 = FStarC_TypeChecker_Env.get_effect_decl env1 p in
            ...
            (match uu___3 with
             | (m_ed, n_ed, p_ed) ->
                 let uu___4 =
                   ...
                   let uu___8 = FStarC_Syntax_Util.get_eff_repr m_ed in
                   let uu___9 = FStarC_Syntax_Util.get_eff_repr n_ed in
                   let uu___10 = FStarC_Syntax_Util.get_eff_repr p_ed in
                   let uu___11 = FStarC_TypeChecker_Env.get_range env1 in
                   validate_indexed_effect_bind_shape env1 m n p uu___5
                     uu___6 uu___7 uu___8 uu___9 uu___10 us1 ty1 uu___11
                     Prims.int_zero false in
                 (match uu___4 with
                  | (k, kind) ->
                      ((let uu___6 = FStarC_Debug.extreme () in
                        ...
                        then
                          let uu___7 =
                            FStarC_Syntax_Print.tscheme_to_string (us1, t) in
                          let uu___8 =
                            FStarC_Syntax_Print.tscheme_to_string (us1, k) in
                          FStarC_Format.print3
                       ...
                       (let uu___7 =
                          ...
                          (us1, uu___8) in
                        ((us1, t), uu___7, kind)))))))
let tc_polymonadic_subcomp (env0 : FStarC_TypeChecker_Env.env)
  (m : FStarC_Ident.lident) (n : FStarC_Ident.lident)
  ...
  (let combinator_name =
   ...
   let uu___1 =
     check_and_gen env0 combinator_name "polymonadic_subcomp" Prims.int_one
       ts in
   match uu___1 with
   | (us, t, ty) ->
       let uu___2 = FStarC_Syntax_Subst.open_univ_vars us ty in
       (match uu___2 with
        | (us1, ty1) ->
            let env = FStarC_TypeChecker_Env.push_univ_vars env0 us1 in
            let uu___3 =
              let uu___4 = FStarC_TypeChecker_Env.get_effect_decl env m in
              let uu___5 = FStarC_TypeChecker_Env.get_effect_decl env n in
              (uu___4, uu___5) in
            (match uu___3 with
             | (m_ed, n_ed) ->
                 let uu___4 =
                   ...
                   let uu___9 = FStarC_List.hd us1 in
                   let uu___10 = FStarC_TypeChecker_Env.get_range env in
                   validate_indexed_effect_subcomp_shape env m n uu___5
                     uu___6 uu___7 uu___8 uu___9 ty1 Prims.int_zero uu___10 in
                 (match uu___4 with
                  | (k, kind) ->
                      ((let uu___6 = FStarC_Debug.extreme () in
                        if uu___6
