open Prims
let dbg_Exports : Prims.bool FStarC_Effect.ref=
  FStarC_Debug.get_toggle "Exports"
let dbg_LayeredEffects : Prims.bool FStarC_Effect.ref=
  FStarC_Debug.get_toggle "LayeredEffects"
let dbg_NYC : Prims.bool FStarC_Effect.ref= FStarC_Debug.get_toggle "NYC"
let dbg_Patterns : Prims.bool FStarC_Effect.ref=
  FStarC_Debug.get_toggle "Patterns"
let dbg_Range : Prims.bool FStarC_Effect.ref= FStarC_Debug.get_toggle "Range"
let dbg_RelCheck : Prims.bool FStarC_Effect.ref=
  FStarC_Debug.get_toggle "RelCheck"
let dbg_RFD : Prims.bool FStarC_Effect.ref= FStarC_Debug.get_toggle "RFD"
let dbg_Tac : Prims.bool FStarC_Effect.ref= FStarC_Debug.get_toggle "Tac"
let dbg_UniverseOf : Prims.bool FStarC_Effect.ref=
  FStarC_Debug.get_toggle "UniverseOf"
let instantiate_both (env : FStarC_TypeChecker_Env.env) :
...
let is_eq
  ...
  | uu___1 -> false
let steps (env : 'uuuuu) : FStarC_TypeChecker_Env.step Prims.list=
...
let norm (env : FStarC_TypeChecker_Env.env) (t : FStarC_Syntax_Syntax.term) :
  FStarC_Syntax_Syntax.term=
  FStarC_TypeChecker_Normalize.normalize (steps env) env t
let norm_c (env : FStarC_TypeChecker_Env.env) (c : FStarC_Syntax_Syntax.comp)
  : FStarC_Syntax_Syntax.comp=
  FStarC_TypeChecker_Normalize.normalize_comp (steps env) env c
let check_no_escape
  (head_opt : FStarC_Syntax_Syntax.term FStar_Pervasives_Native.option)
  (env : FStarC_TypeChecker_Env.env)
  (fvs : FStarC_Syntax_Syntax.bv Prims.list) (kt : FStarC_Syntax_Syntax.term)
  ...
  FStarC_Errors.with_ctx "While checking for escaped variables"
    (fun uu___ ->
           ...
           | FStar_Pervasives_Native.None ->
               let uu___1 =
                 ...
                 let uu___3 =
                   let uu___4 =
                     let uu___5 =
                       FStarC_Class_PP.pp FStarC_Syntax_Print.pretty_bv x in
               ...
               let uu___1 =
                 ...
                 let uu___3 =
                   ...
                   let uu___5 =
                     ...
                     let uu___7 =
                       let uu___8 =
                         FStarC_TypeChecker_Normalize.term_to_doc env head in
       ...
       | uu___1 ->
                    ...
                    FStarC_Class_Setlike.mem ()
                      (Obj.magic
                         (FStarC_FlatSet.setlike_flat_set
                            FStarC_Syntax_Syntax.ord_bv)) x (Obj.magic fvs'))
                 fvs in
             match uu___2 with
             | FStar_Pervasives_Native.None ->
                 (t1,
                 ...
                 then let uu___3 = norm env t1 in aux true uu___3
                   ...
                   (try
                      (fun uu___4 ->
                         ...
                         | () ->
                             let env_extended =
                               FStarC_TypeChecker_Env.push_bvs env fvs in
                             let uu___5 =
                               let uu___6 =
                             ...
                             (match uu___5 with
                              | (s, uu___6, g0) ->
                                  let uu___7 =
                                    FStarC_TypeChecker_Rel.try_teq false
                                      env_extended t1 s in
                                  (match uu___7 with
           ...
           aux false kt)
let check_expected_aqual_for_binder (aq : FStarC_Syntax_Syntax.aqual)
  (b : FStarC_Syntax_Syntax.binder) (pos : FStarC_Range_Type.t) :
       ...
       let uu___3 =
         let uu___4 =
           let uu___5 =
             ...
             FStarC_Format.fmt2
               "Expected an %splicit argument, got an %splicit one." uu___6
               uu___7 in
  ...
  expected_aq
let check_erasable_binder_attributes (env : FStarC_TypeChecker_Env.env)
  (attrs : FStarC_Syntax_Syntax.term Prims.list)
  (binder_ty : FStarC_Syntax_Syntax.typ) : unit=
  FStarC_List.iter
    (fun attr ->
       let uu___ =
         (FStarC_Syntax_Util.is_fvar FStarC_Parser_Const.erasable_attr attr)
           &&
           (let uu___1 =
       ...
       then
         FStarC_Errors.raise_error (FStarC_Syntax_Syntax.has_range_syntax ())
           attr FStarC_Errors_Codes.Fatal_QulifierListNotPermitted ()
           (Obj.magic FStarC_Errors_Msg.is_error_message_string)
           (Obj.magic
              "Incompatible attributes:  an erasable attribute on a binder must bind a name at an non-informative type")
       else ()) attrs
let push_binding (env : FStarC_TypeChecker_Env.env)
  (b : FStarC_Syntax_Syntax.binder) : FStarC_TypeChecker_Env.env=
  FStarC_TypeChecker_Env.push_bv env b.FStarC_Syntax_Syntax.binder_bv
let maybe_extend_subst (s : FStarC_Syntax_Syntax.subst_elt Prims.list)
  (b : FStarC_Syntax_Syntax.binder)
  (v : FStarC_Syntax_Syntax.term' FStarC_Syntax_Syntax.syntax) :
  FStarC_Syntax_Syntax.subst_t=
  let uu___ = FStarC_Syntax_Syntax.is_null_binder b in
  if uu___
  then s
  else (FStarC_Syntax_Syntax.NT ((b.FStarC_Syntax_Syntax.binder_bv), v)) :: s
let set_lcomp_result (lc : FStarC_TypeChecker_Common.lcomp)
  (t : FStarC_Syntax_Syntax.typ) : FStarC_TypeChecker_Common.lcomp=
...
let memo_tk (e : FStarC_Syntax_Syntax.term) (t : FStarC_Syntax_Syntax.typ) :
  FStarC_Syntax_Syntax.term= e
let maybe_warn_on_use (env : FStarC_TypeChecker_Env.env)
  (fv : FStarC_Syntax_Syntax.fv) : unit=
  let uu___ =
                    ...
                    let m =
                      let uu___2 =
                        let uu___3 =
                          FStarC_Ident.string_of_lid
                            fv.FStarC_Syntax_Syntax.fv_name in
                        FStarC_Format.fmt1 "%s is deprecated" uu___3 in
                      FStarC_Errors_Msg.text uu___2 in
                    let uu___2 = msg_arg [m] in
                    FStarC_Errors.log_issue FStarC_Ident.hasrange_lident
                      fv.FStarC_Syntax_Syntax.fv_name
                      ...
                      (Obj.magic uu___2)
                | uu___2 -> ())) attrs
let value_check_expected_typ (env : FStarC_TypeChecker_Env.env)
  (e : FStarC_Syntax_Syntax.term)
  (tlc :
    (FStarC_Syntax_Syntax.term, FStarC_TypeChecker_Common.lcomp)
      FStar_Pervasives.either)
  (guard : FStarC_TypeChecker_Env.guard_t) :
  (FStarC_Syntax_Syntax.term * FStarC_TypeChecker_Common.lcomp *
    FStarC_TypeChecker_Env.guard_t)=
  FStarC_Defensive.def_check_scoped FStarC_TypeChecker_Env.hasBinders_env
    FStarC_TypeChecker_Env.hasNames_guard FStarC_TypeChecker_Env.pretty_guard
    e.FStarC_Syntax_Syntax.pos "value_check_expected_typ" env guard;
  (let lc =
     match tlc with
   ...
   let uu___1 =
     ...
     | FStar_Pervasives_Native.Some (t', use_eq) ->
         let uu___3 =
           FStarC_TypeChecker_Util.check_has_type_maybe_coerce env e lc t'
             use_eq in
         (match uu___3 with
          | (e1, lc1, g) ->
              ((let uu___5 = FStarC_Debug.medium () in
                if uu___5
                then
                  let uu___6 = FStarC_TypeChecker_Common.lcomp_to_string lc1 in
                  let uu___7 =
                    FStarC_Class_Show.show FStarC_Syntax_Print.showable_term
                      t' in
                  let uu___8 = FStarC_TypeChecker_Rel.guard_to_string env g in
                  let uu___9 =
               ...
               (let t1 = lc1.FStarC_TypeChecker_Common.res_typ in
                ...
                let msg =
                  let uu___5 =
                    FStarC_TypeChecker_Env.is_trivial_guard_formula g1 in
                  if uu___5
                  then FStar_Pervasives_Native.None
                  else
                    FStar_Pervasives_Native.Some
                      (FStarC_TypeChecker_Err.subtyping_failed env t1 t') in
                let uu___5 =
                  FStarC_TypeChecker_Util.strengthen_precondition msg env e1
                    lc1 g1 in
                match uu___5 with
                | (lc2, g2) ->
...
let comp_check_expected_typ (env : FStarC_TypeChecker_Env.env)
  ...
  | FStar_Pervasives_Native.Some (t, use_eq) ->
      ...
      (match uu___1 with
       | (e1, lc1, g_c) ->
           let uu___2 =
             FStarC_TypeChecker_Util.weaken_result_typ env e1 lc1 t use_eq in
           (match uu___2 with
            | (e2, lc2, g) ->
                let uu___3 =
                  FStarC_Class_Monoid.op_Plus_Plus
                ...
                (e2, lc2, uu___3)))
let check_expected_effect (env : FStarC_TypeChecker_Env.env)
  (use_eq : Prims.bool)
  (copt : FStarC_Syntax_Syntax.comp FStar_Pervasives_Native.option)
  (ec : (FStarC_Syntax_Syntax.term * FStarC_Syntax_Syntax.comp)) :
      ...
      let uu___1 =
        ...
        | FStar_Pervasives_Native.None ->
            let uu___2 =
              ((FStarC_Options.ml_ish ()) &&
                 (let uu___3 = FStarC_Parser_Const.effect_ALL_lid () in
                  let uu___4 = FStarC_Syntax_Util.comp_effect_name c in
                  FStarC_Ident.lid_equals uu___3 uu___4))
                ||
                (((FStarC_Options.ml_ish ()) && (FStarC_Options.lax ())) &&
            ...
            then
              let uu___3 =
                let uu___4 =
                  FStarC_Syntax_Util.ml_comp ct e.FStarC_Syntax_Syntax.pos in
                 ...
                 (let uu___6 = FStarC_Syntax_Util.is_pure_or_ghost_comp c in
                  ...
                  then
                    ...
                    (let norm_eff_name =
                       ...
                       FStarC_TypeChecker_Env.norm_eff_name env uu___8 in
                     let uu___8 =
                     ...
                     then
                       let def_eff_opt =
                         FStarC_TypeChecker_Env.get_default_effect env
                           norm_eff_name in
                               ...
                               let uu___11 =
                                 let uu___12 =
                                   ...
                                   FStarC_Class_Show.show
                                     FStarC_Ident.showable_lident uu___13 in
                                 FStarC_Format.fmt1
                                   "Missing annotation for a layered effect (%s) computation."
                                   uu___12 in
                       ...
                       | FStar_Pervasives_Native.Some def_eff ->
                             ...
                             | FStarC_Syntax_Syntax.Comp
                                 {
                                   FStarC_Syntax_Syntax.comp_univs =
                                     comp_univs;
                                   FStarC_Syntax_Syntax.effect_name = uu___10;
                                   FStarC_Syntax_Syntax.result_typ =
                                     result_ty;
                                   FStarC_Syntax_Syntax.effect_args = uu___11;
                                   FStarC_Syntax_Syntax.flags = uu___12;_}
                           ...
                           (match uu___9 with
                            | (comp_univs, result_ty) ->
                                ...
                                let uu___10 =
                                  let uu___11 =
                                    FStarC_Syntax_Syntax.mk_Comp expected_c in
                                  FStar_Pervasives_Native.Some uu___11 in
                                (uu___10, c, FStar_Pervasives_Native.None))
                     else
                       (let uu___10 =
             ...
             (match expected_c_opt with
              ...
              | FStar_Pervasives_Native.Some expected_c ->
                  ((match gopt with
                   ...
                   (let c3 =
                      let uu___5 = FStarC_TypeChecker_Common.lcomp_of_comp c2 in
                      FStarC_TypeChecker_Util.maybe_assume_result_eq_pure_term
                        env e uu___5 in
                    let uu___5 = FStarC_TypeChecker_Common.lcomp_comp c3 in
                    match uu___5 with
                    | (c4, g_c) ->
                        (FStarC_Defensive.def_check_scoped
                           FStarC_TypeChecker_Env.hasBinders_env
                           ...
                           "check_expected_effect.c.after_assume" env c4;
                         (let uu___8 = FStarC_Debug.medium () in
                          ...
                          then
                            ...
                            let uu___11 =
                              FStarC_Class_Show.show
                                FStarC_Syntax_Print.showable_comp expected_c in
                            let uu___12 =
                              FStarC_Class_Show.show
                                FStarC_Class_Show.showable_bool use_eq in
                            FStarC_Format.print4
                         ...
                         (let uu___8 =
                            FStarC_TypeChecker_Util.check_comp env use_eq e
                              c4 expected_c in
                          match uu___8 with
                          | (e1, uu___9, g) ->
                              let g1 =
                                ...
                                FStarC_TypeChecker_Util.label_guard uu___10
                                  uu___11 g in
                              ((let uu___11 = FStarC_Debug.medium () in
                                if uu___11
                                then
                                  let uu___12 =
                               ...
                               (let e2 =
                                  let uu___11 =
                                    FStarC_Syntax_Util.comp_effect_name c4 in
                                  let uu___12 =
                                    FStarC_Syntax_Util.comp_effect_name
                                      expected_c in
                                  let uu___13 =
                                    FStarC_Syntax_Util.comp_result c4 in
                                  FStarC_TypeChecker_Util.maybe_lift env e1
...
let no_logical_guard (env : FStarC_TypeChecker_Env.env)
  (uu___ : ('uuuuu * 'uuuuu1 * FStarC_TypeChecker_Env.guard_t)) :
      ...
      (match uu___1 with
       ...
       | FStarC_TypeChecker_Common.NonTrivial f1 ->
           FStarC_TypeChecker_Err.unexpected_non_trivial_precondition_on_term
             env f1)
let print_expected_ty_str (env : FStarC_TypeChecker_Env.env) : Prims.string=
  let uu___ = FStarC_TypeChecker_Env.expected_typ env in
  match uu___ with
  ...
  | FStar_Pervasives_Native.Some (t, use_eq) ->
      ...
      FStarC_Format.fmt2 "Expected type is (%s, use_eq = %s)" uu___1 uu___2
let print_expected_ty (env : FStarC_TypeChecker_Env.env) : unit=
  let uu___ = print_expected_ty_str env in FStarC_Format.print1 "%s\n" uu___
let rec get_pat_vars' (uu___2 : FStarC_Syntax_Syntax.bv Prims.list)
  (uu___1 : Prims.bool) (uu___ : FStarC_Syntax_Syntax.term) :
  FStarC_Syntax_Syntax.bv FStarC_FlatSet.t=
  (fun all andlist pats ->
     ...
     | (head, args) ->
         ...
         (match uu___1 with
          ...
          | (FStarC_Syntax_Syntax.Tm_fvar fv,
             (uu___2, FStar_Pervasives_Native.Some
              { FStarC_Syntax_Syntax.aqual_implicit = true;
                FStarC_Syntax_Syntax.aqual_attributes = uu___3;_})::(hd,
                                                                    FStar_Pervasives_Native.None)::
                   ...
                   (let hdvs = get_pat_vars' all false hd in
                    ...
                    then
                      FStarC_Class_Setlike.inter ()
                        (Obj.magic
                           (FStarC_FlatSet.setlike_flat_set
                              FStarC_Syntax_Syntax.ord_bv)) (Obj.magic hdvs)
                        (Obj.magic tlvs)
                    else
          ...
          | (FStarC_Syntax_Syntax.Tm_fvar fv,
             (uu___2, FStar_Pervasives_Native.Some
              { FStarC_Syntax_Syntax.aqual_implicit = true;
                FStarC_Syntax_Syntax.aqual_attributes = uu___3;_})::(pat,
                                                                    FStar_Pervasives_Native.None)::[])
              when
    ...
    uu___1 uu___
let get_pat_vars (all : FStarC_Syntax_Syntax.bv Prims.list)
  (pats : FStarC_Syntax_Syntax.term) :
  FStarC_Syntax_Syntax.bv FStarC_FlatSet.t= get_pat_vars' all false pats
let check_pat_fvs (rng : FStarC_Range_Type.t)
  (env : FStarC_TypeChecker_Env.env) (pats : FStarC_Syntax_Syntax.term)
  (bs : FStarC_Syntax_Syntax.binder Prims.list) : unit=
  let pat_vars =
    let uu___ =
      FStarC_List.map (fun b -> b.FStarC_Syntax_Syntax.binder_bv) bs in
    let uu___1 =
      FStarC_TypeChecker_Normalize.normalize [FStarC_TypeChecker_Env.Beta]
        env pats in
         ...
         | { FStarC_Syntax_Syntax.binder_bv = b;
             ...
             let uu___5 =
               FStarC_Class_Setlike.mem ()
                 (Obj.magic
                    (FStarC_FlatSet.setlike_flat_set
                       FStarC_Syntax_Syntax.ord_bv)) b (Obj.magic pat_vars) in
  ...
  | FStar_Pervasives_Native.Some
      ...
      ->
      let uu___4 =
        let uu___5 = FStarC_Class_Show.show FStarC_Syntax_Print.showable_bv x in
        FStarC_Format.fmt1 "Pattern misses at least one bound variable: %s"
          uu___5 in
      FStarC_Errors.log_issue (FStarC_Syntax_Syntax.has_range_syntax ()) pats
        FStarC_Errors_Codes.Warning_SMTPatternIllFormed ()
        (Obj.magic FStarC_Errors_Msg.is_error_message_string)
        (Obj.magic uu___4)
let check_no_smt_theory_symbols (en : FStarC_TypeChecker_Env.env)
        ...
        (match uu___1 with
         ...
         | (FStarC_Syntax_Syntax.Tm_fvar fv,
            uu___2::(hd, uu___3)::(tl, uu___4)::[]) when
             ...
             let uu___6 = pat_terms tl in FStarC_List.op_At uu___5 uu___6
         | (FStarC_Syntax_Syntax.Tm_fvar fv, uu___2::(pat, uu___3)::[]) when
             FStarC_Syntax_Syntax.fv_eq_lid fv FStarC_Parser_Const.smtpat_lid
             -> [pat]
         | (FStarC_Syntax_Syntax.Tm_fvar fv,
            (subpats, FStar_Pervasives_Native.None)::[]) when
             FStarC_Syntax_Syntax.fv_eq_lid fv
  ...
  let rec aux t1 =
    ...
    | FStarC_Syntax_Syntax.Tm_app
        ...
        FStarC_List.fold_left
          (fun acc uu___2 ->
             match uu___2 with
             | (t3, uu___3) ->
                 let uu___4 = aux t3 in FStarC_List.op_At acc uu___4) uu___1
          args
    ...
    | FStarC_Syntax_Syntax.Tm_meta
        ...
        -> aux t2 in
  let tlist = let uu___ = pat_terms t in FStarC_List.collect aux uu___ in
  if (FStarC_List.length tlist) = Prims.int_zero
  then ()
  else
    (let uu___1 =
       let uu___2 =
     ...
     FStarC_Errors.log_issue (FStarC_Syntax_Syntax.has_range_syntax ()) t
       ...
       (Obj.magic FStarC_Errors_Msg.is_error_message_list_doc)
       (Obj.magic uu___1))
let check_smt_pat (env : FStarC_TypeChecker_Env.env)
  (t : FStarC_Syntax_Syntax.term' FStarC_Syntax_Syntax.syntax)
  (bs : FStarC_Syntax_Syntax.binder Prims.list)
  (c : FStarC_Syntax_Syntax.comp' FStarC_Syntax_Syntax.syntax) : unit=
  ...
  then
    ...
    | FStarC_Syntax_Syntax.Comp
        { FStarC_Syntax_Syntax.comp_univs = uu___1;
          ...
          FStarC_Syntax_Syntax.effect_args = _pre::_post::(pats, uu___4)::[];
...
let guard_letrecs (env : FStarC_TypeChecker_Env.env)
  (actuals : FStarC_Syntax_Syntax.binders)
  (expected_c : FStarC_Syntax_Syntax.comp) :
  ...
  | letrecs ->
      ...
      let decreases_clause bs c =
        ...
        (let filter_types_and_functions bs1 =
               ...
               (fun uu___2 binder ->
                  ...
                  | (out, env2) ->
                      ...
                      let t =
                        ...
                        FStarC_TypeChecker_Normalize.unfold_whnf env2 uu___3 in
                      let env3 =
                        FStarC_TypeChecker_Env.push_binders env2 [binder] in
                      (match t.FStarC_Syntax_Syntax.n with
                       | FStarC_Syntax_Syntax.Tm_type uu___3 -> (out, env3)
                       | FStarC_Syntax_Syntax.Tm_arrow uu___3 -> (out, env3)
                       | uu___3 ->
                           let arg = FStarC_Syntax_Syntax.bv_to_name b in
                           let arg1 =
                             let uu___4 = FStarC_Syntax_Util.is_erased_head t in
                             match uu___4 with
                             | FStar_Pervasives_Native.Some (u, ty) ->
                                 FStarC_Syntax_Util.apply_reveal u ty arg
                             | uu___5 -> arg in
                           ((arg1 :: out), env3))) ([], env1) bs1 in
           match uu___1 with | (out_rev, env2) -> FStarC_List.rev out_rev in
         ...
         match uu___1 with
         | FStar_Pervasives_Native.Some (FStarC_Syntax_Syntax.DECREASES d) ->
             d
         | uu___2 ->
      ...
      let rec mk_precedes_lex env2 l l_prev =
        let rec aux l1 l_prev1 =
          let type_of should_warn e1 e2 =
            ...
            let rec warn t11 t21 =
              let uu___ =
                let uu___1 =
                  FStarC_TypeChecker_TermEqAndSimplify.eq_tm env2 t11 t21 in
                 ...
                 | (FStarC_Syntax_Syntax.Tm_app
                    ...
                    { FStarC_Syntax_Syntax.hd = h2;
                     ...
                     ((warn h1 h2) ||
                       ...
                       ||
                       (let uu___3 = FStarC_List.zip args1 args2 in
                        FStarC_List.existsML
                          (fun uu___4 ->
                             match uu___4 with
                             | ((a1, uu___5), (a2, uu___6)) -> warn a1 a2)
                          uu___3)
                 | (FStarC_Syntax_Syntax.Tm_refine
                    ...
                    { FStarC_Syntax_Syntax.b = t22;
                     ...
                     (warn t12.FStarC_Syntax_Syntax.sort
                       ...
                       || (warn phi1 phi2)
                 | (FStarC_Syntax_Syntax.Tm_uvar uu___3, uu___4) -> false
                 | (uu___3, FStarC_Syntax_Syntax.Tm_uvar uu___4) -> false
                   ...
                   let uu___5 =
                     let uu___6 =
                       ...
                       let uu___8 =
                               ...
                               let uu___14 =
                                 let uu___15 =
                                   ...
                                   FStar_Pprint.op_Hat_Slash_Hat uu___16
                                     uu___17 in
                                 FStar_Pprint.parens uu___15 in
                         ...
                         let uu___10 = FStarC_Errors_Msg.text "are equal." in
          ...
          | ([], []) ->
              let uu___ =
                let uu___1 =
                  FStarC_Syntax_Syntax.as_arg FStarC_Syntax_Syntax.unit_const in
                let uu___2 =
                  let uu___3 =
                   ...
                   let uu___1 =
                     ...
                     let uu___3 =
                       ...
                       let uu___5 =
                         ...
                         let uu___7 =
                           let uu___8 = FStarC_Syntax_Syntax.as_arg x_prev in
                           [uu___8] in
                         uu___6 :: uu___7 in
                       uu___4 :: uu___5 in
                     uu___2 :: uu___3 in
          ...
          | (x::tl, x_prev::tl_prev) ->
              ...
              (match uu___ with
               | (t_x, t_x_prev) ->
                   ...
                   let eq3_x_x_prev =
                     FStarC_Syntax_Util.mk_eq3_no_univ t_x t_x_prev x x_prev in
                   let uu___1 =
        ...
        let uu___ =
          let uu___1 = ((FStarC_List.length l), (FStarC_List.length l_prev)) in
          match uu___1 with
          | (n, n_prev) ->
              if n = n_prev
              then (l, l_prev)
                ...
                then
                  (let uu___3 =
                     let uu___4 = FStarC_List.splitAt n l_prev in
                     FStar_Pervasives_Native.fst uu___4 in
                   (l, uu___3))
                else
                  (let uu___4 =
                     let uu___5 = FStarC_List.splitAt n_prev l in
           ...
           FStarC_Syntax_Syntax.Decreases_wf (rel_prev, e_prev)) ->
            let rel_guard =
              let uu___ =
                ...
                let uu___2 =
                  let uu___3 = FStarC_Syntax_Syntax.as_arg e_prev in [uu___3] in
                uu___1 :: uu___2 in
              FStarC_Syntax_Syntax.mk_Tm_app rel uu___ r in
            let uu___ =
              let uu___1 =
                FStarC_TypeChecker_TermEqAndSimplify.eq_tm env2 rel rel_prev in
              uu___1 = FStarC_TypeChecker_TermEqAndSimplify.Equal in
            if uu___
            then rel_guard
            else
              (let uu___2 =
               ...
               | (t_rel, uu___3) ->
                   ...
                   (match uu___4 with
                    | (t_rel_prev, uu___5) ->
                        let eq_guard =
                          FStarC_Syntax_Util.mk_eq3_no_univ t_rel t_rel_prev
                            rel rel_prev in
      ...
      let guard_one_letrec uu___ =
        ...
        | (l, arity, t, u_names) ->
            ...
            (match uu___1 with
             | (formals, c) ->
                 (if arity > (FStarC_List.length formals)
                  then
                    failwith
                  ...
                  (let formals1 =
                   ...
                   let precedes =
                     let env2 =
                       FStarC_TypeChecker_Env.push_binders env1 formals1 in
                   ...
                   let uu___3 = FStarC_Util.prefix formals1 in
                   match uu___3 with
                   | (bs,
                      { FStarC_Syntax_Syntax.binder_bv = last;
                       ...
                       let refined_formals =
                         let uu___4 =
                           let uu___5 =
                             FStarC_Syntax_Syntax.mk_binder_with_attrs last1
                               imp pqual attrs in
                           [uu___5] in
                         FStarC_List.op_At bs uu___4 in
...
let wrap_guard_with_tactic_opt
  (topt : FStarC_Syntax_Syntax.term FStar_Pervasives_Native.option)
  (g : FStarC_TypeChecker_Env.guard_t) : FStarC_TypeChecker_Env.guard_t=
  match topt with
...
let is_comp_ascribed_reflect (e : FStarC_Syntax_Syntax.term) :
  ...
  | FStarC_Syntax_Syntax.Tm_ascribed
      ...
      (match uu___5 with
       | FStarC_Syntax_Syntax.Tm_app
           ...
           when (FStarC_List.length args) = Prims.int_one ->
           let uu___6 =
             let uu___7 = FStarC_Syntax_Subst.compress head in
             uu___7.FStarC_Syntax_Syntax.n in
           (match uu___6 with
            | FStarC_Syntax_Syntax.Tm_constant (FStarC_Const.Const_reflect l)
                ->
                let uu___7 =
                  let uu___8 = FStarC_List.hd args in
...
let effect_has_primitive_extraction (env : FStarC_TypeChecker_Env.env)
  (eff : FStarC_Ident.lident) : Prims.bool=
  let eff1 = FStarC_TypeChecker_Env.norm_eff_name env eff in
  let ed = FStarC_TypeChecker_Env.get_effect_decl env eff1 in
  FStarC_Syntax_Util.has_attribute ed.FStarC_Syntax_Syntax.eff_attrs
    FStarC_Parser_Const.primitive_extraction_attr
let rec tc_term (env : FStarC_TypeChecker_Env.env)
  (e : FStarC_Syntax_Syntax.term) :
  (FStarC_Syntax_Syntax.term * FStarC_TypeChecker_Common.lcomp *
    FStarC_TypeChecker_Env.guard_t)=
  FStarC_Defensive.def_check_scoped FStarC_TypeChecker_Env.hasBinders_env
  ...
  (let uu___2 = FStarC_Debug.medium () in
   ...
   then
     ...
     let uu___5 = FStarC_Class_Show.show FStarC_Syntax_Print.showable_term e in
     let uu___6 =
  ...
  (let uu___2 =
   ...
   | (r, ms) ->
       ((let uu___4 = FStarC_Debug.medium () in
            ...
            (let uu___6 = r in
             ...
             | (e1, lc, uu___7) ->
                 let uu___8 =
                   ...
                   FStarC_Range_Ops.string_of_range uu___9 in
                 let uu___9 =
                   FStarC_Class_Show.show FStarC_Syntax_Print.showable_term
                     e1 in
                 let uu___10 = FStarC_TypeChecker_Common.lcomp_to_string lc in
                 let uu___11 =
        ...
        r))
and tc_maybe_toplevel_term (env : FStarC_TypeChecker_Env.env)
  (e : FStarC_Syntax_Syntax.term) :
  (FStarC_Syntax_Syntax.term * FStarC_TypeChecker_Common.lcomp *
    FStarC_TypeChecker_Env.guard_t)=
  let env1 =
    if e.FStarC_Syntax_Syntax.pos = FStarC_Range_Type.dummyRange
    then env
  ...
  (let top = FStarC_Syntax_Subst.compress e in
   ...
   (match top.FStarC_Syntax_Syntax.n with
    ...
    | FStarC_Syntax_Syntax.Tm_quoted (qt, qi) ->
        ...
        let non_trivial_antiquotations qi1 =
          let is_not_name t =
            ...
            | uu___3 -> true in
          FStarC_Util.for_some is_not_name
               ...
               let uu___2 =
                 let uu___3 =
                   FStarC_List.map
                     (fun uu___4 ->
                        match uu___4 with
                        | (t, bv') -> FStarC_Syntax_Syntax.bv_to_name bv') z in
                 (Prims.int_zero, uu___3) in
               {
                 FStarC_Syntax_Syntax.qkind = (qi.FStarC_Syntax_Syntax.qkind);
         ...
         | FStarC_Syntax_Syntax.Quote_static ->
             ...
             let uu___2 =
               FStarC_List.fold_left
                             ...
                             let env_tm2 =
                               let uu___6 =
                                 FStarC_Syntax_Syntax.new_bv
                                   FStar_Pervasives_Native.None
                                   FStarC_Syntax_Syntax.t_term in
                               FStarC_TypeChecker_Env.push_bv env_tm1 uu___6 in
                             let uu___6 =
                               FStarC_Class_Monoid.op_Plus_Plus
                 ...
                 ([],
                   (FStarC_Class_Monoid.mzero
                      FStarC_TypeChecker_Common.monoid_guard_t), env_tm) aqs in
             (match uu___2 with
              | (aqs_rev, guard, _env) ->
                  let qi1 =
                    {
                      ...
                      FStarC_Syntax_Syntax.antiquotations =
                        (Prims.int_zero, (FStarC_List.rev aqs_rev))
                    } in
                  let tm =
                    FStarC_Syntax_Syntax.mk
                      (FStarC_Syntax_Syntax.Tm_quoted (qt, qi1))
                  ...
                  value_check_expected_typ env1 tm
                    (FStar_Pervasives.Inl FStarC_Syntax_Syntax.t_term) guard)
         | FStarC_Syntax_Syntax.Quote_dynamic ->
             let c = FStarC_Syntax_Syntax.mk_Tac FStarC_Syntax_Syntax.t_term in
              ...
              | (env', uu___3) ->
                  ...
                  (match uu___4 with
                   | (qt1, uu___5, g) ->
                       ...
                       let g01 =
                         FStarC_TypeChecker_Rel.resolve_implicits env'1 g0 in
                       let t =
                         FStarC_Syntax_Syntax.mk
    ...
    | FStarC_Syntax_Syntax.Tm_ascribed
        ...
        ->
        let uu___2 =
          tc_tactic FStarC_Syntax_Syntax.t_unit FStarC_Syntax_Syntax.t_unit
            env1 tac in
        (match uu___2 with
         | (tac1, uu___3, g_tac) ->
             let t' =
                        ...
                        (let u_c =
                         ...
                         let repr =
                           let uu___11 =
                             ...
                             FStarC_TypeChecker_Env.effect_repr env0 uu___12
                               u_c in
                           FStarC_Option.must uu___11 in
                         let e2 =
                           let uu___11 =
                             let uu___12 =
                               let uu___13 =
                           ...
                           FStarC_Syntax_Syntax.mk uu___11
                             e1.FStarC_Syntax_Syntax.pos in
                         (let uu___12 = FStarC_Debug.extreme () in
                          if uu___12
                          then
                            let uu___13 =
                              FStarC_Class_Show.show
                         ...
                         (let uu___12 = tc_tot_or_gtot_term env0 e2 in
                          ...
                          | (e3, uu___13, g_e) ->
                              ...
                              ((let uu___15 = FStarC_Debug.extreme () in
                                if uu___15
                                then
                                  let uu___16 =
                                    FStarC_Class_Show.show
                                      FStarC_Syntax_Print.showable_term e4 in
                                  let uu___17 =
                                    FStarC_TypeChecker_Rel.guard_to_string
                                      env0 g_e in
                                  FStarC_Format.print2
                               ...
                               (let top1 =
                                  ...
                                  let uu___15 =
                                    ...
                                    FStarC_Syntax_Syntax.Tm_ascribed uu___16 in
                                  FStarC_Syntax_Syntax.mk uu___15 r in
                                let uu___15 =
                                  let uu___16 =
                                    FStarC_TypeChecker_Common.lcomp_of_comp
                                      expected_c1 in
                                  comp_check_expected_typ env1 top1 uu___16 in
                                match uu___15 with
                                | (top2, c, g_env) ->
                                    let uu___16 =
                                      let uu___17 =
         ...
         | (env0, uu___4) ->
             ...
             (match uu___5 with
              | (expected_c1, uu___6, g) ->
                  let uu___7 =
                    let uu___8 =
                      let uu___9 = FStarC_Syntax_Util.comp_result expected_c1 in
                      FStarC_TypeChecker_Env.set_expected_typ_maybe_eq env0
                        uu___9 use_eq in
                    tc_term uu___8 e1 in
                  (match uu___7 with
                   | (e2, c', g') ->
                       let uu___8 =
                         let uu___9 = FStarC_TypeChecker_Common.lcomp_comp c' in
                         match uu___9 with
                         | (c'1, g_c') ->
                             let uu___10 =
                        ...
                        | (e3, expected_c2, g'') ->
                              ...
                              let uu___9 =
                                let uu___10 =
                                    ...
                                    FStar_Pervasives_Native.Some uu___12 in
                                  {
                                    ...
                                    FStarC_Syntax_Syntax.eff_opt = uu___11
                                  } in
                                FStarC_Syntax_Syntax.Tm_ascribed uu___10 in
                            ...
                            let f =
                              ...
                              FStarC_Class_Monoid.op_Plus_Plus
                                FStarC_TypeChecker_Common.monoid_guard_t
                                uu___9 g'' in
                            let uu___9 = comp_check_expected_typ env1 e4 lc in
                            (match uu___9 with
                             | (e5, c, f2) ->
                                 let uu___10 =
                                   FStarC_Class_Monoid.op_Plus_Plus
         ...
         | (k, u) ->
             ...
             (match uu___4 with
              | (t1, uu___5, f) ->
                  let uu___6 =
                    let uu___7 =
                      FStarC_TypeChecker_Env.set_expected_typ_maybe_eq env1
                        t1 use_eq in
          ...
          FStarC_Syntax_Syntax.hd =
            {
              ...
              FStarC_Syntax_Syntax.vars = uu___3;
              FStarC_Syntax_Syntax.hash_code = uu___4;_};
          FStarC_Syntax_Syntax.args = (e1, FStar_Pervasives_Native.None)::[];_}
        ->
        let uu___5 =
          let uu___6 =
    ...
    | FStarC_Syntax_Syntax.Tm_app
        ...
        let uu___6 =
          let uu___7 =
            FStarC_Class_Show.show FStarC_Syntax_Print.showable_term top in
          FStarC_Format.fmt1 "Ill-applied constant %s" uu___7 in
        FStarC_Errors.raise_error (FStarC_Syntax_Syntax.has_range_syntax ())
          e FStarC_Errors_Codes.Fatal_IllAppliedConstant ()
          (Obj.magic FStarC_Errors_Msg.is_error_message_string)
          (Obj.magic uu___6)
    | FStarC_Syntax_Syntax.Tm_app
        {
    ...
    | FStarC_Syntax_Syntax.Tm_app
        ...
        ->
        (if FStar_Pervasives_Native.uu___is_Some aqual
         then
              ...
              (match uu___9 with
               | (e2, c, g) ->
                   let uu___10 =
                     ...
                     | (c1, g_c) ->
                         let uu___12 =
                           FStarC_TypeChecker_Env.unfold_effect_abbrev env1
                             c1 in
                         (uu___12, g_c) in
                   (match uu___10 with
                    | (c1, g_c) ->
                        ((let uu___12 =
                         ...
                         (let u_c =
                            FStarC_List.hd c1.FStarC_Syntax_Syntax.comp_univs in
                          let e3 =
                          ...
                          let repr =
                            ...
                            FStarC_TypeChecker_Env.reify_comp env1 uu___12
                              u_c in
                          let c2 =
                            let uu___12 =
                              effect_has_primitive_extraction env1
                                c1.FStarC_Syntax_Syntax.effect_name in
                            if uu___12
                            then
                              let uu___13 =
                                FStarC_Syntax_Syntax.mk_GTotal repr in
                              FStarC_TypeChecker_Common.lcomp_of_comp uu___13
                            else
                              (let uu___14 =
                               ...
                               then
                                 ...
                                 (let ct =
                                    {
                                      FStarC_Syntax_Syntax.comp_univs = [u_c];
                                      FStarC_Syntax_Syntax.effect_name =
                                  ...
                                  FStarC_TypeChecker_Common.lcomp_of_comp
                                    uu___16)) in
                          let uu___12 = comp_check_expected_typ env1 e3 c2 in
                          match uu___12 with
                          | (e4, c3, g') ->
                              let uu___13 =
                                let uu___14 =
         ...
         (let uu___7 =
          ...
          then
            let uu___8 =
              ...
              FStarC_Format.fmt1 "Effect %s cannot be reflected" uu___9 in
            FStarC_Errors.raise_error
              (FStarC_Syntax_Syntax.has_range_syntax ()) e1
              FStarC_Errors_Codes.Fatal_EffectCannotBeReified ()
              (Obj.magic FStarC_Errors_Msg.is_error_message_string)
              ...
              (match uu___9 with
               | FStar_Pervasives_Native.None ->
                   let uu___10 =
                     ...
                     FStarC_Format.fmt1 "Effect %s not found (for reflect)"
                       uu___11 in
                   FStarC_Errors.raise_error
                     (FStarC_Syntax_Syntax.has_range_syntax ()) e1
                             ...
                             let uu___13 =
                               ...
                               | (a, u_a) ->
                                   let uu___15 =
                                     FStarC_TypeChecker_Util.new_implicit_var
                                       "tc_term reflect"
                                       e2.FStarC_Syntax_Syntax.pos env_no_ex
                                       a false in
                                   (match uu___15 with
                                    | (a_uvar, uu___16, g_a) ->
                                        let uu___17 =
                                          FStarC_TypeChecker_Util.fresh_effect_repr_en
                                            env_no_ex
                                            e2.FStarC_Syntax_Syntax.pos l u_a
                                            a_uvar in
                             ...
                             (match uu___13 with
                              | ((expected_repr_typ, g_repr), u_a, a, g_a) ->
                                  ...
                                  let eff_args =
                                    ...
                                    match uu___14 with
                                    | FStarC_Syntax_Syntax.Tm_app
                                        { FStarC_Syntax_Syntax.hd = uu___15;
                                          FStarC_Syntax_Syntax.args =
                                            uu___16::args;_}
                                        -> args
                                    | uu___15 ->
    ...
    | FStarC_Syntax_Syntax.Tm_app
        ...
        let uu___6 =
          let uu___7 =
            ...
            then
              match args with
              | (b, uu___8)::rest -> ((FStar_Pervasives_Native.Some b), rest)
              | uu___8 -> failwith "Impossible"
            else (FStar_Pervasives_Native.None, args) in
          match uu___7 with
          | (base_term, fields) ->
              if
                (FStarC_List.length uc.FStarC_Syntax_Syntax.uc_fields) <>
                  (FStarC_List.length fields)
              then
                let uu___8 =
                  let uu___9 =
                    FStarC_Class_Show.show FStarC_Class_Show.showable_nat
                      (FStarC_List.length uc.FStarC_Syntax_Syntax.uc_fields) in
                  let uu___10 =
                    FStarC_Class_Show.show FStarC_Class_Show.showable_nat
                      (FStarC_List.length fields) in
                  FStarC_Format.fmt2
                ...
                (let uu___9 =
                   let uu___10 =
                     FStarC_List.map FStar_Pervasives_Native.fst fields in
                   FStarC_List.zip uc.FStarC_Syntax_Syntax.uc_fields uu___10 in
                 (base_term, uu___9)) in
        (match uu___6 with
         | (base_term, uc_fields) ->
             let uu___7 =
              ...
              | ((rdc, constrname, constructor), topt) ->
                  ...
                  let mk_field_projector i x =
                    ...
                    FStarC_Syntax_Syntax.mk_Tm_app candidate
                      ...
                      x.FStarC_Syntax_Syntax.pos in
                  let fields =
                    FStarC_TypeChecker_Util.make_record_fields_in_order env1
                      uc topt rdc1 uc_fields
                      (fun field_name ->
                         match base_term with
                         | FStar_Pervasives_Native.Some x ->
    ...
    | FStarC_Syntax_Syntax.Tm_app
        {
          FStarC_Syntax_Syntax.hd =
            {
              FStarC_Syntax_Syntax.n = FStarC_Syntax_Syntax.Tm_fvar
                { FStarC_Syntax_Syntax.fv_name = field_name;
                  FStarC_Syntax_Syntax.fv_qual = FStar_Pervasives_Native.Some
        ...
        let proceed_with choice =
          ...
          | FStar_Pervasives_Native.None ->
              let uu___5 =
                let uu___6 =
                  let uu___7 =
                    let uu___8 = FStarC_Ident.string_of_lid field_name in
        ...
        let uu___5 =
          let uu___6 = FStarC_TypeChecker_Env.clear_expected_typ env1 in
        ...
        (match uu___5 with
         | (uu___6, lc, uu___7) ->
             ...
             let uu___8 = FStarC_Syntax_Util.head_and_args t0 in
             (match uu___8 with
              | (thead, uu___9) ->
                  ((let uu___11 = FStarC_Effect.op_Bang dbg_RFD in
                    if uu___11
                    then
                      let uu___12 =
                        FStarC_Class_Show.show
                             ...
                             (match i with
                              ...
                              | FStar_Pervasives_Native.Some (i1, uu___13) ->
                                  let constrname =
                                    ...
                                    FStarC_Ident.lid_of_ids uu___14 in
                                  let projname =
                                    FStarC_Syntax_Util.mk_field_projector_name_from_ident
                                      constrname i1 in
                                  let qual =
                                  ...
                                  let choice =
                                    let uu___14 =
                                      let uu___15 =
                                        FStarC_Ident.range_of_lid field_name in
                                      FStarC_Ident.set_lid_range projname
                                        uu___15 in
                                    FStarC_Syntax_Syntax.lid_as_fv uu___14
                                      qual in
                                  proceed_with
    ...
    | FStarC_Syntax_Syntax.Tm_app
        { FStarC_Syntax_Syntax.hd = head;
          FStarC_Syntax_Syntax.args = (tau, FStar_Pervasives_Native.None)::[];_}
        when
    ...
    | FStarC_Syntax_Syntax.Tm_app
        { FStarC_Syntax_Syntax.hd = head;
          FStarC_Syntax_Syntax.args =
            (uu___2, FStar_Pervasives_Native.Some
             { FStarC_Syntax_Syntax.aqual_implicit = true;
               FStarC_Syntax_Syntax.aqual_attributes = uu___3;_})::(tau,
                                                                    FStar_Pervasives_Native.None)::[];_}
        when
        (FStarC_Syntax_Util.is_synth_by_tactic head) &&
          (Prims.op_Negation env1.FStarC_TypeChecker_Env.phase1)
    ...
    | FStarC_Syntax_Syntax.Tm_app
        ...
        (match uu___2 with
         | (args1, args2) ->
             ...
             let t2 = FStarC_Syntax_Util.mk_app t1 args2 in tc_term env1 t2)
    | FStarC_Syntax_Syntax.Tm_app
        { FStarC_Syntax_Syntax.hd = head; FStarC_Syntax_Syntax.args = args;_}
        ->
        let env0 = env1 in
        ...
        ((let uu___3 = FStarC_Debug.high () in
          if uu___3
          then
            let uu___4 =
              FStarC_Range_Ops.string_of_range top.FStarC_Syntax_Syntax.pos in
            let uu___5 =
              FStarC_Class_Show.show FStarC_Syntax_Print.showable_term top in
                   ...
                   let uu___5 =
                     ...
                     then
                       let uu___7 =
                         ...
                         check_short_circuit_args env2 head1 chead1 g_head1
                           args uu___8 in
                       match uu___7 with | (e1, c, g) -> (e1, c, g)
                     else
                       (let uu___8 = FStarC_TypeChecker_Env.expected_typ env0 in
                        check_application_args env2 head1 chead1 g_head1 args
                          uu___8) in
                   (match uu___5 with
                    | (e1, c, g) ->
                        let uu___6 =
                          let uu___7 =
                            (FStarC_TypeChecker_Common.is_tot_or_gtot_lcomp c)
                              ||
                          ...
                          then
                            let uu___8 =
                              FStarC_TypeChecker_Util.maybe_instantiate env0
                                e1 c.FStarC_TypeChecker_Common.res_typ in
                            match uu___8 with
                        ...
                        (match uu___6 with
                         | (e2, c1, implicits) ->
                             ((let uu___8 = FStarC_Debug.extreme () in
                               if uu___8
                               then
                                 let uu___9 =
                               ...
                               | (e3, c2, g') ->
                                   let gres =
                                     ...
                                     FStarC_Class_Monoid.op_Plus_Plus
                                       FStarC_TypeChecker_Common.monoid_guard_t
                                       uu___9 implicits in
                                   ((let uu___10 = FStarC_Debug.extreme () in
                                     if uu___10
                                     then
                                       let uu___11 =
                                         FStarC_Class_Show.show
...
and tc_match (env : FStarC_TypeChecker_Env.env)
                       ...
                       | FStar_Pervasives_Native.Some (us, t) ->
                           ...
                           (match uu___9 with
                            | (bs, c) ->
                                ...
                                FStarC_TypeChecker_Util.maybe_coerce_lc env'
                                  e11 c1 uu___10)
                       | FStar_Pervasives_Native.None ->
                           (e11, c1,
                             (FStarC_Class_Monoid.mzero
           ...
           (match uu___3 with
            | (e12, c11, g_c) ->
                let uu___4 =
                  match ret_opt with
                  | FStar_Pervasives_Native.None ->
                      let uu___5 = FStarC_TypeChecker_Env.expected_typ env in
                      (match uu___5 with
                           ...
                           (match uu___6 with
                            | (k, uu___7) ->
                                let uu___8 =
                                  FStarC_TypeChecker_Util.new_implicit_var
                                    "match result"
                                    e12.FStarC_Syntax_Syntax.pos env k false in
                                (match uu___8 with
                                 | (res_t, uu___9, g) ->
                                     let uu___10 =
                      ...
                      ((let uu___6 =
                        ...
                        then
                          let uu___7 =
                            ...
                            FStarC_Format.fmt2
                              ...
                              uu___8 uu___9 in
                          FStarC_Errors.raise_error
                            (FStarC_Syntax_Syntax.has_range_syntax ()) e12
                            FStarC_Errors_Codes.Fatal_UnexpectedEffect ()
                            (Obj.magic
                               FStarC_Errors_Msg.is_error_message_string)
                            (Obj.magic uu___7)
                       ...
                       (let uu___6 =
                        ...
                        | (env1, uu___7) ->
                            let uu___8 =
                              let uu___9 =
                                FStarC_Syntax_Subst.open_ascription [b] asc in
                              match uu___9 with
                              | (bs, asc1) ->
                ...
                (match uu___4 with
                 | (env_branches, ret_opt1, g11) ->
                     ...
                     let t_eqns =
                       FStarC_List.map (tc_eqn guard_x env_branches ret_opt1)
                         eqns in
                     let uu___5 =
                       match ret_opt1 with
                       | FStar_Pervasives_Native.Some
                           ...
                           let c2 =
                             FStarC_Syntax_Subst.subst_comp
                               [FStarC_Syntax_Syntax.NT
                                  ((b.FStarC_Syntax_Syntax.binder_bv), e12)]
                               c in
                           let uu___8 =
                             let uu___9 =
                               FStarC_List.map
                                 (fun uu___10 ->
                                    match uu___10 with
                                    | (uu___11, f, uu___12, uu___13, uu___14,
                                       g, b1) -> (f, g, b1)) t_eqns in
                             FStarC_List.unzip3 uu___9 in
                           (match uu___8 with
                            | (fmls, gs, erasables) ->
                                let uu___9 =
                                       ...
                                       let uu___10 =
                                         ...
                                         let uu___12 =
                                           FStarC_Syntax_Syntax.bv_to_name
                                             guard_x in
                                         FStarC_Syntax_Util.mk_eq2 uu___11
                                           c11.FStarC_TypeChecker_Common.res_typ
                                           uu___12 e12 in
                                       FStarC_TypeChecker_Common.weaken_guard_formula
                                         g2 uu___10 in
                           ...
                           let uu___7 =
                             FStarC_List.fold_right
                               (fun uu___8 uu___9 ->
                                  ...
                                  | ((branch, f, eff_label, cflags, c, g,
                                      erasable_branch),
                                     (caccum, gaccum, erasable)) ->
                                      let uu___10 =
                                        let uu___11 =
                                          let uu___12 =
                                            FStarC_Option.must cflags in
                                          let uu___13 = FStarC_Option.must c in
                                          (f, eff_label, uu___12, uu___13) in
                                        uu___11 :: caccum in
                                      let uu___11 =
                                        FStarC_Class_Monoid.op_Plus_Plus
                                          FStarC_TypeChecker_Common.monoid_guard_t
                                ...
                                (match ret_opt1 with
                                 | FStar_Pervasives_Native.None ->
                                     let res_t =
                                       ...
                                       FStar_Pervasives_Native.fst uu___8 in
                                     let uu___8 =
                                       FStarC_TypeChecker_Util.bind_cases env
                      ...
                      | (c_branches, g_branches, erasable) ->
                          ...
                          let cres1 =
                            ...
                            then
                              ...
                              let uu___6 =
                                FStarC_TypeChecker_Common.lcomp_of_comp c in
                              FStarC_TypeChecker_Util.bind
                                e.FStarC_Syntax_Syntax.pos false env
                          ...
                          let e =
                            ...
                            let mk_match scrutinee =
                              ...
                              let e3 =
                                FStarC_TypeChecker_Util.maybe_monadic env e2
                                  cres1.FStarC_TypeChecker_Common.eff_name
                                  cres1.FStarC_TypeChecker_Common.res_typ in
                              match ret_opt2 with
                              | FStar_Pervasives_Native.None ->
                            ...
                            then mk_match e12
                              ...
                              (let e_match =
                                 let uu___8 =
                                   FStarC_Syntax_Syntax.bv_to_name guard_x in
                                 mk_match uu___8 in
                               let lb =
                                 let uu___8 =
                                 ...
                                 FStarC_Syntax_Util.mk_letbinding
                                   ...
                                   c11.FStarC_TypeChecker_Common.res_typ
                                   uu___8 e12 [] e12.FStarC_Syntax_Syntax.pos in
                               let e2 =
                                 let uu___8 =
                                   let uu___9 =
                                     let uu___10 =
                          ...
                          let uu___6 =
                            ...
                            | FStar_Pervasives_Native.None ->
                                (e, cres1,
                                  (FStarC_Class_Monoid.mzero
                                     FStarC_TypeChecker_Common.monoid_guard_t))
                            | uu___7 -> comp_check_expected_typ env e cres1 in
                          (match uu___6 with
  ...
  | uu___1 ->
      let uu___2 =
        let uu___3 =
          FStarC_Class_Tagged.tag_of FStarC_Syntax_Syntax.tagged_term top in
        FStarC_Format.fmt1 "tc_match called on %s\n" uu___3 in
      failwith uu___2
and tc_synth (head : FStarC_Syntax_Syntax.term)
  (env : FStarC_TypeChecker_Env.env) (args : FStarC_Syntax_Syntax.args)
  ...
  let uu___ =
    ...
    | (a, FStar_Pervasives_Native.Some
       { FStarC_Syntax_Syntax.aqual_implicit = true;
         FStarC_Syntax_Syntax.aqual_attributes = uu___1;_})::(tau,
                                                              FStar_Pervasives_Native.None)::[]
  ...
  | (tau, atyp) ->
      ((let uu___2 = FStarC_Effect.op_Bang dbg_Tac in
        ...
        then
          let uu___3 =
            FStarC_Class_Show.show FStarC_Syntax_Print.showable_term tau in
          let uu___4 =
            FStarC_Class_Show.show
                  ...
                  (FStarC_TypeChecker_Rel.force_trivial_guard env g2;
                   (let t =
                      env.FStarC_TypeChecker_Env.synth_hook env typ1
                        ...
                        } typ1.FStarC_Syntax_Syntax.pos in
                    ...
                    (let uu___10 =
                       let uu___11 = FStarC_Syntax_Syntax.mk_Total typ1 in
                       FStarC_TypeChecker_Common.lcomp_of_comp uu___11 in
                     (t, uu___10,
                       (FStarC_Class_Monoid.mzero
                          FStarC_TypeChecker_Common.monoid_guard_t)))))))))
and tc_tactic (a : FStarC_Syntax_Syntax.typ) (b : FStarC_Syntax_Syntax.typ)
  (env : FStarC_TypeChecker_Env.env) (tau : FStarC_Syntax_Syntax.term) :
  (FStarC_Syntax_Syntax.term * FStarC_TypeChecker_Common.lcomp *
    FStarC_TypeChecker_Env.guard_t)=
  let env1 =
    {
...
and check_instantiated_fvar (env : FStarC_TypeChecker_Env.env)
  ...
  (e : FStarC_Syntax_Syntax.term) (t0 : FStarC_Syntax_Syntax.typ) :
  (FStarC_Syntax_Syntax.term * FStarC_TypeChecker_Common.lcomp *
    FStarC_TypeChecker_Env.guard_t)=
  ...
  (let uu___1 =
     (is_data_ctor q) &&
       (let uu___2 = FStarC_TypeChecker_Env.is_datacon env v in
        Prims.op_Negation uu___2) in
   if uu___1
   then
     let uu___2 =
       let uu___3 = FStarC_Class_Show.show FStarC_Ident.showable_lident v in
       FStarC_Format.fmt1 "Expected a data constructor; got %s" uu___3 in
     FStarC_Errors.raise_error FStarC_TypeChecker_Env.hasRange_env env
       FStarC_Errors_Codes.Fatal_MissingDataConstructor ()
       (Obj.magic FStarC_Errors_Msg.is_error_message_string)
       (Obj.magic uu___2)
   else ());
...
and tc_value (env : FStarC_TypeChecker_Env.env)
  (e : FStarC_Syntax_Syntax.term) :
  (FStarC_Syntax_Syntax.term * FStarC_TypeChecker_Common.lcomp *
    FStarC_TypeChecker_Env.guard_t)=
  ...
  (let env1 = FStarC_TypeChecker_Env.set_range env e.FStarC_Syntax_Syntax.pos in
   ...
   | FStarC_Syntax_Syntax.Tm_bvar x ->
       let uu___1 =
         let uu___2 =
           FStarC_Class_Show.show FStarC_Syntax_Print.showable_term top in
         FStarC_Format.fmt1 "Violation of locally nameless convention: %s"
           uu___2 in
       FStarC_Errors.raise_error (FStarC_Syntax_Syntax.has_range_syntax ())
         top FStarC_Errors_Codes.Error_IllScopedTerm ()
         (Obj.magic FStarC_Errors_Msg.is_error_message_string)
         (Obj.magic uu___1)
   | FStarC_Syntax_Syntax.Tm_uvar (u, s) ->
       let uu___1 =
         let uu___2 =
           ...
           FStarC_Syntax_Subst.subst' s uu___3 in
         FStar_Pervasives.Inl uu___2 in
       value_check_expected_typ env1 e uu___1
         (FStarC_Class_Monoid.mzero FStarC_TypeChecker_Common.monoid_guard_t)
   | FStarC_Syntax_Syntax.Tm_unknown ->
       let r = FStarC_TypeChecker_Env.get_range env1 in
       let uu___1 =
         let uu___2 = FStarC_TypeChecker_Env.expected_typ env1 in
         match uu___2 with
         | FStar_Pervasives_Native.None ->
             let uu___3 = FStarC_Syntax_Util.type_u () in
             (match uu___3 with
              | (k, u) ->
                  ...
                  (match uu___4 with | (t, uu___5, g0) -> (t, g0)))
         | FStar_Pervasives_Native.Some (t, use_eq) when use_eq ->
             let uu___3 =
               let uu___4 =
                 ...
                 FStarC_Errors_Msg.text uu___5 in
               let uu___5 =
                 let uu___6 = FStarC_Errors_Msg.text "Please use subtyping." in
                 [uu___6] in
               uu___4 :: uu___5 in
             FStarC_Errors.raise_error
               (FStarC_Syntax_Syntax.has_range_syntax ()) e
       ...
       (match uu___1 with
        | (t, g0) ->
            let uu___2 =
              ...
              FStarC_TypeChecker_Util.new_implicit_var uu___3 r env1 t false in
            (match uu___2 with
             | (e1, uu___3, g1) ->
                 let uu___4 =
   ...
   | FStarC_Syntax_Syntax.Tm_name x ->
       let uu___1 = FStarC_TypeChecker_Env.lookup_bv env1 x in
       (match uu___1 with
        | (t, rng) ->
            let x1 =
            ...
            (FStarC_TypeChecker_Env.insert_bv_info env1 x1 t;
             (let e1 = FStarC_Syntax_Syntax.bv_to_name x1 in
              ...
              | (e2, t1, implicits) ->
                  let tc =
                    let uu___4 = FStarC_TypeChecker_Env.should_verify env1 in
                    if uu___4
                    then FStar_Pervasives.Inl t1
                    else
                      (let uu___6 =
                         let uu___7 = FStarC_Syntax_Syntax.mk_Total t1 in
                         FStarC_TypeChecker_Common.lcomp_of_comp uu___7 in
   ...
   | FStarC_Syntax_Syntax.Tm_uinst
       ({ FStarC_Syntax_Syntax.n = FStarC_Syntax_Syntax.Tm_fvar fv;
        ...
        us)
       ->
       let us1 = FStarC_List.map (tc_universe env1) us in
       let uu___4 =
       ...
       (match uu___4 with
        | ((us', t), range) ->
            ...
            (maybe_warn_on_use env1 fv1;
             if (FStarC_List.length us1) <> (FStarC_List.length us')
             then
               (let uu___7 =
                  let uu___8 =
               ...
               (fun ul ur ->
                  ...
                  | uu___8 ->
                      let uu___9 =
                        let uu___10 =
                          FStarC_Class_Show.show
                            FStarC_Syntax_Syntax.showable_fv fv1 in
                        let uu___11 =
                          FStarC_Class_Show.show
                      ...
                      FStarC_Errors.raise_error
                        ...
                        (Obj.magic FStarC_Errors_Msg.is_error_message_string)
                        (Obj.magic uu___9)) us' us1;
             FStarC_TypeChecker_Env.insert_fv_info env1 fv1 t;
             (let e1 =
                let uu___9 =
                  FStarC_Syntax_Syntax.mk (FStarC_Syntax_Syntax.Tm_fvar fv1)
                    e.FStarC_Syntax_Syntax.pos in
                FStarC_Syntax_Syntax.mk_Tm_uinst uu___9 us1 in
              check_instantiated_fvar env1 fv1.FStarC_Syntax_Syntax.fv_name
                fv1.FStarC_Syntax_Syntax.fv_qual e1 t)))
   | FStarC_Syntax_Syntax.Tm_uinst (uu___1, us) ->
       FStarC_Errors.raise_error FStarC_TypeChecker_Env.hasRange_env env1
   ...
   | FStarC_Syntax_Syntax.Tm_fvar fv ->
       let maybe_set_fv_qual env2 fv1 =
         let uu___1 =
           (FStar_Pervasives_Native.uu___is_None
              fv1.FStarC_Syntax_Syntax.fv_qual)
             &&
             (FStarC_TypeChecker_Env.is_datacon env2
                fv1.FStarC_Syntax_Syntax.fv_name) in
         if uu___1
         then
           {
       ...
       (match uu___1 with
        | ((us, t), range) ->
            ...
            (maybe_warn_on_use env1 fv2;
             (let uu___4 = FStarC_Effect.op_Bang dbg_Range in
              if uu___4
              then
                let uu___5 =
                  let uu___6 = FStarC_Syntax_Syntax.lid_of_fv fv2 in
                  FStarC_Class_Show.show FStarC_Ident.showable_lident uu___6 in
                let uu___6 =
                  FStarC_Range_Ops.string_of_range e.FStarC_Syntax_Syntax.pos in
                let uu___7 = FStarC_Range_Ops.string_of_range range in
                let uu___8 = FStarC_Range_Ops.string_of_use_range range in
                let uu___9 =
             ...
             (let e1 =
                let uu___5 =
                  FStarC_Syntax_Syntax.mk (FStarC_Syntax_Syntax.Tm_fvar fv2)
                    e.FStarC_Syntax_Syntax.pos in
                FStarC_Syntax_Syntax.mk_Tm_uinst uu___5 us in
              check_instantiated_fvar env1 fv2.FStarC_Syntax_Syntax.fv_name
                fv2.FStarC_Syntax_Syntax.fv_qual e1 t)))
   ...
   | FStarC_Syntax_Syntax.Tm_arrow
       ...
       (match uu___1 with
        | (bs1, c1) ->
            ...
            (match uu___2 with
             | (env2, uu___3) ->
                 let uu___4 = tc_binders env2 bs1 in
                 (match uu___4 with
                  | (bs2, env3, g, us) ->
                      let uu___5 = tc_comp env3 c1 in
                      (match uu___5 with
                       | (c2, uc, f) ->
                           let e1 =
                             let uu___6 = FStarC_Syntax_Util.arrow bs2 c2 in
                             {
                               FStarC_Syntax_Syntax.n =
                                 (uu___6.FStarC_Syntax_Syntax.n);
                               FStarC_Syntax_Syntax.pos =
                                 (top.FStarC_Syntax_Syntax.pos);
                               FStarC_Syntax_Syntax.vars =
                                 (uu___6.FStarC_Syntax_Syntax.vars);
                               FStarC_Syntax_Syntax.hash_code =
                                 (uu___6.FStarC_Syntax_Syntax.hash_code)
                             } in
                           (if
                              Prims.op_Negation
                            ...
                            (let u = FStarC_Syntax_Syntax.U_max (uc :: us) in
                             ...
                             let g1 =
                               let uu___7 =
                                 FStarC_TypeChecker_Env.close_guard_univs us
                                   bs2 f in
                               FStarC_Class_Monoid.op_Plus_Plus
                                 FStarC_TypeChecker_Common.monoid_guard_t g
                                 uu___7 in
       ...
       (match uu___1 with
        | (x1, phi1) ->
            ...
            (match uu___2 with
             | (env2, uu___3) ->
                 let uu___4 =
                   let uu___5 = FStarC_List.hd x1 in tc_binder env2 uu___5 in
                 (match uu___4 with
                  | (x2, env3, f1, u) ->
                                 ...
                                 let e1 =
                                   let uu___10 =
                                     FStarC_Syntax_Util.refine
                                       x2.FStarC_Syntax_Syntax.binder_bv phi2 in
                                   {
                                     FStarC_Syntax_Syntax.n =
                                       (uu___10.FStarC_Syntax_Syntax.n);
                                     FStarC_Syntax_Syntax.pos =
                                       (top.FStarC_Syntax_Syntax.pos);
                                     FStarC_Syntax_Syntax.vars =
                                       (uu___10.FStarC_Syntax_Syntax.vars);
                                     FStarC_Syntax_Syntax.hash_code =
                                       (uu___10.FStarC_Syntax_Syntax.hash_code)
                                   } in
                                 let t =
                                   FStarC_Syntax_Syntax.mk
                                     (FStarC_Syntax_Syntax.Tm_type u)
   ...
   | FStarC_Syntax_Syntax.Tm_abs
       ...
       ->
       let bs1 = FStarC_TypeChecker_Util.maybe_add_implicit_binders env1 bs in
             ...
             FStarC_Class_Show.show FStarC_Syntax_Print.showable_term
               {
                 ...
                 FStarC_Syntax_Syntax.vars = (top.FStarC_Syntax_Syntax.vars);
                 FStarC_Syntax_Syntax.hash_code =
                   (top.FStarC_Syntax_Syntax.hash_code)
               } in
           FStarC_Format.print1 "Abstraction is: %s\n" uu___4
         else ());
        (let uu___3 = FStarC_Syntax_Subst.open_term bs1 body in
         match uu___3 with | (bs2, body1) -> tc_abs env1 top bs2 body1))
   | uu___1 ->
       let uu___2 =
         let uu___3 =
           FStarC_Class_Show.show FStarC_Syntax_Print.showable_term top in
         let uu___4 =
           FStarC_Class_Tagged.tag_of FStarC_Syntax_Syntax.tagged_term top in
         FStarC_Format.fmt2 "Unexpected value: %s (%s)" uu___3 uu___4 in
       failwith uu___2)
and tc_constant (env : FStarC_TypeChecker_Env.env_t)
  (r : FStarC_Range_Type.t) (c : FStarC_Const.sconst) :
  ...
  let res =
    ...
    | FStarC_Const.Const_char uu___ ->
        let uu___1 =
          FStarC_Syntax_DsEnv.try_lookup_lid env.FStarC_TypeChecker_Env.dsenv
    ...
    | uu___ ->
        ...
        FStarC_Errors.raise_error FStarC_Class_HasRange.hasRange_range r
          FStarC_Errors_Codes.Fatal_UnsupportedConstant ()
          (Obj.magic FStarC_Errors_Msg.is_error_message_string)
          (Obj.magic uu___1) in
  FStarC_Syntax_Subst.set_use_range r res
and tc_comp (env : FStarC_TypeChecker_Env.env)
  ...
  | FStarC_Syntax_Syntax.Comp c1 ->
      ...
      let tc =
        let uu___ =
          let uu___1 =
            FStarC_Syntax_Syntax.as_arg c1.FStarC_Syntax_Syntax.result_typ in
           ...
           (match uu___2 with
            | (head2, args) ->
                ...
                (match uu___3 with
                 | (uu___4, args1) ->
                     let uu___5 =
                       let uu___6 = FStarC_List.hd args1 in
                       let uu___7 = FStarC_List.tl args1 in (uu___6, uu___7) in
                     (match uu___5 with
                      | (res, args2) ->
                          let uu___6 =
                            let uu___7 =
                                 ...
                                 FStarC_Syntax_Syntax.mk_Comp
                                   {
                                     ...
                                     FStarC_Syntax_Syntax.effect_args = args2;
                                     FStarC_Syntax_Syntax.flags = flags
                                   } in
                               let u_c =
                                 FStarC_TypeChecker_Util.universe_of_comp env
                                   u c2 in
                               let uu___7 =
                                 let uu___8 =
                                   FStarC_Class_Monoid.msum
                                     ...
                                     guards in
                                 FStarC_Class_Monoid.op_Plus_Plus
                                   FStarC_TypeChecker_Common.monoid_guard_t f
                                   uu___8 in
                               (c2, u_c, uu___7))))))
and tc_universe (env : FStarC_TypeChecker_Env.env)
  ...
  | uu___ -> aux u
and tc_abs_expected_function_typ (env : FStarC_TypeChecker_Env.env)
      ...
      let rec as_function_typ norm1 t2 =
        ...
        | FStarC_Syntax_Syntax.Tm_uvar uu___1 ->
            ((match env.FStarC_TypeChecker_Env.letrecs with
              | [] -> ()
              | uu___3 ->
                  failwith "Impossible: uvar abs with non-empty environment");
                  ...
                  (match uu___5 with
                   | (envbody1, uu___6) ->
                       ((FStar_Pervasives_Native.Some t2), bs1, [],
                         FStar_Pervasives_Native.None, envbody1, body, g_env))))
        | FStarC_Syntax_Syntax.Tm_app
            {
              FStarC_Syntax_Syntax.hd =
                {
        ...
        | FStarC_Syntax_Syntax.Tm_refine
            ...
            ->
            let uu___2 = as_function_typ norm1 b.FStarC_Syntax_Syntax.sort in
            (match uu___2 with
        ...
        | FStarC_Syntax_Syntax.Tm_arrow
            ...
            ->
            let uu___1 = FStarC_Syntax_Subst.open_comp bs_expected c_expected in
            (match uu___1 with
             | (bs_expected1, c_expected1) ->
                 let check_actuals_against_formals env1 bs1 bs_expected2
                   body1 =
                     ...
                     | (env_bs, bs2, more, guard_env, subst) ->
                         (match more with
                          ...
                          | FStar_Pervasives_Native.Some
                              ...
                              let c =
                                let uu___3 =
                                  FStarC_Syntax_Util.arrow more_bs_expected
                                    c_expected2 in
                                FStarC_Syntax_Syntax.mk_Total uu___3 in
                              let uu___3 =
                                FStarC_Syntax_Subst.subst_comp subst c in
                              (env_bs, bs2, guard_env, uu___3, body2)
                          | FStar_Pervasives_Native.Some
                                 ...
                                 | FStarC_Syntax_Syntax.Tm_arrow
                                     ...
                                     (match uu___4 with
                                      | (bs_expected4, c_expected4) ->
                                          let uu___5 =
                                            tc_abs_check_binders env_bs
                                              more_bs bs_expected4 use_eq in
                                          (match uu___5 with
                                           | (env_bs_bs', bs', more1,
                                              guard'_env_bs, subst1) ->
                                               let guard'_env =
                                                 FStarC_TypeChecker_Env.close_guard
                                                   env_bs bs2 guard'_env_bs in
                                               let uu___6 =
                                                 let uu___7 =
                                                   FStarC_Class_Monoid.op_Plus_Plus
                                                     FStarC_TypeChecker_Common.monoid_guard_t
                                                     guard_env guard'_env in
                                                 (env_bs_bs',
                                                   (FStarC_List.op_At bs2 bs'),
                                                   more1, uu___7, subst1) in
                                               handle_more uu___6 c_expected4
                                                 body2))
                                 | uu___4 ->
                                     let body3 =
                                       FStarC_Syntax_Util.abs more_bs body2
                                         FStar_Pervasives_Native.None in
                   ...
                   let uu___2 =
                     tc_abs_check_binders env1 bs1 bs_expected2 use_eq in
                 ...
                 let mk_letrec_env envbody bs1 c =
                   ...
                   | (envbody2, letrec_binders, g) ->
                       let uu___3 =
                         FStarC_TypeChecker_Env.close_guard envbody2 bs1 g in
                 ...
                 let uu___2 =
                   check_actuals_against_formals envbody bs bs_expected1 body in
                 (match uu___2 with
                       ...
                       | (envbody3, letrecs, g_annots) ->
                           let envbody4 =
                             ...
                             FStarC_TypeChecker_Env.set_expected_typ_maybe_eq
                               envbody3 uu___4 use_eq in
                           let uu___4 =
                             FStarC_Class_Monoid.op_Plus_Plus
                               FStarC_TypeChecker_Common.monoid_guard_t g_env
                               g_annots in
                           ((FStar_Pervasives_Native.Some t2), bs1, letrecs,
                             (FStar_Pervasives_Native.Some c), envbody4,
                             body1, uu___4))))
        | uu___1 ->
            if Prims.op_Negation norm1
            then
              let uu___2 =
                let uu___3 = FStarC_TypeChecker_Normalize.unfold_whnf env t2 in
              ...
              (let uu___3 =
               ...
               | (uu___4, bs1, uu___5, c_opt, envbody, body1, g_env) ->
                   ((FStar_Pervasives_Native.Some t2), bs1, [], c_opt,
                     envbody, body1, g_env)) in
      as_function_typ false t1
and tc_abs_check_binders (env : FStarC_TypeChecker_Env.env)
  (bs : FStarC_Syntax_Syntax.binders)
  (bs_expected : FStarC_Syntax_Syntax.binders) (use_eq : Prims.bool) :
  ...
  let rec aux uu___ bs1 bs_expected1 =
    ...
    | (env1, subst) ->
        (match (bs1, bs_expected1) with
         ...
         | ({ FStarC_Syntax_Syntax.binder_bv = uu___1;
            ...
            { FStarC_Syntax_Syntax.binder_bv = hd_e;
             ...
             let bv =
               let uu___6 =
                 let uu___7 =
                   FStarC_Ident.range_of_id hd_e.FStarC_Syntax_Syntax.ppname in
             ...
             let uu___6 =
               let uu___7 =
                 FStarC_Syntax_Syntax.mk_binder_with_attrs bv q pqual attrs in
               uu___7 :: bs1 in
            ...
            { FStarC_Syntax_Syntax.binder_bv = hd_expected;
             ...
             ((let special q1 q2 =
               ...
               then
                 let uu___3 =
                   ...
                   let uu___5 =
                     ...
                     let uu___7 =
                       let uu___8 =
                         let uu___9 = FStarC_Errors_Msg.text "Expected:" in
                         let uu___10 =
                           let uu___11 =
                             let uu___12 =
                               FStarC_Syntax_Print.bqual_to_string imp' in
              ...
              (let positivity_qual_to_string uu___2 =
               ...
               (let uu___3 =
                  let uu___4 =
                    FStarC_TypeChecker_Common.check_positivity_qual true
                ...
                then
                  let uu___4 =
                    ...
                    FStarC_Format.fmt3
                      ...
                      uu___5 (positivity_qual_to_string pqual_expected)
               ...
               (let expected_t =
                ...
                let uu___3 =
                  let uu___4 =
                    let uu___5 =
                      FStarC_Syntax_Util.unmeta hd.FStarC_Syntax_Syntax.sort in
                    uu___5.FStarC_Syntax_Syntax.n in
                  match uu___4 with
                  | FStarC_Syntax_Syntax.Tm_unknown ->
                      (expected_t,
                        (FStarC_Class_Monoid.mzero
                           FStarC_TypeChecker_Common.monoid_guard_t))
                  | uu___5 ->
                      ((let uu___7 = FStarC_Debug.high () in
                        if uu___7
                        then
                          let uu___8 =
                            FStarC_Class_Show.show
                            ...
                            let g2_env =
                              let label_guard g =
                                ...
                                FStarC_TypeChecker_Util.label_guard
                                  ...
                                  uu___9 g in
                              let uu___9 =
                                FStarC_TypeChecker_Rel.teq_nosmt env1 t
                                  expected_t in
                              match uu___9 with
                              | FStar_Pervasives_Native.Some g ->
                              ...
                              | FStar_Pervasives_Native.None ->
                                  ...
                                  then
                                    let uu___10 =
                                      FStarC_TypeChecker_Rel.teq env1 t
                                        expected_t in
                                    label_guard uu___10
                                  else
                                    (let uu___11 =
                ...
                | (t, g_env) ->
                    ...
                    (check_erasable_binder_attributes env1
                     ...
                     (let b_expected =
                      ...
                      let subst1 =
                        let uu___5 = FStarC_Syntax_Syntax.bv_to_name hd1 in
                        maybe_extend_subst subst b_expected uu___5 in
                      let uu___5 = aux (env_b, subst1) bs2 bs_expected2 in
                      match uu___5 with
         ...
         | (rest, []) ->
             (env1, [],
               (FStar_Pervasives_Native.Some (FStar_Pervasives.Inl rest)),
               (FStarC_Class_Monoid.mzero
                  FStarC_TypeChecker_Common.monoid_guard_t), subst)
         | ([], rest) ->
             (env1, [],
               (FStar_Pervasives_Native.Some (FStar_Pervasives.Inr rest)),
               (FStarC_Class_Monoid.mzero
                  FStarC_TypeChecker_Common.monoid_guard_t), subst)) in
  aux (env, []) bs bs_expected
and tc_abs (env : FStarC_TypeChecker_Env.env)
  (top : FStarC_Syntax_Syntax.term) (bs : FStarC_Syntax_Syntax.binders)
  (body : FStarC_Syntax_Syntax.term) :
  (FStarC_Syntax_Syntax.term * FStarC_TypeChecker_Common.lcomp *
    FStarC_TypeChecker_Env.guard_t)=
  let fail msg t =
    FStarC_TypeChecker_Err.expected_a_term_of_type_t_got_a_function env
      top.FStarC_Syntax_Syntax.pos msg t top in
  let env0 = env in
  let uu___ = FStarC_TypeChecker_Env.clear_expected_typ env in
  match uu___ with
  | (env1, topt) ->
      ((let uu___2 = FStarC_Debug.high () in
        if uu___2
        then
          let uu___3 =
            FStarC_Class_Show.show
        ...
        | (tfun_opt, bs1, letrec_binders, c_opt, envbody, body1, g_env) ->
            ((let uu___4 = FStarC_Debug.extreme () in
              ...
              then
                ...
                let uu___7 =
                  let uu___8 = FStarC_TypeChecker_Env.expected_typ envbody in
                  FStarC_Class_Show.show
                    (FStarC_Class_Show.show_option
                       (FStarC_Class_Show.show_tuple2
                          FStarC_Syntax_Print.showable_term
             ...
             (let uu___5 = FStarC_Effect.op_Bang dbg_NYC in
              if uu___5
              then
                let uu___6 =
                  FStarC_Class_Show.show
             ...
             (let envbody1 =
              ...
              let uu___5 =
                let uu___6 =
                  ...
                  let uu___7 =
                    (FStar_Pervasives_Native.uu___is_Some c_opt) &&
                      (let uu___8 =
                         let uu___9 = FStarC_Syntax_Subst.compress body1 in
                       ...
                       | FStarC_Syntax_Syntax.Tm_app
                           ...
                           when (FStarC_List.length args) = Prims.int_one ->
                           let uu___9 =
                             let uu___10 = FStarC_Syntax_Subst.compress head in
                             uu___10.FStarC_Syntax_Syntax.n in
                           (match uu___9 with
                            | FStarC_Syntax_Syntax.Tm_constant
                                (FStarC_Const.Const_reflect uu___10) -> true
                            | uu___10 -> false)
                       | uu___9 -> false) in
                  if uu___7
                  then
                    let uu___8 =
                      let uu___9 =
                        FStarC_TypeChecker_Env.clear_expected_typ envbody1 in
                    ...
                    let uu___9 =
                      let uu___10 =
                        let uu___11 =
                          let uu___12 =
                            let uu___13 =
                              let uu___14 = FStarC_Option.must c_opt in
                              FStar_Pervasives.Inr uu___14 in
                            let uu___14 = FStarC_Option.must use_eq_opt in
                            (uu___13, FStar_Pervasives_Native.None, uu___14) in
                          {
                    ...
                    (let uu___9 =
                       let uu___10 =
                         let uu___11 =
                           let uu___12 = FStarC_Syntax_Subst.compress body1 in
                           uu___12.FStarC_Syntax_Syntax.n in
                         (c_opt, uu___11) in
                       match uu___10 with
                       | (FStar_Pervasives_Native.None,
                       ...
                       | uu___11 ->
                           FStar_Pervasives.Inl
                             (FStarC_Option.dflt false use_eq_opt) in
                     ...
                     | (body3, cbody, guard_body) ->
                         ...
                         (match should_check_expected_effect with
                          | FStar_Pervasives.Inl use_eq ->
                              let uu___8 =
                                FStarC_TypeChecker_Common.lcomp_comp cbody in
                              (match uu___8 with
                               | (cbody1, g_lc) ->
                                   let uu___9 =
                                     FStarC_Errors.with_ctx
              ...
              | (body2, cbody, guard_body) ->
                  ((let uu___7 = FStarC_Debug.extreme () in
                    if uu___7
                    then
                      let uu___8 =
                   ...
                   (let guard_body1 =
                      ...
                      then
                        ((let uu___8 = FStarC_Debug.medium () in
                         ...
                         FStarC_TypeChecker_Rel.discharge_guard envbody1
                           guard_body)
                      else guard_body in
                    let guard =
                      let guard_body2 =
                        FStarC_TypeChecker_Env.close_guard envbody1
                          (FStarC_List.op_At bs1 letrec_binders) guard_body1 in
                      FStarC_Class_Monoid.op_Plus_Plus
                        FStarC_TypeChecker_Common.monoid_guard_t g_env
                        guard_body2 in
                    let guard1 =
                      FStarC_TypeChecker_Util.close_guard_implicits env1
                        false bs1 guard in
                      ...
                      let uu___7 =
                        let uu___8 =
                          FStarC_Syntax_Util.residual_comp_of_comp
                            (FStarC_Option.dflt cbody c_opt) in
                        FStar_Pervasives_Native.Some uu___8 in
                               ...
                               (FStarC_Syntax_Util.is_binder_unused b) &&
                                 (let uu___12 =
                                    FStarC_TypeChecker_Positivity.name_unused_in_type
                                      envbody1
                                      b.FStarC_Syntax_Syntax.binder_bv body2 in
                                  Prims.op_Negation uu___12) in
                             if uu___11
                             then
                               let uu___12 =
                    ...
                    (let uu___8 =
                       ...
                       | FStar_Pervasives_Native.Some t ->
                           ...
                           let uu___9 =
                             match topt with
                             | FStar_Pervasives_Native.Some (t2, use_eq) ->
                                 (t2, use_eq)
                             | FStar_Pervasives_Native.None ->
                                 failwith
                     ...
                     | (e1, tfun, guard2) ->
                         ...
                         let uu___9 =
                           let uu___10 =
                             FStarC_TypeChecker_Common.lcomp_of_comp c in
                           FStarC_TypeChecker_Util.strengthen_precondition
                             FStar_Pervasives_Native.None env1 e1 uu___10
                             guard2 in
                         (match uu___9 with | (c1, g) -> (e1, c1, g)))))))))
and check_application_args (env : FStarC_TypeChecker_Env.env)
  (head : FStarC_Syntax_Syntax.term) (chead : FStarC_Syntax_Syntax.comp)
  (ghead : FStarC_TypeChecker_Env.guard_t)
  (args :
  ...
  (let uu___1 = FStarC_Debug.high () in
   ...
   then
     ...
     let uu___3 =
       FStarC_Class_Show.show FStarC_Syntax_Print.showable_term thead in
     let uu___4 =
       FStarC_Class_Show.show
         (FStarC_Class_Show.show_list
  ...
  (let monadic_application uu___1 subst arg_comps_rev arg_rets_rev guard fvs
     bs =
     match uu___1 with
     | (head1, chead1, ghead1, cres) ->
         let uu___2 =
           ...
           | [] ->
               let uu___3 =
                 FStarC_Class_Monoid.op_Plus_Plus
                   FStarC_TypeChecker_Common.monoid_guard_t ghead1 guard in
               (cres, uu___3)
           | uu___3 ->
               let g =
                 let uu___4 =
                   FStarC_Class_Monoid.op_Plus_Plus
                     FStarC_TypeChecker_Common.monoid_guard_t ghead1 guard in
                 FStarC_TypeChecker_Rel.solve_deferred_constraints env uu___4 in
               let uu___4 =
         ...
         (match uu___2 with
          | (cres1, guard1) ->
              let uu___3 =
                let uu___4 = FStarC_Syntax_Util.comp_result cres1 in
                check_no_escape (FStar_Pervasives_Native.Some head1) env fvs
                  uu___4 in
              (match uu___3 with
               | (rt, g0) ->
                   let uu___4 =
                     let uu___5 = FStarC_Syntax_Util.set_result_typ cres1 rt in
                     let uu___6 =
                       FStarC_Class_Monoid.op_Plus_Plus
                         FStarC_TypeChecker_Common.monoid_guard_t g0 guard1 in
                     (uu___5, uu___6) in
                   (match uu___4 with
                    | (cres2, guard2) ->
                        ((let uu___6 = FStarC_Debug.medium () in
                          ...
                          then
                            let uu___7 =
                              FStarC_Class_Show.show
                                FStarC_Syntax_Print.showable_comp cres2 in
                            FStarC_Format.print1
                         ...
                         (let uu___6 =
                            let uu___7 =
                              let uu___8 =
                                FStarC_Syntax_Subst.subst_comp subst chead1 in
                              FStarC_TypeChecker_Common.lcomp_of_comp uu___8 in
                            let uu___8 =
                              let uu___9 =
                                FStarC_Syntax_Subst.subst_comp subst cres2 in
                              FStarC_TypeChecker_Common.lcomp_of_comp uu___9 in
                            (uu___7, uu___8) in
                          match uu___6 with
                          | (chead2, cres3) ->
                              let uu___7 =
                                ...
                                then
                                  ...
                                  ((let uu___11 = FStarC_Debug.extreme () in
                                    if uu___11
                                    then
                                      let uu___12 =
                                        FStarC_Class_Show.show
                                            ...
                                            let uu___8 =
                                              FStarC_Option.map
                                                (FStarC_TypeChecker_Env.push_bv
                                                   env1) name_opt in
                                            FStarC_Option.dflt env1 uu___8) in
                                     let uu___8 =
                                       FStarC_List.fold_left
                                         (fun uu___9 uu___10 ->
                                                 ...
                                                 (let env1 =
                                                  ...
                                                  then
                                                    ...
                                                    (let uu___14 =
                                                     ...
                                                     ((i + Prims.int_one),
                                                       uu___14)))))
                                         (Prims.int_one, cres4) arg_comps_rev in
                                     match uu___8 with
                                     | (uu___9, comp1) ->
                                         let env1 =
                                           push_option_names_to_env env
                                             arg_rets_names_opt in
                                         ((let uu___11 =
                                             FStarC_Debug.extreme () in
                                           if uu___11
                                     ...
                                     then
                                       let args1 =
                                         FStarC_List.fold_left
                                           (fun args2 uu___8 ->
                                              match uu___8 with
                                              | (arg, uu___9, uu___10) -> arg
                                                  :: args2) [] arg_comps_rev in
                                       let app1 =
                                         FStarC_Syntax_Syntax.mk_Tm_app head1
                                           args1 r in
                                       let app2 =
                                              ...
                                              let uu___12 =
                                                let uu___13 =
                                                  ...
                                                  (uu___14,
                                                    FStar_Pervasives_Native.None,
                                                    chead2) in
                                                uu___13 :: arg_comps_rev in
                                              FStarC_List.map map_fun uu___12 in
                                            FStarC_List.split uu___11 in
                                          match uu___10 with
                                          | (lifted_args, reverse_args) ->
                                              let uu___11 =
                                                let uu___12 =
                                                  FStarC_List.hd reverse_args in
                                                FStar_Pervasives_Native.fst
                                                  uu___12 in
                                              let uu___12 =
                                                let uu___13 =
                                                  FStarC_List.tl reverse_args in
                                                FStarC_List.rev uu___13 in
                                              (lifted_args, uu___11, uu___12) in
                                        match uu___9 with
                                        | (lifted_args, head2, args1) ->
                                            ...
                                            let app3 =
                                              FStarC_TypeChecker_Util.maybe_monadic
                                                ...
                                                comp.FStarC_TypeChecker_Common.eff_name
                                                comp.FStarC_TypeChecker_Common.res_typ in
                                            let bind_lifted_args e uu___10 =
                                              match uu___10 with
                                              | FStar_Pervasives_Native.None
                                                  -> e
                                              | FStar_Pervasives_Native.Some
   ...
   let rec tc_args head_info uu___1 bs args1 =
     ...
     | (subst, outargs, arg_rets, g, fvs) ->
         let instantiate_one_and_go rng b rest_bs args2 =
           let b1 = FStarC_Syntax_Subst.subst_binder subst b in
           let uu___2 =
             FStarC_TypeChecker_Util.instantiate_one_binder env rng b1 in
           match uu___2 with
           | (tm, ty, aq, g') ->
               let uu___3 =
                 check_no_escape (FStar_Pervasives_Native.Some head) env fvs
                   ty in
               (match uu___3 with
                | (ty1, g_ex) ->
                    let guard =
                      ...
                      FStarC_Class_Monoid.op_Plus_Plus
                        FStarC_TypeChecker_Common.monoid_guard_t uu___4 g_ex in
                    let arg = (tm, aq) in
                    let subst1 =
                      (FStarC_Syntax_Syntax.NT
                    ...
                    let uu___4 =
                      let uu___5 =
                        let uu___6 =
                          let uu___7 =
                            let uu___8 = FStarC_Syntax_Syntax.mk_Total ty1 in
                            FStarC_TypeChecker_Common.lcomp_of_comp uu___8 in
                          (arg, FStar_Pervasives_Native.None, uu___7) in
                        uu___6 :: outargs in
                      (subst1, uu___5, (arg :: arg_rets), guard, fvs) in
         ...
         (match (bs, args1) with
          | ({ FStarC_Syntax_Syntax.binder_bv = x;
             ...
             (uu___5, FStar_Pervasives_Native.None)::uu___6) ->
              let r1 =
                ...
                | ((t, uu___7), uu___8, uu___9)::uu___10 ->
                    FStarC_Range_Ops.union_ranges
                      head.FStarC_Syntax_Syntax.pos
                      t.FStarC_Syntax_Syntax.pos in
              let uu___7 = FStarC_List.hd bs in
              instantiate_one_and_go r1 uu___7 rest args1
          | ({ FStarC_Syntax_Syntax.binder_bv = x;
               FStarC_Syntax_Syntax.binder_qual =
                 FStar_Pervasives_Native.Some (FStarC_Syntax_Syntax.Meta
                 uu___2);
          ...
          | ({ FStarC_Syntax_Syntax.binder_bv = x;
             ...
             ({ FStarC_Syntax_Syntax.n = FStarC_Syntax_Syntax.Tm_unknown;
              ...
              let uu___7 =
                let uu___8 =
                  let uu___9 = FStarC_List.hd args1 in
                  FStar_Pervasives_Native.fst uu___9 in
                FStarC_Class_HasRange.pos
                  (FStarC_Syntax_Syntax.has_range_syntax ()) uu___8 in
              let uu___8 = FStarC_List.hd bs in
              instantiate_one_and_go uu___7 uu___8 rest rest'
          | ({ FStarC_Syntax_Syntax.binder_bv = x;
              ...
              ((let uu___4 = FStarC_Debug.extreme () in
                ...
                then
                  ...
                  let uu___8 =
                    FStarC_Class_Show.show
                      (FStarC_Class_Show.show_list
                         FStarC_Syntax_Print.showable_subst_elt) subst in
                  let uu___9 =
                    FStarC_Class_Show.show FStarC_Syntax_Print.showable_term
                      targ in
                  FStarC_Format.print5
               ...
               (let uu___4 =
                ...
                | (targ1, g_ex) ->
                    let env1 =
                      FStarC_TypeChecker_Env.set_expected_typ_maybe_eq env
                        targ1 (is_eq bqual1) in
                    ((let uu___6 = FStarC_Debug.high () in
                      if uu___6
                      then
                        let uu___7 =
                        ...
                        let uu___9 =
                          FStarC_Class_Show.show
                            FStarC_Syntax_Print.showable_term targ1 in
                        let uu___10 =
                          FStarC_Class_Show.show
                            FStarC_Class_Show.showable_bool (is_eq bqual1) in
                        FStarC_Format.print4
                     ...
                     (let uu___6 = tc_term env1 e in
                      ...
                      | (e1, c, g_e) ->
                          let g1 =
                            let uu___7 =
                              FStarC_Class_Monoid.op_Plus_Plus
                                FStarC_TypeChecker_Common.monoid_guard_t g_ex
                                g in
                            FStarC_Class_Monoid.op_Plus_Plus
                              FStarC_TypeChecker_Common.monoid_guard_t uu___7
                              g_e in
                          let arg = (e1, aq1) in
                          let xterm =
                            let uu___7 = FStarC_Syntax_Syntax.bv_to_name x1 in
                            (uu___7, aq1) in
                          let uu___7 =
                            (FStarC_TypeChecker_Common.is_tot_or_gtot_lcomp c)
                              ||
                              (FStarC_TypeChecker_Util.is_pure_or_ghost_effect
                                 env1 c.FStarC_TypeChecker_Common.eff_name) in
                          if uu___7
                          then
                            let subst1 =
                              let uu___8 = FStarC_List.hd bs in
                            ...
                            tc_args head_info
                              (subst1,
                                ((arg, (FStar_Pervasives_Native.Some x1), c)
                                :: outargs), (xterm :: arg_rets), g1, fvs)
                              rest rest'
                          else
                            tc_args head_info
                              (subst,
                                ((arg, (FStar_Pervasives_Native.Some x1), c)
                                :: outargs), (xterm :: arg_rets), g1, (x1 ::
                                fvs)) rest rest'))))
          | (uu___2, []) ->
              monadic_application head_info subst outargs arg_rets g fvs bs
          | ([], arg::uu___2) ->
              let uu___3 =
                monadic_application head_info subst outargs arg_rets g fvs [] in
              (match uu___3 with
               | (head1, chead1, ghead1) ->
                   let uu___4 =
                     let uu___5 = FStarC_TypeChecker_Common.lcomp_comp chead1 in
                     match uu___5 with
                     | (c, g1) ->
                         let uu___6 =
                           FStarC_Class_Monoid.op_Plus_Plus
                             FStarC_TypeChecker_Common.monoid_guard_t ghead1
                             g1 in
                         (c, uu___6) in
                   (match uu___4 with
                    | (chead2, ghead2) ->
                        let rec aux norm1 solve ghead3 tres =
                          let tres1 =
                            let uu___5 =
                              let uu___6 = FStarC_Syntax_Subst.compress tres in
                          ...
                          | FStarC_Syntax_Syntax.Tm_arrow
                              ...
                              ->
                              let uu___5 =
                                FStarC_Syntax_Subst.open_comp bs1 cres' in
                              (match uu___5 with
                               | (bs2, cres'1) ->
                                   let head_info1 =
                                     (head1, chead2, ghead3, cres'1) in
                                   ((let uu___7 = FStarC_Debug.low () in
                                     if uu___7
                                     then
                                       FStarC_Errors.log_issue
                                         (FStarC_Syntax_Syntax.has_range_syntax
                              ...
                              let rec norm_tres tres2 =
                                let tres3 =
                                  let uu___6 =
                                    FStarC_TypeChecker_Normalize.unfold_whnf
                                      env tres2 in
                                  FStarC_Syntax_Util.unascribe uu___6 in
                                let uu___6 =
                                  let uu___7 =
                                    FStarC_Syntax_Subst.compress tres3 in
                                  uu___7.FStarC_Syntax_Syntax.n in
                                match uu___6 with
                                | FStarC_Syntax_Syntax.Tm_refine
                                    {
                                      FStarC_Syntax_Syntax.b =
                                        {
                                          FStarC_Syntax_Syntax.ppname =
                                            uu___7;
                                          FStarC_Syntax_Syntax.index = uu___8;
                                          FStarC_Syntax_Syntax.sort = tres4;_};
                                      FStarC_Syntax_Syntax.phi = uu___9;_}
                                    -> norm_tres tres4
                                | uu___7 -> tres3 in
                          ...
                          | uu___5 ->
                              let uu___6 = FStarC_Syntax_Syntax.argpos arg in
                              let uu___7 =
                                let uu___8 =
                                  let uu___9 =
                                    FStarC_Errors_Msg.text
                                  ...
                                  let uu___10 =
                                    FStarC_Class_PP.pp
                                      FStarC_Syntax_Print.pretty_term thead in
                                  FStar_Pprint.prefix (Prims.of_int (4))
                                    Prims.int_one uu___9 uu___10 in
                                let uu___9 =
                                  let uu___10 =
                                    let uu___11 =
                                      FStarC_Errors_Msg.text "Got" in
                                    let uu___12 =
                                      let uu___13 =
                                        FStarC_Class_PP.pp
                                          FStarC_Class_PP.pp_int n_args in
                                      let uu___14 =
                                        FStarC_Errors_Msg.text "arguments" in
                                    ...
                                    let uu___12 =
                                      ...
                                      let uu___14 =
                                        FStarC_Class_PP.pp
                                          ...
                                          tres1 in
                                      FStar_Pprint.prefix (Prims.of_int (4))
                                        Prims.int_one uu___13 uu___14 in
                                    [uu___12] in
                                  uu___10 :: uu___11 in
                                uu___8 :: uu___9 in
                              FStarC_Errors.raise_error
                                ...
                                (Obj.magic
                                   FStarC_Errors_Msg.is_error_message_list_doc)
                                (Obj.magic uu___7) in
                        let uu___5 = FStarC_Syntax_Util.comp_result chead2 in
                        aux false false ghead2 uu___5))) in
   let rec check_function_app tf guard =
                ...
                | (bs, guard1) ->
                    let uu___6 =
                      let uu___7 =
                        ...
                        FStar_Pervasives_Native.fst uu___8 in
                      FStarC_TypeChecker_Util.new_implicit_var
                        "formal parameter" tf1.FStarC_Syntax_Syntax.pos env
                        uu___7 false in
                    (match uu___6 with
                     | (t, uu___7, g) ->
                         let uu___8 =
                           let uu___9 = FStarC_Syntax_Syntax.null_binder t in
                           uu___9 :: bs in
                         let uu___9 =
                           FStarC_Class_Monoid.op_Plus_Plus
                             FStarC_TypeChecker_Common.monoid_guard_t g
              ...
              let uu___4 =
                let uu___5 =
                  let uu___6 =
                    ...
                    FStar_Pervasives_Native.fst uu___7 in
                  FStarC_TypeChecker_Util.new_implicit_var "result type"
                    tf1.FStarC_Syntax_Syntax.pos env uu___6 false in
                match uu___5 with
                | (t, uu___6, g) ->
                    let uu___7 = FStarC_Options.ml_ish () in
                    if uu___7
                    then
                      ...
                      let uu___9 =
                        FStarC_Class_Monoid.op_Plus_Plus
                          FStarC_TypeChecker_Common.monoid_guard_t guard1 g in
                      (uu___8, uu___9)
                    else
                      (let uu___9 = FStarC_Syntax_Syntax.mk_Total t in
                       let uu___10 =
                         FStarC_Class_Monoid.op_Plus_Plus
                           FStarC_TypeChecker_Common.monoid_guard_t guard1 g in
                       (uu___9, uu___10)) in
               ...
               | (cres, guard2) ->
                   ...
                   ((let uu___6 = FStarC_Debug.extreme () in
                     ...
                     then
                       ...
                       let uu___9 =
                         FStarC_Class_Show.show
                           FStarC_Syntax_Print.showable_term bs_cres in
                       FStarC_Format.print3
                    ...
                    (let g =
                       let uu___6 =
                         FStarC_TypeChecker_Rel.teq env tf1 bs_cres in
                       FStarC_TypeChecker_Rel.solve_deferred_constraints env
                         uu___6 in
                     let uu___6 =
                       FStarC_Class_Monoid.op_Plus_Plus
                         FStarC_TypeChecker_Common.monoid_guard_t g guard2 in
                     check_function_app bs_cres uu___6))))
     | FStarC_Syntax_Syntax.Tm_app
         {
           FStarC_Syntax_Syntax.hd =
             { FStarC_Syntax_Syntax.n = FStarC_Syntax_Syntax.Tm_uvar uu___2;
               FStarC_Syntax_Syntax.pos = uu___3;
               FStarC_Syntax_Syntax.vars = uu___4;
               FStarC_Syntax_Syntax.hash_code = uu___5;_};
           ...
           FStarC_List.fold_right
             (fun uu___8 uu___9 ->
                ...
                | (bs, guard1) ->
                    let uu___10 =
                      let uu___11 =
                        let uu___12 = FStarC_Syntax_Util.type_u () in
                    ...
                    (match uu___10 with
                     | (t, uu___11, g) ->
                         let uu___12 =
                           let uu___13 = FStarC_Syntax_Syntax.null_binder t in
                           uu___13 :: bs in
                         let uu___13 =
                           FStarC_Class_Monoid.op_Plus_Plus
                             FStarC_TypeChecker_Common.monoid_guard_t g
          ...
          | (bs, guard1) ->
              let uu___8 =
                let uu___9 =
                  ...
                  FStarC_TypeChecker_Util.new_implicit_var "result type"
                    tf1.FStarC_Syntax_Syntax.pos env uu___10 false in
                match uu___9 with
                | (t, uu___10, g) ->
                    let uu___11 = FStarC_Options.ml_ish () in
                    if uu___11
                    then
                      let uu___12 = FStarC_Syntax_Util.ml_comp t r in
                      let uu___13 =
                        FStarC_Class_Monoid.op_Plus_Plus
                          FStarC_TypeChecker_Common.monoid_guard_t guard1 g in
                      (uu___12, uu___13)
                    else
                      (let uu___13 = FStarC_Syntax_Syntax.mk_Total t in
                       let uu___14 =
                         FStarC_Class_Monoid.op_Plus_Plus
                           FStarC_TypeChecker_Common.monoid_guard_t guard1 g in
                       (uu___13, uu___14)) in
     ...
     | FStarC_Syntax_Syntax.Tm_refine
         { FStarC_Syntax_Syntax.b = bv; FStarC_Syntax_Syntax.phi = uu___2;_}
   ...
   check_function_app thead
     (FStarC_Class_Monoid.mzero FStarC_TypeChecker_Common.monoid_guard_t))
and check_short_circuit_args (env : FStarC_TypeChecker_Env.env)
  (head : FStarC_Syntax_Syntax.term) (chead : FStarC_Syntax_Syntax.comp)
  (g_head : FStarC_TypeChecker_Env.guard_t)
  (args :
    (FStarC_Syntax_Syntax.term' FStarC_Syntax_Syntax.syntax *
      FStarC_Syntax_Syntax.arg_qualifier FStar_Pervasives_Native.option)
      Prims.list)
  ...
  let r = FStarC_TypeChecker_Env.get_range env in
  let tf =
    let uu___ = FStarC_Syntax_Util.comp_result chead in
    FStarC_Syntax_Subst.compress uu___ in
  match tf.FStarC_Syntax_Syntax.n with
  | FStarC_Syntax_Syntax.Tm_arrow
      { FStarC_Syntax_Syntax.bs1 = bs; FStarC_Syntax_Syntax.comp = c;_} when
      (FStarC_Syntax_Util.is_total_comp c) &&
        ((FStarC_List.length bs) = (FStarC_List.length args))
      ->
          ...
          (fun uu___1 uu___2 b ->
             ...
             | ((seen, guard, ghost), (e, aq)) ->
                 ...
                 (match uu___3 with
                  | (e1, c1, g) ->
                      let short =
                        FStarC_TypeChecker_Util.short_circuit head seen in
                      let g1 =
                        let uu___4 =
                          FStarC_TypeChecker_Env.guard_of_guard_formula short in
                        FStarC_TypeChecker_Env.imp_guard uu___4 g in
                      let ghost1 =
                        ghost ||
                          ((let uu___4 =
                              FStarC_TypeChecker_Common.is_total_lcomp c1 in
                      ...
                      let uu___4 =
                        FStarC_Class_Monoid.op_Plus_Plus
                          FStarC_TypeChecker_Common.monoid_guard_t guard g1 in
                      ((FStarC_List.op_At seen [(e1, aq1)]), uu___4, ghost1)))
  ...
  | uu___ -> check_application_args env head chead g_head args expected_topt
and tc_pat (env : FStarC_TypeChecker_Env.env)
  (pat_t : FStarC_Syntax_Syntax.typ) (p0 : FStarC_Syntax_Syntax.pat) :
  ...
  let pat_typ_ok env1 pat_t1 scrutinee_t =
    (let uu___1 = FStarC_Effect.op_Bang dbg_Patterns in
     ...
     then
       let uu___2 =
         FStarC_Class_Show.show FStarC_Syntax_Print.showable_term pat_t1 in
       let uu___3 =
         FStarC_Class_Show.show FStarC_Syntax_Print.showable_term scrutinee_t in
       FStarC_Format.print2 "$$$$$$$$$$$$pat_typ_ok? %s vs. %s\n" uu___2
         uu___3
     else ());
    FStarC_Defensive.def_check_scoped FStarC_TypeChecker_Env.hasBinders_env
      FStarC_Class_Binders.hasNames_term FStarC_Syntax_Print.pretty_term
      pat_t1.FStarC_Syntax_Syntax.pos "pat_typ_ok.pat_t.entry" env1 pat_t1;
    (let fail1 msg_str =
       let msg =
         if msg_str = ""
         then []
       ...
       let msg1 =
         let uu___2 =
           let uu___3 =
             ...
             let uu___5 =
               FStarC_Class_PP.pp FStarC_Syntax_Print.pretty_term pat_t1 in
             FStar_Pprint.prefix (Prims.of_int (2)) Prims.int_one uu___4
               uu___5 in
           let uu___4 =
             let uu___5 =
               FStarC_Errors_Msg.text "does not match type of scrutinee" in
             let uu___6 =
               FStarC_Class_PP.pp FStarC_Syntax_Print.pretty_term scrutinee_t in
     ...
     | (head_s, args_s) ->
         ...
         (match uu___3 with
          | { FStarC_Syntax_Syntax.n = FStarC_Syntax_Syntax.Tm_fvar uu___4;
               ...
               | (head_p, args_p) ->
                   ...
                   then
                     ...
                     (match uu___10 with
                      | FStarC_Syntax_Syntax.Tm_fvar f ->
                          ((let uu___12 =
                           ...
                           if
                             (FStarC_List.length args_p) <>
                               (FStarC_List.length args_s)
                           then fail1 ""
                           else ();
                           (let uu___13 =
                              let uu___14 =
                              ...
                              | FStar_Pervasives_Native.Some n ->
                                  let uu___15 = FStarC_Util.first_N n args_p in
                                  (match uu___15 with
                                   | (params_p, uu___16) ->
                                       let uu___17 =
                                         FStarC_Util.first_N n args_s in
                                       (match uu___17 with
                                        | (params_s, uu___18) ->
                     ...
                     (let uu___11 =
                        ...
                        FStarC_Format.fmt2 "Head mismatch %s vs %s" uu___12
                          uu___13 in
                      fail1 uu___11))
          | uu___4 ->
              let uu___5 =
                FStarC_TypeChecker_Rel.teq_nosmt env1 pat_t2 scrutinee_t in
              (match uu___5 with
               | FStar_Pervasives_Native.None -> fail1 ""
               | FStar_Pervasives_Native.Some g ->
                   let g1 =
                     FStarC_TypeChecker_Rel.discharge_guard_no_smt env1 g in
                   g1))) in
  let type_of_simple_pat env1 e =
    ...
    | (head, args) ->
        (match head.FStarC_Syntax_Syntax.n with
         | FStarC_Syntax_Syntax.Tm_uinst
             ({ FStarC_Syntax_Syntax.n = FStarC_Syntax_Syntax.Tm_fvar uu___1;
                FStarC_Syntax_Syntax.pos = uu___2;
                FStarC_Syntax_Syntax.vars = uu___3;
                FStarC_Syntax_Syntax.hash_code = uu___4;_},
              uu___5)
             ...
             let uu___6 =
               ...
               | FStarC_Syntax_Syntax.Tm_uinst (head1, us) ->
                   ...
                   (match uu___7 with
                    | FStarC_Syntax_Syntax.Tm_fvar f ->
                        let res =
                          FStarC_TypeChecker_Env.try_lookup_and_inst_lid env1
                            us f.FStarC_Syntax_Syntax.fv_name in
                        (match res with
                         | FStar_Pervasives_Native.Some (t, uu___8) when
                             FStarC_TypeChecker_Env.is_datacon env1
                               f.FStarC_Syntax_Syntax.fv_name
                             -> (head1, (us, t))
                         | uu___8 ->
                             let uu___9 =
                               let uu___10 =
                                 FStarC_Ident.string_of_lid
                                   f.FStarC_Syntax_Syntax.fv_name in
                               FStarC_Format.fmt1
                                 "Could not find constructor: %s" uu___10 in
                             fail uu___9))
               | FStarC_Syntax_Syntax.Tm_fvar f ->
                   let uu___7 =
                        ...
                        (let rec aux uu___9 formals1 args1 =
                           ...
                           | (subst, args_out, bvs, guard) ->
                               (match (formals1, args1) with
                                | ([], []) ->
                                    let head2 =
                                      FStarC_Syntax_Syntax.mk_Tm_uinst head1
                                        us in
                                    let pat_e =
                                      FStarC_Syntax_Syntax.mk_Tm_app head2
                                        args_out e.FStarC_Syntax_Syntax.pos in
                                    let uu___10 =
                                      FStarC_Syntax_Subst.subst subst t in
                                    (pat_e, uu___10, bvs, guard, erasable)
                                | ({ FStarC_Syntax_Syntax.binder_bv = f;
                                   ...
                                   (a, imp_a)::args2) ->
                                    ...
                                    let uu___13 =
                                      let uu___14 =
                                        let uu___15 =
                                          FStarC_Syntax_Subst.compress a in
                                        uu___15.FStarC_Syntax_Syntax.n in
                                      match uu___14 with
                                      | FStarC_Syntax_Syntax.Tm_name x ->
                                          let x1 =
                                          ...
                                          let a1 =
                                            FStarC_Syntax_Syntax.bv_to_name
                                              x1 in
                                          let subst1 =
                                            (FStarC_Syntax_Syntax.NT (f, a1))
                                            :: subst in
                                          ((a1, imp_a), subst1,
                                            (FStarC_List.op_At bvs [x1]),
                                            (FStarC_Class_Monoid.mzero
                                               FStarC_TypeChecker_Common.monoid_guard_t))
                                      | FStarC_Syntax_Syntax.Tm_uvar uu___15
                                          ->
                                          let use_eq = true in
                                          let env2 =
                                            FStarC_TypeChecker_Env.set_expected_typ_maybe_eq
                                      ...
                                      | uu___15 ->
                                          let a1 =
                                            FStarC_Syntax_Subst.subst subst a in
                                          let env2 =
                                            FStarC_TypeChecker_Env.set_expected_typ
                                              env1 t_f1 in
                                          let uu___16 =
                    ...
                    | FStarC_Syntax_Syntax.Tm_fvar f ->
                        let res =
                          FStarC_TypeChecker_Env.try_lookup_and_inst_lid env1
                            us f.FStarC_Syntax_Syntax.fv_name in
                        (match res with
                         | FStar_Pervasives_Native.Some (t, uu___4) when
                             FStarC_TypeChecker_Env.is_datacon env1
                               f.FStarC_Syntax_Syntax.fv_name
                             -> (head1, (us, t))
                         | uu___4 ->
                             let uu___5 =
                               let uu___6 =
                                 FStarC_Ident.string_of_lid
                                   f.FStarC_Syntax_Syntax.fv_name in
                               FStarC_Format.fmt1
                                 "Could not find constructor: %s" uu___6 in
                             fail uu___5))
               | FStarC_Syntax_Syntax.Tm_fvar f ->
                   let uu___3 =
                     FStarC_TypeChecker_Env.lookup_datacon env1
                           ...
                           | (subst, args_out, bvs, guard) ->
                               (match (formals1, args1) with
                                | ([], []) ->
                                    ...
                                    let uu___6 =
                                      FStarC_Syntax_Subst.subst subst t in
                                    (pat_e, uu___6, bvs, guard, erasable)
                                | ({ FStarC_Syntax_Syntax.binder_bv = f;
                                     FStarC_Syntax_Syntax.binder_qual =
                                       uu___6;
                                     FStarC_Syntax_Syntax.binder_positivity =
  ...
  let rec check_nested_pattern env1 p t =
    (let uu___1 = FStarC_Effect.op_Bang dbg_Patterns in
     if uu___1
     then
       let uu___2 = FStarC_Class_Show.show FStarC_Syntax_Print.showable_pat p in
       let uu___3 =
         FStarC_Class_Show.show FStarC_Syntax_Print.showable_term t in
    ...
    (let id t1 =
       let uu___1 =
         FStarC_Syntax_Syntax.fvar FStarC_Parser_Const.id_lid
           FStar_Pervasives_Native.None in
       let uu___2 = let uu___3 = FStarC_Syntax_Syntax.iarg t1 in [uu___3] in
       FStarC_Syntax_Syntax.mk_Tm_app uu___1 uu___2
         t1.FStarC_Syntax_Syntax.pos in
     let mk_disc_t disc inner_t =
       let x_b =
         let uu___1 =
           FStarC_Syntax_Syntax.gen_bv "x" FStar_Pervasives_Native.None t in
              ...
              | FStarC_Syntax_Syntax.Tm_fvar fv ->
                  let uu___3 =
                    let uu___4 =
                      ...
                      FStarC_TypeChecker_Env.num_inductive_ty_params env1
                        uu___5 in
                    let uu___5 =
                      FStarC_Option.map
                        (fun n ->
                           ...
                           then
                             let uu___6 = FStarC_List.splitAt n args in
                  ...
                  FStarC_List.map
                    (fun uu___4 ->
                       match uu___4 with
                       | (t1, uu___5) -> FStarC_Syntax_Syntax.iarg t1) uu___3
              | uu___3 -> []) in
       let tm =
         let uu___1 =
           let uu___2 =
             ...
             [uu___3] in
           FStarC_List.op_At ty_args uu___2 in
         FStarC_Syntax_Syntax.mk_Tm_app disc uu___1
           FStarC_Range_Type.dummyRange in
       let tm1 =
         let uu___1 = let uu___2 = FStarC_Syntax_Syntax.as_arg tm in [uu___2] in
     ...
     | FStarC_Syntax_Syntax.Pat_dot_term uu___1 ->
         let uu___2 =
           ...
           FStarC_Format.fmt1
             "Impossible: Expected an undecorated pattern, got %s" uu___3 in
         failwith uu___2
     ...
     | FStarC_Syntax_Syntax.Pat_constant c ->
         ((match c with
           ...
           | uu___2 ->
               ...
               fail uu___3);
          (let uu___2 =
             FStarC_TypeChecker_PatternUtils.pat_as_exp false false env1 p in
           match uu___2 with
               ...
               (match uu___6 with
                | (e_c1, lc, g) ->
                    (FStarC_TypeChecker_Rel.force_trivial_guard env1 g;
                     (let expected_t =
                        expected_pat_typ env1 p0.FStarC_Syntax_Syntax.p t in
                      (let uu___9 =
                         let uu___10 =
                           FStarC_TypeChecker_Rel.teq_nosmt_force env1
                             lc.FStarC_TypeChecker_Common.res_typ expected_t in
                       ...
                       then
                         let uu___10 =
                           ...
                           let uu___12 =
                             FStarC_Class_Show.show
                               FStarC_Syntax_Print.showable_term expected_t in
                           FStarC_Format.fmt2
     ...
     | FStarC_Syntax_Syntax.Pat_cons
         ...
         let uu___2 =
           FStarC_TypeChecker_Util.find_record_or_dc_from_typ env1
             (FStar_Pervasives_Native.Some t) uc p.FStarC_Syntax_Syntax.p in
         (match uu___2 with
          | (rdc, uu___3, constructor_fv) ->
              ...
              let sub_pats1 =
                FStarC_TypeChecker_Util.make_record_fields_in_order env1 uc
                  (FStar_Pervasives_Native.Some (FStar_Pervasives.Inl t)) rdc
                  f_sub_pats
                  (fun uu___4 ->
                     let x =
                       FStarC_Syntax_Syntax.new_bv
              ...
              let p2 = FStarC_TypeChecker_PatternUtils.elaborate_pat env1 p1 in
     ...
     | FStarC_Syntax_Syntax.Pat_cons (fv, us_opt, sub_pats) ->
               ...
               (fun uu___1 ->
                  ...
                  | (p1, b) ->
                      (match p1.FStarC_Syntax_Syntax.v with
                       | FStarC_Syntax_Syntax.Pat_dot_term uu___2 -> (p1, b)
                       | uu___2 ->
                           let uu___3 =
                             let uu___4 =
                               let uu___5 =
             ...
             (fun uu___1 ->
                ...
                | (x, uu___2) ->
                    (match x.FStarC_Syntax_Syntax.v with
                     | FStarC_Syntax_Syntax.Pat_dot_term uu___3 -> false
         ...
         (match uu___1 with
          | (simple_bvs_pat, simple_pat_e, g0, simple_pat_elab) ->
              (if
                 (FStarC_List.length simple_bvs_pat) <>
                   (FStarC_List.length sub_pats1)
               then
                 (let uu___3 =
                    let uu___4 =
                      FStarC_Range_Ops.string_of_range
                    ...
                    let uu___6 =
                      FStarC_Class_Show.show FStarC_Class_Show.showable_nat
                        (FStarC_List.length sub_pats1) in
                    let uu___7 =
                      FStarC_Class_Show.show FStarC_Class_Show.showable_nat
                        (FStarC_List.length simple_bvs_pat) in
                    FStarC_Format.fmt4
                  ...
                  | (simple_pat_e1, simple_pat_t, simple_bvs, guard,
                     erasable) ->
                      let simple_bvs1 =
                        let uu___5 =
                          FStarC_Util.first_N
                            ((FStarC_List.length simple_bvs) -
                               (FStarC_List.length simple_bvs_pat))
                            simple_bvs in
                        FStar_Pervasives_Native.snd uu___5 in
                      let g' =
                        let uu___5 =
                          FStarC_TypeChecker_Env.push_bvs env1 simple_bvs1 in
                        let uu___6 =
                          expected_pat_typ env1 p0.FStarC_Syntax_Syntax.p t in
                      ...
                      let guard2 =
                        FStarC_Class_Monoid.op_Plus_Plus
                          FStarC_TypeChecker_Common.monoid_guard_t guard1 g' in
                      ((let uu___6 = FStarC_Effect.op_Bang dbg_Patterns in
                        if uu___6
                        then
                          let uu___7 =
                            FStarC_Class_Show.show
                              FStarC_Syntax_Print.showable_term simple_pat_e1 in
                          let uu___8 =
                            FStarC_Class_Show.show
                              FStarC_Syntax_Print.showable_term simple_pat_t in
                          let uu___9 =
                            let uu___10 =
                              FStarC_List.map
                                (fun x ->
                                   ...
                                   Prims.strcat "(" uu___11) simple_bvs1 in
                            FStarC_String.concat " " uu___10 in
                          FStarC_Format.print3
                    ...
                    let uu___4 =
                      let uu___5 =
                        let uu___6 =
                          FStarC_Class_Monoid.op_Plus_Plus
                            FStarC_TypeChecker_Common.monoid_guard_t g0 g1 in
                        ([], [], [], [], uu___6, erasable, Prims.int_zero) in
                      FStarC_List.fold_left2
                        (fun uu___6 uu___7 x ->
                           match (uu___6, uu___7) with
                           | ((bvs, tms, pats, subst, g, erasable1, i),
                              (p1, b)) ->
                               let expected_t =
                                 FStarC_Syntax_Subst.subst subst
                                   x.FStarC_Syntax_Syntax.sort in
                               ...
                               let uu___8 =
                                 check_nested_pattern env2 p1 expected_t in
                               (match uu___8 with
                                | (bvs_p, tms_p, e_p, p2, g', erasable_p) ->
                                    let g'1 =
                                      ...
                                      FStarC_TypeChecker_Env.close_guard env2
                                        uu___9 g' in
                                    let tms_p1 =
                                      let disc_tm =
                                        let uu___9 =
                                      ...
                                      let uu___9 =
                                        let uu___10 =
                                          FStarC_Syntax_Syntax.fvar disc_tm
                                            FStar_Pervasives_Native.None in
                                        mk_disc_t uu___10 in
                                      FStarC_List.map uu___9 tms_p in
                                    let uu___9 =
                                      FStarC_Class_Monoid.op_Plus_Plus
                                        FStarC_TypeChecker_Common.monoid_guard_t
                                        g g'1 in
                                    ((FStarC_List.op_At bvs bvs_p),
                                      (FStarC_List.op_At tms tms_p1),
                                      (FStarC_List.op_At pats [(p2, b)]),
                                      ((FStarC_Syntax_Syntax.NT (x, e_p)) ::
                                      subst), uu___9,
                                      (erasable1 || erasable_p),
                                      (i + Prims.int_one)))) uu___5 sub_pats1
                        simple_bvs in
                    (match uu___4 with
                     | (bvs, tms, checked_sub_pats, subst, g, erasable1,
                        uu___5) ->
                         let pat_e =
                           FStarC_Syntax_Subst.subst subst simple_pat_e1 in
                         let reconstruct_nested_pat pat =
                                 ...
                                 (match hd.FStarC_Syntax_Syntax.v with
                                  ...
                                  | FStarC_Syntax_Syntax.Pat_var x ->
                                      (match (bvs1, sub_pats2) with
                                       | (x'::bvs2, (hd1, uu___6)::sub_pats3)
                                           when
                                           FStarC_Syntax_Syntax.bv_eq x x' ->
                                           let uu___7 =
                                             aux simple_pats1 bvs2 sub_pats3 in
                                           (hd1, b) :: uu___7
                                       | uu___6 ->
                                           failwith
                           ...
                           let us =
                             let uu___6 =
                               FStarC_Syntax_Util.head_and_args simple_pat_e1 in
                             match uu___6 with
                             | (hd, uu___7) ->
                                 let uu___8 =
                                   let uu___9 =
                           ...
                           | FStarC_Syntax_Syntax.Pat_cons
                               ...
                               let nested_pats =
                                 aux simple_pats simple_bvs checked_sub_pats in
                               {
                                 FStarC_Syntax_Syntax.v =
                                   (FStarC_Syntax_Syntax.Pat_cons
                                      (fv1,
                         ...
                         let uu___6 = reconstruct_nested_pat simple_pat_elab in
                         (bvs, tms, pat_e, uu___6, g, erasable1)))))) in
  (let uu___1 = FStarC_Effect.op_Bang dbg_Patterns in
   if uu___1
   then
     let uu___2 = FStarC_Class_Show.show FStarC_Syntax_Print.showable_pat p0 in
...
and tc_eqn (scrutinee : FStarC_Syntax_Syntax.bv)
  ...
  ((FStarC_Syntax_Syntax.pat * FStarC_Syntax_Syntax.term
    ...
    FStarC_Syntax_Syntax.cflag Prims.list FStar_Pervasives_Native.option *
  ...
  | (pattern, when_clause, branch_exp) ->
      ...
      (match uu___1 with
       | (cpat, uu___2, cbr) ->
           ...
           let uu___3 =
             let uu___4 = FStarC_TypeChecker_Env.push_bv env scrutinee in
             FStarC_TypeChecker_Env.clear_expected_typ uu___4 in
           (match uu___3 with
            | (scrutinee_env, uu___4) ->
                let uu___5 =
                  let uu___6 = FStarC_TypeChecker_Env.push_bv env scrutinee in
                    ...
                    norm_pat_exp, guard_pat, erasable) ->
                     ((let uu___7 = FStarC_Debug.extreme () in
                       ...
                       then
                         let uu___8 =
                           FStarC_Class_Show.show
                             FStarC_Syntax_Print.showable_pat pattern1 in
                         let uu___9 =
                           FStarC_Class_Show.show
                             (FStarC_Class_Show.show_list
                                FStarC_Syntax_Print.showable_bv) pat_bvs in
                         let uu___10 =
                           FStarC_Class_Show.show
                             (FStarC_Class_Show.show_list
                                FStarC_Syntax_Print.showable_term) pat_bv_tms in
                         FStarC_Format.print3
                      ...
                      (let uu___7 =
                         ...
                         | FStar_Pervasives_Native.Some e ->
                             let uu___8 =
                               FStarC_TypeChecker_Env.should_verify env in
                             if uu___8
                             then
                               FStarC_Errors.raise_error
                                 (FStarC_Syntax_Syntax.has_range_syntax ()) e
                               ...
                               (let uu___10 =
                                  let uu___11 =
                                    FStarC_TypeChecker_Env.set_expected_typ
                                      pat_env FStarC_Syntax_Util.t_bool in
                                  tc_term uu___11 e in
                                match uu___10 with
                                | (e1, c, g) ->
                                    ((FStar_Pervasives_Native.Some e1), g)) in
                       match uu___7 with
                       | (when_clause1, g_when) ->
                           let uu___8 =
                             let branch_exp1 =
                               match ret_opt with
                               | FStar_Pervasives_Native.None -> branch_exp
                               | FStar_Pervasives_Native.Some (b, asc) ->
                                   let uu___9 =
                                     FStarC_Syntax_Subst.subst_ascription
                                       [FStarC_Syntax_Syntax.NT
                                          ((b.FStarC_Syntax_Syntax.binder_bv),
                                            norm_pat_exp)] asc in
                                   FStarC_Syntax_Util.ascribe branch_exp
                                     uu___9 in
                           ...
                           (match uu___8 with
                            | (branch_exp1, c, g_branch) ->
                                (FStarC_Defensive.def_check_scoped
                                   ...
                                   cbr.FStarC_Syntax_Syntax.pos "tc_eqn.1"
                                   pat_env g_branch;
                                 (let when_condition =
                                  ...
                                  let branch_guard =
                                    ...
                                    then FStarC_Syntax_Util.exp_true_bool
                                      ...
                                      (let rec build_branch_guard
                                         scrutinee_tm1 pattern2 pat_exp1 =
                                         let discriminate scrutinee_tm2 f =
                                           let uu___12 =
                                             let uu___13 =
                                         ...
                                         let pat_exp2 =
                                           let uu___12 =
                                             FStarC_Syntax_Subst.compress
                                               pat_exp1 in
                                           FStarC_Syntax_Util.unmeta uu___12 in
                                                         ...
                                                         | ((pi, uu___19),
                                                            (ei, uu___20)) ->
                                                             ...
                                                             build_branch_guard
                                                               scrutinee_tm2
                                                               pi ei) uu___17 in
                                                  FStarC_List.flatten uu___16 in
                                                let uu___16 =
                                                  let uu___17 =
                                                    force_scrutinee () in
                                                  discriminate uu___17 f in
                                                FStarC_List.op_At uu___16
                                                  sub_term_guards)
                                         | (FStarC_Syntax_Syntax.Pat_dot_term
                                            uu___12, uu___13) -> []
                                         | uu___12 ->
                                       ...
                                       let build_and_check_branch_guard
                                         ...
                                         then
                                           ...
                                           (let t =
                                              let uu___14 =
                                                build_branch_guard
                                                  scrutinee_tm1 pattern2 pat in
                                              FStarC_Syntax_Util.mk_and_l
                                                uu___14 in
                                            (let uu___15 =
                                               FStarC_Debug.high () in
                                             if uu___15
                                             then
                                               let uu___16 =
                                                 FStarC_Class_Show.show
                                          ...
                                          let uu___14 =
                                            let uu___15 =
                                              env1.FStarC_TypeChecker_Env.universe_of
                                                env1 pat_t in
                                            FStarC_Syntax_Util.mk_eq2 uu___15
                                              pat_t scrutinee_tm e in
                                          FStar_Pervasives_Native.Some
                                            uu___14) in
                                     match ret_opt with
                                     | FStar_Pervasives_Native.Some
                                         (uu___12,
                                          (FStar_Pervasives.Inr c1, uu___13,
                                           uu___14))
                                         ->
                                         let pat_bs =
                                           FStarC_List.map
                                              ...
                                              (match uu___14 with
                                               | (c_weak, g_when_weak) ->
                                                   ...
                                                   ((c_weak.FStarC_TypeChecker_Common.eff_name),
                                                     ...
                                                     uu___15, uu___16))) in
                                   match uu___11 with
                                   | (effect_label, cflags, maybe_return_c,
                                      g_when1, g_branch1) ->
                                       let guard =
                                         FStarC_Class_Monoid.op_Plus_Plus
                                           FStarC_TypeChecker_Common.monoid_guard_t
                                           g_when1 g_branch1 in
                                       ((let uu___13 = FStarC_Debug.high () in
                                         if uu___13
                                         then
                                           let uu___14 =
                                             FStarC_TypeChecker_Rel.guard_to_string
                                        ...
                                        (let uu___13 =
                                         ...
                                         (uu___13, branch_guard,
                                           effect_label, cflags,
                                           maybe_return_c, uu___14, erasable))))))))))))
and check_top_level_let (env : FStarC_TypeChecker_Env.env)
  (e : FStarC_Syntax_Syntax.term) :
  (FStarC_Syntax_Syntax.term * FStarC_TypeChecker_Common.lcomp *
    FStarC_TypeChecker_Env.guard_t)=
      ...
      (match uu___ with
       | (e1, univ_vars, c1, g1, annotated) ->
           let uu___1 =
             if
               annotated &&
                 (Prims.op_Negation env1.FStarC_TypeChecker_Env.generalize)
             then
               let uu___2 =
                 FStarC_TypeChecker_Normalize.reduce_uvar_solutions env1 e1 in
               (g1, uu___2, univ_vars, c1)
             else
               (let g11 =
                  let uu___3 =
                    FStarC_TypeChecker_Rel.solve_deferred_constraints env1 g1 in
                ...
                | (comp1, g_comp1) ->
                    let g12 =
                      FStarC_Class_Monoid.op_Plus_Plus
                        FStarC_TypeChecker_Common.monoid_guard_t g11 g_comp1 in
                    let uu___4 =
                      let uu___5 =
                        FStarC_TypeChecker_Generalize.generalize env1 false
                    ...
                    (match uu___4 with
                     | (uu___5, univs, e11, c11, gvs) ->
                         ...
                         let g15 =
                           FStarC_TypeChecker_Env.abstract_guard_n gvs g14 in
                         let uu___6 =
                      ...
                      then (e2, c12)
                        ...
                        ((let uu___6 =
                            (let uu___7 = FStarC_Options.ml_ish () in
                             Prims.op_Negation uu___7) &&
                              (Prims.op_Negation
                                 env1.FStarC_TypeChecker_Env.phase1) in
                          if uu___6
                          then
                            let uu___7 =
                      ...
                      (let e12 =
                         ...
                         then
                           FStarC_TypeChecker_Normalize.normalize
                             ...
                             FStarC_TypeChecker_Env.NoFullNorm;
                             FStarC_TypeChecker_Env.DoNotUnfoldPureLets] env1
                             e11
                         else e11 in
                       (let uu___5 = FStarC_Debug.medium () in
                        if uu___5
                       ...
                       (let cres =
                        ...
                        let lb1 =
                          let uu___5 = FStarC_Syntax_Util.comp_result c12 in
                          let uu___6 =
                            FStarC_Syntax_Util.comp_effect_name c12 in
                          FStarC_Syntax_Util.close_univs_and_mk_letbinding
                            FStar_Pervasives_Native.None
                            lb.FStarC_Syntax_Syntax.lbname univ_vars1 uu___5
                            uu___6 e12 lb.FStarC_Syntax_Syntax.lbattrs
...
and maybe_intro_smt_lemma (env : FStarC_TypeChecker_Env.env)
  (lem_typ : FStarC_Syntax_Syntax.term)
  (c2 : FStarC_TypeChecker_Common.lcomp) : FStarC_TypeChecker_Common.lcomp=
        ...
        FStarC_List.fold_left
          (fun uu___2 b ->
             ...
             | (env1, us) ->
                 ...
                 (env2, (u :: us))) (env, []) bs in
      match uu___1 with | (uu___2, us) -> FStarC_List.rev us in
    let quant =
      FStarC_Syntax_Util.smt_lemma_as_forall lem_typ universe_of_binders in
    FStarC_TypeChecker_Util.weaken_precondition env c2
      (FStarC_TypeChecker_Common.NonTrivial quant)
  else c2
and check_inner_let (env : FStarC_TypeChecker_Env.env)
  (e : FStarC_Syntax_Syntax.term) :
  (FStarC_Syntax_Syntax.term * FStarC_TypeChecker_Common.lcomp *
    FStarC_TypeChecker_Env.guard_t)=
  let env1 = instantiate_both env in
  ...
  | FStarC_Syntax_Syntax.Tm_let
      ...
      (match uu___ with
       | (e1, uu___1, c1, g1, annotated) ->
           ...
           let is_inline_let_vc =
             FStarC_Util.for_some
               (FStarC_Syntax_Util.is_fvar
                  FStarC_Parser_Const.inline_let_vc_attr)
               lb.FStarC_Syntax_Syntax.lbattrs in
           ((let uu___3 =
               (is_inline_let || is_inline_let_vc) &&
                 (let uu___4 =
                    pure_or_ghost ||
            ...
            (let x =
             ...
             match uu___3 with
             | (xb, e21) ->
                 let xbinder = FStarC_List.hd xb in
                  ...
                  | (e22, c2, g2) ->
                      ...
                      let cres =
                        FStarC_TypeChecker_Util.maybe_return_e2_and_bind
                          e1.FStarC_Syntax_Syntax.pos
                          (Prims.op_Negation is_inline_let_vc) env2
                      ...
                      let lb1 =
                        ...
                        FStarC_Syntax_Util.mk_letbinding
                          ...
                          c1.FStarC_TypeChecker_Common.res_typ
                          cres.FStarC_TypeChecker_Common.eff_name e11 attrs
                          lb.FStarC_Syntax_Syntax.lbpos in
                      let e3 =
                        let uu___5 =
                          let uu___6 =
                      ...
                      let g21 =
                        let uu___5 =
                          ...
                          FStarC_TypeChecker_Env.is_layered_effect env2
                            uu___6 in
                        FStarC_TypeChecker_Util.close_guard_implicits env2
                          uu___5 xb g2 in
                      let guard =
                        FStarC_Class_Monoid.op_Plus_Plus
                          FStarC_TypeChecker_Common.monoid_guard_t g1 g21 in
                      let uu___5 =
                        let uu___6 = FStarC_TypeChecker_Env.expected_typ env2 in
                      ...
                      then
                        ...
                        ((let uu___7 = FStarC_Effect.op_Bang dbg_Exports in
                          if uu___7
                          then
                            let uu___8 =
                              FStarC_Class_Show.show
                        ...
                        (let uu___7 =
                           check_no_escape FStar_Pervasives_Native.None env2
                             [x1] cres.FStarC_TypeChecker_Common.res_typ in
                         match uu___7 with
                         | (t, g_ex) ->
                             ((let uu___9 = FStarC_Effect.op_Bang dbg_Exports in
                               if uu___9
                               then
                                 let uu___10 =
                                   FStarC_Class_Show.show
...
and check_top_level_let_rec (env : FStarC_TypeChecker_Env.env)
  (top : FStarC_Syntax_Syntax.term) :
  (FStarC_Syntax_Syntax.term * FStarC_TypeChecker_Common.lcomp *
    FStarC_TypeChecker_Env.guard_t)=
  let env1 = instantiate_both env in
                                  ...
                                  (fun lb ->
                                     let lbdef =
                                       FStarC_TypeChecker_Normalize.reduce_uvar_solutions
                                         env1 lb.FStarC_Syntax_Syntax.lbdef in
                                     ...
                                     then lb
                                       ...
                                       FStarC_Syntax_Util.close_univs_and_mk_letbinding
                                         ...
                                         lb.FStarC_Syntax_Syntax.lbeff lbdef
                                         lb.FStarC_Syntax_Syntax.lbattrs
                                         lb.FStarC_Syntax_Syntax.lbpos) lbs3 in
                              (lbs4, g_lbs1)
                            else
                              (let ecs =
                                 let uu___6 =
                                      ...
                                      | (x, uvs, e, c, gvs) ->
                                          ...
                                          let uu___8 =
                                            FStarC_Syntax_Util.comp_effect_name
                                              c in
                                          FStarC_Syntax_Util.close_univs_and_mk_letbinding
                                            all_lb_names x uvs uu___7 uu___8
                                            e lb.FStarC_Syntax_Syntax.lbattrs
                           ...
                           | (lbs4, g_lbs2) ->
                               let cres =
                                 ...
                                 FStarC_TypeChecker_Common.lcomp_of_comp
                                   uu___5 in
                               let uu___5 =
                                 FStarC_Syntax_Subst.close_let_rec lbs4 e21 in
                               (match uu___5 with
                                | (lbs5, e22) ->
                                    ((let uu___7 =
                                     ...
                                     (let uu___7 =
                                      ...
                                      (uu___7, cres,
                                        (FStarC_Class_Monoid.mzero
                                           FStarC_TypeChecker_Common.monoid_guard_t))))))))))
  | uu___ -> failwith "Impossible: check_top_level_let_rec: not a let rec"
and check_inner_let_rec (env : FStarC_TypeChecker_Env.env)
  (top : FStarC_Syntax_Syntax.term) :
  (FStarC_Syntax_Syntax.term * FStarC_TypeChecker_Common.lcomp *
    FStarC_TypeChecker_Env.guard_t)=
  let env1 = instantiate_both env in
                 ...
                 | (lbs2, rec_env, g_t) ->
                     let uu___3 =
                       ...
                       | (lbs3, g) ->
                           let uu___5 =
                             FStarC_Class_Monoid.op_Plus_Plus
                               FStarC_TypeChecker_Common.monoid_guard_t g_t g in
                           (lbs3, uu___5) in
                     (match uu___3 with
                      | (lbs3, g_lbs) ->
                          let uu___4 =
                           ...
                           | (env2, lbs4) ->
                               let bvs =
                                 FStarC_List.map
                                   (fun lb ->
                                      FStar_Pervasives.__proj__Inl__item__v
                                        lb.FStarC_Syntax_Syntax.lbname) lbs4 in
...
and build_let_rec_env (_top_level : Prims.bool)
  (env : FStarC_TypeChecker_Env.env)
  (lbs : FStarC_Syntax_Syntax.letbinding Prims.list) :
  (FStarC_Syntax_Syntax.letbinding Prims.list * FStarC_TypeChecker_Env.env_t
    * FStarC_TypeChecker_Env.guard_t)=
  let env0 = env in
    ...
    then FStar_Pervasives_Native.None
      ...
      (let lbtyp0 = lbtyp in
       ...
       | (actuals, body, body_lc) ->
           let actuals1 =
             let uu___3 = FStarC_TypeChecker_Env.set_expected_typ env lbtyp in
             FStarC_TypeChecker_Util.maybe_add_implicit_binders uu___3
               actuals in
           let nactuals = FStarC_List.length actuals1 in
           let uu___3 =
             FStarC_TypeChecker_Normalize.get_n_binders env nactuals lbtyp in
           (match uu___3 with
            | (formals, c) ->
                (if
                   (FStarC_List.isEmpty formals) ||
                     (FStarC_List.isEmpty actuals1)
                 then
                   (let uu___5 =
                      let uu___6 =
                        FStarC_Errors_Msg.text
                      ...
                      let uu___7 =
                        let uu___8 =
                          let uu___9 =
                            ...
                            FStarC_Format.fmt3 "Got (%s) %s : %s" uu___10
                              uu___11 uu___12 in
      ...
      tc_check_tot_or_gtot_term
        {
          ...
          FStarC_TypeChecker_Env.range = (env01.FStarC_TypeChecker_Env.range);
          FStarC_TypeChecker_Env.curmodule =
            (env01.FStarC_TypeChecker_Env.curmodule);
          FStarC_TypeChecker_Env.gamma = (env01.FStarC_TypeChecker_Env.gamma);
          FStarC_TypeChecker_Env.gamma_sig =
          ...
          FStarC_TypeChecker_Env.admit = (env01.FStarC_TypeChecker_Env.admit);
          FStarC_TypeChecker_Env.phase1 =
          ...
          FStarC_TypeChecker_Env.dsenv = (env01.FStarC_TypeChecker_Env.dsenv);
          FStarC_TypeChecker_Env.nbe = (env01.FStarC_TypeChecker_Env.nbe);
          FStarC_TypeChecker_Env.strict_args_tab =
  ...
  let uu___ =
    FStarC_List.fold_left
      (fun uu___1 lb ->
         ...
         | (lbs1, env1, g_acc) ->
             let uu___2 =
               FStarC_TypeChecker_Util.extract_let_rec_annotation env1 lb in
             (match uu___2 with
              | (univ_vars, lbtyp, lbdef, check_t) ->
                  let env2 =
                    FStarC_TypeChecker_Env.push_univ_vars env1 univ_vars in
                  let uu___3 =
                    ...
                    then (g_acc, lbtyp)
                      ...
                      (let uu___5 = check_annot univ_vars lbtyp in
                       ...
                       | (uu___6, g, t) ->
                           let uu___7 =
                             FStarC_Class_Monoid.op_Plus_Plus
                               FStarC_TypeChecker_Common.monoid_guard_t g_acc
                               g in
                           (uu___7, t)) in
                  (match uu___3 with
                   | (g, lbtyp1) ->
                       let uu___4 =
                         let uu___5 =
                           termination_check_enabled
                             lb.FStarC_Syntax_Syntax.lbattrs
                             lb.FStarC_Syntax_Syntax.lbname lbdef lbtyp1 in
                         match uu___5 with
                         | FStar_Pervasives_Native.Some (arity, lbdef1) ->
                             ((let uu___7 = FStarC_Debug.extreme () in
                               if uu___7
                               then
                                 let uu___8 =
                                 ...
                                 let uu___9 =
                                   FStarC_Class_Show.show
                                     FStarC_Syntax_Print.showable_term lbdef1 in
                                 FStarC_Format.print2
                              ...
                              (let lb1 =
                                 {
                                   ...
                                   FStarC_Syntax_Syntax.lbeff =
                                     (lb.FStarC_Syntax_Syntax.lbeff);
                                   FStarC_Syntax_Syntax.lbdef = lbdef1;
                                   FStarC_Syntax_Syntax.lbattrs =
                                     (lb.FStarC_Syntax_Syntax.lbattrs);
                                   FStarC_Syntax_Syntax.lbpos =
                                     (lb.FStarC_Syntax_Syntax.lbpos)
                         ...
                         | FStar_Pervasives_Native.None ->
                             ...
                             let uu___6 =
                               FStarC_TypeChecker_Env.push_let_binding env2
                                 lb1.FStarC_Syntax_Syntax.lbname
                                 (univ_vars, lbtyp1) in
                             (lb1, uu___6) in
                       (match uu___4 with
      ...
      ([], env,
        (FStarC_Class_Monoid.mzero FStarC_TypeChecker_Common.monoid_guard_t))
      lbs in
  match uu___ with | (lbs1, env1, g) -> ((FStarC_List.rev lbs1), env1, g)
and check_let_recs (env : FStarC_TypeChecker_Env.env_t)
  (lbts : FStarC_Syntax_Syntax.letbinding Prims.list) :
               ...
               (match bs with
                      ...
                      let uu___6 =
                        let uu___7 =
                          let uu___8 =
                            ...
                            FStarC_Format.fmt2 "%s is defined to be %s"
                              uu___9 uu___10 in
                ...
                | uu___3 ->
                    let arity =
                      ...
                      | FStar_Pervasives_Native.None -> FStarC_List.length bs in
                    let uu___4 = FStarC_List.splitAt arity bs in
                    (match uu___4 with
                     | (bs0, bs1) ->
                         let def =
                           if FStarC_List.isEmpty bs1
                           then FStarC_Syntax_Util.abs bs0 t lcomp
                           else
                             (let inner = FStarC_Syntax_Util.abs bs1 t lcomp in
                              let inner1 =
  ...
  | (lbs, gs) ->
      let uu___1 =
        FStarC_Class_Monoid.msum FStarC_TypeChecker_Common.monoid_guard_t gs in
      (lbs, uu___1)
and check_let_bound_def (top_level : Prims.bool)
  (env : FStarC_TypeChecker_Env.env) (lb : FStarC_Syntax_Syntax.letbinding) :
            ...
            (let e11 = FStarC_Syntax_Subst.subst univ_opening e1 in
             ...
             | (e12, c1, g1) ->
                 let uu___5 =
                   ...
                   FStarC_TypeChecker_Util.strengthen_precondition
                     (FStar_Pervasives_Native.Some
                        (fun uu___7 -> FStarC_TypeChecker_Err.ill_kinded_type))
                     uu___6 e12 c1 wf_annot in
                 (match uu___5 with
                  | (c11, guard_f) ->
                      let g11 =
                        FStarC_Class_Monoid.op_Plus_Plus
                          FStarC_TypeChecker_Common.monoid_guard_t g1 guard_f in
                      ((let uu___7 = FStarC_Debug.extreme () in
                        if uu___7
                        then
                          let uu___8 =
                            FStarC_Class_Show.show
                              ...
                              lb.FStarC_Syntax_Syntax.lbname in
                          let uu___9 =
                            FStarC_TypeChecker_Common.lcomp_to_string c11 in
                          let uu___10 =
                            FStarC_TypeChecker_Rel.guard_to_string env g11 in
                          FStarC_Format.print3
                            "checked let-bound def %s : %s guard is %s\n"
                            uu___8 uu___9 uu___10
                        else ());
                       (e12, univ_vars, c11, g11,
                         (FStar_Pervasives_Native.uu___is_Some topt)))))))
and check_lbtyp (top_level : Prims.bool) (env : FStarC_TypeChecker_Env.env)
  (lb : FStarC_Syntax_Syntax.letbinding) :
  (FStarC_Syntax_Syntax.typ FStar_Pervasives_Native.option *
    FStarC_TypeChecker_Env.guard_t * FStarC_Syntax_Syntax.univ_names *
    FStarC_Syntax_Syntax.subst_elt Prims.list * FStarC_TypeChecker_Env.env)=
  FStarC_Errors.with_ctx "While checking type annotation of a letbinding"
    (fun uu___ ->
       ...
       | FStarC_Syntax_Syntax.Tm_unknown ->
           ...
           (match uu___1 with
            | (univ_opening, univ_vars) ->
                ...
                (FStar_Pervasives_Native.None,
                  (FStarC_Class_Monoid.mzero
                     FStarC_TypeChecker_Common.monoid_guard_t), univ_vars,
                  univ_opening, uu___2))
       | uu___1 ->
           let uu___2 =
             FStarC_Syntax_Subst.univ_var_opening
           ...
           (match uu___2 with
            | (univ_opening, univ_vars) ->
                ...
                if
                  top_level &&
                    (Prims.op_Negation env.FStarC_TypeChecker_Env.generalize)
                then
                  let uu___3 =
                              ...
                              then
                                let uu___10 =
                                  let uu___11 =
                                    FStarC_Syntax_Syntax.range_of_lbname
                                      lb.FStarC_Syntax_Syntax.lbname in
                                  FStarC_Range_Ops.string_of_range uu___11 in
                                let uu___11 =
                                  FStarC_Class_Show.show
...
and tc_binder (env : FStarC_TypeChecker_Env.env)
  (uu___ : FStarC_Syntax_Syntax.binder) :
             ...
             then
               ...
               let uu___5 =
                 FStarC_Class_Show.show FStarC_Syntax_Print.showable_term
                   x.FStarC_Syntax_Syntax.sort in
               let uu___6 =
                 FStarC_Class_Show.show FStarC_Syntax_Print.showable_term tu in
               FStarC_Format.print3 "Checking binder %s:%s at type %s\n"
                 uu___4 uu___5 uu___6
             else ());
            (let uu___3 =
               tc_check_tot_or_gtot_term env x.FStarC_Syntax_Syntax.sort tu
                 FStar_Pervasives_Native.None in
             match uu___3 with
             | (t, uu___4, g) ->
                 let uu___5 =
                           ...
                           (check_erasable_binder_attributes env attrs1 t;
                            (let x1 =
                             ...
                             (let uu___9 = push_binding env x1 in
                              (x1, uu___9, g1, u)))))))))
and tc_binders (env : FStarC_TypeChecker_Env.env)
  (bs : FStarC_Syntax_Syntax.binders) :
  ...
  (let uu___1 = FStarC_Debug.extreme () in
   ...
   then
     let uu___2 =
       FStarC_Class_Show.show
         (FStarC_Class_Show.show_list FStarC_Syntax_Print.showable_binder) bs in
          ...
          | (b1, env', g, u) ->
              ...
              (match uu___2 with
               | (bs3, env'1, g', us) ->
                   let uu___3 =
                     let uu___4 =
                       FStarC_TypeChecker_Env.close_guard_univs [u] [b1] g' in
                     FStarC_Class_Monoid.op_Plus_Plus
                       FStarC_TypeChecker_Common.monoid_guard_t g uu___4 in
                   ((b1 :: bs3), env'1, uu___3, (u :: us)))) in
   aux env bs)
and tc_smt_pats (en : FStarC_TypeChecker_Env.env)
  (pats :
    (FStarC_Syntax_Syntax.term' FStarC_Syntax_Syntax.syntax *
      FStarC_Syntax_Syntax.arg_qualifier FStar_Pervasives_Native.option)
  ...
  let tc_args en1 args =
    FStarC_List.fold_right
      ...
      ([],
        (FStarC_Class_Monoid.mzero FStarC_TypeChecker_Common.monoid_guard_t)) in
  FStarC_List.fold_right
    (fun p uu___ ->
       match uu___ with
       | (pats1, g) ->
...
and tc_tot_or_gtot_term_maybe_solve_deferred
  ...
  | (e1, c, g) ->
      ...
      then (e1, c, g)
        ...
        (let g1 =
           if solve_deferred
           then FStarC_TypeChecker_Rel.solve_deferred_constraints env g
           else g in
         ...
         | (c1, g_c) ->
             ...
             let uu___4 =
               let uu___5 =
                 let uu___6 = FStarC_Syntax_Util.comp_effect_name c2 in
                 FStarC_TypeChecker_Util.is_pure_effect env uu___6 in
               if uu___5
               then
                 let uu___6 =
                   let uu___7 = FStarC_Syntax_Util.comp_result c2 in
                   FStarC_Syntax_Syntax.mk_Total uu___7 in
                 (uu___6, false)
               else
                 (let uu___7 =
                    let uu___8 = FStarC_Syntax_Util.comp_result c2 in
                    FStarC_Syntax_Syntax.mk_GTotal uu___8 in
                  (uu___7, true)) in
             (match uu___4 with
              | (target_comp, allow_ghost) ->
                  let uu___5 =
                    FStarC_TypeChecker_Rel.sub_comp env c2 target_comp in
                  (match uu___5 with
                   | FStar_Pervasives_Native.Some g' ->
                       let uu___6 =
                         FStarC_TypeChecker_Common.lcomp_of_comp target_comp in
                       let uu___7 =
                         let uu___8 =
                           FStarC_Class_Monoid.op_Plus_Plus
                             FStarC_TypeChecker_Common.monoid_guard_t g_c g' in
                         FStarC_Class_Monoid.op_Plus_Plus
                           FStarC_TypeChecker_Common.monoid_guard_t g1 uu___8 in
                       (e1, uu___6, uu___7)
                   | uu___6 ->
                       if allow_ghost
                       then
                         ...
                         FStarC_TypeChecker_Err.expected_pure_expression
                           e1.FStarC_Syntax_Syntax.pos e1 c2 msg)))
and tc_tot_or_gtot_term' (env : FStarC_TypeChecker_Env.env)
  (e : FStarC_Syntax_Syntax.term)
  (msg : Prims.string FStar_Pervasives_Native.option) :
  (FStarC_Syntax_Syntax.term * FStarC_TypeChecker_Common.lcomp *
    FStarC_TypeChecker_Env.guard_t)=
...
and tc_tot_or_gtot_term (env : FStarC_TypeChecker_Env.env)
  ...
  (FStarC_Syntax_Syntax.term * FStarC_TypeChecker_Common.lcomp *
    FStarC_TypeChecker_Env.guard_t)=
  tc_tot_or_gtot_term' env e FStar_Pervasives_Native.None
and tc_check_tot_or_gtot_term (env : FStarC_TypeChecker_Env.env)
...
and tc_trivial_guard (env : FStarC_TypeChecker_Env.env)
  (t : FStarC_Syntax_Syntax.term) :
  (FStarC_Syntax_Syntax.term * FStarC_TypeChecker_Common.lcomp)=
  let uu___ = tc_tot_or_gtot_term env t in
  match uu___ with
  | (t1, c, g) -> (FStarC_TypeChecker_Rel.force_trivial_guard env g; (t1, c))
and tc_attributes (env : FStarC_TypeChecker_Env.env_t)
  (attrs : FStarC_Syntax_Syntax.term Prims.list) :
       ...
       | (g, attrs1) ->
           ...
           (match uu___1 with
            | (attr', uu___2, g') ->
                ...
                (uu___3, (attr' :: attrs1))))
    ((FStarC_Class_Monoid.mzero FStarC_TypeChecker_Common.monoid_guard_t),
      []) (FStarC_List.rev attrs)
let tc_check_trivial_guard (env : FStarC_TypeChecker_Env.env)
  (t : FStarC_Syntax_Syntax.term) (k : FStarC_Syntax_Syntax.term) :
  FStarC_Syntax_Syntax.term=
  let uu___ = tc_check_tot_or_gtot_term env t k FStar_Pervasives_Native.None in
  match uu___ with
  | (t1, uu___1, g) -> (FStarC_TypeChecker_Rel.force_trivial_guard env g; t1)
let typeof_tot_or_gtot_term (env : FStarC_TypeChecker_Env.env)
  (e : FStarC_Syntax_Syntax.term) (must_tot : Prims.bool) :
  (FStarC_Syntax_Syntax.term * FStarC_Syntax_Syntax.typ *
    FStarC_TypeChecker_Env.guard_t)=
  (let uu___1 = FStarC_Effect.op_Bang dbg_RelCheck in
   if uu___1
   then
     let uu___2 = FStarC_Class_Show.show FStarC_Syntax_Print.showable_term e in
  ...
  (let env1 =
   ...
   let uu___1 =
     try (fun uu___2 -> match () with | () -> tc_tot_or_gtot_term env1 e) ()
     with
     | FStarC_Errors.Error (e1, msg, r, ctx) when
         r = FStarC_Range_Type.dummyRange ->
         let uu___3 =
           let uu___4 =
   ...
   | (t, c, g) ->
       ...
       then
         let c1 =
           FStarC_TypeChecker_Normalize.maybe_ghost_to_pure_lcomp env1 c in
          ...
          then (t, (c1.FStarC_TypeChecker_Common.res_typ), g)
            ...
            (let uu___4 =
             ...
             FStarC_Errors.raise_error FStarC_TypeChecker_Env.hasRange_env
               env1 FStarC_Errors_Codes.Fatal_UnexpectedImplictArgument ()
               (Obj.magic FStarC_Errors_Msg.is_error_message_string)
               (Obj.magic uu___4)))
       else (t, (c.FStarC_TypeChecker_Common.res_typ), g))
let level_of_type_fail (env : FStarC_TypeChecker_Env.env)
  (e : FStarC_Syntax_Syntax.term) (t : Prims.string) : 'uuuuu=
  let uu___ =
    let uu___1 =
      let uu___2 =
        let uu___3 =
          FStarC_Class_Show.show FStarC_Syntax_Print.showable_term e in
        FStarC_Format.fmt2 "Expected a type; got %s of type %s" uu___3 t in
      FStarC_Errors_Msg.text uu___2 in
    [uu___1] in
  FStarC_Errors.raise_error FStarC_TypeChecker_Env.hasRange_env env
    FStarC_Errors_Codes.Fatal_UnexpectedTermType ()
    (Obj.magic FStarC_Errors_Msg.is_error_message_list_doc) (Obj.magic uu___)
let level_of_type (env : FStarC_TypeChecker_Env.env)
  (e : FStarC_Syntax_Syntax.term) (t : FStarC_Syntax_Syntax.typ) :
          ...
          (let uu___3 = FStarC_Syntax_Util.type_u () in
           ...
           | (t_u, u) ->
               ...
               ((match g.FStarC_TypeChecker_Common.guard_f with
                ...
                u)) in
  aux true t
let rec apply_well_typed (env : FStarC_TypeChecker_Env.env)
  (t_hd : FStarC_Syntax_Syntax.typ) (args : FStarC_Syntax_Syntax.args) :
  FStarC_Syntax_Syntax.typ FStar_Pervasives_Native.option=
    ...
    (let uu___1 =
     ...
     | FStarC_Syntax_Syntax.Tm_arrow
         ...
         let uu___2 =
           if n_args < n_bs
           then
             let uu___3 = FStarC_Util.first_N n_args bs in
             match uu___3 with
             | (bs1, rest) ->
                 let t =
                   FStarC_Syntax_Syntax.mk
                 ...
                 (match uu___4 with
                  | (bs2, c1) ->
                      let uu___5 = FStarC_Syntax_Util.comp_result c1 in
                      (bs2, args, uu___5, []))
           else
             (let uu___4 = FStarC_Syntax_Subst.open_comp bs c in
              match uu___4 with
              | (bs1, c1) ->
                  let uu___5 = FStarC_List.splitAt n_bs args in
                  (match uu___5 with
                   | (args1, remaining_args) ->
                       let uu___6 = FStarC_Syntax_Util.comp_result c1 in
                       (bs1, args1, uu___6, remaining_args))) in
         (match uu___2 with
...
let rec universe_of_aux (env : FStarC_TypeChecker_Env.env)
  ...
  | FStarC_Syntax_Syntax.Tm_fvar fv ->
      let uu___1 =
        FStarC_TypeChecker_Env.lookup_lid env fv.FStarC_Syntax_Syntax.fv_name in
  ...
  | FStarC_Syntax_Syntax.Tm_ascribed
      { FStarC_Syntax_Syntax.tm = uu___1;
        FStarC_Syntax_Syntax.asc = (FStar_Pervasives.Inl t, uu___2, uu___3);
        FStarC_Syntax_Syntax.eff_opt = uu___4;_}
      -> t
  | FStarC_Syntax_Syntax.Tm_ascribed
      { FStarC_Syntax_Syntax.tm = uu___1;
        FStarC_Syntax_Syntax.asc = (FStar_Pervasives.Inr c, uu___2, uu___3);
        FStarC_Syntax_Syntax.eff_opt = uu___4;_}
  ...
  | FStarC_Syntax_Syntax.Tm_uinst
      ...
      (match uu___4 with
       | ((us', t), uu___5) ->
           (if (FStarC_List.length us) <> (FStarC_List.length us')
            then
              FStarC_Errors.raise_error FStarC_TypeChecker_Env.hasRange_env
                env FStarC_Errors_Codes.Fatal_UnexpectedNumberOfUniverse ()
                (Obj.magic FStarC_Errors_Msg.is_error_message_string)
             ...
             FStarC_List.map
               (fun uu___2 ->
                  ...
                  | { FStarC_Syntax_Syntax.binder_bv = b;
                      ...
                      level_of_type env1 b.FStarC_Syntax_Syntax.sort uu___6)
               bs1 in
           let u_res =
             let res = FStarC_Syntax_Util.comp_result c1 in
             let uu___2 = universe_of_aux env1 res in
             level_of_type env1 res uu___2 in
           let u_c = FStarC_TypeChecker_Util.universe_of_comp env1 u_res c1 in
           let u =
        ...
        | FStarC_Syntax_Syntax.Tm_match
            ...
            (match uu___5 with
             | (pat, uu___6, tm) ->
                 ...
                 (match uu___7 with
                  | (hd3, args') ->
                      let uu___8 = FStarC_TypeChecker_Env.push_bvs env1 bvs in
                      type_of_head retry uu___8 hd3
                        (FStarC_List.op_At args' args1)))
        | uu___1 when retry ->
            let e1 =
              FStarC_TypeChecker_Normalize.normalize
                [FStarC_TypeChecker_Env.Beta;
        ...
        | uu___1 ->
            ...
            (match uu___2 with
             | (env2, uu___3) ->
                 ...
                 ((let uu___5 = FStarC_Effect.op_Bang dbg_UniverseOf in
                   if uu___5
                   then
                     let uu___6 =
  ...
  | FStarC_Syntax_Syntax.Tm_match
      { FStarC_Syntax_Syntax.scrutinee = uu___1;
        FStarC_Syntax_Syntax.ret_opt = uu___2; FStarC_Syntax_Syntax.brs = [];
        FStarC_Syntax_Syntax.rc_opt1 = uu___3;_}
      -> level_of_type_fail env e "empty match cases"
let universe_of (env : FStarC_TypeChecker_Env.env)
  (e : FStarC_Syntax_Syntax.term) : FStarC_Syntax_Syntax.universe=
  FStarC_Errors.with_ctx "While attempting to compute a universe level"
    (fun uu___ ->
       ...
       FStarC_Defensive.def_check_scoped
         FStarC_TypeChecker_Env.hasBinders_env
         FStarC_Class_Binders.hasNames_term FStarC_Syntax_Print.pretty_term
         e.FStarC_Syntax_Syntax.pos "universe_of entry" env e;
...
let tc_tparams (env0 : FStarC_TypeChecker_Env.env_t)
  (tps : FStarC_Syntax_Syntax.binders) :
  (FStarC_Syntax_Syntax.binders * FStarC_TypeChecker_Env.env *
...
let rec __typeof_tot_or_gtot_term_fastpath (env : FStarC_TypeChecker_Env.env)
  (t : FStarC_Syntax_Syntax.term) (must_tot : Prims.bool) :
  FStarC_Syntax_Syntax.typ FStar_Pervasives_Native.option=
  let mk_tm_type u =
    FStarC_Syntax_Syntax.mk (FStarC_Syntax_Syntax.Tm_type u)
      t.FStarC_Syntax_Syntax.pos in
  ...
  | FStarC_Syntax_Syntax.Tm_abs
      ...
      let mk_comp =
        let uu___1 =
          FStarC_Ident.lid_equals eff FStarC_Parser_Const.effect_Tot_lid in
        if uu___1
        then FStar_Pervasives_Native.Some FStarC_Syntax_Syntax.mk_Total
        else
          (let uu___3 =
             FStarC_Ident.lid_equals eff FStarC_Parser_Const.effect_GTot_lid in
           if uu___3
           then FStar_Pervasives_Native.Some FStarC_Syntax_Syntax.mk_GTotal
           else FStar_Pervasives_Native.None) in
      FStarC_Option.bind mk_comp
        (fun f ->
           let tbody1 =
             match tbody with
                 ...
                 (match uu___1 with
                  | (bs1, body1) ->
                      let uu___2 =
                        ...
                        __typeof_tot_or_gtot_term_fastpath uu___3 body1 false in
                      FStarC_Option.map (FStarC_Syntax_Subst.close bs1)
                        uu___2) in
           FStarC_Option.bind tbody1
             (fun tbody2 ->
  ...
  | FStarC_Syntax_Syntax.Tm_refine
      ...
      __typeof_tot_or_gtot_term_fastpath env x.FStarC_Syntax_Syntax.sort
        must_tot
  | FStarC_Syntax_Syntax.Tm_app
      {
        FStarC_Syntax_Syntax.hd =
                  ...
                  (effect_ok t2) ||
                    (FStarC_List.for_all
                       (fun uu___2 ->
                          ...
                          | (a, uu___3) ->
                              let uu___4 =
                                __typeof_tot_or_gtot_term_fastpath env a
                                  must_tot in
                              FStar_Pervasives_Native.uu___is_Some uu___4)
                       args) in
                if uu___1
  ...
  | FStarC_Syntax_Syntax.Tm_ascribed
      { FStarC_Syntax_Syntax.tm = t2;
        FStarC_Syntax_Syntax.asc = (FStar_Pervasives.Inl k, uu___, uu___1);
        FStarC_Syntax_Syntax.eff_opt = uu___2;_}
      ->
  ...
  | FStarC_Syntax_Syntax.Tm_ascribed
      { FStarC_Syntax_Syntax.tm = uu___;
        FStarC_Syntax_Syntax.asc = (FStar_Pervasives.Inr c, uu___1, uu___2);
        FStarC_Syntax_Syntax.eff_opt = uu___3;_}
      ->
      ...
      let uu___4 =
        ((Prims.op_Negation must_tot) ||
           (let uu___5 =
              let uu___6 = FStarC_Syntax_Util.comp_effect_name c in
  ...
  | FStarC_Syntax_Syntax.Tm_let
      ...
      ->
      let x =
        FStar_Pervasives.__proj__Inl__item__v lb.FStarC_Syntax_Syntax.lbname in
      let uu___ =
        let uu___1 =
      ...
      (match uu___ with
       | (xb, body1) ->
           ...
           let t2 = __typeof_tot_or_gtot_term_fastpath env_x body1 must_tot in
           FStarC_Option.bind t2
             (fun t3 ->
  ...
  | uu___ ->
      let uu___1 =
        ...
        Prims.strcat "Impossible! (" uu___2 in
      failwith uu___1
let typeof_tot_or_gtot_term_fastpath (env : FStarC_TypeChecker_Env.env)
  (t : FStarC_Syntax_Syntax.term) (must_tot : Prims.bool) :
  FStarC_Syntax_Syntax.typ FStar_Pervasives_Native.option=
  FStarC_Errors.with_ctx "In a call to typeof_tot_or_gtot_term_fastpath"
    (fun uu___ ->
       FStarC_Defensive.def_check_scoped
         FStarC_TypeChecker_Env.hasBinders_env
         FStarC_Class_Binders.hasNames_term FStarC_Syntax_Print.pretty_term
...
let rec effectof_tot_or_gtot_term_fastpath (env : FStarC_TypeChecker_Env.env)
  (t : FStarC_Syntax_Syntax.term) :
  ...
  | FStarC_Syntax_Syntax.Tm_ascribed
      ...
      ->
      let c_eff =
        let uu___5 = FStarC_Syntax_Util.comp_effect_name c in
        FStarC_TypeChecker_Env.norm_eff_name env uu___5 in
      let uu___5 =
        (FStarC_Ident.lid_equals c_eff FStarC_Parser_Const.effect_PURE_lid)
          ||
          (FStarC_Ident.lid_equals c_eff FStarC_Parser_Const.effect_GHOST_lid) in
      if uu___5
