...
let rec term_eq_dbg (dbg : Prims.bool) (t1 : FStarC_Syntax_Syntax.term)
  ...
  let uu___ =
    let uu___1 =
      let uu___2 =
        let uu___3 = un_uinst t11 in FStarC_Syntax_Subst.compress uu___3 in
      uu___2.FStarC_Syntax_Syntax.n in
    let uu___2 =
      let uu___3 =
        let uu___4 = un_uinst t21 in FStarC_Syntax_Subst.compress uu___4 in
      uu___3.FStarC_Syntax_Syntax.n in
    (uu___1, uu___2) in
  match uu___ with
  ...
  | (FStarC_Syntax_Syntax.Tm_fvar x, FStarC_Syntax_Syntax.Tm_fvar y) ->
      let uu___1 = FStarC_Syntax_Syntax.fv_eq x y in check1 "fvar" uu___1
  | (FStarC_Syntax_Syntax.Tm_constant c1, FStarC_Syntax_Syntax.Tm_constant
     c2) -> let uu___1 = FStarC_Const.eq_const c1 c2 in check1 "const" uu___1
     ...
     { FStarC_Syntax_Syntax.bs = b2; FStarC_Syntax_Syntax.body = t22;
      ...
      (let uu___1 = eqlist (binder_eq_dbg dbg) b1 b2 in
       check1 "abs binders" uu___1) &&
        (let uu___1 = term_eq_dbg dbg t12 t22 in check1 "abs bodies" uu___1)
  | (FStarC_Syntax_Syntax.Tm_arrow
     ...
     { FStarC_Syntax_Syntax.bs1 = b2; FStarC_Syntax_Syntax.comp = c2;_}) ->
      (let uu___1 = eqlist (binder_eq_dbg dbg) b1 b2 in
       check1 "arrow binders" uu___1) &&
        (let uu___1 = comp_eq_dbg dbg c1 c2 in check1 "arrow comp" uu___1)
  | (FStarC_Syntax_Syntax.Tm_refine
  ...
  | (FStarC_Syntax_Syntax.Tm_match
     ...
     { FStarC_Syntax_Syntax.scrutinee = t22;
      ...
      ->
      (let uu___3 = term_eq_dbg dbg t12 t22 in check1 "match head" uu___3) &&
        (let uu___3 = eqlist (branch_eq_dbg dbg) bs1 bs2 in
         check1 "match branches" uu___3)
  | (FStarC_Syntax_Syntax.Tm_lazy uu___1, uu___2) ->
      let uu___3 = let uu___4 = unlazy t11 in term_eq_dbg dbg uu___4 t21 in
      check1 "lazy_l" uu___3
  | (uu___1, FStarC_Syntax_Syntax.Tm_lazy uu___2) ->
      let uu___3 = let uu___4 = unlazy t21 in term_eq_dbg dbg t11 uu___4 in
  ...
  | (FStarC_Syntax_Syntax.Tm_let
     ...
     { FStarC_Syntax_Syntax.lbs = (b2, lbs2);
      ...
      ((check1 "let flag" (b1 = b2)) &&
        ...
        && (let uu___1 = term_eq_dbg dbg t12 t22 in check1 "let body" uu___1)
  | (FStarC_Syntax_Syntax.Tm_uvar (u1, uu___1), FStarC_Syntax_Syntax.Tm_uvar
     (u2, uu___2)) ->
      check1 "uvar"
  ...
  | (FStarC_Syntax_Syntax.Tm_meta
     { FStarC_Syntax_Syntax.tm2 = t12; FStarC_Syntax_Syntax.meta = m1;_},
     FStarC_Syntax_Syntax.Tm_meta
     { FStarC_Syntax_Syntax.tm2 = t22; FStarC_Syntax_Syntax.meta = m2;_}) ->
      (match (m1, m2) with
...
let destruct_lemma_with_smt_patterns (t : FStarC_Syntax_Syntax.term) :
  ...
  match uu___ with
  | FStarC_Syntax_Syntax.Tm_arrow
      { FStarC_Syntax_Syntax.bs1 = binders; FStarC_Syntax_Syntax.comp = c;_}
      ->
