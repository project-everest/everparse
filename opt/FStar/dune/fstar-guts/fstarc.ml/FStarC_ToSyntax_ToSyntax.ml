...
let register_extension_tosyntax (lang_name : Prims.string)
  (cb : extension_tosyntax_decl_t) : unit=
  FStarC_SMap.add extension_tosyntax_table lang_name cb
let lookup_extension_tosyntax (lang_name : Prims.string) :
  extension_tosyntax_decl_t FStar_Pervasives_Native.option=
  FStarC_SMap.try_find extension_tosyntax_table lang_name
let dbg_attrs : Prims.bool FStarC_Effect.ref= FStarC_Debug.get_toggle "attrs"
...
let tun_r (r : FStarC_Range_Type.t) : FStarC_Syntax_Syntax.term=
  {
...
type annotated_pat =
  (FStarC_Syntax_Syntax.pat * (FStarC_Syntax_Syntax.bv *
    ...
    Prims.list)
let mk_thunk (e : FStarC_Syntax_Syntax.term) : FStarC_Syntax_Syntax.term=
  let b =
    let uu___ =
...
let mk_binder_with_attrs (bv : FStarC_Syntax_Syntax.bv)
  (aq : FStarC_Syntax_Syntax.bqual)
...
let qualify_field_names (record_or_dc_lid : FStarC_Ident.lident)
  (field_names : FStarC_Ident.lident Prims.list) :
  FStarC_Ident.lident Prims.list=
    ...
    FStarC_List.fold_left
      (fun uu___1 l ->
         ...
         | (ns_opt, out) ->
             ...
             (match uu___2 with
              | "" ->
                  if FStar_Pervasives_Native.uu___is_Some ns_opt
                  then
                    let uu___3 =
                  ...
                  (match ns_opt with
                   | FStar_Pervasives_Native.Some ns' ->
                       ...
                       then
                         ...
                         (let uu___4 =
                            let uu___5 = qualify_to_record l in uu___5 :: out in
                          (ns_opt, uu___4))
  ...
  match uu___ with
  | (uu___1, field_names_rev) -> FStarC_List.rev field_names_rev
let desugar_disjunctive_pattern
  (annotated_pats :
    (FStarC_Syntax_Syntax.pat' FStarC_Syntax_Syntax.withinfo_t *
      (FStarC_Syntax_Syntax.bv * FStarC_Syntax_Syntax.term * 'uuuuu)
      Prims.list) Prims.list)
  (when_opt :
    FStarC_Syntax_Syntax.term' FStarC_Syntax_Syntax.syntax
      FStar_Pervasives_Native.option)
  (branch : FStarC_Syntax_Syntax.term) :
           ...
           let branch1 =
             FStarC_List.fold_left
               (fun br uu___1 ->
                  ...
                  | (bv, ty, uu___2) ->
                      let lb =
                        let uu___3 = FStarC_Syntax_Syntax.bv_to_name bv in
                      ...
                      let branch2 =
                        let uu___3 =
                          let uu___4 = FStarC_Syntax_Syntax.mk_binder bv in
                          [uu___4] in
                      ...
                      FStarC_Syntax_Syntax.mk
                        (FStarC_Syntax_Syntax.Tm_let
                           ...
                           }) br.FStarC_Syntax_Syntax.pos) branch annots in
           FStarC_Syntax_Util.branch (pat, when_opt, branch1)) annotated_pats
let trans_qual (r : FStarC_Range_Type.t)
  (maybe_effect_id : FStarC_Ident.lident FStar_Pervasives_Native.option)
  (uu___ : FStarC_Parser_AST.qualifier) : FStarC_Syntax_Syntax.qualifier=
  match uu___ with
  ...
  | FStarC_Parser_AST.Visible ->
      FStarC_Errors.raise_error FStarC_Class_HasRange.hasRange_range r
        ...
        (Obj.magic FStarC_Errors_Msg.is_error_message_string)
        (Obj.magic "Unsupported qualifier")
let as_imp (uu___ : FStarC_Parser_AST.imp) :
...
let arg_withimp_t (imp : FStarC_Parser_AST.imp) (t : 'uuuuu) :
  ('uuuuu * FStarC_Syntax_Syntax.arg_qualifier
    FStar_Pervasives_Native.option)=
  let uu___ = as_imp imp in (t, uu___)
let contains_binder (binders : FStarC_Parser_AST.binder Prims.list) :
  Prims.bool=
...
let tm_type (r : FStarC_Range_Type.range) : FStarC_Parser_AST.term=
  let uu___ =
    ...
    FStarC_Parser_AST.Name uu___1 in
  FStarC_Parser_AST.mk_term uu___ r FStarC_Parser_AST.Kind
let rec is_comp_type (env : FStarC_Syntax_DsEnv.env)
  (t : FStarC_Parser_AST.term) : Prims.bool=
...
let desugar_name'
  ...
  let tm_attrs_opt =
    ...
    else FStarC_Syntax_DsEnv.try_lookup_lid_with_attributes_no_resolve env l in
...
let desugar_name (mk : 'uuuuu)
  ...
  FStarC_Syntax_DsEnv.fail_or env (desugar_name' setpos env resolve) l
let compile_op_lid (n : Prims.int) (s : Prims.string)
  (r : FStarC_Range_Type.range) : FStarC_Ident.lident=
  let uu___ =
    let uu___1 =
      let uu___2 =
...
let op_as_term (env : env_t) (arity : Prims.int) (op : FStarC_Ident.ident) :
  FStarC_Syntax_Syntax.term FStar_Pervasives_Native.option=
  let r l =
    let uu___ =
      let uu___1 =
  ...
  | uu___1 -> fallback ()
let head_and_args (t : FStarC_Parser_AST.term) :
  ...
  let rec aux args t1 =
    ...
    | uu___1 -> (t1, args) in
  aux [] t
let rec uncurry (bs : FStarC_Parser_AST.binder Prims.list)
  (t : FStarC_Parser_AST.term) :
  (FStarC_Parser_AST.binder Prims.list * FStarC_Parser_AST.term)=
  match t.FStarC_Parser_AST.tm with
  | FStarC_Parser_AST.Product (binders, t1) ->
      uncurry (FStarC_List.op_At bs binders) t1
  | uu___ -> (bs, t)
let rec is_var_pattern (p : FStarC_Parser_AST.pattern) : Prims.bool=
  ...
  | uu___ -> false
let rec is_app_pattern (p : FStarC_Parser_AST.pattern) : Prims.bool=
  match p.FStarC_Parser_AST.pat with
  ...
  | FStarC_Parser_AST.PatApp
      ...
      -> true
  | uu___ -> false
let replace_unit_pattern (p : FStarC_Parser_AST.pattern) :
  ...
  | uu___ -> p
let rec destruct_app_pattern (env : env_t) (is_top_level : Prims.bool)
  ...
  | FStarC_Parser_AST.PatApp
      ({
         FStarC_Parser_AST.pat = FStarC_Parser_AST.PatVar (id, uu___, uu___1);
...
let rec gather_pattern_bound_vars_maybe_top
  (uu___1 : FStarC_Ident.ident FStarC_FlatSet.t)
  (uu___ : FStarC_Parser_AST.pattern) : FStarC_Ident.ident FStarC_FlatSet.t=
  (fun acc p ->
     let gather_pattern_bound_vars_from_list =
       FStarC_List.fold_left gather_pattern_bound_vars_maybe_top acc in
     match p.FStarC_Parser_AST.pat with
     ...
     | FStarC_Parser_AST.PatRest -> Obj.magic (Obj.repr acc)
     | FStarC_Parser_AST.PatOp uu___ -> Obj.magic (Obj.repr acc)
     | FStarC_Parser_AST.PatApp (phead, pats) ->
         Obj.magic
           (Obj.repr (gather_pattern_bound_vars_from_list (phead :: pats)))
              ...
              (FStarC_Class_Setlike.add ()
                 (Obj.magic
                    (FStarC_FlatSet.setlike_flat_set
                       FStarC_Syntax_Syntax.ord_ident)) x (Obj.magic acc)))
     | FStarC_Parser_AST.PatList pats ->
         Obj.magic (Obj.repr (gather_pattern_bound_vars_from_list pats))
     ...
     | FStarC_Parser_AST.PatRecord guarded_pats ->
         Obj.magic
           (Obj.repr
              (let uu___ =
                 FStarC_List.map FStar_Pervasives_Native.snd guarded_pats in
               gather_pattern_bound_vars_from_list uu___))
     | FStarC_Parser_AST.PatAscribed (pat, uu___) ->
         Obj.magic (Obj.repr (gather_pattern_bound_vars_maybe_top acc pat)))
    uu___1 uu___
let gather_pattern_bound_vars :
  FStarC_Parser_AST.pattern -> FStarC_Ident.ident FStarC_FlatSet.t=
  let acc =
    Obj.magic
...
type bnd =
  ...
  FStarC_Syntax_Syntax.term FStar_Pervasives_Native.option)) 
let uu___is_LocalBinder (projectee : bnd) : Prims.bool=
  match projectee with | LocalBinder _0 -> true | uu___ -> false
let __proj__LocalBinder__item___0 (projectee : bnd) :
  (FStarC_Syntax_Syntax.bv * FStarC_Syntax_Syntax.bqual *
    FStarC_Syntax_Syntax.term Prims.list)=
  match projectee with | LocalBinder _0 -> _0
let uu___is_LetBinder (projectee : bnd) : Prims.bool=
  match projectee with | LetBinder _0 -> true | uu___ -> false
let __proj__LetBinder__item___0 (projectee : bnd) :
  (FStarC_Ident.lident * (FStarC_Syntax_Syntax.term *
    FStarC_Syntax_Syntax.term FStar_Pervasives_Native.option))=
  match projectee with | LetBinder _0 -> _0
let is_implicit (b : bnd) : Prims.bool=
  match b with
  | LocalBinder
...
let mk_lb
  (uu___ :
    (FStarC_Syntax_Syntax.term' FStarC_Syntax_Syntax.syntax Prims.list *
      ...
      FStarC_Syntax_Syntax.syntax * FStarC_Range_Type.range))
...
let no_annot_abs (bs : FStarC_Syntax_Syntax.binders)
  (t : FStarC_Syntax_Syntax.term) : FStarC_Syntax_Syntax.term=
  FStarC_Syntax_Util.abs bs t FStar_Pervasives_Native.None
let rec generalize_annotated_univs (s : FStarC_Syntax_Syntax.sigelt) :
  ...
  let reg u =
    let uu___ =
      let uu___1 =
        let uu___2 = FStarC_Effect.op_Bang seen in
        FStarC_Class_Setlike.mem ()
          (Obj.magic
             (FStarC_RBSet.setlike_rbset FStarC_Syntax_Syntax.ord_ident)) u
          (Obj.magic uu___2) in
      Prims.op_Negation uu___1 in
    if uu___
    then
      ((let uu___2 =
          let uu___3 = FStarC_Effect.op_Bang seen in
          Obj.magic
            (FStarC_Class_Setlike.add ()
               (Obj.magic
                  (FStarC_RBSet.setlike_rbset FStarC_Syntax_Syntax.ord_ident))
               u (Obj.magic uu___3)) in
        FStarC_Effect.op_Colon_Equals seen uu___2);
       (let uu___2 = let uu___3 = FStarC_Effect.op_Bang vars in u :: uu___3 in
        FStarC_Effect.op_Colon_Equals vars uu___2))
    else () in
  let get uu___ =
    let uu___1 = FStarC_Effect.op_Bang vars in FStarC_List.rev uu___1 in
  let uu___ =
                     ...
                     let uu___6 =
                       let uu___7 =
                         ...
                         let uu___9 =
                           let uu___10 =
                             FStarC_Syntax_Subst.shift_subst
                               (FStarC_List.length bs) usubst in
                           FStarC_Syntax_Subst.subst uu___10 t in
                         {
                           ...
                           FStarC_Syntax_Syntax.mutuals = lids1;
                           FStarC_Syntax_Syntax.ds = lids2;
                           FStarC_Syntax_Syntax.injective_type_params = false
                         } in
  ...
  | FStarC_Syntax_Syntax.Sig_fail
      ...
      let uu___1 =
        let uu___2 =
          let uu___3 = FStarC_List.map generalize_annotated_univs ses in
          {
      ...
      let uu___1 =
        let uu___2 =
              ...
              ed.FStarC_Syntax_Syntax.signature in
          {
            ...
            FStarC_Syntax_Syntax.actions = (ed.FStarC_Syntax_Syntax.actions);
...
let is_special_effect_combinator (uu___ : Prims.string) : Prims.bool=
  match uu___ with
  | "lift1" -> true
  | "lift2" -> true
  | "pure" -> true
  ...
  | "wp" -> true
  | uu___1 -> false
let rec sum_to_universe (u : FStarC_Syntax_Syntax.universe) (n : Prims.int) :
...
let rec desugar_maybe_non_constant_universe (t : FStarC_Parser_AST.term) :
              ...
              (let nargs =
                 FStarC_List.map
                   (fun uu___6 ->
                      ...
                      | FStar_Pervasives.Inr uu___7 -> failwith "impossible")
                   univargs in
               let uu___6 =
  ...
  | uu___1 ->
      ...
      FStarC_Errors.raise_error FStarC_Parser_AST.hasRange_term t
        ...
        (Obj.magic FStarC_Errors_Msg.is_error_message_string)
        (Obj.magic uu___2)
let desugar_universe (t : FStarC_Parser_AST.term) :
  FStarC_Syntax_Syntax.universe=
  ...
  | (bv,
     {
      ...
      let uu___5 =
        ...
        FStarC_Format.fmt1 "Unexpected antiquotation: `@(%s)" uu___6 in
      FStarC_Errors.raise_error (FStarC_Syntax_Syntax.has_range_syntax ()) e
        FStarC_Errors_Codes.Fatal_UnexpectedAntiquotation ()
        (Obj.magic FStarC_Errors_Msg.is_error_message_string)
        (Obj.magic uu___5)
  | (bv, e)::uu___ ->
      let uu___1 =
        let uu___2 =
          FStarC_Class_Show.show FStarC_Syntax_Print.showable_term e in
        FStarC_Format.fmt1 "Unexpected antiquotation: `#(%s)" uu___2 in
      FStarC_Errors.raise_error (FStarC_Syntax_Syntax.has_range_syntax ()) e
        FStarC_Errors_Codes.Fatal_UnexpectedAntiquotation ()
        (Obj.magic FStarC_Errors_Msg.is_error_message_string)
        (Obj.magic uu___1)
       ...
       | FStarC_Syntax_Syntax.Pat_var x ->
           Obj.magic
             (Obj.repr
                (let uu___ =
                   let uu___1 =
                     FStarC_Ident.string_of_id x.FStarC_Syntax_Syntax.ppname in
           ...
           Obj.magic
             (Obj.repr
                (let aux uu___3 uu___2 =
                 ...
                 FStarC_List.fold_left aux uu___2 pats1))) uu___ in
  match pats with
  | [] -> ()
      ...
      let aux p1 =
        let uu___ =
          ...
          FStarC_Class_Setlike.equal ()
            (Obj.magic
               (FStarC_RBSet.setlike_rbset FStarC_Syntax_Syntax.ord_bv))
            (Obj.magic pvars) (Obj.magic uu___1) in
        if uu___
        then ()
        else
                ...
                let uu___3 =
                  Obj.magic
                    (FStarC_Class_Setlike.diff ()
                       (Obj.magic
                          (FStarC_RBSet.setlike_rbset
                             FStarC_Syntax_Syntax.ord_bv)) (Obj.magic s2)
                       (Obj.magic s1)) in
                Obj.magic
                  (FStarC_Class_Setlike.union ()
                     (Obj.magic
...
let smt_pat_or_lid (r : FStarC_Range_Type.t) : FStarC_Ident.lident=
  FStarC_Ident.set_lid_range FStarC_Parser_Const.smtpatOr_lid r
let rec hoist_pat_ascription' (pat : FStarC_Parser_AST.pattern) :
  ...
  let handle_list type_lid pat_cons pats =
    let uu___ =
      let uu___1 = FStarC_List.map hoist_pat_ascription' pats in
      FStarC_List.unzip uu___1 in
    match uu___ with
    | (pats1, terms) ->
        let uu___1 =
          FStarC_List.for_all FStar_Pervasives_Native.uu___is_None terms in
        if uu___1
  ...
  | FStarC_Parser_AST.PatAscribed (pat1, (typ, FStar_Pervasives_Native.None))
      -> (pat1, (FStar_Pervasives_Native.Some typ))
  | uu___ -> (pat, FStar_Pervasives_Native.None)
let rest_pat_for_lid (env : env_t) (l : FStarC_Ident.lid) :
  FStarC_Parser_AST.pattern Prims.list=
  let uu___ =
    FStarC_Syntax_DsEnv.fail_or env
      (FStarC_Syntax_DsEnv.try_lookup_datacon env) l in
  match uu___ with
  | (l1, se) ->
      (match se.FStarC_Syntax_Syntax.sigel with
       | FStarC_Syntax_Syntax.Sig_datacon
           ...
           ->
           let uu___7 = FStarC_Syntax_Util.arrow_formals t in
           (match uu___7 with
            | (bs, uu___8) ->
                let uu___9 = FStarC_List.splitAt num_ty_params bs in
                (match uu___9 with
                 | (uu___10, bs1) ->
                     FStarC_List.map
                       (fun b ->
                          let q =
                            ...
                            | FStar_Pervasives_Native.Some
                                (FStarC_Syntax_Syntax.Implicit uu___11) ->
                                FStar_Pervasives_Native.Some
                                  FStarC_Parser_AST.Implicit
                            | uu___11 -> FStar_Pervasives_Native.None in
                          let uu___11 =
                            FStarC_Class_HasRange.pos
                              FStarC_Syntax_Syntax.hasRange_fv l1 in
                          FStarC_Parser_AST.mk_pattern
                            (FStarC_Parser_AST.PatWild (q, [])) uu___11) bs1))
       | uu___1 ->
           failwith "unexpected: try_lookup_datacon returned odd sigelt")
let hoist_pat_ascription (pat : FStarC_Parser_AST.pattern) :
  FStarC_Parser_AST.pattern=
...
let rec desugar_data_pat (top_level_ascr_allowed : Prims.bool) (env : env_t)
  (p : FStarC_Parser_AST.pattern) :
    ...
    let uu___ =
      FStarC_Option.find
        (fun y ->
           ...
           let uu___2 = FStarC_Ident.string_of_id x in uu___1 = uu___2) l in
    match uu___ with
  ...
  let rec aux' top loc aqs env1 p1 =
    let pos q = FStarC_Syntax_Syntax.withinfo q p1.FStarC_Parser_AST.prange in
    ...
    | FStarC_Parser_AST.PatOp op ->
        let id_op =
          let uu___ =
            ...
            let uu___2 = FStarC_Ident.range_of_id op in (uu___1, uu___2) in
    ...
    | FStarC_Parser_AST.PatAscribed (p2, (t, tacopt)) ->
        ((match tacopt with
          ...
          | FStar_Pervasives_Native.Some uu___1 ->
              FStarC_Errors.raise_error FStarC_Parser_AST.hasRange_pattern
                orig
          ...
          | (loc1, aqs1, env', binder, p3, annots) ->
              let uu___2 =
                ...
                | LocalBinder (x, aq, attrs) ->
                    let uu___3 =
                      let uu___4 =
                        FStarC_ToSyntax_TickedVars.close_fun env1 t in
                    ...
                    (match uu___3 with
                     | (t1, aqs') ->
                         ...
                         ([(x1, t1, attrs)], (LocalBinder (x1, aq, attrs)),
                           (FStarC_List.op_At aqs' aqs1))) in
              (match uu___2 with
               | (annots', binder1, aqs2) ->
                   ((match p3.FStarC_Syntax_Syntax.v with
                    ...
                    (loc1, aqs2, env', binder1, p3,
                      (FStarC_List.op_At annots' annots))))))
    ...
    | FStarC_Parser_AST.PatConst c ->
        ...
        (loc, aqs, env1, (LocalBinder (x, FStar_Pervasives_Native.None, [])),
          uu___, [])
    | FStarC_Parser_AST.PatVQuote e ->
        let pat =
          let uu___ =
            let uu___1 =
              let uu___2 = desugar_vquote env1 e p1.FStarC_Parser_AST.prange in
    ...
    | FStarC_Parser_AST.PatVar (x, aq, attrs) ->
        ...
        (match uu___ with
         | (loc1, env2, xbv) ->
             ...
             (loc1, aqs, env2, (LocalBinder (xbv, aq1, attrs1)), uu___1, []))
    ...
    | FStarC_Parser_AST.PatApp
        ({ FStarC_Parser_AST.pat = FStarC_Parser_AST.PatName l;
         ...
         { FStarC_Parser_AST.pat = FStarC_Parser_AST.PatRest;
           FStarC_Parser_AST.prange = uu___1;_}::[])
        ->
        let uu___2 = p1.FStarC_Parser_AST.pat in
        (match uu___2 with
         | FStarC_Parser_AST.PatApp (hd, uu___3) ->
             let argpats = rest_pat_for_lid env1 l in
             let newpat =
               FStarC_Parser_AST.mk_pattern
                 (FStarC_Parser_AST.PatApp (hd, argpats))
                 p1.FStarC_Parser_AST.prange in
             aux' top loc aqs env1 newpat)
    | FStarC_Parser_AST.PatRest ->
        let uu___ =
          let uu___1 = FStarC_Errors_Msg.text "Unexpected pattern." in
          let uu___2 =
            let uu___3 =
              FStarC_Errors_Msg.text
                "Using `..` is only allowed as argument to a data constructor, e.g. `C ..`." in
            [uu___3] in
          uu___1 :: uu___2 in
               ...
               | (loc1, aqs1, env2, annots, args1) ->
                   ...
                   (match uu___3 with
                    | (loc2, aqs2, env3, b, arg1, ans) ->
                        ...
                        (loc2, aqs2, env3, (FStarC_List.op_At ans annots),
                          ((arg1, imp) :: args1)))) args
            (loc, aqs, env1, [], []) in
        (match uu___1 with
         | (loc1, aqs1, env2, annots, args1) ->
             ...
             (match uu___2 with
              | (l1, uu___3) ->
                  let x =
                    let uu___4 = tun_r p1.FStarC_Parser_AST.prange in
                    FStarC_Syntax_Syntax.new_bv
                      (FStar_Pervasives_Native.Some
                         (p1.FStarC_Parser_AST.prange)) uu___4 in
                  let uu___4 =
                    pos
                      (FStarC_Syntax_Syntax.Pat_cons
               ...
               | (loc1, aqs1, env2, annots, pats1) ->
                   ...
                   (match uu___2 with
                    | (loc2, aqs2, env3, uu___3, pat1, ans) ->
                        (loc2, aqs2, env3, (FStarC_List.op_At ans annots),
                          (pat1 :: pats1)))) pats (loc, aqs, env1, [], []) in
        (match uu___ with
         | (loc1, aqs1, env2, annots, pats1) ->
             let pat =
               let uu___1 =
                 let uu___2 =
                   FStarC_Range_Ops.end_range p1.FStarC_Parser_AST.prange in
                 let uu___3 =
                   let uu___4 =
                     let uu___5 =
               ...
               FStarC_List.fold_right
                 (fun hd tl ->
                    let r =
                      FStarC_Range_Ops.union_ranges hd.FStarC_Syntax_Syntax.p
               ...
               | (loc1, aqs1, env2, annots, pats) ->
                   ...
                   (match uu___2 with
                    | (loc2, aqs2, env3, uu___3, pat, ans) ->
                        (loc2, aqs2, env3, (FStarC_List.op_At ans annots),
                          ((pat, false) :: pats)))) (loc, aqs, env1, [], [])
            args in
        (match uu___ with
         | (loc1, aqs1, env2, annots, args1) ->
             let args2 = FStarC_List.rev args1 in
             let l =
               if dep
               then
                 FStarC_Parser_Const_Tuples.mk_dtuple_data_lid
                   (FStarC_List.length args2) p1.FStarC_Parser_AST.prange
               else
                 FStarC_Parser_Const_Tuples.mk_tuple_data_lid
                   (FStarC_List.length args2) p1.FStarC_Parser_AST.prange in
             let constr =
               FStarC_Syntax_DsEnv.fail_or env2
    ...
    | FStarC_Parser_AST.PatRecord fields ->
        let uu___ = FStarC_List.unzip fields in
        (match uu___ with
         | (field_names, pats) ->
             let uu___1 =
               match fields with
               ...
               | (f, uu___2)::uu___3 ->
                   let uu___4 =
                     FStarC_Syntax_DsEnv.try_lookup_record_by_field_name env1
                       f in
                   (match uu___4 with
                    | FStar_Pervasives_Native.None ->
                        (FStar_Pervasives_Native.None, field_names)
                    | FStar_Pervasives_Native.Some r ->
                        let uu___5 =
                          qualify_field_names r.FStarC_Syntax_DsEnv.typename
                            field_names in
                        ((FStar_Pervasives_Native.Some
                         ...
                         (FStarC_Syntax_Syntax.Unresolved_constructor
                            {
                              ...
                              FStarC_Syntax_Syntax.uc_typename = typename;
                              FStarC_Syntax_Syntax.uc_fields = field_names1
                            })) in
                  let uu___2 =
                    FStarC_List.fold_left
                      (fun uu___3 p2 ->
                         ...
                         | (loc1, aqs1, env2, annots, pats1) ->
                             ...
                             (match uu___4 with
                              | (loc2, aqs2, env3, uu___5, pat, ann) ->
                                  (loc2, aqs2, env3,
                                    (FStarC_List.op_At ann annots),
                                    ((pat, false) :: pats1))))
                      (loc, aqs, env1, [], []) pats in
                  (match uu___2 with
                   | (loc1, aqs1, env2, annots, pats1) ->
                       let pats2 = FStarC_List.rev pats1 in
                       let pat =
                         pos
                           (FStarC_Syntax_Syntax.Pat_cons
    ...
    | FStarC_Parser_AST.PatOr (p2::ps) ->
        ...
        (match uu___ with
         | (loc1, aqs, env2, var, p3, ans) ->
             ...
             (match uu___1 with
              | (loc2, aqs1, env3, ps1) ->
                  let pats = (p3, ans) :: (FStarC_List.rev ps1) in
                  ((env3, var, pats), aqs1)))
    | uu___ ->
  ...
  match uu___ with
  | ((env1, b, pats), aqs) ->
      ((let uu___2 = FStarC_List.map FStar_Pervasives_Native.fst pats in
        check_linear_pattern_variables uu___2 p.FStarC_Parser_AST.prange);
       ((env1, b, pats), aqs))
and desugar_binding_pat_maybe_top (top : Prims.bool)
  (env : FStarC_Syntax_DsEnv.env) (p : FStarC_Parser_AST.pattern) :
  ((env_t * bnd * annotated_pat Prims.list) * antiquotations_temp)=
  if top
  then
    ...
    | FStarC_Parser_AST.PatAscribed
        ({ FStarC_Parser_AST.pat = FStarC_Parser_AST.PatOp x;
         ...
         (t, tacopt))
        ->
        let tacopt1 = FStarC_Option.map (desugar_term env) tacopt in
...
and desugar_match_pat_maybe_top (uu___ : Prims.bool) (env : env_t)
  (pat : FStarC_Parser_AST.pattern) :
  ((env_t * annotated_pat Prims.list) * antiquotations_temp)=
  let uu___1 = desugar_data_pat false env pat in
  match uu___1 with | ((env1, uu___2, pat1), aqs) -> ((env1, pat1), aqs)
and desugar_match_pat (env : env_t) (p : FStarC_Parser_AST.pattern) :
  ((env_t * annotated_pat Prims.list) * antiquotations_temp)=
  desugar_match_pat_maybe_top false env p
and desugar_term_aq (env : env_t) (e : FStarC_Parser_AST.term) :
  (FStarC_Syntax_Syntax.term * antiquotations_temp)=
  let env1 = FStarC_Syntax_DsEnv.set_expect_typ env false in
  desugar_term_maybe_top false env1 e
and desugar_term (env : FStarC_Syntax_DsEnv.env) (e : FStarC_Parser_AST.term)
  : FStarC_Syntax_Syntax.term=
  let uu___ = desugar_term_aq env e in
  match uu___ with | (t, aq) -> (check_no_aq aq; t)
and desugar_typ_aq (env : FStarC_Syntax_DsEnv.env)
  (e : FStarC_Parser_AST.term) :
  (FStarC_Syntax_Syntax.term * antiquotations_temp)=
  let env1 = FStarC_Syntax_DsEnv.set_expect_typ env true in
  desugar_term_maybe_top false env1 e
and desugar_typ (env : FStarC_Syntax_DsEnv.env) (e : FStarC_Parser_AST.term)
  : FStarC_Syntax_Syntax.term=
...
and desugar_machine_integer (env : FStarC_Syntax_DsEnv.env)
  ...
  | (signedness, width) ->
      ...
      ((let uu___2 =
        ...
        then
          let uu___3 =
            FStarC_Format.fmt2 "%s is not in the expected range for %s" repr
              tnm in
       ...
       (let private_intro_nm =
        ...
        let lid1 =
          ...
          | FStar_Pervasives_Native.Some intro_term ->
              (match intro_term.FStarC_Syntax_Syntax.n with
               | FStarC_Syntax_Syntax.Tm_fvar fv ->
                   let private_lid =
                     let uu___3 = FStarC_Ident.path_of_text private_intro_nm in
                     FStarC_Ident.lid_of_path uu___3 range in
                   let private_fv =
                     FStarC_Syntax_Syntax.lid_and_dd_as_fv private_lid
          ...
          | FStar_Pervasives_Native.None ->
              let uu___3 =
                FStarC_Format.fmt1
                  "Unexpected numeric literal.  Restart F* to load %s." tnm in
              FStarC_Errors.raise_error FStarC_Class_HasRange.hasRange_range
                range FStarC_Errors_Codes.Fatal_UnexpectedNumericLiteral ()
                (Obj.magic FStarC_Errors_Msg.is_error_message_string)
                (Obj.magic uu___3) in
        let repr' =
          FStarC_Syntax_Syntax.mk
        ...
        let app =
          let uu___2 =
            let uu___3 =
              let uu___4 =
                let uu___5 =
                  let uu___6 = FStarC_Syntax_Syntax.as_aqual_implicit false in
                  (repr', uu___6) in
                [uu___5] in
              {
          ...
          (FStarC_Syntax_Syntax.Tm_meta
             {
               ...
               FStarC_Syntax_Syntax.meta =
                 (FStarC_Syntax_Syntax.Meta_desugared
                    (FStarC_Syntax_Syntax.Machine_integer (signedness, width)))
             }) range))
and desugar_term_maybe_top (top_level : Prims.bool) (env : env_t)
  (top : FStarC_Parser_AST.term) :
  (FStarC_Syntax_Syntax.term * antiquotations_temp)=
  let mk e = FStarC_Syntax_Syntax.mk e top.FStarC_Parser_AST.range in
  let noaqs = [] in
  let join_aqs aqs = FStarC_List.flatten aqs in
  let setpos e =
    {
      ...
      FStarC_Syntax_Syntax.hash_code = (e.FStarC_Syntax_Syntax.hash_code)
    } in
      ...
      FStarC_List.fold_left
        (fun uu___1 b ->
           ...
           | (env2, bs) ->
               ...
               let uu___2 = as_binder env2 b.FStarC_Parser_AST.aqual bb in
               (match uu___2 with | (b1, env3) -> (env3, (b1 :: bs))))
        (env1, []) binders in
    match uu___ with | (env2, bs_rev) -> (env2, (FStarC_List.rev bs_rev)) in
  let unqual_bv_of_binder b =
    ...
    | uu___ ->
        FStarC_Errors.raise_error FStarC_Syntax_Syntax.hasRange_binder b
          FStarC_Errors_Codes.Fatal_UnexpectedTerm ()
          (Obj.magic FStarC_Errors_Msg.is_error_message_string)
          (Obj.magic "Unexpected qualified binder in ELIM_EXISTS") in
  (let uu___1 = FStarC_Effect.op_Bang dbg_ToSyntax in
   if uu___1
   then
     let uu___2 = FStarC_Class_Show.show FStarC_Parser_AST.showable_term top in
  ...
  (let uu___1 = let uu___2 = unparen top in uu___2.FStarC_Parser_AST.tm in
   ...
   | FStarC_Parser_AST.Requires t ->
       let uu___2 = desugar_formula env t in (uu___2, noaqs)
   | FStarC_Parser_AST.Ensures t ->
       let uu___2 = desugar_formula env t in (uu___2, noaqs)
   ...
   | FStarC_Parser_AST.Op (id, args) when
       ...
       let e =
         let uu___2 =
           let uu___3 =
             let uu___4 = FStarC_Ident.mk_ident ("==", r) in (uu___4, args) in
       ...
       let uu___2 =
         let uu___3 =
           let uu___4 =
             let uu___5 = FStarC_Ident.mk_ident ("~", r) in (uu___5, [e]) in
   ...
   | FStarC_Parser_AST.Op (op_star, lhs::rhs::[]) when
       ...
       let t =
         let uu___2 =
           let uu___3 =
             let uu___4 =
               FStarC_List.map (fun uu___5 -> FStar_Pervasives.Inr uu___5)
                 terms in
             (uu___4, rhs) in
   ...
   | FStarC_Parser_AST.Op (s, args) ->
       let uu___2 = op_as_term env (FStarC_List.length args) s in
       (match uu___2 with
        | FStar_Pervasives_Native.None ->
            let uu___3 =
                ...
                let uu___4 =
                  FStarC_List.map
                    (fun t ->
                       ...
                       match uu___5 with
                       | (t', s1) -> ((t', FStar_Pervasives_Native.None), s1))
                    args in
       ...
       let uu___3 =
         let uu___4 =
           let uu___5 =
             let uu___6 =
               let uu___7 =
                 let uu___8 = smt_pat_or_lid top.FStarC_Parser_AST.range in
                 FStarC_Parser_AST.Var uu___8 in
               {
                 FStarC_Parser_AST.tm = uu___7;
                 FStarC_Parser_AST.range = (top.FStarC_Parser_AST.range);
   ...
   | FStarC_Parser_AST.Name lid when
       ...
       let uu___2 =
         mk (FStarC_Syntax_Syntax.Tm_type FStarC_Syntax_Syntax.U_unknown) in
       (uu___2, noaqs)
   | FStarC_Parser_AST.Construct (lid, (t, FStarC_Parser_AST.UnivApp)::[])
       when let uu___2 = FStarC_Ident.string_of_lid lid in uu___2 = "Type" ->
       let uu___2 =
         let uu___3 =
   ...
   | FStarC_Parser_AST.Name lid when
       ...
       let uu___2 =
         mk (FStarC_Syntax_Syntax.Tm_constant FStarC_Const.Const_effect) in
       (uu___2, noaqs)
   | FStarC_Parser_AST.Name lid when
   ...
   | FStarC_Parser_AST.Projector (eff_name, id) when
       ...
       let uu___2 = FStarC_Syntax_DsEnv.try_lookup_effect_defn env eff_name in
       (match uu___2 with
   ...
   | FStarC_Parser_AST.Var l ->
       let uu___2 = desugar_name mk setpos env true l in (uu___2, noaqs)
   | FStarC_Parser_AST.Name l ->
       let uu___2 = desugar_name mk setpos env true l in (uu___2, noaqs)
       ...
       (match name with
        ...
        | uu___2 ->
            let uu___3 =
              ...
              FStarC_Format.fmt1 "Data constructor or effect %s not found"
                uu___4 in
            FStarC_Errors.raise_error FStarC_Parser_AST.hasRange_term top
       ...
       (match uu___2 with
        | FStar_Pervasives_Native.None ->
            let uu___3 =
              ...
              FStarC_Format.fmt1 "Data constructor %s not found" uu___4 in
            FStarC_Errors.raise_error FStarC_Parser_AST.hasRange_term top
              FStarC_Errors_Codes.Fatal_DataContructorNotFound ()
              (Obj.magic FStarC_Errors_Msg.is_error_message_string)
              (Obj.magic uu___3)
        | uu___3 ->
   ...
   | FStarC_Parser_AST.Construct (l, args) ->
       let uu___2 = FStarC_Syntax_DsEnv.try_lookup_datacon env l in
       (match uu___2 with
        | FStar_Pervasives_Native.Some (head, uu___3) ->
             ...
             | uu___4 ->
                 let uu___5 =
                   FStarC_Util.take
                     (fun uu___6 ->
                        match uu___6 with
                        | (uu___7, imp) -> imp = FStarC_Parser_AST.UnivApp)
                     args in
                 (match uu___5 with
                  | (universes, args1) ->
                      let universes1 =
                        FStarC_List.map
                          (fun x ->
                             desugar_universe (FStar_Pervasives_Native.fst x))
                          universes in
                      let uu___6 =
                        let uu___7 =
                          FStarC_List.map
                            (fun uu___8 ->
                               match uu___8 with
                               | (t, imp) ->
                                   let uu___9 = desugar_term_aq env t in
                                   (match uu___9 with
                                    | (te, aq) ->
                                        let uu___10 = arg_withimp_t imp te in
                                        (uu___10, aq))) args1 in
                      ...
                      (match uu___6 with
                       | (args2, aqs) ->
                             ...
                             then head1
                               ...
                               mk
                                 (FStarC_Syntax_Syntax.Tm_uinst
                                    (head1, universes1)) in
                           let tm =
                             if (FStarC_List.length args2) = Prims.int_zero
                             then head2
                             else
                               mk
                                 (FStarC_Syntax_Syntax.Tm_app
                           ...
                           (tm, (join_aqs aqs)))))
        | FStar_Pervasives_Native.None ->
            let uu___3 = FStarC_Syntax_DsEnv.try_lookup_effect_name env l in
            (match uu___3 with
             | FStar_Pervasives_Native.None ->
                 let uu___4 =
                   let uu___5 =
                 ...
                 FStarC_Errors.raise_error FStarC_Ident.hasrange_lident l
                   FStarC_Errors_Codes.Fatal_ConstructorNotFound ()
                   (Obj.magic FStarC_Errors_Msg.is_error_message_string)
                   (Obj.magic uu___4)
             | FStar_Pervasives_Native.Some uu___4 ->
                 let uu___5 =
                   let uu___6 =
                     ...
                     Prims.strcat uu___7 " used at an unexpected position" in
            ...
            let tup =
              let uu___3 =
                FStarC_Parser_Const_Tuples.mk_tuple_lid
                  (FStarC_List.length targs) top.FStarC_Parser_AST.range in
              FStarC_Syntax_DsEnv.fail_or env
       ...
       let uu___2 =
         let uu___3 =
           let uu___4 =
             let uu___5 =
               let uu___6 =
                 FStarC_Parser_AST.mk_binder (FStarC_Parser_AST.NoName t)
                   t.FStarC_Parser_AST.range FStarC_Parser_AST.Type_level
                   FStar_Pervasives_Native.None in
               FStar_Pervasives.Inl uu___6 in
             [uu___5] in
           FStarC_List.op_At binders uu___4 in
         FStarC_List.fold_left
           (fun uu___4 b ->
              match uu___4 with
              | (env1, tparams, typs) ->
                        ...
                        | (env2, x) ->
                            let uu___7 =
                              let uu___8 =
                                ...
                                [uu___9] in
                              FStarC_List.op_At tparams uu___8 in
                            let uu___8 =
                              let uu___9 =
                                let uu___10 =
                                  let uu___11 = no_annot_abs tparams t1 in
                                  FStarC_Syntax_Syntax.as_arg uu___11 in
                                [uu___10] in
                              FStarC_List.op_At typs uu___9 in
                            (env2, uu___7, uu___8)))) (env, [], []) uu___3 in
       (match uu___2 with
        | (env1, uu___3, targs) ->
            let tup =
              let uu___4 =
       ...
       (match uu___2 with
        | (bs, t1) ->
            let rec aux env1 aqs bs1 uu___3 =
              ...
              | [] ->
                  let cod =
                    desugar_comp top.FStarC_Parser_AST.range true env1 t1 in
                  let uu___4 =
                    let uu___5 =
                      FStarC_Syntax_Util.arrow (FStarC_List.rev bs1) cod in
                    setpos uu___5 in
                  (uu___4, aqs)
              | hd::tl ->
                  ...
                  (match uu___4 with
                   | (bb, aqs') ->
                       ...
                       (match uu___5 with
                        | (b, env2) ->
                            aux env2 (FStarC_List.op_At aqs' aqs) (b :: bs1)
                              tl)) in
            aux env [] [] bs)
         ...
         let uu___2 =
           let uu___3 =
             ...
             let uu___5 =
               ...
               FStarC_Parser_AST.mk_term uu___6 top.FStarC_Parser_AST.range
                 FStarC_Parser_AST.Expr in
             (uu___4, uu___5) in
   ...
   | FStarC_Parser_AST.Abs (binders, body) ->
       let bvss = FStarC_List.map gather_pattern_bound_vars binders in
               ...
               let i =
                 Obj.magic
                   (FStarC_Class_Setlike.inter ()
                      (Obj.magic
                         (FStarC_FlatSet.setlike_flat_set
                            FStarC_Syntax_Syntax.ord_ident)) (Obj.magic acc)
                      (Obj.magic set)) in
               let uu___2 =
                 FStarC_Class_Setlike.is_empty ()
                   (Obj.magic
       ...
       ((let uu___3 = check_disjoint bvss in
        ...
        (let binders1 = FStarC_List.map replace_unit_pattern binders in
                ...
                | (env1, ftvs) ->
                    (match pat.FStarC_Parser_AST.pat with
                     | FStarC_Parser_AST.PatAscribed
                         ...
                         let uu___6 =
                           let uu___7 =
                             FStarC_ToSyntax_TickedVars.free_ticked_vars env1
                               t in
                           FStarC_List.op_At uu___7 ftvs in
                         (env1, uu___6)
                     | FStarC_Parser_AST.PatAscribed
                         (uu___5, (t, FStar_Pervasives_Native.Some tac)) ->
                         let uu___6 =
                           let uu___7 =
                             FStarC_ToSyntax_TickedVars.free_ticked_vars env1
                               t in
         ...
         | (uu___4, ftv) ->
             let ftv1 =
               FStarC_Class_Ord.sort_dedup FStarC_Syntax_Syntax.ord_ident ftv in
             let binders2 =
               let uu___5 =
                 FStarC_List.map
                   (fun a ->
               ...
               FStarC_List.op_At uu___5 binders1 in
               ...
               | [] ->
                   ...
                   (match uu___5 with
                    | (body1, aq) ->
                        ...
                        let uu___6 =
                          let uu___7 =
                            no_annot_abs (FStarC_List.rev bs) body2 in
                          setpos uu___7 in
                        (uu___6, (FStarC_List.op_At aq aqs)))
               | p::rest ->
                                         ...
                                         let p2 =
                                           ...
                                           FStarC_Syntax_Syntax.withinfo
                                             (FStarC_Syntax_Syntax.Pat_cons
                                                (tupn,
                                                  FStar_Pervasives_Native.None,
                                                  (FStarC_List.op_At pats1
                                                     [(p1, false)]))) uu___10 in
                                         FStar_Pervasives_Native.Some
                                           (sc1, p2)
                                     | uu___7 -> failwith "Impossible") in
                              let uu___7 = mk_binder_with_attrs x aq1 attrs in
                              (uu___7, sc_pat_opt1) in
                        (match uu___6 with
                         | (b1, sc_pat_opt1) ->
                             aux (FStarC_List.op_At aq aqs) env2 (b1 :: bs)
                               sc_pat_opt1 rest)) in
             aux [] env [] FStar_Pervasives_Native.None binders2))
   | FStarC_Parser_AST.App (uu___2, uu___3, FStarC_Parser_AST.UnivApp) ->
       let rec aux universes e =
         let uu___4 = let uu___5 = unparen e in uu___5.FStarC_Parser_AST.tm in
         match uu___4 with
         ...
         | uu___5 ->
             ...
             (match uu___6 with
              | (head, aq) ->
                  let uu___7 =
                    mk (FStarC_Syntax_Syntax.Tm_uinst (head, universes)) in
                  (uu___7, aq)) in
       aux [] top
             ...
             | (t1, aq2) ->
                 ...
                 let uu___4 =
                   FStarC_Syntax_Syntax.extend_app head arg
                     top.FStarC_Parser_AST.range in
                 (uu___4, (FStarC_List.op_At aq1 aq2))))
   | FStarC_Parser_AST.Bind (x, t1, t2) ->
       ((let uu___3 =
           let uu___4 =
             FStarC_Errors_Msg.text
               "The lightweight do notation [x <-- y; z] or [x ;; z] is deprecated." in
           let uu___5 =
             let uu___6 =
               FStarC_Errors_Msg.text
                 "Use let operators (i.e. [let* x = y in z] or [y ;* z], [*] being any sequence of operator characters) instead." in
             [uu___6] in
           uu___4 :: uu___5 in
         FStarC_Errors.log_issue FStarC_Class_HasRange.hasRange_range
           top.FStarC_Parser_AST.range
           FStarC_Errors_Codes.Warning_DeprecatedLightDoNotation ()
           (Obj.magic FStarC_Errors_Msg.is_error_message_list_doc)
           (Obj.magic uu___3));
        (let xpat =
           let uu___3 = FStarC_Ident.range_of_id x in
           FStarC_Parser_AST.mk_pattern
             (FStarC_Parser_AST.PatVar (x, FStar_Pervasives_Native.None, []))
             uu___3 in
         let k =
         ...
         let bind_lid =
           let uu___3 = FStarC_Ident.range_of_id x in
           FStarC_Ident.lid_of_path ["bind"] uu___3 in
         let bind =
           let uu___3 = FStarC_Ident.range_of_id x in
           FStarC_Parser_AST.mk_term (FStarC_Parser_AST.Var bind_lid) uu___3
             FStarC_Parser_AST.Expr in
         let uu___3 =
           FStarC_Parser_AST.mkExplicitApp bind [t1; k]
             top.FStarC_Parser_AST.range in
         desugar_term_aq env uu___3))
   ...
   | FStarC_Parser_AST.LetOpenRecord (r, rty, e) ->
       ...
       let record =
         ...
         | FStar_Pervasives_Native.None ->
             let uu___3 =
               let uu___4 = FStarC_Parser_AST.term_to_string rty in
               FStarC_Format.fmt1 "Not a record type: `%s`" uu___4 in
             FStarC_Errors.raise_error FStarC_Parser_AST.hasRange_term rty
               FStarC_Errors_Codes.Error_BadLetOpenRecord ()
               (Obj.magic FStarC_Errors_Msg.is_error_message_string)
               (Obj.magic uu___3) in
       ...
       let elab =
         let pat =
           let uu___2 =
             let uu___3 =
               let uu___4 = mk_pattern (FStarC_Parser_AST.PatName constrname) in
               let uu___5 =
                 FStarC_List.map
                   (fun uu___6 ->
                      match uu___6 with
              ...
              FStarC_List.fold_left
                (fun def uu___2 ->
                   ...
                   | (andOp, andPat, andDef) ->
                       ...
                       FStarC_Parser_AST.mkExplicitApp uu___3 [def; andDef]
                         top.FStarC_Parser_AST.range) letDef tl in
            let mproduct_pat =
              FStarC_List.fold_left
                (fun pat uu___2 ->
                   match uu___2 with
                   | (andOp, andPat, andDef) ->
                       FStarC_Parser_AST.mk_pattern
                         (FStarC_Parser_AST.PatTuple ([pat; andPat], false))
            ...
            let fn =
              let uu___2 =
                let uu___3 =
                  ...
                  (uu___4, body) in
                FStarC_Parser_AST.Abs uu___3 in
              FStarC_Parser_AST.mk_term uu___2 body.FStarC_Parser_AST.range
   ...
   | FStarC_Parser_AST.Let (qual, lbs, body) ->
       let is_rec = qual = FStarC_Parser_AST.LocalRec in
       let extra_attrs =
         if qual = FStarC_Parser_AST.LocalUnfold
         then
           [FStarC_Parser_AST.inline_let_attribute;
           FStarC_Parser_AST.inline_let_vc_attribute]
         else [] in
       let add_extra_attrs attrs =
         match (attrs, extra_attrs) with
         | (uu___2, []) -> attrs
         | (FStar_Pervasives_Native.None, uu___2) ->
             FStar_Pervasives_Native.Some extra_attrs
         | (FStar_Pervasives_Native.Some attrs1, uu___2) ->
             FStar_Pervasives_Native.Some
               (FStarC_List.op_At attrs1 extra_attrs) in
       let ds_let_rec_or_app uu___2 =
             ...
             (fun uu___3 ->
                ...
                | (attr_opt, (p, def)) ->
                    ...
                    then
                      ...
                      ((add_extra_attrs attr_opt), uu___5, def)
                    else
                      (let uu___6 = FStarC_Parser_AST.un_function p def in
                       match uu___6 with
                       | FStar_Pervasives_Native.Some (p1, def1) ->
                           let uu___7 = destruct_app_pattern env top_level p1 in
                           ((add_extra_attrs attr_opt), uu___7, def1)
                       | uu___7 ->
                           (match p.FStarC_Parser_AST.pat with
                            | FStarC_Parser_AST.PatAscribed
                                ({
                            ...
                            | FStarC_Parser_AST.PatVar (id, uu___8, uu___9)
                                ...
                                then
                                  let uu___10 =
                                    ...
                                    (uu___11, [],
                                      FStar_Pervasives_Native.None) in
                                  ((add_extra_attrs attr_opt), uu___10, def)
                                else
                                  ((add_extra_attrs attr_opt),
                                    ((FStar_Pervasives.Inl id), [],
                   ...
                   (_attr_opt, (f, uu___6, uu___7), uu___8)) ->
                    let uu___9 =
                      ...
                      | FStar_Pervasives.Inl x ->
                          let uu___10 = FStarC_Syntax_DsEnv.push_bv' env1 x in
                          (match uu___10 with
                           | (env2, xx, used_marker) ->
                               let dummy_ref = FStarC_Effect.mk_ref true in
                               let uu___11 =
                                 let uu___12 =
                                   FStarC_Syntax_Syntax.mk_binder xx in
                                 uu___12 :: rec_bindings in
                               (env2, (FStar_Pervasives.Inl xx), uu___11,
                      ...
                      | FStar_Pervasives.Inr l ->
                          ...
                          (match uu___10 with
                           | (env2, used_marker) ->
                               (env2, (FStar_Pervasives.Inr l), rec_bindings,
                                 (used_marker :: used_markers))) in
                    (match uu___9 with
         ...
         | (env', fnames, rec_bindings, used_markers) ->
             let fnames1 = FStarC_List.rev fnames in
             ...
             let desugar_one_def env1 lbname uu___4 =
               ...
               | (attrs_opt, (uu___5, args, result_t), def) ->
                   let args1 = FStarC_List.map replace_unit_pattern args in
                   ...
                   let def1 =
                     ...
                     | FStar_Pervasives_Native.Some (t, tacopt) ->
                             ...
                             ((let uu___8 =
                               ...
                               | FStar_Pervasives_Native.Some p ->
                                   let uu___9 =
                                     let uu___10 =
                                       FStarC_Errors_Msg.text
                                         "Computation type annotations are only permitted on let-bindings without inlined patterns." in
                                     let uu___11 =
                                       let uu___12 =
                                         FStarC_Errors_Msg.text
                                           "Suggestion: replace this pattern with a variable." in
                                       [uu___12] in
                                     uu___10 :: uu___11 in
                                   FStarC_Errors.raise_error
                                     FStarC_Parser_AST.hasRange_pattern p
                         ...
                         FStarC_Parser_AST.mk_term
                           (FStarC_Parser_AST.Ascribed
                              (def, t1, tacopt, false))
                           def.FStarC_Parser_AST.range FStarC_Parser_AST.Expr in
                   let def2 =
                     match args1 with
                     | [] -> def1
                     | uu___6 ->
                   ...
                   (match uu___6 with
                    | (body1, aq) ->
                        ...
                        let body2 =
                          if is_rec
                          then FStarC_Syntax_Subst.close rec_bindings1 body1
                          else body1 in
                        let attrs =
                          match attrs_opt with
                          | FStar_Pervasives_Native.None -> []
                          | FStar_Pervasives_Native.Some l ->
                              FStarC_List.map (desugar_term env1) l in
                        let uu___7 =
                          mk_lb
                            (attrs, lbname1,
                              (setpos FStarC_Syntax_Syntax.tun), body2, pos) in
                        (uu___7, aq)) in
             let uu___4 =
               let uu___5 =
                 FStarC_List.map2
                   (desugar_one_def (if is_rec then env' else env)) fnames1
                   funs in
                  ...
                  (match uu___5 with
                   | (body1, aq) ->
                       (if is_rec
                        then
                          FStarC_List.iter2
                            (fun uu___7 used_marker ->
                               match uu___7 with
                               | (_attr_opt, (f, uu___8, uu___9), uu___10) ->
                                   let uu___11 =
                                     let uu___12 =
                                       FStarC_Effect.op_Bang used_marker in
                                   ...
                                   then
                                     let uu___12 =
                                       ...
                                       | FStar_Pervasives.Inl x ->
                                           let uu___13 =
                                             FStarC_Ident.string_of_id x in
                                           let uu___14 =
                                             FStarC_Ident.range_of_id x in
                        ...
                        (let uu___7 =
                           ...
                           mk uu___8 in
                         (uu___7,
                           (FStarC_List.op_At aq (FStarC_List.flatten aqss))))))) in
       let ds_non_rec attrs_opt pat t1 t2 =
         let attrs =
           match attrs_opt with
           | FStar_Pervasives_Native.None -> []
           | FStar_Pervasives_Native.Some l ->
               FStarC_List.map (desugar_term env) l in
         let uu___2 = desugar_term_aq env t1 in
         match uu___2 with
         | (t11, aq0) ->
             let uu___3 = desugar_binding_pat_maybe_top top_level env pat in
             (match uu___3 with
                  ...
                  (check_no_aq aqs;
                   (let uu___5 =
                      ...
                      | LetBinder (l, (t, tacopt)) ->
                          (if FStar_Pervasives_Native.uu___is_Some tacopt
                           then
                             (let uu___7 = FStarC_Option.must tacopt in
                              FStarC_Errors.log_issue
                                      ...
                                      let uu___11 =
                                        let uu___12 =
                                          let uu___13 =
                                            mk_lb
                                              (attrs,
                                                (FStar_Pervasives.Inr fv), t,
                                                t11,
                                                (t11.FStarC_Syntax_Syntax.pos)) in
                                          [uu___13] in
                                        (false, uu___12) in
                                      {
                                        FStarC_Syntax_Syntax.lbs = uu___11;
                                     ...
                                     let uu___10 =
                                       let uu___11 =
                                             ...
                                             body1 in
                                         {
                                           ...
                                           FStarC_Syntax_Syntax.ret_opt =
                                             FStar_Pervasives_Native.None;
                                           FStarC_Syntax_Syntax.brs = uu___13;
                                           FStarC_Syntax_Syntax.rc_opt1 =
                                             FStar_Pervasives_Native.None
                                         } in
                                       FStarC_Syntax_Syntax.Tm_match uu___11 in
                                   ...
                                   let uu___11 =
                                     ...
                                     let uu___13 =
                                       let uu___14 =
                                         ...
                                         [uu___15] in
                                       FStarC_Syntax_Subst.close uu___14
                                         body2 in
                                     {
                                       FStarC_Syntax_Syntax.lbs = uu___12;
                                       FStarC_Syntax_Syntax.body1 = uu___13
                                     } in
                                   FStarC_Syntax_Syntax.Tm_let uu___11 in
                                 mk uu___10 in
                               (uu___9, aq)) in
                    match uu___5 with
                    | (tm, aq1) -> (tm, (FStarC_List.op_At aq0 aq1))))) in
       let uu___2 = FStarC_List.hd lbs in
       (match uu___2 with
        | (attrs, (head_pat, defn)) ->
            let attrs1 = add_extra_attrs attrs in
            let uu___3 = is_rec || (is_app_pattern head_pat) in
            if uu___3
            then ds_let_rec_or_app ()
            else ds_non_rec attrs1 head_pat defn body)
   | FStarC_Parser_AST.If
       ...
       desugar_term_aq env t
   | FStarC_Parser_AST.If (t1, FStar_Pervasives_Native.None, asc_opt, t2, t3)
       ->
       let x =
         let uu___2 = tun_r t3.FStarC_Parser_AST.range in
         FStarC_Syntax_Syntax.new_bv
           (FStar_Pervasives_Native.Some (t3.FStarC_Parser_AST.range)) uu___2 in
       let t_bool =
         let uu___2 =
           let uu___3 =
             FStarC_Syntax_Syntax.lid_and_dd_as_fv
               FStarC_Parser_Const.bool_lid FStar_Pervasives_Native.None in
        ...
        | (t1', aq1) ->
            let t1'1 =
              FStarC_Syntax_Util.ascribe t1'
                ((FStar_Pervasives.Inl t_bool), FStar_Pervasives_Native.None,
                  false) in
                             ...
                             let uu___7 =
                               let uu___8 =
                                 let uu___9 =
                                   ...
                                   uu___10 :: uu___11 in
                                 {
                                   FStarC_Syntax_Syntax.scrutinee = t1'1;
   ...
   | FStarC_Parser_AST.TryWith (e, branches) ->
       ...
       let try_with =
         FStarC_Parser_AST.mk_term (FStarC_Parser_AST.Var try_with_lid) r
           FStarC_Parser_AST.Expr in
       let a1 =
         FStarC_Parser_AST.mk_term
           (FStarC_Parser_AST.App (try_with, body, FStarC_Parser_AST.Nothing))
           r top.FStarC_Parser_AST.level in
       let a2 =
         FStarC_Parser_AST.mk_term
           (FStarC_Parser_AST.App (a1, handler, FStarC_Parser_AST.Nothing)) r
           top.FStarC_Parser_AST.level in
         ...
         | (pat, wopt, b) ->
             ...
             (match uu___3 with
              | ((env1, pat1), aqP) ->
                  ...
                  (match uu___4 with
                   | (b1, aqB) ->
                       let uu___5 = desugar_disjunctive_pattern pat1 wopt1 b1 in
                       (uu___5, (FStarC_List.op_At aqP aqB)))) in
       let uu___2 = desugar_term_aq env e in
       (match uu___2 with
        | (e1, aq) ->
            ...
            (match uu___3 with
             | (asc_opt, aq0) ->
                 let uu___4 =
                   let uu___5 =
                     let uu___6 = FStarC_List.map desugar_branch branches in
                     FStarC_List.unzip uu___6 in
                   match uu___5 with | (x, y) -> ((FStarC_List.flatten x), y) in
                 (match uu___4 with
                  | (brs, aqs) ->
                      let uu___5 =
                        mk
        ...
        | (asc, aq0) ->
            ...
            (match uu___3 with
             | (e1, aq) ->
                 ...
                 (uu___4, (FStarC_List.op_At aq0 aq))))
   ...
   | FStarC_Parser_AST.Record (eopt, fields) ->
       let record_opt =
         let uu___2 = FStarC_List.hd fields in
         match uu___2 with
         | (f, uu___3) ->
           ...
           FStarC_List.map
             (fun uu___4 ->
                ...
                | (fn, fval) ->
                    ...
                    (match uu___5 with | (fval1, aq) -> ((fn, fval1), aq)))
             fields in
         FStarC_List.unzip uu___3 in
       (match uu___2 with
        | (fields1, aqs) ->
            let uu___3 = FStarC_List.unzip fields1 in
            (match uu___3 with
             | (field_names, assignments) ->
                 let args =
                   FStarC_List.map
                     (fun f -> (f, FStar_Pervasives_Native.None)) assignments in
                 ...
                 let uc =
                   ...
                   | FStar_Pervasives_Native.None ->
                       {
                         FStarC_Syntax_Syntax.uc_base_term =
                           (FStar_Pervasives_Native.uu___is_Some eopt);
                   ...
                   | FStar_Pervasives_Native.Some record ->
                       let uu___4 =
                         qualify_field_names
                           record.FStarC_Syntax_DsEnv.typename field_names in
                       {
                         FStarC_Syntax_Syntax.uc_base_term =
                           (FStar_Pervasives_Native.uu___is_Some eopt);
                         FStarC_Syntax_Syntax.uc_typename =
                           ...
                           let tm =
                             ...
                             | uu___6 ->
                                 ...
                                 (match uu___7 with
                                  | (env', bv_x) ->
                                      let nm =
                                        FStarC_Syntax_Syntax.bv_to_name bv_x in
                                      let body =
                                        mk_result
                                          ((nm, FStar_Pervasives_Native.None)
                                          :: args) in
                                      let body1 =
                                        let uu___8 =
                                          let uu___9 =
                                            FStarC_Syntax_Syntax.mk_binder
                                              bv_x in
                                          [uu___9] in
                                        FStarC_Syntax_Subst.close uu___8 body in
                                      let lb =
                                        mk_lb
                                          ([], (FStar_Pervasives.Inl bv_x),
                                            FStarC_Syntax_Syntax.tun, e1,
                                            (e1.FStarC_Syntax_Syntax.pos)) in
                                      mk
                                        (FStarC_Syntax_Syntax.Tm_let
                                           {
        ...
        | (e1, s) ->
            ...
            let uu___3 =
              let uu___4 =
                let uu___5 =
                  let uu___6 =
                    let uu___7 = FStarC_Syntax_Syntax.as_arg e1 in [uu___7] in
                  {
   ...
   | FStarC_Parser_AST.VQuote e ->
       let uu___2 =
         let uu___3 =
           let uu___4 = desugar_vquote env e top.FStarC_Parser_AST.range in
           FStarC_Syntax_Util.exp_string uu___4 in
         {
           ...
           FStarC_Syntax_Syntax.vars = (uu___3.FStarC_Syntax_Syntax.vars);
           FStarC_Syntax_Syntax.hash_code =
        ...
        | (tm, vts) ->
            let vt_binders =
              FStarC_List.map
                (fun uu___3 ->
                   match uu___3 with
                   | (bv, _tm) -> FStarC_Syntax_Syntax.mk_binder bv) vts in
            let vt_tms = FStarC_List.map FStar_Pervasives_Native.snd vts in
            ...
            ((let fvs = FStarC_Syntax_Free.names tm1 in
              ...
              then
                let uu___5 =
                  ...
                  FStarC_Format.fmt1
                    ...
                    uu___6 in
                FStarC_Errors.raise_error FStarC_Parser_AST.hasRange_term e
                  FStarC_Errors_Codes.Fatal_MissingFieldInRecord ()
                  (Obj.magic FStarC_Errors_Msg.is_error_message_string)
                  (Obj.magic uu___5)
              else ());
             (match () with
              | () ->
                  ...
                  let uu___4 = mk (FStarC_Syntax_Syntax.Tm_quoted (tm1, qi)) in
                  (uu___4, noaqs))))
   ...
   | FStarC_Parser_AST.CalcProof (rel, init_expr, steps) ->
             ...
             let uu___4 =
               let uu___5 =
                 let uu___6 =
                   ...
                   (uu___7, uu___8, FStar_Pervasives_Native.None, false) in
                 FStarC_Parser_AST.Ascribed uu___6 in
               FStarC_Parser_AST.mk_term uu___5 rel1.FStarC_Parser_AST.range
                 FStarC_Parser_AST.Expr in
             (pats, uu___4) in
           FStarC_Parser_AST.Abs uu___3 in
         FStarC_Parser_AST.mk_term uu___2 rel1.FStarC_Parser_AST.range
       ...
       let push_impl r =
         FStarC_Parser_AST.mk_term
           (FStarC_Parser_AST.Var FStarC_Parser_Const.calc_push_impl_lid) r
           FStarC_Parser_AST.Expr in
       let last_expr =
         let uu___2 = FStarC_List.last_opt steps in
         match uu___2 with
       ...
       let finish =
         let uu___2 =
           FStarC_Parser_AST.mk_term
             ...
             top.FStarC_Parser_AST.range FStarC_Parser_AST.Expr in
         FStarC_Parser_AST.mkApp uu___2 [(rel1, FStarC_Parser_AST.Nothing)]
           top.FStarC_Parser_AST.range in
       let e =
              ...
              | ((e1, prev), FStarC_Parser_AST.CalcStep
                 (rel2, just, next_expr)) ->
                  let just1 =
                    ...
                    if uu___5
                    then
                      let uu___6 = push_impl just.FStarC_Parser_AST.range in
                      let uu___7 =
                        let uu___8 =
                  ...
                  let pf =
                    ...
                    let uu___6 =
                      let uu___7 =
                        let uu___8 = wild rel2.FStarC_Parser_AST.range in
                        ...
                        let uu___9 =
                          let uu___10 =
                            ...
                            let uu___12 =
                              let uu___13 =
                                let uu___14 =
                                  let uu___15 = FStarC_Parser_AST.thunk e1 in
                                  (uu___15, FStarC_Parser_AST.Nothing) in
                                let uu___15 =
                                  let uu___16 =
                                    let uu___17 =
                                      FStarC_Parser_AST.thunk just1 in
                                    (uu___17, FStarC_Parser_AST.Nothing) in
                                  [uu___16] in
                                uu___14 :: uu___15 in
              ...
              | b::bs3 ->
                  ...
                  let uu___4 =
                    FStarC_Syntax_Util.abs [b] tail
                      FStar_Pervasives_Native.None in
                  mk_forall_intro x.FStarC_Syntax_Syntax.sort uu___3 uu___4 in
            ...
            let rec aux bs2 vs2 sub token =
              ...
              | (b::bs3, v::vs3) ->
                  ...
                  let token1 =
                    ...
                    aux uu___3 vs3 ((FStarC_Syntax_Syntax.NT (x, v)) :: sub)
                      token in
                  let token2 =
                    let uu___3 =
                      let uu___4 =
                        let uu___5 = FStarC_Syntax_Subst.subst sub p1 in
                        FStarC_Syntax_Util.close_exists_no_univs bs3 uu___5 in
                      FStarC_Syntax_Util.abs [b] uu___4
                        FStar_Pervasives_Native.None in
                    mk_exists_intro x.FStarC_Syntax_Syntax.sort uu___3 v
                      token1 in
                  token2
              | uu___3 ->
                  FStarC_Errors.raise_error FStarC_Parser_AST.hasRange_term
                    top FStarC_Errors_Codes.Fatal_UnexpectedTerm ()
                    (Obj.magic FStarC_Errors_Msg.is_error_message_string)
                    (Obj.magic
   ...
   | FStarC_Parser_AST.IntroAnd (p, q, e1, e2) ->
       ...
       let head =
         let uu___2 =
           FStarC_Syntax_Syntax.lid_and_dd_as_fv
             FStarC_Parser_Const.and_intro_lid FStar_Pervasives_Native.None in
         FStarC_Syntax_Syntax.fv_to_tm uu___2 in
       let args =
         let uu___2 =
           let uu___3 =
       ...
       (match uu___2 with
        | (env', bs1) ->
            ...
            let mk_forall_elim a p2 v tok =
              ...
              let args =
                let uu___3 =
                  let uu___4 = FStarC_Syntax_Syntax.as_aqual_implicit true in
                  (a, uu___4) in
                let uu___4 =
                  let uu___5 =
                    let uu___6 = FStarC_Syntax_Syntax.as_aqual_implicit true in
                    (p2, uu___6) in
                  [uu___5;
              ...
              | (b::bs3, v::vs3) ->
                  ...
                  let token1 =
                    let uu___3 =
                      let uu___4 =
                        let uu___5 = FStarC_Syntax_Subst.subst sub p1 in
                        FStarC_Syntax_Util.close_forall_no_univs bs3 uu___5 in
                      FStarC_Syntax_Util.abs [b] uu___4
                        FStar_Pervasives_Native.None in
                    mk_forall_elim x.FStarC_Syntax_Syntax.sort uu___3 v token in
                  let sub1 = (FStarC_Syntax_Syntax.NT (x, v)) :: sub in
                  let uu___3 = FStarC_Syntax_Subst.subst_binders sub1 bs3 in
            ...
            let range =
              FStarC_List.fold_right
                (fun bs2 r ->
                   ...
                   FStarC_Range_Ops.union_ranges uu___3 r) bs1
                p1.FStarC_Syntax_Syntax.pos in
            let uu___3 =
              aux bs1 vs1 []
                {
                  FStarC_Syntax_Syntax.n =
                       ...
                       let args =
                         ...
                         let uu___5 =
                           let uu___6 =
                             let uu___7 =
                               let uu___8 =
                                 let uu___9 = FStarC_List.hd bs1 in [uu___9] in
                   ...
                   | b::[] ->
                       ...
                       let uu___5 =
                         ...
                         FStarC_Syntax_Util.abs [b; b_pf_p] uu___6
                           FStar_Pervasives_Native.None in
                       mk_exists_elim x.FStarC_Syntax_Syntax.sort uu___4
                         squash_token uu___5
                   ...
                   | b::bs1 ->
                       let pf_i =
                         ...
                         FStarC_Syntax_Syntax.gen_bv "pf" uu___4
                           FStarC_Syntax_Syntax.tun in
                       let k =
                         let uu___4 = FStarC_Syntax_Syntax.bv_to_name pf_i in
                         aux bs1 uu___4 in
                       let x = unqual_bv_of_binder b in
                       let uu___4 =
                       ...
                       let uu___5 =
                         let uu___6 =
                           let uu___7 =
                             let uu___8 = FStarC_Syntax_Syntax.mk_binder pf_i in
                             [uu___8] in
                           b :: uu___7 in
                 ...
                 let range =
                   FStarC_List.fold_right
                     (fun bs1 r ->
                        ...
                        FStarC_Range_Ops.union_ranges uu___4 r) bs
                     p1.FStarC_Syntax_Syntax.pos in
                 let uu___4 =
                   aux bs
                     {
         ...
         let uu___2 =
           let uu___3 =
             let uu___4 =
               let uu___5 =
                 let uu___6 =
                   FStarC_Range_Ops.union_ranges p1.FStarC_Syntax_Syntax.pos
                       ...
                       let uu___7 =
                         ...
                         let uu___9 =
                           ...
                           let uu___11 =
                             let uu___12 =
                               let uu___13 =
                                 FStarC_Syntax_Util.abs [extra_binder; y1]
                                   e21 FStar_Pervasives_Native.None in
   ...
   | FStarC_Parser_AST.ListLiteral ts ->
       let nil r =
         FStarC_Parser_AST.mk_term
           (FStarC_Parser_AST.Construct (FStarC_Parser_Const.nil_lid, [])) r
           FStarC_Parser_AST.Expr in
       let cons r hd tl =
         FStarC_Parser_AST.mk_term
           (FStarC_Parser_AST.Construct
              (FStarC_Parser_Const.cons_lid,
                ...
                (tl, FStarC_Parser_AST.Nothing)])) r FStarC_Parser_AST.Expr in
       let t' =
         let uu___2 = nil top.FStarC_Parser_AST.range in
         FStarC_List.fold_right (cons top.FStarC_Parser_AST.range) ts uu___2 in
       desugar_term_aq env t'
   | FStarC_Parser_AST.SeqLiteral ts ->
       ...
       let cons r hd tl =
         ...
         FStarC_Parser_AST.mkApp uu___2
           [(hd, FStarC_Parser_AST.Nothing); (tl, FStarC_Parser_AST.Nothing)]
           r in
       let t' =
         let uu___2 = nil top.FStarC_Parser_AST.range in
         FStarC_List.fold_right (cons top.FStarC_Parser_AST.range) ts uu___2 in
       desugar_term_aq env t'
   | uu___2 when top.FStarC_Parser_AST.level = FStarC_Parser_AST.Formula ->
       let uu___3 = desugar_formula env top in (uu___3, noaqs)
   | uu___2 ->
       let uu___3 =
       ...
       FStarC_Errors.raise_error FStarC_Parser_AST.hasRange_term top
         ...
         (Obj.magic FStarC_Errors_Msg.is_error_message_string)
         (Obj.magic uu___3))
and desugar_match_returns (env : env_t)
  ...
  ((FStarC_Syntax_Syntax.binder *
    ...
    FStar_Pervasives_Native.option * (FStarC_Syntax_Syntax.bv *
    FStarC_Syntax_Syntax.term) Prims.list)=
  match asc_opt with
  | FStar_Pervasives_Native.None -> (FStar_Pervasives_Native.None, [])
            ...
            | (env_asc, b) ->
                ...
                (match uu___2 with
                 | (asc1, aq) ->
                     let asc2 =
                       let uu___3 =
                         let uu___4 = FStarC_Syntax_Util.unascribe scrutinee in
                       ...
                       | FStarC_Syntax_Syntax.Tm_name sbv ->
                           let uu___4 =
                             ...
                             [uu___5] in
                           FStarC_Syntax_Subst.subst_ascription uu___4 asc1
                       | uu___4 -> asc1 in
                     let asc3 = FStarC_Syntax_Subst.close_ascription [b] asc2 in
                     let b1 =
                       let uu___3 = FStarC_Syntax_Subst.close_binders [b] in
                       FStarC_List.hd uu___3 in
                     ((FStar_Pervasives_Native.Some (b1, asc3)), aq))))
and desugar_ascription (env : env_t) (t : FStarC_Parser_AST.term)
  (tac_opt : FStarC_Parser_AST.term FStar_Pervasives_Native.option)
  (use_eq : Prims.bool) :
  (FStarC_Syntax_Syntax.ascription * antiquotations_temp)=
  let uu___ =
  ...
  | (annot, aq0) ->
      let uu___1 =
        let uu___2 = FStarC_Option.map (desugar_term env) tac_opt in
        (annot, uu___2, use_eq) in
      (uu___1, aq0)
and desugar_args (env : FStarC_Syntax_DsEnv.env)
  ...
  FStarC_List.map
    (fun uu___ ->
       match uu___ with
       | (a, imp) ->
           let uu___1 = desugar_term env a in arg_withimp_t imp uu___1) args
and desugar_comp (r : FStarC_Range_Type.range)
  (allow_type_promotion : Prims.bool) (env : FStarC_Syntax_DsEnv.env)
  (t : FStarC_Parser_AST.term) : FStarC_Syntax_Syntax.comp=
  let fail code msg =
  ...
  let is_smt_pat1 t1 =
    ...
    | FStarC_Parser_AST.Construct (smtpat, uu___1) ->
        FStarC_Util.for_some
          (fun s ->
             let uu___2 = FStarC_Ident.string_of_lid smtpat in uu___2 = s)
          ["SMTPat"; "SMTPatT"; "SMTPatOr"]
    | FStarC_Parser_AST.Var smtpat ->
        FStarC_Util.for_some
          (fun s ->
             let uu___1 = FStarC_Ident.string_of_lid smtpat in uu___1 = s)
          ["smt_pat"; "smt_pat_or"]
    | uu___1 -> false in
  let is_smt_pat uu___ =
    ...
    | (t1, uu___1) ->
        ...
        (match uu___2 with
         | FStarC_Parser_AST.ListLiteral ts ->
             FStarC_Util.for_all is_smt_pat1 ts
         | uu___3 -> false) in
        ...
        (match head.FStarC_Parser_AST.tm with
         | FStarC_Parser_AST.Name lemma when
             ...
             let unit_tm =
               let uu___1 =
                 FStarC_Parser_AST.mk_term
                   (FStarC_Parser_AST.Name FStarC_Parser_Const.unit_lid)
                   t1.FStarC_Parser_AST.range FStarC_Parser_AST.Type_level in
               (uu___1, FStarC_Parser_AST.Nothing) in
             let nil_pat =
               let uu___1 =
                 FStarC_Parser_AST.mk_term
                   (FStarC_Parser_AST.Name FStarC_Parser_Const.nil_lid)
             ...
             let req_true =
               let req =
                 let uu___1 =
                   FStarC_Parser_AST.mk_term
                     (FStarC_Parser_AST.Name FStarC_Parser_Const.true_lid)
                     t1.FStarC_Parser_AST.range FStarC_Parser_AST.Formula in
                 FStarC_Parser_AST.Requires uu___1 in
               let uu___1 =
                 FStarC_Parser_AST.mk_term req t1.FStarC_Parser_AST.range
                   FStarC_Parser_AST.Type_level in
               (uu___1, FStarC_Parser_AST.Nothing) in
             let thunk_ens uu___1 =
               match uu___1 with
               | (e, i) ->
                   let uu___2 = FStarC_Parser_AST.thunk e in (uu___2, i) in
             let fail_lemma uu___1 =
               ...
               let uu___2 =
                 let uu___3 =
                   ...
                   let uu___5 =
                     let uu___6 =
                       FStarC_List.map FStar_Pprint.doc_of_string
                         expected_one_of in
                     FStarC_Errors_Msg.sublist FStar_Pprint.empty uu___6 in
             ...
             let args1 =
               ...
               | ens::[] ->
                   let uu___1 =
                     let uu___2 =
                       let uu___3 = thunk_ens ens in [uu___3; nil_pat] in
                     req_true :: uu___2 in
                   unit_tm :: uu___1
               ...
               | ens::dec::[] when (is_ensures ens) && (is_decreases dec) ->
                   let uu___1 =
                     let uu___2 =
                       let uu___3 = thunk_ens ens in [uu___3; nil_pat; dec] in
                     req_true :: uu___2 in
                   unit_tm :: uu___1
               | ens::dec::smtpat::[] when
                   ...
                   let uu___1 =
                     let uu___2 =
                       let uu___3 = thunk_ens ens in [uu___3; smtpat; dec] in
                     req_true :: uu___2 in
                   unit_tm :: uu___1
               | req::ens::dec::[] when
               ...
               | req::ens::dec::smtpat::[] when
                   ...
                   let uu___1 =
                     let uu___2 =
                       let uu___3 = thunk_ens ens in [uu___3; dec; smtpat] in
                     req :: uu___2 in
                   unit_tm :: uu___1
         ...
         | uu___1 when allow_type_promotion ->
             let default_effect =
               ...
               then FStarC_Parser_Const.effect_ML_lid ()
                 ...
                 ((let uu___5 = FStarC_Options.warn_default_effects () in
                   if uu___5
                   then
                     FStarC_Errors.log_issue FStarC_Parser_AST.hasRange_term
      ...
      (if (FStarC_List.length args) = Prims.int_zero
       then
         (let uu___2 =
            ...
            FStarC_Format.fmt1 "Not enough args to effect %s" uu___3 in
       ...
       (let is_universe uu___2 =
        ...
        let uu___2 = FStarC_Util.take is_universe args in
        match uu___2 with
        | (universes, args1) ->
            let universes1 =
              FStarC_List.map
                ...
                universes in
            let uu___3 =
              let uu___4 = FStarC_List.hd args1 in
              let uu___5 = FStarC_List.tl args1 in (uu___4, uu___5) in
            (match uu___3 with
             | (result_arg, rest) ->
                 let result_typ =
                   desugar_typ env (FStar_Pervasives_Native.fst result_arg) in
                 let uu___4 =
                   let is_decrease t1 =
                     let uu___5 =
                       let uu___6 = unparen (FStar_Pervasives_Native.fst t1) in
                       uu___6.FStarC_Parser_AST.tm in
                     match uu___5 with
                     | FStarC_Parser_AST.Decreases uu___6 -> true
                     | uu___6 -> false in
                   FStarC_List.partition is_decrease rest in
                 (match uu___4 with
                  | (dec, rest1) ->
                        ...
                        FStarC_List.map
                          (fun t1 ->
                             let uu___5 =
                               ...
                               uu___6.FStarC_Parser_AST.tm in
                             match uu___5 with
                             | FStarC_Parser_AST.Decreases t2 ->
                                 let dec_order =
                                   ...
                                   | FStarC_Parser_AST.LexList l ->
                                       ...
                                       FStarC_Syntax_Syntax.Decreases_lex
                                         uu___6
                                   | FStarC_Parser_AST.WFOrder (t11, t21) ->
                                       let uu___6 =
                                         let uu___7 = desugar_term env t11 in
                                         let uu___8 = desugar_term env t21 in
                                         (uu___7, uu___8) in
                                       FStarC_Syntax_Syntax.Decreases_wf
                                         uu___6
                                   | uu___6 ->
                                       let uu___7 =
                                         let uu___8 = desugar_term env t3 in
                                         [uu___8] in
                                       FStarC_Syntax_Syntax.Decreases_lex
                                         uu___7 in
                      ...
                      let no_additional_args =
                        ...
                        (((is_empty decreases_clause) && (is_empty rest2)) &&
                      ...
                      then FStarC_Syntax_Syntax.mk_Total result_typ
                        ...
                        (let uu___7 =
                         ...
                         if uu___7
                         then FStarC_Syntax_Syntax.mk_GTotal result_typ
                         else
                           (let flags =
                              let uu___9 =
                                FStarC_Ident.lid_equals eff
                                ...
                                (let uu___11 =
                                 ...
                                 then [FStarC_Syntax_Syntax.TOTAL]
                                   ...
                                   (let uu___13 =
                                      let uu___14 =
                                        FStarC_Parser_Const.effect_ML_lid () in
                                      FStarC_Ident.lid_equals eff uu___14 in
                                    if uu___13
                            ...
                            let flags1 = FStarC_List.op_At flags cattributes in
                            let rest3 =
                              let uu___9 =
                                FStarC_Ident.lid_equals eff
                                  FStarC_Parser_Const.effect_Lemma_lid in
                              ...
                              then
                                ...
                                | req::ens::(pat, aq)::[] ->
                                    let pat1 =
                                      match pat.FStarC_Syntax_Syntax.n with
                                      | FStarC_Syntax_Syntax.Tm_fvar fv when
                                          ...
                                          let uu___10 =
                                            let uu___11 =
                                              ...
                                              (pattern, uu___12) in
                                            [uu___11] in
                                          FStarC_Syntax_Syntax.mk_Tm_app nil
                                            uu___10
                            ...
                            FStarC_Syntax_Syntax.mk_Comp
                              {
                                ...
                                FStarC_Syntax_Syntax.effect_args = rest3;
                                FStarC_Syntax_Syntax.flags =
                                  (FStarC_List.op_At flags1 decreases_clause)
                              }))))))
and desugar_formula (env : FStarC_Syntax_DsEnv.env)
      ...
      desugar_binder env
        {
          ...
          FStarC_Parser_AST.battributes = (b.FStarC_Parser_AST.battributes)
        } in
                   ...
                   (fun es ->
                      FStarC_List.map
                        (fun e ->
                           ...
                           arg_withimp_t FStarC_Parser_AST.Nothing uu___2) es)
                   pats1 in
               (match pats2 with
        ...
        (match uu___1 with
         | (env1, a1) ->
             let a2 =
               {
                 ...
                 FStarC_Syntax_Syntax.index = (a1.FStarC_Syntax_Syntax.index);
             ...
             let body3 =
               let uu___2 =
                 let uu___3 =
                   let uu___4 = FStarC_Syntax_Syntax.mk_binder a2 in [uu___4] in
                 no_annot_abs uu___3 body2 in
               setpos uu___2 in
             let uu___2 =
               let uu___3 =
                 let uu___4 =
                   let uu___5 = FStarC_Syntax_Syntax.as_arg body3 in [uu___5] in
                 {
  ...
  let push_quant q binders pats body =
    ...
    | b::b'::_rest ->
        ...
        let body1 =
          ...
          let uu___1 =
            FStarC_Range_Ops.union_ranges b'.FStarC_Parser_AST.brange
              body.FStarC_Parser_AST.range in
          FStarC_Parser_AST.mk_term uu___ uu___1 FStarC_Parser_AST.Formula in
  ...
  | FStarC_Parser_AST.Labeled (f1, l, p) ->
      ...
      let uu___1 =
        let uu___2 =
          ...
          { FStarC_Syntax_Syntax.tm2 = f2; FStarC_Syntax_Syntax.meta = uu___3
          } in
  ...
  | FStarC_Parser_AST.QForall (_1::_2::_3, pats, body) ->
      ...
      let uu___1 =
        push_quant (fun x -> FStarC_Parser_AST.QForall x) binders pats body in
      desugar_formula env uu___1
  | FStarC_Parser_AST.QExists (_1::_2::_3, pats, body) ->
      let binders = _1 :: _2 :: _3 in
      let uu___1 =
        push_quant (fun x -> FStarC_Parser_AST.QExists x) binders pats body in
      desugar_formula env uu___1
  | FStarC_Parser_AST.QuantOp (i, _1::_2::_3, pats, body) ->
      ...
      let uu___1 =
        push_quant
          (fun uu___2 ->
             match uu___2 with
             | (x, y, z) -> FStarC_Parser_AST.QuantOp (i, x, y, z)) binders
          pats body in
      desugar_formula env uu___1
  | FStarC_Parser_AST.QForall (b::[], pats, body) ->
      let q = FStarC_Parser_Const.forall_lid in
      let q_head =
        let uu___1 = FStarC_Ident.set_lid_range q b.FStarC_Parser_AST.brange in
        FStarC_Syntax_Syntax.fvar_with_dd uu___1 FStar_Pervasives_Native.None in
      ...
      let q_head =
        ...
        | FStar_Pervasives_Native.None ->
            let uu___2 =
              ...
              FStarC_Format.fmt1 "quantifier operator %s not found" uu___3 in
...
and desugar_binder_aq (env : FStarC_Syntax_DsEnv.env)
  ...
  | FStarC_Parser_AST.Annotated (x, t) ->
      ...
      (match uu___ with
       | (ty, aqs) -> (((FStar_Pervasives_Native.Some x), ty, attrs), aqs))
...
and desugar_vquote (env : env_t) (e : FStarC_Parser_AST.term)
  ...
  | uu___1 ->
      ...
      FStarC_Errors.raise_error FStarC_Class_HasRange.hasRange_range r
        ...
        (Obj.magic FStarC_Errors_Msg.is_error_message_string)
        (Obj.magic uu___2)
and as_binder (env : FStarC_Syntax_DsEnv.env)
  (imp : FStarC_Parser_AST.arg_qualifier FStar_Pervasives_Native.option)
  (uu___ :
    (FStarC_Ident.ident FStar_Pervasives_Native.option *
      FStarC_Syntax_Syntax.term * FStarC_Syntax_Syntax.attribute Prims.list))
  ...
  | (FStar_Pervasives_Native.Some a, k, attrs) ->
      ...
      (match uu___1 with
       | (env1, a1) ->
           ...
           (uu___2, env1))
and trans_bqual (env : env_t)
  (uu___ : FStarC_Parser_AST.arg_qualifier FStar_Pervasives_Native.option) :
  ...
  | FStar_Pervasives_Native.Some (FStarC_Parser_AST.Meta t) ->
      let uu___1 =
        let uu___2 = desugar_term env t in FStarC_Syntax_Syntax.Meta uu___2 in
      FStar_Pervasives_Native.Some uu___1
      ...
      let tcresolve =
        let uu___1 =
          FStarC_Parser_AST.mk_term
            ...
            FStarC_Range_Type.dummyRange FStarC_Parser_AST.Expr in
        desugar_term env uu___1 in
      FStar_Pervasives_Native.Some (FStarC_Syntax_Syntax.Meta tcresolve)
  | FStar_Pervasives_Native.None -> FStar_Pervasives_Native.None
let typars_of_binders (env : FStarC_Syntax_DsEnv.env)
              ...
              | (FStar_Pervasives_Native.Some a, k, attrs) ->
                  ...
                  (match uu___2 with
                   | (env2, a1) ->
                       ...
                       (env2, uu___3))
              | uu___2 ->
                  FStarC_Errors.raise_error FStarC_Parser_AST.hasRange_binder
                    b FStarC_Errors_Codes.Fatal_UnexpectedBinder ()
                    (Obj.magic FStarC_Errors_Msg.is_error_message_string)
                    (Obj.magic "Unexpected binder"))) (env, []) bs in
  match uu___ with | (env1, tpars) -> (env1, (FStarC_List.rev tpars))
let desugar_attributes (env : env_t)
  (cattributes : FStarC_Parser_AST.term Prims.list) :
  ...
  let desugar_attribute t =
    ...
    | uu___1 ->
        ...
        FStarC_Errors.raise_error FStarC_Parser_AST.hasRange_term t
          ...
          (Obj.magic FStarC_Errors_Msg.is_error_message_string)
          (Obj.magic uu___2) in
  FStarC_List.map desugar_attribute cattributes
let binder_ident (b : FStarC_Parser_AST.binder) :
  FStarC_Ident.ident FStar_Pervasives_Native.option=
  match b.FStarC_Parser_AST.b with
  | FStarC_Parser_AST.Annotated (x, uu___) -> FStar_Pervasives_Native.Some x
  | FStarC_Parser_AST.Variable x -> FStar_Pervasives_Native.Some x
  | FStarC_Parser_AST.NoName uu___ -> FStar_Pervasives_Native.None
let binder_idents (bs : FStarC_Parser_AST.binder Prims.list) :
  FStarC_Ident.ident Prims.list=
  FStarC_List.collect
    (fun b ->
       let uu___ = binder_ident b in FStarC_Common.list_of_option uu___) bs
let mk_typ_abbrev (env : FStarC_Syntax_DsEnv.env)
  (d : FStarC_Parser_AST.decl) (lid : FStarC_Ident.lident)
  (uvs : FStarC_Syntax_Syntax.univ_name Prims.list)
  (typars : FStarC_Syntax_Syntax.binders)
  (kopt : FStarC_Syntax_Syntax.typ FStar_Pervasives_Native.option)
  (t : FStarC_Syntax_Syntax.term) (lids : FStarC_Ident.lident Prims.list)
  (quals : FStarC_Syntax_Syntax.qualifier Prims.list)
  (rng : FStarC_Range_Type.range) : FStarC_Syntax_Syntax.sigelt=
  let attrs =
    let uu___ = FStarC_List.map (desugar_term env) d.FStarC_Parser_AST.attrs in
    FStarC_Syntax_Util.deduplicate_terms uu___ in
  let val_attrs =
    let uu___ = FStarC_Syntax_DsEnv.lookup_letbinding_quals_and_attrs env lid in
  ...
  let lb =
    ...
    let uu___1 =
      if FStar_Pervasives_Native.uu___is_Some kopt
      then
        let uu___2 =
          let uu___3 = FStarC_Option.must kopt in
  ...
  let uu___ =
    FStarC_Syntax_Util.deduplicate_terms (FStarC_List.op_At val_attrs attrs) in
...
let rec desugar_tycon (env : FStarC_Syntax_DsEnv.env)
  (d : FStarC_Parser_AST.decl)
  (d_attrs_initial : FStarC_Syntax_Syntax.term Prims.list)
  (quals : FStarC_Syntax_Syntax.qualifier Prims.list)
  (tcs : FStarC_Parser_AST.tycon Prims.list) :
  ...
  let tycon_id uu___ =
    ...
    | FStarC_Parser_AST.TyconAbbrev (id, uu___1, uu___2, uu___3) -> id
    | FStarC_Parser_AST.TyconRecord (id, uu___1, uu___2, uu___3, uu___4) ->
        id
    | FStarC_Parser_AST.TyconVariant (id, uu___1, uu___2, uu___3) -> id in
  let binder_to_term b =
    ...
    | FStarC_Parser_AST.Annotated (x, uu___) ->
        ...
        FStarC_Parser_AST.mk_term uu___1 uu___2 FStarC_Parser_AST.Expr
    | FStarC_Parser_AST.Variable x ->
        let uu___ =
          let uu___1 = FStarC_Ident.lid_of_ids [x] in
          FStarC_Parser_AST.Var uu___1 in
        let uu___1 = FStarC_Ident.range_of_id x in
        FStarC_Parser_AST.mk_term uu___ uu___1 FStarC_Parser_AST.Expr
                      ...
                      | FStar_Pervasives_Native.Some
                          ...
                          let record_id =
                            let uu___4 =
                              ...
                              let uu___6 = FStarC_Ident.range_of_id cid in
                              (uu___5, uu___6) in
                            FStarC_Ident.mk_ident uu___4 in
                          let record_id_t =
                            let uu___4 =
                              let uu___5 =
                                FStarC_Ident.lid_of_ns_and_id [] record_id in
                              FStarC_Parser_AST.Var uu___5 in
                            let uu___5 = FStarC_Ident.range_of_id cid in
                            {
                              FStarC_Parser_AST.tm = uu___4;
                            ...
                            let uu___4 =
                              FStarC_List.map
                                (fun bd ->
                                   ...
                                   (uu___5, FStarC_Parser_AST.Nothing)) bds in
                            let uu___5 = FStarC_Ident.range_of_id record_id in
                            FStarC_Parser_AST.mkApp record_id_t uu___4 uu___5 in
                          let desugar_marker =
                            let range = FStarC_Ident.range_of_id record_id in
                            let desugar_attr_fv =
                              let uu___4 =
                                FStarC_Class_HasRange.setPos
                                  FStarC_Ident.hasrange_lident range
                                  FStarC_Parser_Const.desugar_of_variant_record_lid in
                              {
                                FStarC_Syntax_Syntax.fv_name = uu___4;
                                FStarC_Syntax_Syntax.fv_qual =
                                  FStar_Pervasives_Native.None
                              } in
                            let desugar_attr =
                              FStarC_Syntax_Syntax.mk
                                (FStarC_Syntax_Syntax.Tm_fvar desugar_attr_fv)
                                range in
                            let cid_as_constant =
                              let uu___4 =
                                let uu___5 =
                                  let uu___6 =
                                    FStarC_Syntax_DsEnv.qualify env cid in
                                  FStarC_Ident.string_of_lid uu___6 in
                                FStarC_Syntax_Embeddings_Base.embed
                                  FStarC_Syntax_Embeddings.e_string uu___5 in
                              uu___4 range FStar_Pervasives_Native.None
                                FStarC_Syntax_Embeddings_Base.id_norm_cb in
                            FStarC_Syntax_Syntax.mk_Tm_app desugar_attr
                              [(cid_as_constant,
                            ...
                            let uu___5 =
                              let uu___6 =
                                ...
                                | FStar_Pervasives_Native.Some k2 ->
                                      ...
                                      let uu___8 =
                                        let uu___9 =
                                          let uu___10 =
                                            ...
                                            [uu___11] in
                                          (uu___10, k2) in
                                        FStarC_Parser_AST.Product uu___9 in
                                      {
                                        FStarC_Parser_AST.tm = uu___8;
                                    ...
                                    FStarC_Parser_AST.VpArbitrary uu___7 in
                              FStar_Pervasives_Native.Some uu___6 in
                            (cid, uu___5, attrs) in
                          ((FStar_Pervasives_Native.Some
                              ((FStarC_Parser_AST.TyconRecord
                                  (record_id, bds,
                                    FStar_Pervasives_Native.None, attrs, r)),
                                (desugar_marker :: d_attrs_initial))),
                            uu___4)
                      | uu___4 ->
                          (FStar_Pervasives_Native.None,
                            (cid, payload, attrs)))) variants in
          FStarC_List.unzip uu___2 in
        (match uu___1 with
         | (additional_records, variants1) ->
             let concat_options = FStarC_List.filter_map (fun r -> r) in
             let uu___2 = concat_options additional_records in
             FStarC_List.op_At uu___2
               [((FStarC_Parser_AST.TyconVariant (id, bds, k, variants1)),
                  d_attrs_initial)])
    | tycon -> [(tycon, d_attrs_initial)] in
  let tcs1 = FStarC_List.concatMap desugar_tycon_variant_record tcs in
  let tot rng1 =
    FStarC_Parser_AST.mk_term
      (FStarC_Parser_AST.Name FStarC_Parser_Const.effect_Tot_lid) rng1
      FStarC_Parser_AST.Expr in
  ...
  let apply_binders t binders =
    ...
    FStarC_List.fold_left
      (fun out b ->
         let uu___ =
           let uu___1 =
             let uu___2 = binder_to_term b in (out, uu___2, (imp_of_aqual b)) in
           FStarC_Parser_AST.App uu___1 in
         FStarC_Parser_AST.mk_term uu___ out.FStarC_Parser_AST.range
           out.FStarC_Parser_AST.level) t binders in
  let tycon_record_as_variant uu___ =
    match uu___ with
    | FStarC_Parser_AST.TyconRecord (id, parms, kopt, attrs, fields) ->
        let constrName =
          let uu___1 =
            let uu___2 =
              let uu___3 = FStarC_Ident.string_of_id id in
              Prims.strcat "Mk" uu___3 in
            let uu___3 = FStarC_Ident.range_of_id id in (uu___2, uu___3) in
        ...
        (FStarC_List.iter
           (fun uu___2 ->
              ...
              | (f, uu___3, uu___4, uu___5) ->
                  let uu___6 =
                    FStarC_Util.for_some
                      (fun i -> FStarC_Ident.ident_equals f i) names in
                  if uu___6
                  then
                    let uu___7 =
                      ...
                      FStarC_Format.fmt1
                        ...
                        uu___8 in
                    FStarC_Errors.raise_error FStarC_Ident.hasrange_ident f
         ...
         (let uu___2 =
            FStarC_List.map
              (fun uu___3 ->
                 match uu___3 with | (f, uu___4, uu___5, uu___6) -> f) fields in
          ((FStarC_Parser_AST.TyconVariant
              (id, parms, kopt,
                [(constrName,
                   (FStar_Pervasives_Native.Some
                      (FStarC_Parser_AST.VpArbitrary constrTyp)), attrs)])),
            uu___2)))
    | uu___1 -> failwith "impossible" in
    ...
    | FStarC_Parser_AST.TyconAbstract (id, binders, kopt) ->
        ...
        (match uu___1 with
         | (_env', typars) ->
             let k =
               match kopt with
               | FStar_Pervasives_Native.None -> FStarC_Syntax_Util.ktype
               | FStar_Pervasives_Native.Some k1 -> desugar_term _env' k1 in
             let tconstr =
               let uu___2 =
                 let uu___3 =
             ...
             let uu___2 =
               FStarC_Syntax_DsEnv.push_top_level_rec_binding _env id in
             (match uu___2 with
              | (_env1, uu___3) ->
                  let uu___4 =
                    FStarC_Syntax_DsEnv.push_top_level_rec_binding _env' id in
  ...
  | (FStarC_Parser_AST.TyconAbstract (id, bs, kopt), d_attrs)::[] ->
      let kopt1 =
        ...
        | FStar_Pervasives_Native.None ->
            let uu___ =
              let uu___1 = FStarC_Ident.range_of_id id in tm_type_z uu___1 in
      ...
      (match uu___ with
       | (uu___1, uu___2, se, uu___3) ->
             ...
             | FStarC_Syntax_Syntax.Sig_inductive_typ
                 ...
                 let t =
                   ...
                   | uu___7 ->
                       let uu___8 =
                         let uu___9 =
                           let uu___10 = FStarC_Syntax_Syntax.mk_Total k in
                           {
           ...
           (env1, [se1]))
  | (FStarC_Parser_AST.TyconAbbrev (id, binders, kopt, t), _d_attrs)::[] ->
       ...
       | (env', typars) ->
           let kopt1 =
             ...
             | FStar_Pervasives_Native.None ->
                 ...
                 if uu___1
                 then FStar_Pervasives_Native.Some FStarC_Syntax_Syntax.teff
           ...
           let quals1 =
             ...
             then quals
               ...
               if t0.FStarC_Parser_AST.level = FStarC_Parser_AST.Formula
               then FStarC_Syntax_Syntax.Logic :: quals
               else quals in
           let qlid = FStarC_Syntax_DsEnv.qualify env id in
           let se =
             if FStarC_List.contains FStarC_Syntax_Syntax.Effect quals1
             then
               let uu___1 =
                 let uu___2 =
                   let uu___3 = unparen t in uu___3.FStarC_Parser_AST.tm in
                 match uu___2 with
                 | FStarC_Parser_AST.Construct (head, args) ->
                     ...
                     (match uu___3 with
                      | (cattributes, args1) ->
                          let uu___4 =
                            FStarC_Parser_AST.mk_term
                              (FStarC_Parser_AST.Construct (head, args1))
                              t.FStarC_Parser_AST.range
                              t.FStarC_Parser_AST.level in
                          let uu___5 = desugar_attributes env cattributes in
                          (uu___4, uu___5))
                 | uu___3 -> (t, []) in
               match uu___1 with
               | (t1, cattributes) ->
                   let c =
                     desugar_comp t1.FStarC_Parser_AST.range false env' t1 in
                   let typars1 = FStarC_Syntax_Subst.close_binders typars in
                   let c1 = FStarC_Syntax_Subst.close_comp typars1 c in
                   let quals2 =
                     FStarC_List.filter
                       (fun uu___2 ->
                          match uu___2 with
                   ...
                   let uu___2 =
                     let uu___3 =
                       let uu___4 =
                         let uu___5 = FStarC_Syntax_Util.comp_flags c1 in
                         FStarC_List.op_At cattributes uu___5 in
                       {
                         FStarC_Syntax_Syntax.lid4 = qlid;
                         FStarC_Syntax_Syntax.us4 = [];
                         FStarC_Syntax_Syntax.bs2 = typars1;
                         FStarC_Syntax_Syntax.comp1 = c1;
                         FStarC_Syntax_Syntax.cflags = uu___4
                       } in
                     FStarC_Syntax_Syntax.Sig_effect_abbrev uu___3 in
                   let uu___3 = FStarC_Ident.range_of_id id in
               ...
               (let t1 = desugar_typ env' t in
                let uu___2 = FStarC_Ident.range_of_id id in
                mk_typ_abbrev env d qlid [] typars kopt1 t1 [qlid] quals1
                  uu___2) in
  ...
  | uu___::uu___1 ->
      ...
      let mutuals =
        FStarC_List.map
          (fun uu___2 ->
             match uu___2 with
             | (x, uu___3) -> FStarC_Syntax_DsEnv.qualify env (tycon_id x))
          tcs1 in
                 ...
                 (match tc with
                           ...
                           let uu___6 =
                             let uu___7 =
                               let uu___8 =
                                 let uu___9 =
                                   let uu___10 =
                                     FStarC_Syntax_DsEnv.current_module env1 in
                                   FStarC_Ident.ids_of_lid uu___10 in
                                 (uu___9, fs) in
                               FStarC_Syntax_Syntax.RecordType uu___8 in
                             uu___7 :: quals1 in
                           collect_tcs uu___6 (env1, tcs2) (t, d_attrs))
                  | FStarC_Parser_AST.TyconVariant
                      (id, binders, kopt, constructors) ->
                      let uu___4 =
                        desugar_abstract_tc quals1 env1 mutuals d_attrs
                  ...
                  | FStarC_Parser_AST.TyconAbbrev (id, binders, kopt, t) ->
                      ...
                      (match uu___4 with
                       | (env2, uu___5, se, tconstr) ->
                           (env2,
                             (((FStar_Pervasives.Inr (se, binders, t, quals1)),
                                d_attrs) :: tcs2)))
                  | uu___4 ->
                      FStarC_Errors.raise_error
      ...
      let uu___2 = FStarC_List.fold_left (collect_tcs quals) (env, []) tcs1 in
      (match uu___2 with
       | (env1, tcs2) ->
           let tcs3 = FStarC_List.rev tcs2 in
           let tps_sigelts =
             FStarC_List.collect
               (fun uu___3 ->
                  match uu___3 with
                  | (tc, d_attrs) ->
                      (match tc with
                       | FStar_Pervasives.Inr
                           ({
                              FStarC_Syntax_Syntax.sigel =
                                ...
                                { FStarC_Syntax_Syntax.lid = id;
                                  ...
                                  FStarC_Syntax_Syntax.params = tpars;
                                  FStarC_Syntax_Syntax.num_uniform_params =
                                    uu___4;
                                  FStarC_Syntax_Syntax.t = k;
                           ...
                           ->
                           let t1 =
                             let uu___14 = typars_of_binders env1 binders in
                             match uu___14 with
                             | (env2, tpars1) ->
                                  ...
                                  | (env_tps, tpars2) ->
                                      ...
                                      let tpars3 =
                                        FStarC_Syntax_Subst.close_binders
                                          tpars2 in
                                      FStarC_Syntax_Subst.close tpars3 t2) in
                           let uu___14 =
                             let uu___15 =
                               let uu___16 = FStarC_Ident.range_of_lid id in
                           ...
                           let mk_tot t =
                             ...
                             FStarC_Parser_AST.mk_term
                               (FStarC_Parser_AST.App
                                  (tot1, t, FStarC_Parser_AST.Nothing))
                               t.FStarC_Parser_AST.range
                               t.FStarC_Parser_AST.level in
                           ...
                           (match uu___10 with
                            | (env_tps, tps) ->
                                ...
                                let uu___11 =
                                         ...
                                         | (id, payload, cons_attrs) ->
                                             ...
                                             let t1 =
                                               let uu___14 =
                                                 FStarC_ToSyntax_TickedVars.close
                                                   env_tps t in
                                               desugar_term env_tps uu___14 in
                                             let name =
                                             ...
                                             let quals2 =
                                               FStarC_List.collect
                                                 ...
                                                 tname_quals in
                                             let ntps =
                                               FStarC_List.length data_tpars in
                                             let t2 =
                                  ...
                                  FStarC_List.split uu___12 in
                                (match uu___11 with
                                 | (constrNames, constrs1) ->
                                     ((let uu___13 =
                                         FStarC_Effect.op_Bang dbg_attrs in
                                       if uu___13
                                       then
                                         let uu___14 =
                                           FStarC_Class_Show.show
                                      ...
                                      (let uu___13 =
                                         let uu___14 =
                                           let uu___15 =
                                             FStarC_Ident.range_of_lid tname in
                                           let uu___16 =
                                             FStarC_Syntax_Util.deduplicate_terms
                                               (FStarC_List.op_At val_attrs
                                                  d_attrs) in
                                           let uu___17 =
                                             FStarC_Syntax_DsEnv.opens_and_abbrevs
                                               env1 in
           ...
           let sigelts =
             FStarC_List.map
               (fun uu___3 -> match uu___3 with | (uu___4, se) -> se)
               tps_sigelts in
           let uu___3 =
             let uu___4 =
               FStarC_List.collect FStarC_Syntax_Util.lids_of_sigelt sigelts in
             FStarC_Syntax_MutRecTy.disentangle_abbrevs_from_bundle sigelts
               quals uu___4 rng in
           (match uu___3 with
            | (bundle, abbrevs) ->
                ((let uu___5 = FStarC_Effect.op_Bang dbg_attrs in
                  if uu___5
                  then
                    let uu___6 =
                      FStarC_Class_Show.show
                 ...
                 (let env2 = FStarC_Syntax_DsEnv.push_sigelt env0 bundle in
                  let env3 =
                    FStarC_List.fold_left FStarC_Syntax_DsEnv.push_sigelt
                      env2 abbrevs in
                  (env3, (FStarC_List.op_At [bundle] abbrevs))))))
  | [] -> failwith "impossible"
let desugar_binders (env : FStarC_Syntax_DsEnv.env)
  (binders : FStarC_Parser_AST.binder Prims.list) :
      ...
      (fun uu___1 b ->
         ...
         | (env1, binders1) ->
             ...
             (match uu___2 with
              ...
              | uu___3 ->
                  FStarC_Errors.raise_error FStarC_Parser_AST.hasRange_binder
                    b FStarC_Errors_Codes.Fatal_MissingNameInBinder ()
                    (Obj.magic FStarC_Errors_Msg.is_error_message_string)
                    (Obj.magic "Missing name in binder"))) (env, []) binders in
  match uu___ with | (env1, binders1) -> (env1, (FStarC_List.rev binders1))
let push_reflect_effect (env : FStarC_Syntax_DsEnv.env)
  (quals : FStarC_Syntax_Syntax.qualifier Prims.list)
  (effect_name : FStarC_Ident.lid) (range : FStarC_Range_Type.range) :
  FStarC_Syntax_DsEnv.env=
  let uu___ =
    FStarC_Util.for_some
      (fun uu___1 ->
...
let parse_attr_with_list (warn : Prims.bool) (at : FStarC_Syntax_Syntax.term)
  (head : FStarC_Ident.lident) :
    ...
    then
      let uu___1 =
        ...
        FStarC_Format.fmt1
          ...
          uu___2 in
      FStarC_Errors.log_issue (FStarC_Syntax_Syntax.has_range_syntax ()) at
            ...
            | (a1, uu___2)::[] ->
                ...
                (match uu___3 with
                 | FStar_Pervasives_Native.Some es ->
                     ((FStar_Pervasives_Native.Some
                         (es, (at.FStarC_Syntax_Syntax.pos))), true)
                 | uu___4 -> (warn1 (); (FStar_Pervasives_Native.None, true)))
            | uu___2 -> (warn1 (); (FStar_Pervasives_Native.None, true)))
       | uu___2 -> (FStar_Pervasives_Native.None, false))
let get_fail_attr1 (warn : Prims.bool) (at : FStarC_Syntax_Syntax.term) :
...
let get_fail_attr (warn : Prims.bool)
  ...
  let comb f1 f2 =
    ...
    | (FStar_Pervasives_Native.Some (e1, rng1, l1),
       FStar_Pervasives_Native.Some (e2, rng2, l2)) ->
        let uu___ =
          let uu___1 = FStarC_Range_Ops.union_ranges rng1 rng2 in
          ((FStarC_List.op_At e1 e2), uu___1, (l1 || l2)) in
        FStar_Pervasives_Native.Some uu___
  ...
  FStarC_List.fold_right
    (fun at acc -> let uu___ = get_fail_attr1 warn at in comb uu___ acc) ats
    FStar_Pervasives_Native.None
let lookup_effect_lid (env : FStarC_Syntax_DsEnv.env)
  (l : FStarC_Ident.lident) (r : FStarC_Range_Type.t) :
  ...
  | FStar_Pervasives_Native.None ->
      let uu___1 =
        let uu___2 =
          let uu___3 = FStarC_Class_Show.show FStarC_Ident.showable_lident l in
...
let trans_pragma (env : env_t) (uu___ : FStarC_Parser_AST.pragma) :
  FStarC_Syntax_Syntax.pragma=
  match uu___ with
...
let rec desugar_effect (env : FStarC_Syntax_DsEnv.env)
  (d : FStarC_Parser_AST.decl)
  (d_attrs : FStarC_Syntax_Syntax.term Prims.list)
  (quals : FStarC_Parser_AST.qualifiers) (is_layered : Prims.bool)
  (eff_name : FStarC_Ident.ident)
  (eff_binders : FStarC_Parser_AST.binder Prims.list)
  (eff_typ : FStarC_Parser_AST.term)
  (eff_decls : FStarC_Parser_AST.decl Prims.list) :
  (FStarC_Syntax_DsEnv.env * FStarC_Syntax_Syntax.sigelt Prims.list)=
  let env0 = env in
  let monad_env = FStarC_Syntax_DsEnv.enter_monad_scope env eff_name in
  ...
  | (env1, binders) ->
      ...
      let num_indices =
        let uu___1 =
          let uu___2 = FStarC_Syntax_Util.arrow_formals eff_t in
          FStar_Pervasives_Native.fst uu___2 in
        FStarC_List.length uu___1 in
      let for_free =
        (num_indices = Prims.int_one) && (Prims.op_Negation is_layered) in
      (if for_free
       then
         (let uu___2 =
            ...
            FStarC_Format.fmt1
              ...
              uu___3 in
          FStarC_Errors.log_issue FStarC_Parser_AST.hasRange_decl d
            FStarC_Errors_Codes.Warning_DeprecatedGeneric ()
            (Obj.magic FStarC_Errors_Msg.is_error_message_string)
            (Obj.magic uu___2))
       else ();
       (let mandatory_members =
        ...
        let name_of_eff_decl decl =
          ...
          | FStarC_Parser_AST.Tycon
              (uu___2, uu___3, (FStarC_Parser_AST.TyconAbbrev
               (name, uu___4, uu___5, uu___6))::[])
              -> FStarC_Ident.string_of_id name
          | uu___2 -> failwith "Malformed effect member declaration." in
        let uu___2 =
          FStarC_List.partition
            (fun decl ->
               let uu___3 = name_of_eff_decl decl in
               FStarC_List.mem uu___3 mandatory_members) eff_decls in
        match uu___2 with
            ...
            let uu___3 =
              FStarC_List.fold_left
                (fun uu___4 decl ->
                   match uu___4 with
                   | (env2, out) ->
                       let uu___5 = desugar_decl env2 decl in
                       (match uu___5 with
                        | (env3, ses) ->
                            let uu___6 =
                              let uu___7 = FStarC_List.hd ses in uu___7 ::
                                out in
                            (env3, uu___6))) (env1, [])
                mandatory_members_decls in
            (match uu___3 with
             | (env2, decls) ->
                 let binders1 = FStarC_Syntax_Subst.close_binders binders in
                 let actions1 =
                   FStarC_List.map
                     (fun d1 ->
                        match d1.FStarC_Parser_AST.d with
                        | FStarC_Parser_AST.Tycon
                            (uu___4, uu___5, (FStarC_Parser_AST.TyconAbbrev
                             (name, action_params, uu___6,
                              {
                                FStarC_Parser_AST.tm =
                                  FStarC_Parser_AST.Construct
                                  (uu___7,
                                   (def, uu___8)::(cps_type, uu___9)::[]);
                                FStarC_Parser_AST.range = uu___10;
                                FStarC_Parser_AST.level = uu___11;_}))::[])
                            when Prims.op_Negation for_free ->
                            let uu___12 = desugar_binders env2 action_params in
                            (match uu___12 with
                             | (env3, action_params1) ->
                                 let action_params2 =
                                   FStarC_Syntax_Subst.close_binders
                                     action_params1 in
                                 let uu___13 =
                                   FStarC_Syntax_DsEnv.qualify env3 name in
                                 let uu___14 =
                                   let uu___15 = desugar_term env3 def in
                                   FStarC_Syntax_Subst.close
                                     (FStarC_List.op_At binders1
                                        action_params2) uu___15 in
                                 let uu___15 =
                                   let uu___16 = desugar_typ env3 cps_type in
                                   FStarC_Syntax_Subst.close
                                     (FStarC_List.op_At binders1
                                        action_params2) uu___16 in
                                 {
                                   FStarC_Syntax_Syntax.action_name = uu___13;
                                   FStarC_Syntax_Syntax.action_unqualified_name
                                     = name;
                                   FStarC_Syntax_Syntax.action_univs = [];
                                   FStarC_Syntax_Syntax.action_params =
                                     action_params2;
                                   FStarC_Syntax_Syntax.action_defn = uu___14;
                                   FStarC_Syntax_Syntax.action_typ = uu___15
                                 })
                        | FStarC_Parser_AST.Tycon
                            (uu___4, uu___5, (FStarC_Parser_AST.TyconAbbrev
                             (name, action_params, uu___6, defn))::[])
                            when for_free || is_layered ->
                            let uu___7 = desugar_binders env2 action_params in
                            (match uu___7 with
                             | (env3, action_params1) ->
                                 let action_params2 =
                                   FStarC_Syntax_Subst.close_binders
                                 ...
                                 let uu___8 =
                                   FStarC_Syntax_DsEnv.qualify env3 name in
                                 let uu___9 =
                                   let uu___10 = desugar_term env3 defn in
                                   FStarC_Syntax_Subst.close
                                     (FStarC_List.op_At binders1
                                        action_params2) uu___10 in
                                 {
                                   FStarC_Syntax_Syntax.action_name = uu___8;
                                   FStarC_Syntax_Syntax.action_unqualified_name
                                     = name;
                                   FStarC_Syntax_Syntax.action_univs = [];
                                   FStarC_Syntax_Syntax.action_params =
                                     action_params2;
                                   FStarC_Syntax_Syntax.action_defn = uu___9;
                     ...
                     actions in
                 let eff_t1 = FStarC_Syntax_Subst.close binders1 eff_t in
                 let lookup s =
                   let l =
                     let uu___4 =
                       FStarC_Ident.mk_ident
                         (s, (d.FStarC_Parser_AST.drange)) in
                     FStarC_Syntax_DsEnv.qualify env2 uu___4 in
                   let uu___4 =
                     let uu___5 =
                       FStarC_Syntax_DsEnv.fail_or env2
                         (FStarC_Syntax_DsEnv.try_lookup_definition env2) l in
                     FStarC_Syntax_Subst.close binders1 uu___5 in
                   ([], uu___4) in
                 let mname = FStarC_Syntax_DsEnv.qualify env0 eff_name in
                 let qualifiers =
                   FStarC_List.map
                     (trans_qual d.FStarC_Parser_AST.drange
                        (FStar_Pervasives_Native.Some mname)) quals in
                 let dummy_tscheme = ([], FStarC_Syntax_Syntax.tun) in
                 let uu___4 =
                   if for_free
                   then
                     let uu___5 =
                       let uu___6 =
                         ...
                         {
                           FStarC_Syntax_Syntax.ret_wp = dummy_tscheme;
                           FStarC_Syntax_Syntax.bind_wp = dummy_tscheme;
                           FStarC_Syntax_Syntax.stronger = dummy_tscheme;
                           FStarC_Syntax_Syntax.if_then_else = dummy_tscheme;
                           FStarC_Syntax_Syntax.ite_wp = dummy_tscheme;
                           FStarC_Syntax_Syntax.close_wp = dummy_tscheme;
                           FStarC_Syntax_Syntax.trivial = dummy_tscheme;
                     ...
                     ((FStarC_Syntax_Syntax.WP_eff_sig ([], eff_t1)), uu___5)
                   else
                     if is_layered
                     then
                       (let has_subcomp =
                          FStarC_List.existsb
                            (fun decl ->
                               let uu___6 = name_of_eff_decl decl in
                               uu___6 = "subcomp") eff_decls in
                        let has_if_then_else =
                          FStarC_List.existsb
                            (fun decl ->
                               let uu___6 = name_of_eff_decl decl in
                               uu___6 = "if_then_else") eff_decls in
                        let has_close =
                          FStarC_List.existsb
                            (fun decl ->
                               let uu___6 = name_of_eff_decl decl in
                        ...
                        let uu___6 =
                          let uu___7 =
                            let uu___8 = FStarC_Syntax_Subst.compress eff_t1 in
                        ...
                        | (eff_t2, num_effect_params) ->
                            let uu___7 =
                              let uu___8 =
                                let uu___9 =
                                  let uu___10 = lookup "repr" in
                                  (uu___10, dummy_tscheme) in
                                let uu___10 =
                                  let uu___11 = lookup "return" in
                                  (uu___11, dummy_tscheme) in
                                let uu___11 =
                                  let uu___12 = lookup "bind" in
                                  to_comb uu___12 in
                                let uu___12 =
                                  if has_subcomp
                                  then
                                    let uu___13 = lookup "subcomp" in
                                    to_comb uu___13
                                  else
                                    (dummy_tscheme, dummy_tscheme,
                                      FStar_Pervasives_Native.None) in
                                let uu___13 =
                                  if has_if_then_else
                                  then
                                    let uu___14 = lookup "if_then_else" in
                                    to_comb uu___14
                                  else
                                    (dummy_tscheme, dummy_tscheme,
                                      FStar_Pervasives_Native.None) in
                                let uu___14 =
                                  ...
                                  then
                                    let uu___15 =
                                      let uu___16 = lookup "close" in
                                      (uu___16, dummy_tscheme) in
                                    FStar_Pervasives_Native.Some uu___15
                                  else FStar_Pervasives_Native.None in
                                {
                                  FStarC_Syntax_Syntax.l_repr = uu___9;
                                  FStarC_Syntax_Syntax.l_return = uu___10;
                                  FStarC_Syntax_Syntax.l_bind = uu___11;
                                  FStarC_Syntax_Syntax.l_subcomp = uu___12;
                                  FStarC_Syntax_Syntax.l_if_then_else =
                                    uu___13;
                                  FStarC_Syntax_Syntax.l_close = uu___14
                                } in
                              FStarC_Syntax_Syntax.Layered_eff uu___8 in
                            ((FStarC_Syntax_Syntax.Layered_eff_sig
                                (num_effect_params, ([], eff_t2))), uu___7))
                     else
                       (let rr =
                          FStarC_Util.for_some
                            (fun uu___7 ->
                               ...
                               | FStarC_Syntax_Syntax.Reflectable uu___8 ->
                                   true
                               | uu___8 -> false) qualifiers in
                        let uu___7 =
                          let uu___8 =
                            let uu___9 = lookup "return_wp" in
                            let uu___10 = lookup "bind_wp" in
                            let uu___11 = lookup "stronger" in
                            let uu___12 = lookup "if_then_else" in
                            ...
                            let uu___18 =
                              ...
                              then
                                ...
                                FStar_Pervasives_Native.Some uu___19
                              else FStar_Pervasives_Native.None in
                            {
                              FStarC_Syntax_Syntax.ret_wp = uu___9;
                              FStarC_Syntax_Syntax.bind_wp = uu___10;
                              FStarC_Syntax_Syntax.stronger = uu___11;
                              FStarC_Syntax_Syntax.if_then_else = uu___12;
                              FStarC_Syntax_Syntax.ite_wp = uu___13;
                              FStarC_Syntax_Syntax.close_wp = uu___14;
                              FStarC_Syntax_Syntax.trivial = uu___15;
                              FStarC_Syntax_Syntax.repr = uu___16;
                              FStarC_Syntax_Syntax.return_repr = uu___17;
                              FStarC_Syntax_Syntax.bind_repr = uu___18
                            } in
                          FStarC_Syntax_Syntax.Primitive_eff uu___8 in
                 ...
                 (match uu___4 with
                  | (eff_sig, combinators) ->
                      let extraction_mode =
                        if is_layered
                        then FStarC_Syntax_Syntax.Extract_none ""
                        else
                          if for_free
                          then
                            (let uu___6 =
                               FStarC_Util.for_some
                                 (fun uu___7 ->
                                    ...
                                    | uu___8 -> false) qualifiers in
                             if uu___6
                             then FStarC_Syntax_Syntax.Extract_reify
                             else FStarC_Syntax_Syntax.Extract_primitive)
                          else FStarC_Syntax_Syntax.Extract_primitive in
                      let sigel =
                        FStarC_Syntax_Syntax.Sig_new_effect
                          {
                            ...
                            FStarC_Syntax_Syntax.signature = eff_sig;
                            FStarC_Syntax_Syntax.combinators = combinators;
                            FStarC_Syntax_Syntax.actions = actions1;
                            FStarC_Syntax_Syntax.eff_attrs = d_attrs;
                            FStarC_Syntax_Syntax.extraction_mode =
                              extraction_mode
                          } in
                      let se =
                        let uu___5 =
                          FStarC_Syntax_DsEnv.opens_and_abbrevs env2 in
                        {
                          FStarC_Syntax_Syntax.sigel = sigel;
                          FStarC_Syntax_Syntax.sigrng =
                            (d.FStarC_Parser_AST.drange);
                          FStarC_Syntax_Syntax.sigquals = qualifiers;
                          FStarC_Syntax_Syntax.sigmeta =
                            FStarC_Syntax_Syntax.default_sigmeta;
                          FStarC_Syntax_Syntax.sigattrs = d_attrs;
                      ...
                      let env3 = FStarC_Syntax_DsEnv.push_sigelt env0 se in
                      let env4 =
                        FStarC_List.fold_left
                          (fun env5 a ->
                             let uu___5 =
                               FStarC_Syntax_Util.action_as_lb mname a
                                 (a.FStarC_Syntax_Syntax.action_defn).FStarC_Syntax_Syntax.pos in
                             FStarC_Syntax_DsEnv.push_sigelt env5 uu___5)
                          env3 actions1 in
                      let env5 =
                        push_reflect_effect env4 qualifiers mname
                          d.FStarC_Parser_AST.drange in
                      (env5, [se])))))
and desugar_redefine_effect (env : FStarC_Syntax_DsEnv.env)
  (d : FStarC_Parser_AST.decl)
  (d_attrs : FStarC_Syntax_Syntax.attribute Prims.list)
  (trans_qual1 :
    FStarC_Ident.lident FStar_Pervasives_Native.option ->
      FStarC_Parser_AST.qualifier -> FStarC_Syntax_Syntax.qualifier)
  (quals : FStarC_Parser_AST.qualifier Prims.list)
  (eff_name : FStarC_Ident.ident)
  (eff_binders : FStarC_Parser_AST.binder Prims.list)
  (defn : FStarC_Parser_AST.term) :
  (FStarC_Syntax_DsEnv.env * FStarC_Syntax_Syntax.sigelt Prims.list)=
  let env0 = env in
        ...
        | (head, args) ->
            let lid =
              ...
              | uu___3 ->
                  let uu___4 =
                    let uu___5 =
                      let uu___6 = FStarC_Parser_AST.term_to_string head in
                      Prims.strcat uu___6 " not found" in
            ...
            let ed =
              FStarC_Syntax_DsEnv.fail_or env2
                (FStarC_Syntax_DsEnv.try_lookup_effect_defn env2) lid in
            let uu___3 =
              match FStarC_List.rev args with
              | (last_arg, uu___4)::args_rev ->
                  let uu___5 =
            ...
            (match uu___3 with
             | (cattributes, args1) ->
                 ...
                 let uu___5 = desugar_attributes env2 cattributes in
      ...
      (match uu___1 with
       | (ed_lid, ed, args, cattributes) ->
           ...
           (if
            ...
            then
              FStarC_Errors.raise_error FStarC_Parser_AST.hasRange_term defn
            ...
            (let uu___3 =
             ...
             | (ed_binders, uu___4, ed_binders_opening) ->
                 let sub' shift_n uu___5 =
                   ...
                   | (us, x) ->
                       let x1 =
                         let uu___6 =
                           FStarC_Syntax_Subst.shift_subst
                             (shift_n + (FStarC_List.length us))
                             ed_binders_opening in
                         FStarC_Syntax_Subst.subst uu___6 x in
                       let s =
                         FStarC_Syntax_Util.subst_of_list ed_binders args in
                       let uu___6 =
                         let uu___7 = FStarC_Syntax_Subst.subst s x1 in
                         (us, uu___7) in
                       FStarC_Syntax_Subst.close_tscheme binders1 uu___6 in
                 ...
                 let ed1 =
                   let uu___5 =
                     FStarC_Syntax_Util.apply_eff_sig sub
                       ed.FStarC_Syntax_Syntax.signature in
                   let uu___6 =
                     FStarC_Syntax_Util.apply_eff_combinators sub
                     ...
                     FStarC_List.map
                       (fun action ->
                            ...
                            FStar_Pervasives_Native.snd uu___11 in
                          {
                            ...
                            FStarC_Syntax_Syntax.action_defn = uu___9;
                            FStarC_Syntax_Syntax.action_typ = uu___10
                          }) ed.FStarC_Syntax_Syntax.actions in
                   {
                     FStarC_Syntax_Syntax.mname = mname;
                     FStarC_Syntax_Syntax.cattributes = cattributes;
                     FStarC_Syntax_Syntax.univs =
                 ...
                 let se =
                   let uu___5 =
                     let uu___6 =
                       trans_qual1 (FStar_Pervasives_Native.Some mname) in
                     FStarC_List.map uu___6 quals in
                   let uu___6 = FStarC_Syntax_DsEnv.opens_and_abbrevs env2 in
                   {
                     FStarC_Syntax_Syntax.sigel =
                   ...
                   FStarC_List.fold_left
                     (fun env5 a ->
                        let uu___5 =
                          FStarC_Syntax_Util.action_as_lb mname a
                            (a.FStarC_Syntax_Syntax.action_defn).FStarC_Syntax_Syntax.pos in
                        FStarC_Syntax_DsEnv.push_sigelt env5 uu___5) env3
                     ed1.FStarC_Syntax_Syntax.actions in
                 let env5 =
                   if
                     FStarC_List.contains FStarC_Parser_AST.Reflectable quals
                   then
                     let reflect_lid =
                       let uu___5 = FStarC_Ident.id_of_text "reflect" in
                       FStarC_Syntax_DsEnv.qualify monad_env uu___5 in
                     let quals1 =
                       [FStarC_Syntax_Syntax.Assumption;
                       FStarC_Syntax_Syntax.Reflectable mname] in
                     let refl_decl =
                       let uu___5 =
                         FStarC_Syntax_DsEnv.opens_and_abbrevs env4 in
                       {
                         FStarC_Syntax_Syntax.sigel =
                           (FStarC_Syntax_Syntax.Sig_declare_typ
                              {
                     ...
                     FStarC_Syntax_DsEnv.push_sigelt env4 refl_decl
                   else env4 in
                 (env5, [se]))))
and desugar_decl_maybe_fail_attr (env : FStarC_Syntax_DsEnv.env)
  (d : FStarC_Parser_AST.decl) (attrs : FStarC_Syntax_Syntax.term Prims.list)
  : (env_t * FStarC_Syntax_Syntax.sigelts)=
  let no_fail_attrs ats =
    FStarC_List.filter
      (fun at ->
         let uu___ = get_fail_attr1 false at in
         FStar_Pervasives_Native.uu___is_None uu___) ats in
  let uu___ =
        ...
        let d1 =
          {
            ...
            FStarC_Parser_AST.interleaved = (d.FStarC_Parser_AST.interleaved)
          } in
        let uu___2 =
         ...
         | (errs, r) ->
             (match (errs, r) with
              | ([], FStar_Pervasives_Native.Some (env1, ses)) ->
                  ...
                  let se =
                    let uu___3 = FStarC_Syntax_DsEnv.opens_and_abbrevs env1 in
                    {
                      FStarC_Syntax_Syntax.sigel =
                        (FStarC_Syntax_Syntax.Sig_fail
                           {
              ...
              | (errs1, ropt) ->
                  ...
                  ((let uu___4 = FStarC_Options.print_expected_failures () in
                    if uu___4
                    then FStarC_Errors.print_expected_failures errs1
                    else ());
                   if expected_errs = []
                   then (env0, [])
                   else
                           ...
                           (let uu___8 =
                              let uu___9 =
                                ...
                                let uu___11 =
                                  let uu___12 =
                                    let uu___13 =
                                      FStarC_Errors_Msg.text "but it raised" in
                                    let uu___14 =
                                      let uu___15 =
                                        FStarC_Class_Ord.sort
...
and desugar_decl (env : env_t) (d : FStarC_Parser_AST.decl) :
  (env_t * FStarC_Syntax_Syntax.sigelts)=
  ...
  (let attrs = FStarC_List.map (desugar_term env) d.FStarC_Parser_AST.attrs in
   ...
   let uu___1 = desugar_decl_maybe_fail_attr env d attrs1 in
   match uu___1 with
   | (env1, ses) ->
       let ses1 =
         let uu___2 =
           FStarC_Syntax_Util.has_attribute attrs1
             FStarC_Parser_Const.admitted_lid in
         if uu___2
         then
           FStarC_List.map
             (fun se ->
                {
                  ...
                  FStarC_Syntax_Syntax.sigquals =
                    (se.FStarC_Syntax_Syntax.sigquals);
                  FStarC_Syntax_Syntax.sigmeta =
                    (let uu___3 = se.FStarC_Syntax_Syntax.sigmeta in
                     {
       ...
       let uu___2 = FStarC_List.map generalize_annotated_univs ses1 in
       (env1, uu___2))
and desugar_decl_core (env : FStarC_Syntax_DsEnv.env)
  (d_attrs : FStarC_Syntax_Syntax.term Prims.list)
  (d : FStarC_Parser_AST.decl) : (env_t * FStarC_Syntax_Syntax.sigelts)=
  ...
  | FStarC_Parser_AST.Pragma p ->
      ...
      (FStarC_Syntax_Util.process_pragma p1 d.FStarC_Parser_AST.drange;
       (let se =
          let uu___1 = FStarC_Syntax_DsEnv.opens_and_abbrevs env in
          {
            FStarC_Syntax_Syntax.sigel = (FStarC_Syntax_Syntax.Sig_pragma p1);
  ...
  | FStarC_Parser_AST.Tycon (is_effect, typeclass, tcs) ->
      ...
      let quals1 =
        if is_effect then FStarC_Parser_AST.Effect_qual :: quals else quals in
      let quals2 =
        if typeclass
        then
          match tcs with
          ...
          | uu___ ->
              FStarC_Errors.raise_error FStarC_Parser_AST.hasRange_decl d
                FStarC_Errors_Codes.Error_BadClassDecl ()
                (Obj.magic FStarC_Errors_Msg.is_error_message_string)
                (Obj.magic
      ...
      let uu___ =
        let uu___1 =
          FStarC_List.map (trans_qual1 FStar_Pervasives_Native.None) quals2 in
        desugar_tycon env d d_attrs uu___1 tcs in
      (match uu___ with
       | (env1, ses) ->
           ((let uu___2 = FStarC_Effect.op_Bang dbg_attrs in
             if uu___2
             then
               let uu___3 =
            ...
            (let mkclass lid =
             ...
             let rec get_meths se =
               ...
               | FStarC_Syntax_Syntax.Sig_datacon
                   ...
                   ->
                   let uu___8 = FStarC_Syntax_Util.arrow_formals t in
                   (match uu___8 with
                    | (bs, uu___9) ->
                        let uu___10 = FStarC_List.splitAt num_ty_params bs in
                        (match uu___10 with
                         | (uu___11, bs1) ->
                             let bs2 = FStarC_Syntax_Util.name_binders bs1 in
                             FStarC_List.concatMap
                               (fun b ->
                                  let id =
                                    (b.FStarC_Syntax_Syntax.binder_bv).FStarC_Syntax_Syntax.ppname in
                                  let uu___12 =
                                    FStarC_Syntax_DsEnv.qualify env1 id in
                                  [uu___12]) bs2))
               | uu___2 -> [] in
             let formals =
               let bndl =
                 FStarC_Util.try_find
                   (fun uu___2 ->
                      ...
                      | {
                          ...
                          FStarC_Syntax_Syntax.sigopts = uu___9;_} -> true
                      | uu___3 -> false) ses in
               match bndl with
               | FStar_Pervasives_Native.None -> FStar_Pervasives_Native.None
             ...
             let rec splice_decl meths se =
               ...
               | FStarC_Syntax_Syntax.Sig_bundle
                   { FStarC_Syntax_Syntax.ses = ses1;
                     FStarC_Syntax_Syntax.lids = uu___2;_}
                   -> FStarC_List.concatMap (splice_decl meths) ses1
               | FStarC_Syntax_Syntax.Sig_inductive_typ
                   { FStarC_Syntax_Syntax.lid = lid;
                   ...
                   let uu___8 =
                     ...
                     let uu___10 = FStarC_Syntax_DsEnv.opens_and_abbrevs env1 in
                     {
             ...
             let uu___2 =
               if typeclass
               then
                 let meths = FStarC_List.concatMap get_meths ses in
                 let rec add_class_attr se =
                   ...
                   | FStarC_Syntax_Syntax.Sig_bundle
                       ...
                       ->
                       let ses2 = FStarC_List.map add_class_attr ses1 in
                       let uu___3 =
                         let uu___4 =
                           let uu___5 =
                             FStarC_Syntax_Syntax.fvar_with_dd
                   ...
                   | uu___3 -> se in
                 let uu___3 = FStarC_List.map add_class_attr ses in
                 let uu___4 = FStarC_List.concatMap (splice_decl meths) ses in
                 (uu___3, uu___4)
               else (ses, []) in
             match uu___2 with
             | (ses1, extra) ->
                 let env2 =
                   FStarC_List.fold_left FStarC_Syntax_DsEnv.push_sigelt env1
                     extra in
  ...
  | FStarC_Parser_AST.TopLevelLet (isrec, lets) ->
      ...
      then
        let lets1 =
          FStarC_List.map (fun x -> (FStar_Pervasives_Native.None, x)) lets in
        let qual =
          match isrec with
          | FStarC_Parser_AST.NoLetQualifier ->
              FStarC_Parser_AST.LocalNoLetQualifier
          | FStarC_Parser_AST.Rec -> FStarC_Parser_AST.LocalRec in
        let as_inner_let =
          let uu___ =
            let uu___1 =
              let uu___2 =
                     ...
                     FStarC_List.fold_right
                       (fun fv uu___5 ->
                          ...
                          | (qs, ats) ->
                              ...
                              (match uu___6 with
                               | (qs', ats') ->
                                   ((FStarC_List.rev_append qs' qs),
                                     (FStarC_List.rev_append ats' ats)))) fvs
                       ([], []) in
                   (match uu___4 with
                    | (val_quals, val_attrs) ->
                        let top_attrs =
                          FStarC_Syntax_Util.deduplicate_terms
                            (FStarC_List.rev_append val_attrs d_attrs) in
                        let lbs1 =
                          let uu___5 = lbs in
                          match uu___5 with
                          | (isrec1, lbs0) ->
                        ...
                        let names =
                          FStarC_List.map
                            (fun fv -> fv.FStarC_Syntax_Syntax.fv_name) fvs in
                        let s =
                          let uu___5 =
                        ...
                        (env1, [s]))
               | uu___3 -> failwith "Desugaring a let did not produce a let")))
      else
        (let uu___1 =
           match lets with
           | (pat, body)::[] -> (pat, body)
         ...
         | (pat, body) ->
             ...
             let main_let =
               let quals1 =
                 if
                   FStarC_List.mem FStarC_Parser_AST.Private
                         ...
                         let bv_pat1 =
                           let uu___4 =
                             let uu___5 =
                               let uu___6 =
                                 let uu___7 =
                                   let uu___8 = FStarC_Ident.range_of_id id in
                                   unit_ty uu___8 in
                                 (uu___7, FStar_Pervasives_Native.None) in
                               (bv_pat, uu___6) in
                          ...
                          FStarC_Parser_AST.mk_term
                            (FStarC_Parser_AST.Match
                               (main, FStar_Pervasives_Native.None,
                                 FStar_Pervasives_Native.None,
                                 [(pat, FStar_Pervasives_Native.None, branch)]))
               ...
               FStarC_Class_Setlike.elems ()
                 (Obj.magic
                    (FStarC_FlatSet.setlike_flat_set
                       FStarC_Syntax_Syntax.ord_ident)) (Obj.magic uu___2) in
             let uu___2 =
               (FStarC_List.isEmpty bvs) &&
                 (let uu___3 = is_var_pattern pat in Prims.op_Negation uu___3) in
             if uu___2
             then build_coverage_check main_let
             else FStarC_List.fold_left build_projection main_let bvs)
      ...
      let uu___ =
        let uu___1 =
          let uu___2 = FStarC_Syntax_DsEnv.opens_and_abbrevs env in
          {
            ...
            FStarC_Syntax_Syntax.sigrng = (d.FStarC_Parser_AST.drange);
            FStarC_Syntax_Syntax.sigquals = [FStarC_Syntax_Syntax.Assumption];
            FStarC_Syntax_Syntax.sigmeta =
              FStarC_Syntax_Syntax.default_sigmeta;
            FStarC_Syntax_Syntax.sigattrs = d_attrs;
  ...
  | FStarC_Parser_AST.Val (id, t) ->
      ...
      let se =
        let uu___ =
          FStarC_List.map (trans_qual1 FStar_Pervasives_Native.None) quals1 in
        let uu___1 = FStarC_Syntax_DsEnv.opens_and_abbrevs env in
        {
          FStarC_Syntax_Syntax.sigel =
            (FStarC_Syntax_Syntax.Sig_declare_typ
  ...
  | FStarC_Parser_AST.Exception (id, t_opt) ->
      let t =
        ...
        | FStar_Pervasives_Native.Some term ->
            ...
            let uu___ =
              let uu___1 = FStarC_Syntax_Syntax.null_binder t1 in [uu___1] in
            let uu___1 =
              let uu___2 =
                FStarC_Syntax_DsEnv.fail_or env
                  (FStarC_Syntax_DsEnv.try_lookup_lid env)
            ...
            (FStarC_Syntax_Syntax.Sig_datacon
               {
                 ...
                 FStarC_Syntax_Syntax.us1 = [];
                 FStarC_Syntax_Syntax.t1 = t;
                 FStarC_Syntax_Syntax.ty_lid = FStarC_Parser_Const.exn_lid;
  ...
  | FStarC_Parser_AST.NewEffect (FStarC_Parser_AST.DefineEffect
      ...
      let quals = d.FStarC_Parser_AST.quals in
      desugar_effect env d d_attrs quals false eff_name eff_binders eff_typ
        eff_decls
  | FStarC_Parser_AST.LayeredEffect (FStarC_Parser_AST.DefineEffect
      (eff_name, eff_binders, eff_typ, eff_decls)) ->
      let quals = d.FStarC_Parser_AST.quals in
      desugar_effect env d d_attrs quals true eff_name eff_binders eff_typ
        eff_decls
  | FStarC_Parser_AST.LayeredEffect (FStarC_Parser_AST.RedefineEffect uu___)
      ->
      failwith
      ...
      then
        let uu___1 =
          ...
          | FStarC_Parser_AST.NonReifiableLift t ->
              let uu___2 =
                let uu___3 = let uu___4 = desugar_term env t in ([], uu___4) in
                FStar_Pervasives_Native.Some uu___3 in
              (uu___2, FStar_Pervasives_Native.None)
          | FStarC_Parser_AST.ReifiableLift (wp, t) ->
              let uu___2 =
                let uu___3 = let uu___4 = desugar_term env wp in ([], uu___4) in
                FStar_Pervasives_Native.Some uu___3 in
              let uu___3 =
                let uu___4 = let uu___5 = desugar_term env t in ([], uu___5) in
                FStar_Pervasives_Native.Some uu___4 in
              (uu___2, uu___3)
  ...
  | FStarC_Parser_AST.Polymonadic_bind (m_eff, n_eff, p_eff, bind) ->
      ...
      let uu___ =
        let uu___1 =
          let uu___2 =
            let uu___3 =
              let uu___4 = let uu___5 = desugar_term env bind in ([], uu___5) in
              {
                FStarC_Syntax_Syntax.m_lid = (m.FStarC_Syntax_Syntax.mname);
                FStarC_Syntax_Syntax.n_lid = (n.FStarC_Syntax_Syntax.mname);
                FStarC_Syntax_Syntax.p_lid = (p.FStarC_Syntax_Syntax.mname);
                FStarC_Syntax_Syntax.tm3 = uu___4;
                FStarC_Syntax_Syntax.typ = ([], FStarC_Syntax_Syntax.tun);
                FStarC_Syntax_Syntax.kind1 = FStar_Pervasives_Native.None
              } in
        ...
        let uu___1 =
          let uu___2 =
            let uu___3 =
              ...
              {
                FStarC_Syntax_Syntax.m_lid1 = (m.FStarC_Syntax_Syntax.mname);
                FStarC_Syntax_Syntax.n_lid1 = (n.FStarC_Syntax_Syntax.mname);
                FStarC_Syntax_Syntax.tm4 = uu___4;
                FStarC_Syntax_Syntax.typ1 = ([], FStarC_Syntax_Syntax.tun);
                FStarC_Syntax_Syntax.kind2 = FStar_Pervasives_Native.None
              } in
  ...
  | FStarC_Parser_AST.Splice (is_typed, ids, t) ->
      ...
      let se =
        let uu___ =
          let uu___1 =
            let uu___2 =
              FStarC_List.map (FStarC_Syntax_DsEnv.qualify env) ids1 in
            {
              FStarC_Syntax_Syntax.is_typed = is_typed;
        ...
        let uu___1 =
          FStarC_List.map (trans_qual1 FStar_Pervasives_Native.None)
            d.FStarC_Parser_AST.quals in
        let uu___2 = FStarC_Syntax_DsEnv.opens_and_abbrevs env in
        {
  ...
  | FStarC_Parser_AST.DeclSyntaxExtension
      ...
      (match extension_parser with
       | FStar_Pervasives_Native.None ->
           let uu___1 =
             FStarC_Format.fmt1 "Unknown syntax extension %s" extension_name in
           FStarC_Errors.raise_error FStarC_Class_HasRange.hasRange_range
             range FStarC_Errors_Codes.Fatal_SyntaxError ()
             (Obj.magic FStarC_Errors_Msg.is_error_message_string)
             (Obj.magic uu___1)
       | FStar_Pervasives_Native.Some parser ->
           let opens =
             let uu___1 = FStarC_Syntax_DsEnv.open_modules_and_namespaces env in
           ...
           (match uu___1 with
            ...
            | FStar_Pervasives.Inr d' ->
                let quals =
                  FStarC_List.op_At d'.FStarC_Parser_AST.quals
                    d.FStarC_Parser_AST.quals in
                let attrs =
      ...
      (match uu___ with
       ...
       | FStar_Pervasives_Native.Some desugar ->
           let mk_sig sigel =
             ...
             se in
           let lids =
             FStarC_List.map (FStarC_Syntax_DsEnv.qualify env)
           ...
           let env1 =
             FStarC_List.fold_left FStarC_Syntax_DsEnv.push_sigelt env
               sigelts in
           (env1, sigelts))
let desugar_decls (env : env_t) (decls : FStarC_Parser_AST.decl Prims.list) :
  (env_t * FStarC_Syntax_Syntax.sigelt Prims.list)=
  FStarC_Stats.record "desugar_decls"
    (fun uu___ ->
       let uu___1 =
         FStarC_List.fold_left
           (fun uu___2 d ->
              match uu___2 with
              | (env1, sigelts) ->
                  let uu___3 = desugar_decl env1 d in
                  (match uu___3 with
                   | (env2, se) ->
                       (env2, (FStarC_List.rev_append se sigelts))))
           (env, []) decls in
       match uu___1 with
       | (env1, sigelts) -> (env1, (FStarC_List.rev sigelts)))
let desugar_modul_common
  (curmod : FStarC_Syntax_Syntax.modul FStar_Pervasives_Native.option)
  (env : FStarC_Syntax_DsEnv.env) (m : FStarC_Parser_AST.modul) :
  ...
  let uu___ =
    ...
    | FStarC_Parser_AST.Interface
        ...
        ->
        let uu___1 =
          FStarC_Syntax_DsEnv.prepare_module_or_interface true admitted env1
            mname FStarC_Syntax_DsEnv.default_mii in
    ...
    | FStarC_Parser_AST.Module
        ...
        ->
        let uu___1 =
          FStarC_Syntax_DsEnv.prepare_module_or_interface false false env1
            mname FStarC_Syntax_DsEnv.default_mii in
...
let desugar_partial_modul
  (curmod : FStarC_Syntax_Syntax.modul FStar_Pervasives_Native.option)
  (env : env_t) (m : FStarC_Parser_AST.modul) :
  (env_t * FStarC_Syntax_Syntax.modul)=
  let m1 =
    let uu___ =
      (FStarC_Options.interactive ()) &&
        (let uu___1 =
...
let desugar_modul (env : FStarC_Syntax_DsEnv.env)
  (m : FStarC_Parser_AST.modul) : (env_t * FStarC_Syntax_Syntax.modul)=
  let uu___ =
    let uu___1 =
  ...
  FStarC_Errors.with_ctx uu___
    (fun uu___1 ->
       let uu___2 = desugar_modul_common FStar_Pervasives_Native.None env m in
       match uu___2 with
       | (env1, modul, pop_when_done) ->
           let uu___3 =
...
let ast_modul_to_modul (modul : FStarC_Parser_AST.modul) :
...
let decls_to_sigelts (decls : FStarC_Parser_AST.decl Prims.list) :
...
let partial_ast_modul_to_modul
  (modul : FStarC_Syntax_Syntax.modul FStar_Pervasives_Native.option)
  (a_modul : FStarC_Parser_AST.modul) :
  FStarC_Syntax_Syntax.modul FStarC_Syntax_DsEnv.withenv=
  fun env ->
    with_options
      (fun uu___ ->
...
let add_modul_to_env_core (finish : Prims.bool)
  (m : FStarC_Syntax_Syntax.modul)
  (mii : FStarC_Syntax_DsEnv.module_inclusion_info)
  (erase_univs : FStarC_Syntax_Syntax.term -> FStarC_Syntax_Syntax.term) :
  ...
  fun en ->
    let erase_univs_ed ed =
      ...
      let uu___ =
        ...
        FStarC_Syntax_Subst.open_term' uu___1 FStarC_Syntax_Syntax.t_unit in
      match uu___ with
      | (binders, uu___1, binders_opening) ->
          let erase_term t =
            let uu___2 =
              let uu___3 = FStarC_Syntax_Subst.subst binders_opening t in
          ...
          let erase_tscheme uu___2 =
            ...
            | (us, t) ->
                let t1 =
                  let uu___3 =
                    FStarC_Syntax_Subst.shift_subst (FStarC_List.length us)
                      binders_opening in
          ...
          let erase_action action =
            let opening =
              FStarC_Syntax_Subst.shift_subst
                (FStarC_List.length action.FStarC_Syntax_Syntax.action_univs)
                binders_opening in
            let erased_action_params =
              ...
              | uu___2 ->
                  ...
                  let uu___3 =
                    let uu___4 =
                      let uu___5 = FStarC_Syntax_Subst.close binders t in
            ...
            let erase_term1 t =
              let uu___2 =
                ...
                erase_univs uu___3 in
              FStarC_Syntax_Subst.close binders uu___2 in
            let uu___2 = erase_term1 action.FStarC_Syntax_Syntax.action_defn in
            let uu___3 = erase_term1 action.FStarC_Syntax_Syntax.action_typ in
            {
              ...
              FStarC_Syntax_Syntax.action_unqualified_name =
                (action.FStarC_Syntax_Syntax.action_unqualified_name);
              FStarC_Syntax_Syntax.action_univs = [];
              FStarC_Syntax_Syntax.action_params = erased_action_params;
          ...
          let uu___4 =
            FStarC_Syntax_Util.apply_eff_combinators erase_tscheme
              ed.FStarC_Syntax_Syntax.combinators in
          let uu___5 =
            FStarC_List.map erase_action ed.FStarC_Syntax_Syntax.actions in
          {
            FStarC_Syntax_Syntax.mname = (ed.FStarC_Syntax_Syntax.mname);
            FStarC_Syntax_Syntax.cattributes =
              (ed.FStarC_Syntax_Syntax.cattributes);
    ...
    let push_sigelt env se =
      ...
      | FStarC_Syntax_Syntax.Sig_new_effect ed ->
          ...
          push_reflect_effect env1 se.FStarC_Syntax_Syntax.sigquals
            ed.FStarC_Syntax_Syntax.mname se.FStarC_Syntax_Syntax.sigrng
