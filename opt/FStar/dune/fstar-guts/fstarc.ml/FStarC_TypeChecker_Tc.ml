...
let run_postprocess (for_extraction : Prims.bool)
  ...
  | (attrs, pt, on_type) ->
      ...
      let se2 =
        ...
        | uu___1 -> se1 in
      se2
let tc_sig_let (env : FStarC_TypeChecker_Env.env)
  (r : FStarC_Range_Type.range) (se : FStarC_Syntax_Syntax.sigelt)
  ...
  let check_quals_eq l qopt val_q =
    match qopt with
    | FStar_Pervasives_Native.None -> FStar_Pervasives_Native.Some val_q
                     ...
                     let uu___8 =
                       let uu___9 =
                         let uu___10 =
                           FStarC_Class_Show.show
                             (FStarC_Class_Show.show_list
                                FStarC_Syntax_Print.showable_qualifier) q'1 in
                       ...
                       let uu___8 =
                         let uu___9 =
                           let uu___10 =
                             FStarC_Class_Show.show
                               (FStarC_Class_Show.show_list
                                  FStarC_Syntax_Print.showable_qualifier) d1 in
                           FStar_Pprint.arbitrary_string uu___10 in
                         FStar_Pprint.squotes uu___9 in
      ...
      (fun uu___1 lb ->
         ...
         | (gen, lbs1, quals_opt) ->
             ...
             let uu___2 =
               ...
               match uu___3 with
               | FStar_Pervasives_Native.None -> (gen, lb, quals_opt)
               | FStar_Pervasives_Native.Some ((uvs, tval), quals) ->
                   let quals_opt1 =
                     check_quals_eq lbname.FStarC_Syntax_Syntax.fv_name
                       quals_opt quals in
                   let def =
             ...
             (match uu___2 with
              | (gen1, lb1, quals_opt1) -> (gen1, (lb1 :: lbs1), quals_opt1)))
      (true, [],
        (if se.FStarC_Syntax_Syntax.sigquals = []
         then FStar_Pervasives_Native.None
         else FStar_Pervasives_Native.Some (se.FStarC_Syntax_Syntax.sigquals)))
      (FStar_Pervasives_Native.snd lbs) in
  match uu___ with
                ...
                FStarC_Util.for_some
                  (fun uu___3 ->
                     ...
                     | FStarC_Syntax_Syntax.Unfold_for_unification_and_vcgen
                         -> true
                     | uu___4 -> false) q in
              if uu___2 then q else FStarC_Syntax_Syntax.Visible_default :: q in
                     ...
                     (let lbs2 =
                      ...
                      let quals1 =
                        ...
                        | FStarC_Syntax_Syntax.Tm_meta
                            ...
                            -> FStarC_Syntax_Syntax.HasMaskedEffect :: quals
                        | uu___10 -> quals in
                      ({
                         FStarC_Syntax_Syntax.sigel =
                           (FStarC_Syntax_Syntax.Sig_let
...
let tc_more_partial_modul (env : FStarC_TypeChecker_Env.env)
  ...
  | (ses, env1) ->
      ...
      (modul1, ses, env1)
let finish_partial_modul (loading_from_cache : Prims.bool)
  (iface_exists : Prims.bool) (en : FStarC_TypeChecker_Env.env)
