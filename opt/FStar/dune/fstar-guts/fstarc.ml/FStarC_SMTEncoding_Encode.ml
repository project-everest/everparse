...
let encode_free_var (uninterpreted : Prims.bool)
  ...
  let uu___ =
    ((let uu___1 =
      ...
      Prims.op_Negation uu___1) || (FStarC_Syntax_Util.is_lemma t_norm)) ||
      uninterpreted in
  if uu___
  then
    let arg_sorts =
      ...
      | FStarC_Syntax_Syntax.Tm_arrow
          ...
          ->
          FStarC_List.map (fun uu___3 -> FStarC_SMTEncoding_Term.Term_sort)
            binders
      | uu___2 -> [] in
    let arity = FStarC_List.length arg_sorts in
    let uu___1 =
      FStarC_SMTEncoding_Env.new_term_constant_and_tok_from_lid env lid arity in
    match uu___1 with
    | (vname, vtok, env1) ->
        let d =
          FStarC_SMTEncoding_Term.DeclFun
        ...
        let uu___2 = FStarC_SMTEncoding_Term.mk_decls_trivial [d; dd] in
        (uu___2, env1)
  else
    (let uu___2 = prims.is lid in
     ...
     then
       let vname =
         FStarC_SMTEncoding_Env.varops.FStarC_SMTEncoding_Env.new_fvar lid in
       let uu___3 = prims.mk lid vname in
       match uu___3 with
       | (tok, arity, definition) ->
           let env1 =
             FStarC_SMTEncoding_Env.push_free_var env lid arity vname
               (FStar_Pervasives_Native.Some tok) in
           let uu___4 = FStarC_SMTEncoding_Term.mk_decls_trivial definition in
           (uu___4, env1)
     else
       (let encode_non_total_function_typ =
          let uu___4 = FStarC_Ident.nsstr lid in uu___4 <> "Prims" in
        let uu___4 =
          let uu___5 =
            FStarC_SMTEncoding_EncodeTerm.curried_arrow_formals_comp t_norm in
          match uu___5 with
          | (args, comp) ->
              let tcenv_comp =
              ...
              then
                ...
                (let uu___7 =
                   let uu___8 = FStarC_Syntax_Util.comp_result comp1 in
              ...
              FStarC_List.collect
                (fun uu___5 ->
                   ...
                   | FStarC_Syntax_Syntax.Discriminator d ->
                       let uu___6 = FStarC_Util.prefix vars in
                       (match uu___6 with
                        | (uu___7, xxv) ->
                            let xx =
                              let uu___8 =
                                let uu___9 =
                                  ...
                                  (uu___10,
                                    FStarC_SMTEncoding_Term.Term_sort) in
                                FStarC_SMTEncoding_Term.mk_fv uu___9 in
                                      ...
                                      let uu___14 =
                                        let uu___15 =
                                          ...
                                          FStarC_SMTEncoding_Term.boxBool
                                            uu___16 in
                                        (vapp, uu___15) in
                                      FStarC_SMTEncoding_Util.mkEq uu___14 in
                                    ([[vapp]], vars, uu___13) in
                                  FStarC_SMTEncoding_Term.mkForall uu___11
                                    uu___12 in
                                let uu___11 =
                                  let uu___12 =
                                    let uu___13 =
                                      FStarC_Ident.string_of_lid d in
                                    FStarC_SMTEncoding_Env.escape uu___13 in
                                  Prims.strcat "disc_equation_" uu___12 in
                                (uu___10,
                                  (FStar_Pervasives_Native.Some
                                     "Discriminator equation"), uu___11) in
                   ...
                   | FStarC_Syntax_Syntax.Projector (d, f) ->
                       ...
                       (match uu___6 with
                        | (uu___7, xxv) ->
                            ...
                            let tp_name =
                              FStarC_SMTEncoding_Env.mk_term_projector_name d
                                f1 in
                            let prim_app =
                              FStarC_SMTEncoding_Util.mkApp (tp_name, [xx]) in
                            let uu___8 =
                              let uu___9 =
                                let uu___10 =
                                  let uu___11 =
            ...
            (match uu___5 with
             | (vars, guards, env', decls1, uu___6) ->
                 let uu___7 =
                   match pre_opt with
                   | FStar_Pervasives_Native.None ->
                       let uu___8 = FStarC_SMTEncoding_Util.mk_and_l guards in
                       (uu___8, decls1)
                   | FStar_Pervasives_Native.Some p ->
                       let uu___8 =
                         FStarC_SMTEncoding_EncodeTerm.encode_formula p env' in
                       (match uu___8 with
                        | (g, ds) ->
                            let uu___9 =
                              FStarC_SMTEncoding_Util.mk_and_l (g :: guards) in
                            (uu___9, (FStarC_List.op_At decls1 ds))) in
                 (match uu___7 with
                  | (guard, decls11) ->
                      let dummy_var =
                        FStarC_SMTEncoding_Term.mk_fv
                      ...
                      let should_thunk uu___8 =
                        let is_type t =
                          ...
                          match uu___9 with
                          | FStarC_Syntax_Syntax.Tm_type uu___10 -> true
                          | uu___10 -> false in
                        let is_squash t =
                          let uu___9 = FStarC_Syntax_Util.head_and_args t in
                          match uu___9 with
                          | (head, uu___10) ->
                              let uu___11 =
                                let uu___12 =
                                     ...
                                     FStarC_Syntax_Syntax.b =
                                       {
                                         FStarC_Syntax_Syntax.ppname =
                                           uu___12;
                                         FStarC_Syntax_Syntax.index = uu___13;
                                         FStarC_Syntax_Syntax.sort =
                                           {
                                             ...
                                             FStarC_Syntax_Syntax.hash_code =
                                               uu___16;_};_};
                                     FStarC_Syntax_Syntax.phi = uu___17;_}
                                   ->
                                   FStarC_Syntax_Syntax.fv_eq_lid fv1
                            ...
                            | (vname, vtok_opt, env1) ->
                                ...
                                let vapp =
                                  let uu___10 =
                                    let uu___11 =
                                      FStarC_List.map
                                        FStarC_SMTEncoding_Util.mkFreeV vars1 in
                                    (vname, uu___11) in
                                  ...
                                  let vname_decl =
                                    let uu___11 =
                                      ...
                                      (vname, uu___12,
                                        ...
                                        FStar_Pervasives_Native.None) in
                                    FStarC_SMTEncoding_Term.DeclFun uu___11 in
                                  let uu___11 =
                                    let env2 =
                                      {
                                        FStarC_SMTEncoding_Env.bvar_bindings
                                    ...
                                    then
                                      FStarC_SMTEncoding_EncodeTerm.encode_term_pred
                                        FStar_Pervasives_Native.None tt env2
                                        vtok_tm
                                    else
                                      FStarC_SMTEncoding_EncodeTerm.encode_term_pred
                                        FStar_Pervasives_Native.None t_norm
                                        env2 vtok_tm in
                                  match uu___11 with
                                  | (tok_typing, decls2) ->
                                      let uu___12 =
                                        ...
                                        | [] ->
                                            ...
                                            let uu___14 =
                                              ...
                                              FStarC_SMTEncoding_Env.push_free_var
                                                env1 lid arity vname uu___15 in
                                            (uu___13, uu___14)
                                ...
                                (match uu___10 with
                                 | (decls2, env2) ->
                                     let uu___11 =
                                       let res_t1 =
                                         FStarC_Syntax_Subst.compress res_t in
                                       let uu___12 =
                                       ...
                                       | (encoded_res_t, decls) ->
                                           ...
                                           (encoded_res_t, uu___13, decls) in
                                     (match uu___11 with
                                      | (encoded_res_t, ty_pred, decls3) ->
                                                ...
                                                let uu___15 =
                                                  let uu___16 =
                                                    FStarC_SMTEncoding_Util.mkImp
                                                      (guard, ty_pred) in
                                                  ([[vapp]], vars1, uu___16) in
                                                FStarC_SMTEncoding_Term.mkForall
                                                  uu___14 uu___15 in
                                              (uu___13,
                                                (FStar_Pervasives_Native.Some
                                                   "free var typing"),
                                                (Prims.strcat "typing_" vname)) in
                                            FStarC_SMTEncoding_Util.mkAssume
                                              uu___12 in
                                          let freshness =
                                            if
                                          ...
                                          let g =
                                            let uu___12 =
                                              ...
                                              FStarC_List.op_At decls2
                                                uu___13 in
                                            FStarC_List.op_At decls11 uu___12 in
                                          (g, env2)))))))))
...
let encode_top_level_val (uninterpreted : Prims.bool)
  (env : FStarC_SMTEncoding_Env.env_t) (us : FStarC_Syntax_Syntax.univ_names)
  ...
  | (decls, env1) ->
      ...
      then
        let uu___2 =
          ...
          FStarC_List.op_At decls uu___3 in
        (uu___2, env1)
      else (decls, env1)
    ...
    FStarC_List.fold_left
      (fun uu___1 lb ->
         ...
         | (decls, env1) ->
             ...
             (match uu___2 with
              | (decls', env2) ->
                  ((FStarC_List.rev_append decls' decls), env2))) ([], env)
      bindings in
                               ...
                               (let t_norm =
                                ...
                                let uu___7 =
                                  declare_top_level_let env1
                                    (FStar_Pervasives.__proj__Inr__item__v
                                       lb.FStarC_Syntax_Syntax.lbname)
                                    lb.FStarC_Syntax_Syntax.lbtyp t_norm in
                                match uu___7 with
                                | (tok, decl, env2) ->
                                    ((tok :: toks), (t_norm :: typs), (decl
                                      :: decls), env2)))) ([], [], [], env)
                       bindings in
                   match uu___4 with
                   | (toks, typs, decls, env1) ->
                                   ...
                                   let uu___12 =
                                     ...
                                     | (tcenv', uu___14, e_t) ->
                                         let uu___15 =
                                           match e_t with
                                           | e1::t_norm1::[] -> (e1, t_norm1)
                                           | uu___16 -> failwith "Impossible" in
                                         (match uu___15 with
                                          | (e1, t_norm1) ->
                                              ({
                                                 FStarC_SMTEncoding_Env.bvar_bindings
                         ...
                         (try
                            (fun uu___7 ->
                               ...
                               | () ->
                                   ...
                                   then
                                     encode_non_rec_lbdef bindings typs1
                                       toks_fvbs env1
                                   else
                          ...
                          | FStarC_SMTEncoding_Env.Inner_let_rec names ->
                              let plural =
                                (FStarC_List.length names) > Prims.int_one in
                              let r =
                                let uu___8 = FStarC_List.hd names in
        ...
        let uu___3 =
          FStarC_Util.for_some
            (fun l ->
               ...
               FStar_Pervasives_Native.uu___is_None uu___4) datas in
        if uu___3
        then []
        else
          (let uu___5 =
               ...
               let uu___6 =
                 FStarC_List.fold_left
                   (fun uu___7 l ->
                      ...
                      | (out, decls) ->
                          let is_l =
                            FStarC_SMTEncoding_Env.mk_data_tester env1 l xx in
                          let uu___8 =
                            let uu___9 =
                            ...
                            then
                              ...
                              | (uu___11, data_t) ->
                                  let uu___12 =
                                    FStarC_Syntax_Util.arrow_formals data_t in
                                  (match uu___12 with
                                   | (args, res) ->
                                       let indices =
                                         let uu___13 =
                                       ...
                                       (match uu___13 with
                                        | (indices1, decls') ->
                                            (if
                                               (FStarC_List.length indices1)
                                                 <> (FStarC_List.length vars)
                          ...
                          (match uu___8 with
                           | (inversion_case, decls') ->
                               ...
                               (uu___9, (FStarC_List.op_At decls decls'))))
                     ...
                     | (ffsym, ff) ->
                         let fuel_guarded_inversion =
                           let xx_has_type_sfuel =
                             if (FStarC_List.length datas) > Prims.int_one
                             then
                               let uu___8 =
                                 FStarC_SMTEncoding_Util.mkApp
                                   ("SFuel", [ff]) in
                               FStarC_SMTEncoding_Term.mk_HasTypeFuel uu___8
                                 xx tapp
                             else
                               FStarC_SMTEncoding_Term.mk_HasTypeFuel ff xx
                                 tapp in
                           let uu___8 =
                             let uu___9 =
                                     ...
                                     let uu___15 =
                                       FStarC_SMTEncoding_Term.mk_fv
                                         (xxsym,
                                           FStarC_SMTEncoding_Term.Term_sort) in
                                     uu___15 :: vars in
                                   FStarC_SMTEncoding_Env.add_fuel uu___13
                                     uu___14 in
                                 let uu___13 =
                                   FStarC_SMTEncoding_Util.mkImp
                                     (xx_has_type_sfuel, data_ax) in
                                 ([[xx_has_type_sfuel]], uu___12, uu___13) in
                               FStarC_SMTEncoding_Term.mkForall uu___10
                                 uu___11 in
                             let uu___10 =
                               let uu___11 =
                                 let uu___12 = FStarC_Ident.string_of_lid t in
                         ...
                         FStarC_List.op_At decls uu___8))) in
      let uu___3 =
        let k1 =
          match tps with
          | [] -> k
       ...
       | (formals, res) ->
           ...
           (match uu___4 with
            | (vars, guards, env', binder_decls, uu___5) ->
                ...
                (match uu___6 with
                 | (tname, ttok, env1) ->
                     let ttok_tm = FStarC_SMTEncoding_Util.mkApp (ttok, []) in
                       ...
                       let tname_decl =
                         let uu___8 =
                             ...
                             FStar_Pervasives_Native.Some uu___11 in
                           {
                             ...
                             FStarC_SMTEncoding_Term.constr_fields = uu___9;
                       ...
                       let uu___8 =
                         ...
                         | [] ->
                             let uu___9 =
                               let uu___10 =
                                 let uu___11 =
                                   FStarC_SMTEncoding_Util.mkApp (tname, []) in
                                 FStar_Pervasives_Native.Some uu___11 in
                               FStarC_SMTEncoding_Env.push_free_var env1 t
                         ...
                         | uu___9 ->
                             ...
                             let ttok_fresh =
                               ...
                               FStarC_SMTEncoding_Term.fresh_token
                                 (ttok, FStarC_SMTEncoding_Term.Term_sort)
                                 uu___10 in
                             let ttok_app =
                               FStarC_SMTEncoding_EncodeTerm.mk_Apply ttok_tm
                                 vars in
                             let pats = [[ttok_app]; [tapp]] in
                             let name_tok_corr =
                               let uu___10 =
                                 let uu___11 =
                                   let uu___12 = FStarC_Ident.range_of_lid t in
                                   let uu___13 =
                                     let uu___14 =
                                       FStarC_SMTEncoding_Util.mkEq
                                         (ttok_app, tapp) in
                                     (pats, FStar_Pervasives_Native.None,
                                       vars, uu___14) in
                                   FStarC_SMTEncoding_Term.mkForall' uu___12
                                     uu___13 in
                                 (uu___11,
                                   (FStar_Pervasives_Native.Some
                                      "name-token correspondence"),
                                   (Prims.strcat "token_correspondence_" ttok)) in
                               FStarC_SMTEncoding_Util.mkAssume uu___10 in
                             ([ttok_decl; ttok_fresh; name_tok_corr], env1) in
                       match uu___8 with
                       | (tok_decls, env2) ->
                           ((FStarC_List.op_At tname_decl tok_decls), env2) in
                     (match uu___7 with
                      | (decls, env2) ->
                          let kindingAx =
                            let uu___8 =
                              FStarC_SMTEncoding_EncodeTerm.encode_term_pred
                                FStar_Pervasives_Native.None res env' tapp in
                            match uu___8 with
                            | (k1, decls1) ->
                                let karr =
                                  if
                                    ...
                                    let uu___9 =
                                      let uu___10 =
                                        ...
                                        (uu___11,
                                          (FStar_Pervasives_Native.Some
                                             "kinding"),
                                          (Prims.strcat "pre_kinding_" ttok)) in
                                      FStarC_SMTEncoding_Util.mkAssume
                                        uu___10 in
                                    [uu___9]
                                  else [] in
                                ...
                                let tot_fun_axioms =
                                  let uu___9 =
                                    FStarC_List.map
                                      (fun uu___10 ->
                                         FStarC_SMTEncoding_Util.mkTrue) vars in
                                  FStarC_SMTEncoding_EncodeTerm.isTotFun_axioms
                                    ...
                                    let uu___11 =
                                      let uu___12 =
                                        ...
                                        FStarC_SMTEncoding_Util.mkAssume
                                          uu___13 in
                                      [uu___12] in
                                    FStarC_List.op_At karr uu___11 in
                                  FStarC_SMTEncoding_Term.mk_decls_trivial
                                    uu___10 in
                                FStarC_List.op_At decls1 uu___9 in
                          let aux =
                            let uu___8 =
                              let uu___9 = inversion_axioms env2 tapp vars in
                              let uu___10 =
                                let uu___11 =
                                  let uu___12 =
                                    let uu___13 = FStarC_Ident.range_of_lid t in
                                    pretype_axiom
                                      (Prims.op_Negation
                                         injective_type_params) uu___13 env2
                                      tapp vars in
                                  [uu___12] in
                                FStarC_SMTEncoding_Term.mk_decls_trivial
                                  uu___11 in
                              FStarC_List.op_At uu___9 uu___10 in
                            FStarC_List.op_At kindingAx uu___8 in
                          let uu___8 =
                            let uu___9 =
  ...
  | FStarC_Syntax_Syntax.Sig_datacon
      ...
      (match uu___3 with
       | (formals, t_res) ->
           let arity = FStarC_List.length formals in
           let uu___4 =
             FStarC_SMTEncoding_Env.new_term_constant_and_tok_from_lid env d
               arity in
           (match uu___4 with
            | (ddconstrsym, ddtok, env1) ->
                ...
                (match uu___5 with
                 | (fuel_var, fuel_tm) ->
                     ...
                     let uu___6 =
                       FStarC_SMTEncoding_EncodeTerm.encode_binders
                         (FStar_Pervasives_Native.Some fuel_tm) formals env1 in
                     (match uu___6 with
                      | (vars, guards, env', binder_decls, names) ->
                            ...
                            FStarC_List.mapi
                              (fun n x ->
                                 let field_projectible =
                                   (n >= n_tps) || injective_type_params1 in
                                 let uu___7 =
                                   FStarC_SMTEncoding_Env.mk_term_projector_name
                                     d x in
                                 {
                          ...
                          let datacons =
                            let uu___7 = FStarC_Ident.range_of_lid d in
                            let uu___8 =
                              let uu___9 =
                                let uu___10 =
                                  FStarC_SMTEncoding_Env.varops.FStarC_SMTEncoding_Env.next_id
                                ...
                                FStar_Pervasives_Native.Some uu___10 in
                              {
                                ...
                                FStarC_SMTEncoding_Term.constr_sort =
                                  FStarC_SMTEncoding_Term.Term_sort;
                                FStarC_SMTEncoding_Term.constr_id = uu___9;
                                FStarC_SMTEncoding_Term.constr_base =
                                  (Prims.op_Negation injective_type_params1)
                              } in
                            FStarC_SMTEncoding_Term.constructor_to_decl
                              uu___7 uu___8 in
                          let app =
                            FStarC_SMTEncoding_EncodeTerm.mk_Apply ddtok_tm
                              vars in
                          let guard = FStarC_SMTEncoding_Util.mk_and_l guards in
                          let xvars =
                            FStarC_List.map FStarC_SMTEncoding_Util.mkFreeV
                          ...
                          let uu___7 =
                            FStarC_SMTEncoding_EncodeTerm.encode_term_pred
                              FStar_Pervasives_Native.None t1 env1 ddtok_tm in
                          (match uu___7 with
                           | (tok_typing, decls3) ->
                               let tok_typing1 =
                                 match fields with
                                 | uu___8::uu___9 ->
                                     ...
                                     let uu___11 =
                                       let uu___12 =
                                         FStarC_SMTEncoding_Term.mk_NoHoist f
                                           tok_typing in
                                                               ...
                                                               | (data_arg_params,
                                                                  uu___23) ->
                                                                   ...
                                                                   let uu___24
                                                                    ...
                                                                    FStarC_Syntax_Subst.compress
                                                                    t3 in
                                                                    uu___32.FStarC_Syntax_Syntax.n in
                                                                    match uu___31
                                                                    with
                                                                    | 
                                                                    FStarC_Syntax_Syntax.Tm_arrow
                                         ...
                                         let g =
                                           let uu___10 =
                                             let uu___11 =
                                               ...
                                               FStarC_List.op_At decls3
                                                 uu___12 in
                                             FStarC_List.op_At decls2 uu___11 in
                                           FStarC_List.op_At binder_decls
                                             uu___10 in
                                         let uu___10 =
                                           let uu___11 =
                                             FStarC_SMTEncoding_Term.mk_decls_trivial
                                               datacons in
                                           FStarC_List.op_At uu___11 g in
                                         (uu___10, env1))))))))
       ...
       then ([], env)
         ...
         (let close_effect_params tm =
            ...
            | uu___3 ->
                ...
                FStarC_Syntax_Syntax.mk uu___4 tm.FStarC_Syntax_Syntax.pos in
          let encode_action env1 a =
            ...
            | (formals, uu___4) ->
                ...
                (match uu___5 with
                 | (aname, atok, env2) ->
                     let uu___6 =
                       FStarC_SMTEncoding_EncodeTerm.encode_term action_defn
                         env2 in
                     (match uu___6 with
                      | (tm, decls) ->
                          let a_decls =
                            ...
                            [uu___7;
                            FStarC_SMTEncoding_Term.DeclFun
                              (atok, [], FStarC_SMTEncoding_Term.Term_sort,
                                (FStar_Pervasives_Native.Some "Action token"))] in
                          let uu___7 =
                            let aux uu___8 uu___9 =
                              ...
                              | ({ FStarC_Syntax_Syntax.binder_bv = bv;
                                 ...
                                 (env3, acc_sorts, acc)) ->
                                  let uu___13 =
                                    FStarC_SMTEncoding_Env.gen_term_var env3
                                      bv in
                                  (match uu___13 with
                                   | (xxsym, xx, env4) ->
                                       let uu___14 =
                            ...
                            FStarC_List.fold_right aux formals (env2, [], []) in
                          (match uu___7 with
                           | (uu___8, xs_sorts, xs) ->
                               let app =
                                 FStarC_SMTEncoding_Util.mkApp (aname, xs) in
                               let a_eq =
                                 let uu___9 =
                                   let uu___10 =
                                     let uu___11 =
         ...
         (let fv =
          ...
          | (decls, env1) ->
              ...
              let uu___3 =
                let uu___4 =
                  let uu___5 =
                    primitive_type_axioms env1.FStarC_SMTEncoding_Env.tcenv
                      lid tname tsym in
                  FStarC_SMTEncoding_Term.mk_decls_trivial uu___5 in
   ...
   | FStarC_Syntax_Syntax.Sig_let
       ...
       let uu___9 =
         FStarC_SMTEncoding_Env.new_term_constant_and_tok_from_lid env
           b2t.FStarC_Syntax_Syntax.fv_name Prims.int_one in
       (match uu___9 with
        | (tname, ttok, env1) ->
            let xx =
              FStarC_SMTEncoding_Term.mk_fv
   ...
   | FStarC_Syntax_Syntax.Sig_let
       ...
       let bindings1 =
         FStarC_List.map
           (fun lb ->
              let def =
                norm_before_encoding_us env lb.FStarC_Syntax_Syntax.lbunivs
    ...
    | (i, decls, env1) ->
        (match b with
         ...
         | FStarC_Syntax_Syntax.Binding_lid (x, (uu___1, t)) ->
             ...
             let fv =
               FStarC_Syntax_Syntax.lid_as_fv x FStar_Pervasives_Native.None in
             let uu___2 = encode_free_var false env1 fv t t_norm [] in
             (match uu___2 with
              | (g, env') ->
                  ((i + Prims.int_one), (FStarC_List.op_At decls g), env'))) in
  let uu___ =
...
let snapshot_env (uu___ : unit) : (Prims.int * unit)=
  FStarC_Common.snapshot push_env last_env ()
let rollback_env (depth : Prims.int FStar_Pervasives_Native.option) : 
  unit= FStarC_Common.rollback pop_env last_env depth
...
let snapshot_encoding (msg : Prims.string) : encoding_depth=
  FStarC_Util.atomically
    (fun uu___ ->
       ...
       | (env_depth, ()) ->
           let uu___2 =
             FStarC_SMTEncoding_Env.varops.FStarC_SMTEncoding_Env.snapshot () in
           (match uu___2 with
         ...
         (let uu___1 =
          ...
          | FStar_Pervasives_Native.None ->
              (FStarC_SMap.add env.FStarC_SMTEncoding_Env.global_cache
                 (FStar_Pervasives_Native.__proj__Some__item__v
                    elt.FStarC_SMTEncoding_Term.key) elt;
               [elt]))) decls
                ...
                FStarC_List.fold_left
                  (fun uu___6 se ->
                     ...
                     | (g, env2) ->
                         ...
                         (match uu___7 with
                          | (g', env3) ->
                              ((FStarC_List.rev_append g' g), env3)))
                  ([], env1) ses in
              match uu___5 with | (g', env2) -> ((FStarC_List.rev g'), env2) in
            let uu___5 =
              encode_signature
                {
                  FStarC_SMTEncoding_Env.bvar_bindings =
        ...
        | (q1, bindings) ->
            ...
            (match uu___3 with
             | (env_decls, env1) ->
                 ((let uu___5 =
                     ((FStarC_Debug.medium ()) ||
                        (FStarC_Effect.op_Bang dbg_SMTEncoding))
