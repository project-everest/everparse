...
let simplify_guard (env : FStarC_TypeChecker_Env.env)
...
let simplify_guard_full_norm (env : FStarC_TypeChecker_Env.env)
  (g : FStarC_TypeChecker_Common.guard_t) :
  FStarC_TypeChecker_Common.guard_t=
  match g.FStarC_TypeChecker_Common.guard_f with
  | FStarC_TypeChecker_Common.Trivial -> g
...
let teq (env : FStarC_TypeChecker_Env.env) (t1 : FStarC_Syntax_Syntax.typ)
  ...
  | FStar_Pervasives_Native.Some g ->
      ((let uu___2 =
       ...
       g)
let get_teq_predicate (env : FStarC_TypeChecker_Env.env)
  (t1 : FStarC_Syntax_Syntax.typ) (t2 : FStarC_Syntax_Syntax.typ) :
  FStarC_TypeChecker_Common.guard_t FStar_Pervasives_Native.option=
  (let uu___1 =
  ...
  then
    (let uu___1 =
       let uu___2 =
         ...
         let uu___4 = FStarC_Class_PP.pp FStarC_Syntax_Print.pretty_term vc in
                 ...
                 (if debug && did_anything
                  then
                    (let uu___6 =
                       ...
                       [uu___7] in
                     diag FStarC_Errors_Msg.is_error_message_list_doc uu___6)
                  else ();
                  (let vcs2 =
                     FStarC_List.map
                       (fun uu___6 ->
     ...
     then
       FStarC_List.collect
         (fun uu___2 ->
            match uu___2 with
            | (env1, goal, opts) ->
                let uu___3 = FStarC_TypeChecker_Env.split_smt_query env1 goal in
                (match uu___3 with
                 ...
                 | FStar_Pervasives_Native.Some goals ->
                     FStarC_List.map
                       (fun uu___4 ->
                          match uu___4 with
                          | (env2, goal1) -> (env2, goal1, opts)) goals)) vcs
     else vcs in
   FStarC_List.iter
     (fun uu___1 ->
        match uu___1 with
               ...
               then
                 (if is_tac
                  then FStarC_TypeChecker_Env.trivial_guard
                    ...
                    (let imp_tm1 =
                       let uu___4 =
                         let uu___5 = FStarC_Syntax_Subst.compress imp_tm in
                         uu___5.FStarC_Syntax_Syntax.n in
                       match uu___4 with
                       | FStarC_Syntax_Syntax.Tm_abs
                           { FStarC_Syntax_Syntax.bs = bs;
                     ...
                     match uu___4 with
                     | (k', g1) ->
                         let uu___5 = get_subtyping_predicate env1 k' uvar_ty in
                         (match uu___5 with
                          | FStar_Pervasives_Native.None ->
                              FStarC_TypeChecker_Err.expected_expression_of_type
                                env1 imp_tm1.FStarC_Syntax_Syntax.pos uvar_ty
                                imp_tm1 k'
                              ...
                              let uu___6 =
                                let uu___7 =
                                  FStarC_TypeChecker_Env.apply_guard f
                                    imp_tm1 in
                                FStarC_TypeChecker_Env.conj_guard uu___7 g1 in
                              {
                                FStarC_TypeChecker_Common.guard_f =
                                  FStarC_TypeChecker_Common.Trivial;
                                FStarC_TypeChecker_Common.deferred_to_tac =
                 ...
                 (let uu___4 =
                  ...
                  | FStar_Pervasives.Inl (FStar_Pervasives_Native.None) ->
                      FStarC_TypeChecker_Common.trivial_guard
                  | FStar_Pervasives.Inl (FStar_Pervasives_Native.Some g1) ->
                      {
                        FStarC_TypeChecker_Common.guard_f =
               ...
               discharge_guard'
                 (FStar_Pervasives_Native.Some
                    (fun uu___5 ->
                       ...
                       FStarC_Format.fmt4
                         "%s (Introduced at %s for %s resolved at %s)" uu___6
                         uu___7 imp_reason uu___8)) env1 g true in
             match uu___4 with
             | FStar_Pervasives_Native.Some g1 -> g1
             | FStar_Pervasives_Native.None ->
                 failwith
