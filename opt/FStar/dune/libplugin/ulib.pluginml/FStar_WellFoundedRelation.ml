...
let uu___is_AccClassicalIntro :
  'a 'r . 'a -> ('a, 'r, Obj.t) acc_classical -> Prims.bool =
  fun x -> fun projectee -> true
let __proj__AccClassicalIntro__item__access_smaller :
  'a 'r .
    'a ->
      ('a, 'r, Obj.t) acc_classical -> 'a -> ('a, 'r, Obj.t) acc_classical
  =
  fun x ->
    fun projectee ->
...
let __proj__Mkwfr_t__item__decreaser :
  'a . 'a wfr_t -> 'a -> ('a, Obj.t, Obj.t) acc_classical =
  fun projectee ->
...
let lex_dep_wfr :
  'a 'b .
    'a wfr_t ->
      ('a -> 'b wfr_t) -> ('a, 'b) Fstarcompiler.Prims.dtuple2 wfr_t
  =
  fun wfr_a ->
    fun a_to_wfr_b ->
      {
