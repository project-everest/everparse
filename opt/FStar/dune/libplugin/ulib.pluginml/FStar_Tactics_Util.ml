  ...
  fun uu___2 uu___1 uu___ ->
    (fun i f x ->
       ...
       | a1::tl ->
           Obj.magic
             (Obj.repr
                (fun ps -> f i a1 ps; iteri_aux (i + Prims.int_one) f tl ps)))
      uu___2 uu___1 uu___
...
let rec fold_left :
  ...
  fun uu___2 uu___1 uu___ ->
    (fun f x l ->
       ...
       | hd::tl ->
           Obj.magic
             (Obj.repr (fun ps -> let x1 = f x hd ps in fold_left f x1 tl ps)))
      uu___2 uu___1 uu___
let rec fold_right :
  'a 'b .
  ...
  fun uu___2 uu___1 uu___ ->
    (fun f l x ->
       ...
       | hd::tl ->
           Obj.magic
             (Obj.repr
                (fun ps -> let x1 = fold_right f tl x ps in f hd x1 ps)))
      uu___2 uu___1 uu___
let rec zip :
  'a 'b .
    'a Prims.list ->
             ...
             (Obj.repr
                (fun ps ->
                   ...
                   | FStar_Pervasives_Native.None ->
                       filter_map_acc f acc tl ps))) uu___2 uu___1 uu___
let filter_map
  (f :
    'a ->
    ...
    (fun f x l1 l2 ->
       ...
       | (hd1::tl1, hd2::tl2) ->
           Obj.magic
             (Obj.repr
                (fun ps ->
                   let x1 = f x hd1 hd2 ps in fold_left2 f x1 tl1 tl2 ps)))
           ...
           Obj.magic
             (Obj.repr
                (fun ps ->
                   let x1 = f x ps in
                   let x2 =
                     let x3 = string_of_list f xs ps in Prims.strcat ";" x3 in
...
let string_of_option
  ...
  (fun f o ->
     ...
     | FStar_Pervasives_Native.Some x ->
         Obj.magic
           (Obj.repr (fun ps -> let x1 = f x ps in Prims.strcat "Some " x1))
     | FStar_Pervasives_Native.None ->
