...
let uu___is_Left_lex :
  'a 'b 'rua 'rub .
    ('a, 'b) Fstarcompiler.Prims.dtuple2 ->
      ('a, 'b) Fstarcompiler.Prims.dtuple2 ->
        ('a, 'b, 'rua, 'rub, Obj.t, Obj.t) lex_t -> Prims.bool
  =
  fun uu___ ->
    fun uu___1 ->
      fun projectee ->
...
let __proj__Left_lex__item__x1 :
  'a 'b 'rua 'rub .
    ('a, 'b) Fstarcompiler.Prims.dtuple2 ->
      ('a, 'b) Fstarcompiler.Prims.dtuple2 ->
        ('a, 'b, 'rua, 'rub, Obj.t, Obj.t) lex_t -> 'a
  =
  fun uu___ ->
    fun uu___1 ->
      fun projectee ->
...
let __proj__Left_lex__item__y1 :
  'a 'b 'rua 'rub .
    ('a, 'b) Fstarcompiler.Prims.dtuple2 ->
      ('a, 'b) Fstarcompiler.Prims.dtuple2 ->
        ('a, 'b, 'rua, 'rub, Obj.t, Obj.t) lex_t -> 'b
  =
  fun uu___ ->
    fun uu___1 ->
      fun projectee ->
...
let __proj__Left_lex__item___4 :
  'a 'b 'rua 'rub .
    ('a, 'b) Fstarcompiler.Prims.dtuple2 ->
      ('a, 'b) Fstarcompiler.Prims.dtuple2 ->
        ('a, 'b, 'rua, 'rub, Obj.t, Obj.t) lex_t -> 'rua
  =
  fun uu___ ->
    fun uu___1 ->
      fun projectee ->
...
let __proj__Right_lex__item___3 :
  'a 'b 'rua 'rub .
    ('a, 'b) Fstarcompiler.Prims.dtuple2 ->
      ('a, 'b) Fstarcompiler.Prims.dtuple2 ->
        ('a, 'b, 'rua, 'rub, Obj.t, Obj.t) lex_t -> 'rub
  =
  fun uu___ ->
    fun uu___1 ->
...
let tuple_to_dep_tuple :
  'a 'b . ('a * 'b) -> ('a, 'b) Fstarcompiler.Prims.dtuple2 =
  fun x ->
...
let uu___is_Left_sym :
  'a 'b 'rua 'rub .
    ('a * 'b) ->
      ('a * 'b) -> ('a, 'b, 'rua, 'rub, Obj.t, Obj.t) sym -> Prims.bool
  =
  fun uu___ ->
    fun uu___1 ->
      fun projectee ->
...
let __proj__Left_sym__item__x1 :
  'a 'b 'rua 'rub .
    ('a * 'b) -> ('a * 'b) -> ('a, 'b, 'rua, 'rub, Obj.t, Obj.t) sym -> 'a
  =
  fun uu___ ->
    fun uu___1 ->
...
let __proj__Left_sym__item__y :
  'a 'b 'rua 'rub .
    ('a * 'b) -> ('a * 'b) -> ('a, 'b, 'rua, 'rub, Obj.t, Obj.t) sym -> 'b
  =
  fun uu___ ->
    fun uu___1 ->
...
let __proj__Left_sym__item___3 :
  'a 'b 'rua 'rub .
    ('a * 'b) -> ('a * 'b) -> ('a, 'b, 'rua, 'rub, Obj.t, Obj.t) sym -> 'rua
  =
  fun uu___ ->
    fun uu___1 ->
...
let __proj__Right_sym__item___3 :
  'a 'b 'rua 'rub .
    ('a * 'b) -> ('a * 'b) -> ('a, 'b, 'rua, 'rub, Obj.t, Obj.t) sym -> 'rub
  =
  fun uu___ ->
    fun uu___1 ->
