...
let (uu___is_CT_Unit :
  FStarC_Reflection_V2_Data.vconst ->
    FStarC_Reflection_Types.term ->
      (Obj.t, Obj.t) constant_typing -> Prims.bool)
  =
  fun uu___ ->
    fun uu___1 ->
      fun projectee ->
          ...
          FStarC_Reflection_V2_Data.var ->
            FStarC_Reflection_Types.term ->
              FStarC_Reflection_Types.term ->
                FStarC_Reflection_Types.term ->
                  (Obj.t, Obj.t, Obj.t)
                    FStarC_Tactics_Types_Reflection.subtyping_token ->
                    (Obj.t, Obj.t, Obj.t)
                      FStarC_Tactics_Types_Reflection.subtyping_token)
  =
  fun g ->
    ...
    FStarC_Reflection_Types.term ->
      FStarC_Reflection_Types.term ->
        FStarC_Reflection_Types.typ ->
          FStarC_Reflection_V2_Data.aqualv ->
            FStarC_Reflection_V2_Data.var ->
              (Obj.t, Obj.t, Obj.t) equiv -> (Obj.t, Obj.t, Obj.t) equiv)
  =
  fun g ->
    fun e1 ->
      fun e2 ->
...
let (uu___is_ST_Let :
  FStarC_Reflection_Types.env ->
    FStarC_Reflection_Types.sigelt ->
      (Obj.t, Obj.t) sigelt_typing -> Prims.bool)
  =
  fun uu___ ->
    fun uu___1 ->
      fun projectee ->
...
let (__proj__ST_Let__item__g :
  FStarC_Reflection_Types.env ->
    FStarC_Reflection_Types.sigelt ->
      (Obj.t, Obj.t) sigelt_typing -> FStarC_Reflection_Types.env)
  =
  fun uu___ ->
    fun uu___1 ->
      fun projectee ->
...
let (__proj__ST_Let__item__fv :
  FStarC_Reflection_Types.env ->
    FStarC_Reflection_Types.sigelt ->
      (Obj.t, Obj.t) sigelt_typing -> FStarC_Reflection_Types.fv)
  =
  fun uu___ ->
    fun uu___1 ->
      fun projectee ->
        match projectee with | ST_Let (g, fv, us, ty, tm, _5) -> fv
let (__proj__ST_Let__item__us :
  FStarC_Reflection_Types.env ->
    FStarC_Reflection_Types.sigelt ->
      (Obj.t, Obj.t) sigelt_typing ->
        FStarC_Reflection_Types.univ_name Prims.list)
  =
  fun uu___ ->
    fun uu___1 ->
...
let (__proj__ST_Let__item__ty :
  FStarC_Reflection_Types.env ->
    FStarC_Reflection_Types.sigelt ->
      (Obj.t, Obj.t) sigelt_typing -> FStarC_Reflection_Types.typ)
  =
  fun uu___ ->
    fun uu___1 ->
      fun projectee ->
...
let (__proj__ST_Let__item__tm :
  FStarC_Reflection_Types.env ->
    FStarC_Reflection_Types.sigelt ->
      (Obj.t, Obj.t) sigelt_typing -> FStarC_Reflection_Types.term)
  =
  fun uu___ ->
    fun uu___1 ->
      fun projectee ->
...
let (__proj__ST_Let_Opaque__item__us :
  FStarC_Reflection_Types.env ->
    FStarC_Reflection_Types.sigelt ->
      (Obj.t, Obj.t) sigelt_typing ->
        FStarC_Reflection_Types.univ_name Prims.list)
...
let (mk_checked_let :
  FStarC_Reflection_Types.env ->
    FStarC_Reflection_Types.name ->
      Prims.string ->
        FStarC_Reflection_Types.term ->
          FStarC_Reflection_Types.typ -> (Obj.t, Obj.t) sigelt_for)
  =
  fun g ->
    fun cur_module ->
      fun nm ->
