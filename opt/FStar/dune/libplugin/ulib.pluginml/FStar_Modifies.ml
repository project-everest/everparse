...
let uu___is_LocBuffer (projectee : loc_aux) : Prims.bool= true
let __proj__LocBuffer__item__b (projectee : loc_aux) :
  Obj.t FStar_Buffer.buffer= match projectee with | LocBuffer (t, b) -> b
