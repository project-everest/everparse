                 ...
                 fun c1 ->
                   ...
                   | (h1::t1, h2::t2) ->
                       Obj.magic
                         (Obj.repr
                            (fun ps ->
                               let x = fold_right2 f t1 t2 c1 ps in
                               f h1 h2 x ps))
...
let last : 'a . 'a Prims.list -> ('a, unit) FStar_Tactics_Effect.tac_repr =
  fun uu___ ->
    (fun xs ->
       ...
       | h::uu___ -> Obj.magic (Obj.repr (fun uu___1 -> h))
       | [] ->
           Obj.magic
              ...
              FStar_Tactics_V2_Derived.try_with
                ...
                (fun uu___ ->
                   (fun uu___ ->
                      match uu___ with
                      | NotFoundBV uu___1 ->
                          Obj.magic (Obj.repr (fun uu___2 -> t))
                      | e ->
                          Obj.magic
                            (Obj.repr
                               (fun ps1 ->
...
let (replace_by :
  ...
  fun s ->
    fun b ->
      fun t ->
        fun ps ->
          let x = FStar_Tactics_Visit.visit_tm (replace_var s b) t ps in x
let (tapp :
        ...
        let x =
          ...
          | FStar_Tactics_NamedView.Tv_Type _u ->
              Obj.magic
                (Obj.repr
                   (let x2 =
                      FStar_Tactics_V2_Derived.fresh_binder_named "s" t ps in
                    let x3 =
                      FStar_Tactics_V2_Derived.fresh_binder_named "r" t ps in
                    let x4 =
        ...
        (fun uu___ ->
           fun ps ->
             ...
             | FStar_Pervasives_Native.Some se' ->
                 Obj.magic
                   (Obj.repr (FStarC_Reflection_V2_Builtins.pack_fv x))
                           ...
                           Obj.repr
                             (let x4 =
                              ...
                              let x5 =
                                ...
                                FStarC_Reflection_V2_Builtins.lookup_typ x6
                                  x4 in
                              match x5 with
                              | FStar_Pervasives_Native.Some se' ->
                                  Obj.repr
  ...
  fun b ->
    fun s ->
      fun ps ->
        ...
        let x2 =
          FStarC_Tactics_Unseal.unseal b.FStar_Tactics_NamedView.ppname ps in
        let x3 uu___1 =
          fun uu___ ->
            (fun s1 -> fun t -> Obj.magic (fun uu___ -> Prims.strcat s1 t))
              uu___1 uu___ in
        let x4 =
        ...
        ((push_var_to_state
            (FStar_Tactics_V2_SyntaxCoercions.binder_to_namedv b)
            {
              FStar_Tactics_NamedView.uniq =
                (x4.FStar_Tactics_NamedView.uniq);
              FStar_Tactics_NamedView.ppname =
                (x4.FStar_Tactics_NamedView.ppname);
              FStar_Tactics_NamedView.sort =
                (x4.FStar_Tactics_NamedView.sort);
              FStar_Tactics_NamedView.qual = x;
              FStar_Tactics_NamedView.attrs =
                (x4.FStar_Tactics_NamedView.attrs)
            }
            {
              FStar_Tactics_NamedView.uniq =
                (x5.FStar_Tactics_NamedView.uniq);
              FStar_Tactics_NamedView.ppname =
                (x5.FStar_Tactics_NamedView.ppname);
              FStar_Tactics_NamedView.sort =
                (x5.FStar_Tactics_NamedView.sort);
              FStar_Tactics_NamedView.qual = x;
              FStar_Tactics_NamedView.attrs =
                (x5.FStar_Tactics_NamedView.attrs)
            }
            {
              FStar_Tactics_NamedView.uniq =
                (x6.FStar_Tactics_NamedView.uniq);
              FStar_Tactics_NamedView.ppname =
                (x6.FStar_Tactics_NamedView.ppname);
              FStar_Tactics_NamedView.sort =
                (x6.FStar_Tactics_NamedView.sort);
              FStar_Tactics_NamedView.qual = x;
              FStar_Tactics_NamedView.attrs =
                (x6.FStar_Tactics_NamedView.attrs)
            } s),
          ({
...
let (param :
  FStar_Tactics_NamedView.term ->
    (FStar_Tactics_NamedView.term, unit) FStar_Tactics_Effect.tac_repr)
  = fun t -> fun ps -> let x = param' init_param_state t ps in x
let _ =
        ...
        fun ps ->
          ...
          | (nm, ty) ->
              let x1 =
                ...
                let x3 =
                  let x4 = let x5 = last nm ps in Prims.strcat x5 "_param" in
                  [x4] in
                    ...
                    | (s1, bs1) ->
                        ...
                        let x7 =
                          ...
                          let x9 =
                            ...
                            let x11 =
                              let x12 = replace_by s1 true x3 ps in [x12] in
                            x10 :: x11 in
                          FStar_Reflection_V2_Derived.mk_e_app x8 x9 in
                        let x8 =
                          FStar_Tactics_V2_SyntaxHelpers.mk_tot_arr x5 x7 ps in
                        (x1, x8)))
let (param_inductive :
               ...
               | (s, param_bs) ->
                   ...
                   let x5 =
                     ...
                     let x7 =
                       ...
                       let x9 = let x10 = replace_by s true x2 ps in [x10] in
                       x8 :: x9 in
