...
type t = uint128
let (v : t -> Obj.t FStar_UInt.uint_t) =
  fun x ->
    (FStar_UInt64.v x.low) +
      ((FStar_UInt64.v x.high) * (Prims.pow2 (Prims.of_int (64))))
let (uint_to_t : Obj.t FStar_UInt.uint_t -> t) =
  fun x ->
    {
  ...
  Prims.nat ->
    Prims.nat ->
      Obj.t FStar_UInt.uint_t ->
        Obj.t FStar_UInt.uint_t -> Obj.t FStar_UInt.uint_t)
  =
  fun n1 -> fun n2 -> fun num1 -> fun num2 -> num1 + (num2 * (Prims.pow2 n1))
let (vec128 : t -> Obj.t FStar_BitVector.bv_t) =
  fun a -> FStar_UInt.to_vec (Prims.of_int (128)) (v a)
let (vec64 : FStar_UInt64.t -> Obj.t FStar_BitVector.bv_t) =
...
let (l32 : Obj.t FStar_UInt.uint_t -> Obj.t FStar_UInt.uint_t) =
  fun x -> x mod (Prims.pow2 (Prims.of_int (32)))
let (h32 : Obj.t FStar_UInt.uint_t -> Obj.t FStar_UInt.uint_t) =
  fun x -> x / (Prims.pow2 (Prims.of_int (32)))
let (mul32_bound :
  Obj.t FStar_UInt.uint_t ->
    Obj.t FStar_UInt.uint_t -> Obj.t FStar_UInt.uint_t)
  = fun x -> fun y -> x * y
let (pll : FStar_UInt64.t -> FStar_UInt64.t -> Obj.t FStar_UInt.uint_t) =
  fun x ->
    fun y -> mul32_bound (l32 (FStar_UInt64.v x)) (l32 (FStar_UInt64.v y))
let (plh : FStar_UInt64.t -> FStar_UInt64.t -> Obj.t FStar_UInt.uint_t) =
  fun x ->
    fun y -> mul32_bound (l32 (FStar_UInt64.v x)) (h32 (FStar_UInt64.v y))
let (phl : FStar_UInt64.t -> FStar_UInt64.t -> Obj.t FStar_UInt.uint_t) =
  fun x ->
    fun y -> mul32_bound (h32 (FStar_UInt64.v x)) (l32 (FStar_UInt64.v y))
let (phh : FStar_UInt64.t -> FStar_UInt64.t -> Obj.t FStar_UInt.uint_t) =
  fun x ->
    fun y -> mul32_bound (h32 (FStar_UInt64.v x)) (h32 (FStar_UInt64.v y))
let (pll_l : FStar_UInt64.t -> FStar_UInt64.t -> Obj.t FStar_UInt.uint_t) =
  fun x -> fun y -> l32 (pll x y)
let (pll_h : FStar_UInt64.t -> FStar_UInt64.t -> Obj.t FStar_UInt.uint_t) =
