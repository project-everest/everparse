...
let sigelt_name (uu___ : FStarC_Reflection_Types.sigelt) :
  ...
  (fun se ->
     ...
     | FStarC_Reflection_V2_Data.Sg_Val (nm, uu___, uu___1) ->
         Obj.magic
           (Obj.repr (fun uu___2 -> FStarC_Reflection_V2_Builtins.pack_fv nm))
                ...
                (let x3 = g.fundeps in
                 ...
                 | FStar_Pervasives_Native.Some fundeps ->
                     (debug st
                        (fun uu___2 ->
                           (fun uu___2 ->
                              Obj.magic (fun uu___3 -> "checking fundeps"))
                             uu___2) ps1;
                      if
                        FStar_List_Tot_Base.existsb
                          (fun i ->
         ...
         Obj.magic
           (Obj.repr
              (fun ps ->
                 ...
                 unrefine x ps))
     | uu___ ->
         Obj.magic (Obj.repr (fun uu___1 -> FStar_Tactics_NamedView.pack t)))
    uu___
