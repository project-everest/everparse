...
let uu___is_Refl (uu___ : 'a) (uu___1 : 'a)
  (projectee : ('a, 'r, Obj.t, Obj.t) _closure) : Prims.bool=
  match projectee with | Refl x -> true | uu___2 -> false
let __proj__Refl__item__x (uu___ : 'a) (uu___1 : 'a)
  (projectee : ('a, 'r, Obj.t, Obj.t) _closure) : 'a=
  match projectee with | Refl x -> x
let uu___is_Step (uu___ : 'a) (uu___1 : 'a)
  (projectee : ('a, 'r, Obj.t, Obj.t) _closure) : Prims.bool=
  match projectee with | Step (x, y, _2) -> true | uu___2 -> false
let __proj__Step__item__x (uu___ : 'a) (uu___1 : 'a)
  (projectee : ('a, 'r, Obj.t, Obj.t) _closure) : 'a=
  match projectee with | Step (x, y, _2) -> x
let __proj__Step__item__y (uu___ : 'a) (uu___1 : 'a)
  (projectee : ('a, 'r, Obj.t, Obj.t) _closure) : 'a=
  match projectee with | Step (x, y, _2) -> y
let uu___is_Closure (uu___ : 'a) (uu___1 : 'a)
  (projectee : ('a, 'r, Obj.t, Obj.t) _closure) : Prims.bool=
  match projectee with | Closure (x, y, z, _3, _4) -> true | uu___2 -> false
let __proj__Closure__item__x (uu___ : 'a) (uu___1 : 'a)
  (projectee : ('a, 'r, Obj.t, Obj.t) _closure) : 'a=
  match projectee with | Closure (x, y, z, _3, _4) -> x
let __proj__Closure__item__y (uu___ : 'a) (uu___1 : 'a)
  (projectee : ('a, 'r, Obj.t, Obj.t) _closure) : 'a=
  match projectee with | Closure (x, y, z, _3, _4) -> y
let __proj__Closure__item__z (uu___ : 'a) (uu___1 : 'a)
  (projectee : ('a, 'r, Obj.t, Obj.t) _closure) : 'a=
  match projectee with | Closure (x, y, z, _3, _4) -> z
let __proj__Closure__item___3 (uu___ : 'a) (uu___1 : 'a)
  (projectee : ('a, 'r, Obj.t, Obj.t) _closure) :
  ('a, 'r, Obj.t, Obj.t) _closure=
  match projectee with | Closure (x, y, z, _3, _4) -> _3
let __proj__Closure__item___4 (uu___ : 'a) (uu___1 : 'a)
  (projectee : ('a, 'r, Obj.t, Obj.t) _closure) :
  ('a, 'r, Obj.t, Obj.t) _closure=
  ...
  'a 'r .
    'a ->
      'a ->
        ('a, 'r, Obj.t, Obj.t) _closure ->
          (unit,
            ('a, unit, ('a, 'r, Obj.t, Obj.t) _closure)
              FStar_Pervasives.dtuple3)
            Fstarcompiler.FStar_Pervasives.either
  =
  fun x y xy ->
    match xy with
    | Refl uu___ -> Fstarcompiler.FStar_Pervasives.Inl ()
    ...
    | Closure (x1, i, y1, xi, iy) ->
        (match closure_one_aux i y1 iy with
         ...
         | Fstarcompiler.FStar_Pervasives.Inr (FStar_Pervasives.Mkdtuple3
             (z, r_i_z, c_z_y)) ->
             let c_z_y1 = c_z_y in
             (match closure_one_aux x1 i xi with
              ...
              | Fstarcompiler.FStar_Pervasives.Inr
                  (FStar_Pervasives.Mkdtuple3 (w, r_x_w, c_w_i)) ->
