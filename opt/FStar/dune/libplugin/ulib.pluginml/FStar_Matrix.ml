...
let (get_ij :
  Prims.pos ->
    Prims.pos ->
      Obj.t FStar_IntegerIntervals.under ->
        Obj.t FStar_IntegerIntervals.under ->
          Obj.t FStar_IntegerIntervals.under)
...
let seq_of_matrix :
  'c .
    Prims.pos ->
      Prims.pos -> ('c, Obj.t, Obj.t) matrix -> 'c FStar_Seq_Base.seq
    ...
    Prims.pos ->
      Prims.pos ->
        ('c, Obj.t, Obj.t) matrix ->
          Obj.t FStar_IntegerIntervals.under ->
            Obj.t FStar_IntegerIntervals.under -> 'c
  =
  fun m ->
    fun n ->
...
let matrix_of_seq :
  'c .
    Prims.pos ->
      Prims.pos -> 'c FStar_Seq_Base.seq -> ('c, Obj.t, Obj.t) matrix
  = fun m -> fun n -> fun s -> s
...
let matrix_seq :
  'c .
    Prims.pos ->
      Prims.pos ->
        ('c, Obj.t, Obj.t) matrix_generator -> 'c FStar_Seq_Base.seq
...
let matrix_add_zero :
  'c .
    'c FStar_Algebra_CommMonoid_Equiv.equiv ->
      ('c, Obj.t) FStar_Algebra_CommMonoid_Equiv.cm ->
        Prims.pos -> Prims.pos -> ('c, Obj.t, Obj.t) matrix
  =
  fun eq ->
    fun add ->
      fun m ->
...
let col :
  'c .
    Prims.pos ->
      Prims.pos ->
        ('c, Obj.t, Obj.t) matrix ->
          Obj.t FStar_IntegerIntervals.under -> 'c FStar_Seq_Base.seq
  =
  fun m ->
    fun n ->
        ...
        Prims.pos ->
          Prims.pos ->
            ('c, Obj.t) FStar_Algebra_CommMonoid_Equiv.cm ->
              ('c, Obj.t) FStar_Algebra_CommMonoid_Equiv.cm ->
                ('c, Obj.t, Obj.t) matrix ->
                  ('c, Obj.t, Obj.t) matrix -> ('c, Obj.t, Obj.t) matrix
  =
  fun eq ->
    fun m ->
      fun n ->
...
let matrix_mul_unit :
  'c .
    'c FStar_Algebra_CommMonoid_Equiv.equiv ->
      ('c, Obj.t) FStar_Algebra_CommMonoid_Equiv.cm ->
        ('c, Obj.t) FStar_Algebra_CommMonoid_Equiv.cm ->
          Prims.pos -> ('c, Obj.t, Obj.t) matrix
  =
  fun eq ->
    fun add ->
      fun mul ->
