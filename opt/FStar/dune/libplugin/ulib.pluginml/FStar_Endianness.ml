...
let rec le_to_n (b : bytes) : Prims.nat=
...
let rec be_to_n (b : bytes) : Prims.nat=
  if (FStar_Seq_Base.length b) = Prims.int_zero
  then Prims.int_zero
  else
...
let uint32_of_le (b : bytes) : FStar_UInt32.t=
  let n = le_to_n b in FStar_UInt32.uint_to_t n
let le_of_uint32 (x : FStar_UInt32.t) : bytes=
  n_to_le (Prims.of_int (4)) (FStar_UInt32.v x)
let uint32_of_be (b : bytes) : FStar_UInt32.t=
  let n = be_to_n b in FStar_UInt32.uint_to_t n
let be_of_uint32 (x : FStar_UInt32.t) : bytes=
  n_to_be (Prims.of_int (4)) (FStar_UInt32.v x)
let uint64_of_le (b : bytes) : FStar_UInt64.t=
  let n = le_to_n b in FStar_UInt64.uint_to_t n
let le_of_uint64 (x : FStar_UInt64.t) : bytes=
  n_to_le (Prims.of_int (8)) (FStar_UInt64.v x)
let uint64_of_be (b : bytes) : FStar_UInt64.t=
  let n = be_to_n b in FStar_UInt64.uint_to_t n
let be_of_uint64 (x : FStar_UInt64.t) : bytes=
  n_to_be (Prims.of_int (8)) (FStar_UInt64.v x)
let rec seq_uint32_of_le (l : Prims.nat) (b : bytes) :
...
let rec le_of_seq_uint32 (s : FStar_UInt32.t FStar_Seq_Base.seq) : bytes=
...
let rec seq_uint32_of_be (l : Prims.nat) (b : bytes) :
  FStar_UInt32.t FStar_Seq_Base.seq=
  if (FStar_Seq_Base.length b) = Prims.int_zero
  then FStar_Seq_Base.empty ()
  else
...
let rec be_of_seq_uint32 (s : FStar_UInt32.t FStar_Seq_Base.seq) : bytes=
  if (FStar_Seq_Base.length s) = Prims.int_zero
  then FStar_Seq_Base.empty ()
  else
    FStar_Seq_Base.append (be_of_uint32 (FStar_Seq_Properties.head s))
      (be_of_seq_uint32 (FStar_Seq_Properties.tail s))
let rec seq_uint64_of_le (l : Prims.nat) (b : bytes) :
  FStar_UInt64.t FStar_Seq_Base.seq=
  if (FStar_Seq_Base.length b) = Prims.int_zero
  then FStar_Seq_Base.empty ()
  else
...
let rec le_of_seq_uint64 (s : FStar_UInt64.t FStar_Seq_Base.seq) : bytes=
  if (FStar_Seq_Base.length s) = Prims.int_zero
  then FStar_Seq_Base.empty ()
  else
    FStar_Seq_Base.append (le_of_uint64 (FStar_Seq_Properties.head s))
      (le_of_seq_uint64 (FStar_Seq_Properties.tail s))
let rec seq_uint64_of_be (l : Prims.nat) (b : bytes) :
  FStar_UInt64.t FStar_Seq_Base.seq=
  if (FStar_Seq_Base.length b) = Prims.int_zero
  then FStar_Seq_Base.empty ()
  else
...
let rec be_of_seq_uint64 (s : FStar_UInt64.t FStar_Seq_Base.seq) : bytes=
  if (FStar_Seq_Base.length s) = Prims.int_zero
  then FStar_Seq_Base.empty ()
  else
