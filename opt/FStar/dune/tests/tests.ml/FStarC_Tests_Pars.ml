      ...
      (match uu___2 with
       | (m1, env') ->
           let uu___3 =
             ...
             FStarC_Syntax_DsEnv.prepare_module_or_interface false false env'
               uu___4 FStarC_Syntax_DsEnv.default_mii in
...
let do_init (uu___ : unit) : unit=
  ...
  (let prelude_file =
   ...
   let uu___2 =
     let uu___3 = FStarC_Syntax_DsEnv.empty_env FStarC_Parser_Dep.empty_deps in
  ...
  FStarC_Errors.with_ctx (Prims.strcat "pars_and_tc_fragment " s)
    (fun uu___ ->
       ...
       let uu___1 =
         ...
         FStarC_Universal.tc_one_fragment uu___2 tcenv
