          ...
          let uu___4 =
            Obj.magic
              (FStarC_Class_Setlike.empty ()
                 (Obj.magic
                    (FStarC_FlatSet.setlike_flat_set FStarC_Class_Ord.ord_int))
                 ()) in
          insert nn
            (FStarC_FlatSet.setlike_flat_set FStarC_Class_Ord.ord_int) uu___4) in
   match uu___2 with
   | (f, ms) ->
       ((let uu___4 =
           FStarC_Class_Show.show FStarC_Class_Show.showable_int ms in
         FStarC_Format.print1 "FlatSet insert: %s\n" uu___4);
        (let uu___4 =
           FStarC_Timing.record_ms
             (fun uu___5 ->
                all_mem nn
         ...
         | (f_ok, ms1) ->
             ((let uu___6 =
               ...
               FStarC_Format.print1 "FlatSet all_mem: %s\n" uu___6);
              (let uu___6 =
                 FStarC_Timing.record_ms
                   (fun uu___7 ->
                      all_remove nn
               ...
               | (f1, ms2) ->
                   ((let uu___8 =
                       FStarC_Class_Show.show FStarC_Class_Show.showable_int
                         ms2 in
                     FStarC_Format.print1 "FlatSet all_remove: %s\n" uu___8);
                    ...
                    (let uu___10 =
                     ...
                     | (rb, ms3) ->
                         ((let uu___12 =
                           ...
                           FStarC_Format.print1 "RBSet insert: %s\n" uu___12);
                          (let uu___12 =
                             FStarC_Timing.record_ms
                               (fun uu___13 ->
                                  all_mem nn
                           ...
                           | (rb_ok, ms4) ->
                               ((let uu___14 =
                                 ...
                                 FStarC_Format.print1 "RBSet all_mem: %s\n"
                                   uu___14);
                                (let uu___14 =
                                   FStarC_Timing.record_ms
                                     (fun uu___15 ->
                                 ...
                                 | (rb1, ms5) ->
                                     ((let uu___16 =
                                         FStarC_Class_Show.show
                                           FStarC_Class_Show.showable_int ms5 in
