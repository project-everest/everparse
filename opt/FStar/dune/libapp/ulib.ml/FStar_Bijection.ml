...
let bij_either :
  'a 'b 'c 'd .
    ('a, 'b) op_Equals_Tilde ->
      ('c, 'd) op_Equals_Tilde ->
        (('a, 'c) FStar_Pervasives.either, ('b, 'd) FStar_Pervasives.either)
          op_Equals_Tilde
  =
  fun ab ->
    fun cd ->
      {
        right =
          (fun x ->
             match x with
             | FStar_Pervasives.Inl x1 -> FStar_Pervasives.Inl (ab.right x1)
             | FStar_Pervasives.Inr y -> FStar_Pervasives.Inr (cd.right y));
        left =
          (fun x ->
             match x with
             | FStar_Pervasives.Inl x1 -> FStar_Pervasives.Inl (ab.left x1)
             | FStar_Pervasives.Inr y -> FStar_Pervasives.Inr (cd.left y));
        left_right = ();
        right_left = ()
      }
let bij_flip_sum :
  'a 'b .
    unit ->
      (('a, 'b) FStar_Pervasives.either, ('b, 'a) FStar_Pervasives.either)
        op_Equals_Tilde
  =
  fun uu___ ->
    {
      right =
        (fun uu___1 ->
           match uu___1 with
           | FStar_Pervasives.Inl x -> FStar_Pervasives.Inr x
           | FStar_Pervasives.Inr y -> FStar_Pervasives.Inl y);
      left =
        (fun uu___1 ->
           match uu___1 with
           | FStar_Pervasives.Inl x -> FStar_Pervasives.Inr x
