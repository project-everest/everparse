...
T1_t1_parser32(FStar_Bytes_bytes input)
{
...
FStar_Bytes_bytes T1_t1_serializer32(FStar_Bytes_bytes input)
{
...
uint32_t T1_t1_size32(FStar_Bytes_bytes input)
{
...
uint32_t T1_t1_validator(LowParse_Slice_slice input, uint32_t pos)
{
  uint32_t res;
...
uint32_t T1_t1_jumper(LowParse_Slice_slice input, uint32_t pos)
{
