...
typedef struct K___uint8_t_Prims_list__FStar_Bytes_bytes_s
{
  uint8_t fst;
  Prims_list__FStar_Bytes_bytes *snd;
}
K___uint8_t_Prims_list__FStar_Bytes_bytes;

typedef struct K___T11_t11_uint32_t_s
{
  T11_t11 fst;
  uint32_t snd;
}
K___T11_t11_uint32_t;

typedef struct FStar_Pervasives_Native_option__K___T11_t11_uint32_t_s
{
  FStar_Pervasives_Native_option__K___uint32_t_uint32_t_tags tag;
  K___T11_t11_uint32_t v;
}
FStar_Pervasives_Native_option__K___T11_t11_uint32_t;

typedef struct K___K___uint8_t_Prims_list__FStar_Bytes_bytes_uint32_t_s
{
  K___uint8_t_Prims_list__FStar_Bytes_bytes fst;
  uint32_t snd;
}
K___K___uint8_t_Prims_list__FStar_Bytes_bytes_uint32_t;

typedef struct
FStar_Pervasives_Native_option__K___K___uint8_t_Prims_list__FStar_Bytes_bytes_uint32_t_s
{
  FStar_Pervasives_Native_option__K___uint32_t_uint32_t_tags tag;
  K___K___uint8_t_Prims_list__FStar_Bytes_bytes_uint32_t v;
}
