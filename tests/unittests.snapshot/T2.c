...
bool T2_check_t2_list_bytesize(Prims_list__FStar_Bytes_bytes *l)
{
  bool b = true;
...
T2_t2_parser32(FStar_Bytes_bytes input)
{
...
FStar_Bytes_bytes T2_t2_serializer32(Prims_list__FStar_Bytes_bytes *input)
{
...
uint32_t T2_t2_size32(Prims_list__FStar_Bytes_bytes *input)
{
  bool b = true;
  K___bool_K___uint32_t_Prims_list__FStar_Bytes_bytes
...
uint32_t T2_t2_validator(LowParse_Slice_slice input, uint32_t pos)
{
  uint32_t res;
...
uint32_t T2_t2_jumper(LowParse_Slice_slice input, uint32_t pos)
{
