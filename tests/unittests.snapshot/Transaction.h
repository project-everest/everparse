...
#include "LowParse.h"
#include "Transaction_inputs.h"
#include "Transaction_outputs.h"
#include "kremlin/internal/compat.h"

typedef struct Transaction_transaction_s
{
  uint32_t version;
  Prims_list__Txin_txin *inputs;
  Prims_list__Txout_txout *outputs;
  uint32_t lock_time;
}
...
#define __Transaction_H_DEFINED
#endif
