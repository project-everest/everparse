...
bool T33_check_t33_list_bytesize(Prims_list__T13_t13 *l)
{
  bool b = true;
...
T33_t33_parser32(FStar_Bytes_bytes input)
{
...
FStar_Bytes_bytes T33_t33_serializer32(Prims_list__T13_t13 *input)
{
...
uint32_t T33_t33_size32(Prims_list__T13_t13 *input)
{
  bool b = true;
  K___bool_K___uint32_t_Prims_list__T13_t13
...
uint32_t T33_t33_validator(LowParse_Slice_slice input, uint32_t pos)
{
  uint32_t
  n1 =
...
uint32_t T33_t33_jumper(LowParse_Slice_slice input, uint32_t pos)
{
