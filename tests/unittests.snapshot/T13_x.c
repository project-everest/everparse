...
T13_x_t13_x_parser32(FStar_Bytes_bytes input)
{
...
FStar_Bytes_bytes T13_x_t13_x_serializer32(FStar_Bytes_bytes input)
{
...
uint32_t T13_x_t13_x_size32(FStar_Bytes_bytes input)
{
...
uint32_t T13_x_t13_x_validator(LowParse_Slice_slice input, uint32_t pos)
{
  uint32_t res;
...
uint32_t T13_x_t13_x_jumper(LowParse_Slice_slice input, uint32_t pos)
{
