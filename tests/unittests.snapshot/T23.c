...
bool T23_check_t23_bytesize(T18_t18 x)
{
  uint32_t l = T18_t18_size32(x);
  return (uint32_t)0U <= l && l <= (uint32_t)255U;
}

FStar_Pervasives_Native_option__K___T18_t18_uint32_t T23_t23_parser32(FStar_Bytes_bytes input)
{
  ...
  FStar_Pervasives_Native_option__K___T18_t18_uint32_t scrut2;
  if (scrut1.tag == FStar_Pervasives_Native_Some)
  {
    ...
    FStar_Pervasives_Native_option__K___T18_t18_uint32_t scrut0;
    ...
    {
      FStar_Pervasives_Native_option__K___T18_t18_uint32_t
      scrut = T18_t18_parser32(FStar_Bytes_slice(input_, (uint32_t)0U, v1));
      if (scrut.tag == FStar_Pervasives_Native_Some)
      {
        uint32_t consumed = scrut.v.snd;
        T18_t18 v2 = scrut.v.fst;
        if (consumed == v1)
          scrut0 =
            (
              (FStar_Pervasives_Native_option__K___T18_t18_uint32_t){
        ...
        scrut0 =
          KRML_EABORT(FStar_Pervasives_Native_option__K___T18_t18_uint32_t,
            "unreachable (pattern matches are exhaustive in F*)");
    }
    if (scrut0.tag == FStar_Pervasives_Native_Some)
    {
      uint32_t l_ = scrut0.v.snd;
      T18_t18 v_ = scrut0.v.fst;
      scrut2 =
        (
          (FStar_Pervasives_Native_option__K___T18_t18_uint32_t){
            .tag = FStar_Pervasives_Native_Some,
  ...
  FStar_Pervasives_Native_option__K___T18_t18_uint32_t res;
  if (scrut2.tag == FStar_Pervasives_Native_Some)
  {
    uint32_t consumed = scrut2.v.snd;
    T18_t18 x = scrut2.v.fst;
    res =
      (
        (FStar_Pervasives_Native_option__K___T18_t18_uint32_t){
          .tag = FStar_Pervasives_Native_Some,
  ...
  FStar_Pervasives_Native_option__K___T18_t18_uint32_t scrut;
...
FStar_Bytes_bytes T23_t23_serializer32(T18_t18 input)
{
  T18_t18 x = input;
  FStar_Bytes_bytes pl = T18_t18_serializer32(x);
...
uint32_t T23_t23_size32(T18_t18 input)
{
  uint32_t len1 = T18_t18_size32(input);
  return (uint32_t)1U + len1;
}

uint32_t T23_t23_validator(LowParse_Slice_slice input, uint32_t pos)
{
  uint32_t res;
  ...
  else
  {
    ...
    if (!(va < (uint32_t)0U || (uint32_t)255U < va))
      ...
      else
      {
        uint32_t
        pos_ =
          T18_t18_validator(((LowParse_Slice_slice){ .base = input.base, .len = res + va }),
            res);
...
uint32_t T23_t23_jumper(LowParse_Slice_slice input, uint32_t pos)
{
  return pos + (uint32_t)1U + LowParse_Low_BoundedInt_read_bounded_integer_1(input, pos);
}

uint32_t T23_t23_accessor(LowParse_Slice_slice input, uint32_t pos)
{
  uint32_t pos2 = pos;
  return pos2 + (uint32_t)1U;
}
