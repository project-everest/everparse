...
uint32_t Txin_scriptSig_txin_scriptSig_validator(LowParse_Slice_slice input, uint32_t pos)
{
  uint32_t
...
uint32_t Txin_scriptSig_txin_scriptSig_jumper(LowParse_Slice_slice input, uint32_t pos)
{
