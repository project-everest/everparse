...
FStar_Pervasives_Native_option__K___T17_t17_uint32_t T17_t17_parser32(FStar_Bytes_bytes input)
{
  ...
  if (pi.tag == FStar_Pervasives_Native_None)
    return
      (
        (FStar_Pervasives_Native_option__K___T17_t17_uint32_t){
          .tag = FStar_Pervasives_Native_None
        }
      );
  else if (pi.tag == FStar_Pervasives_Native_Some)
  {
    ...
    {
      FStar_Pervasives_Native_option__K______uint32_t scrut = T17_x_a_t17_x_a_parser32(input_k);
      FStar_Pervasives_Native_option__K___T17_t17_uint32_t pcases2;
      if (scrut.tag == FStar_Pervasives_Native_Some)
      {
        ...
        pcases2 =
          (
            (FStar_Pervasives_Native_option__K___T17_t17_uint32_t){
              .tag = FStar_Pervasives_Native_Some,
              .v = { .fst = { .tag = T17_X_a }, .snd = consumed }
            }
          );
      }
      else
    ...
    else
    {
      ...
      scrut = T17_x_b_t17_x_b_parser32(input_k);
      FStar_Pervasives_Native_option__K___T17_t17_uint32_t pcases2;
      if (scrut.tag == FStar_Pervasives_Native_Some)
      {
        uint32_t consumed = scrut.v.snd;
        ...
        pcases2 =
          (
            (FStar_Pervasives_Native_option__K___T17_t17_uint32_t){
              .tag = FStar_Pervasives_Native_Some,
              .v = { .fst = { .tag = T17_X_b, ._0 = v1 }, .snd = consumed }
            }
          );
      }
      else
...
FStar_Bytes_bytes T17_t17_serializer32(T17_t17 x)
{
  Tag_tag tg;
  if (x.tag == T17_X_a)
    tg = Tag_A;
  ...
  if (__eq__Tag_tag(Tag_A, tg))
    s2 = T17_x_a_t17_x_a_serializer32();
  else
  {
    T13_t13 ite;
    if (x.tag == T17_X_b)
    ...
    s2 = T17_x_b_t17_x_b_serializer32(ite);
  }
  FStar_Bytes_bytes res = FStar_Bytes_append(s1, s2);
  return res;
}

uint32_t T17_t17_size32(T17_t17 x)
{
  Tag_tag tg;
  if (x.tag == T17_X_a)
    tg = Tag_A;
