...
FStar_Pervasives_Native_option__K___T15_body_t15_body_uint32_t
T15_body_t15_body_parser32(FStar_Bytes_bytes input)
{
  ...
  else if (pi.tag == FStar_Pervasives_Native_Some)
  {
    ...
    if (k_ == (uint8_t)0U)
    {
      ...
      scrut = LowParse_SLow_Int_parse32_u16(input_k);
      FStar_Pervasives_Native_option__K___T15_body_t15_body_uint32_t pcases4;
        ...
        pcases4 =
          (
            (FStar_Pervasives_Native_option__K___T15_body_t15_body_uint32_t){
              ...
              .v = { .fst = { .tag = T15_body_Body_x, { .case_Body_x = v1 } }, .snd = consumed }
            }
          );
      }
      else
      ...
      else if (pcases4.tag == FStar_Pervasives_Native_Some)
      {
        ...
        T15_body_t15_body x = pcases4.v.fst;
        return
          (
            (FStar_Pervasives_Native_option__K___T15_body_t15_body_uint32_t){
              .tag = FStar_Pervasives_Native_Some,
    ...
    else if (k_ == (uint8_t)1U)
    {
      ...
      scrut = LowParse_SLow_Int_parse32_u32(input_k);
      FStar_Pervasives_Native_option__K___T15_body_t15_body_uint32_t pcases4;
      if (scrut.tag == FStar_Pervasives_Native_Some)
      {
        uint32_t consumed = scrut.v.snd;
        ...
        pcases4 =
          (
            (FStar_Pervasives_Native_option__K___T15_body_t15_body_uint32_t){
              .tag = FStar_Pervasives_Native_Some,
              .v = { .fst = { .tag = T15_body_Body_y, { .case_Body_y = v1 } }, .snd = consumed }
            }
          );
      }
      else
    ...
    {
      FStar_Pervasives_Native_option__K___T15_body_t15_body_uint32_t
      pcases4 = { .tag = FStar_Pervasives_Native_None };
      if (pcases4.tag == FStar_Pervasives_Native_None)
        return
          (
            (FStar_Pervasives_Native_option__K___T15_body_t15_body_uint32_t){
    ...
    else if (k_ == (uint8_t)5U)
    {
      ...
      pcases4 =
        {
          .tag = FStar_Pervasives_Native_Some,
          .v = { .fst = { .tag = T15_body_Body_w }, .snd = (uint32_t)0U }
        };
      if (pcases4.tag == FStar_Pervasives_Native_None)
        return
          (
...
FStar_Bytes_bytes T15_body_t15_body_serializer32(T15_body_t15_body x)
{
  ...
  if (tg.tag == LowParse_Spec_Enum_Known)
  {
    ...
    if (__eq__Tag2_tag2(((Tag2_tag2){ .tag = Tag2_X }), tg_))
    {
      ...
      s2 = LowParse_SLow_Int_serialize32_u16(x1);
    }
    else if (__eq__Tag2_tag2(((Tag2_tag2){ .tag = Tag2_Y }), tg_))
    {
      uint32_t x1;
      if (x.tag == T15_body_Body_y)
        x1 = x.case_Body_y;
      else
        x1 = KRML_EABORT(uint32_t, "unreachable (pattern matches are exhaustive in F*)");
      s2 = LowParse_SLow_Int_serialize32_u32(x1);
    }
...
uint32_t T15_body_t15_body_size32(T15_body_t15_body x)
{
  LowParse_Spec_Enum_maybe_enum_key__Tag2_tag2_uint8_t tg;
  if (x.tag == T15_body_Body_x)
    tg =
