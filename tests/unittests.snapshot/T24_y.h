...
typedef struct Prims_list__uint16_t_s Prims_list__uint16_t;

typedef struct Prims_list__uint16_t_s
{
  Prims_list__T13_t13_tags tag;
  uint16_t hd;
  Prims_list__uint16_t *tl;
}
Prims_list__uint16_t;

typedef Prims_list__uint16_t *T24_y_t24_y;

typedef struct K___Prims_list__uint16_t_uint32_t_s
{
  Prims_list__uint16_t *fst;
  uint32_t snd;
}
K___Prims_list__uint16_t_uint32_t;

typedef struct FStar_Pervasives_Native_option__K___Prims_list__uint16_t_uint32_t_s
{
  FStar_Pervasives_Native_option__K___uint32_t_uint32_t_tags tag;
  K___Prims_list__uint16_t_uint32_t v;
}
...
typedef struct K___uint32_t_Prims_list__uint16_t_s
{
  uint32_t fst;
  Prims_list__uint16_t *snd;
}
K___uint32_t_Prims_list__uint16_t;
