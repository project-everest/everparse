...
FStar_Bytes_bytes T9___proj__Mkt9__item__a(T9_t9 projectee)
{
  return projectee.a;
}

Prims_list__FStar_Bytes_bytes *T9___proj__Mkt9__item__b(T9_t9 projectee)
{
  return projectee.b;
}

typedef struct K___K___FStar_Bytes_bytes_Prims_list__FStar_Bytes_bytes_uint32_t_s
{
  K___FStar_Bytes_bytes_Prims_list__FStar_Bytes_bytes fst;
  uint32_t snd;
}
K___K___FStar_Bytes_bytes_Prims_list__FStar_Bytes_bytes_uint32_t;

typedef struct
FStar_Pervasives_Native_option__K___K___FStar_Bytes_bytes_Prims_list__FStar_Bytes_bytes_uint32_t_s
{
  FStar_Pervasives_Native_option__K___uint32_t_uint32_t_tags tag;
  K___K___FStar_Bytes_bytes_Prims_list__FStar_Bytes_bytes_uint32_t v;
}
FStar_Pervasives_Native_option__K___K___FStar_Bytes_bytes_Prims_list__FStar_Bytes_bytes_uint32_t;

FStar_Pervasives_Native_option__K___T9_t9_uint32_t T9_t9_parser32(FStar_Bytes_bytes input)
{
  FStar_Pervasives_Native_option__K___FStar_Bytes_bytes_uint32_t scrut0 = T1_t1_parser32(input);
  FStar_Pervasives_Native_option__K___K___FStar_Bytes_bytes_Prims_list__FStar_Bytes_bytes_uint32_t
  scrut;
  if (scrut0.tag == FStar_Pervasives_Native_Some)
  {
    ...
    scrut0 = T9_b_t9_b_parser32(input_);
    if (scrut0.tag == FStar_Pervasives_Native_Some)
    {
  ...
  if (scrut.tag == FStar_Pervasives_Native_Some)
  {
    ...
    K___FStar_Bytes_bytes_Prims_list__FStar_Bytes_bytes v1 = scrut.v.fst;
    FStar_Bytes_bytes a = v1.fst;
    Prims_list__FStar_Bytes_bytes *b = v1.snd;
    return
      (
        (FStar_Pervasives_Native_option__K___T9_t9_uint32_t){
          .tag = FStar_Pervasives_Native_Some,
          .v = { .fst = { .a = a, .b = b }, .snd = consumed }
        }
      );
  }
  else
    return
      ((FStar_Pervasives_Native_option__K___T9_t9_uint32_t){ .tag = FStar_Pervasives_Native_None });
}

FStar_Bytes_bytes T9_t9_serializer32(T9_t9 input)
{
  K___FStar_Bytes_bytes_Prims_list__FStar_Bytes_bytes x = { .fst = input.a, .snd = input.b };
  FStar_Bytes_bytes fs = x.fst;
  Prims_list__FStar_Bytes_bytes *sn = x.snd;
  FStar_Bytes_bytes output1 = T1_t1_serializer32(fs);
  FStar_Bytes_bytes output2 = T9_b_t9_b_serializer32(sn);
  return FStar_Bytes_append(output1, output2);
}

uint32_t T9_t9_size32(T9_t9 input)
{
  uint32_t v1 = T1_t1_size32(input.a);
  uint32_t v2 = T9_b_t9_b_size32(input.b);
...
uint32_t T9_t9_validator(LowParse_Slice_slice input, uint32_t pos)
{
  uint32_t pos1 = T1_t1_validator(input, pos);
  if (pos1 > LOWPARSE_LOW_BASE_VALIDATOR_MAX_LENGTH)
    return pos1;
  else
    return T9_b_t9_b_validator(input, pos1);
}

uint32_t T9_t9_jumper(LowParse_Slice_slice input, uint32_t pos)
{
  return T9_b_t9_b_jumper(input, T1_t1_jumper(input, pos));
}

uint32_t T9_accessor_t9_a(LowParse_Slice_slice input, uint32_t pos)
{
  return pos;
}

uint32_t T9_accessor_t9_b(LowParse_Slice_slice input, uint32_t pos)
{
  uint32_t pos2 = pos;
  uint32_t pos21 = pos2;
