...
typedef struct K___Tagle_tagle_uint32_t_s
{
  Tagle_tagle fst;
  uint32_t snd;
}
K___Tagle_tagle_uint32_t;

typedef struct FStar_Pervasives_Native_option__K___Tagle_tagle_uint32_t_s
{
  FStar_Pervasives_Native_option__K___uint32_t_uint32_t_tags tag;
  K___Tagle_tagle_uint32_t v;
}
FStar_Pervasives_Native_option__K___Tagle_tagle_uint32_t;

typedef struct LowParse_Spec_Enum_maybe_enum_key__Tagle_tagle_uint8_t_s
{
  LowParse_Spec_Enum_maybe_enum_key__Tag_tag_uint8_t_tags tag;
  union {
    Tagle_tagle case_Known;
...
typedef struct K___LowParse_Spec_Enum_maybe_enum_key__Tagle_tagle_uint8_t_uint32_t_s
{
  LowParse_Spec_Enum_maybe_enum_key__Tagle_tagle_uint8_t fst;
  uint32_t snd;
}
K___LowParse_Spec_Enum_maybe_enum_key__Tagle_tagle_uint8_t_uint32_t;

typedef struct
FStar_Pervasives_Native_option__K___LowParse_Spec_Enum_maybe_enum_key__Tagle_tagle_uint8_t_uint32_t_s
{
  FStar_Pervasives_Native_option__K___uint32_t_uint32_t_tags tag;
  K___LowParse_Spec_Enum_maybe_enum_key__Tagle_tagle_uint8_t_uint32_t v;
}
