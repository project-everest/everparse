...
typedef uint8_t T17_t17_tags;

typedef struct T17_t17_s
{
  T17_t17_tags tag;
  T13_t13 _0;
}
...
typedef struct K___T17_t17_uint32_t_s
{
  T17_t17 fst;
  uint32_t snd;
}
K___T17_t17_uint32_t;

typedef struct FStar_Pervasives_Native_option__K___T17_t17_uint32_t_s
{
  FStar_Pervasives_Native_option__K___uint32_t_uint32_t_tags tag;
  K___T17_t17_uint32_t v;
}
