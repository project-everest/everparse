...
T21_t21_parser32(FStar_Bytes_bytes input)
{
...
FStar_Bytes_bytes T21_t21_serializer32(FStar_Bytes_bytes input)
{
...
uint32_t T21_t21_size32(FStar_Bytes_bytes input)
{
...
uint32_t T21_t21_validator(LowParse_Slice_slice input, uint32_t pos)
{
  uint32_t res;
...
uint32_t T21_t21_jumper(LowParse_Slice_slice input, uint32_t pos)
{
