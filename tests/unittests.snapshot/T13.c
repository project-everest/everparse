...
uint8_t T13___proj__Mkt13__item__u(T13_t13 projectee)
{
  return projectee.u;
}

FStar_Bytes_bytes T13___proj__Mkt13__item__x(T13_t13 projectee)
{
  return projectee.x;
}

uint16_t T13___proj__Mkt13__item__y(T13_t13 projectee)
{
  return projectee.y;
}

FStar_Pervasives_Native_option__K___T13_t13_uint32_t T13_t13_parser32(FStar_Bytes_bytes input)
{
  FStar_Pervasives_Native_option__K___uint8_t_uint32_t
  scrut0 = LowParse_SLow_Int_parse32_u8(input);
  FStar_Pervasives_Native_option__K___K___uint8_t_FStar_Bytes_bytes_uint32_t scrut1;
  if (scrut0.tag == FStar_Pervasives_Native_Some)
  {
    ...
    scrut = T13_x_t13_x_parser32(input_);
    if (scrut.tag == FStar_Pervasives_Native_Some)
    {
      ...
      scrut1 =
        (
          (FStar_Pervasives_Native_option__K___K___uint8_t_FStar_Bytes_bytes_uint32_t){
  ...
  FStar_Pervasives_Native_option__K___K___K___uint8_t_FStar_Bytes_bytes_uint16_t_uint32_t scrut;
  if (scrut1.tag == FStar_Pervasives_Native_Some)
  {
    uint32_t l = scrut1.v.snd;
    K___uint8_t_FStar_Bytes_bytes v1 = scrut1.v.fst;
    FStar_Bytes_bytes input_ = FStar_Bytes_slice(input, l, FStar_Bytes_len(input));
    ...
    if (scrut0.tag == FStar_Pervasives_Native_Some)
    {
      ...
      scrut =
        (
          (FStar_Pervasives_Native_option__K___K___K___uint8_t_FStar_Bytes_bytes_uint16_t_uint32_t){
            .tag = FStar_Pervasives_Native_Some,
            .v = { .fst = { .fst = v1, .snd = v_ }, .snd = l + l_ }
          }
        );
  ...
  if (scrut.tag == FStar_Pervasives_Native_Some)
  {
    ...
    K___K___uint8_t_FStar_Bytes_bytes_uint16_t v1 = scrut.v.fst;
    uint16_t y = v1.snd;
    FStar_Bytes_bytes x = v1.fst.snd;
    uint8_t u = v1.fst.fst;
    return
      (
        (FStar_Pervasives_Native_option__K___T13_t13_uint32_t){
          .tag = FStar_Pervasives_Native_Some,
          .v = { .fst = { .u = u, .x = x, .y = y }, .snd = consumed }
        }
      );
  }
  else
...
FStar_Bytes_bytes T13_t13_serializer32(T13_t13 input)
{
  K___K___uint8_t_FStar_Bytes_bytes_uint16_t
  x = { .fst = { .fst = input.u, .snd = input.x }, .snd = input.y };
  K___uint8_t_FStar_Bytes_bytes fs = x.fst;
  uint16_t sn = x.snd;
  uint8_t fs1 = fs.fst;
  FStar_Bytes_bytes sn1 = fs.snd;
  FStar_Bytes_bytes output1 = LowParse_SLow_Int_serialize32_u8(fs1);
  FStar_Bytes_bytes output20 = T13_x_t13_x_serializer32(sn1);
  FStar_Bytes_bytes output10 = FStar_Bytes_append(output1, output20);
  FStar_Bytes_bytes output2 = LowParse_SLow_Int_serialize32_u16(sn);
  return FStar_Bytes_append(output10, output2);
}

uint32_t T13_t13_size32(T13_t13 input)
{
  uint32_t v1 = (uint32_t)1U;
  uint32_t v20 = T13_x_t13_x_size32(input.x);
  uint32_t res;
...
uint32_t T13_t13_validator(LowParse_Slice_slice input, uint32_t pos)
{
  uint32_t pos10;
  if (input.len - pos < (uint32_t)1U)
    pos10 = LOWPARSE_LOW_BASE_VALIDATOR_ERROR_NOT_ENOUGH_DATA;
  else
    pos10 = pos + (uint32_t)1U;
  uint32_t pos1;
  if (pos10 > LOWPARSE_LOW_BASE_VALIDATOR_MAX_LENGTH)
    pos1 = pos10;
  else
    pos1 = T13_x_t13_x_validator(input, pos10);
...
uint32_t T13_t13_jumper(LowParse_Slice_slice input, uint32_t pos)
{
  return T13_x_t13_x_jumper(input, pos + (uint32_t)1U) + (uint32_t)2U;
}

uint32_t T13_accessor_t13_u(LowParse_Slice_slice input, uint32_t pos)
{
  return pos;
}

uint32_t T13_accessor_t13_x(LowParse_Slice_slice input, uint32_t pos)
{
  uint32_t pos2 = pos;
  uint32_t pos21 = pos2;
...
uint32_t T13_accessor_t13_y(LowParse_Slice_slice input, uint32_t pos)
{
  uint32_t pos2 = pos;
  uint32_t pos21 = pos2;
  uint32_t res = T13_x_t13_x_jumper(input, pos21 + (uint32_t)1U);
  uint32_t pos3 = res;
  uint32_t pos30 = pos3;
  return pos30;
}
