...
typedef struct T25_t25_s
{
  T24_t24 payload;
  FStar_Bytes_bytes bpayload;
}
T25_t25;
...
typedef struct K___T25_t25_uint32_t_s
{
  T25_t25 fst;
  uint32_t snd;
}
K___T25_t25_uint32_t;

typedef struct FStar_Pervasives_Native_option__K___T25_t25_uint32_t_s
{
  FStar_Pervasives_Native_option__K___uint32_t_uint32_t_tags tag;
  K___T25_t25_uint32_t v;
}
