...
typedef struct K___Tag_tag_uint32_t_s
{
  Tag_tag fst;
  uint32_t snd;
}
K___Tag_tag_uint32_t;

typedef struct FStar_Pervasives_Native_option__K___Tag_tag_uint32_t_s
{
  FStar_Pervasives_Native_option__K___uint32_t_uint32_t_tags tag;
  K___Tag_tag_uint32_t v;
}
...
typedef uint8_t LowParse_Spec_Enum_maybe_enum_key__Tag_tag_uint8_t_tags;

typedef struct LowParse_Spec_Enum_maybe_enum_key__Tag_tag_uint8_t_s
{
  LowParse_Spec_Enum_maybe_enum_key__Tag_tag_uint8_t_tags tag;
  union {
    Tag_tag case_Known;
...
typedef struct K___LowParse_Spec_Enum_maybe_enum_key__Tag_tag_uint8_t_uint32_t_s
{
  LowParse_Spec_Enum_maybe_enum_key__Tag_tag_uint8_t fst;
  uint32_t snd;
}
K___LowParse_Spec_Enum_maybe_enum_key__Tag_tag_uint8_t_uint32_t;

typedef struct
FStar_Pervasives_Native_option__K___LowParse_Spec_Enum_maybe_enum_key__Tag_tag_uint8_t_uint32_t_s
{
  FStar_Pervasives_Native_option__K___uint32_t_uint32_t_tags tag;
  K___LowParse_Spec_Enum_maybe_enum_key__Tag_tag_uint8_t_uint32_t v;
}
