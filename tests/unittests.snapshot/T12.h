...
typedef struct K___T12_t12_uint32_t_s
{
  T12_t12 fst;
  uint32_t snd;
}
K___T12_t12_uint32_t;

typedef struct FStar_Pervasives_Native_option__K___T12_t12_uint32_t_s
{
  FStar_Pervasives_Native_option__K___uint32_t_uint32_t_tags tag;
  K___T12_t12_uint32_t v;
}
