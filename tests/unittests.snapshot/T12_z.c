...
T12_z_t12_z_parser32(FStar_Bytes_bytes input)
{
  FStar_Pervasives_Native_option__K___Prims_list__FStar_Bytes_bytes_uint32_t scrut0;
  if (FStar_Bytes_len(input) < (uint32_t)18U)
    scrut0 =
      (
        (FStar_Pervasives_Native_option__K___Prims_list__FStar_Bytes_bytes_uint32_t){
    ...
    x0 =
      {
        ...
        .snd = {
          ...
          .v = { .fst = FStar_Bytes_slice(input, (uint32_t)0U, (uint32_t)18U), .snd = buf0 }
        }
      };
    while (b)
    {
      ...
      if (x.tag == FStar_Pervasives_Native_Some)
      {
        ...
        FStar_Bytes_bytes input_ = x.v.fst;
        uint32_t len1 = FStar_Bytes_len(input_);
        if (len1 == (uint32_t)0U)
          ite =
            (
              (K___bool_FStar_Pervasives_Native_option__K___FStar_Bytes_bytes_Prims_list__FStar_Bytes_bytes){
        ...
        else
        {
          ...
          if (scrut.tag == FStar_Pervasives_Native_Some)
          {
            ...
            {
              FStar_Bytes_bytes input__ = FStar_Bytes_slice(input_, consumed, len1);
              KRML_CHECK_SIZE(sizeof (Prims_list__FStar_Bytes_bytes), (uint32_t)1U);
              Prims_list__FStar_Bytes_bytes
              *buf = KRML_HOST_MALLOC(sizeof (Prims_list__FStar_Bytes_bytes));
              buf[0U]
              = ((Prims_list__FStar_Bytes_bytes){ .tag = Prims_Cons, .hd = v1, .tl = accu_ });
              ite =
                (
                  (K___bool_FStar_Pervasives_Native_option__K___FStar_Bytes_bytes_Prims_list__FStar_Bytes_bytes){
                    .fst = true,
      ...
      scrut =
        (
          (FStar_Pervasives_Native_option__K___Prims_list__FStar_Bytes_bytes_uint32_t){
            ...
            .v = {
              .fst = res,
              .snd = FStar_Bytes_len(FStar_Bytes_slice(input, (uint32_t)0U, (uint32_t)18U))
            }
          }
        );
    }
...
FStar_Bytes_bytes T12_z_t12_z_serializer32(Prims_list__FStar_Bytes_bytes *input)
{
  bool b = true;
  K___bool_K___FStar_Bytes_bytes_Prims_list__FStar_Bytes_bytes
  x0 = { .fst = true, .snd = { .fst = FStar_Bytes_empty_bytes, .snd = input } };
  while (b)
  {
    K___FStar_Bytes_bytes_Prims_list__FStar_Bytes_bytes x = x0.snd;
    FStar_Bytes_bytes accu = x.fst;
    Prims_list__FStar_Bytes_bytes *input_ = x.snd;
    K___bool_K___FStar_Bytes_bytes_Prims_list__FStar_Bytes_bytes ite;
    if (input_->tag == Prims_Nil)
      ite =
        ((K___bool_K___FStar_Bytes_bytes_Prims_list__FStar_Bytes_bytes){ .fst = false, .snd = x });
  ...
  K___bool_K___FStar_Bytes_bytes_Prims_list__FStar_Bytes_bytes scrut = x0;
  K___FStar_Bytes_bytes_Prims_list__FStar_Bytes_bytes scrut0 = scrut.snd;
  return scrut0.fst;
}

uint32_t T12_z_t12_z_size32(Prims_list__FStar_Bytes_bytes *x)
{
  return (uint32_t)18U;
}
...
uint32_t T12_z_t12_z_validator(LowParse_Slice_slice input, uint32_t pos)
{
  ...
  else
  {
    ...
    while (true)
    {
      uint32_t pos1 = bpos;
      bool ite;
      if (pos1 == pos + (uint32_t)18U)
        ite = true;
      else
      {
        uint32_t
        pos11 =
          T1_t1_validator(((LowParse_Slice_slice){ .base = input.base, .len = pos + (uint32_t)18U }),
            pos1);
        bpos = pos11;
