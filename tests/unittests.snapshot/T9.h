...
typedef struct T9_t9_s
{
  FStar_Bytes_bytes a;
  Prims_list__FStar_Bytes_bytes *b;
}
T9_t9;
...
typedef struct K___T9_t9_uint32_t_s
{
  T9_t9 fst;
  uint32_t snd;
}
...
typedef struct FStar_Pervasives_Native_option__K___T9_t9_uint32_t_s
{
  FStar_Pervasives_Native_option__K___uint32_t_uint32_t_tags tag;
  K___T9_t9_uint32_t v;
}
