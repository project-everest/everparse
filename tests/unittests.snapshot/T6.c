...
FStar_Pervasives_Native_option__K___T6_t6_uint32_t T6_t6_parser32(FStar_Bytes_bytes input)
{
  ...
  if (pi.tag == FStar_Pervasives_Native_None)
    return
      ((FStar_Pervasives_Native_option__K___T6_t6_uint32_t){ .tag = FStar_Pervasives_Native_None });
  else if (pi.tag == FStar_Pervasives_Native_Some)
  {
    ...
    if (__eq__Tag_tag(Tag_A, k))
    {
      ...
      FStar_Pervasives_Native_option__K___T6_t6_uint32_t pcases2;
      if (scrut.tag == FStar_Pervasives_Native_Some)
      {
        uint32_t consumed = scrut.v.snd;
        ...
        pcases2 =
          (
            (FStar_Pervasives_Native_option__K___T6_t6_uint32_t){
              .tag = FStar_Pervasives_Native_Some,
              .v = { .fst = { .tag = T6_Body_a, { .case_Body_a = v1 } }, .snd = consumed }
            }
          );
      }
      else
      ...
      if (scrut.tag == FStar_Pervasives_Native_Some)
      {
        ...
        pcases2 =
          (
            (FStar_Pervasives_Native_option__K___T6_t6_uint32_t){
              .tag = FStar_Pervasives_Native_Some,
              .v = { .fst = { .tag = T6_Body_b, { .case_Body_b = v1 } }, .snd = consumed }
            }
          );
      }
      else
...
FStar_Bytes_bytes T6_t6_serializer32(T6_t6 x)
{
  Tag_tag tg;
  if (x.tag == T6_Body_a)
    tg = Tag_A;
    ...
    if (x.tag == T6_Body_b)
      ...
      ite =
        KRML_EABORT(Prims_list__FStar_Bytes_bytes *,
          "unreachable (pattern matches are exhaustive in F*)");
    s2 = T4_t4_serializer32(ite);
  }
  FStar_Bytes_bytes res = FStar_Bytes_append(s1, s2);
  return res;
}

uint32_t T6_t6_size32(T6_t6 x)
{
  Tag_tag tg;
  if (x.tag == T6_Body_a)
    tg = Tag_A;
