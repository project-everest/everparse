...
Prims_string Tagle_string_of_tagle(Tagle_tagle uu___0_30)
{
  switch (uu___0_30)
  {
    case Tagle_A:
...
static FStar_Pervasives_Native_option__K___Tagle_tagle_uint32_t
Tagle_parse32_tagle_key(FStar_Bytes_bytes input)
{
...
FStar_Pervasives_Native_option__K___Tagle_tagle_uint32_t
Tagle_tagle_parser32(FStar_Bytes_bytes input)
{
  FStar_Pervasives_Native_option__K___Tagle_tagle_uint32_t
  scrut = Tagle_parse32_tagle_key(input);
  if (scrut.tag == FStar_Pervasives_Native_Some)
  {
    uint32_t consumed = scrut.v.snd;
    Tagle_tagle v1 = scrut.v.fst;
    return
      (
        (FStar_Pervasives_Native_option__K___Tagle_tagle_uint32_t){
          .tag = FStar_Pervasives_Native_Some,
...
bool __eq__Tagle_tagle(Tagle_tagle y, Tagle_tagle x)
{
  switch (x)
  {
    case Tagle_A:
...
static FStar_Bytes_bytes Tagle_serialize32_tagle_key(Tagle_tagle input)
{
  uint8_t ite;
  if (__eq__Tagle_tagle(Tagle_A, input))
    ite = (uint8_t)0U;
  else
    ite = (uint8_t)1U;
...
FStar_Bytes_bytes Tagle_tagle_serializer32(Tagle_tagle input)
{
  Tagle_tagle x = input;
  return Tagle_serialize32_tagle_key(x);
}

uint32_t Tagle_tagle_size32(Tagle_tagle x)
{
  return (uint32_t)1U;
}
