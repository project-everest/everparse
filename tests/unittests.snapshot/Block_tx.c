...
uint32_t Block_tx_block_tx_validator(LowParse_Slice_slice input, uint32_t pos)
{
  ...
  else
  {
    ...
    if (n1 < (uint32_t)0U || (uint32_t)65536U < n1)
    ...
    else
    {
      ...
      while (true)
      {
        ...
        else
        {
          ...
          uint32_t pos2 = Transaction_transaction_validator(input, pos11);
          br = r - (uint32_t)1U;
          bpos1 = pos2;
...
uint32_t Block_tx_block_tx_jumper(LowParse_Slice_slice input, uint32_t pos)
{
  ...
  while (true)
  {
    ...
    {
      uint32_t pos11 = bpos1;
      uint32_t pos2 = Transaction_transaction_jumper(input, pos11);
      br = r - (uint32_t)1U;
      bpos1 = pos2;
      ite = false;
    }
