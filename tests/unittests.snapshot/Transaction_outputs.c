...
uint32_t
Transaction_outputs_transaction_outputs_validator(LowParse_Slice_slice input, uint32_t pos)
{
  ...
  else
  {
    ...
    if (n1 < (uint32_t)0U || (uint32_t)11110U < n1)
    ...
    else
    {
      ...
      while (true)
      {
        ...
        else
        {
          ...
          uint32_t pos2 = Txout_txout_validator(input, pos11);
          br = r - (uint32_t)1U;
          bpos1 = pos2;
...
uint32_t
Transaction_outputs_transaction_outputs_jumper(LowParse_Slice_slice input, uint32_t pos)
{
  ...
  while (true)
  {
    ...
    {
      uint32_t pos11 = bpos1;
      uint32_t pos2 = Txout_txout_jumper(input, pos11);
      br = r - (uint32_t)1U;
      bpos1 = pos2;
      ite = false;
    }
