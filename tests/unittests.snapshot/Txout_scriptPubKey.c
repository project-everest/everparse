...
#include "Txout_scriptPubKey.h"

uint32_t
Txout_scriptPubKey_txout_scriptPubKey_validator(LowParse_Slice_slice input, uint32_t pos)
{
  uint32_t
  n1 = LowParse_Low_BCVLI_validate_bounded_bcvli_((uint32_t)0U, (uint32_t)10000U, input, pos);
...
uint32_t Txout_scriptPubKey_txout_scriptPubKey_jumper(LowParse_Slice_slice input, uint32_t pos)
{
