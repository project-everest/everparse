...
T17_x_b_t17_x_b_parser32(FStar_Bytes_bytes input)
{
...
FStar_Bytes_bytes T17_x_b_t17_x_b_serializer32(T13_t13 input)
{
  FStar_Bytes_bytes pl = T13_t13_serializer32(input);
...
uint32_t T17_x_b_t17_x_b_size32(T13_t13 input)
{
  uint32_t len1 = T13_t13_size32(input);
  return (uint32_t)2U + len1;
}

uint32_t T17_x_b_t17_x_b_validator(LowParse_Slice_slice input, uint32_t pos)
{
  uint32_t res;
...
uint32_t T17_x_b_t17_x_b_jumper(LowParse_Slice_slice input, uint32_t pos)
{
  return pos + (uint32_t)2U + LowParse_Low_BoundedInt_read_bounded_integer_2(input, pos);
}

uint32_t T17_x_b_t17_x_b_accessor(LowParse_Slice_slice input, uint32_t pos)
{
