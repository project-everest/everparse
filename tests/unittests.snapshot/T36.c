...
T36_t36_parser32(FStar_Bytes_bytes input)
{
...
FStar_Bytes_bytes T36_t36_serializer32(FStar_Bytes_bytes input)
{
...
uint32_t T36_t36_size32(FStar_Bytes_bytes input)
{
...
uint32_t T36_t36_validator(LowParse_Slice_slice input, uint32_t pos)
{
  uint32_t
  n1 =
...
uint32_t T36_t36_jumper(LowParse_Slice_slice input, uint32_t pos)
{
