...
bool Tag_uu___is_A(Tag_tag projectee)
{
  switch (projectee)
  {
    case Tag_A:
...
bool Tag_uu___is_B(Tag_tag projectee)
{
  switch (projectee)
  {
    case Tag_B:
...
Prims_string Tag_string_of_tag(Tag_tag uu___0_30)
{
  switch (uu___0_30)
  {
    case Tag_A:
...
static FStar_Pervasives_Native_option__K___Tag_tag_uint32_t
Tag_parse32_tag_key(FStar_Bytes_bytes input)
{
...
FStar_Pervasives_Native_option__K___Tag_tag_uint32_t Tag_tag_parser32(FStar_Bytes_bytes input)
{
  FStar_Pervasives_Native_option__K___Tag_tag_uint32_t scrut = Tag_parse32_tag_key(input);
  if (scrut.tag == FStar_Pervasives_Native_Some)
  {
    uint32_t consumed = scrut.v.snd;
    Tag_tag v1 = scrut.v.fst;
    return
      (
        (FStar_Pervasives_Native_option__K___Tag_tag_uint32_t){
          .tag = FStar_Pervasives_Native_Some,
...
bool __eq__Tag_tag(Tag_tag y, Tag_tag x)
{
  switch (x)
  {
    case Tag_A:
...
static FStar_Bytes_bytes Tag_serialize32_tag_key(Tag_tag input)
{
  uint8_t ite;
  if (__eq__Tag_tag(Tag_A, input))
    ite = (uint8_t)0U;
  else
    ite = (uint8_t)1U;
...
FStar_Bytes_bytes Tag_tag_serializer32(Tag_tag input)
{
  Tag_tag x = input;
  return Tag_serialize32_tag_key(x);
}

uint32_t Tag_tag_size32(Tag_tag x)
{
  return (uint32_t)1U;
}

uint32_t Tag_tag_validator(LowParse_Slice_slice input, uint32_t pos)
{
  uint32_t res;
...
uint32_t Tag_tag_jumper(LowParse_Slice_slice input, uint32_t pos)
{
  return pos + (uint32_t)1U;
}

Tag_tag Tag_tag_reader(LowParse_Slice_slice input, uint32_t pos)
{
...
uint32_t Tag_tag_writer(Tag_tag x, LowParse_Slice_slice input, uint32_t pos)
{
  uint8_t ite;
  if (__eq__Tag_tag(Tag_A, x))
    ite = (uint8_t)0U;
  else
    ite = (uint8_t)1U;
