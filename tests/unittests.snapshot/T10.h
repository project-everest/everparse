...
typedef FStar_Bytes_bytes T10_t10;

uint32_t T10_t10_validator(LowParse_Slice_slice input, uint32_t pos);

uint32_t T10_t10_jumper(LowParse_Slice_slice input, uint32_t pos);

#define __T10_H_DEFINED
#endif
