...
#include "kremlib.h"
#ifndef __T22_body_b_H
#define __T22_body_b_H

#include "LowParse.h"
#include "FStar.h"
#include "kremlin/internal/compat.h"

typedef FStar_Bytes_bytes T22_body_b_t22_body_b;

typedef struct K___FStar_Bytes_bytes_uint32_t_s
{
  FStar_Bytes_bytes fst;
  uint32_t snd;
}
K___FStar_Bytes_bytes_uint32_t;

typedef struct FStar_Pervasives_Native_option__K___FStar_Bytes_bytes_uint32_t_s
{
  FStar_Pervasives_Native_option__K___uint32_t_uint32_t_tags tag;
  K___FStar_Bytes_bytes_uint32_t v;
}
