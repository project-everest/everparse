...
typedef struct K___T16_x_t16_x_uint32_t_s
{
  T16_x_t16_x fst;
  uint32_t snd;
}
K___T16_x_t16_x_uint32_t;

typedef struct FStar_Pervasives_Native_option__K___T16_x_t16_x_uint32_t_s
{
  FStar_Pervasives_Native_option__K___uint32_t_uint32_t_tags tag;
  K___T16_x_t16_x_uint32_t v;
}
