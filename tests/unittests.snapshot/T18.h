...
typedef uint8_t T18_t18_tags;

typedef struct T18_t18_s
{
  T18_t18_tags tag;
  T13_t13 _0;
}
...
typedef struct K___T18_t18_uint32_t_s
{
  T18_t18 fst;
  uint32_t snd;
}
K___T18_t18_uint32_t;

typedef struct FStar_Pervasives_Native_option__K___T18_t18_uint32_t_s
{
  FStar_Pervasives_Native_option__K___uint32_t_uint32_t_tags tag;
  K___T18_t18_uint32_t v;
}
