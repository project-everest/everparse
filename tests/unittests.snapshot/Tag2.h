...
typedef struct K___Tag2_tag2_uint32_t_s
{
  Tag2_tag2 fst;
  uint32_t snd;
}
K___Tag2_tag2_uint32_t;

typedef struct FStar_Pervasives_Native_option__K___Tag2_tag2_uint32_t_s
{
  FStar_Pervasives_Native_option__K___uint32_t_uint32_t_tags tag;
  K___Tag2_tag2_uint32_t v;
}
