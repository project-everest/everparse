...
bool T34_check_t34_list_bytesize(Prims_list__T14_t14 *l)
{
  bool b = true;
  K___bool_K___uint32_t_Prims_list__T14_t14
  x0 = { .fst = true, .snd = { .fst = (uint32_t)0U, .snd = l } };
  while (b)
  {
    K___uint32_t_Prims_list__T14_t14 x = x0.snd;
    uint32_t len1 = x.fst;
    Prims_list__T14_t14 *rem1 = x.snd;
    K___bool_K___uint32_t_Prims_list__T14_t14 ite;
    if (rem1->tag == Prims_Nil)
      ite = ((K___bool_K___uint32_t_Prims_list__T14_t14){ .fst = false, .snd = x });
    else if (rem1->tag == Prims_Cons)
    {
      Prims_list__T14_t14 *q = rem1->tl;
      T14_t14 a = rem1->hd;
      uint32_t sza = T14_t14_size32(a);
      uint32_t len_;
      ...
      {
        KRML_CHECK_SIZE(sizeof (Prims_list__T14_t14), (uint32_t)1U);
        Prims_list__T14_t14 *buf = KRML_HOST_MALLOC(sizeof (Prims_list__T14_t14));
        buf[0U] = ((Prims_list__T14_t14){ .tag = Prims_Nil });
        ite =
          (
            (K___bool_K___uint32_t_Prims_list__T14_t14){
              .fst = false,
      ...
      ite =
        KRML_EABORT(K___bool_K___uint32_t_Prims_list__T14_t14,
          "unreachable (pattern matches are exhaustive in F*)");
    x0 = ite;
    b = x0.fst;
  }
  K___bool_K___uint32_t_Prims_list__T14_t14 scrut = x0;
  K___uint32_t_Prims_list__T14_t14 scrut0 = scrut.snd;
  uint32_t x = scrut0.fst;
  return (uint32_t)100000U <= x && x <= (uint32_t)131072U;
}

typedef struct K___Prims_list__T14_t14_Prims_list__T14_t14_s
{
  Prims_list__T14_t14 *fst;
  Prims_list__T14_t14 *snd;
}
K___Prims_list__T14_t14_Prims_list__T14_t14;

typedef struct K___bool_K___Prims_list__T14_t14_Prims_list__T14_t14_s
{
  bool fst;
  K___Prims_list__T14_t14_Prims_list__T14_t14 snd;
}
K___bool_K___Prims_list__T14_t14_Prims_list__T14_t14;

Prims_list__T14_t14 *LowParse_SLow_List_list_rev__T14_t14(Prims_list__T14_t14 *l)
{
  if (l->tag == Prims_Nil)
  {
    KRML_CHECK_SIZE(sizeof (Prims_list__T14_t14), (uint32_t)1U);
  ...
  else
  {
    ...
    while (b)
    {
      K___Prims_list__T14_t14_Prims_list__T14_t14 x = x0.snd;
      Prims_list__T14_t14 *rem1 = x.fst;
      Prims_list__T14_t14 *acc = x.snd;
      K___bool_K___Prims_list__T14_t14_Prims_list__T14_t14 ite;
      if (rem1->tag == Prims_Nil)
        ite =
          (
            (K___bool_K___Prims_list__T14_t14_Prims_list__T14_t14){
      ...
      else if (rem1->tag == Prims_Cons)
      {
        ...
        KRML_CHECK_SIZE(sizeof (Prims_list__T14_t14), (uint32_t)1U);
        Prims_list__T14_t14 *buf = KRML_HOST_MALLOC(sizeof (Prims_list__T14_t14));
        buf[0U] = ((Prims_list__T14_t14){ .tag = Prims_Cons, .hd = a, .tl = acc });
        ite =
          (
            (K___bool_K___Prims_list__T14_t14_Prims_list__T14_t14){
              .fst = true,
        ...
        ite =
          KRML_EABORT(K___bool_K___Prims_list__T14_t14_Prims_list__T14_t14,
            "unreachable (pattern matches are exhaustive in F*)");
      x0 = ite;
      b = x0.fst;
    }
    K___bool_K___Prims_list__T14_t14_Prims_list__T14_t14 scrut = x0;
    K___Prims_list__T14_t14_Prims_list__T14_t14 scrut0 = scrut.snd;
    return scrut0.snd;
  }
}

FStar_Pervasives_Native_option__K___Prims_list__T14_t14_uint32_t
T34_t34_parser32(FStar_Bytes_bytes input)
{
  ...
  else if (scrut0.tag == FStar_Pervasives_Native_Some)
  {
    ...
    if (x32 < (uint32_t)253U && (uint32_t)100000U <= x32 && x32 <= (uint32_t)131072U)
      scrut1 =
        (
          (FStar_Pervasives_Native_option__K___uint32_t_uint32_t){
      ...
      if ((uint32_t)65536U <= (uint32_t)100000U)
        scrut1 =
          (
            (FStar_Pervasives_Native_option__K___uint32_t_uint32_t){
              .tag = FStar_Pervasives_Native_None
      ...
      else
      {
        ...
        else if (scrut.tag == FStar_Pervasives_Native_Some)
        {
          ...
          if (y < (uint32_t)253U || y < (uint32_t)100000U || (uint32_t)131072U < y)
            scrut1 =
              (
                (FStar_Pervasives_Native_option__K___uint32_t_uint32_t){
                  .tag = FStar_Pervasives_Native_None
    ...
    else if (x32 == (uint32_t)254U)
    {
      ...
      else if (scrut.tag == FStar_Pervasives_Native_Some)
      {
        uint32_t consumed_y = scrut.v.snd;
        uint32_t y = scrut.v.fst;
        if (y < (uint32_t)65536U || y < (uint32_t)100000U || (uint32_t)131072U < y)
          scrut1 =
            (
              (FStar_Pervasives_Native_option__K___uint32_t_uint32_t){
                .tag = FStar_Pervasives_Native_None
    ...
    scrut1 =
      KRML_EABORT(FStar_Pervasives_Native_option__K___uint32_t_uint32_t,
        "unreachable (pattern matches are exhaustive in F*)");
  FStar_Pervasives_Native_option__K___Prims_list__T14_t14_uint32_t scrut2;
  ...
  else if (scrut1.tag == FStar_Pervasives_Native_Some)
  {
    ...
    FStar_Pervasives_Native_option__K___Prims_list__T14_t14_uint32_t scrut0;
    ...
    else
    {
      bool b = true;
      KRML_CHECK_SIZE(sizeof (Prims_list__T14_t14), (uint32_t)1U);
      Prims_list__T14_t14 *buf0 = KRML_HOST_MALLOC(sizeof (Prims_list__T14_t14));
      buf0[0U] = ((Prims_list__T14_t14){ .tag = Prims_Nil });
      K___bool_FStar_Pervasives_Native_option__K___FStar_Bytes_bytes_Prims_list__T14_t14
      x0 =
        {
          .fst = true,
          .snd = {
      ...
      while (b)
      {
        FStar_Pervasives_Native_option__K___FStar_Bytes_bytes_Prims_list__T14_t14 x = x0.snd;
        K___bool_FStar_Pervasives_Native_option__K___FStar_Bytes_bytes_Prims_list__T14_t14 ite;
        if (x.tag == FStar_Pervasives_Native_Some)
        {
          Prims_list__T14_t14 *accu_ = x.v.snd;
          ...
          {
            FStar_Pervasives_Native_option__K___T14_t14_uint32_t scrut = T14_t14_parser32(input_1);
            if (scrut.tag == FStar_Pervasives_Native_Some)
            {
              uint32_t consumed1 = scrut.v.snd;
              T14_t14 v1 = scrut.v.fst;
              ...
              else
              {
                ...
                KRML_CHECK_SIZE(sizeof (Prims_list__T14_t14), (uint32_t)1U);
                Prims_list__T14_t14 *buf = KRML_HOST_MALLOC(sizeof (Prims_list__T14_t14));
                buf[0U] = ((Prims_list__T14_t14){ .tag = Prims_Cons, .hd = v1, .tl = accu_ });
                ite =
                  (
                    (K___bool_FStar_Pervasives_Native_option__K___FStar_Bytes_bytes_Prims_list__T14_t14){
                      .fst = true,
              ...
              ite =
                KRML_EABORT(K___bool_FStar_Pervasives_Native_option__K___FStar_Bytes_bytes_Prims_list__T14_t14,
                  "unreachable (pattern matches are exhaustive in F*)");
          }
        }
        else
      ...
      K___bool_FStar_Pervasives_Native_option__K___FStar_Bytes_bytes_Prims_list__T14_t14
      scrut1 = x0;
      FStar_Pervasives_Native_option__K___FStar_Bytes_bytes_Prims_list__T14_t14 accu = scrut1.snd;
      FStar_Pervasives_Native_option__Prims_list__T14_t14 scrut2;
      if (accu.tag == FStar_Pervasives_Native_None)
        scrut2 =
          (
            (FStar_Pervasives_Native_option__Prims_list__T14_t14){
              .tag = FStar_Pervasives_Native_None
            }
          );
      else if (accu.tag == FStar_Pervasives_Native_Some)
      {
        Prims_list__T14_t14 *accu_ = accu.v.snd;
        scrut2 =
          (
            (FStar_Pervasives_Native_option__Prims_list__T14_t14){
              .tag = FStar_Pervasives_Native_Some,
              .v = LowParse_SLow_List_list_rev__T14_t14(accu_)
            }
          );
      }
      else
        scrut2 =
          KRML_EABORT(FStar_Pervasives_Native_option__Prims_list__T14_t14,
            "unreachable (pattern matches are exhaustive in F*)");
      FStar_Pervasives_Native_option__K___Prims_list__T14_t14_uint32_t scrut;
      ...
      {
        Prims_list__T14_t14 *res = scrut2.v;
        scrut =
          (
            (FStar_Pervasives_Native_option__K___Prims_list__T14_t14_uint32_t){
              .tag = FStar_Pervasives_Native_Some,
        ...
        scrut =
          KRML_EABORT(FStar_Pervasives_Native_option__K___Prims_list__T14_t14_uint32_t,
            "unreachable (pattern matches are exhaustive in F*)");
      if (scrut.tag == FStar_Pervasives_Native_Some)
      {
        uint32_t consumed1 = scrut.v.snd;
        Prims_list__T14_t14 *v1 = scrut.v.fst;
        if (consumed1 == sz)
          scrut0 =
            (
              (FStar_Pervasives_Native_option__K___Prims_list__T14_t14_uint32_t){
    ...
    if (scrut0.tag == FStar_Pervasives_Native_Some)
    {
      ...
      Prims_list__T14_t14 *v1 = scrut0.v.fst;
      scrut =
        (
          (FStar_Pervasives_Native_option__K___Prims_list__T14_t14_uint32_t){
            .tag = FStar_Pervasives_Native_Some,
    ...
    else if (scrut.tag == FStar_Pervasives_Native_Some)
    {
      ...
      Prims_list__T14_t14 *x = scrut.v.fst;
      scrut2 =
        (
          (FStar_Pervasives_Native_option__K___Prims_list__T14_t14_uint32_t){
            .tag = FStar_Pervasives_Native_Some,
  ...
  if (scrut2.tag == FStar_Pervasives_Native_Some)
  {
    ...
    Prims_list__T14_t14 *v1 = scrut2.v.fst;
    return
      (
        (FStar_Pervasives_Native_option__K___Prims_list__T14_t14_uint32_t){
          .tag = FStar_Pervasives_Native_Some,
...
FStar_Bytes_bytes T34_t34_serializer32(Prims_list__T14_t14 *input)
{
  Prims_list__T14_t14 *x0 = input;
  bool b = true;
  K___bool_K___FStar_Bytes_bytes_Prims_list__T14_t14
  x = { .fst = true, .snd = { .fst = FStar_Bytes_empty_bytes, .snd = x0 } };
  while (b)
  {
    K___FStar_Bytes_bytes_Prims_list__T14_t14 x1 = x.snd;
    FStar_Bytes_bytes accu = x1.fst;
    Prims_list__T14_t14 *input_ = x1.snd;
    K___bool_K___FStar_Bytes_bytes_Prims_list__T14_t14 ite;
    if (input_->tag == Prims_Nil)
      ite = ((K___bool_K___FStar_Bytes_bytes_Prims_list__T14_t14){ .fst = false, .snd = x1 });
    else if (input_->tag == Prims_Cons)
    {
      Prims_list__T14_t14 *q = input_->tl;
      T14_t14 a = input_->hd;
      FStar_Bytes_bytes sa = T14_t14_serializer32(a);
      ...
      ite =
        KRML_EABORT(K___bool_K___FStar_Bytes_bytes_Prims_list__T14_t14,
          "unreachable (pattern matches are exhaustive in F*)");
    x = ite;
    b = x.fst;
  }
  K___bool_K___FStar_Bytes_bytes_Prims_list__T14_t14 scrut = x;
  K___FStar_Bytes_bytes_Prims_list__T14_t14 scrut0 = scrut.snd;
...
uint32_t T34_t34_size32(Prims_list__T14_t14 *input)
{
  bool b = true;
  K___bool_K___uint32_t_Prims_list__T14_t14
...
uint32_t T34_t34_validator(LowParse_Slice_slice input, uint32_t pos)
{
  uint32_t
  n1 =
    LowParse_Low_BCVLI_validate_bounded_bcvli_((uint32_t)100000U,
      (uint32_t)131072U,
      input,
      pos);
    ...
    else
    {
      ...
      while (true)
      {
        ...
        else
        {
          uint32_t
          pos11 =
            T14_t14_validator(((LowParse_Slice_slice){ .base = input.base, .len = n1 + len1 }),
              pos1);
          bpos = pos11;
...
uint32_t T34_t34_jumper(LowParse_Slice_slice input, uint32_t pos)
{
