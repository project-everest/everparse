...
typedef struct K___uint16_t_T16_x_t16_x_s
{
  uint16_t fst;
  T16_x_t16_x snd;
}
K___uint16_t_T16_x_t16_x;

typedef struct K___K___uint16_t_T16_x_t16_x_uint32_t_s
{
  K___uint16_t_T16_x_t16_x fst;
  uint32_t snd;
}
K___K___uint16_t_T16_x_t16_x_uint32_t;

typedef struct FStar_Pervasives_Native_option__K___K___uint16_t_T16_x_t16_x_uint32_t_s
{
  FStar_Pervasives_Native_option__K___uint32_t_uint32_t_tags tag;
  K___K___uint16_t_T16_x_t16_x_uint32_t v;
}
FStar_Pervasives_Native_option__K___K___uint16_t_T16_x_t16_x_uint32_t;

FStar_Pervasives_Native_option__K___T16_t16_uint32_t T16_t16_parser32(FStar_Bytes_bytes input)
{
  FStar_Pervasives_Native_option__K___uint16_t_uint32_t
  scrut0 = LowParse_SLow_Int_parse32_u16(input);
  FStar_Pervasives_Native_option__K___K___uint16_t_T16_x_t16_x_uint32_t scrut;
  if (scrut0.tag == FStar_Pervasives_Native_Some)
  {
    uint32_t l = scrut0.v.snd;
    uint16_t v1 = scrut0.v.fst;
    FStar_Bytes_bytes input_ = FStar_Bytes_slice(input, l, FStar_Bytes_len(input));
    FStar_Pervasives_Native_option__K___T16_x_t16_x_uint32_t scrut0 = T16_x_t16_x_parser32(input_);
    if (scrut0.tag == FStar_Pervasives_Native_Some)
    {
      uint32_t l_ = scrut0.v.snd;
      T16_x_t16_x v_ = scrut0.v.fst;
      scrut =
        (
          (FStar_Pervasives_Native_option__K___K___uint16_t_T16_x_t16_x_uint32_t){
  ...
  if (scrut.tag == FStar_Pervasives_Native_Some)
  {
    ...
    K___uint16_t_T16_x_t16_x v1 = scrut.v.fst;
    uint16_t len1 = v1.fst;
    T16_x_t16_x x = v1.snd;
    return
      (
        (FStar_Pervasives_Native_option__K___T16_t16_uint32_t){
          .tag = FStar_Pervasives_Native_Some,
          .v = { .fst = { .len = len1, .x = x }, .snd = consumed }
        }
      );
  }
  else
...
FStar_Bytes_bytes T16_t16_serializer32(T16_t16 input)
{
  K___uint16_t_T16_x_t16_x x = { .fst = input.len, .snd = input.x };
  uint16_t fs = x.fst;
  T16_x_t16_x sn = x.snd;
  FStar_Bytes_bytes output1 = LowParse_SLow_Int_serialize32_u16(fs);
  FStar_Bytes_bytes output2 = T16_x_t16_x_serializer32(sn);
  return FStar_Bytes_append(output1, output2);
}

uint32_t T16_t16_size32(T16_t16 input)
{
  uint32_t v1 = (uint32_t)2U;
  uint32_t v2 = T16_x_t16_x_size32(input.x);
