...
T25_bpayload_t25_bpayload_parser32(FStar_Bytes_bytes input)
{
...
FStar_Bytes_bytes T25_bpayload_t25_bpayload_serializer32(FStar_Bytes_bytes input)
{
...
uint32_t T25_bpayload_t25_bpayload_size32(FStar_Bytes_bytes input)
{
...
uint32_t T25_bpayload_t25_bpayload_validator(LowParse_Slice_slice input, uint32_t pos)
{
  uint32_t res;
...
uint32_t T25_bpayload_t25_bpayload_jumper(LowParse_Slice_slice input, uint32_t pos)
{
