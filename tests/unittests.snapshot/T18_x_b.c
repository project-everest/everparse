...
bool T18_x_b_check_t18_x_b_bytesize(T13_t13 x)
{
  uint32_t l = T13_t13_size32(x);
  return (uint32_t)0U <= l && l <= (uint32_t)255U;
}

FStar_Pervasives_Native_option__K___T13_t13_uint32_t
T18_x_b_t18_x_b_parser32(FStar_Bytes_bytes input)
{
  ...
  FStar_Pervasives_Native_option__K___T13_t13_uint32_t scrut2;
  if (scrut1.tag == FStar_Pervasives_Native_Some)
  {
    ...
    FStar_Pervasives_Native_option__K___T13_t13_uint32_t scrut0;
    ...
    {
      FStar_Pervasives_Native_option__K___T13_t13_uint32_t
      scrut = T13_t13_parser32(FStar_Bytes_slice(input_, (uint32_t)0U, v1));
      if (scrut.tag == FStar_Pervasives_Native_Some)
      {
        uint32_t consumed = scrut.v.snd;
        T13_t13 v2 = scrut.v.fst;
        if (consumed == v1)
          scrut0 =
            (
              (FStar_Pervasives_Native_option__K___T13_t13_uint32_t){
        ...
        scrut0 =
          KRML_EABORT(FStar_Pervasives_Native_option__K___T13_t13_uint32_t,
            "unreachable (pattern matches are exhaustive in F*)");
    }
    if (scrut0.tag == FStar_Pervasives_Native_Some)
    {
      uint32_t l_ = scrut0.v.snd;
      T13_t13 v_ = scrut0.v.fst;
      scrut2 =
        (
          (FStar_Pervasives_Native_option__K___T13_t13_uint32_t){
            .tag = FStar_Pervasives_Native_Some,
  ...
  FStar_Pervasives_Native_option__K___T13_t13_uint32_t res;
  if (scrut2.tag == FStar_Pervasives_Native_Some)
  {
    uint32_t consumed = scrut2.v.snd;
    T13_t13 x = scrut2.v.fst;
    res =
      (
        (FStar_Pervasives_Native_option__K___T13_t13_uint32_t){
          .tag = FStar_Pervasives_Native_Some,
  ...
  FStar_Pervasives_Native_option__K___T13_t13_uint32_t scrut;
...
FStar_Bytes_bytes T18_x_b_t18_x_b_serializer32(T13_t13 input)
{
  T13_t13 x = input;
  FStar_Bytes_bytes pl = T13_t13_serializer32(x);
...
uint32_t T18_x_b_t18_x_b_size32(T13_t13 input)
{
  uint32_t len1 = T13_t13_size32(input);
  return (uint32_t)1U + len1;
}

uint32_t T18_x_b_t18_x_b_validator(LowParse_Slice_slice input, uint32_t pos)
{
  uint32_t res;
  ...
  else
  {
    ...
    if (!(va < (uint32_t)0U || (uint32_t)255U < va))
      ...
      else
      {
        uint32_t
        pos_ =
          T13_t13_validator(((LowParse_Slice_slice){ .base = input.base, .len = res + va }),
            res);
...
uint32_t T18_x_b_t18_x_b_jumper(LowParse_Slice_slice input, uint32_t pos)
{
  return pos + (uint32_t)1U + LowParse_Low_BoundedInt_read_bounded_integer_1(input, pos);
}

uint32_t T18_x_b_t18_x_b_accessor(LowParse_Slice_slice input, uint32_t pos)
{
  uint32_t pos2 = pos;
