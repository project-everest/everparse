    ...
    x0 =
      {
        ...
        .snd = {
          ...
          .v = { .fst = FStar_Bytes_slice(input, (uint32_t)0U, (uint32_t)8U), .snd = buf0 }
        }
      };
    while (b)
    {
      ...
      scrut =
        (
          (FStar_Pervasives_Native_option__K___Prims_list__FStar_Bytes_bytes_uint32_t){
            ...
            .v = {
              .fst = res,
              .snd = FStar_Bytes_len(FStar_Bytes_slice(input, (uint32_t)0U, (uint32_t)8U))
            }
          }
        );
    }
...
FStar_Bytes_bytes T4_t4_serializer32(Prims_list__FStar_Bytes_bytes *input)
{
...
uint32_t T4_t4_size32(Prims_list__FStar_Bytes_bytes *x)
{
  return (uint32_t)8U;
}
