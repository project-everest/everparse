...
extern FStar_Bytes_bytes FStar_Bytes_bytes_of_hex(Prims_string uu____740);

extern Prims_string FStar_Bytes_hex_of_bytes(FStar_Bytes_bytes uu____768);
...
extern bool FStar_IO_debug_print_string(Prims_string uu____291);
