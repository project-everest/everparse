...
FStar_Pervasives_Native_option__K___T13_t13_uint32_t T29_t29_parser32(FStar_Bytes_bytes input)
{
  ...
  else if (scrut1.tag == FStar_Pervasives_Native_Some)
  {
    ...
    {
      FStar_Pervasives_Native_option__K___T13_t13_uint32_t
      scrut = T13_t13_parser32(FStar_Bytes_slice(input_, (uint32_t)0U, sz));
...
FStar_Bytes_bytes T29_t29_serializer32(T13_t13 input)
{
  T13_t13 x = input;
  FStar_Bytes_bytes sp = T13_t13_serializer32(x);
  uint32_t len1 = FStar_Bytes_len(sp);
  return FStar_Bytes_append(LowParse_SLow_BCVLI_serialize32_bcvli(len1), sp);
}

uint32_t T29_t29_size32(T13_t13 input)
{
  uint32_t sp = T13_t13_size32(input);
