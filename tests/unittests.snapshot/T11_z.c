...
bool T11_z_check_t11_z_list_bytesize(Prims_list__FStar_Bytes_bytes *l)
{
  bool b = true;
  K___bool_K___uint32_t_Prims_list__FStar_Bytes_bytes
  x0 = { .fst = true, .snd = { .fst = (uint32_t)0U, .snd = l } };
  while (b)
  {
    K___uint32_t_Prims_list__FStar_Bytes_bytes x = x0.snd;
    uint32_t len1 = x.fst;
    Prims_list__FStar_Bytes_bytes *rem1 = x.snd;
    K___bool_K___uint32_t_Prims_list__FStar_Bytes_bytes ite;
    if (rem1->tag == Prims_Nil)
      ite = ((K___bool_K___uint32_t_Prims_list__FStar_Bytes_bytes){ .fst = false, .snd = x });
    else if (rem1->tag == Prims_Cons)
    {
      Prims_list__FStar_Bytes_bytes *q = rem1->tl;
      FStar_Bytes_bytes a = rem1->hd;
      uint32_t sza = T1_t1_size32(a);
      uint32_t len_;
      ...
      ite =
        KRML_EABORT(K___bool_K___uint32_t_Prims_list__FStar_Bytes_bytes,
          "unreachable (pattern matches are exhaustive in F*)");
    x0 = ite;
    b = x0.fst;
  }
  K___bool_K___uint32_t_Prims_list__FStar_Bytes_bytes scrut = x0;
  K___uint32_t_Prims_list__FStar_Bytes_bytes scrut0 = scrut.snd;
  uint32_t x = scrut0.fst;
  return (uint32_t)0U <= x && x <= (uint32_t)255U;
}

typedef struct K___bool_K___Prims_list__FStar_Bytes_bytes_Prims_list__FStar_Bytes_bytes_s
{
  bool fst;
  K___Prims_list__FStar_Bytes_bytes_Prims_list__FStar_Bytes_bytes snd;
}
K___bool_K___Prims_list__FStar_Bytes_bytes_Prims_list__FStar_Bytes_bytes;

Prims_list__FStar_Bytes_bytes
*LowParse_SLow_List_list_rev__FStar_Bytes_bytes(Prims_list__FStar_Bytes_bytes *l)
{
  if (l->tag == Prims_Nil)
  {
    KRML_CHECK_SIZE(sizeof (Prims_list__FStar_Bytes_bytes), (uint32_t)1U);
  ...
  else
  {
    ...
    while (b)
    {
      K___Prims_list__FStar_Bytes_bytes_Prims_list__FStar_Bytes_bytes x = x0.snd;
      Prims_list__FStar_Bytes_bytes *rem1 = x.fst;
      Prims_list__FStar_Bytes_bytes *acc = x.snd;
      K___bool_K___Prims_list__FStar_Bytes_bytes_Prims_list__FStar_Bytes_bytes ite;
      if (rem1->tag == Prims_Nil)
        ite =
          (
            (K___bool_K___Prims_list__FStar_Bytes_bytes_Prims_list__FStar_Bytes_bytes){
      ...
      else if (rem1->tag == Prims_Cons)
      {
        ...
        Prims_list__FStar_Bytes_bytes
        *buf = KRML_HOST_MALLOC(sizeof (Prims_list__FStar_Bytes_bytes));
        buf[0U] = ((Prims_list__FStar_Bytes_bytes){ .tag = Prims_Cons, .hd = a, .tl = acc });
        ite =
          (
            (K___bool_K___Prims_list__FStar_Bytes_bytes_Prims_list__FStar_Bytes_bytes){
              .fst = true,
        ...
        ite =
          KRML_EABORT(K___bool_K___Prims_list__FStar_Bytes_bytes_Prims_list__FStar_Bytes_bytes,
            "unreachable (pattern matches are exhaustive in F*)");
      x0 = ite;
      b = x0.fst;
    }
    K___bool_K___Prims_list__FStar_Bytes_bytes_Prims_list__FStar_Bytes_bytes scrut = x0;
    K___Prims_list__FStar_Bytes_bytes_Prims_list__FStar_Bytes_bytes scrut0 = scrut.snd;
    return scrut0.snd;
  }
}

FStar_Pervasives_Native_option__K___Prims_list__FStar_Bytes_bytes_uint32_t
T11_z_t11_z_parser32(FStar_Bytes_bytes input)
{
  FStar_Pervasives_Native_option__K___uint32_t_uint32_t
  scrut0 = LowParse_SLow_BoundedInt_parse32_bounded_integer_1(input);
  ...
  if (scrut0.tag == FStar_Pervasives_Native_Some)
  {
    ...
    if (!(v1 < (uint32_t)0U || (uint32_t)255U < v1))
      scrut1 =
        (
          (FStar_Pervasives_Native_option__K___uint32_t_uint32_t){
  ...
  FStar_Pervasives_Native_option__K___Prims_list__FStar_Bytes_bytes_uint32_t scrut2;
  if (scrut1.tag == FStar_Pervasives_Native_Some)
  {
    ...
    FStar_Pervasives_Native_option__K___Prims_list__FStar_Bytes_bytes_uint32_t scrut0;
    ...
    else
    {
      ...
      *buf0 = KRML_HOST_MALLOC(sizeof (Prims_list__FStar_Bytes_bytes));
      ...
      K___bool_FStar_Pervasives_Native_option__K___FStar_Bytes_bytes_Prims_list__FStar_Bytes_bytes
      x0 =
        {
          .fst = true,
          .snd = {
      ...
      while (b)
      {
        FStar_Pervasives_Native_option__K___FStar_Bytes_bytes_Prims_list__FStar_Bytes_bytes
        x = x0.snd;
        K___bool_FStar_Pervasives_Native_option__K___FStar_Bytes_bytes_Prims_list__FStar_Bytes_bytes
        ite;
        if (x.tag == FStar_Pervasives_Native_Some)
        {
          Prims_list__FStar_Bytes_bytes *accu_ = x.v.snd;
          ...
          else
          {
            ...
            if (scrut.tag == FStar_Pervasives_Native_Some)
            {
              ...
              else
              {
                ...
                *buf = KRML_HOST_MALLOC(sizeof (Prims_list__FStar_Bytes_bytes));
                buf[0U]
                = ((Prims_list__FStar_Bytes_bytes){ .tag = Prims_Cons, .hd = v2, .tl = accu_ });
                ite =
                  (
                    (K___bool_FStar_Pervasives_Native_option__K___FStar_Bytes_bytes_Prims_list__FStar_Bytes_bytes){
                      .fst = true,
              ...
              ite =
                KRML_EABORT(K___bool_FStar_Pervasives_Native_option__K___FStar_Bytes_bytes_Prims_list__FStar_Bytes_bytes,
                  "unreachable (pattern matches are exhaustive in F*)");
          }
        }
        else
      ...
      FStar_Pervasives_Native_option__K___FStar_Bytes_bytes_Prims_list__FStar_Bytes_bytes
      accu = scrut1.snd;
      FStar_Pervasives_Native_option__Prims_list__FStar_Bytes_bytes scrut2;
      ...
      {
        Prims_list__FStar_Bytes_bytes *accu_ = accu.v.snd;
        scrut2 =
          (
            (FStar_Pervasives_Native_option__Prims_list__FStar_Bytes_bytes){
              .tag = FStar_Pervasives_Native_Some,
              .v = LowParse_SLow_List_list_rev__FStar_Bytes_bytes(accu_)
            }
          );
      }
      else
        scrut2 =
          KRML_EABORT(FStar_Pervasives_Native_option__Prims_list__FStar_Bytes_bytes,
            "unreachable (pattern matches are exhaustive in F*)");
      FStar_Pervasives_Native_option__K___Prims_list__FStar_Bytes_bytes_uint32_t scrut;
      ...
      {
        Prims_list__FStar_Bytes_bytes *res = scrut2.v;
        scrut =
          (
            (FStar_Pervasives_Native_option__K___Prims_list__FStar_Bytes_bytes_uint32_t){
              .tag = FStar_Pervasives_Native_Some,
        ...
        scrut =
          KRML_EABORT(FStar_Pervasives_Native_option__K___Prims_list__FStar_Bytes_bytes_uint32_t,
            "unreachable (pattern matches are exhaustive in F*)");
      if (scrut.tag == FStar_Pervasives_Native_Some)
      {
        uint32_t consumed = scrut.v.snd;
        Prims_list__FStar_Bytes_bytes *v2 = scrut.v.fst;
        if (consumed == v1)
          scrut0 =
            (
              (FStar_Pervasives_Native_option__K___Prims_list__FStar_Bytes_bytes_uint32_t){
    ...
    if (scrut0.tag == FStar_Pervasives_Native_Some)
    {
      ...
      Prims_list__FStar_Bytes_bytes *v_ = scrut0.v.fst;
      scrut2 =
        (
          (FStar_Pervasives_Native_option__K___Prims_list__FStar_Bytes_bytes_uint32_t){
            .tag = FStar_Pervasives_Native_Some,
  ...
  FStar_Pervasives_Native_option__K___Prims_list__FStar_Bytes_bytes_uint32_t res;
  if (scrut2.tag == FStar_Pervasives_Native_Some)
  {
    uint32_t consumed = scrut2.v.snd;
    Prims_list__FStar_Bytes_bytes *x = scrut2.v.fst;
    res =
      (
        (FStar_Pervasives_Native_option__K___Prims_list__FStar_Bytes_bytes_uint32_t){
          .tag = FStar_Pervasives_Native_Some,
  ...
  else if (res.tag == FStar_Pervasives_Native_Some)
  {
    ...
    Prims_list__FStar_Bytes_bytes *x = res.v.fst;
    Prims_list__FStar_Bytes_bytes *x1 = x;
    scrut =
      (
        (FStar_Pervasives_Native_option__K___Prims_list__FStar_Bytes_bytes_uint32_t){
          .tag = FStar_Pervasives_Native_Some,
...
FStar_Bytes_bytes T11_z_t11_z_serializer32(Prims_list__FStar_Bytes_bytes *input)
{
  Prims_list__FStar_Bytes_bytes *x0 = input;
  bool b = true;
  K___bool_K___FStar_Bytes_bytes_Prims_list__FStar_Bytes_bytes
  x = { .fst = true, .snd = { .fst = FStar_Bytes_empty_bytes, .snd = x0 } };
  while (b)
  {
    K___FStar_Bytes_bytes_Prims_list__FStar_Bytes_bytes x1 = x.snd;
    FStar_Bytes_bytes accu = x1.fst;
    Prims_list__FStar_Bytes_bytes *input_ = x1.snd;
    K___bool_K___FStar_Bytes_bytes_Prims_list__FStar_Bytes_bytes ite;
    if (input_->tag == Prims_Nil)
      ite =
        ((K___bool_K___FStar_Bytes_bytes_Prims_list__FStar_Bytes_bytes){ .fst = false, .snd = x1 });
    else if (input_->tag == Prims_Cons)
    {
      Prims_list__FStar_Bytes_bytes *q = input_->tl;
      FStar_Bytes_bytes a = input_->hd;
      FStar_Bytes_bytes sa = T1_t1_serializer32(a);
      ...
      ite =
        KRML_EABORT(K___bool_K___FStar_Bytes_bytes_Prims_list__FStar_Bytes_bytes,
          "unreachable (pattern matches are exhaustive in F*)");
    x = ite;
    b = x.fst;
  }
  K___bool_K___FStar_Bytes_bytes_Prims_list__FStar_Bytes_bytes scrut = x;
  K___FStar_Bytes_bytes_Prims_list__FStar_Bytes_bytes scrut0 = scrut.snd;
...
uint32_t T11_z_t11_z_size32(Prims_list__FStar_Bytes_bytes *input)
{
  bool b = true;
  K___bool_K___uint32_t_Prims_list__FStar_Bytes_bytes
  ...
  K___bool_K___uint32_t_Prims_list__FStar_Bytes_bytes scrut = x0;
  K___uint32_t_Prims_list__FStar_Bytes_bytes scrut0 = scrut.snd;
  uint32_t len1 = scrut0.fst;
  return (uint32_t)1U + len1;
}

uint32_t T11_z_t11_z_validator(LowParse_Slice_slice input, uint32_t pos)
{
  uint32_t res;
...
uint32_t T11_z_t11_z_jumper(LowParse_Slice_slice input, uint32_t pos)
{
