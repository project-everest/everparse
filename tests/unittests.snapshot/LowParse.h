...
typedef uint8_t FStar_Pervasives_Native_option__K___uint32_t_uint32_t_tags;

typedef struct FStar_Pervasives_Native_option__K___uint32_t_uint32_t_s
{
  FStar_Pervasives_Native_option__K___uint32_t_uint32_t_tags tag;
  K___uint32_t_uint32_t v;
}
...
typedef struct K___uint16_t_uint32_t_s
{
  uint16_t fst;
  uint32_t snd;
}
K___uint16_t_uint32_t;

typedef struct FStar_Pervasives_Native_option__K___uint16_t_uint32_t_s
{
  FStar_Pervasives_Native_option__K___uint32_t_uint32_t_tags tag;
  K___uint16_t_uint32_t v;
}
...
typedef struct K___uint8_t_uint32_t_s
{
  uint8_t fst;
  uint32_t snd;
}
K___uint8_t_uint32_t;

typedef struct FStar_Pervasives_Native_option__K___uint8_t_uint32_t_s
{
  FStar_Pervasives_Native_option__K___uint32_t_uint32_t_tags tag;
  K___uint8_t_uint32_t v;
}
...
extern LowParse_Slice_slice LowParse_TestLib_Low_load_file_buffer_c(C_String_t filename);
