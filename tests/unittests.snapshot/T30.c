...
FStar_Pervasives_Native_option__K___T14_t14_uint32_t T30_t30_parser32(FStar_Bytes_bytes input)
{
  ...
  else if (scrut0.tag == FStar_Pervasives_Native_Some)
  {
    ...
    if (x32 < (uint32_t)253U && (uint32_t)0U <= x32 && x32 <= (uint32_t)4294967295U)
      scrut1 =
        (
          (FStar_Pervasives_Native_option__K___uint32_t_uint32_t){
    ...
    else if ((uint32_t)4294967295U < (uint32_t)253U)
      scrut1 =
        (
          (FStar_Pervasives_Native_option__K___uint32_t_uint32_t){
            .tag = FStar_Pervasives_Native_None
      ...
      if ((uint32_t)65536U <= (uint32_t)0U)
        scrut1 =
          (
            (FStar_Pervasives_Native_option__K___uint32_t_uint32_t){
              .tag = FStar_Pervasives_Native_None
      ...
      else
      {
        ...
        else if (scrut.tag == FStar_Pervasives_Native_Some)
        {
          ...
          if (y < (uint32_t)253U || y < (uint32_t)0U || (uint32_t)4294967295U < y)
            scrut1 =
              (
                (FStar_Pervasives_Native_option__K___uint32_t_uint32_t){
                  .tag = FStar_Pervasives_Native_None
    ...
    else if (x32 == (uint32_t)254U)
    {
      ...
      else if (scrut.tag == FStar_Pervasives_Native_Some)
      {
        uint32_t consumed_y = scrut.v.snd;
        uint32_t y = scrut.v.fst;
        if (y < (uint32_t)65536U || y < (uint32_t)0U || (uint32_t)4294967295U < y)
          scrut1 =
            (
              (FStar_Pervasives_Native_option__K___uint32_t_uint32_t){
                .tag = FStar_Pervasives_Native_None
    ...
    scrut1 =
      KRML_EABORT(FStar_Pervasives_Native_option__K___uint32_t_uint32_t,
        "unreachable (pattern matches are exhaustive in F*)");
  FStar_Pervasives_Native_option__K___T14_t14_uint32_t scrut2;
  ...
  else if (scrut1.tag == FStar_Pervasives_Native_Some)
  {
    ...
    FStar_Pervasives_Native_option__K___T14_t14_uint32_t scrut0;
    ...
    {
      FStar_Pervasives_Native_option__K___T14_t14_uint32_t
      scrut = T14_t14_parser32(FStar_Bytes_slice(input_, (uint32_t)0U, sz));
      if (scrut.tag == FStar_Pervasives_Native_Some)
      {
        ...
        scrut0 =
          KRML_EABORT(FStar_Pervasives_Native_option__K___T14_t14_uint32_t,
            "unreachable (pattern matches are exhaustive in F*)");
    }
    FStar_Pervasives_Native_option__K___T14_t14_uint32_t scrut;
    if (scrut0.tag == FStar_Pervasives_Native_Some)
    {
      uint32_t consumed1 = scrut0.v.snd;
      T14_t14 v1 = scrut0.v.fst;
      scrut =
        (
          (FStar_Pervasives_Native_option__K___T14_t14_uint32_t){
            .tag = FStar_Pervasives_Native_Some,
...
FStar_Bytes_bytes T30_t30_serializer32(T14_t14 input)
{
  T14_t14 x = input;
  FStar_Bytes_bytes sp = T14_t14_serializer32(x);
  uint32_t len1 = FStar_Bytes_len(sp);
  return FStar_Bytes_append(LowParse_SLow_BCVLI_serialize32_bcvli(len1), sp);
}

uint32_t T30_t30_size32(T14_t14 input)
{
  uint32_t sp = T14_t14_size32(input);
  return LowParse_SLow_BCVLI_size32_bcvli(sp) + sp;
}

uint32_t T30_t30_validator(LowParse_Slice_slice input, uint32_t pos)
{
  uint32_t
  n1 =
  ...
  else
  {
    ...
    {
      uint32_t
      pos_ = T14_t14_validator(((LowParse_Slice_slice){ .base = input.base, .len = n1 + len1 }), n1);
...
uint32_t T30_t30_jumper(LowParse_Slice_slice input, uint32_t pos)
{
...
uint32_t T30_t30_accessor(LowParse_Slice_slice input, uint32_t pos)
{
