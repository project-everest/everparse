...
bool T32_check_t32_list_bytesize(Prims_list__T14_t14 *l)
{
  bool b = true;
...
T32_t32_parser32(FStar_Bytes_bytes input)
{
...
FStar_Bytes_bytes T32_t32_serializer32(Prims_list__T14_t14 *input)
{
...
uint32_t T32_t32_size32(Prims_list__T14_t14 *input)
{
  bool b = true;
  K___bool_K___uint32_t_Prims_list__T14_t14
...
uint32_t T32_t32_validator(LowParse_Slice_slice input, uint32_t pos)
{
  uint32_t
...
uint32_t T32_t32_jumper(LowParse_Slice_slice input, uint32_t pos)
{
