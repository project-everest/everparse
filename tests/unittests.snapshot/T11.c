...
FStar_Pervasives_Native_option__K___T11_t11_uint32_t T11_t11_parser32(FStar_Bytes_bytes input)
{
  FStar_Pervasives_Native_option__K___uint8_t_uint32_t
  scrut0 = LowParse_SLow_Int_parse32_u8(input);
  FStar_Pervasives_Native_option__K___K___uint8_t_Prims_list__FStar_Bytes_bytes_uint32_t scrut;
  if (scrut0.tag == FStar_Pervasives_Native_Some)
  {
    ...
    scrut0 = T11_z_t11_z_parser32(input_);
    if (scrut0.tag == FStar_Pervasives_Native_Some)
    {
      ...
      scrut =
        (
          (FStar_Pervasives_Native_option__K___K___uint8_t_Prims_list__FStar_Bytes_bytes_uint32_t){
  ...
  if (scrut.tag == FStar_Pervasives_Native_Some)
  {
    ...
    K___uint8_t_Prims_list__FStar_Bytes_bytes v1 = scrut.v.fst;
    uint8_t u = v1.fst;
    Prims_list__FStar_Bytes_bytes *z = v1.snd;
    return
      (
        (FStar_Pervasives_Native_option__K___T11_t11_uint32_t){
          .tag = FStar_Pervasives_Native_Some,
          .v = { .fst = { .u = u, .z = z }, .snd = consumed }
        }
      );
  }
  else
...
FStar_Bytes_bytes T11_t11_serializer32(T11_t11 input)
{
  K___uint8_t_Prims_list__FStar_Bytes_bytes x = { .fst = input.u, .snd = input.z };
  uint8_t fs = x.fst;
  Prims_list__FStar_Bytes_bytes *sn = x.snd;
  FStar_Bytes_bytes output1 = LowParse_SLow_Int_serialize32_u8(fs);
  FStar_Bytes_bytes output2 = T11_z_t11_z_serializer32(sn);
  return FStar_Bytes_append(output1, output2);
}

uint32_t T11_t11_size32(T11_t11 input)
{
  uint32_t v1 = (uint32_t)1U;
  uint32_t v2 = T11_z_t11_z_size32(input.z);
