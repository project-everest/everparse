...
T22_body_b_t22_body_b_parser32(FStar_Bytes_bytes input)
{
  ...
  if (scrut0.tag == FStar_Pervasives_Native_Some)
  {
    ...
    if (!(v1 < (uint32_t)2U || (uint32_t)8U < v1))
      scrut1 =
        (
          (FStar_Pervasives_Native_option__K___uint32_t_uint32_t){
...
FStar_Bytes_bytes T22_body_b_t22_body_b_serializer32(FStar_Bytes_bytes input)
{
...
uint32_t T22_body_b_t22_body_b_size32(FStar_Bytes_bytes input)
{
...
uint32_t T22_body_b_t22_body_b_validator(LowParse_Slice_slice input, uint32_t pos)
{
  uint32_t res;
  ...
  else
  {
    ...
    if (!(va < (uint32_t)2U || (uint32_t)8U < va))
      if (input.len - res < va)
...
uint32_t T22_body_b_t22_body_b_jumper(LowParse_Slice_slice input, uint32_t pos)
{
