...
typedef struct K___T24_t24_FStar_Bytes_bytes_s
{
  T24_t24 fst;
  FStar_Bytes_bytes snd;
}
K___T24_t24_FStar_Bytes_bytes;

typedef struct K___K___T24_t24_FStar_Bytes_bytes_uint32_t_s
{
  K___T24_t24_FStar_Bytes_bytes fst;
  uint32_t snd;
}
K___K___T24_t24_FStar_Bytes_bytes_uint32_t;

typedef struct FStar_Pervasives_Native_option__K___K___T24_t24_FStar_Bytes_bytes_uint32_t_s
{
  FStar_Pervasives_Native_option__K___uint32_t_uint32_t_tags tag;
  K___K___T24_t24_FStar_Bytes_bytes_uint32_t v;
}
FStar_Pervasives_Native_option__K___K___T24_t24_FStar_Bytes_bytes_uint32_t;

FStar_Pervasives_Native_option__K___T25_t25_uint32_t T25_t25_parser32(FStar_Bytes_bytes input)
{
  FStar_Pervasives_Native_option__K___T24_t24_uint32_t
  scrut0 = T25_payload_t25_payload_parser32(input);
  FStar_Pervasives_Native_option__K___K___T24_t24_FStar_Bytes_bytes_uint32_t scrut;
  if (scrut0.tag == FStar_Pervasives_Native_Some)
  {
    ...
    scrut0 = T25_bpayload_t25_bpayload_parser32(input_);
    if (scrut0.tag == FStar_Pervasives_Native_Some)
    {
      uint32_t l_ = scrut0.v.snd;
      FStar_Bytes_bytes v_ = scrut0.v.fst;
      scrut =
        (
          (FStar_Pervasives_Native_option__K___K___T24_t24_FStar_Bytes_bytes_uint32_t){
  ...
  if (scrut.tag == FStar_Pervasives_Native_Some)
  {
    ...
    K___T24_t24_FStar_Bytes_bytes v1 = scrut.v.fst;
    T24_t24 payload = v1.fst;
    FStar_Bytes_bytes bpayload = v1.snd;
    return
      (
        (FStar_Pervasives_Native_option__K___T25_t25_uint32_t){
          .tag = FStar_Pervasives_Native_Some,
          .v = { .fst = { .payload = payload, .bpayload = bpayload }, .snd = consumed }
        }
      );
  }
  else
...
FStar_Bytes_bytes T25_t25_serializer32(T25_t25 input)
{
  K___T24_t24_FStar_Bytes_bytes x = { .fst = input.payload, .snd = input.bpayload };
  T24_t24 fs = x.fst;
  FStar_Bytes_bytes sn = x.snd;
  FStar_Bytes_bytes output1 = T25_payload_t25_payload_serializer32(fs);
  FStar_Bytes_bytes output2 = T25_bpayload_t25_bpayload_serializer32(sn);
  return FStar_Bytes_append(output1, output2);
}

uint32_t T25_t25_size32(T25_t25 input)
{
  uint32_t v1 = T25_payload_t25_payload_size32(input.payload);
  uint32_t v2 = T25_bpayload_t25_bpayload_size32(input.bpayload);
