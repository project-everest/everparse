...
FStar_Pervasives_Native_option__K___T14_t14_uint32_t T14_t14_parser32(FStar_Bytes_bytes input)
{
  ...
  if (scrut0.tag == FStar_Pervasives_Native_Some)
  {
    ...
    scrut = T14_x_t14_x_parser32(input_);
  ...
  if (scrut.tag == FStar_Pervasives_Native_Some)
  {
    ...
    return
      (
        (FStar_Pervasives_Native_option__K___T14_t14_uint32_t){
          .tag = FStar_Pervasives_Native_Some,
...
FStar_Bytes_bytes T14_t14_serializer32(T14_t14 input)
{
  ...
  FStar_Bytes_bytes output20 = T14_x_t14_x_serializer32(sn1);
...
uint32_t T14_t14_size32(T14_t14 input)
{
  uint32_t v1 = (uint32_t)1U;
  uint32_t v20 = T14_x_t14_x_size32(input.x);
  uint32_t res;
