...
uint8_t T12___proj__Mkt12__item__u(T12_t12 projectee)
{
  return projectee.u;
}

Prims_list__FStar_Bytes_bytes *T12___proj__Mkt12__item__z(T12_t12 projectee)
{
  return projectee.z;
}

FStar_Pervasives_Native_option__K___T12_t12_uint32_t T12_t12_parser32(FStar_Bytes_bytes input)
{
  ...
  if (scrut0.tag == FStar_Pervasives_Native_Some)
  {
    ...
    scrut0 = T12_z_t12_z_parser32(input_);
    if (scrut0.tag == FStar_Pervasives_Native_Some)
    {
  ...
  if (scrut.tag == FStar_Pervasives_Native_Some)
  {
    ...
    return
      (
        (FStar_Pervasives_Native_option__K___T12_t12_uint32_t){
          .tag = FStar_Pervasives_Native_Some,
...
FStar_Bytes_bytes T12_t12_serializer32(T12_t12 input)
{
  ...
  FStar_Bytes_bytes output2 = T12_z_t12_z_serializer32(sn);
  return FStar_Bytes_append(output1, output2);
}

uint32_t T12_t12_size32(T12_t12 input)
{
  uint32_t v1 = (uint32_t)1U;
  uint32_t v2 = T12_z_t12_z_size32(input.z);
...
uint32_t T12_t12_validator(LowParse_Slice_slice input, uint32_t pos)
{
  uint32_t pos1;
  ...
  if (pos1 > LOWPARSE_LOW_BASE_VALIDATOR_MAX_LENGTH)
    ...
    return T12_z_t12_z_validator(input, pos1);
}

uint32_t T12_t12_jumper(LowParse_Slice_slice input, uint32_t pos)
{
  return pos + (uint32_t)19U;
}

uint32_t T12_accessor_t12_u(LowParse_Slice_slice input, uint32_t pos)
{
  return pos;
}

uint32_t T12_accessor_t12_z(LowParse_Slice_slice input, uint32_t pos)
{
  uint32_t pos2 = pos;
  uint32_t pos21 = pos2;
