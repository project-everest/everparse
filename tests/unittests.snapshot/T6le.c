...
{
  if (x.tag == T6le_Body_a)
    return Tagle_A;
  else if (x.tag == T6le_Body_b)
    return Tagle_B;
  else
  {
    KRML_HOST_EPRINTF("KreMLin abort at %s:%d\n%s\n",
...
FStar_Pervasives_Native_option__K___T6le_t6le_uint32_t
T6le_t6le_parser32(FStar_Bytes_bytes input)
{
  FStar_Pervasives_Native_option__K___uint8_t_uint32_t
  scrut0 = LowParse_SLow_Int_parse32_u8(input);
  FStar_Pervasives_Native_option__K___LowParse_Spec_Enum_maybe_enum_key__Tagle_tagle_uint8_t_uint32_t
  scrut;
  if (scrut0.tag == FStar_Pervasives_Native_Some)
  {
    uint32_t consumed = scrut0.v.snd;
    uint8_t v1 = scrut0.v.fst;
    LowParse_Spec_Enum_maybe_enum_key__Tagle_tagle_uint8_t ite;
    if ((uint8_t)0U == v1)
      ite =
        (
          (LowParse_Spec_Enum_maybe_enum_key__Tagle_tagle_uint8_t){
    ...
    {
      LowParse_Spec_Enum_maybe_enum_key__Tagle_tagle_uint8_t y;
      if ((uint8_t)1U == v1)
        y =
          (
            (LowParse_Spec_Enum_maybe_enum_key__Tagle_tagle_uint8_t){
      ...
      if (y.tag == LowParse_Spec_Enum_Known)
      {
        ...
        ite =
          KRML_EABORT(LowParse_Spec_Enum_maybe_enum_key__Tagle_tagle_uint8_t,
            "unreachable (pattern matches are exhaustive in F*)");
    }
    scrut =
      (
  ...
  FStar_Pervasives_Native_option__K___Tagle_tagle_uint32_t pi;
  if (scrut.tag == FStar_Pervasives_Native_Some)
  {
    uint32_t consumed = scrut.v.snd;
    LowParse_Spec_Enum_maybe_enum_key__Tagle_tagle_uint8_t k = scrut.v.fst;
    if (k.tag == LowParse_Spec_Enum_Known)
    {
      Tagle_tagle k_ = k.case_Known;
      pi =
        (
          (FStar_Pervasives_Native_option__K___Tagle_tagle_uint32_t){
            .tag = FStar_Pervasives_Native_Some,
      ...
      if (scrut.tag == FStar_Pervasives_Native_Some)
      {
        ...
        pcases2 =
          (
            (FStar_Pervasives_Native_option__K___T6le_t6le_uint32_t){
              .tag = FStar_Pervasives_Native_Some,
              .v = { .fst = { .tag = T6le_Body_a, { .case_Body_a = v1 } }, .snd = consumed }
            }
          );
      }
      else
      ...
      if (scrut.tag == FStar_Pervasives_Native_Some)
      {
        ...
        pcases2 =
          (
            (FStar_Pervasives_Native_option__K___T6le_t6le_uint32_t){
              .tag = FStar_Pervasives_Native_Some,
              .v = { .fst = { .tag = T6le_Body_b, { .case_Body_b = v1 } }, .snd = consumed }
            }
          );
      }
      else
...
FStar_Bytes_bytes T6le_t6le_serializer32(T6le_t6le x)
{
  Tagle_tagle tg;
  if (x.tag == T6le_Body_a)
    tg = Tagle_A;
    ...
    tg = KRML_EABORT(Tagle_tagle, "unreachable (pattern matches are exhaustive in F*)");
  uint8_t ite0;
  if (__eq__Tagle_tagle(Tagle_A, tg))
    ite0 = (uint8_t)0U;
  else
    ite0 = (uint8_t)1U;
...
uint32_t T6le_t6le_size32(T6le_t6le x)
{
  Tagle_tagle tg;
  if (x.tag == T6le_Body_a)
    tg = Tagle_A;
