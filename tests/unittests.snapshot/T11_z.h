...
{
  Prims_list__T13_t13_tags tag;
  FStar_Bytes_bytes hd;
  Prims_list__FStar_Bytes_bytes *tl;
}
Prims_list__FStar_Bytes_bytes;

typedef Prims_list__FStar_Bytes_bytes *T11_z_t11_z;

typedef struct K___uint32_t_Prims_list__FStar_Bytes_bytes_s
{
  uint32_t fst;
  Prims_list__FStar_Bytes_bytes *snd;
}
K___uint32_t_Prims_list__FStar_Bytes_bytes;

typedef struct K___bool_K___uint32_t_Prims_list__FStar_Bytes_bytes_s
{
  bool fst;
  K___uint32_t_Prims_list__FStar_Bytes_bytes snd;
}
K___bool_K___uint32_t_Prims_list__FStar_Bytes_bytes;

bool T11_z_check_t11_z_list_bytesize(Prims_list__FStar_Bytes_bytes *l);

typedef struct K___FStar_Bytes_bytes_Prims_list__FStar_Bytes_bytes_s
{
  FStar_Bytes_bytes fst;
  Prims_list__FStar_Bytes_bytes *snd;
}
K___FStar_Bytes_bytes_Prims_list__FStar_Bytes_bytes;

typedef struct
FStar_Pervasives_Native_option__K___FStar_Bytes_bytes_Prims_list__FStar_Bytes_bytes_s
{
  FStar_Pervasives_Native_option__K___uint32_t_uint32_t_tags tag;
  K___FStar_Bytes_bytes_Prims_list__FStar_Bytes_bytes v;
}
FStar_Pervasives_Native_option__K___FStar_Bytes_bytes_Prims_list__FStar_Bytes_bytes;

typedef struct
K___bool_FStar_Pervasives_Native_option__K___FStar_Bytes_bytes_Prims_list__FStar_Bytes_bytes_s
{
  bool fst;
  FStar_Pervasives_Native_option__K___FStar_Bytes_bytes_Prims_list__FStar_Bytes_bytes snd;
}
K___bool_FStar_Pervasives_Native_option__K___FStar_Bytes_bytes_Prims_list__FStar_Bytes_bytes;

typedef struct K___Prims_list__FStar_Bytes_bytes_Prims_list__FStar_Bytes_bytes_s
{
  Prims_list__FStar_Bytes_bytes *fst;
  Prims_list__FStar_Bytes_bytes *snd;
}
K___Prims_list__FStar_Bytes_bytes_Prims_list__FStar_Bytes_bytes;

Prims_list__FStar_Bytes_bytes
*LowParse_SLow_List_list_rev__FStar_Bytes_bytes(Prims_list__FStar_Bytes_bytes *l);

typedef struct K___Prims_list__FStar_Bytes_bytes_uint32_t_s
{
  Prims_list__FStar_Bytes_bytes *fst;
  uint32_t snd;
}
K___Prims_list__FStar_Bytes_bytes_uint32_t;

typedef struct FStar_Pervasives_Native_option__K___Prims_list__FStar_Bytes_bytes_uint32_t_s
{
  FStar_Pervasives_Native_option__K___uint32_t_uint32_t_tags tag;
  K___Prims_list__FStar_Bytes_bytes_uint32_t v;
}
...
typedef struct K___bool_K___FStar_Bytes_bytes_Prims_list__FStar_Bytes_bytes_s
{
  bool fst;
  K___FStar_Bytes_bytes_Prims_list__FStar_Bytes_bytes snd;
}
