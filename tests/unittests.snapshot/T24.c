...
typedef struct K___K___uint32_t_Prims_list__uint16_t_uint32_t_s
{
  K___uint32_t_Prims_list__uint16_t fst;
  uint32_t snd;
}
K___K___uint32_t_Prims_list__uint16_t_uint32_t;

typedef struct FStar_Pervasives_Native_option__K___K___uint32_t_Prims_list__uint16_t_uint32_t_s
{
  FStar_Pervasives_Native_option__K___uint32_t_uint32_t_tags tag;
  K___K___uint32_t_Prims_list__uint16_t_uint32_t v;
}
FStar_Pervasives_Native_option__K___K___uint32_t_Prims_list__uint16_t_uint32_t;

FStar_Pervasives_Native_option__K___T24_t24_uint32_t T24_t24_parser32(FStar_Bytes_bytes input)
{
  FStar_Pervasives_Native_option__K___uint32_t_uint32_t
  scrut0 = LowParse_SLow_BCVLI_parse32_bcvli(input);
  FStar_Pervasives_Native_option__K___K___uint32_t_Prims_list__uint16_t_uint32_t scrut;
  if (scrut0.tag == FStar_Pervasives_Native_Some)
  {
    ...
    scrut0 = T24_y_t24_y_parser32(input_);
    if (scrut0.tag == FStar_Pervasives_Native_Some)
    {
      uint32_t l_ = scrut0.v.snd;
      Prims_list__uint16_t *v_ = scrut0.v.fst;
      scrut =
        (
          (FStar_Pervasives_Native_option__K___K___uint32_t_Prims_list__uint16_t_uint32_t){
  ...
  if (scrut.tag == FStar_Pervasives_Native_Some)
  {
    ...
    K___uint32_t_Prims_list__uint16_t v1 = scrut.v.fst;
    uint32_t x = v1.fst;
    Prims_list__uint16_t *y = v1.snd;
    return
      (
        (FStar_Pervasives_Native_option__K___T24_t24_uint32_t){
          .tag = FStar_Pervasives_Native_Some,
          .v = { .fst = { .x = x, .y = y }, .snd = consumed }
        }
      );
  }
  else
...
FStar_Bytes_bytes T24_t24_serializer32(T24_t24 input)
{
  K___uint32_t_Prims_list__uint16_t x = { .fst = input.x, .snd = input.y };
  uint32_t fs = x.fst;
  Prims_list__uint16_t *sn = x.snd;
  FStar_Bytes_bytes output1 = LowParse_SLow_BCVLI_serialize32_bcvli(fs);
  FStar_Bytes_bytes output2 = T24_y_t24_y_serializer32(sn);
  return FStar_Bytes_append(output1, output2);
}

uint32_t T24_t24_size32(T24_t24 input)
{
  uint32_t v1 = LowParse_SLow_BCVLI_size32_bcvli(input.x);
  uint32_t v2 = T24_y_t24_y_size32(input.y);
