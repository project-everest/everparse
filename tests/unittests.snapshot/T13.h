...
typedef struct K___uint8_t_FStar_Bytes_bytes_s
{
  uint8_t fst;
  FStar_Bytes_bytes snd;
}
K___uint8_t_FStar_Bytes_bytes;

typedef struct K___K___uint8_t_FStar_Bytes_bytes_uint16_t_s
{
  K___uint8_t_FStar_Bytes_bytes fst;
  uint16_t snd;
}
K___K___uint8_t_FStar_Bytes_bytes_uint16_t;

typedef struct K___T13_t13_uint32_t_s
{
  T13_t13 fst;
  uint32_t snd;
}
K___T13_t13_uint32_t;

typedef struct FStar_Pervasives_Native_option__K___T13_t13_uint32_t_s
{
  FStar_Pervasives_Native_option__K___uint32_t_uint32_t_tags tag;
  K___T13_t13_uint32_t v;
}
FStar_Pervasives_Native_option__K___T13_t13_uint32_t;

typedef struct K___K___K___uint8_t_FStar_Bytes_bytes_uint16_t_uint32_t_s
{
  K___K___uint8_t_FStar_Bytes_bytes_uint16_t fst;
  uint32_t snd;
}
K___K___K___uint8_t_FStar_Bytes_bytes_uint16_t_uint32_t;

typedef struct
FStar_Pervasives_Native_option__K___K___K___uint8_t_FStar_Bytes_bytes_uint16_t_uint32_t_s
{
  FStar_Pervasives_Native_option__K___uint32_t_uint32_t_tags tag;
  K___K___K___uint8_t_FStar_Bytes_bytes_uint16_t_uint32_t v;
}
FStar_Pervasives_Native_option__K___K___K___uint8_t_FStar_Bytes_bytes_uint16_t_uint32_t;

typedef struct K___K___uint8_t_FStar_Bytes_bytes_uint32_t_s
{
  K___uint8_t_FStar_Bytes_bytes fst;
  uint32_t snd;
}
K___K___uint8_t_FStar_Bytes_bytes_uint32_t;

typedef struct FStar_Pervasives_Native_option__K___K___uint8_t_FStar_Bytes_bytes_uint32_t_s
{
  FStar_Pervasives_Native_option__K___uint32_t_uint32_t_tags tag;
  K___K___uint8_t_FStar_Bytes_bytes_uint32_t v;
}
