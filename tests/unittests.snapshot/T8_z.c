...
bool T8_z_check_t8_z_list_bytesize(Prims_list__FStar_Bytes_bytes *l)
{
  bool b = true;
...
T8_z_t8_z_parser32(FStar_Bytes_bytes input)
{
...
FStar_Bytes_bytes T8_z_t8_z_serializer32(Prims_list__FStar_Bytes_bytes *input)
{
...
uint32_t T8_z_t8_z_size32(Prims_list__FStar_Bytes_bytes *input)
{
  bool b = true;
  K___bool_K___uint32_t_Prims_list__FStar_Bytes_bytes
