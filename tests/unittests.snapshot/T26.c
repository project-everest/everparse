...
FStar_Pervasives_Native_option__K___T25_t25_uint32_t T26_t26_parser32(FStar_Bytes_bytes input)
{
  ...
  else if (scrut0.tag == FStar_Pervasives_Native_Some)
  {
    ...
    scrut1 =
      KRML_EABORT(FStar_Pervasives_Native_option__K___uint32_t_uint32_t,
        "unreachable (pattern matches are exhaustive in F*)");
  FStar_Pervasives_Native_option__K___T25_t25_uint32_t scrut2;
  ...
  else if (scrut1.tag == FStar_Pervasives_Native_Some)
  {
    ...
    FStar_Pervasives_Native_option__K___T25_t25_uint32_t scrut0;
    ...
    {
      FStar_Pervasives_Native_option__K___T25_t25_uint32_t
      scrut = T25_t25_parser32(FStar_Bytes_slice(input_, (uint32_t)0U, sz));
      if (scrut.tag == FStar_Pervasives_Native_Some)
      {
        uint32_t consumed1 = scrut.v.snd;
        T25_t25 v1 = scrut.v.fst;
        if (consumed1 == sz)
          scrut0 =
            (
              (FStar_Pervasives_Native_option__K___T25_t25_uint32_t){
        ...
        scrut0 =
          KRML_EABORT(FStar_Pervasives_Native_option__K___T25_t25_uint32_t,
            "unreachable (pattern matches are exhaustive in F*)");
    }
    FStar_Pervasives_Native_option__K___T25_t25_uint32_t scrut;
    if (scrut0.tag == FStar_Pervasives_Native_Some)
    {
      uint32_t consumed1 = scrut0.v.snd;
      T25_t25 v1 = scrut0.v.fst;
      scrut =
        (
          (FStar_Pervasives_Native_option__K___T25_t25_uint32_t){
            .tag = FStar_Pervasives_Native_Some,
...
FStar_Bytes_bytes T26_t26_serializer32(T25_t25 input)
{
  T25_t25 x = input;
  FStar_Bytes_bytes sp = T25_t25_serializer32(x);
...
uint32_t T26_t26_size32(T25_t25 input)
{
  uint32_t sp = T25_t25_size32(input);
  uint32_t ite;
  if (sp < (uint32_t)128U)
    ite = (uint32_t)1U;
