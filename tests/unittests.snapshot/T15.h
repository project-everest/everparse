...
typedef struct T15_t15_s
{
  FStar_Bytes_bytes start;
  T15_body_t15_body body;
}
T15_t15;
...
typedef struct K___T15_t15_uint32_t_s
{
  T15_t15 fst;
  uint32_t snd;
}
K___T15_t15_uint32_t;

typedef struct FStar_Pervasives_Native_option__K___T15_t15_uint32_t_s
{
  FStar_Pervasives_Native_option__K___uint32_t_uint32_t_tags tag;
  K___T15_t15_uint32_t v;
}
