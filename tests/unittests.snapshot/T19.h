...
typedef struct K___T19_t19__uint32_t_s
{
  T19_t19_ fst;
  uint32_t snd;
}
K___T19_t19__uint32_t;

typedef struct FStar_Pervasives_Native_option__K___T19_t19__uint32_t_s
{
  FStar_Pervasives_Native_option__K___uint32_t_uint32_t_tags tag;
  K___T19_t19__uint32_t v;
}
