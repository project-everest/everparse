...
typedef struct K___FStar_Bytes_bytes_T15_body_t15_body_s
{
  FStar_Bytes_bytes fst;
  T15_body_t15_body snd;
}
K___FStar_Bytes_bytes_T15_body_t15_body;

typedef struct K___K___FStar_Bytes_bytes_T15_body_t15_body_uint32_t_s
{
  K___FStar_Bytes_bytes_T15_body_t15_body fst;
  uint32_t snd;
}
K___K___FStar_Bytes_bytes_T15_body_t15_body_uint32_t;

typedef struct
FStar_Pervasives_Native_option__K___K___FStar_Bytes_bytes_T15_body_t15_body_uint32_t_s
{
  FStar_Pervasives_Native_option__K___uint32_t_uint32_t_tags tag;
  K___K___FStar_Bytes_bytes_T15_body_t15_body_uint32_t v;
}
FStar_Pervasives_Native_option__K___K___FStar_Bytes_bytes_T15_body_t15_body_uint32_t;

FStar_Pervasives_Native_option__K___T15_t15_uint32_t T15_t15_parser32(FStar_Bytes_bytes input)
{
  FStar_Pervasives_Native_option__K___FStar_Bytes_bytes_uint32_t scrut0 = T1_t1_parser32(input);
  FStar_Pervasives_Native_option__K___K___FStar_Bytes_bytes_T15_body_t15_body_uint32_t scrut;
  if (scrut0.tag == FStar_Pervasives_Native_Some)
  {
    ...
    scrut0 = T15_body_t15_body_parser32(input_);
    if (scrut0.tag == FStar_Pervasives_Native_Some)
    {
      uint32_t l_ = scrut0.v.snd;
      T15_body_t15_body v_ = scrut0.v.fst;
      scrut =
        (
          (FStar_Pervasives_Native_option__K___K___FStar_Bytes_bytes_T15_body_t15_body_uint32_t){
  ...
  if (scrut.tag == FStar_Pervasives_Native_Some)
  {
    ...
    K___FStar_Bytes_bytes_T15_body_t15_body v1 = scrut.v.fst;
    FStar_Bytes_bytes start = v1.fst;
    T15_body_t15_body body = v1.snd;
    return
      (
        (FStar_Pervasives_Native_option__K___T15_t15_uint32_t){
          .tag = FStar_Pervasives_Native_Some,
          .v = { .fst = { .start = start, .body = body }, .snd = consumed }
        }
      );
  }
  else
...
FStar_Bytes_bytes T15_t15_serializer32(T15_t15 input)
{
  K___FStar_Bytes_bytes_T15_body_t15_body x = { .fst = input.start, .snd = input.body };
  FStar_Bytes_bytes fs = x.fst;
  T15_body_t15_body sn = x.snd;
  FStar_Bytes_bytes output1 = T1_t1_serializer32(fs);
  FStar_Bytes_bytes output2 = T15_body_t15_body_serializer32(sn);
  return FStar_Bytes_append(output1, output2);
}

uint32_t T15_t15_size32(T15_t15 input)
{
  uint32_t v1 = T1_t1_size32(input.start);
  uint32_t v2 = T15_body_t15_body_size32(input.body);
